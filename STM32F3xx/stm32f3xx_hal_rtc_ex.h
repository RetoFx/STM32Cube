...
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef * const hrtc, uint32_t RTC_TimeStampEdge, uint32_t RTC_TimeStampPin);
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef * const hrtc, uint32_t RTC_TimeStampEdge, uint32_t RTC_TimeStampPin);
