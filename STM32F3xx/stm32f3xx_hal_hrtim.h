...
/** @defgroup HRTIM_Timer_External_Event_Filter HRTIM Timer External Event Filter
  ...
  *        by a timer
  */
#define HRTIM_TIMEVENTFILTER_NONE             (0x00000000UL)
...
/** @defgroup HRTIM_External_Event_Sources HRTIM External Event Sources
  ...
  */
#define HRTIM_EVENTSRC_1         (0x00000000UL)                                  /*!< External event source 1U */
...
#define HRTIM_CALIBRATIONRATE_7300  0x00000000UL                                    /*!< Periodic DLL calibration: T = 1048576U * tHRTIM (7.300 ms) */
...
#define IS_HRTIM_TIMERID(TIMERID) (((TIMERID) & 0xFFC0FFFFUL) == 0x00000000UL)
...
#define IS_HRTIM_OUTPUT(OUTPUT) (((OUTPUT) & 0xFFFFFC00UL) == 0x00000000UL)
...
#define IS_HRTIM_TIMFAULTENABLE(TIMFAULTENABLE) (((TIMFAULTENABLE) & 0xFFFFFFE0UL) == 0x00000000UL)
...
#define IS_HRTIM_TIMUPDATETRIGGER(TIMUPDATETRIGGER) (((TIMUPDATETRIGGER) & 0xFE07FFFFUL) == 0x00000000UL)

#define IS_HRTIM_TIMRESETTRIGGER(TIMRESETTRIGGER) (((TIMRESETTRIGGER) & 0x80000001UL) == 0x00000000UL)
...
#define IS_HRTIM_TIMER_BURSTDMA(TIMER, BURSTDMA)                                            \
  ...
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((BURSTDMA) & 0xFFE00000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((BURSTDMA) & 0xFFE00000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((BURSTDMA) & 0xFFE00000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((BURSTDMA) & 0xFFE00000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((BURSTDMA) & 0xFFE00000UL) == 0x00000000UL)))

#define IS_HRTIM_BURSTMODECTL(BURSTMODECTL) \
    (((BURSTMODECTL) == HRTIM_BURSTMODECTL_DISABLED)  || \
     ((BURSTMODECTL) == HRTIM_BURSTMODECTL_ENABLED))

#define IS_HRTIM_TIMERUPDATE(TIMERUPDATE) (((TIMERUPDATE) & 0xFFFFFFC0UL) == 0x00000000UL)

#define IS_HRTIM_TIMERRESET(TIMERRESET) (((TIMERRESET) & 0xFFFFC0FFUL) == 0x00000000UL)

#define IS_HRTIM_IT(IT) (((IT) & 0xFFFCFFC0UL) == 0x00000000UL)
...
/** @brief  Sets the HRTIM timer Counter Register value on runtime
  ...
  *                   This parameter can be one of the following values:
  *                   @arg 0x5U for master timer
  *                   @arg 0x0U to 0x4U for timers A to E
