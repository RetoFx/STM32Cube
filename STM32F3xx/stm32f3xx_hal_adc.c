        ...
        (++) For STM32F30x/STM32F33x devices:
             ...
             or asynchronous clock derived from ADC dedicated PLL 72MHz.
              - Synchronous clock is mandatory since used as ADC core clock.
                ...
                Synchronous clock is configured using macro __HAL_RCC_ADCx_CLK_ENABLE().
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef * const hadc)
{
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_ADC_MspInit(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_ADC_MspDeInit(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
HAL_StatusTypeDef HAL_ADC_RegisterCallback(ADC_HandleTypeDef * const hadc, HAL_ADC_CallbackIDTypeDef CallbackID, pADC_CallbackTypeDef pCallback)
{
  ...
  if ((hadc->State & HAL_ADC_STATE_READY) != 0U)
  {
    switch (CallbackID)
    {
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_Start(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval HAL status.
  */
__weak HAL_StatusTypeDef HAL_ADC_Stop(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_PollForConversion(ADC_HandleTypeDef * const hadc, uint32_t Timeout)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
  UNUSED(Timeout);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_PollForEvent(ADC_HandleTypeDef * const hadc, uint32_t EventType, uint32_t Timeout)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
  UNUSED(EventType);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_Start_IT(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval HAL status.
  */
__weak HAL_StatusTypeDef HAL_ADC_Stop_IT(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
__weak HAL_StatusTypeDef HAL_ADC_Start_DMA(ADC_HandleTypeDef * const hadc, uint32_t * const pData, uint32_t Length)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
  UNUSED(pData);
...
/**
  ...
  * @retval HAL status.
  */
__weak HAL_StatusTypeDef HAL_ADC_Stop_DMA(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  */
__weak uint32_t HAL_ADC_GetValue(ADC_HandleTypeDef const * const hadc)
{
  /* Note : This function is defined into this file for library reference. */
  /*        Function content is located into file stm32f3xx_hal_adc_ex.c   */
...
/**
  ...
  * @retval None
  */
__weak void HAL_ADC_IRQHandler(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADC_WEAK_CALLBACK(void, HAL_ADC_ConvCpltCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADC_WEAK_CALLBACK(void, HAL_ADC_ConvHalfCpltCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADC_WEAK_CALLBACK(void, HAL_ADC_LevelOutOfWindowCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADC_WEAK_CALLBACK(void, HAL_ADC_ErrorCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef * const hadc, ADC_ChannelConfTypeDef const * const sConfig)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
  UNUSED(sConfig);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef * const hadc, ADC_AnalogWDGConfTypeDef const * const AnalogWDGConfig)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
