...
/* Private function prototypes -----------------------------------------------*/
    ...
    defined(STM32F303x8) || defined(STM32F334x8) || defined(STM32F328xx) || \
    defined(STM32F301x8) || defined(STM32F302x8) || defined(STM32F318xx)
static HAL_StatusTypeDef ADC_Enable(ADC_HandleTypeDef * const hadc);
static HAL_StatusTypeDef ADC_Disable(ADC_HandleTypeDef * const hadc);
static HAL_StatusTypeDef ADC_ConversionStop(ADC_HandleTypeDef * const hadc, uint32_t ConversionGroup);
#endif /* STM32F302xE || STM32F303xE || STM32F398xx || */
       /* STM32F302xC || STM32F303xC || STM32F358xx || */
       /* STM32F303x8 || STM32F334x8 || STM32F328xx || */
       /* STM32F301x8 || STM32F302x8 || STM32F318xx    */
...
#if defined(STM32F373xC) || defined(STM32F378xx)
static HAL_StatusTypeDef ADC_Enable(ADC_HandleTypeDef * const hadc);
static HAL_StatusTypeDef ADC_ConversionStop_Disable(ADC_HandleTypeDef * const hadc);
#endif /* STM32F373xC || STM32F378xx */

static void ADC_DMAConvCplt(DMA_HandleTypeDef * const hdma);
static void ADC_DMAHalfConvCplt(DMA_HandleTypeDef * const hdma);
static void ADC_DMAError(DMA_HandleTypeDef * const hdma);
...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef * const hadc)
{
    ...
    HAL_ADC_MspInit(hadc);
      ...
      if (HAL_IS_BIT_CLR(hadc->Instance->CR, ADC_CR_ADVREGEN_0))
      {
            ...
            (tmp_hal_status == HAL_OK)                                  )
        {
          ...
          wait_loop_index = (ADC_STAB_DELAY_US * (SystemCoreClock / 1000000UL));
      ...
      (ADC_IS_CONVERSION_ONGOING_REGULAR(hadc) == RESET)          )
  {
    ...
    /*   0x00U: 1 channel converted (channel on regular rank 1U)                */
...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef * const hadc)
{
      ...
      (tmp_hal_status == HAL_OK)                                  )
  {
    ...
    /*   conversions is forced to 0x00U for alignment over all STM32 devices.  */
    /* - if scan mode is enabled, regular channels sequence length is set to  */
    /*   parameter "NbrOfConversion"                                          */
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef * const hadc)
{
  ...
  if (tmp_hal_status == HAL_OK)
  {
    ...
    /* function "void HAL_ADC_MspInit(ADC_HandleTypeDef * const hadc)":              */
    /*                                                                        */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_Calibration_Start(ADC_HandleTypeDef * const hadc, uint32_t SingleDiff)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_Calibration_Start(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  uint32_t tickstart;
  __IO uint32_t wait_loop_index = 0U;
...
/**
  ...
  */
uint32_t HAL_ADCEx_Calibration_GetValue(ADC_HandleTypeDef const * const hadc, uint32_t SingleDiff)
{
  /* Check the parameters */
  assert_param(IS_ADC_ALL_INSTANCE(hadc->Instance));
  assert_param(IS_ADC_SINGLE_DIFFERENTIAL(SingleDiff));
...
/**
  ...
  * @retval HAL state
  */
HAL_StatusTypeDef HAL_ADCEx_Calibration_SetValue(ADC_HandleTypeDef * const hadc, uint32_t SingleDiff, uint32_t CalibrationFactor)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedStop(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef * const hadc, uint32_t Timeout)
{
  uint32_t tickstart;
  uint32_t tmp_Flag_EOC;
  uint32_t tmp_cfgr = 0x00000000UL;
...
/**
  ...
  * @retval HAL status.
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedStart_IT(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedStop_IT(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef * const hadc, uint32_t * const pData, uint32_t Length)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_MultiModeStop_DMA(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  uint32_t tickstart;
  ADC_HandleTypeDef tmphadcSlave = {0};
...
/**
  ...
  */
uint32_t HAL_ADCEx_MultiModeGetValue(ADC_HandleTypeDef const * const hadc)
{
  ADC_Common_TypeDef *tmpADC_Common;
...
/**
  ...
  */
uint32_t HAL_ADCEx_InjectedGetValue(ADC_HandleTypeDef const * const hadc, uint32_t InjectedRank)
{
  uint32_t tmp_jdr = 0U;
...
/**
  ...
  * @retval HAL status.
  */
HAL_StatusTypeDef HAL_ADCEx_RegularStop(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
HAL_StatusTypeDef HAL_ADCEx_RegularStop_IT(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
HAL_StatusTypeDef HAL_ADCEx_RegularStop_DMA(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_RegularMultiModeStop_DMA(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  uint32_t tickstart;
  ADC_HandleTypeDef tmphadcSlave = {0};
...
/**
  ...
  * @retval None
  */
HAL_ADCEX_WEAK_CALLBACK(void, HAL_ADCEx_InjectedConvCpltCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADCEX_WEAK_CALLBACK(void, HAL_ADCEx_InjectedQueueOverflowCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADCEX_WEAK_CALLBACK(void, HAL_ADCEx_LevelOutOfWindow2Callback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval None
  */
HAL_ADCEX_WEAK_CALLBACK(void, HAL_ADCEx_LevelOutOfWindow3Callback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
       ...
       )
    {
            ...
            (ADC_IS_ENABLE(&tmphadcSharingSameCommonRegister) == RESET)   )   )
      {
        ...
        if ((sConfig->Channel == ADC_CHANNEL_TEMPSENSOR) && (hadc->Instance == ADC1))
        {
          ...
          /* Delay for temperature sensor stabilization time */
          /* Compute number of CPU cycles to wait for */
          wait_loop_index = (ADC_TEMPSENSOR_DELAY_US * (SystemCoreClock / 1000000UL));
          while(wait_loop_index != 0U)
          {
            wait_loop_index--;
          }
...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef * const hadc, ADC_InjectionConfTypeDef const * const sConfigInjected)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ADC_Common_TypeDef *tmpADC_Common;
  ADC_HandleTypeDef tmphadcSharingSameCommonRegister;
  ...
  /*    * Injected channels sequence length is set to 0x00U: 1 channel         */
  ...
  else
  {
    ...
    if (hadc->InjectionConfig.ChannelCount == 0U)
    {
      ...
      hadc->InjectionConfig.ContextQueue = 0x00000000UL;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef * const hadc, ADC_MultiModeTypeDef const * const multimode)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ADC_Common_TypeDef *tmpADC_Common;
  ADC_HandleTypeDef tmphadcSharingSameCommonRegister;
...
static void ADC_DMAConvCplt(DMA_HandleTypeDef * const hdma)
{
  ...
  ADC_HandleTypeDef * const hadc = ( ADC_HandleTypeDef * )((DMA_HandleTypeDef * )hdma)->Parent;
