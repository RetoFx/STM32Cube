...
typedef enum
{
  HAL_OPAMP_STATE_RESET               = 0x00000000UL, /*!< OPMAP is not yet Initialized          */
...
#define OPAMP_NONINVERTINGINPUT_IO1         (0x00000000UL)           /*!< VP1 (PA7 for OPAMP1, VP3 PD14 for OPAMP2, VP1 PB13 for OPAMP3, VP1 PD11 for OPAMP4)
                                                                                  connected to OPAMPx non inverting input */
...
#define OPAMP_INVERTINGINPUT_IO0         (0x00000000UL)               /*!< inverting input connected to VM0 */
...
#define OPAMP_SEC_NONINVERTINGINPUT_IO0          OPAMP_CSR_VPSSEL       /*!< VP0 (PA1 for OPAMP1, PA7 for OPAMP2, PB0 for OPAMP3, PB13 for OPAMP4)
                                                                              connected to OPAMPx non inverting input */
#define OPAMP_SEC_NONINVERTINGINPUT_IO1          (0x00000000UL)          /*!< VP1 (PA7 for OPAMP1, PD14 for OPAMP2, PB13 for OPAMP3, PD11 for OPAMP4)
                                                                             connected to OPAMPx non inverting input */
...
#define OPAMP_SEC_INVERTINGINPUT_IO0          (0x00000000UL)            /*!< VM0 (PC5 for OPAMP1 and OPAMP2, PB10 for OPAMP3 and OPAMP4)
...
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_NO               (0x00000000UL)                             /*!< In PGA mode, the non inverting input is not connected */
...
#define OPAMP_PGA_GAIN_2                (0x00000000UL)                                 /*!< PGA gain =  2 */
...
#define OPAMP_VREF_3VDDA                     (0x00000000UL)          /*!< OPMAP Vref = 3.3U% VDDA */
...
#define OPAMP_VREF_NOTCONNECTEDTO_ADC          (0x00000000UL) /*!< VREF not connected to ADC */
#define OPAMP_VREF_CONNECTEDTO_ADC             (0x00000001UL) /*!< VREF not connected to ADC */
...
OPAMP_TrimmingValueTypeDef HAL_OPAMP_GetTrimOffset(OPAMP_HandleTypeDef const * const hopamp, uint32_t trimmingoffset);
