...
/**
  ...
  * @retval The selected DAC channel data output value.
  */
__weak uint32_t HAL_DACEx_DualGetValue(DAC_HandleTypeDef const * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
__weak HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef * const hdac, DAC_ChannelConfTypeDef const * const sConfig, uint32_t Channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(sConfig);
...
__weak HAL_StatusTypeDef HAL_DACEx_DualSetValue(DAC_HandleTypeDef * const hdac, uint32_t Alignment, uint32_t Data1, uint32_t Data2)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Alignment);
