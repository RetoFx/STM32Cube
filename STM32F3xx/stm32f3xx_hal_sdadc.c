    ...
    *** Initialization ***
    ...
    [..]
      (#) As prerequisite, fill in the HAL_SDADC_MspInit() :
        (++) Enable SDADCx clock interface with __HAL_RCC_SDADCx_CLK_ENABLE().
...
static HAL_StatusTypeDef SDADC_EnterInitMode(SDADC_HandleTypeDef * const hsdadc);
static void              SDADC_ExitInitMode(SDADC_HandleTypeDef * const hsdadc);
static uint32_t          SDADC_GetInjChannelsNbr(uint32_t Channels);
static HAL_StatusTypeDef SDADC_RegConvStart(SDADC_HandleTypeDef * const hsdadc);
static HAL_StatusTypeDef SDADC_RegConvStop(SDADC_HandleTypeDef * const hsdadc);
static HAL_StatusTypeDef SDADC_InjConvStart(SDADC_HandleTypeDef * const hsdadc);
static HAL_StatusTypeDef SDADC_InjConvStop(SDADC_HandleTypeDef * const hsdadc);
static void              SDADC_DMARegularHalfConvCplt(DMA_HandleTypeDef * const hdma);
static void              SDADC_DMARegularConvCplt(DMA_HandleTypeDef * const hdma);
static void              SDADC_DMAInjectedHalfConvCplt(DMA_HandleTypeDef * const hdma);
static void              SDADC_DMAInjectedConvCplt(DMA_HandleTypeDef * const hdma);
static void              SDADC_DMAError(DMA_HandleTypeDef * const hdma);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_SDADC_MspInit(SDADC_HandleTypeDef * const hsdadc)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SDADC_MspDeInit(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_MultiModeConfigChannel(SDADC_HandleTypeDef * const hsdadc,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_InjectedMultiModeConfigChannel(SDADC_HandleTypeDef * const hsdadc,
                                                           uint32_t MultimodeType)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_CalibrationStart(SDADC_HandleTypeDef * const hsdadc,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_CalibrationStart_IT(SDADC_HandleTypeDef * const hsdadc,
                                                uint32_t CalibrationSequence)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_Start_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData,
                                      uint32_t Length)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_PollForInjectedConversion(SDADC_HandleTypeDef * const hsdadc,
                                                      uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_InjectedStart_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData,
                                              uint32_t Length)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_MultiModeStart_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData,
                                               uint32_t Length)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDADC_InjectedMultiModeStart_DMA(SDADC_HandleTypeDef * const hsdadc,
                                                       uint32_t * const pData, uint32_t Length)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_CalibrationCpltCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_ConvHalfCpltCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_ConvCpltCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_InjectedConvHalfCpltCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_InjectedConvCpltCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
/**
  ...
  * @retval None
  */
HAL_SDADC_WEAK_CALLBACK(void, HAL_SDADC_ErrorCallback)(SDADC_HandleTypeDef * const hsdadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsdadc);
...
{
  /* Get SDADC handle */
  SDADC_HandleTypeDef * const hsdadc = (SDADC_HandleTypeDef *) ((DMA_HandleTypeDef *)hdma)->Parent;
