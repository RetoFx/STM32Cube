...
typedef struct __SDADC_HandleTypeDef
{
  ...
  void (* ConvHalfCpltCallback)(struct __SDADC_HandleTypeDef * const hadc);            /*!< SDADC half regular conversion complete callback */
  void (* ConvCpltCallback)(struct __SDADC_HandleTypeDef * const hadc);                /*!< SDADC regular conversion complete callback */
  void (* InjectedConvHalfCpltCallback)(struct __SDADC_HandleTypeDef * const hadc);    /*!< SDADC half injected conversion complete callback */
  void (* InjectedConvCpltCallback)(struct __SDADC_HandleTypeDef * const hadc);        /*!< SDADC injected conversion complete callback */
  void (* CalibrationCpltCallback)(struct __SDADC_HandleTypeDef * const hadc);         /*!< SDADC calibration callback */
  void (* ErrorCallback)(struct __SDADC_HandleTypeDef * const hadc);                   /*!< SDADC error callback */
  void (* MspInitCallback)(struct __SDADC_HandleTypeDef * const hadc);                 /*!< SDADC Msp Init callback */
  void (* MspDeInitCallback)(struct __SDADC_HandleTypeDef * const hadc);               /*!< SDADC Msp DeInit callback */
...
typedef struct
{
  ...
  uint32_t Offset;         /*!< Specifies the 12-bit offset value.
                                This parameter can be any value lower or equal to 0x00000FFFUL */
...
/**
  ...
  */
typedef  void (*pSDADC_CallbackTypeDef)(SDADC_HandleTypeDef * const hsdadc); /*!< pointer to a SDADC callback function */
...
#define SDADC_CONF_INDEX_1                     (0x00000001UL) /*!< Configuration 1 Register selected */
#define SDADC_CONF_INDEX_2                     (0x00000002UL) /*!< Configuration 2 Register selected */
/**
  * @}
  */
...
#define SDADC_GAIN_8                         (0x00300000UL)  /*!< Gain equal to 8U */
#define SDADC_GAIN_16                        SDADC_CONF0R_GAIN0_2    /*!< Gain equal to 16U */
#define SDADC_GAIN_32                        (0x00500000UL)  /*!< Gain equal to 32U */
...
#define SDADC_MULTIMODE_SDADC1_SDADC3        (0x00000001UL) /*!< Get conversion values for SDADC1 and SDADC3 */
/**
  * @}
  */
...
#define IS_SDADC_OFFSET_VALUE(VALUE) ((VALUE) <= 0x00000FFFUL)
...
#define IS_SDADC_INJECTED_CHANNEL(CHANNEL) (((CHANNEL) != 0U) && ((CHANNEL) <= 0x000F01FFUL))
...
HAL_StatusTypeDef HAL_SDADC_Init(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_DeInit(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_MspInit(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_MspDeInit(SDADC_HandleTypeDef * const hsdadc);
...
HAL_StatusTypeDef HAL_SDADC_PrepareChannelConfig(SDADC_HandleTypeDef * const hsdadc,
                                                 uint32_t ConfIndex,
                                                 SDADC_ConfParamTypeDef * const ConfParamStruct);
HAL_StatusTypeDef HAL_SDADC_AssociateChannelConfig(SDADC_HandleTypeDef * const hsdadc,
                                                   uint32_t Channel,
                                                   uint32_t ConfIndex);
HAL_StatusTypeDef HAL_SDADC_ConfigChannel(SDADC_HandleTypeDef * const hsdadc,
                                          uint32_t Channel,
                                          uint32_t ContinuousMode);
HAL_StatusTypeDef HAL_SDADC_InjectedConfigChannel(SDADC_HandleTypeDef * const hsdadc,
                                                  uint32_t Channel,
                                                  uint32_t ContinuousMode);
HAL_StatusTypeDef HAL_SDADC_SelectInjectedExtTrigger(SDADC_HandleTypeDef * const hsdadc,
                                                     uint32_t InjectedExtTrigger,
                                                     uint32_t ExtTriggerEdge);
HAL_StatusTypeDef HAL_SDADC_SelectInjectedDelay(SDADC_HandleTypeDef * const hsdadc,
                                                uint32_t InjectedDelay);
HAL_StatusTypeDef HAL_SDADC_SelectRegularTrigger(SDADC_HandleTypeDef * const hsdadc, uint32_t Trigger);
HAL_StatusTypeDef HAL_SDADC_SelectInjectedTrigger(SDADC_HandleTypeDef * const hsdadc, uint32_t Trigger);
HAL_StatusTypeDef HAL_SDADC_MultiModeConfigChannel(SDADC_HandleTypeDef * const hsdadc, uint32_t MultimodeType);
HAL_StatusTypeDef HAL_SDADC_InjectedMultiModeConfigChannel(SDADC_HandleTypeDef * const hsdadc, uint32_t MultimodeType);
...
HAL_StatusTypeDef HAL_SDADC_CalibrationStart(SDADC_HandleTypeDef * const hsdadc, uint32_t CalibrationSequence);
HAL_StatusTypeDef HAL_SDADC_CalibrationStart_IT(SDADC_HandleTypeDef * const hsdadc, uint32_t CalibrationSequence);

HAL_StatusTypeDef HAL_SDADC_Start(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_Start_IT(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_Start_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData, uint32_t Length);
HAL_StatusTypeDef HAL_SDADC_Stop(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_Stop_IT(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_Stop_DMA(SDADC_HandleTypeDef * const hsdadc);

HAL_StatusTypeDef HAL_SDADC_InjectedStart(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_InjectedStart_IT(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_InjectedStart_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData, uint32_t Length);
HAL_StatusTypeDef HAL_SDADC_InjectedStop(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_InjectedStop_IT(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_InjectedStop_DMA(SDADC_HandleTypeDef * const hsdadc);

HAL_StatusTypeDef HAL_SDADC_MultiModeStart_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData, uint32_t Length);
HAL_StatusTypeDef HAL_SDADC_MultiModeStop_DMA(SDADC_HandleTypeDef * const hsdadc);
HAL_StatusTypeDef HAL_SDADC_InjectedMultiModeStart_DMA(SDADC_HandleTypeDef * const hsdadc, uint32_t * const pData, uint32_t Length);
HAL_StatusTypeDef HAL_SDADC_InjectedMultiModeStop_DMA(SDADC_HandleTypeDef * const hsdadc);

uint32_t HAL_SDADC_GetValue(SDADC_HandleTypeDef const * const hsdadc);
uint32_t HAL_SDADC_InjectedGetValue(SDADC_HandleTypeDef * const hsdadc, uint32_t * const Channel);
uint32_t HAL_SDADC_MultiModeGetValue(SDADC_HandleTypeDef * const hsdadc);
uint32_t HAL_SDADC_InjectedMultiModeGetValue(SDADC_HandleTypeDef * const hsdadc);

void HAL_SDADC_IRQHandler(SDADC_HandleTypeDef * const hsdadc);

HAL_StatusTypeDef HAL_SDADC_PollForCalibEvent(SDADC_HandleTypeDef * const hsdadc, uint32_t Timeout);
HAL_StatusTypeDef HAL_SDADC_PollForConversion(SDADC_HandleTypeDef * const hsdadc, uint32_t Timeout);
HAL_StatusTypeDef HAL_SDADC_PollForInjectedConversion(SDADC_HandleTypeDef * const hsdadc, uint32_t Timeout);

void HAL_SDADC_CalibrationCpltCallback(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_ConvHalfCpltCallback(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_ConvCpltCallback(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_InjectedConvHalfCpltCallback(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_InjectedConvCpltCallback(SDADC_HandleTypeDef * const hsdadc);
void HAL_SDADC_ErrorCallback(SDADC_HandleTypeDef * const hsdadc);
...
HAL_SDADC_StateTypeDef HAL_SDADC_GetState(SDADC_HandleTypeDef const * const hsdadc);
uint32_t               HAL_SDADC_GetError(SDADC_HandleTypeDef const * const hsdadc);
