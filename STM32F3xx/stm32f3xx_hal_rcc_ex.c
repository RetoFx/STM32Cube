...
/**
  ...
  * @note   Returns 0 if peripheral clock is unknown or 0xDEADDEADUL if not applicable.
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
  ...
  static uint16_t const adc_pll_prediv_table[16U] = { 1U,  2U,  4U,  6U, 8U, 10U, 12U, 16U, 32U, 64U, 128U, 256U, 256U, 256U, 256U, 256U};
#endif /* RCC_CFGR2_ADC1PRES || RCC_CFGR2_ADCPRE12 || RCC_CFGR2_ADCPRE34 */
#if defined(RCC_CFGR_SDPRE)
  static uint8_t const sdadc_prescaler_table[16U] = { 2U,  4U,  6U, 8U, 10U, 12U, 14U, 16U, 20U, 24U, 28U, 32U, 36U, 40U, 44U, 48U};
  ...
  case RCC_PERIPHCLK_ADC12:
    {
      ...
      else
      {
        ...
        if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLLRDY))
        {
          ...
          frequency = RCC_GetPLLCLKFreq() / adc_pll_prediv_table[(srcclk >> RCC_CFGR2_ADCPRE12_Pos) & 0xFU];
        }
      }
      break;
    }
  ...
  case RCC_PERIPHCLK_ADC34:
    {
      ...
      else
      {
        ...
        {
          /* Frequency is the PLL frequency divided by ADC prescaler (1U/2U/4U/6U/8U/10U/12U/16U/32U/64U/128U/256U) */
          frequency = RCC_GetPLLCLKFreq() / adc_pll_prediv_table[(srcclk >> RCC_CFGR2_ADCPRE34_Pos) & 0xFU];
        }
      }
      break;
    }
  ...
  case RCC_PERIPHCLK_SDADC:
    {
      ...
      frequency = SystemCoreClock / sdadc_prescaler_table[(srcclk >> RCC_CFGR_SDPRE_Pos) & 0xFU];
      break;
    }
#endif /* RCC_CFGR_SDPRE */
