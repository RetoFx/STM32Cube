...
/** @defgroup DACEx_Private_Functions DACEx Private Functions
  * @{
  */
static void DAC_DMAConvCpltCh1(DMA_HandleTypeDef * const hdma);
static void DAC_DMAErrorCh1(DMA_HandleTypeDef * const hdma);
static void DAC_DMAHalfConvCpltCh1(DMA_HandleTypeDef * const hdma);
...
static void DAC_DMAConvCpltCh2(DMA_HandleTypeDef * const hdma);
static void DAC_DMAErrorCh2(DMA_HandleTypeDef * const hdma);
static void DAC_DMAHalfConvCpltCh2(DMA_HandleTypeDef * const hdma);
...
/**
  ...
  * @retval None
  */
void HAL_DAC_IRQHandler(struct __DAC_HandleTypeDef * const hdac)
{
