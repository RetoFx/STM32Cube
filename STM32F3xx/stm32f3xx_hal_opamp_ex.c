...
HAL_StatusTypeDef HAL_OPAMPEx_SelfCalibrateAll(OPAMP_HandleTypeDef * const hopamp1, OPAMP_HandleTypeDef * const hopamp2, OPAMP_HandleTypeDef * const hopamp3, OPAMP_HandleTypeDef * const hopamp4)
{
  HAL_StatusTypeDef status = HAL_OK;
