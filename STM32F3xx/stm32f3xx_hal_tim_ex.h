...
/** @defgroup TIMEx_Remap TIM Extended Remapping
  ...
  */
#if defined(TIM1)
#define TIM_TIM1_ADC1_NONE                     (0x00000000UL) /*!< TIM1_ETR is not connected to any AWD (analog watchdog)*/
#define TIM_TIM1_ADC1_AWD1                     (0x00000001UL) /*!< TIM1_ETR is connected to ADC1 AWD1 */
#define TIM_TIM1_ADC1_AWD2                     (0x00000002UL) /*!< TIM1_ETR is connected to ADC1 AWD2 */
#define TIM_TIM1_ADC1_AWD3                     (0x00000003UL) /*!< TIM1_ETR is connected to ADC1 AWD3 */

#if defined(ADC4)
#define TIM_TIM1_ADC4_NONE                     (0x00000000UL) /*!< TIM1_ETR is not connected to any AWD (analog watchdog)*/
#define TIM_TIM1_ADC4_AWD1                     (0x00000004UL) /*!< TIM1_ETR is connected to ADC4 AWD1 */
#define TIM_TIM1_ADC4_AWD2                     (0x00000008UL) /*!< TIM1_ETR is connected to ADC4 AWD2 */
#define TIM_TIM1_ADC4_AWD3                     (0x0000000CUL) /*!< TIM1_ETR is connected to ADC4 AWD3 */
#elif defined(ADC2)
#define TIM_TIM1_ADC2_NONE                     (0x00000000UL) /*!< TIM1_ETR is not connected to any AWD (analog watchdog)*/
#define TIM_TIM1_ADC2_AWD1                     (0x00000004UL) /*!< TIM1_ETR is connected to ADC2 AWD1 */
#define TIM_TIM1_ADC2_AWD2                     (0x00000008UL) /*!< TIM1_ETR is connected to ADC2 AWD2 */
#define TIM_TIM1_ADC2_AWD3                     (0x0000000CUL) /*!< TIM1_ETR is connected to ADC2 AWD3 */
#endif /* ADC4 */
#endif /* TIM1 */

#if defined(TIM8)
#define TIM_TIM8_ADC2_NONE                     (0x00000000UL) /*!< TIM8_ETR is not connected to any AWD (analog watchdog) */
#define TIM_TIM8_ADC2_AWD1                     (0x00000001UL) /*!< TIM8_ETR is connected to ADC2 AWD1 */
#define TIM_TIM8_ADC2_AWD2                     (0x00000002UL) /*!< TIM8_ETR is connected to ADC2 AWD2 */
#define TIM_TIM8_ADC2_AWD3                     (0x00000003UL) /*!< TIM8_ETR is connected to ADC2 AWD3 */

#define TIM_TIM8_ADC3_NONE                     (0x00000000UL) /*!< TIM8_ETR is not connected to any AWD (analog watchdog) */
#define TIM_TIM8_ADC3_AWD1                     (0x00000004UL) /*!< TIM8_ETR is connected to ADC3 AWD1 */
#define TIM_TIM8_ADC3_AWD2                     (0x00000008UL) /*!< TIM8_ETR is connected to ADC3 AWD2 */
#define TIM_TIM8_ADC3_AWD3                     (0x0000000CUL) /*!< TIM8_ETR is connected to ADC3 AWD3 */
#endif /* TIM8 */

#if defined(TIM14)
#define TIM_TIM14_GPIO                         (0x00000000UL) /*!< TIM14 TI1 is connected to GPIO */
#define TIM_TIM14_RTC                          (0x00000001UL) /*!< TIM14 TI1 is connected to RTC_clock */
#define TIM_TIM14_HSE                          (0x00000002UL) /*!< TIM14 TI1 is connected to HSE/32U */
#define TIM_TIM14_MCO                          (0x00000003UL) /*!< TIM14 TI1 is connected to MCO */
#endif /* TIM14 */

#if defined(TIM16)
#define TIM_TIM16_GPIO                         (0x00000000UL) /*!< TIM16 TI1 is connected to GPIO */
#define TIM_TIM16_RTC                          (0x00000001UL) /*!< TIM16 TI1 is connected to RTC_clock */
#define TIM_TIM16_HSE                          (0x00000002UL) /*!< TIM16 TI1 is connected to HSE/32 */
#define TIM_TIM16_MCO                          (0x00000003UL) /*!< TIM16 TI1 is connected to MCO */
#endif /* TIM16 */

#if defined(TIM20)
#define TIM_TIM20_ADC3_NONE                    (0x00000000UL) /*!< TIM20_ETR is not connected to any AWD (analog watchdog) */
#define TIM_TIM20_ADC3_AWD1                    (0x00000001UL) /*!< TIM20_ETR is connected to ADC3 AWD1 */
#define TIM_TIM20_ADC3_AWD2                    (0x00000002UL) /*!< TIM20_ETR is connected to ADC3 AWD2 */
#define TIM_TIM20_ADC3_AWD3                    (0x00000003UL) /*!< TIM20_ETR is connected to ADC3 AWD3 */

#define TIM_TIM20_ADC4_NONE                    (0x00000000UL) /*!< TIM20_ETR is not connected to any AWD (analog watchdog) */
#define TIM_TIM20_ADC4_AWD1                    (0x00000004UL) /*!< TIM20_ETR is connected to ADC4 AWD1 */
#define TIM_TIM20_ADC4_AWD2                    (0x00000008UL) /*!< TIM20_ETR is connected to ADC4 AWD2 */
#define TIM_TIM20_ADC4_AWD3                    (0x0000000CUL) /*!< TIM20_ETR is connected to ADC4 AWD3 */
#endif /* TIM20 */
/**
  * @}
  */
...
#define IS_TIM_REMAP(__INSTANCE__, __REMAP__)                                        \
  ((((__INSTANCE__) == TIM1)  && ((((__REMAP__) & 0xFFFFFFF0UL) == 0x00000000UL)))     \
   || (((__INSTANCE__) == TIM8)  && ((((__REMAP__) & 0xFFFFFFF0UL) == 0x00000000UL)))  \
   || (((__INSTANCE__) == TIM20) && ((((__REMAP__) & 0xFFFFFFF0UL) == 0x00000000UL)))  \
   || (((__INSTANCE__) == TIM16) && ((((__REMAP__) & 0xFFFFFFFCUL) == 0x00000000UL))))
...
#elif defined(TIM14)
#define IS_TIM_REMAP(__INSTANCE__, __REMAP__)                                        \
  (((__INSTANCE__) == TIM14)  && (((__REMAP__) & 0xFFFFFFFCUL) == 0x00000000UL))
