...
static uint8_t const REG_OFFSET_TAB_ADCxR[] =
{
  0x00U,   /* 0: HRTIM_ADC1R */
  0x04U,   /* 1: HRTIM_ADC2R */
  0x08U,   /* 2: HRTIM_ADC3R */
...
static uint32_t const REG_MASK_TAB_UPDATETRIG[] =
{
  ...
  0x01FE0000UL,  /* 1: TIMER A */
  0x01FE0000UL,  /* 2: TIMER B */
  0x01FE0000UL,  /* 3: TIMER C */
  0x01FE0000UL,  /* 4: TIMER D */
  0x01FE0000UL   /* 5: TIMER E */
};
...
/** @defgroup HRTIM_LL_EC_CALIBRATIONRATE  DLL CALIBRATION RATE
  ...
  */
#define LL_HRTIM_DLLCALIBRATION_RATE_7300      0x00000000UL                                    /*!< Periodic DLL calibration: T = 1048576U * tHRTIM (7.300 ms) */
...
/** @defgroup HRTIM_LL_EC_CAPTURETRIG  CAPTURE TRIGGER
  ...
  */
#define LL_HRTIM_CAPTURETRIG_NONE         ((uint32_t)0x00000000UL)/*!< Capture trigger is disabled */
...
/** @defgroup HRTIM_LL_EC_CROSSBAR_INPUT CROSSBAR INPUT
  ...
  */
#define LL_HRTIM_CROSSBAR_NONE       0x00000000UL             /*!< Reset the output set crossbar */
...
/** @defgroup HRTIM_LL_EC_EE_SRC EXTERNAL EVENT SOURCE
  ...
  */
#define LL_HRTIM_EE_SRC_1         0x00000000UL                                    /*!< External event source 1 (EExSrc1)*/
...
{
  uint32_t const shift = ((3U * ADCTrig) & 0x1FU);
...
/**
  ...
  *         @arg @ref LL_HRTIM_CAPTURETRIG_TIME_CMP2
  */
__STATIC_INLINE uint32_t LL_HRTIM_TIM_GetCaptureTrig(HRTIM_TypeDef const * const HRTIMx, uint32_t Timer, uint32_t CaptureUnit)
{
  uint32_t iTimer = (uint8_t)(POSITION_VAL(Timer) - HRTIM_MCR_TACEN_Pos);
...
/** @defgroup HRTIM_LL_LL_EF_Init In-initialization and de-initialization functions
  * @{
  */
ErrorStatus LL_HRTIM_DeInit(HRTIM_TypeDef * const HRTIMx);
/**
  * @}
  */
