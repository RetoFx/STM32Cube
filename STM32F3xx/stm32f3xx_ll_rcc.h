...
#define HSI_VALUE    8000000UL  /*!< Value of the HSI oscillator in Hz */
#endif /* HSI_VALUE */
...
/** @defgroup RCC_LL_EC_LSEDRIVE  LSE oscillator drive capability
  * @{
  */
#define LL_RCC_LSEDRIVE_LOW                ((uint32_t)0x00000000UL) /*!< Xtal mode lower driving capability */
...
/** @defgroup RCC_LL_EC_MCO1_DIV  MCO1 prescaler
  * @{
  */
#define LL_RCC_MCO1_DIV_1                  ((uint32_t)0x00000000UL)/*!< MCO Clock divided by 1 */
...
/** @defgroup RCC_LL_EC_PLLSOURCE PLL SOURCE
  * @{
  */
#define LL_RCC_PLLSOURCE_NONE              0x00000000UL                                   /*!< No clock selected as main PLL entry clock source */
...
{
  MODIFY_REG(RCC->CFGR3, (RCC_CFGR3_USART1SW << ((USARTxSource  & 0xFF000000UL) >> 24U)), (USARTxSource & 0x00FFFFFFUL));
}
...
{
  MODIFY_REG(RCC->CFGR3, ((UARTxSource  & 0x0000FFFFUL) << 8U), (UARTxSource & (RCC_CFGR3_UART4SW | RCC_CFGR3_UART5SW)));
}
#endif /* RCC_CFGR3_UART4SW || RCC_CFGR3_UART5SW */
...
{
  MODIFY_REG(RCC->CFGR3, ((I2CxSource  & 0xFF000000UL) >> 24U), (I2CxSource & 0x00FFFFFFUL));
}
...
{
  MODIFY_REG(RCC->CFGR3, (RCC_CFGR3_TIM1SW << (TIMxSource >> 27U)), (TIMxSource & 0x03FFFFFFUL));
}
#endif /* RCC_CFGR3_TIMSW */
...
{
#if defined(RCC_CFGR2_ADCPRE34)
  MODIFY_REG(RCC->CFGR2, (ADCxSource >> 16U), (ADCxSource & 0x0000FFFFUL));
#else
