...
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive_DMA(I2S_HandleTypeDef * const hi2s, uint16_t const * const pTxData, uint16_t * const pRxData,
                                                uint16_t Size);
...
void HAL_I2SEx_TxRxHalfCpltCallback(I2S_HandleTypeDef * const hi2s);
void HAL_I2SEx_TxRxCpltCallback(I2S_HandleTypeDef * const hi2s);
/**
  * @}
  */
