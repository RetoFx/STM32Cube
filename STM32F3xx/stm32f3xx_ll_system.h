...
#define SYSCFG_OFFSET_CFGR1    0x00000000UL
#define SYSCFG_OFFSET_CFGR3    0x00000050UL
...
/** @defgroup SYSTEM_LL_EC_SPI1_DMA_RMP_RX SYSCFG SPI1 RX/TX DMA1 request REMAP
  * @{
  */
#define LL_SYSCFG_SPI1RX_RMP_DMA1_CH2    (SYSCFG_CFGR3_SPI1_RX_DMA_RMP << 16U | (uint32_t)0x00000000UL)          /*!< SPI1_RX mapped on DMA1 CH2 */
...
#define LL_SYSCFG_SPI1TX_RMP_DMA1_CH3    (SYSCFG_CFGR3_SPI1_TX_DMA_RMP << 16U | (uint32_t)0x00000000UL)          /*!< SPI1_TX mapped on DMA1 CH3 */
...
/** @defgroup SYSTEM_LL_EC_I2C1_DMA_RMP_RX SYSCFG I2C1 RX/TX DMA1 request REMAP
  * @{
  */
#define LL_SYSCFG_I2C1RX_RMP_DMA1_CH7    (SYSCFG_CFGR3_I2C1_RX_DMA_RMP << 16U | (uint32_t)0x00000000UL)          /*!< I2C1_RX mapped on DMA1 CH7 */
...
#define LL_SYSCFG_I2C1TX_RMP_DMA1_CH6    (SYSCFG_CFGR3_I2C1_TX_DMA_RMP << 16U | (uint32_t)0x00000000UL)          /*!< I2C1_TX mapped on DMA1 CH6 */
...
#define LL_SYSCFG_ADC24_RMP_DMA2_CH12    (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_ADC24_DMA_RMP << 8U | (uint32_t)0x00000000UL)        /*!< ADC24 DMA requests mapped on DMA2 channels 1 and 2 */
...
#define LL_SYSCFG_ADC2_RMP_DMA1_CH2      (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_0 << 8U | (uint32_t)0x00000000UL)       /*!< ADC2 mapped on DMA1 channel 2 */
...
#define LL_SYSCFG_ADC2_RMP_DMA2          (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_ADC2_DMA_RMP_1 << 8U | (uint32_t)0x00000000UL)       /*!< ADC2 mapped on DMA2 */
...
/** @defgroup SYSTEM_LL_EC_DAC1_DMA2_REMAP SYSCFG DAC1/2 DMA1/2 request REMAP
  * @{
  */
#define LL_SYSCFG_DAC1_CH1_RMP_DMA2_CH3     ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) | (uint32_t)0x00000000UL)              /*!< DAC_CH1 DMA requests mapped on DMA2 channel 3 */
...
#define LL_SYSCFG_DAC1_OUT2_RMP_DMA2_CH4    ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) | (uint32_t)0x00000000UL)              /*!< DAC1_OUT2 DMA requests mapped on DMA2 channel 4 */
...
#define LL_SYSCFG_DAC2_OUT1_RMP_DMA2_CH5    ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) | (uint32_t)0x00000000UL)             /*!< DAC2_OUT1 DMA requests mapped on DMA2 channel 5 */
...
#define LL_SYSCFG_DAC2_CH1_RMP_NO           ((SYSCFG_CFGR1_DAC2Ch1_DMA_RMP << 8U) | (uint32_t)0x00000000UL)                  /*!< No remap */
...
/** @defgroup SYSTEM_LL_EC_TIM16_DMA1_REMAP SYSCFG TIM DMA request REMAP
  * @{
  */
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3        ((SYSCFG_CFGR1_TIM16_DMA_RMP << 8U) | (uint32_t)0x00000000UL)                     /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA1 channel 3 */
...
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1        ((SYSCFG_CFGR1_TIM17_DMA_RMP << 8U) | (uint32_t)0x00000000UL)                     /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA1 channel 1 */
...
#define LL_SYSCFG_TIM6_RMP_DMA2_CH3         ((SYSCFG_CFGR1_TIM6DAC1Ch1_DMA_RMP << 8U) | (uint32_t)0x00000000UL)               /*!< TIM6 DMA requests mapped on DMA2 channel 3 */
...
#if defined(SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP)
#define LL_SYSCFG_TIM7_RMP_DMA2_CH4         ((SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP << 8U) | (uint32_t)0x00000000UL)               /*!< TIM7 DMA requests mapped on DMA2 channel 4 */
...
#endif /*SYSCFG_CFGR1_TIM7DAC1Ch2_DMA_RMP*/
#if defined(SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP)
#define LL_SYSCFG_TIM18_RMP_DMA2_CH5        ((SYSCFG_CFGR1_TIM18DAC2Ch1_DMA_RMP << 8U) | (uint32_t)0x00000000UL)              /*!< TIM18 DMA requests mapped on DMA2 channel 5 */
...
#define LL_SYSCFG_TIM1_ITR3_RMP_TIM4_TRGO      ((SYSCFG_CFGR1_TIM1_ITR3_RMP << 8U) | (uint32_t)0x00000000UL)              /*!< TIM1_ITR3 = TIM4_TRGO */
...
#define LL_SYSCFG_TIM15_ENCODEMODE_NOREDIRECTION ((SYSCFG_CFGR1_ENCODER_MODE << 8U) | (uint32_t)0x00000000UL)               /*!< No redirection */
...
/** @defgroup SYSTEM_LL_EC_ADC12_EXT2_RMP_TIM1 SYSCFG ADC Trigger REMAP
  * @{
  */
#define LL_SYSCFG_ADC12_EXT2_RMP_TIM1_CC3      ((SYSCFG_CFGR4_ADC12_EXT2_RMP << 16U) | (uint32_t)0x00000000UL)           /*!< Input trigger of ADC12 regular channel EXT2:Trigger source is TIM1_CC3 */
...
#define LL_SYSCFG_ADC12_EXT3_RMP_TIM2_CC2      ((SYSCFG_CFGR4_ADC12_EXT3_RMP << 16U) | (uint32_t)0x00000000UL)           /*!< Input trigger of ADC12 regular channel EXT3:Trigger source is TIM2_CC2 */
...
#define LL_SYSCFG_ADC12_EXT5_RMP_TIM4_CC4      ((SYSCFG_CFGR4_ADC12_EXT5_RMP << 16U) | (uint32_t)0x00000000UL)           /*!< Input trigger of ADC12 regular channel EXT5:Trigger source is TIM4_CC4 */
...
#define LL_SYSCFG_ADC12_EXT13_RMP_TIM6_TRGO    ((SYSCFG_CFGR4_ADC12_EXT13_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC12 regular channel EXT13:Trigger source is TIM6_TRGO */
...
#define LL_SYSCFG_ADC12_EXT15_RMP_TIM3_CC4     ((SYSCFG_CFGR4_ADC12_EXT15_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC12 regular channel EXT15:Trigger source is TIM3_CC4 */
...
#define LL_SYSCFG_ADC12_JEXT3_RMP_TIM2_CC1     ((SYSCFG_CFGR4_ADC12_JEXT3_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC12 regular channel JEXT3:Trigger source is TIM2_CC1 */
...
#define LL_SYSCFG_ADC12_JEXT6_RMP_EXTI_LINE_15 ((SYSCFG_CFGR4_ADC12_JEXT6_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC12 regular channel JEXT6:Trigger source is EXTI_LINE_15 */
...
#define LL_SYSCFG_ADC12_JEXT13_RMP_TIM3_CC1    ((SYSCFG_CFGR4_ADC12_JEXT13_RMP << 16U) | (uint32_t)0x00000000UL)         /*!< Input trigger of ADC12 regular channel JEXT13:Trigger source is TIM3_CC1 */
...
#define LL_SYSCFG_ADC34_EXT5_RMP_EXTI_LINE_2   ((SYSCFG_CFGR4_ADC34_EXT5_RMP << 16U) | (uint32_t)0x00000000UL)           /*!< Input trigger of ADC34 regular channel EXT5:Trigger source is EXTI_LINE_2 */
...
#define LL_SYSCFG_ADC34_EXT6_RMP_TIM4_CC1      ((SYSCFG_CFGR4_ADC34_EXT6_RMP << 16U) | (uint32_t)0x00000000UL)           /*!< Input trigger of ADC34 regular channel EXT6:Trigger source is TIM4_CC1 */
...
#define LL_SYSCFG_ADC34_EXT15_RMP_TIM2_CC1     ((SYSCFG_CFGR4_ADC34_EXT15_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC34 regular channel EXT15:Trigger source is  TIM2_CC1 */
...
#define LL_SYSCFG_ADC34_JEXT5_RMP_TIM4_CC3     ((SYSCFG_CFGR4_ADC34_JEXT5_RMP << 16U) | (uint32_t)0x00000000UL)          /*!< Input trigger of ADC34 regular channel JEXT5:Trigger source is TIM4_CC3 */
...
#define LL_SYSCFG_ADC34_JEXT11_RMP_TIM1_CC3    ((SYSCFG_CFGR4_ADC34_JEXT11_RMP << 16U) | (uint32_t)0x00000000UL)         /*!< Input trigger of ADC34 regular channel JEXT11:Trigger source is TIM1_CC3 */
...
#define LL_SYSCFG_ADC34_JEXT14_RMP_TIM7_TRGO   ((SYSCFG_CFGR4_ADC34_JEXT14_RMP << 16U) | (uint32_t)0x00000000UL)         /*!< Input trigger of ADC34 regular channel JEXT14:Trigger source is TIM7_TRGO */
...
#define LL_SYSCFG_DAC1_TRIG1_RMP_TIM8_TRGO         (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_DAC1_TRIG1_RMP << 4U | (uint32_t)0x00000000UL)       /*!< No remap: DAC trigger TRIG1 is TIM8_TRGO */
#define LL_SYSCFG_DAC1_TRIG1_RMP_TIM3_TRGO         (SYSCFG_OFFSET_CFGR1 << 24U | SYSCFG_CFGR1_DAC1_TRIG1_RMP << 4U | SYSCFG_CFGR1_DAC1_TRIG1_RMP) /*!< DAC trigger is TIM3_TRGO */
#endif /* SYSCFG_CFGR1_DAC1_TRIG1_RMP */
#if defined(SYSCFG_CFGR3_DAC1_TRG3_RMP)
#define LL_SYSCFG_DAC1_TRIG3_RMP_TIM15_TRGO        (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG3_RMP << 4U | (uint32_t)0x00000000UL)        /*!< DAC trigger is TIM15_TRGO */
#define LL_SYSCFG_DAC1_TRIG3_RMP_HRTIM1_DAC1_TRIG1 (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG3_RMP << 4U | SYSCFG_CFGR3_DAC1_TRG3_RMP)   /*!< DAC trigger is HRTIM1_DAC1_TRIG1 */
#endif /* SYSCFG_CFGR3_DAC1_TRG3_RMP */
#if defined(SYSCFG_CFGR3_DAC1_TRG5_RMP)
#define LL_SYSCFG_DAC1_TRIG5_RMP_NO                (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG5_RMP << 4U | (uint32_t)0x00000000UL)        /*!<  No remap  */
#define LL_SYSCFG_DAC1_TRIG5_RMP_HRTIM1_DAC1_TRIG2 (SYSCFG_OFFSET_CFGR3 << 24U | SYSCFG_CFGR3_DAC1_TRG5_RMP << 4U | SYSCFG_CFGR3_DAC1_TRG5_RMP)   /*!< DAC trigger is HRTIM1_DAC1_TRIG2 */
...
/** @defgroup SYSTEM_LL_EC_EXTI_LINE SYSCFG EXTI LINE
  * @{
  */
#define LL_SYSCFG_EXTI_LINE0               (uint32_t)(0x000FUL << 16U | 0U)  /* EXTI_POSITION_0  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE1               (uint32_t)(0x00F0UL << 16U | 0U)  /* EXTI_POSITION_4  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE2               (uint32_t)(0x0F00UL << 16U | 0U)  /* EXTI_POSITION_8  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE3               (uint32_t)(0xF000UL << 16U | 0U)  /* EXTI_POSITION_12 | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE4               (uint32_t)(0x000FUL << 16U | 1U)  /* EXTI_POSITION_0  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE5               (uint32_t)(0x00F0UL << 16U | 1U)  /* EXTI_POSITION_4  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE6               (uint32_t)(0x0F00UL << 16U | 1U)  /* EXTI_POSITION_8  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE7               (uint32_t)(0xF000UL << 16U | 1U)  /* EXTI_POSITION_12 | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE8               (uint32_t)(0x000FUL << 16U | 2U)  /* EXTI_POSITION_0  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE9               (uint32_t)(0x00F0UL << 16U | 2U)  /* EXTI_POSITION_4  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE10              (uint32_t)(0x0F00UL << 16U | 2U)  /* EXTI_POSITION_8  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE11              (uint32_t)(0xF000UL << 16U | 2U)  /* EXTI_POSITION_12 | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE12              (uint32_t)(0x000FUL << 16U | 3U)  /* EXTI_POSITION_0  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE13              (uint32_t)(0x00F0UL << 16U | 3U)  /* EXTI_POSITION_4  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE14              (uint32_t)(0x0F00UL << 16U | 3U)  /* EXTI_POSITION_8  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE15              (uint32_t)(0xF000UL << 16U | 3U)  /* EXTI_POSITION_12 | EXTICR[3U] */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_TRACE DBGMCU TRACE Pin Assignment
  * @{
  */
#define LL_DBGMCU_TRACE_NONE               0x00000000UL                                     /*!< TRACE pins not assigned (default state) */
...
{
  MODIFY_REG(SYSCFG->CFGR3, (Remap >> 16U), (Remap & 0x0000FFFFUL));
}
#endif /* SYSCFG_CFGR3_SPI1_RX_DMA_RMP */
...
__STATIC_INLINE void LL_SYSCFG_SetRemapDMA_ADC(uint32_t Remap)
{
  ...
  MODIFY_REG(*reg, (Remap & 0x00FF0000UL) >> 8U, (Remap & 0x0000FFFFUL));
}
#endif /* SYSCFG_CFGR1_ADC24_DMA_RMP || SYSCFG_CFGR3_ADC2_DMA_RMP */
...
{
  MODIFY_REG(SYSCFG->CFGR1, (Remap & 0x00FF0000UL) >> 8U, (Remap & 0x0000FF00UL));
}
...
{
   MODIFY_REG(SYSCFG->CFGR1, (Remap & 0xFF00FF00UL) >> 8U, (Remap & 0x00FF00FFUL));
}
#endif /* SYSCFG_CFGR1_TIM1_ITR3_RMP || SYSCFG_CFGR1_ENCODER_MODE */
...
{
  MODIFY_REG(SYSCFG->CFGR4, (Remap & 0xFFFF0000UL) >> 16U, (Remap & 0x0000FFFFUL));
}
#endif /* SYSCFG_CFGR4_ADC12_EXT2_RMP */
...
{
  __IO uint32_t *reg = (__IO uint32_t *)(uint32_t)(SYSCFG_BASE + (Remap >> 24U));
  MODIFY_REG(*reg, (Remap & 0x00F00F00UL) >> 4U, (Remap & 0x000F00F0UL));
}
#endif /* SYSCFG_CFGR1_DAC1_TRIG1_RMP || SYSCFG_CFGR3_TRIGGER_RMP */
...
/**
  ...
  * @note For STM32F303xC, STM32F358xx and STM32F302xC devices, the device ID is 0x422U
  * @note For STM32F373xx and STM32F378xx devices, the device ID is 0x432U
  * @note For STM32F303x8, STM32F334xx and STM32F328xx devices, the device ID is 0x438U.
  * @note For STM32F302x8, STM32F301x8 and STM32F318xx devices, the device ID is 0x439U
  * @note For STM32F303xE, STM32F398xx and STM32F302xE devices, the device ID is 0x446U
