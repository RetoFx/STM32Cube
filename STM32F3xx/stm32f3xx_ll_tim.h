...
#define TIMx_OR_RMP_MASK  0x0000FFFFUL
#if defined(TIM1)
...
/** @defgroup TIM_LL_EC_TIM16_TI1_RMP  TIM16 External Input Ch1 Remap
  * @{
  */
#define LL_TIM_TIM16_TI1_RMP_GPIO    0x00000000UL                                                   /*!< TIM16 input capture 1 is connected to GPIO */
...
/** @defgroup TIM_LL_EC_OCREF_CLR_INT OCREF clear input selection
  * @{
  */
#define LL_TIM_OCREF_CLR_INT_OCREF_CLR     0x00000000UL         /*!< OCREF_CLR_INT is connected to the OCREF_CLR input */
