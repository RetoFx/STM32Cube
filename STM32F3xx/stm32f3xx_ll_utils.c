...
#define UTILS_PLL_OUTPUT_MAX        72000000UL    /*!< Frequency max for PLL output, in Hz  */
...
#define UTILS_LATENCY2_FREQ         48000000UL        /*!< SYSCLK frequency to set FLASH latency 2 */
/**
  * @}
  */
/* Private macros ------------------------------------------------------------*/
...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 ===============================================================================
    [..]
         ...
         (+) The maximum frequency of the SYSCLK, HCLK, PCLK1 and PCLK2 is 72000000UL Hz.
  @endverbatim
  @internal
