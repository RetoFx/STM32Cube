...
#define UTILS_PLL_OUTPUT_MIN        16000000UL           /*!< Frequency min for PLL output, in Hz  */
#define UTILS_PLL_OUTPUT_MAX        48000000UL    /*!< Frequency max for PLL output, in Hz  */

/* Defines used for HSE range */
#define UTILS_HSE_FREQUENCY_MIN      4000000UL       /*!< Frequency min for HSE frequency, in Hz   */
#define UTILS_HSE_FREQUENCY_MAX     32000000UL       /*!< Frequency max for HSE frequency, in Hz   */

/* Defines used for FLASH latency according to SYSCLK Frequency */
#define UTILS_LATENCY1_FREQ         24000000UL        /*!< SYSCLK frequency to set FLASH latency 1 */
/**
  * @}
  */
/* Private macros ------------------------------------------------------------*/
...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 ===============================================================================
    [..]
         ...
         (+) The maximum frequency of the SYSCLK, HCLK, PCLK1 and PCLK2 is 48000000UL Hz.
  @endverbatim
  @internal
...
/**
  ...
  *          - ERROR: Max frequency configuration not done
  */
ErrorStatus LL_PLL_ConfigSystemClock_HSI48(LL_UTILS_PLLInitTypeDef const * const UTILS_PLLInitStruct,
                                         LL_UTILS_ClkInitTypeDef const * const UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  uint32_t pllfreq = 0U;
...
/**
  ...
  *                   be in the range 16-48MHz
  * @note   FLASH latency can be modified through this function.
  * @param  HSEFrequency Value between Min_Data = 4000000UL and Max_Data = 32000000UL
