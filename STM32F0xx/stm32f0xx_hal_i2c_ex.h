...
#else
#define I2C_FASTMODEPLUS_PA9            (uint32_t)(0x00000001UL | I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PA9 not supported   */
#define I2C_FASTMODEPLUS_PA10           (uint32_t)(0x00000002UL | I2C_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PA10 not supported  */
...
/** @addtogroup I2CEx_Exported_Functions_Group1 Filter Mode Functions
  * @{
  */
HAL_StatusTypeDef HAL_I2CEx_ConfigAnalogFilter(I2C_HandleTypeDef * const hi2c,
                                               uint32_t AnalogFilter);
HAL_StatusTypeDef HAL_I2CEx_ConfigDigitalFilter(I2C_HandleTypeDef * const hi2c,
