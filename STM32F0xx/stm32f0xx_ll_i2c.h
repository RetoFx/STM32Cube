...
#define LL_I2C_MODE_SMBUS_DEVICE           0x00000000UL              /*!< SMBus Device default mode
...
/** @defgroup I2C_LL_EC_SMBUS_TIMEOUTA_MODE SMBus TimeoutA Mode SCL SDA Timeout
  * @{
  */
#define LL_I2C_SMBUS_TIMEOUTA_MODE_SCL_LOW      0x00000000UL          /*!< TimeoutA is used to detect
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableSlaveByteControl(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableSlaveByteControl(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSlaveByteControl(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ConfigSMBusTimeout(I2C_TypeDef * const I2Cx, uint32_t TimeoutA, uint32_t TimeoutAMode,
                                               uint32_t TimeoutB)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetSMBusTimeoutA(I2C_TypeDef * const I2Cx, uint32_t TimeoutA)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutA(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetSMBusTimeoutAMode(I2C_TypeDef * const I2Cx, uint32_t TimeoutAMode)
{
...
/**
  ...
  *         @arg @ref LL_I2C_SMBUS_TIMEOUTA_MODE_SDA_SCL_HIGH
  */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutAMode(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetSMBusTimeoutB(I2C_TypeDef * const I2Cx, uint32_t TimeoutB)
{
...
/**
  ...
  * @retval Value between Min_Data=0 and Max_Data=0xFFFU
  */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusTimeoutB(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableSMBusTimeout(I2C_TypeDef * const I2Cx, uint32_t ClockTimeout)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableSMBusTimeout(I2C_TypeDef * const I2Cx, uint32_t ClockTimeout)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusTimeout(I2C_TypeDef const * const I2Cx, uint32_t ClockTimeout)
{
