...
#define RCC_CFGR_PLLMUL_BIT_NUMBER         18U
#define RCC_CFGR_HPRE_BIT_NUMBER           4U
#define RCC_CFGR_PPRE_BIT_NUMBER           8U
/* Flags in the CFGR2 register */
#define RCC_CFGR2_PREDIV_BIT_NUMBER        0U
/* Flags in the CR register */
#define RCC_CR_HSIRDY_BIT_NUMBER           1U
#define RCC_CR_HSERDY_BIT_NUMBER           17U
#define RCC_CR_PLLRDY_BIT_NUMBER           25U
/* Flags in the CR2 register */
#define RCC_CR2_HSI14RDY_BIT_NUMBER        1U
#define RCC_CR2_HSI48RDY_BIT_NUMBER       17U
/* Flags in the BDCR register */
#define RCC_BDCR_LSERDY_BIT_NUMBER         1U
/* Flags in the CSR register */
#define RCC_CSR_LSIRDY_BIT_NUMBER          1U
#define RCC_CSR_V18PWRRSTF_BIT_NUMBER      23U
#define RCC_CSR_RMVF_BIT_NUMBER            24U
#define RCC_CSR_OBLRSTF_BIT_NUMBER         25U
#define RCC_CSR_PINRSTF_BIT_NUMBER         26U
#define RCC_CSR_PORRSTF_BIT_NUMBER         27U
#define RCC_CSR_SFTRSTF_BIT_NUMBER         28U
#define RCC_CSR_IWDGRSTF_BIT_NUMBER        29U
#define RCC_CSR_WWDGRSTF_BIT_NUMBER        30U
#define RCC_CSR_LPWRRSTF_BIT_NUMBER        31U
/* Flags in the HSITRIM register */
#define RCC_CR_HSITRIM_BIT_NUMBER          3U
...
#define RCC_OSCILLATORTYPE_HSI14           (0x00000010UL)
#if defined(RCC_HSI48_SUPPORT)
#define RCC_OSCILLATORTYPE_HSI48           (0x00000020UL)
#endif /* RCC_HSI48_SUPPORT */
/**
  * @}
  */
...
#define RCC_HSE_ON                       (0x00000001UL)                     /*!< HSE clock activation */
#define RCC_HSE_BYPASS                   (0x00000005UL)                     /*!< External clock source for HSE clock */
/**
  * @}
  */
...
#define RCC_LSE_ON                       (0x00000001UL)                       /*!< LSE clock activation */
#define RCC_LSE_BYPASS                   (0x00000005UL)                       /*!< External clock source for LSE clock */
...
/** @defgroup RCC_HSI14_Config RCC HSI14 Config
  * @{
  */
#define RCC_HSI14_OFF                    (0x00000000UL)
...
/** @defgroup RCC_PLL_Config PLL Config
  * @{
  */
#define RCC_PLL_NONE                      (0x00000000UL)  /*!< PLL is not configured */
...
/** @defgroup RCC_RTC_Clock_Source RTC Clock Source
  * @{
  */
#define RCC_RTCCLKSOURCE_NO_CLK          (0x00000000UL)                 /*!< No clock */
...
/** @defgroup RCC_Flag Flags
  ...
  */
/* Flags in the CR register */
#define RCC_FLAG_HSIRDY                  ((uint8_t)((CR_REG_INDEX << 5U) | RCC_CR_HSIRDY_BIT_NUMBER))
#define RCC_FLAG_HSERDY                  ((uint8_t)((CR_REG_INDEX << 5U) | RCC_CR_HSERDY_BIT_NUMBER))
#define RCC_FLAG_PLLRDY                  ((uint8_t)((CR_REG_INDEX << 5U) | RCC_CR_PLLRDY_BIT_NUMBER))
/* Flags in the CR2 register */
#define RCC_FLAG_HSI14RDY                ((uint8_t)((CR2_REG_INDEX << 5U) | RCC_CR2_HSI14RDY_BIT_NUMBER))

/* Flags in the CSR register */
#define RCC_FLAG_LSIRDY                  ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_LSIRDY_BIT_NUMBER))
#if   defined(RCC_CSR_V18PWRRSTF)
#define RCC_FLAG_V18PWRRST               ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_V18PWRRSTF_BIT_NUMBER))
#endif
#define RCC_FLAG_OBLRST                  ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_OBLRSTF_BIT_NUMBER))
#define RCC_FLAG_PINRST                  ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_PINRSTF_BIT_NUMBER))      /*!< PIN reset flag */
#define RCC_FLAG_PORRST                  ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_PORRSTF_BIT_NUMBER))      /*!< POR/PDR reset flag */
#define RCC_FLAG_SFTRST                  ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_SFTRSTF_BIT_NUMBER))      /*!< Software Reset flag */
#define RCC_FLAG_IWDGRST                 ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_IWDGRSTF_BIT_NUMBER))     /*!< Independent Watchdog reset flag */
#define RCC_FLAG_WWDGRST                 ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_WWDGRSTF_BIT_NUMBER))     /*!< Window watchdog reset flag */
#define RCC_FLAG_LPWRRST                 ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_LPWRRSTF_BIT_NUMBER))     /*!< Low-Power reset flag */

/* Flags in the BDCR register */
#define RCC_FLAG_LSERDY                  ((uint8_t)((BDCR_REG_INDEX << 5U) | RCC_BDCR_LSERDY_BIT_NUMBER))     /*!< External Low Speed oscillator Ready */
...
/** @defgroup RCC_AHB_Force_Release_Reset RCC AHB Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_AHB_FORCE_RESET()     (RCC->AHBRSTR = 0xFFFFFFFFUL)
...
#define __HAL_RCC_AHB_RELEASE_RESET()   (RCC->AHBRSTR = 0x00000000UL)
...
#define __HAL_RCC_APB1_RELEASE_RESET()   (RCC->APB1RSTR = 0x00000000UL)
...
#define __HAL_RCC_APB2_RELEASE_RESET()   (RCC->APB2RSTR = 0x00000000UL)
...
#define __HAL_RCC_HSI_CALIBRATIONVALUE_ADJUST(_HSICALIBRATIONVALUE_) \
                  MODIFY_REG(RCC->CR, RCC_CR_HSITRIM, (uint32_t)(_HSICALIBRATIONVALUE_) << RCC_CR_HSITRIM_BIT_NUMBER)
...
#define __HAL_RCC_GET_FLAG(__FLAG__) (((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR :      \
                                       ...
                                       RCC->CSR) & (1UL << ((__FLAG__) & RCC_FLAG_MASK)))
