...
/** @defgroup DMAEx_Exported_Constants DMAEx Exported Constants
  * @{
  */
#define DMA1_CHANNEL1_RMP                                     0x00000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA1_CHANNEL2_RMP                                     0x10000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA1_CHANNEL3_RMP                                     0x20000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA1_CHANNEL4_RMP                                     0x30000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA1_CHANNEL5_RMP                                     0x40000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#if !defined(STM32F030xC)
#define DMA1_CHANNEL6_RMP                                     0x50000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA1_CHANNEL7_RMP                                     0x60000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA2_CHANNEL1_RMP                                     0x00000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA2_CHANNEL2_RMP                                     0x10000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA2_CHANNEL3_RMP                                     0x20000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA2_CHANNEL4_RMP                                     0x30000000UL /*!< Internal define for remapping on STM32F09x/30xC */
#define DMA2_CHANNEL5_RMP                                     0x40000000UL /*!< Internal define for remapping on STM32F09x/30xC */
...
#define __HAL_DMA1_REMAP(__REQUEST__)                                                              \
         do { assert_param(IS_HAL_DMA1_REMAP(__REQUEST__));                                             \
              DMA1->CSELR &= ~(0x0FUL << (uint32_t)(((__REQUEST__) >> 28U) * 4U)); \
              DMA1->CSELR |= (uint32_t)((__REQUEST__) & 0x0FFFFFFFUL);                                     \
  }while(0U)

#if defined(STM32F091xC) || defined(STM32F098xx)
#define __HAL_DMA2_REMAP(__REQUEST__)                                                              \
         do { assert_param(IS_HAL_DMA2_REMAP(__REQUEST__));                                             \
              DMA2->CSELR &= ~(0x0FUL << (uint32_t)(((__REQUEST__) >> 28U) * 4U)); \
              DMA2->CSELR |= (uint32_t)((__REQUEST__) & 0x0FFFFFFFUL);                                     \
         }while(0U)
#endif /* STM32F091xC || STM32F098xx */
