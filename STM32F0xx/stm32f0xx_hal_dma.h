...
#define HAL_DMA_ERROR_NO_XFER       (0x00000004UL)    /*!< no ongoin transfer   */
...
#define DMA_FLAG_GL1                      (0x00000001UL) /*!< Channel 1 global interrupt flag  */
#define DMA_FLAG_TC1                      (0x00000002UL) /*!< Channel 1 transfer complete flag */
#define DMA_FLAG_HT1                      (0x00000004UL) /*!< Channel 1 half transfer flag     */
#define DMA_FLAG_TE1                      (0x00000008UL) /*!< Channel 1 transfer error flag    */
#define DMA_FLAG_GL2                      (0x00000010UL) /*!< Channel 2 global interrupt flag  */
#define DMA_FLAG_TC2                      (0x00000020UL) /*!< Channel 2 transfer complete flag */
#define DMA_FLAG_HT2                      (0x00000040UL) /*!< Channel 2 half transfer flag     */
#define DMA_FLAG_TE2                      (0x00000080UL) /*!< Channel 2 transfer error flag    */
#define DMA_FLAG_GL3                      (0x00000100UL) /*!< Channel 3 global interrupt flag  */
#define DMA_FLAG_TC3                      (0x00000200UL) /*!< Channel 3 transfer complete flag */
#define DMA_FLAG_HT3                      (0x00000400UL) /*!< Channel 3 half transfer flag     */
#define DMA_FLAG_TE3                      (0x00000800UL) /*!< Channel 3 transfer error flag    */
#define DMA_FLAG_GL4                      (0x00001000UL) /*!< Channel 4 global interrupt flag  */
#define DMA_FLAG_TC4                      (0x00002000UL) /*!< Channel 4 transfer complete flag */
#define DMA_FLAG_HT4                      (0x00004000UL) /*!< Channel 4 half transfer flag     */
#define DMA_FLAG_TE4                      (0x00008000UL) /*!< Channel 4 transfer error flag    */
#define DMA_FLAG_GL5                      (0x00010000UL) /*!< Channel 5 global interrupt flag  */
#define DMA_FLAG_TC5                      (0x00020000UL) /*!< Channel 5 transfer complete flag */
#define DMA_FLAG_HT5                      (0x00040000UL) /*!< Channel 5 half transfer flag     */
#define DMA_FLAG_TE5                      (0x00080000UL) /*!< Channel 5 transfer error flag    */
#define DMA_FLAG_GL6                      (0x00100000UL) /*!< Channel 6 global interrupt flag  */
#define DMA_FLAG_TC6                      (0x00200000UL) /*!< Channel 6 transfer complete flag */
#define DMA_FLAG_HT6                      (0x00400000UL) /*!< Channel 6 half transfer flag     */
#define DMA_FLAG_TE6                      (0x00800000UL) /*!< Channel 6 transfer error flag    */
#define DMA_FLAG_GL7                      (0x01000000UL) /*!< Channel 7 global interrupt flag  */
#define DMA_FLAG_TC7                      (0x02000000UL) /*!< Channel 7 transfer complete flag */
#define DMA_FLAG_HT7                      (0x04000000UL) /*!< Channel 7 half transfer flag     */
#define DMA_FLAG_TE7                      (0x08000000UL) /*!< Channel 7 transfer error flag    */
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef * const hdma, uint32_t CompleteLevel, uint32_t Timeout);
...
#define IS_DMA_BUFFER_SIZE(SIZE) (((SIZE) >= 0x1U) && ((SIZE) < 0x10000UL))
