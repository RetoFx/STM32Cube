...
/**
  ...
  */
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1U)
  void (* ConvCpltCallback)(struct __TSC_HandleTypeDef * const htsc);   /*!< TSC Conversion complete callback  */
  void (* ErrorCallback)(struct __TSC_HandleTypeDef * const htsc);      /*!< TSC Error callback                */

  void (* MspInitCallback)(struct __TSC_HandleTypeDef * const htsc);    /*!< TSC Msp Init callback             */
  void (* MspDeInitCallback)(struct __TSC_HandleTypeDef * const htsc);  /*!< TSC Msp DeInit callback           */
...
/**
  ...
  */
typedef  void (*pTSC_CallbackTypeDef)(TSC_HandleTypeDef * const htsc); /*!< pointer to an TSC callback function */
...
/** @defgroup TSC_MaxCount_Value Max Count Value
  * @{
  */
#define TSC_MCV_255             0x00000000UL                   /*!< 255U maximum number of charge transfer pulses   */
...
#endif /* (USE_HAL_TSC_REGISTER_CALLBACKS == 1U) */
...
HAL_StatusTypeDef HAL_TSC_Init(TSC_HandleTypeDef * const htsc);
HAL_StatusTypeDef HAL_TSC_DeInit(TSC_HandleTypeDef * const htsc);
void HAL_TSC_MspInit(TSC_HandleTypeDef * const htsc);
void HAL_TSC_MspDeInit(TSC_HandleTypeDef * const htsc);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_TSC_RegisterCallback(TSC_HandleTypeDef * const htsc, HAL_TSC_CallbackIDTypeDef CallbackID,
                                           pTSC_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_TSC_UnRegisterCallback(TSC_HandleTypeDef * const htsc, HAL_TSC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_TSC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_TSC_Start(TSC_HandleTypeDef * const htsc);
HAL_StatusTypeDef HAL_TSC_Start_IT(TSC_HandleTypeDef * const htsc);
HAL_StatusTypeDef HAL_TSC_Stop(TSC_HandleTypeDef * const htsc);
HAL_StatusTypeDef HAL_TSC_Stop_IT(TSC_HandleTypeDef * const htsc);
HAL_StatusTypeDef HAL_TSC_PollForAcquisition(TSC_HandleTypeDef * const htsc);
TSC_GroupStatusTypeDef HAL_TSC_GroupGetStatus(TSC_HandleTypeDef const * const htsc, uint32_t gx_index);
uint32_t HAL_TSC_GroupGetValue(TSC_HandleTypeDef const * const htsc, uint32_t gx_index);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_TSC_IOConfig(TSC_HandleTypeDef * const htsc, TSC_IOConfigTypeDef const * const config);
HAL_StatusTypeDef HAL_TSC_IODischarge(TSC_HandleTypeDef * const htsc, FunctionalState choice);
/**
  * @}
  */
...
HAL_TSC_StateTypeDef HAL_TSC_GetState(TSC_HandleTypeDef * const htsc);
/**
  * @}
  */
...
void HAL_TSC_IRQHandler(TSC_HandleTypeDef * const htsc);
void HAL_TSC_ConvCpltCallback(TSC_HandleTypeDef * const htsc);
void HAL_TSC_ErrorCallback(TSC_HandleTypeDef * const htsc);
/**
  * @}
  */
