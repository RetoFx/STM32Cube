...
uint32_t LL_EXTI_DeInit(void)
{
  ...
  LL_EXTI_WriteReg(IMR,   0x0FF40000UL);
#elif defined(STM32F070x6) || defined(STM32F042x6) || defined(STM32F048xx)
  LL_EXTI_WriteReg(IMR,   0x7FF40000UL);
#elif defined(STM32F030x8) || defined(STM32F051x8) || defined(STM32F058xx)
  LL_EXTI_WriteReg(IMR,   0x0F940000UL);
#else
  LL_EXTI_WriteReg(IMR,   0x7F840000UL);
#endif
  ...
  LL_EXTI_WriteReg(PR,    0x007BFFFFUL);
