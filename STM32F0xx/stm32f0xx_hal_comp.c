...
/**
  ...
  * @retval None
  */
__weak void HAL_COMP_MspInit(COMP_HandleTypeDef * const hcomp)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_COMP_MspDeInit(COMP_HandleTypeDef * const hcomp)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcomp);
...
HAL_StatusTypeDef HAL_COMP_Start(COMP_HandleTypeDef * const hcomp)
{
  ...
  else
  {
    ...
    if(hcomp->State == HAL_COMP_STATE_READY)
    {
      ...
      /* Delay for COMP startup time */
      wait_loop_index = (COMP_DELAY_STARTUP_US * (SystemCoreClock / 1000000UL));
...
/**
  ...
  * @retval None
  */
HAL_COMP_WEAK_CALLBACK(void, HAL_COMP_TriggerCallback)(COMP_HandleTypeDef * const hcomp)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcomp);
