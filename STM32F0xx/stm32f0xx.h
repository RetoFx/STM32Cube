...
/**
  ...
  */
#define __STM32F0_DEVICE_VERSION_MAIN   (0x02U) /*!< [31:24] main version */
#define __STM32F0_DEVICE_VERSION_SUB1   (0x03U) /*!< [23:16] sub1 version */
#define __STM32F0_DEVICE_VERSION_SUB2   (0x07U) /*!< [15:8]  sub2 version */
#define __STM32F0_DEVICE_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __STM32F0_DEVICE_VERSION        ((__STM32F0_DEVICE_VERSION_MAIN << 24U) \
                                        |(__STM32F0_DEVICE_VERSION_SUB1 << 16U) \
                                        |(__STM32F0_DEVICE_VERSION_SUB2 << 8U ) \
