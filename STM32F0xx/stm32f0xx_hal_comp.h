...
typedef struct __COMP_HandleTypeDef
{
  ...
  void (* TriggerCallback)(struct __COMP_HandleTypeDef * const hcomp);   /*!< COMP trigger callback */
  void (* MspInitCallback)(struct __COMP_HandleTypeDef * const hcomp);   /*!< COMP Msp Init callback */
  void (* MspDeInitCallback)(struct __COMP_HandleTypeDef * const hcomp); /*!< COMP Msp DeInit callback */
...
/**
  ...
  */
typedef  void (*pCOMP_CallbackTypeDef)(COMP_HandleTypeDef * const hcomp); /*!< pointer to a COMP callback function */
...
/** @defgroup COMP_State COMP State
  * @{
  */
#define HAL_COMP_STATE_RESET             (0x00000000UL)    /*!< COMP not yet initialized or disabled             */
#define HAL_COMP_STATE_READY             (0x00000001UL)    /*!< COMP initialized and ready for use               */
#define HAL_COMP_STATE_READY_LOCKED      (0x00000011UL)    /*!< COMP initialized but the configuration is locked */
#define HAL_COMP_STATE_BUSY              (0x00000002UL)    /*!< COMP is running                                  */
#define HAL_COMP_STATE_BUSY_LOCKED       (0x00000012UL)    /*!< COMP is running and the configuration is locked  */
/**
  * @}
  */
...
/** @defgroup COMP_OutputPolarity COMP OutputPolarity
  * @{
  */
#define COMP_OUTPUTPOL_NONINVERTED             (0x00000000UL)  /*!< COMP output on GPIO isn't inverted */
...
#define COMP_INVERTINGINPUT_1_4VREFINT         (0x00000000UL) /*!< 1/4 VREFINT connected to comparator inverting input */
...
/** @defgroup COMP_NonInvertingInput COMP NonInvertingInput
  * @{
  */
#define COMP_NONINVERTINGINPUT_IO1               (0x00000000UL) /*!< I/O1 (PA1 for COMP1, PA3 for COMP2)
...
#define COMP_OUTPUT_NONE                       (0x00000000UL)                          /*!< COMP output isn't connected to other peripherals */
...
#define COMP_OUTPUTLEVEL_LOW                   (0x00000000UL)
...
/** @defgroup COMP_TriggerMode COMP TriggerMode
  * @{
  */
#define COMP_TRIGGERMODE_NONE                  (0x00000000UL)  /*!< No External Interrupt trigger detection */
#define COMP_TRIGGERMODE_IT_RISING             (0x00000001UL)  /*!< External Interrupt Mode with Rising edge trigger detection */
#define COMP_TRIGGERMODE_IT_FALLING            (0x00000002UL)  /*!< External Interrupt Mode with Falling edge trigger detection */
#define COMP_TRIGGERMODE_IT_RISING_FALLING     (0x00000003UL)  /*!< External Interrupt Mode with Rising/Falling edge trigger detection */
#define COMP_TRIGGERMODE_EVENT_RISING          (0x00000010UL)  /*!< Event Mode with Rising edge trigger detection */
#define COMP_TRIGGERMODE_EVENT_FALLING         (0x00000020UL)  /*!< Event Mode with Falling edge trigger detection */
#define COMP_TRIGGERMODE_EVENT_RISING_FALLING  (0x00000030UL)  /*!< Event Mode with Rising/Falling edge trigger detection */
/**
  * @}
  */
...
HAL_StatusTypeDef     HAL_COMP_Init(COMP_HandleTypeDef * const hcomp);
HAL_StatusTypeDef     HAL_COMP_DeInit (COMP_HandleTypeDef * const hcomp);
void                  HAL_COMP_MspInit(COMP_HandleTypeDef * const hcomp);
void                  HAL_COMP_MspDeInit(COMP_HandleTypeDef * const hcomp);

#if (USE_HAL_COMP_REGISTER_CALLBACKS == 1U)
/* Callbacks Register/UnRegister functions  ***********************************/
HAL_StatusTypeDef HAL_COMP_RegisterCallback(COMP_HandleTypeDef * const hcomp, HAL_COMP_CallbackIDTypeDef CallbackID, pCOMP_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_COMP_UnRegisterCallback(COMP_HandleTypeDef * const hcomp, HAL_COMP_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_COMP_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef     HAL_COMP_Start(COMP_HandleTypeDef * const hcomp);
HAL_StatusTypeDef     HAL_COMP_Stop(COMP_HandleTypeDef * const hcomp);
HAL_StatusTypeDef     HAL_COMP_Start_IT(COMP_HandleTypeDef * const hcomp);
HAL_StatusTypeDef     HAL_COMP_Stop_IT(COMP_HandleTypeDef * const hcomp);
void                  HAL_COMP_IRQHandler(COMP_HandleTypeDef * const hcomp);
/**
  * @}
  */
...
HAL_StatusTypeDef     HAL_COMP_Lock(COMP_HandleTypeDef * const hcomp);
uint32_t              HAL_COMP_GetOutputLevel(COMP_HandleTypeDef const * const hcomp);

/* Callback in Interrupt mode */
void                  HAL_COMP_TriggerCallback(COMP_HandleTypeDef * const hcomp);
/**
  * @}
  */
...
uint32_t              HAL_COMP_GetState(COMP_HandleTypeDef const * const hcomp);
uint32_t              HAL_COMP_GetError(COMP_HandleTypeDef const * const hcomp);
/**
  * @}
  */
...
/** @defgroup COMP_Lock COMP Lock
  * @{
  */
#define COMP_LOCK_DISABLE                      (0x00000000UL)
