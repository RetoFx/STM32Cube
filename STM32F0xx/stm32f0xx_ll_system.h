...
* @{
*/
#define LL_SYSCFG_REMAP_FLASH              ((uint32_t)0x00000000UL)                               /*!< Main Flash memory mapped at 0x00000000UL */
#define LL_SYSCFG_REMAP_SYSTEMFLASH        SYSCFG_CFGR1_MEM_MODE_0                             /*!< System Flash memory mapped at 0x00000000UL */
#define LL_SYSCFG_REMAP_SRAM               (SYSCFG_CFGR1_MEM_MODE_1 | SYSCFG_CFGR1_MEM_MODE_0) /*!< Embedded SRAM mapped at 0x00000000UL */
/**
  * @}
  */
...
#define LL_SYSCFG_USART1TX_RMP_DMA1CH2     ((SYSCFG_CFGR1_USART1TX_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)         /*!< USART1_TX DMA request mapped on DMA channel 2U */
...
#define LL_SYSCFG_USART1RX_RMP_DMA1CH3     ((SYSCFG_CFGR1_USART1RX_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)         /*!< USART1_RX DMA request mapped on DMA channel 3U */
...
#define LL_SYSCFG_USART2_RMP_DMA1CH54      ((SYSCFG_CFGR1_USART2_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)           /*!< USART2_RX and USART2_TX DMA requests mapped on DMA channel 5 and 4U respectively */
...
#define LL_SYSCFG_USART3_RMP_DMA1CH67      ((SYSCFG_CFGR1_USART3_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)           /*!< USART3_RX and USART3_TX DMA requests mapped on DMA channel 6 and 7 respectively */
...
/** @defgroup SYSTEM_LL_EC_SPI2_RMP_DMA1 SYSCFG SPI2 DMA Remap
  * @{
  */
#define LL_SYSCFG_SPI2_RMP_DMA1_CH45       ((uint32_t)0x00000000UL)      /*!< SPI2_RX and SPI2_TX DMA requests mapped on DMA channel 4U and 5 respectively */
...
/** @defgroup SYSTEM_LL_EC_I2C1_RMP_DMA1 SYSCFG I2C1 DMA Remap
  * @{
  */
#define LL_SYSCFG_I2C1_RMP_DMA1_CH32       ((uint32_t)0x00000000UL)      /*!< I2C1_RX and I2C1_TX DMA requests mapped on DMA channel 3U and 2U respectively */
...
/** @defgroup SYSTEM_LL_EC_ADC1_RMP_DMA1 SYSCFG ADC1 DMA Remap
  * @{
  */
#define LL_SYSCFG_ADC1_RMP_DMA1_CH1        ((uint32_t)0x00000000UL)     /*!< ADC DMA request mapped on DMA channel 1U */
...
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3       (((SYSCFG_CFGR1_TIM16_DMA_RMP | SYSCFG_CFGR1_TIM16_DMA_RMP2) >> 8U) | (uint32_t)0x00000000UL)        /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA channel 3 */
...
#else
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3       ((SYSCFG_CFGR1_TIM16_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)        /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA channel 3 */
...
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1       (((SYSCFG_CFGR1_TIM17_DMA_RMP | SYSCFG_CFGR1_TIM17_DMA_RMP2) >> 8U) | (uint32_t)0x00000000UL)        /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA channel 1 */
...
#else
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1       ((SYSCFG_CFGR1_TIM17_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)        /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA channel 1 */
...
#define LL_SYSCFG_TIM1_RMP_DMA1_CH234      ((SYSCFG_CFGR1_TIM1_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)         /*!< TIM1_CH1, TIM1_CH2 and TIM1_CH3 DMA requests mapped on DMAchannel 2, 3 and 4 respectively */
...
#define LL_SYSCFG_TIM2_RMP_DMA1_CH34       ((SYSCFG_CFGR1_TIM2_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)          /*!< TIM2_CH2 and TIM2_CH4 DMA requests mapped on DMA channel 3 and 4 respectively */
...
#define LL_SYSCFG_TIM3_RMP_DMA1_CH4        ((SYSCFG_CFGR1_TIM3_DMA_RMP >> 8U) | (uint32_t)0x00000000UL)          /*!< TIM3_CH1 and TIM3_TRIG DMA requests mapped on DMA channel 4 */
...
/** @defgroup SYSTEM_LL_EC_EXTI_LINE SYSCFG EXTI LINE
  * @{
  */
#define LL_SYSCFG_EXTI_LINE0               (uint32_t)(0UL << 16U | 0U)  /*!< EXTI_POSITION_0  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE1               (uint32_t)(4UL << 16U | 0U)  /*!< EXTI_POSITION_4  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE2               (uint32_t)(8UL << 16U | 0U)  /*!< EXTI_POSITION_8  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE3               (uint32_t)(12UL << 16U | 0U) /*!< EXTI_POSITION_12 | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE4               (uint32_t)(0UL << 16U | 1U)  /*!< EXTI_POSITION_0  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE5               (uint32_t)(4UL << 16U | 1U)  /*!< EXTI_POSITION_4  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE6               (uint32_t)(8UL << 16U | 1U)  /*!< EXTI_POSITION_8  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE7               (uint32_t)(12UL << 16U | 1U) /*!< EXTI_POSITION_12 | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE8               (uint32_t)(0UL << 16U | 2U)  /*!< EXTI_POSITION_0  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE9               (uint32_t)(4UL << 16U | 2U)  /*!< EXTI_POSITION_4  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE10              (uint32_t)(8UL << 16U | 2U)  /*!< EXTI_POSITION_8  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE11              (uint32_t)(12UL << 16U | 2U) /*!< EXTI_POSITION_12 | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE12              (uint32_t)(0UL << 16U | 3U)  /*!< EXTI_POSITION_0  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE13              (uint32_t)(4UL << 16U | 3U)  /*!< EXTI_POSITION_4  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE14              (uint32_t)(8UL << 16U | 3U)  /*!< EXTI_POSITION_8  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE15              (uint32_t)(12UL << 16U | 3U) /*!< EXTI_POSITION_12 | EXTICR[3U] */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_LATENCY FLASH LATENCY
  * @{
  */
#define LL_FLASH_LATENCY_0                 0x00000000UL             /*!< FLASH Zero Latency cycle */
...
/**
  * @brief  Set memory mapping at address 0x00000000UL
...
/**
  * @brief  Get memory mapping at address 0x00000000UL
...
{
  MODIFY_REG(SYSCFG->CFGR1, (Remap & 0x00FF00FFUL) << 8U, (Remap & 0xFF00FF00UL));
}
#endif /* SYSCFG_CFGR1_USART1TX_DMA_RMP || SYSCFG_CFGR1_USART1RX_DMA_RMP || SYSCFG_CFGR1_USART2_DMA_RMP || SYSCFG_CFGR1_USART3_DMA_RMP */
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[0U], SYSCFG_ITLINE0_SR_EWDG) == (SYSCFG_ITLINE0_SR_EWDG));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVDOUT) == (SYSCFG_ITLINE1_SR_PVDOUT));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_VDDIO2) == (SYSCFG_ITLINE1_SR_VDDIO2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[2U], SYSCFG_ITLINE2_SR_RTC_WAKEUP) == (SYSCFG_ITLINE2_SR_RTC_WAKEUP));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[2U], SYSCFG_ITLINE2_SR_RTC_TSTAMP) == (SYSCFG_ITLINE2_SR_RTC_TSTAMP));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[2U], SYSCFG_ITLINE2_SR_RTC_ALRA) == (SYSCFG_ITLINE2_SR_RTC_ALRA));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[3U], SYSCFG_ITLINE3_SR_FLASH_ITF) == (SYSCFG_ITLINE3_SR_FLASH_ITF));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[4U], SYSCFG_ITLINE4_SR_CRS) == (SYSCFG_ITLINE4_SR_CRS));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[4U], SYSCFG_ITLINE4_SR_CLK_CTRL) == (SYSCFG_ITLINE4_SR_CLK_CTRL));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[5U], SYSCFG_ITLINE5_SR_EXTI0) == (SYSCFG_ITLINE5_SR_EXTI0));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[5U], SYSCFG_ITLINE5_SR_EXTI1) == (SYSCFG_ITLINE5_SR_EXTI1));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[6U], SYSCFG_ITLINE6_SR_EXTI2) == (SYSCFG_ITLINE6_SR_EXTI2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[6U], SYSCFG_ITLINE6_SR_EXTI3) == (SYSCFG_ITLINE6_SR_EXTI3));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI4) == (SYSCFG_ITLINE7_SR_EXTI4));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI5) == (SYSCFG_ITLINE7_SR_EXTI5));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI6) == (SYSCFG_ITLINE7_SR_EXTI6));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI7) == (SYSCFG_ITLINE7_SR_EXTI7));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI8) == (SYSCFG_ITLINE7_SR_EXTI8));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI9) == (SYSCFG_ITLINE7_SR_EXTI9));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI10) == (SYSCFG_ITLINE7_SR_EXTI10));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI11) == (SYSCFG_ITLINE7_SR_EXTI11));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI12) == (SYSCFG_ITLINE7_SR_EXTI12));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI13) == (SYSCFG_ITLINE7_SR_EXTI13));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI14) == (SYSCFG_ITLINE7_SR_EXTI14));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI15) == (SYSCFG_ITLINE7_SR_EXTI15));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_TSC_EOA) == (SYSCFG_ITLINE8_SR_TSC_EOA));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_TSC_MCE) == (SYSCFG_ITLINE8_SR_TSC_MCE));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[9U], SYSCFG_ITLINE9_SR_DMA1_CH1) == (SYSCFG_ITLINE9_SR_DMA1_CH1));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA1_CH2) == (SYSCFG_ITLINE10_SR_DMA1_CH2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA1_CH3) == (SYSCFG_ITLINE10_SR_DMA1_CH3));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA2_CH1) == (SYSCFG_ITLINE10_SR_DMA2_CH1));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA2_CH2) == (SYSCFG_ITLINE10_SR_DMA2_CH2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH4) == (SYSCFG_ITLINE11_SR_DMA1_CH4));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH5) == (SYSCFG_ITLINE11_SR_DMA1_CH5));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH6) == (SYSCFG_ITLINE11_SR_DMA1_CH6));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH7) == (SYSCFG_ITLINE11_SR_DMA1_CH7));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH3) == (SYSCFG_ITLINE11_SR_DMA2_CH3));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH4) == (SYSCFG_ITLINE11_SR_DMA2_CH4));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH5) == (SYSCFG_ITLINE11_SR_DMA2_CH5));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_ADC) == (SYSCFG_ITLINE12_SR_ADC));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_COMP1) == (SYSCFG_ITLINE12_SR_COMP1));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_COMP2) == (SYSCFG_ITLINE12_SR_COMP2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_BRK) == (SYSCFG_ITLINE13_SR_TIM1_BRK));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_UPD) == (SYSCFG_ITLINE13_SR_TIM1_UPD));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_TRG) == (SYSCFG_ITLINE13_SR_TIM1_TRG));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_CCU) == (SYSCFG_ITLINE13_SR_TIM1_CCU));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC) == (SYSCFG_ITLINE14_SR_TIM1_CC));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[15U], SYSCFG_ITLINE15_SR_TIM2_GLB) == (SYSCFG_ITLINE15_SR_TIM2_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[16U], SYSCFG_ITLINE16_SR_TIM3_GLB) == (SYSCFG_ITLINE16_SR_TIM3_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_DAC) == (SYSCFG_ITLINE17_SR_DAC));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_TIM6_GLB) == (SYSCFG_ITLINE17_SR_TIM6_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[18U], SYSCFG_ITLINE18_SR_TIM7_GLB) == (SYSCFG_ITLINE18_SR_TIM7_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[19U], SYSCFG_ITLINE19_SR_TIM14_GLB) == (SYSCFG_ITLINE19_SR_TIM14_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[20U], SYSCFG_ITLINE20_SR_TIM15_GLB) == (SYSCFG_ITLINE20_SR_TIM15_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_TIM16_GLB) == (SYSCFG_ITLINE21_SR_TIM16_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[22U], SYSCFG_ITLINE22_SR_TIM17_GLB) == (SYSCFG_ITLINE22_SR_TIM17_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[23U], SYSCFG_ITLINE23_SR_I2C1_GLB) == (SYSCFG_ITLINE23_SR_I2C1_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C2_GLB) == (SYSCFG_ITLINE24_SR_I2C2_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[25U], SYSCFG_ITLINE25_SR_SPI1) == (SYSCFG_ITLINE25_SR_SPI1));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[26U], SYSCFG_ITLINE26_SR_SPI2) == (SYSCFG_ITLINE26_SR_SPI2));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[27U], SYSCFG_ITLINE27_SR_USART1_GLB) == (SYSCFG_ITLINE27_SR_USART1_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[28U], SYSCFG_ITLINE28_SR_USART2_GLB) == (SYSCFG_ITLINE28_SR_USART2_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART3_GLB) == (SYSCFG_ITLINE29_SR_USART3_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART4_GLB) == (SYSCFG_ITLINE29_SR_USART4_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART5_GLB) == (SYSCFG_ITLINE29_SR_USART5_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART6_GLB) == (SYSCFG_ITLINE29_SR_USART6_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART7_GLB) == (SYSCFG_ITLINE29_SR_USART7_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART8_GLB) == (SYSCFG_ITLINE29_SR_USART8_GLB));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[30U], SYSCFG_ITLINE30_SR_CAN) == (SYSCFG_ITLINE30_SR_CAN));
}
...
{
  return (READ_BIT(SYSCFG->IT_LINE_SR[30U], SYSCFG_ITLINE30_SR_CEC) == (SYSCFG_ITLINE30_SR_CEC));
}
...
/**
  ...
  * @note For STM32F03x devices, the device ID is 0x444U
  * @note For STM32F04x devices, the device ID is 0x445U.
  * @note For STM32F05x devices, the device ID is 0x440U
  * @note For STM32F07x devices, the device ID is 0x448U
  * @note For STM32F09x devices, the device ID is 0x442U
  * @rmtoll DBGMCU_IDCODE DEV_ID        LL_DBGMCU_GetDeviceID
  * @retval Values between Min_Data=0x00U and Max_Data=0xFFFU
  */
...
/**
  ...
  * @note This field indicates the revision of the device.
          For example, it is read as 0x1000U for Revision 1.0.
  * @rmtoll DBGMCU_IDCODE REV_ID        LL_DBGMCU_GetRevisionID
  * @retval Values between Min_Data=0x00U and Max_Data=0xFFFFU
  */
