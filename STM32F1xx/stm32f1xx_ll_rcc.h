...
#define LL_RCC_USB_CLKSOURCE_PLL_DIV_1_5     0x00000000UL            /*!< PLL clock is divided by 1.5 */
...
#define LL_RCC_USB_CLKSOURCE_PLL_DIV_3       0x00000000UL            /*!< PLL clock is divided by 3 */
...
/** @defgroup RCC_LL_EC_USB Peripheral USB get clock source
  * @{
  */
#define LL_RCC_USB_CLKSOURCE               0x00400000UL     /*!< USB Clock source selection */
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_PLLSOURCE PLL SOURCE
  * @{
  */
#define LL_RCC_PLLSOURCE_HSI_DIV_2         0x00000000UL                                    /*!< HSI clock divided by 2 selected as PLL entry clock source */
...
#endif /*RCC_CFGR2_PREDIV1SRC*/
#else
#define LL_RCC_PLLSOURCE_HSE_DIV_1         (RCC_CFGR_PLLSRC | 0x00000000UL)               /*!< HSE/1 clock selected as PLL entry clock source */
...
#else
#define LL_RCC_PREDIV_DIV_1                0x00000000UL              /*!< HSE divider clock clock not divided */
...
{
  MODIFY_REG(RCC->CFGR2, (I2SxSource & 0xFFFF0000UL), (I2SxSource << 16U));
}
#endif /* RCC_CFGR2_I2S2SRC */
