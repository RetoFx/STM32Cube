...
static uint32_t    UTILS_GetPLL2OutputFrequency(uint32_t PLL2_InputFrequency,
                                                LL_UTILS_PLLInitTypeDef const * const UTILS_PLL2InitStruct);
#endif /* RCC_PLL2_SUPPORT */
...
/**
  ...
  */
static uint32_t UTILS_GetPLL2OutputFrequency(uint32_t PLL2_InputFrequency, LL_UTILS_PLLInitTypeDef const * const UTILS_PLL2InitStruct)
{
