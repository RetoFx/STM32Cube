...
typedef enum
{
  HAL_MMC_STATE_RESET                  = 0x00000000UL,  /*!< MMC not yet initialized or disabled  */
  HAL_MMC_STATE_READY                  = 0x00000001UL,  /*!< MMC initialized and ready for use    */
  HAL_MMC_STATE_TIMEOUT                = 0x00000002UL,  /*!< MMC Timeout state                    */
  HAL_MMC_STATE_BUSY                   = 0x00000003UL,  /*!< MMC process ongoing                  */
  HAL_MMC_STATE_PROGRAMMING            = 0x00000004UL,  /*!< MMC Programming State                */
  HAL_MMC_STATE_RECEIVING              = 0x00000005UL,  /*!< MMC Receinving State                 */
  HAL_MMC_STATE_TRANSFER               = 0x00000006UL,  /*!< MMC Transfer State                  */
  HAL_MMC_STATE_ERROR                  = 0x0000000FUL   /*!< MMC is in error state                */
...
#define HAL_MMC_CARD_READY          0x00000001UL  /*!< Card state is ready                     */
#define HAL_MMC_CARD_IDENTIFICATION 0x00000002UL  /*!< Card is in identification state         */
...
#define HAL_MMC_CARD_ERROR          0x000000FFUL  /*!< Card response Error                     */
/**
  * @}
  */
...
/** @defgroup MMC_Exported_Constansts_Group2 MMC context enumeration
  * @{
  */
#define   MMC_CONTEXT_NONE                            0x00000000UL   /*!< None                             */
#define   MMC_CONTEXT_READ_SINGLE_BLOCK               0x00000001UL   /*!< Read single block operation      */
#define   MMC_CONTEXT_READ_MULTIPLE_BLOCK             0x00000002UL   /*!< Read multiple blocks operation   */
#define   MMC_CONTEXT_WRITE_SINGLE_BLOCK              0x00000010UL   /*!< Write single block operation     */
#define   MMC_CONTEXT_WRITE_MULTIPLE_BLOCK            0x00000020UL   /*!< Write multiple blocks operation  */
#define   MMC_CONTEXT_IT                              0x00000008UL   /*!< Process in Interrupt mode        */
#define   MMC_CONTEXT_DMA                             0x00000080UL   /*!< Process in DMA mode              */
...
/** @defgroup MMC_Exported_Constansts_Group4 MMC Memory Cards
  * @{
  */
#define  MMC_LOW_CAPACITY_CARD                0x00000000UL    /*!< MMC Card Capacity <=2Gbytes   */
#define  MMC_HIGH_CAPACITY_CARD               0x00000001UL    /*!< MMC Card Capacity >2Gbytes and <2Tbytes   */
