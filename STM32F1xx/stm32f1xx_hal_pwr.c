...
/** @defgroup PWR_PVD_Mode_Mask PWR PVD Mode Mask
  * @{
  */
#define PVD_MODE_IT               0x00010000UL
#define PVD_MODE_EVT              0x00020000UL
#define PVD_RISING_EDGE           0x00000001UL
#define PVD_FALLING_EDGE          0x00000002UL
/**
  * @}
  */
...
void HAL_PWR_EnableBkUpAccess(void)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, DBP_BIT_NUMBER, ENABLE);
}
...
void HAL_PWR_DisableBkUpAccess(void)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, DBP_BIT_NUMBER, DISABLE);
}
...
void HAL_PWR_EnablePVD(void)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, PVDE_BIT_NUMBER, ENABLE);
}
...
void HAL_PWR_DisablePVD(void)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, PVDE_BIT_NUMBER, DISABLE);
}
...
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CSR, POSITION_VAL(WakeUpPinx), ENABLE);
}
...
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CSR, POSITION_VAL(WakeUpPinx), DISABLE);
}
...
/**
  ...
  * @retval None
  */
HAL_PWR_WEAK_CALLBACK(void, HAL_PWR_PVDCallback)(void)
{
