...
#define RCC_PLLI2SON_BIT_NUMBER           RCC_CR_PLL3ON_Pos
#define RCC_CR_PLLI2SON_BB           ((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) + (RCC_PLLI2SON_BIT_NUMBER * 4U)))
/* Alias word address of PLL2ON bit */
#define RCC_PLL2ON_BIT_NUMBER             RCC_CR_PLL2ON_Pos
#define RCC_CR_PLL2ON_BB             ((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) + (RCC_PLL2ON_BIT_NUMBER * 4U)))
...
/** @defgroup RCCEx_Periph_Clock_Selection Periph Clock Selection
  * @{
  */
#define RCC_PERIPHCLK_RTC           0x00000001UL
#define RCC_PERIPHCLK_ADC           0x00000002UL
#if defined(STM32F101xE) || defined(STM32F101xG) || defined(STM32F103xE) \
 || defined(STM32F103xG) || defined(STM32F105xC) || defined(STM32F107xC)
#define RCC_PERIPHCLK_I2S2          0x00000004UL
#define RCC_PERIPHCLK_I2S3          0x00000008UL
#endif /* STM32F101xE || STM32F101xG || STM32F103xE || STM32F103xG || STM32F105xC || STM32F107xC */
#if defined(STM32F102x6) || defined(STM32F102xB) || defined(STM32F103x6) \
 || defined(STM32F103xB) || defined(STM32F103xE) || defined(STM32F103xG) \
 || defined(STM32F105xC) || defined(STM32F107xC)
#define RCC_PERIPHCLK_USB          0x00000010UL
#endif /* STM32F102x6 || STM32F102xB || STM32F103x6 || STM32F103xB || STM32F103xE || STM32F103xG || STM32F105xC || STM32F107xC */
...
/** @defgroup RCCEx_I2S2_Clock_Source I2S2 Clock Source
  * @{
  */
#define RCC_I2S2CLKSOURCE_SYSCLK              0x00000000UL
#if defined(STM32F105xC) || defined(STM32F107xC)
...
/** @defgroup RCCEx_I2S3_Clock_Source I2S3 Clock Source
  * @{
  */
#define RCC_I2S3CLKSOURCE_SYSCLK              0x00000000UL
#if defined(STM32F105xC) || defined(STM32F107xC)
...
#define RCC_USBCLKSOURCE_PLL_DIV1_5       0x00000000UL
...
#define RCC_USBCLKSOURCE_PLL_DIV3              0x00000000UL
...
#define RCC_HSE_PREDIV_DIV1              0x00000000UL
...
/** @defgroup RCCEx_PLL2_Config PLL Config
  * @{
  */
#define RCC_PLL2_NONE                      0x00000000UL
#define RCC_PLL2_OFF                       0x00000001UL
#define RCC_PLL2_ON                        0x00000002UL
...
/** @brief Macros to enable the main PLL2.
  ...
  */
#define __HAL_RCC_PLL2_ENABLE()          HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_PLL2ON_BIT_NUMBER, ENABLE)
...
/** @brief Macros to disable the main PLL2.
  ...
  * @note   The main PLL2 is disabled by hardware when entering STOP and STANDBY modes.
  */
#define __HAL_RCC_PLL2_DISABLE()         HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_PLL2ON_BIT_NUMBER, DISABLE)
...
/** @addtogroup RCCEx_Exported_Functions_Group3
  * @{
  */
HAL_StatusTypeDef HAL_RCCEx_EnablePLL2(RCC_PLL2InitTypeDef * const PLL2Init);
