...
typedef struct
{
  uint32_t AsynchPrescaler; /*!< Specifies the RTC Asynchronous Predivider value.
                              This parameter must be a number between Min_Data = 0x00U and Max_Data = 0xFFFFFUL
...
#define LL_RTC_BKP_DR11                    (0x00000010UL)
#define LL_RTC_BKP_DR12                    (0x00000011UL)
#define LL_RTC_BKP_DR13                    (0x00000012UL)
#define LL_RTC_BKP_DR14                    (0x00000013UL)
#define LL_RTC_BKP_DR15                    (0x00000014UL)
#define LL_RTC_BKP_DR16                    (0x00000015UL)
#define LL_RTC_BKP_DR17                    (0x00000016UL)
#define LL_RTC_BKP_DR18                    (0x00000017UL)
#define LL_RTC_BKP_DR19                    (0x00000018UL)
#define LL_RTC_BKP_DR20                    (0x00000019UL)
#define LL_RTC_BKP_DR21                    (0x0000001AUL)
#define LL_RTC_BKP_DR22                    (0x0000001BUL)
#define LL_RTC_BKP_DR23                    (0x0000001CUL)
#define LL_RTC_BKP_DR24                    (0x0000001DUL)
#define LL_RTC_BKP_DR25                    (0x0000001EUL)
#define LL_RTC_BKP_DR26                    (0x0000001FUL)
#define LL_RTC_BKP_DR27                    (0x00000020UL)
#define LL_RTC_BKP_DR28                    (0x00000021UL)
#define LL_RTC_BKP_DR29                    (0x00000022UL)
#define LL_RTC_BKP_DR30                    (0x00000023UL)
#define LL_RTC_BKP_DR31                    (0x00000024UL)
#define LL_RTC_BKP_DR32                    (0x00000025UL)
#define LL_RTC_BKP_DR33                    (0x00000026UL)
#define LL_RTC_BKP_DR34                    (0x00000027UL)
#define LL_RTC_BKP_DR35                    (0x00000028UL)
#define LL_RTC_BKP_DR36                    (0x00000029UL)
#define LL_RTC_BKP_DR37                    (0x0000002AUL)
#define LL_RTC_BKP_DR38                    (0x0000002BUL)
#define LL_RTC_BKP_DR39                    (0x0000002CUL)
#define LL_RTC_BKP_DR40                    (0x0000002DUL)
#define LL_RTC_BKP_DR41                    (0x0000002EUL)
#define LL_RTC_BKP_DR42                    (0x0000002FUL)
...
#define LL_RTC_TAMPER_ACTIVELEVEL_HIGH         (0x00000000UL)         /*!< A low level on the TAMPER pin resets all data backup registers (if TPE bit is set) */
...
/**
  ...
  * @param  AsynchPrescaler Value between Min_Data = 0 and Max_Data = 0xFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetAsynchPrescaler(RTC_TypeDef * const RTCx, uint32_t AsynchPrescaler)
{
  MODIFY_REG(RTCx->PRLH, RTC_PRLH_PRL, (AsynchPrescaler >> 16U));
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data = 0 and Max_Data = 0xFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_GetDivider(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetOutputSource(BKP_TypeDef * const BKPx, uint32_t OutputSource)
{
...
/**
  ...
  *         @arg @ref LL_RTC_CALIB_OUTPUT_SECOND
  */
__STATIC_INLINE uint32_t LL_RTC_GetOutPutSource(BKP_TypeDef const * const BKPx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  TimeCounter Value between Min_Data=0x00U and Max_Data=0xFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_Set(RTC_TypeDef * const RTCx, uint32_t TimeCounter)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  AlarmCounter Value between Min_Data=0x00U and Max_Data=0xFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALARM_Set(RTC_TypeDef * const RTCx, uint32_t AlarmCounter)
{
  /* Set RTC COUNTER MSB word */
  WRITE_REG(RTCx->ALRH, (AlarmCounter >> 16U));
  /* Set RTC COUNTER LSB word */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_ALARM_Get(RTC_TypeDef const * const RTCx)
{
  uint16_t high = 0, low = 0;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_Enable(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_Disable(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_SetActiveLevel(BKP_TypeDef * const BKPx, uint32_t Tamper)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetActiveLevel(BKP_TypeDef const * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_BKP_SetRegister(BKP_TypeDef * const BKPx, uint32_t BackupRegister, uint32_t Data)
{
  uint32_t tmp = 0U;
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_BKP_GetRegister(BKP_TypeDef const * const BKPx, uint32_t BackupRegister)
{
  uint32_t tmp = 0U;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_SetCoarseDigital(BKP_TypeDef * const BKPx, uint32_t Value)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_GetCoarseDigital(BKP_TypeDef const * const BKPx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMPI(BKP_TypeDef const * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMPI(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMPE(BKP_TypeDef const * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMPE(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALR(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_ALR(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_OW(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_OW(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SEC(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_SEC(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_RTOF(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_ALR(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_ALR(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ALR(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_SEC(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_SEC(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_SEC(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_OW(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_OW(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_OW(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP(BKP_TypeDef * const BKPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP(BKP_TypeDef const * const BKPx)
{
...
ErrorStatus LL_RTC_ALARM_Init(RTC_TypeDef * const RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
void        LL_RTC_ALARM_StructInit(LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
...
ErrorStatus LL_RTC_TIME_SetCounter(RTC_TypeDef * const RTCx, uint32_t TimeCounter);
ErrorStatus LL_RTC_ALARM_SetCounter(RTC_TypeDef * const RTCx, uint32_t AlarmCounter);
