...
/**
  ...
  * @note For Low Density devices, the device ID is 0x412U
  * @note For Medium Density devices, the device ID is 0x410U
  * @note For High Density devices, the device ID is 0x414U
  * @note For XL Density devices, the device ID is 0x430U
  * @note For Connectivity Line devices, the device ID is 0x418U
...
/**
  ...
  * @note This field indicates the revision of the device.
          For example, it is read as revA -> 0x1000U,for Low Density devices
          For example, it is read as revA -> 0x0000U, revB -> 0x2000U, revZ -> 0x2001U, rev1,2,3,X or Y -> 0x2003U,for Medium Density devices
          For example, it is read as revA or 1 -> 0x1000U, revZ -> 0x1001U,rev1,2,3,X or Y -> 0x1003U,for Medium Density devices
          For example, it is read as revA or 1 -> 0x1003U,for XL Density devices
          For example, it is read as revA -> 0x1000U, revZ -> 0x1001U for  Connectivity line devices
