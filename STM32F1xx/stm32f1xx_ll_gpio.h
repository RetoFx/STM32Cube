...
/** @defgroup GPIO_LL_EC_PIN PIN
  * @{
  */
#define LL_GPIO_PIN_0                    ((GPIO_BSRR_BS0  << GPIO_PIN_MASK_POS) | 0x00000001UL)  /*!< Select pin 0  */
#define LL_GPIO_PIN_1                    ((GPIO_BSRR_BS1  << GPIO_PIN_MASK_POS) | 0x00000002UL)  /*!< Select pin 1  */
#define LL_GPIO_PIN_2                    ((GPIO_BSRR_BS2  << GPIO_PIN_MASK_POS) | 0x00000004UL)  /*!< Select pin 2  */
#define LL_GPIO_PIN_3                    ((GPIO_BSRR_BS3  << GPIO_PIN_MASK_POS) | 0x00000008UL)  /*!< Select pin 3  */
#define LL_GPIO_PIN_4                    ((GPIO_BSRR_BS4  << GPIO_PIN_MASK_POS) | 0x00000010UL)  /*!< Select pin 4  */
#define LL_GPIO_PIN_5                    ((GPIO_BSRR_BS5  << GPIO_PIN_MASK_POS) | 0x00000020UL)  /*!< Select pin 5  */
#define LL_GPIO_PIN_6                    ((GPIO_BSRR_BS6  << GPIO_PIN_MASK_POS) | 0x00000040UL)  /*!< Select pin 6  */
#define LL_GPIO_PIN_7                    ((GPIO_BSRR_BS7  << GPIO_PIN_MASK_POS) | 0x00000080UL)  /*!< Select pin 7  */
#define LL_GPIO_PIN_8                    ((GPIO_BSRR_BS8  << GPIO_PIN_MASK_POS) | 0x04000001UL)  /*!< Select pin 8  */
#define LL_GPIO_PIN_9                    ((GPIO_BSRR_BS9  << GPIO_PIN_MASK_POS) | 0x04000002UL)  /*!< Select pin 9  */
#define LL_GPIO_PIN_10                   ((GPIO_BSRR_BS10 << GPIO_PIN_MASK_POS) | 0x04000004UL)  /*!< Select pin 10 */
#define LL_GPIO_PIN_11                   ((GPIO_BSRR_BS11 << GPIO_PIN_MASK_POS) | 0x04000008UL)  /*!< Select pin 11 */
#define LL_GPIO_PIN_12                   ((GPIO_BSRR_BS12 << GPIO_PIN_MASK_POS) | 0x04000010UL)  /*!< Select pin 12 */
#define LL_GPIO_PIN_13                   ((GPIO_BSRR_BS13 << GPIO_PIN_MASK_POS) | 0x04000020UL)  /*!< Select pin 13 */
#define LL_GPIO_PIN_14                   ((GPIO_BSRR_BS14 << GPIO_PIN_MASK_POS) | 0x04000040UL)  /*!< Select pin 14 */
#define LL_GPIO_PIN_15                   ((GPIO_BSRR_BS15 << GPIO_PIN_MASK_POS) | 0x04000080UL)  /*!< Select pin 15 */
...
/** @defgroup GPIO_LL_EC_MODE Mode
  * @{
  */
#define LL_GPIO_MODE_ANALOG              0x00000000UL       /*!< Select analog mode */
...
/** @defgroup GPIO_LL_EC_OUTPUT Output Type
  * @{
  */
#define LL_GPIO_OUTPUT_PUSHPULL          0x00000000UL                /*!< Select push-pull as output type */
...
/** @defgroup GPIO_LL_EC_PULL Pull Up Pull Down
  * @{
  */
#define LL_GPIO_PULL_DOWN                0x00000000UL    /*!< Select I/O pull down */
...
/** @defgroup GPIO_LL_EC_EXTI_LINE GPIO EXTI LINE
  * @{
  */
#define LL_GPIO_AF_EXTI_LINE0            (0x000FUL << 16U | 0U)  /*!< EXTI_POSITION_0  | EXTICR[0U] */
#define LL_GPIO_AF_EXTI_LINE1            (0x00F0UL << 16U | 0U)  /*!< EXTI_POSITION_4  | EXTICR[0U] */
#define LL_GPIO_AF_EXTI_LINE2            (0x0F00UL << 16U | 0U)  /*!< EXTI_POSITION_8  | EXTICR[0U] */
#define LL_GPIO_AF_EXTI_LINE3            (0xF000UL << 16U | 0U)  /*!< EXTI_POSITION_12 | EXTICR[0U] */
#define LL_GPIO_AF_EXTI_LINE4            (0x000FUL << 16U | 1U)  /*!< EXTI_POSITION_0  | EXTICR[1U] */
#define LL_GPIO_AF_EXTI_LINE5            (0x00F0UL << 16U | 1U)  /*!< EXTI_POSITION_4  | EXTICR[1U] */
#define LL_GPIO_AF_EXTI_LINE6            (0x0F00UL << 16U | 1U)  /*!< EXTI_POSITION_8  | EXTICR[1U] */
#define LL_GPIO_AF_EXTI_LINE7            (0xF000UL << 16U | 1U)  /*!< EXTI_POSITION_12 | EXTICR[1U] */
#define LL_GPIO_AF_EXTI_LINE8            (0x000FUL << 16U | 2U)  /*!< EXTI_POSITION_0  | EXTICR[2U] */
#define LL_GPIO_AF_EXTI_LINE9            (0x00F0UL << 16U | 2U)  /*!< EXTI_POSITION_4  | EXTICR[2U] */
#define LL_GPIO_AF_EXTI_LINE10           (0x0F00UL << 16U | 2U)  /*!< EXTI_POSITION_8  | EXTICR[2U] */
#define LL_GPIO_AF_EXTI_LINE11           (0xF000UL << 16U | 2U)  /*!< EXTI_POSITION_12 | EXTICR[2U] */
#define LL_GPIO_AF_EXTI_LINE12           (0x000FUL << 16U | 3U)  /*!< EXTI_POSITION_0  | EXTICR[3U] */
#define LL_GPIO_AF_EXTI_LINE13           (0x00F0UL << 16U | 3U)  /*!< EXTI_POSITION_4  | EXTICR[3U] */
#define LL_GPIO_AF_EXTI_LINE14           (0x0F00UL << 16U | 3U)  /*!< EXTI_POSITION_8  | EXTICR[3U] */
#define LL_GPIO_AF_EXTI_LINE15           (0xF000UL << 16U | 3U)  /*!< EXTI_POSITION_12 | EXTICR[3U] */
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinMode(GPIO_TypeDef * const GPIOx, uint32_t Pin, uint32_t Mode)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  *         @arg @ref LL_GPIO_MODE_ALTERNATE
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinMode(GPIO_TypeDef const * const GPIOx, uint32_t Pin)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinSpeed(GPIO_TypeDef * const GPIOx, uint32_t Pin, uint32_t  Speed)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  *         @arg @ref LL_GPIO_SPEED_FREQ_HIGH
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinSpeed(GPIO_TypeDef const * const GPIOx, uint32_t Pin)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinOutputType(GPIO_TypeDef * const GPIOx, uint32_t Pin, uint32_t OutputType)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  *         @arg @ref LL_GPIO_OUTPUT_OPENDRAIN
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinOutputType(GPIO_TypeDef const * const GPIOx, uint32_t Pin)
{
  uint32_t * pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24U)));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinPull(GPIO_TypeDef * const GPIOx, uint32_t Pin, uint32_t Pull)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_PULL_UP
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinPull(GPIO_TypeDef const * const GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_LockPin(GPIO_TypeDef * const GPIOx, uint32_t PinMask)
{
  __IO uint32_t temp;
  WRITE_REG(GPIOx->LCKR, GPIO_LCKR_LCKK | ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
  WRITE_REG(GPIOx->LCKR, ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
  WRITE_REG(GPIOx->LCKR, GPIO_LCKR_LCKK | ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_IsPinLocked(GPIO_TypeDef const * const GPIOx, uint32_t PinMask)
{
  return (READ_BIT(GPIOx->LCKR, ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL)) == ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsAnyPinLocked(GPIO_TypeDef const * const GPIOx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_ReadInputPort(GPIO_TypeDef const * const GPIOx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsInputPinSet(GPIO_TypeDef const * const GPIOx, uint32_t PinMask)
{
  return (READ_BIT(GPIOx->IDR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL) == ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_WriteOutputPort(GPIO_TypeDef * const GPIOx, uint32_t PortValue)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_ReadOutputPort(GPIO_TypeDef const * const GPIOx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsOutputPinSet(GPIO_TypeDef const * const GPIOx, uint32_t PinMask)
{
  return (READ_BIT(GPIOx->ODR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL) == ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL));
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetOutputPin(GPIO_TypeDef * const GPIOx, uint32_t PinMask)
{
  WRITE_REG(GPIOx->BSRR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_ResetOutputPin(GPIO_TypeDef * const GPIOx, uint32_t PinMask)
{
  WRITE_REG(GPIOx->BRR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_TogglePin(GPIO_TypeDef * const GPIOx, uint32_t PinMask)
{
  uint32_t odr = READ_REG(GPIOx->ODR);
  uint32_t pinmask = ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFUL);
...
{
  MODIFY_REG(AFIO->EXTICR[Line & 0xFFU], (Line >> 16U), Port << POSITION_VAL((Line >> 16U)));
}
...
{
  return (uint32_t)(READ_BIT(AFIO->EXTICR[Line & 0xFFU], (Line >> 16U)) >> POSITION_VAL(Line >> 16U));
}
