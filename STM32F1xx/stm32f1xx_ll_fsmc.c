                                     ...
                                     FSMC_NORSRAM_InitTypeDef const * const Init)
{
  ...
  mask |= 0x00070000UL; /* CPSIZE to be defined in CMSIS file */
                                      ...
                                      FSMC_NORSRAM_EXTENDED_TypeDef * const ExDevice, uint32_t Bank)
{
  ...
  {
    Device->BTCR[Bank] = 0x000030DBUL;
  }
  /* FSMC_NORSRAM_BANK2, FSMC_NORSRAM_BANK3 or FSMC_NORSRAM_BANK4 */
  else
  {
    Device->BTCR[Bank] = 0x000030D2UL;
  }

  Device->BTCR[Bank + 1U] = 0x0FFFFFFFUL;
  ExDevice->BWTR[Bank]   = 0x0FFFFFFFUL;
...
HAL_StatusTypeDef FSMC_NAND_DeInit(FSMC_NAND_TypeDef * const Device, uint32_t Bank)
{
  ...
  if (Bank == FSMC_NAND_BANK2)
  {
    ...
    WRITE_REG(Device->PCR2,  0x00000018UL);
    WRITE_REG(Device->SR2,   0x00000040UL);
    WRITE_REG(Device->PMEM2, 0xFCFCFCFCUL);
    WRITE_REG(Device->PATT2, 0xFCFCFCFCUL);
  }
  /* FSMC_Bank3_NAND */
  else
  {
    /* Set the FSMC_NAND_BANK3 registers to their reset values */
    WRITE_REG(Device->PCR3,  0x00000018UL);
    WRITE_REG(Device->SR3,   0x00000040UL);
    WRITE_REG(Device->PMEM3, 0xFCFCFCFCUL);
    WRITE_REG(Device->PATT3, 0xFCFCFCFCUL);
  }
...
HAL_StatusTypeDef FSMC_PCCARD_DeInit(FSMC_PCCARD_TypeDef * const Device)
{
  ...
  Device->PCR4    = 0x00000018UL;
  Device->SR4     = 0x00000040UL;
  Device->PMEM4   = 0xFCFCFCFCUL;
  Device->PATT4   = 0xFCFCFCFCUL;
  Device->PIO4    = 0xFCFCFCFCUL;
