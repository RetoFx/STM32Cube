...
/** @defgroup PCCARD_Private_Defines PCCARD Private Defines
  * @{
  */
#define PCCARD_TIMEOUT_READ_ID                 0x0000FFFFUL
#define PCCARD_TIMEOUT_READ_WRITE_SECTOR       0x0000FFFFUL
#define PCCARD_TIMEOUT_ERASE_SECTOR            0x00000400UL
#define PCCARD_TIMEOUT_STATUS                  0x01000000UL
...
/**
  ...
  * @retval None
  */
__weak void HAL_PCCARD_MspInit(PCCARD_HandleTypeDef * const hpccard)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_PCCARD_MspDeInit(PCCARD_HandleTypeDef * const hpccard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpccard);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
HAL_StatusTypeDef HAL_PCCARD_Read_ID(PCCARD_HandleTypeDef * const hpccard, uint8_t CompactFlash_ID[], uint8_t * const pStatus)
{
  ...
  *(__IO uint16_t *)(PCCARD_IO_SPACE_PRIMARY_ADDR | ATA_STATUS_CMD)  = (uint16_t)0xECECU;
                                         ...
                                         uint8_t * const pStatus)
{
  ...
  *(__IO uint16_t *)(PCCARD_IO_SPACE_PRIMARY_ADDR | ATA_CYLINDER_HIGH) = (uint16_t)0x0000U;
...
HAL_StatusTypeDef HAL_PCCARD_Reset(PCCARD_HandleTypeDef * const hpccard)
{
  ...
  /* Provide a SW reset and Read and verify the:
   - PCCard Configuration Option Register at address 0x98000200UL --> 0x80U
   - Card Configuration and Status Register at address 0x98000202UL --> 0x00U
   - Pin Replacement Register at address 0x98000204UL --> 0x0CU
   - Socket and Copy Register at address 0x98000206UL --> 0x00U
  */
...
/**
  ...
  * @retval None
  */
HAL_PCCARD_WEAK_CALLBACK(void, HAL_PCCARD_ITCallback)(PCCARD_HandleTypeDef * const hpccard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpccard);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @retval status
  */
HAL_StatusTypeDef HAL_PCCARD_UnRegisterCallback(PCCARD_HandleTypeDef * const hpccard, HAL_PCCARD_CallbackIDTypeDef CallbackId)
{
  HAL_StatusTypeDef status = HAL_OK;
