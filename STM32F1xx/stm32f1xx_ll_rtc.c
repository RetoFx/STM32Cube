...
#define RTC_ASYNCH_PRESC_DEFAULT     0x00007FFFUL
...
#define IS_LL_RTC_ASYNCH_PREDIV(__VALUE__)   ((__VALUE__) <= 0xFFFFFUL)
...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef * const RTCx)
{
  ...
  {
    LL_RTC_WriteReg(RTCx, CNTL, 0x0000U);
    LL_RTC_WriteReg(RTCx, CNTH, 0x0000U);
    LL_RTC_WriteReg(RTCx, PRLH, 0x0000U);
    LL_RTC_WriteReg(RTCx, PRLL, 0x8000U);
    LL_RTC_WriteReg(RTCx, CRH,  0x0000U);
    LL_RTC_WriteReg(RTCx, CRL,  0x0020U);

    /* Reset Tamper and alternate functions configuration register */
    LL_RTC_WriteReg(BKP, RTCCR, 0x00000000UL);
    LL_RTC_WriteReg(BKP, CR,    0x00000000UL);
    LL_RTC_WriteReg(BKP, CSR,   0x00000000UL);
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  TimeCounter this value can be from 0 to 0xFFFFFFFFUL
  * @retval An ErrorStatus enumeration value:
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  AlarmCounter this value can be from 0 to 0xFFFFFFFFUL
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: RTC exited from in Init mode
  *          - ERROR: Not applicable
  */
