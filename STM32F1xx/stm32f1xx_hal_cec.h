...
typedef struct __CEC_HandleTypeDef
{
  ...
  void (* TxCpltCallback)(struct __CEC_HandleTypeDef * const hcec); /*!< CEC Tx Transfer completed callback */
...
/** @defgroup CEC_Error_Code CEC Error Code
  * @{
  */
#define HAL_CEC_ERROR_NONE   0x00000000UL    /*!< no error */
...
#if (USE_HAL_CEC_REGISTER_CALLBACKS == 1U)
#define  HAL_CEC_ERROR_INVALID_CALLBACK ((uint32_t)0x00000080UL) /*!< Invalid Callback Error  */
#endif /* USE_HAL_CEC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup CEC_BitTimingErrorMode Bit Timing Error Mode
  * @{
  */
#define CEC_BIT_TIMING_ERROR_MODE_STANDARD  0x00000000UL      /*!< Bit timing error Standard Mode */
...
/** @defgroup CEC_BitPeriodErrorMode Bit Period Error Mode
  * @{
  */
#define CEC_BIT_PERIOD_ERROR_MODE_STANDARD 0x00000000UL      /*!< Bit period error Standard Mode */
...
#define __HAL_CEC_CLEAR_FLAG(__HANDLE__, __FLAG__)                                                                   \
  do {                                                                                       \
    uint32_t tmp = 0x0U;                                                                     \
    tmp = (__HANDLE__)->Instance->CSR & 0x00000002UL;                                         \
    (__HANDLE__)->Instance->CSR &= (uint32_t)(((~(uint32_t)(__FLAG__)) & 0xFFFFFFFCUL) | tmp); \
  } while(0U)
...
/** @brief Check CEC device Own Address Register (OAR) setting.
  ...
  * @retval Test result (TRUE or FALSE).
  */
#define IS_CEC_OWN_ADDRESS(__ADDRESS__) ((__ADDRESS__) <= 0x0000000FUL)
...
/** @brief Check CEC initiator or destination logical address setting.
  ...
  * @retval Test result (TRUE or FALSE).
  */
#define IS_CEC_ADDRESS(__ADDRESS__) ((__ADDRESS__) <= 0x0000000FUL)
/**
  * @}
  */
/* Private functions ---------------------------------------------------------*/
