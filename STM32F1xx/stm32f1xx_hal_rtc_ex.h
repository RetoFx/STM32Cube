...
#endif
#define IS_RTC_SMOOTH_CALIB_MINUS(__VALUE__) ((__VALUE__) <= 0x0000007FUL)
...
#define RTC_TAMPERTRIGGER_HIGHLEVEL         0x00000000UL           /*!< A low level on the TAMPER pin resets all data backup registers (if TPE bit is set) */
...
#if RTC_BKP_NUMBER > 10U
#define RTC_BKP_DR11                        0x00000010UL
#define RTC_BKP_DR12                        0x00000011UL
#define RTC_BKP_DR13                        0x00000012UL
#define RTC_BKP_DR14                        0x00000013UL
#define RTC_BKP_DR15                        0x00000014UL
#define RTC_BKP_DR16                        0x00000015UL
#define RTC_BKP_DR17                        0x00000016UL
#define RTC_BKP_DR18                        0x00000017UL
#define RTC_BKP_DR19                        0x00000018UL
#define RTC_BKP_DR20                        0x00000019UL
#define RTC_BKP_DR21                        0x0000001AUL
#define RTC_BKP_DR22                        0x0000001BUL
#define RTC_BKP_DR23                        0x0000001CUL
#define RTC_BKP_DR24                        0x0000001DUL
#define RTC_BKP_DR25                        0x0000001EUL
#define RTC_BKP_DR26                        0x0000001FUL
#define RTC_BKP_DR27                        0x00000020UL
#define RTC_BKP_DR28                        0x00000021UL
#define RTC_BKP_DR29                        0x00000022UL
#define RTC_BKP_DR30                        0x00000023UL
#define RTC_BKP_DR31                        0x00000024UL
#define RTC_BKP_DR32                        0x00000025UL
#define RTC_BKP_DR33                        0x00000026UL
#define RTC_BKP_DR34                        0x00000027UL
#define RTC_BKP_DR35                        0x00000028UL
#define RTC_BKP_DR36                        0x00000029UL
#define RTC_BKP_DR37                        0x0000002AUL
#define RTC_BKP_DR38                        0x0000002BUL
#define RTC_BKP_DR39                        0x0000002CUL
#define RTC_BKP_DR40                        0x0000002DUL
#define RTC_BKP_DR41                        0x0000002EUL
#define RTC_BKP_DR42                        0x0000002FUL
...
/** @addtogroup RTCEx_Exported_Functions_Group2
  * @{
  */
HAL_StatusTypeDef HAL_RTCEx_SetSecond_IT(RTC_HandleTypeDef * const hrtc);
HAL_StatusTypeDef HAL_RTCEx_DeactivateSecond(RTC_HandleTypeDef * const hrtc);
void              HAL_RTCEx_RTCIRQHandler(RTC_HandleTypeDef * const hrtc);
void              HAL_RTCEx_RTCEventCallback(RTC_HandleTypeDef * const hrtc);
void              HAL_RTCEx_RTCEventErrorCallback(RTC_HandleTypeDef * const hrtc);
...
HAL_StatusTypeDef HAL_RTCEx_SetSmoothCalib(RTC_HandleTypeDef * const hrtc, uint32_t SmoothCalibPeriod, uint32_t SmoothCalibPlusPulses, uint32_t SmouthCalibMinusPulsesValue);
/**
  * @}
  */
