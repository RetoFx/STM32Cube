...
/** @defgroup FSMC_NORSRAM_Bank FSMC NOR/SRAM Bank
  * @{
  */
#define FSMC_NORSRAM_BANK1                       (0x00000000UL)
#define FSMC_NORSRAM_BANK2                       (0x00000002UL)
#define FSMC_NORSRAM_BANK3                       (0x00000004UL)
#define FSMC_NORSRAM_BANK4                       (0x00000006UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Data_Address_Bus_Multiplexing FSMC Data Address Bus Multiplexing
  * @{
  */
#define FSMC_DATA_ADDRESS_MUX_DISABLE            (0x00000000UL)
#define FSMC_DATA_ADDRESS_MUX_ENABLE             (0x00000002UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Memory_Type FSMC Memory Type
  * @{
  */
#define FSMC_MEMORY_TYPE_SRAM                    (0x00000000UL)
#define FSMC_MEMORY_TYPE_PSRAM                   (0x00000004UL)
#define FSMC_MEMORY_TYPE_NOR                     (0x00000008UL)
/**
  * @}
  */
...
/** @defgroup FSMC_NORSRAM_Data_Width FSMC NORSRAM Data Width
  * @{
  */
#define FSMC_NORSRAM_MEM_BUS_WIDTH_8             (0x00000000UL)
#define FSMC_NORSRAM_MEM_BUS_WIDTH_16            (0x00000010UL)
#define FSMC_NORSRAM_MEM_BUS_WIDTH_32            (0x00000020UL)
/**
  * @}
  */
...
/** @defgroup FSMC_NORSRAM_Flash_Access FSMC NOR/SRAM Flash Access
  * @{
  */
#define FSMC_NORSRAM_FLASH_ACCESS_ENABLE         (0x00000040UL)
#define FSMC_NORSRAM_FLASH_ACCESS_DISABLE        (0x00000000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Burst_Access_Mode FSMC Burst Access Mode
  * @{
  */
#define FSMC_BURST_ACCESS_MODE_DISABLE           (0x00000000UL)
#define FSMC_BURST_ACCESS_MODE_ENABLE            (0x00000100UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Wait_Signal_Polarity FSMC Wait Signal Polarity
  * @{
  */
#define FSMC_WAIT_SIGNAL_POLARITY_LOW            (0x00000000UL)
#define FSMC_WAIT_SIGNAL_POLARITY_HIGH           (0x00000200UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Wrap_Mode FSMC Wrap Mode
  * @{
  */
#define FSMC_WRAP_MODE_DISABLE                   (0x00000000UL)
#define FSMC_WRAP_MODE_ENABLE                    (0x00000400UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Wait_Timing FSMC Wait Timing
  * @{
  */
#define FSMC_WAIT_TIMING_BEFORE_WS               (0x00000000UL)
#define FSMC_WAIT_TIMING_DURING_WS               (0x00000800UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Write_Operation FSMC Write Operation
  * @{
  */
#define FSMC_WRITE_OPERATION_DISABLE             (0x00000000UL)
#define FSMC_WRITE_OPERATION_ENABLE              (0x00001000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Wait_Signal FSMC Wait Signal
  * @{
  */
#define FSMC_WAIT_SIGNAL_DISABLE                 (0x00000000UL)
#define FSMC_WAIT_SIGNAL_ENABLE                  (0x00002000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Extended_Mode FSMC Extended Mode
  * @{
  */
#define FSMC_EXTENDED_MODE_DISABLE               (0x00000000UL)
#define FSMC_EXTENDED_MODE_ENABLE                (0x00004000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_AsynchronousWait FSMC Asynchronous Wait
  * @{
  */
#define FSMC_ASYNCHRONOUS_WAIT_DISABLE           (0x00000000UL)
#define FSMC_ASYNCHRONOUS_WAIT_ENABLE            (0x00008000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Page_Size FSMC Page Size
  * @{
  */
#define FSMC_PAGE_SIZE_NONE                      (0x00000000UL)
#define FSMC_PAGE_SIZE_128                       (0x00010000UL)
#define FSMC_PAGE_SIZE_256                       (0x00020000UL)
#define FSMC_PAGE_SIZE_512                       (0x00030000UL)
#define FSMC_PAGE_SIZE_1024                      (0x00040000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Write_Burst FSMC Write Burst
  * @{
  */
#define FSMC_WRITE_BURST_DISABLE                 (0x00000000UL)
#define FSMC_WRITE_BURST_ENABLE                  (0x00080000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Continous_Clock FSMC Continuous Clock
  * @{
  */
#define FSMC_CONTINUOUS_CLOCK_SYNC_ONLY          (0x00000000UL)
#define FSMC_CONTINUOUS_CLOCK_SYNC_ASYNC         (0x00100000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Access_Mode FSMC Access Mode
  * @{
  */
#define FSMC_ACCESS_MODE_A                       (0x00000000UL)
#define FSMC_ACCESS_MODE_B                       (0x10000000UL)
#define FSMC_ACCESS_MODE_C                       (0x20000000UL)
#define FSMC_ACCESS_MODE_D                       (0x30000000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_NAND_Bank FSMC NAND Bank
  * @{
  */
#define FSMC_NAND_BANK2                          (0x00000010UL)
#define FSMC_NAND_BANK3                          (0x00000100UL)
/**
  * @}
  */
...
/** @defgroup FSMC_Wait_feature FSMC Wait feature
  * @{
  */
#define FSMC_NAND_PCC_WAIT_FEATURE_DISABLE       (0x00000000UL)
#define FSMC_NAND_PCC_WAIT_FEATURE_ENABLE        (0x00000002UL)
/**
  * @}
  */
...
/** @defgroup FSMC_PCR_Memory_Type FSMC PCR Memory Type
  ...
  */
#if defined(FSMC_BANK4)
#define FSMC_PCR_MEMORY_TYPE_PCCARD              (0x00000000UL)
#endif /* FSMC_BANK4 */
#define FSMC_PCR_MEMORY_TYPE_NAND                (0x00000008UL)
/**
  * @}
  */
...
/** @defgroup FSMC_NAND_Data_Width FSMC NAND Data Width
  * @{
  */
#define FSMC_NAND_PCC_MEM_BUS_WIDTH_8            (0x00000000UL)
#define FSMC_NAND_PCC_MEM_BUS_WIDTH_16           (0x00000010UL)
/**
  * @}
  */
...
/** @defgroup FSMC_ECC FSMC ECC
  * @{
  */
#define FSMC_NAND_ECC_DISABLE                    (0x00000000UL)
#define FSMC_NAND_ECC_ENABLE                     (0x00000040UL)
/**
  * @}
  */
...
/** @defgroup FSMC_ECC_Page_Size FSMC ECC Page Size
  * @{
  */
#define FSMC_NAND_ECC_PAGE_SIZE_256BYTE          (0x00000000UL)
#define FSMC_NAND_ECC_PAGE_SIZE_512BYTE          (0x00020000UL)
#define FSMC_NAND_ECC_PAGE_SIZE_1024BYTE         (0x00040000UL)
#define FSMC_NAND_ECC_PAGE_SIZE_2048BYTE         (0x00060000UL)
#define FSMC_NAND_ECC_PAGE_SIZE_4096BYTE         (0x00080000UL)
#define FSMC_NAND_ECC_PAGE_SIZE_8192BYTE         (0x000A0000UL)
/**
  * @}
  */
...
/** @defgroup FSMC_LL_Interrupt_definition FSMC Low Layer Interrupt definition
  ...
  */
#if defined(FSMC_BANK3) || defined(FSMC_BANK4)
#define FSMC_IT_RISING_EDGE                      (0x00000008UL)
#define FSMC_IT_LEVEL                            (0x00000010UL)
#define FSMC_IT_FALLING_EDGE                     (0x00000020UL)
#endif /* FSMC_BANK3 || FSMC_Bank4 */
/**
  * @}
  */
...
/** @defgroup FSMC_LL_Flag_definition FSMC Low Layer Flag definition
  ...
  */
#if defined(FSMC_BANK3) || defined(FSMC_BANK4)
#define FSMC_FLAG_RISING_EDGE                    (0x00000001UL)
#define FSMC_FLAG_LEVEL                          (0x00000002UL)
#define FSMC_FLAG_FALLING_EDGE                   (0x00000004UL)
#define FSMC_FLAG_FEMPT                          (0x00000040UL)
#endif /* FSMC_BANK3 || FSMC_Bank4 */
/**
  * @}
  */
...
/** @defgroup FSMC_LL_NORSRAM_Private_Functions_Group1 NOR SRAM Initialization/de-initialization functions
  *  @{
  */
HAL_StatusTypeDef  FSMC_NORSRAM_Init(FSMC_NORSRAM_TypeDef * const Device,
                                     FSMC_NORSRAM_InitTypeDef const * const Init);
HAL_StatusTypeDef  FSMC_NORSRAM_Timing_Init(FSMC_NORSRAM_TypeDef * const Device,
                                            FSMC_NORSRAM_TimingTypeDef const * const Timing, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NORSRAM_Extended_Timing_Init(FSMC_NORSRAM_EXTENDED_TypeDef * const Device,
                                                     FSMC_NORSRAM_TimingTypeDef const * const Timing, uint32_t Bank,
                                                     uint32_t ExtendedMode);
HAL_StatusTypeDef  FSMC_NORSRAM_DeInit(FSMC_NORSRAM_TypeDef * const Device,
                                       FSMC_NORSRAM_EXTENDED_TypeDef * const ExDevice, uint32_t Bank);
/**
  * @}
  */
...
/** @defgroup FSMC_LL_NORSRAM_Private_Functions_Group2 NOR SRAM Control functions
  *  @{
  */
HAL_StatusTypeDef  FSMC_NORSRAM_WriteOperation_Enable(FSMC_NORSRAM_TypeDef * const Device, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NORSRAM_WriteOperation_Disable(FSMC_NORSRAM_TypeDef * const Device, uint32_t Bank);
/**
  * @}
  */
/**
...
/** @defgroup FSMC_LL_NAND_Private_Functions_Group1 NAND Initialization/de-initialization functions
  *  @{
  */
HAL_StatusTypeDef  FSMC_NAND_Init(FSMC_NAND_TypeDef * const Device, FSMC_NAND_InitTypeDef const * const Init);
HAL_StatusTypeDef  FSMC_NAND_CommonSpace_Timing_Init(FSMC_NAND_TypeDef * const Device,
                                                     FSMC_NAND_PCC_TimingTypeDef const * const Timing, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NAND_AttributeSpace_Timing_Init(FSMC_NAND_TypeDef * const Device,
                                                        FSMC_NAND_PCC_TimingTypeDef const * const Timing, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NAND_DeInit(FSMC_NAND_TypeDef * const Device, uint32_t Bank);
/**
  * @}
  */
...
/** @defgroup FSMC_LL_NAND_Private_Functions_Group2 NAND Control functions
  *  @{
  */
HAL_StatusTypeDef  FSMC_NAND_ECC_Enable(FSMC_NAND_TypeDef * const Device, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NAND_ECC_Disable(FSMC_NAND_TypeDef * const Device, uint32_t Bank);
HAL_StatusTypeDef  FSMC_NAND_GetECC(FSMC_NAND_TypeDef const * const Device, uint32_t * const ECCval, uint32_t Bank,
                                    uint32_t Timeout);
/**
  * @}
  */
...
/** @defgroup FSMC_LL_PCCARD_Private_Functions_Group1 PCCARD Initialization/de-initialization functions
  *  @{
  */
HAL_StatusTypeDef  FSMC_PCCARD_Init(FSMC_PCCARD_TypeDef * const Device, FSMC_PCCARD_InitTypeDef const * const Init);
HAL_StatusTypeDef  FSMC_PCCARD_CommonSpace_Timing_Init(FSMC_PCCARD_TypeDef * const Device,
                                                       FSMC_NAND_PCC_TimingTypeDef const * const Timing);
HAL_StatusTypeDef  FSMC_PCCARD_AttributeSpace_Timing_Init(FSMC_PCCARD_TypeDef * const Device,
                                                          FSMC_NAND_PCC_TimingTypeDef const * const Timing);
HAL_StatusTypeDef  FSMC_PCCARD_IOSpace_Timing_Init(FSMC_PCCARD_TypeDef * const Device,
                                                   FSMC_NAND_PCC_TimingTypeDef const * const Timing);
HAL_StatusTypeDef  FSMC_PCCARD_DeInit(FSMC_PCCARD_TypeDef * const Device);
/**
  * @}
  */
/**
