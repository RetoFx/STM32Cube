...
/** @addtogroup STM32F1xx_System_Private_Variables
  ...
  */
  ...
  uint32_t SystemCoreClock         = 24000000UL;        /*!< System Clock Frequency (Core Clock) */
...
void SystemInit (void)
{
 ...
 #define  RCC_CFGR_USBPRE                    0x00400000U        /*!< USB Device prescaler */
#endif
  /*
...
{
  uint32_t tmp = 0UL;
  uint32_t pllmull = 0UL;
  uint32_t pllsource = 0UL;

#if defined(STM32F105xC) || defined(STM32F107xC)
  uint32_t prediv1source = 0UL;
  uint32_t prediv1factor = 0UL;
  uint32_t prediv2factor = 0UL;
  uint32_t pll2mull = 0UL;
#endif /* STM32F105xC */
  ...
  switch (tmp)
  {
    ...
    case RCC_CFGR_SWS_PLL:  /* PLL used as system clock */
      ...
      {
 #if defined(STM32F100xB) || defined(STM32F100xE)
       prediv1factor = (RCC->CFGR2 & RCC_CFGR2_PREDIV1) + 1UL;
...
void SystemInit_ExtMemCtl(void)
{
  ...
  /* Enable FSMC clock */
  RCC->AHBENR = 0x00000114UL;

  /* Delay after an RCC peripheral clock enabling */
  tmpreg = READ_BIT(RCC->AHBENR, RCC_AHBENR_FSMCEN);

  /* Enable GPIOD, GPIOE, GPIOF and GPIOG clocks */
  RCC->APB2ENR = 0x000001E0UL;
...
/*----------------  NBL0, NBL1 configuration ---------------------------------*/
  ...
  GPIOD->CRL = 0x44BB44BBUL;
  GPIOD->CRH = 0xBBBBBBBBUL;

  GPIOE->CRL = 0xB44444BBUL;
  GPIOE->CRH = 0xBBBBBBBBUL;

  GPIOF->CRL = 0x44BBBBBBUL;
  GPIOF->CRH = 0xBBBB4444UL;

  GPIOG->CRL = 0x44BBBBBBUL;
  GPIOG->CRH = 0x444B4B44UL;

/*----------------  FSMC Configuration ---------------------------------------*/
/*----------------  Enable FSMC Bank1_SRAM Bank ------------------------------*/

  FSMC_Bank1->BTCR[4U] = 0x00001091UL;
  FSMC_Bank1->BTCR[5U] = 0x00110212UL;
}
#endif /* DATA_IN_ExtSRAM */
#endif /* STM32F100xE || STM32F101xE || STM32F101xG || STM32F103xE || STM32F103xG */
