...
/**
  ...
  * @retval None
  */
HAL_RTCEX_WEAK_CALLBACK(void, HAL_RTCEx_RTCEventCallback)(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_RTCEX_WEAK_CALLBACK(void, HAL_RTCEx_RTCEventErrorCallback)(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
  /* NOTE : This function Should not be modified, when the callback is needed,
