...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1       0x00000000UL                                              /*!< ADC group regular conversion trigger from external IP: TIM1 channel 1 event (capture compare: input capture or output capture). Trigger edge set to rising edge (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO      0x00000000UL                                                 /*!< ADC group injected conversion trigger from external IP: TIM1 TRGO. Trigger edge set to rising edge (default setting). */
...
/**
  ...
  * @retval Value between Min_Data=0x00000000UL and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(ADC_TypeDef const * const ADCx, uint32_t ConversionData)
{
