...
#define IS_RTC_ASYNCH_PREDIV(PREDIV)  (((PREDIV) <= 0xFFFFFUL) || ((PREDIV) == RTC_AUTO_1_SECOND))
...
typedef struct
{
  uint32_t AsynchPrediv;    /*!< Specifies the RTC Asynchronous Predivider value.
                                 This parameter must be a number between Min_Data = 0x00U and Max_Data = 0xFFFFFUL  or RTC_AUTO_1_SECOND
...
/** @defgroup RTC_Automatic_Prediv_1_Second Automatic calculation of prediv for 1sec timebase
  * @{
  */
#define RTC_AUTO_1_SECOND                      0xFFFFFFFFUL
...
#define RTC_OUTPUTSOURCE_NONE               0x00000000UL                       /*!< No output on the TAMPER pin  */
...
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef * const hrtc, RTC_TimeTypeDef * const sTime, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_SetDate(RTC_HandleTypeDef * const hrtc, RTC_DateTypeDef * const sDate, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef * const hrtc, RTC_DateTypeDef * const sDate, uint32_t Format);
/**
  * @}
  */
