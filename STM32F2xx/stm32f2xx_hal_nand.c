...
/**
  ...
  * @retval None
  */
__weak void HAL_NAND_MspInit(NAND_HandleTypeDef * const hnand)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_NAND_MspDeInit(NAND_HandleTypeDef * const hnand)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hnand);
...
/**
  ...
  * @retval None
  */
HAL_NAND_WEAK_CALLBACK(void, HAL_NAND_ITCallback)(NAND_HandleTypeDef * const hnand)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hnand);
