...
/**
  ...
  */
typedef void (*pDCMI_CallbackTypeDef)(DCMI_HandleTypeDef * const hdcmi); /*!< pointer to a DCMI callback function */
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
...
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
#define HAL_DCMI_ERROR_INVALID_CALLBACK (0x00000080UL)  /*!< Invalid callback error */
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
/**
  * @}
  */
...
#define __HAL_DCMI_GET_FLAG(__HANDLE__, __FLAG__) \
  ((((__FLAG__) & (DCMI_SR_INDEX|DCMI_MIS_INDEX)) == 0x0U) ? ((__HANDLE__)->Instance->RIS & (__FLAG__)) : \
   (((__FLAG__) & DCMI_SR_INDEX) == 0x0U) ? ((__HANDLE__)->Instance->MIS & (__FLAG__)) : \
...
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_DCMI_RegisterCallback(DCMI_HandleTypeDef * const hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID,
...
HAL_StatusTypeDef     HAL_DCMI_ConfigCrop(DCMI_HandleTypeDef * const hdcmi, uint32_t X0, uint32_t Y0, uint32_t XSize,
                                          uint32_t YSize);
