...
#define NOR_CMD_ADDRESS_FIRST_BYTE            (uint16_t)0x0AAAU
#define NOR_CMD_ADDRESS_FIRST_CFI_BYTE        ((uint16_t)0x00AAU)
#define NOR_CMD_ADDRESS_SECOND_BYTE           ((uint16_t)0x0555U)
#define NOR_CMD_ADDRESS_THIRD_BYTE            (uint16_t)0x0AAAU
...
#define NOR_CMD_READ_ARRAY                    ((uint16_t)0x00FFU)
#define NOR_CMD_WORD_PROGRAM                  ((uint16_t)0x0040U)
#define NOR_CMD_BUFFERED_PROGRAM              (uint16_t)0x00E8U
#define NOR_CMD_CONFIRM                       (uint16_t)0x00D0U
#define NOR_CMD_BLOCK_ERASE                   ((uint16_t)0x0020U)
#define NOR_CMD_BLOCK_UNLOCK                  (uint16_t)0x0060U
#define NOR_CMD_READ_STATUS_REG               (uint16_t)0x0070U
#define NOR_CMD_CLEAR_STATUS_REG              (uint16_t)0x0050U

/* Mask on NOR STATUS REGISTER */
#define NOR_MASK_STATUS_DQ4                   ((uint16_t)0x0010U)
#define NOR_MASK_STATUS_DQ5                   ((uint16_t)0x0020U)
#define NOR_MASK_STATUS_DQ6                   ((uint16_t)0x0040U)
#define NOR_MASK_STATUS_DQ7                   ((uint16_t)0x0080U)

/* Address of the primary command set */
#define NOR_ADDRESS_COMMAND_SET               (uint16_t)0x0013U

/* Command set code assignment (defined in JEDEC JEP137B version may 2004) */
#define NOR_INTEL_SHARP_EXT_COMMAND_SET       (uint16_t)0x0001U /* Supported in this driver */
#define NOR_AMD_FUJITSU_COMMAND_SET           (uint16_t)0x0002U /* Supported in this driver */
#define NOR_INTEL_STANDARD_COMMAND_SET        (uint16_t)0x0003U /* Not Supported in this driver */
#define NOR_AMD_FUJITSU_EXT_COMMAND_SET       (uint16_t)0x0004U /* Not Supported in this driver */
#define NOR_WINDBOND_STANDARD_COMMAND_SET     (uint16_t)0x0006U /* Not Supported in this driver */
#define NOR_MITSUBISHI_STANDARD_COMMAND_SET   (uint16_t)0x0100U /* Not Supported in this driver */
#define NOR_MITSUBISHI_EXT_COMMAND_SET        (uint16_t)0x0101U /* Not Supported in this driver */
#define NOR_PAGE_WRITE_COMMAND_SET            (uint16_t)0x0102U /* Not Supported in this driver */
#define NOR_INTEL_PERFORMANCE_COMMAND_SET     (uint16_t)0x0200U /* Not Supported in this driver */
#define NOR_INTEL_DATA_COMMAND_SET            (uint16_t)0x0210U /* Not Supported in this driver */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Init(NOR_HandleTypeDef * const hnor, FSMC_NORSRAM_TimingTypeDef const * const Timing,
                               FSMC_NORSRAM_TimingTypeDef const * const ExtTiming)
{
...
#if (USE_HAL_NOR_REGISTER_CALLBACKS == 1U)
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_DeInit(NOR_HandleTypeDef * const hnor)
{
#if (USE_HAL_NOR_REGISTER_CALLBACKS == 1U)
...
/**
  ...
  * @retval None
  */
__weak void HAL_NOR_MspInit(NOR_HandleTypeDef * const hnor)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_NOR_MspDeInit(NOR_HandleTypeDef * const hnor)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hnor);
...
/**
  ...
  * @retval None
  */
__weak void HAL_NOR_MspWait(NOR_HandleTypeDef const * const hnor, uint32_t Timeout)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hnor);
  UNUSED(Timeout);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Read_ID(NOR_HandleTypeDef * const hnor, NOR_IDTypeDef * const pNOR_ID)
{
  uint32_t deviceaddress;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_ReturnToReadMode(NOR_HandleTypeDef * const hnor)
{
  uint32_t deviceaddress;
  HAL_NOR_StateTypeDef state;
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Read(NOR_HandleTypeDef * const hnor, uint32_t const * const pAddress, uint16_t * const pData)
{
  uint32_t deviceaddress;
  HAL_NOR_StateTypeDef state;
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Program(NOR_HandleTypeDef * const hnor, uint32_t const * const pAddress, uint16_t * const pData)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_ReadBuffer(NOR_HandleTypeDef * const hnor, uint32_t uwAddress, uint16_t * const pData,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_ProgramBuffer(NOR_HandleTypeDef * const hnor, uint32_t uwAddress, uint16_t const * const pData,
                                        uint32_t uwBufferSize)
{
  uint16_t * p_currentaddress;
  uint16_t const * p_endaddress;
  uint16_t const * data = pData;
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Erase_Block(NOR_HandleTypeDef * const hnor, uint32_t BlockAddress, uint32_t Address)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Erase_Chip(NOR_HandleTypeDef * const hnor, uint32_t Address)
{
  uint32_t deviceaddress;
  HAL_StatusTypeDef status = HAL_OK;
  UNUSED(Address);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Read_CFI(NOR_HandleTypeDef * const hnor, NOR_CFITypeDef * const pNOR_CFI)
{
  uint32_t deviceaddress;
  HAL_NOR_StateTypeDef state;
...
/**
  ...
  * @retval status
  */
HAL_StatusTypeDef HAL_NOR_RegisterCallback(NOR_HandleTypeDef * const hnor, HAL_NOR_CallbackIDTypeDef CallbackId,
...
/**
  ...
  * @retval status
  */
HAL_StatusTypeDef HAL_NOR_UnRegisterCallback(NOR_HandleTypeDef * const hnor, HAL_NOR_CallbackIDTypeDef CallbackId)
{
  HAL_StatusTypeDef status = HAL_OK;
  HAL_NOR_StateTypeDef state;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_WriteOperation_Enable(NOR_HandleTypeDef * const hnor)
{
  /* Check the NOR controller state */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_WriteOperation_Disable(NOR_HandleTypeDef * const hnor)
{
  /* Check the NOR controller state */
...
/**
  ...
  */
HAL_NOR_StateTypeDef HAL_NOR_GetState(NOR_HandleTypeDef const * const hnor)
{
  return hnor->State;
}
...
/**
  ...
  */
HAL_NOR_StatusTypeDef HAL_NOR_GetStatus(NOR_HandleTypeDef const * const hnor, uint32_t Address, uint32_t Timeout)
{
