...
HAL_StatusTypeDef HAL_HASH_SHA1_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                      uint8_t * const pOutBuffer,
                                      uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_MD5_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                     uint8_t * const pOutBuffer,
                                     uint32_t Timeout);
...
HAL_StatusTypeDef HAL_HMAC_SHA1_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                      uint8_t * const pOutBuffer,
                                      uint32_t Timeout);
HAL_StatusTypeDef HAL_HMAC_MD5_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                     uint8_t * const pOutBuffer,
                                     uint32_t Timeout);
...
/* Private functions */
HAL_StatusTypeDef HASH_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                             uint8_t * const pOutBuffer,
                             uint32_t Timeout, uint32_t Algorithm);
HAL_StatusTypeDef HASH_Accumulate(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                  uint32_t Algorithm);
HAL_StatusTypeDef HASH_Accumulate_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                     uint32_t Algorithm);
HAL_StatusTypeDef HASH_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                uint8_t * const pOutBuffer,
                                uint32_t Algorithm);
HAL_StatusTypeDef HASH_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                 uint32_t Algorithm);
HAL_StatusTypeDef HASH_Finish(HASH_HandleTypeDef * const hhash, uint8_t * const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HMAC_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                             uint8_t * const pOutBuffer,
                             uint32_t Timeout, uint32_t Algorithm);
HAL_StatusTypeDef HMAC_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                uint8_t * const pOutBuffer,
                                uint32_t Algorithm);
HAL_StatusTypeDef HMAC_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                 uint32_t Algorithm);
