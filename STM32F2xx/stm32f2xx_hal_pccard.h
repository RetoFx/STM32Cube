...
/**
  ...
  */
#if (USE_HAL_PCCARD_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_PCCARD_REGISTER_CALLBACKS == 1U)
  void (* MspInitCallback)(struct __PCCARD_HandleTypeDef * const hpccard);               /*!< PCCARD Msp Init callback              */
  void (* MspDeInitCallback)(struct __PCCARD_HandleTypeDef * const hpccard);             /*!< PCCARD Msp DeInit callback            */
  void (* ItCallback)(struct __PCCARD_HandleTypeDef * const hpccard);                    /*!< PCCARD IT callback                    */
#endif /* USE_HAL_PCCARD_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef void (*pPCCARD_CallbackTypeDef)(PCCARD_HandleTypeDef * const hpccard);
#endif /* USE_HAL_PCCARD_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef  HAL_PCCARD_Init(PCCARD_HandleTypeDef * const hpccard, FSMC_NAND_PCC_TimingTypeDef const * const ComSpaceTiming,
                                   FSMC_NAND_PCC_TimingTypeDef const * const AttSpaceTiming,
                                   FSMC_NAND_PCC_TimingTypeDef const * const IOSpaceTiming);
HAL_StatusTypeDef  HAL_PCCARD_DeInit(PCCARD_HandleTypeDef * const hpccard);
void HAL_PCCARD_MspInit(PCCARD_HandleTypeDef * const hpccard);
void HAL_PCCARD_MspDeInit(PCCARD_HandleTypeDef * const hpccard);
/**
  * @}
  */
...
HAL_StatusTypeDef  HAL_PCCARD_Read_ID(PCCARD_HandleTypeDef * const hpccard, uint8_t CompactFlash_ID[], uint8_t * const pStatus);
HAL_StatusTypeDef  HAL_PCCARD_Write_Sector(PCCARD_HandleTypeDef * const hpccard, uint16_t const * pBuffer, uint16_t SectorAddress,
                                           uint8_t * const pStatus);
HAL_StatusTypeDef  HAL_PCCARD_Read_Sector(PCCARD_HandleTypeDef * const hpccard, uint16_t * pBuffer, uint16_t SectorAddress,
                                          uint8_t * const pStatus);
HAL_StatusTypeDef  HAL_PCCARD_Erase_Sector(PCCARD_HandleTypeDef * const hpccard, uint16_t SectorAddress, uint8_t * const pStatus);
HAL_StatusTypeDef  HAL_PCCARD_Reset(PCCARD_HandleTypeDef * const hpccard);
void               HAL_PCCARD_IRQHandler(PCCARD_HandleTypeDef * const hpccard);
void               HAL_PCCARD_ITCallback(PCCARD_HandleTypeDef * const hpccard);

#if (USE_HAL_PCCARD_REGISTER_CALLBACKS == 1U)
/* PCCARD callback registering/unregistering */
HAL_StatusTypeDef  HAL_PCCARD_RegisterCallback(PCCARD_HandleTypeDef * const hpccard, HAL_PCCARD_CallbackIDTypeDef CallbackId,
                                               pPCCARD_CallbackTypeDef pCallback);
HAL_StatusTypeDef  HAL_PCCARD_UnRegisterCallback(PCCARD_HandleTypeDef * const hpccard,
...
HAL_PCCARD_StateTypeDef  HAL_PCCARD_GetState(PCCARD_HandleTypeDef const * const hpccard);
HAL_PCCARD_StatusTypeDef HAL_PCCARD_GetStatus(PCCARD_HandleTypeDef const * const hpccard);
HAL_PCCARD_StatusTypeDef HAL_PCCARD_ReadStatus(PCCARD_HandleTypeDef const * const hpccard);
/**
  * @}
  */
...
/** @defgroup PCCARD_Private_Constants PCCARD Private Constants
  * @{
  */
#define PCCARD_DEVICE_ADDRESS             0x90000000UL
#define PCCARD_ATTRIBUTE_SPACE_ADDRESS    0x98000000UL              /* Attribute space size to @0x9BFFU FFFF */
#define PCCARD_COMMON_SPACE_ADDRESS       PCCARD_DEVICE_ADDRESS    /* Common space size to @0x93FFU FFFF    */
#define PCCARD_IO_SPACE_ADDRESS           0x9C000000UL              /* IO space size to @0x9FFFU FFFF        */
#define PCCARD_IO_SPACE_PRIMARY_ADDR      0x9C0001F0UL              /* IO space size to @0x9FFFU FFFF        */
