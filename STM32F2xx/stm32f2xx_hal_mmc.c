...
static uint32_t MMC_ReadExtCSD(MMC_HandleTypeDef * const hmmc, uint32_t * const pFieldData, uint16_t FieldIndex, uint32_t Timeout);
...
static uint32_t MMC_PwrClassUpdate(MMC_HandleTypeDef * const hmmc, uint32_t Wide);
/**
  * @}
  */
/* Exported functions --------------------------------------------------------*/
