...
#define RCC_PLLP_DIV4                  0x00000004UL
#define RCC_PLLP_DIV6                  0x00000006UL
#define RCC_PLLP_DIV8                  0x00000008UL
/**
  * @}
  */
...
/** @defgroup RCC_RTC_Clock_Source RTC Clock Source
  * @{
  */
#define RCC_RTCCLKSOURCE_NO_CLK          0x00000000UL
#define RCC_RTCCLKSOURCE_LSE             0x00000100UL
#define RCC_RTCCLKSOURCE_LSI             0x00000200UL
#define RCC_RTCCLKSOURCE_HSE_DIVX        0x00000300UL
#define RCC_RTCCLKSOURCE_HSE_DIV2        0x00020300UL
#define RCC_RTCCLKSOURCE_HSE_DIV3        0x00030300UL
#define RCC_RTCCLKSOURCE_HSE_DIV4        0x00040300UL
#define RCC_RTCCLKSOURCE_HSE_DIV5        0x00050300UL
#define RCC_RTCCLKSOURCE_HSE_DIV6        0x00060300UL
#define RCC_RTCCLKSOURCE_HSE_DIV7        0x00070300UL
#define RCC_RTCCLKSOURCE_HSE_DIV8        0x00080300UL
#define RCC_RTCCLKSOURCE_HSE_DIV9        0x00090300UL
#define RCC_RTCCLKSOURCE_HSE_DIV10       0x000A0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV11       0x000B0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV12       0x000C0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV13       0x000D0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV14       0x000E0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV15       0x000F0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV16       0x00100300UL
#define RCC_RTCCLKSOURCE_HSE_DIV17       0x00110300UL
#define RCC_RTCCLKSOURCE_HSE_DIV18       0x00120300UL
#define RCC_RTCCLKSOURCE_HSE_DIV19       0x00130300UL
#define RCC_RTCCLKSOURCE_HSE_DIV20       0x00140300UL
#define RCC_RTCCLKSOURCE_HSE_DIV21       0x00150300UL
#define RCC_RTCCLKSOURCE_HSE_DIV22       0x00160300UL
#define RCC_RTCCLKSOURCE_HSE_DIV23       0x00170300UL
#define RCC_RTCCLKSOURCE_HSE_DIV24       0x00180300UL
#define RCC_RTCCLKSOURCE_HSE_DIV25       0x00190300UL
#define RCC_RTCCLKSOURCE_HSE_DIV26       0x001A0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV27       0x001B0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV28       0x001C0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV29       0x001D0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV30       0x001E0300UL
#define RCC_RTCCLKSOURCE_HSE_DIV31       0x001F0300UL
/**
  * @}
  */
...
/** @defgroup RCC_MCO1_Clock_Source MCO1 Clock Source
  * @{
  */
#define RCC_MCO1SOURCE_HSI               0x00000000UL
...
/** @defgroup RCC_MCOx_Clock_Prescaler MCOx Clock Prescaler
  * @{
  */
#define RCC_MCODIV_1                    0x00000000UL
...
/** @defgroup RCC_AHB1_Force_Release_Reset AHB1 Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_AHB1_FORCE_RESET()         (RCC->AHB1RSTR = 0xFFFFFFFFUL)
...
/** @defgroup RCC_AHB2_Force_Release_Reset AHB2 Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_AHB2_FORCE_RESET()         (RCC->AHB2RSTR = 0xFFFFFFFFUL)
...
/** @defgroup RCC_APB1_Force_Release_Reset APB1 Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_APB1_FORCE_RESET()     (RCC->APB1RSTR = 0xFFFFFFFFUL)
...
/** @defgroup RCC_APB2_Force_Release_Reset APB2 Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_APB2_FORCE_RESET()     (RCC->APB2RSTR = 0xFFFFFFFFUL)
...
/** @brief  Macros to enable or disable the Internal High Speed oscillator (HSI).
  ...
  *         clock cycles.
  */
#define __HAL_RCC_HSI_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_HSION_BIT_NUMBER, ENABLE)
#define __HAL_RCC_HSI_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_HSION_BIT_NUMBER, DISABLE)
...
/** @brief  Macro to adjust the Internal High Speed oscillator (HSI) calibration value.
  ...
  *         This parameter must be a number between 0 and 0x1FU.
  */
...
/** @brief  Macros to enable or disable the Internal Low Speed oscillator (LSI).
  ...
  *         clock cycles.
  */
#define __HAL_RCC_LSI_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_LSION_BIT_NUMBER, ENABLE)
#define __HAL_RCC_LSI_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_LSION_BIT_NUMBER, DISABLE)
/**
  * @}
  */
...
/** @brief  Macros to enable or disable the RTC clock.
  ...
  */
#define __HAL_RCC_RTC_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->BDCR, RCC_RTCEN_BIT_NUMBER, ENABLE)
#define __HAL_RCC_RTC_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->BDCR, RCC_RTCEN_BIT_NUMBER, DISABLE)
...
#define __HAL_RCC_RTC_CLKPRESCALER(__RTCCLKSource__) (((__RTCCLKSource__) & RCC_BDCR_RTCSEL) == RCC_BDCR_RTCSEL) ?    \
                                                 MODIFY_REG(RCC->CFGR, RCC_CFGR_RTCPRE, ((__RTCCLKSource__) & 0xFFFFCFFUL)) : CLEAR_BIT(RCC->CFGR, RCC_CFGR_RTCPRE)

#define __HAL_RCC_RTC_CONFIG(__RTCCLKSource__) do { __HAL_RCC_RTC_CLKPRESCALER(__RTCCLKSource__);    \
                                                    RCC->BDCR |= ((__RTCCLKSource__) & 0x00000FFFUL);  \
                                                   } while(0U)
...
/** @brief  Macros to force or release the Backup domain reset.
  ...
  */
#define __HAL_RCC_BACKUPRESET_FORCE() HAL_PERIPH_BIT_BAND_WRITE(RCC->BDCR, RCC_BDRST_BIT_NUMBER, ENABLE)
#define __HAL_RCC_BACKUPRESET_RELEASE() HAL_PERIPH_BIT_BAND_WRITE(RCC->BDCR, RCC_BDRST_BIT_NUMBER, DISABLE)
/**
  * @}
  */
...
/** @brief  Macros to enable or disable the main PLL.
  ...
  */
#define __HAL_RCC_PLL_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_PLLON_BIT_NUMBER, ENABLE)
#define __HAL_RCC_PLL_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_PLLON_BIT_NUMBER, DISABLE)
...
/** @brief  Macro to configure the I2S clock source (I2SCLK).
  ...
  */
#define __HAL_RCC_I2S_CONFIG(__SOURCE__) HAL_PERIPH_BIT_BAND_WRITE(RCC->CFGR, RCC_I2SSRC_BIT_NUMBER, (__SOURCE__))
/**
  * @}
  */
...
#define __HAL_RCC_GET_FLAG(__FLAG__) (((((((__FLAG__) >> 5U) == 1U) ? RCC->CR :((((__FLAG__) >> 5U) == 2U) ? RCC->BDCR :((((__FLAG__) >> 5U) == 3U) ? RCC->CSR :RCC->CIR))) & ((uint32_t)1UL << ((__FLAG__) & RCC_FLAG_MASK))) != 0U) ? 1U : 0U)
