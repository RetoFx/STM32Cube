...
/** @defgroup RCCEx_Periph_Clock_Selection RCC Periph Clock Selection
  * @{
  */
#define RCC_PERIPHCLK_I2S             ((uint32_t)0x00000001UL)
#define RCC_PERIPHCLK_TIM             ((uint32_t)0x00000002UL)
#define RCC_PERIPHCLK_RTC             ((uint32_t)0x00000004UL)
#define RCC_PERIPHCLK_PLLI2S          ((uint32_t)0x00000008UL)
...
/** @defgroup RCCEx_BitAddress_AliasRegion RCC BitAddress AliasRegion
  ...
  * @{
  */
#define PLL_TIMEOUT_VALUE          ((uint32_t)100U)  /* 100 ms */
/**
  * @}
  */
