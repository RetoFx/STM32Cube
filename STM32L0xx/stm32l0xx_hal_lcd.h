...
#define LCD_HIGHDRIVE_0           (0x00000000UL)         /*!< Low resistance Drive   */
...
#define LCD_VOLTBUFOUT_DISABLE            (0x00000000UL)       /*!< Voltage output buffer disabled */
#define LCD_VOLTBUFOUT_ENABLE             (LCD_CR_BUFEN)                /*!< BUFEN[1U] Voltage output buffer enabled    */
