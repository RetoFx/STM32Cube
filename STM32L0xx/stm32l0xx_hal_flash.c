  ...
  *
  ...
  ===============================================================================
   ...
   ==============================================================================
     ...
     (+) HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef const * const pOBInit);
     (+) HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef * const pOBInit);
...
void HAL_FLASH_IRQHandler(void)
{
   ...
   *           (RefID = 0x1000U) the FLASH_FLAG_OPTVERR bit was not behaving
    ...
    if(pFlash.ProcedureOnGoing != FLASH_PROC_NONE)
    {
      if(pFlash.ProcedureOnGoing == FLASH_PROC_PAGEERASE)
      {
        ...
        else
        {
          ...
          pFlash.Page = addresstmp = 0xFFFFFFFFUL;
          pFlash.ProcedureOnGoing = FLASH_PROC_NONE;
...
/**
  ...
  *                    (if 0xFFFFFFFFUL, it means that all the selected pages have been erased)
  *                 - Program: Address which was selected for data program
  * @retval none
  */
HAL_FLASH_WEAK_CALLBACK(void, HAL_FLASH_EndOfOperationCallback)(uint32_t ReturnValue)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(ReturnValue);
...
/**
  ...
  * @retval none
  */
HAL_FLASH_WEAK_CALLBACK(void, HAL_FLASH_OperationErrorCallback)(uint32_t ReturnValue)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(ReturnValue);
