...
#define LSI_VALUE    37000UL    /*!< Value of the LSI oscillator in Hz */
#endif /* LSI_VALUE */
...
/** @defgroup RCC_LL_EC_RTC_HSE_DIV RTC HSE Prescaler
  * @{
  */
#define LL_RCC_RTC_HSE_DIV_2               0x00000000UL          /*!< HSE is divided by 2 for RTC clock  */
...
#define LL_RCC_USART1_CLKSOURCE_PCLK2      (uint32_t)((RCC_CCIPR_USART1SEL << 16U) | 0x00000000UL)             /*!< PCLK2 selected as USART1 clock */
...
#define LL_RCC_USART2_CLKSOURCE_PCLK1      (uint32_t)((RCC_CCIPR_USART2SEL << 16U) | 0x00000000UL)             /*!< PCLK1 selected as USART2 clock */
...
/** @defgroup RCC_LL_EC_LPUART1_CLKSOURCE  Peripheral LPUART clock source selection
  * @{
  */
#define LL_RCC_LPUART1_CLKSOURCE_PCLK1     0x00000000UL   /*!< PCLK1 selected as LPUART1 clock */
...
/** @defgroup RCC_LL_EC_I2C1_CLKSOURCE  Peripheral I2C clock source selection
  * @{
  */
#define LL_RCC_I2C1_CLKSOURCE_PCLK1        (uint32_t)((RCC_CCIPR_I2C1SEL << 4U) | (0x00000000UL >> 4U))           /*!< PCLK1 selected as I2C1 clock */
...
#define LL_RCC_I2C3_CLKSOURCE_PCLK1        (uint32_t)((RCC_CCIPR_I2C3SEL << 4U) | (0x00000000UL >> 4U))           /*!< PCLK1 selected as I2C3 clock */
...
/** @defgroup RCC_LL_EC_LPTIM1_CLKSOURCE  Peripheral LPTIM clock source selection
  * @{
  */
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1      (0x00000000UL)          /*!< PCLK1 selected as LPTIM1 clock */
...
/** @defgroup RCC_LL_EC_RNG_CLKSOURCE  Peripheral RNG clock source selection
  * @{
  */
#define LL_RCC_RNG_CLKSOURCE_PLL           (0x00000000UL)          /*!< PLL selected as RNG clock */
...
/** @defgroup RCC_LL_EC_USB_CLKSOURCE  Peripheral USB clock source selection
  * @{
  */
#define LL_RCC_USB_CLKSOURCE_PLL           (0x00000000UL)          /*!< PLL selected as USB clock */
...
/**
  ...
  * @param  Value between Min_Data = 0x00U and Max_Data = 0x1FU
  * @retval None
  */
...
/**
  ...
  * @retval Between Min_Data = 0x00U and Max_Data = 0x1FU
  */
...
{
  MODIFY_REG(RCC->CCIPR, ((I2CxSource >> 4U) & 0x000FF000UL), ((I2CxSource << 4U) & 0x000FF000UL));
}
