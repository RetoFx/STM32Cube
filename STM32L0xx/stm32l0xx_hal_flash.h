...
#define FLASH_BANK2_BASE          (FLASH_BASE + (FLASH_SIZE >> 1U)) /*!< FLASH BANK2 base address in the alias region */
...
/** @defgroup FLASH_Latency FLASH Latency
  * @{
  */
#define FLASH_LATENCY_0            (0x00000000UL)    /*!< FLASH Zero Latency cycle */
...
#define FLASH_PEKEY1               (0x89ABCDEFUL) /*!< Flash program erase key1 */
#define FLASH_PEKEY2               (0x02030405UL) /*!< Flash program erase key: used with FLASH_PEKEY2
                                                     to unlock the write access to the FLASH_PECR register and
                                                     data EEPROM */

#define FLASH_PRGKEY1              (0x8C9DAEBFUL) /*!< Flash program memory key1 */
#define FLASH_PRGKEY2              (0x13141516UL) /*!< Flash program memory key2: used with FLASH_PRGKEY2
                                                     to unlock the program memory */

#define FLASH_OPTKEY1              (0xFBEAD9C8UL) /*!< Flash option key1 */
#define FLASH_OPTKEY2              (0x24252627UL) /*!< Flash option key2: used with FLASH_OPTKEY1 to
