...
#define CRRCR_REG_INDEX                  ((uint8_t)3U)
...
#define RCC_FLAG_HSIDIV                  ((uint8_t)((CR_REG_INDEX << 5U) | RCC_CR_HSIDIVF_Pos))    /*!< HSI16 divider flag */
...
#define RCC_FLAG_FWRST                   ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_FWRSTF_Pos))   /*!< RCC flag FW reset */
#endif /* RCC_CSR_FWRSTF */
/* Flags in the CRRCR register */
#if defined(RCC_HSI48_SUPPORT)
#define RCC_FLAG_HSI48RDY                ((uint8_t)((CRRCR_REG_INDEX << 5U) | RCC_CRRCR_HSI48RDY_Pos))  /*!< HSI48 clock ready flag */
#endif /* RCC_HSI48_SUPPORT */
...
/** @defgroup RCC_IOPORT_Force_Release_Reset IOPORT Peripheral Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_IOP_FORCE_RESET()     (RCC->IOPRSTR = 0xFFFFFFFFUL)
...
#define __HAL_RCC_IOP_RELEASE_RESET()   (RCC->IOPRSTR = 0x00000000UL)
...
/** @brief  Check RCC flag is set or not.
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define __HAL_RCC_GET_FLAG(__FLAG__) (((((((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR :((((__FLAG__) >> 5U) == CSR_REG_INDEX) ? RCC->CSR :RCC->CRRCR)))) & ((uint32_t)1UL << ((__FLAG__) & RCC_FLAG_MASK))) != 0U ) ? 1U : 0U )
#else
#define __HAL_RCC_GET_FLAG(__FLAG__) (((((((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR : RCC->CSR))) & ((uint32_t)1UL << ((__FLAG__) & RCC_FLAG_MASK))) != 0U ) ? 1U : 0U )
#endif /* RCC_HSI48_SUPPORT */
