...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_DAC_Start(DAC_HandleTypeDef * const hdac, uint32_t Channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Channel);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel, uint32_t const * const pData, uint32_t Length, uint32_t Alignment)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Channel);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Channel);
...
/**
  ...
  */
__weak uint32_t HAL_DAC_GetValue(DAC_HandleTypeDef const * const hdac, uint32_t Channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Channel);
...
/**
  ...
  * @retval None
  */
__weak void HAL_DAC_IRQHandler(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef * const hdac, uint32_t Channel, uint32_t Alignment, uint32_t Data)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
  UNUSED(Channel);
