...
/** @defgroup PWR_LL_EC_MODE_PWR Mode Power
  * @{
  */
#define LL_PWR_MODE_STOP                      0x00000000UL                    /*!< Enter Stop mode when the CPU enters deepsleep */
...
/** @defgroup PWR_LL_EC_REGU_MODE_LP_MODES  Regulator Mode In Low Power Modes
  * @{
  */
#define LL_PWR_REGU_LPMODES_MAIN           0x00000000UL        /*!< Voltage regulator in main mode during deepsleep/sleep/low-power run mode */
 ...
 * @{
 */
#define LL_PWR_REGU_DSMODE_MAIN        0x00000000UL           /*!< Voltage regulator in main mode during deepsleep mode when PWR_CR_LPSDSR = 0 */
