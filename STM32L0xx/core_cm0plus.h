...
#else
  uint32_t * const vectors = (uint32_t *)(NVIC_USER_IRQ_OFFSET << 2);      /* point to 1st user interrupt */
...
#else
  uint32_t const * const vectors = (uint32_t const *)(NVIC_USER_IRQ_OFFSET << 2);      /* point to 1st user interrupt */
