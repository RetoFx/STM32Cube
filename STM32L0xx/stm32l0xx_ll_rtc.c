...
#define RTC_ASYNCH_PRESC_DEFAULT     0x0000007FUL
#define RTC_SYNCH_PRESC_DEFAULT      0x000000FFUL
...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef * const RTCx)
{
  ...
  if (LL_RTC_EnterInitMode(RTCx) != ERROR)
  {
    ...
    LL_RTC_WriteReg(RTCx, TR,       0x00000000UL);
    ...
    LL_RTC_WriteReg(RTCx, ALRMAR,   0x00000000UL);
    LL_RTC_WriteReg(RTCx, ALRMBR,   0x00000000UL);
    LL_RTC_WriteReg(RTCx, CALR,     0x00000000UL);
    LL_RTC_WriteReg(RTCx, SHIFTR,   0x00000000UL);
    LL_RTC_WriteReg(RTCx, ALRMASSR, 0x00000000UL);
    LL_RTC_WriteReg(RTCx, ALRMBSSR, 0x00000000UL);

    /* Reset ISR register and exit initialization mode */
    LL_RTC_WriteReg(RTCx, ISR,      0x00000000UL);

    /* Reset Tamper and alternate functions configuration register */
    LL_RTC_WriteReg(RTCx, TAMPCR, 0x00000000UL);

    /* Reset Option register */
    LL_RTC_WriteReg(RTCx, OR, 0x00000000UL);
