...
/** @addtogroup UTILS_LL_Private_Constants
  * @{
  */
#define UTILS_MAX_FREQUENCY_SCALE1  32000000UL        /*!< Maximum frequency for system clock at power scale1, in Hz */
#define UTILS_MAX_FREQUENCY_SCALE2  16000000UL        /*!< Maximum frequency for system clock at power scale2, in Hz */
#define UTILS_MAX_FREQUENCY_SCALE3  4194304UL         /*!< Maximum frequency for system clock at power scale3, in Hz */

/* Defines used for PLL range */
#define UTILS_PLLVCO_OUTPUT_SCALE1  96000000UL        /*!< Frequency max for PLLVCO output at power scale1, in Hz  */
#define UTILS_PLLVCO_OUTPUT_SCALE2  48000000UL        /*!< Frequency max for PLLVCO output at power scale2, in Hz  */
#define UTILS_PLLVCO_OUTPUT_SCALE3  24000000UL        /*!< Frequency max for PLLVCO output at power scale3, in Hz  */

/* Defines used for HSE range */
#define UTILS_HSE_FREQUENCY_MIN     1000000UL         /*!< Frequency min for HSE frequency, in Hz   */
#define UTILS_HSE_FREQUENCY_MAX     24000000UL        /*!< Frequency max for HSE frequency, in Hz   */
...
#define UTILS_SCALE3_LATENCY1_FREQ  2000000UL         /*!< HCLK frequency to set FLASH latency 1 in power scale 3 */
/**
  * @}
  */
/* Private macros ------------------------------------------------------------*/
...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 ===============================================================================
    [..]
         ...
         (+) The maximum frequency of the SYSCLK, HCLK, PCLK1 and PCLK2 is 32000000UL Hz.
  @endverbatim
  @internal
...
/**
  ...
  *           - PLLVCO does not exceed 24 MHz when the product is in range 3
  * @note   FLASH latency can be modified through this function.
  * @param  HSEFrequency Value between Min_Data = 1000000UL and Max_Data = 24000000UL
...
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef const * const UTILS_PLLInitStruct)
{
  ...
  /* The application software must set correctly the PLL multiplication factor to avoid exceeding
     maximum frequency 32000000UL in range 1 */
