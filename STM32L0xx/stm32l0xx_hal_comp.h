...
#define COMP_POWERMODE_ULTRALOWPOWER   (0x00000000UL)               /*!< COMP power mode to ultra low power (indicated as "low speed" in reference manual) (only for COMP instance: COMP2) */
/**
  * @}
  */
...
#define COMP_INPUT_MINUS_VREFINT       (0x00000000UL)                                                              /*!< Comparator input minus connected to VrefInt */
...
#define COMP_LPTIMCONNECTION_DISABLED               (0x00000000UL)    /*!< COMPx signal is gated */
#define COMP_LPTIMCONNECTION_IN1_ENABLED            (0x00000001UL)    /*!< COMPx signal is connected to LPTIM input 1 */
#define COMP_LPTIMCONNECTION_IN2_ENABLED            (0x00000002UL)    /*!< COMPx signal is connected to LPTIM input 2 */
/**
  * @}
  */
