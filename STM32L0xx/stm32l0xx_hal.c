...
#if (BUFFER_CACHE_DISABLE != 0U)
  __HAL_FLASH_BUFFER_CACHE_DISABLE();
#endif /* BUFFER_CACHE_DISABLE */

#if (PREREAD_ENABLE != 0U)
...
/**
  ...
  *              - 0x00000000UL : Boot is configured in Main Flash memory
  *              - 0x00000100UL : Boot is configured in System Flash memory
  *              - 0x00000300UL : Boot is configured in Embedded SRAM memory
  */
