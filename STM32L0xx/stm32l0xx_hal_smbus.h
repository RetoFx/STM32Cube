...
/** @defgroup HAL_state_definition HAL state definition
  ...
  * @{
  */
#define HAL_SMBUS_STATE_RESET           (0x00000000UL)  /*!< SMBUS not yet initialized or disabled         */
#define HAL_SMBUS_STATE_READY           (0x00000001UL)  /*!< SMBUS initialized and ready for use           */
#define HAL_SMBUS_STATE_BUSY            (0x00000002UL)  /*!< SMBUS internal process is ongoing             */
#define HAL_SMBUS_STATE_MASTER_BUSY_TX  (0x00000012UL)  /*!< Master Data Transmission process is ongoing   */
#define HAL_SMBUS_STATE_MASTER_BUSY_RX  (0x00000022UL)  /*!< Master Data Reception process is ongoing      */
#define HAL_SMBUS_STATE_SLAVE_BUSY_TX   (0x00000032UL)  /*!< Slave Data Transmission process is ongoing    */
#define HAL_SMBUS_STATE_SLAVE_BUSY_RX   (0x00000042UL)  /*!< Slave Data Reception process is ongoing       */
#define HAL_SMBUS_STATE_TIMEOUT         (0x00000003UL)  /*!< Timeout state                                 */
#define HAL_SMBUS_STATE_ERROR           (0x00000004UL)  /*!< Reception process is ongoing                  */
#define HAL_SMBUS_STATE_LISTEN          (0x00000008UL)  /*!< Address Listen Mode is ongoing                */
/**
  * @}
  */
...
#define HAL_SMBUS_ERROR_ACKF            (0x00000004UL)    /*!< ACKF error           */
#define HAL_SMBUS_ERROR_OVR             (0x00000008UL)    /*!< OVR error            */
#define HAL_SMBUS_ERROR_HALTIMEOUT      (0x00000010UL)    /*!< Timeout error        */
#define HAL_SMBUS_ERROR_BUSTIMEOUT      (0x00000020UL)    /*!< Bus Timeout error    */
#define HAL_SMBUS_ERROR_ALERT           (0x00000040UL)    /*!< Alert error          */
#define HAL_SMBUS_ERROR_PECERR          (0x00000080UL)    /*!< PEC error            */
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
#define HAL_SMBUS_ERROR_INVALID_CALLBACK  (0x00000100UL)  /*!< Invalid Callback error   */
#endif /* USE_HAL_SMBUS_REGISTER_CALLBACKS */
#define HAL_SMBUS_ERROR_INVALID_PARAM    (0x00000200UL)   /*!< Invalid Parameters error */
/**
  * @}
  */
...
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
  void (* MasterTxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Master Tx Transfer completed callback */
  void (* MasterRxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Master Rx Transfer completed callback */
  void (* SlaveTxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Slave Tx Transfer completed callback  */
  void (* SlaveRxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Slave Rx Transfer completed callback  */
  void (* ListenCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Listen Complete callback              */
  void (* ErrorCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Error callback                        */

  void (* AddrCallback)(struct __SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection, uint16_t AddrMatchCode);
  /*!< SMBUS Slave Address Match callback */

  void (* MspInitCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
  /*!< SMBUS Msp Init callback                     */
  void (* MspDeInitCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);
...
/**
  ...
  */
typedef  void (*pSMBUS_CallbackTypeDef)(SMBUS_HandleTypeDef * const hsmbus);
/*!< pointer to an SMBUS callback function */
typedef  void (*pSMBUS_AddrCallbackTypeDef)(SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection,
...
/** @defgroup SMBUS_addressing_mode SMBUS addressing mode
  * @{
  */
#define SMBUS_ADDRESSINGMODE_7BIT               (0x00000001UL)
#define SMBUS_ADDRESSINGMODE_10BIT              (0x00000002UL)
/**
  * @}
  */
...
#define SMBUS_PERIPHERAL_MODE_SMBUS_SLAVE       (0x00000000UL)
...
#define  SMBUS_SOFTEND_MODE                     (0x00000000UL)
...
#define  SMBUS_NO_STARTSTOP                     (0x00000000UL)
#define  SMBUS_GENERATE_STOP                    (uint32_t)(0x80000000UL | I2C_CR2_STOP)
#define  SMBUS_GENERATE_START_READ              (uint32_t)(0x80000000UL | I2C_CR2_START | I2C_CR2_RD_WRN)
#define  SMBUS_GENERATE_START_WRITE             (uint32_t)(0x80000000UL | I2C_CR2_START)
/**
  * @}
  */
 ...
 */
#define  SMBUS_OTHER_FRAME_NO_PEC               (0x000000AAUL)
#define  SMBUS_OTHER_FRAME_WITH_PEC             (0x0000AA00UL)
#define  SMBUS_OTHER_AND_LAST_FRAME_NO_PEC      (0x00AA0000UL)
#define  SMBUS_OTHER_AND_LAST_FRAME_WITH_PEC    (0xAA000000UL)
/**
  * @}
  */
...
/** @brief  Check whether the specified SMBUS flag is set or not.
  ...
  */
#define SMBUS_FLAG_MASK  (0x0001FFFFUL)
...
#define IS_SMBUS_OWN_ADDRESS1(ADDRESS1)                         ((ADDRESS1) <= 0x000003FFUL)
...
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_SMBUS_RegisterCallback(SMBUS_HandleTypeDef * const hsmbus,
                                             HAL_SMBUS_CallbackIDTypeDef CallbackID,
                                             pSMBUS_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_SMBUS_UnRegisterCallback(SMBUS_HandleTypeDef * const hsmbus,
                                               HAL_SMBUS_CallbackIDTypeDef CallbackID);

HAL_StatusTypeDef HAL_SMBUS_RegisterAddrCallback(SMBUS_HandleTypeDef * const hsmbus,
...
HAL_StatusTypeDef HAL_SMBUS_IsDeviceReady(SMBUS_HandleTypeDef * const hsmbus, uint16_t DevAddress, uint32_t Trials,
                                          uint32_t Timeout);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_SMBUS_Slave_Transmit_IT(SMBUS_HandleTypeDef * const hsmbus, uint8_t const * const pData, uint16_t Size,
                                              uint32_t XferOptions);
HAL_StatusTypeDef HAL_SMBUS_Slave_Receive_IT(SMBUS_HandleTypeDef * const hsmbus, uint8_t * const pData, uint16_t Size,
                                             uint32_t XferOptions);
...
uint32_t HAL_SMBUS_GetState(SMBUS_HandleTypeDef const * const hsmbus);
