...
/** @defgroup RCCEx_Private_Constants RCCEx Private Constants
  ...
  */
#if defined(USB)
extern uint8_t const PLLMulTable[];
#endif /* USB */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef const * const PeriphClkInit)
{
     ...
     )
  {
    ...
    if((temp_reg != 0x00000000UL) && (((temp_reg != (PeriphClkInit->RTCClockSelection & RCC_CSR_RTCSEL))
