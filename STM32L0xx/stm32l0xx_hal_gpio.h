...
/** @defgroup GPIO_speed_define Speed definition
  ...
  * @{
  */
#define  GPIO_SPEED_FREQ_LOW              (0x00000000UL)  /*!< range up to 0.4 MHz, please refer to the product datasheet */
#define  GPIO_SPEED_FREQ_MEDIUM           (0x00000001UL)  /*!< range 0.4 MHz to 2 MHz, please refer to the product datasheet */
#define  GPIO_SPEED_FREQ_HIGH             (0x00000002UL)  /*!< range   2 MHz to 10 MHz, please refer to the product datasheet */
#define  GPIO_SPEED_FREQ_VERY_HIGH        (0x00000003UL)  /*!< range  10 MHz to 35 MHz, please refer to the product datasheet */
