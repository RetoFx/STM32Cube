...
#else
#define SMBUS_FASTMODEPLUS_PB6            (uint32_t)(0x00000004UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB6 not supported   */
#define SMBUS_FASTMODEPLUS_PB7            (uint32_t)(0x00000008UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB7 not supported   */
...
#else
#define SMBUS_FASTMODEPLUS_PB8            (uint32_t)(0x00000010UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB8 not supported   */
#define SMBUS_FASTMODEPLUS_PB9            (uint32_t)(0x00000012UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus PB9 not supported   */
...
#else
#define SMBUS_FASTMODEPLUS_I2C1           (uint32_t)(0x00000100UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus I2C1 not supported  */
...
#else
#define SMBUS_FASTMODEPLUS_I2C2           (uint32_t)(0x00000200UL | SMBUS_FMP_NOT_SUPPORTED) /*!< Fast Mode Plus I2C2 not supported  */
