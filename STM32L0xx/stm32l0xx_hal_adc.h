...
/** @defgroup ADC_ClockPrescaler ADC Clock Prescaler
  * @{
  */
#define ADC_CLOCK_ASYNC_DIV1              (0x00000000UL)                               /*!< ADC Asynchronous clock mode divided by 1 */
...
/** @defgroup ADC_Overrun ADC Overrun
  * @{
  */
#define ADC_OVR_DATA_PRESERVED              (0x00000000UL)
...
/** @defgroup ADC_rank ADC rank
  * @{
  */
#define ADC_RANK_CHANNEL_NUMBER                 (0x00001000UL)  /*!< Enable the rank of the selected channels. Number of ranks in the sequence is defined by number of channels enabled, rank of each channel is defined by channel number (channel 0 fixed on rank 0, channel 1 fixed on rank1, ...) */
#define ADC_RANK_NONE                           (0x00001001UL)  /*!< Disable the selected rank (selected channel) from sequencer */
/**
  * @}
  */
...
/** @defgroup ADC_Channel_AWD_Masks ADC Channel Masks
  * @{
  */
#define ADC_CHANNEL_MASK        (0x0007FFFFUL)
#define ADC_CHANNEL_AWD_MASK    (0x7C000000UL)
/**
  * @}
  */
...
/** @defgroup ADC_sampling_times ADC Sampling Cycles
  * @{
  */
#define ADC_SAMPLETIME_1CYCLE_5       (0x00000000UL)                         /*!<  ADC sampling time 1.5 cycle */
...
#define ADC_SCAN_DIRECTION_FORWARD        (0x00000001UL)        /*!< Scan direction forward: from channel 0 to channel 18 */
#define ADC_SCAN_DIRECTION_BACKWARD       (0x00000002UL)        /*!< Scan direction backward: from channel 18 to channel 0 */
...
#define ADC_OVERSAMPLING_RATIO_2                    (0x00000000UL)  /*!<  ADC Oversampling ratio 2x */
#define ADC_OVERSAMPLING_RATIO_4                    (0x00000004UL)  /*!<  ADC Oversampling ratio 4x */
#define ADC_OVERSAMPLING_RATIO_8                    (0x00000008UL)  /*!<  ADC Oversampling ratio 8x */
#define ADC_OVERSAMPLING_RATIO_16                   (0x0000000CUL)  /*!<  ADC Oversampling ratio 16x */
#define ADC_OVERSAMPLING_RATIO_32                   (0x00000010UL)  /*!<  ADC Oversampling ratio 32x */
#define ADC_OVERSAMPLING_RATIO_64                   (0x00000014UL)  /*!<  ADC Oversampling ratio 64x */
#define ADC_OVERSAMPLING_RATIO_128                  (0x00000018UL)  /*!<  ADC Oversampling ratio 128x */
#define ADC_OVERSAMPLING_RATIO_256                  (0x0000001CUL)  /*!<  ADC Oversampling ratio 256x */
/**
  * @}
  */
...
/** @defgroup ADC_Right_Bit_Shift ADC Right Bit Shift
  * @{
  */
#define ADC_RIGHTBITSHIFT_NONE                       (0x00000000UL)  /*!<  ADC No bit shift for oversampling */
#define ADC_RIGHTBITSHIFT_1                          (0x00000020UL)  /*!<  ADC 1 bit shift for oversampling */
#define ADC_RIGHTBITSHIFT_2                          (0x00000040UL)  /*!<  ADC 2 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_3                          (0x00000060UL)  /*!<  ADC 3 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_4                          (0x00000080UL)  /*!<  ADC 4 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_5                          (0x000000A0UL)  /*!<  ADC 5 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_6                          (0x000000C0UL)  /*!<  ADC 6 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_7                          (0x000000E0UL)  /*!<  ADC 7 bits shift for oversampling */
#define ADC_RIGHTBITSHIFT_8                          (0x00000100UL)  /*!<  ADC 8 bits shift for oversampling */
/**
  * @}
  */
...
/** @defgroup ADC_Triggered_Oversampling_Mode ADC Triggered Oversampling Mode
  * @{
  */
#define ADC_TRIGGEREDMODE_SINGLE_TRIGGER            (0x00000000UL)  /*!<  ADC No bit shift for oversampling */
#define ADC_TRIGGEREDMODE_MULTI_TRIGGER             (0x00000200UL)  /*!<  ADC No bit shift for oversampling */
/**
  * @}
  */
...
#define ADC_SCANDIR(_SCAN_MODE_)                                   \
  ( ( (_SCAN_MODE_) == (ADC_SCAN_DIRECTION_BACKWARD)                           \
    ) ? (ADC_CFGR1_SCANDIR) : (0x00000000UL)                                      \
  )
