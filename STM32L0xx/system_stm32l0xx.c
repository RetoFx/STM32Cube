...
/*lint -save -w1*/
  ...
  #define MSI_VALUE               2097152UL /*!< Value of the Internal oscillator in Hz*/
#endif /* MSI_VALUE */
...
/** @addtogroup STM32L0xx_System_Private_Variables
  ...
  */
  uint32_t SystemCoreClock = 2097152UL; /* 32.768 kHz * 2^6 */
...
/*!< Set MSION bit */
  ...
  */
  ...
  /*
  RCC->CFGR &= (uint32_t) 0x88FF400CUL;
  */
  ...
  /*
  RCC->CR &= (uint32_t)0xFEF6FFF6UL;
  */
  RCC->CR &= ~( (0U * RCC_CR_PLLRDY)
  			  | (1U * RCC_CR_PLLON)
  			  | (0U * RCC_CR_RTCPRE_1)
  			  | (0U * RCC_CR_RTCPRE_0)
  			  | (1U * RCC_CR_CSSHSEON)
  ...
  /*!< Reset HSI48ON  bit */
  /*
  RCC->CRRCR &= (uint32_t)0xFFFFFFFEUL;
  */
#if !defined (RCC_CRRCR_HSI48ON)
 #define RCC_CRRCR_HSI48ON 0x00000001UL
#endif
