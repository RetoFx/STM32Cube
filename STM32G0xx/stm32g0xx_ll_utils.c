...
/** @addtogroup UTILS_LL_Private_Constants
  * @{
  */
#define UTILS_MAX_FREQUENCY          64000000UL     /*!< Maximum frequency for system clock, in Hz */

/* Defines used for PLL range */
#define UTILS_PLLVCO_INPUT_MIN       4000000UL      /*!< Frequency min for PLLVCO input, in Hz   */
#define UTILS_PLLVCO_INPUT_MAX       8000000UL      /*!< Frequency max for PLLVCO input, in Hz   */
...
#define UTILS_SCALE1_LATENCY3_FREQ  64000000UL       /*!< HCLK frequency to set FLASH latency 3 in power scale 1  */
/**
  * @}
  */
...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 ===============================================================================
    [..]
         ...
         (+) The maximum frequency of the SYSCLK, HCLK, PCLK1 is 64000000UL Hz.
  @endverbatim
  @internal
...
/**
  ...
  *         - PLLR: ensure that max frequency at 64000000UL Hz is reach (PLLVCO_output / PLLR)
...
/**
  ...
  *         - PLLN: ensure that the VCO output frequency is between 64 and 344 MHz (PLLVCO_output = PLLVCO_input * PLLN)
  *         - PLLR: ensure that max frequency at 64000000UL Hz is reached (PLLVCO_output / PLLR)
