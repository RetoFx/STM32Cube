...
#define USB_DRD_CLEAR_CHEP_RX_ERR(USBx, bChNum) \
  ...
  } while(0U) /* USB_DRD_CLEAR_CHEP_RX_ERR */
...
#define USB_DRD_CLEAR_CHEP_TX_ERR(USBx, bChNum) \
  do { \
    ...
    \
    USB_DRD_SET_CHEP((USBx), (bChNum), _wRegVal); \
  } while(0U) /* USB_DRD_CLEAR_CHEP_TX_ERR */
...
#define USB_DRD_SET_CHEP_TX_STATUS(USBx, bEpChNum, wState) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_TX_STATUS */
...
#define USB_DRD_SET_CHEP_RX_STATUS(USBx, bEpChNum, wState) \
  do { \
    ...
    USB_DRD_SET_CHEP((USBx), (bEpChNum), (_wRegVal | USB_CHEP_VTRX | USB_CHEP_VTTX)); \
  } while(0U) /* USB_DRD_SET_CHEP_RX_STATUS */
...
#define USB_DRD_SET_CHEP_KIND(USBx, bEpChNum) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_KIND */
...
#define USB_DRD_CLEAR_CHEP_KIND(USBx, bEpChNum) \
  do { \
    ...
    \
    USB_DRD_SET_CHEP((USBx), (bEpChNum), (_wRegVal | USB_CHEP_VTRX | USB_CHEP_VTTX)); \
  } while(0U) /* USB_DRD_CLEAR_CHEP_KIND */
...
#define USB_DRD_CLEAR_RX_CHEP_CTR(USBx, bEpChNum) \
  do { \
    uint32_t _wRegVal; \
    \
    _wRegVal = USB_DRD_GET_CHEP((USBx), (bEpChNum)) & (0xFFFF7FFFUL & USB_CHEP_REG_MASK); \
    \
    USB_DRD_SET_CHEP((USBx), (bEpChNum), (_wRegVal | USB_CHEP_VTTX)); \
  } while(0U) /* USB_CLEAR_RX_CHEP_CTR */

#define USB_DRD_CLEAR_TX_CHEP_CTR(USBx, bEpChNum) \
  do { \
    uint32_t _wRegVal; \
    \
    _wRegVal = USB_DRD_GET_CHEP((USBx), (bEpChNum)) & (0xFFFFFF7FUL & USB_CHEP_REG_MASK); \
    \
    USB_DRD_SET_CHEP((USBx), (bEpChNum), (_wRegVal | USB_CHEP_VTRX)); \
  } while(0U) /* USB_CLEAR_TX_CHEP_CTR */
...
#define USB_DRD_CLEAR_RX_DTOG(USBx, bEpChNum) \
  ...
  } while(0U) /* USB_DRD_CLEAR_RX_DTOG */
...
#define USB_DRD_CLEAR_TX_DTOG(USBx, bEpChNum) \
  ...
  } while(0U) /* USB_DRD_CLEAR_TX_DTOG */
...
#define USB_DRD_SET_CHEP_ADDRESS(USBx, bEpChNum, bAddr) \
  do { \
    ...
    USB_DRD_SET_CHEP((USBx), (bEpChNum), (_wRegVal | USB_CHEP_VTRX | USB_CHEP_VTTX)); \
  } while(0U) /* USB_DRD_SET_CHEP_ADDRESS */
...
#define USB_DRD_SET_CHEP_TX_ADDRESS(USBx, bEpChNum, wAddr) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_TX_ADDRESS */
...
#define USB_DRD_SET_CHEP_RX_ADDRESS(USBx, bEpChNum, wAddr) \
  ...
  } while(0U) /* USB_SET_CHEP_RX_ADDRESS */
...
#define USB_DRD_SET_CHEP_CNT_RX_REG(pdwReg, wCount) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_CNT_RX_REG */
...
/**
  ...
  */
#define USB_DRD_GET_CHEP_TX_CNT(USBx, bEpChNum)           (((USB_DRD_PMA_BUFF + (bEpChNum))->TXBD & 0x03FF0000UL) >> 16U)
#define USB_DRD_GET_CHEP_RX_CNT(USBx, bEpChNum)           (((USB_DRD_PMA_BUFF + (bEpChNum))->RXBD & 0x03FF0000UL) >> 16U)
...
#define USB_DRD_SET_CHEP_DBUF_ADDR(USBx, bEpChNum, wBuf0Addr, wBuf1Addr) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_DBUF_ADDR */
...
#define USB_DRD_SET_CHEP_DBUF0_CNT(USBx, bEpChNum, bDir, wCount) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_DBUF0_CNT */
...
#define USB_DRD_SET_CHEP_DBUF1_CNT(USBx, bEpChNum, bDir, wCount) \
  ...
  } while(0U) /* USB_DRD_SET_CHEP_DBUF1_CNT */
...
#define USB_DRD_SET_CHEP_DBUF_CNT(USBx, bEpChNum, bDir, wCount) \
  ...
  } while(0U) /* USB_DRD_SET_EPCH_DBUF_CNT  */
...
HAL_StatusTypeDef USB_CoreInit(USB_DRD_TypeDef * const USBx, USB_DRD_CfgTypeDef cfg);
HAL_StatusTypeDef USB_DevInit(USB_DRD_TypeDef * const USBx, USB_DRD_CfgTypeDef cfg);
HAL_StatusTypeDef USB_EnableGlobalInt(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_DisableGlobalInt(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_SetCurrentMode(USB_DRD_TypeDef * const USBx, USB_DRD_ModeTypeDef mode);

HAL_StatusTypeDef USB_FlushRxFifo(USB_DRD_TypeDef const * const USBx);
HAL_StatusTypeDef USB_FlushTxFifo(USB_DRD_TypeDef const * const USBx, uint32_t num);

#if defined (HAL_PCD_MODULE_ENABLED)
HAL_StatusTypeDef USB_ActivateEndpoint(USB_DRD_TypeDef const * const USBx, USB_DRD_EPTypeDef const * const ep);
HAL_StatusTypeDef USB_DeactivateEndpoint(USB_DRD_TypeDef const * const USBx, USB_DRD_EPTypeDef const * const ep);
HAL_StatusTypeDef USB_EPStartXfer(USB_DRD_TypeDef * const USBx, USB_DRD_EPTypeDef * const ep);
HAL_StatusTypeDef USB_EPSetStall(USB_DRD_TypeDef * const USBx, USB_DRD_EPTypeDef const * const ep);
HAL_StatusTypeDef USB_EPClearStall(USB_DRD_TypeDef * const USBx, USB_DRD_EPTypeDef const * const ep);
HAL_StatusTypeDef USB_EPStopXfer(USB_DRD_TypeDef * const USBx, USB_DRD_EPTypeDef const * const ep);
#endif /* defined (HAL_PCD_MODULE_ENABLED) */

HAL_StatusTypeDef USB_SetDevAddress(USB_DRD_TypeDef * const USBx, uint8_t address);
HAL_StatusTypeDef USB_DevConnect(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_DevDisconnect(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_StopDevice(USB_DRD_TypeDef * const USBx);
uint32_t          USB_ReadInterrupts(USB_DRD_TypeDef const * const USBx);

HAL_StatusTypeDef USB_ResetPort(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_HostInit(USB_DRD_TypeDef * const USBx, USB_DRD_CfgTypeDef cfg);
HAL_StatusTypeDef USB_HC_IN_Halt(USB_DRD_TypeDef * const USBx, uint8_t phy_ch);
HAL_StatusTypeDef USB_HC_OUT_Halt(USB_DRD_TypeDef * const USBx, uint8_t phy_ch);
HAL_StatusTypeDef USB_HC_StartXfer(USB_DRD_TypeDef * const USBx, USB_DRD_HCTypeDef * const hc);

uint32_t          USB_GetHostSpeed(USB_DRD_TypeDef const * const USBx);
uint32_t          USB_GetCurrentFrame(USB_DRD_TypeDef const * const USBx);
HAL_StatusTypeDef USB_StopHost(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_HC_DoubleBuffer(USB_DRD_TypeDef * const USBx, uint8_t phy_ch_num, uint8_t db_state);
HAL_StatusTypeDef USB_HC_Init(USB_DRD_TypeDef * const USBx, uint8_t phy_ch_num, uint8_t epnum,
                              uint8_t dev_address, uint8_t speed, uint8_t ep_type, uint16_t mps);

HAL_StatusTypeDef USB_ActivateRemoteWakeup(USB_DRD_TypeDef * const USBx);
HAL_StatusTypeDef USB_DeActivateRemoteWakeup(USB_DRD_TypeDef * const USBx);

void              USB_WritePMA(USB_DRD_TypeDef const * const USBx, uint8_t const * const pbUsrBuf,
                               uint16_t wPMABufAddr, uint16_t wNBytes);

void              USB_ReadPMA(USB_DRD_TypeDef const * const USBx, uint8_t * const pbUsrBuf,
                              uint16_t wPMABufAddr, uint16_t wNBytes);
