...
/** @defgroup RCC_HSI_Div HSI Div
  * @{
  */
#define RCC_HSI_DIV1                   0x00000000UL                                        /*!< HSI clock is not divided */
...
/** @defgroup RCC_System_Clock_Source System Clock Source
  * @{
  */
#define RCC_SYSCLKSOURCE_HSI           0x00000000UL                       /*!< HSI selection as system clock */
...
/** @defgroup RCC_System_Clock_Source_Status System Clock Source Status
  * @{
  */
#define RCC_SYSCLKSOURCE_STATUS_HSI    0x00000000UL                       /*!< HSI used as system clock */
...
/** @defgroup RCC_RTC_Clock_Source RTC Clock Source
  * @{
  */
#define RCC_RTCCLKSOURCE_NONE          0x00000000UL            /*!< No clock configured for RTC */
...
/** @defgroup RCC_MCO1_Clock_Prescaler MCO1 Clock Prescaler
  * @{
  */
#define RCC_MCODIV_1                   0x00000000UL                                                 /*!< MCO not divided */
...
/** @defgroup RCC_MCO2_Clock_Prescaler MCO2 Clock Prescaler
  * @{
  */
#define RCC_MCO2DIV_1                  0x00000000UL                                                    /*!< MCO2 not divided */
...
/** @defgroup RCC_AHB_Force_Release_Reset AHB Peripheral Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_AHB_FORCE_RESET()            WRITE_REG(RCC->AHBRSTR, 0xFFFFFFFFUL)
...
#define __HAL_RCC_AHB_RELEASE_RESET()          WRITE_REG(RCC->AHBRSTR, 0x00000000UL)
...
/** @defgroup RCC_IOPORT_Force_Release_Reset IOPORT Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_IOP_FORCE_RESET()            WRITE_REG(RCC->IOPRSTR, 0xFFFFFFFFUL)
...
#define __HAL_RCC_IOP_RELEASE_RESET()          WRITE_REG(RCC->IOPRSTR, 0x00000000UL)
...
/** @defgroup RCC_APB1_Force_Release_Reset APB1 Peripheral Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_APB1_FORCE_RESET()           WRITE_REG(RCC->APBRSTR1, 0xFFFFFFFFUL)
...
#endif /* LPTIM1 */
#define __HAL_RCC_APB1_RELEASE_RESET()         WRITE_REG(RCC->APBRSTR1, 0x00000000UL)
#if defined(TIM2)
...
/** @defgroup RCC_APB2_Force_Release_Reset APB2 Peripheral Force Release Reset
  ...
  * @{
  */
#define __HAL_RCC_APB2_FORCE_RESET()           WRITE_REG(RCC->APBRSTR2, 0xFFFFFFFFUL)
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                      \
  (((((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR :                    \
     ...
     (1UL << ((__FLAG__) & RCC_FLAG_MASK))) != RESET) ? 1U : 0U)
#else
#define __HAL_RCC_GET_FLAG(__FLAG__)                                    \
  (((((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR :                  \
      ((((__FLAG__) >> 5U) == BDCR_REG_INDEX) ? RCC->BDCR :              \
