...
static void               FLASH_OB_GetPCROP1A(uint32_t * const PCROPConfig, uint32_t * const PCROP1AStartAddr,
                                              uint32_t * const PCROP1AEndAddr);
static void               FLASH_OB_GetPCROP1B(uint32_t * const PCROP1BStartAddr, uint32_t * const PCROP1BEndAddr);
...
static void               FLASH_OB_GetPCROP2A(uint32_t * const PCROP2AStartAddr, uint32_t * const PCROP2AEndAddr);
static void               FLASH_OB_GetPCROP2B(uint32_t * const PCROP2BStartAddr, uint32_t * const PCROP2BEndAddr);
...
static void               FLASH_OB_GetSecMem(uint32_t * const BootEntry, uint32_t * const SecSize, uint32_t * const SecSize2);
#else
static void               FLASH_OB_SecMemConfig(uint32_t BootEntry, uint32_t SecSize);
static void               FLASH_OB_GetSecMem(uint32_t * const BootEntry, uint32_t * const SecSize);
#endif /* FLASH_DBANK_SUPPORT */
...
/**
  ...
  * @retval HAL Status
  */
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef * const pEraseInit, uint32_t * const PageError)
{
...
/**
  ...
  * @retval HAL Status
  */
HAL_StatusTypeDef HAL_FLASHEx_Erase_IT(FLASH_EraseInitTypeDef * const pEraseInit)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval None
  */
static void FLASH_OB_GetPCROP1A(uint32_t * const PCROPConfig, uint32_t * const PCROP1AStartAddr, uint32_t * const PCROP1AEndAddr)
{
  uint32_t pcrop;
  uint32_t ropbase;
