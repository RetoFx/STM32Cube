...
/** @defgroup SYSTEM_LL_EC_REMAP SYSCFG REMAP
  * @{
  */
#define LL_SYSCFG_REMAP_FLASH               0x00000000UL                                           /*!< Main Flash memory mapped at 0x00000000UL */
...
/** @defgroup SYSTEM_LL_EC_IR_POL SYSCFG IR Polarity
  * @{
  */
#define LL_SYSCFG_IR_POL_NOT_INVERTED  0x00000000UL                                     /*!< 0: Output of IRDA (IROut) not inverted */
...
/** @defgroup SYSTEM_LL_EC_VOLTAGE VREFBUF VOLTAGE
  * @{
  */
#define LL_VREFBUF_VOLTAGE_SCALE0          0x00000000UL            /*!< Voltage reference scale 0 (VREF_OUT1) */
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[0U], SYSCFG_ITLINE0_SR_EWDG) == (SYSCFG_ITLINE0_SR_EWDG)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVDOUT) == (SYSCFG_ITLINE1_SR_PVDOUT)) ? 1UL : 0UL);
}
#endif /* PWR_PVD_SUPPORT */
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVMOUT) == (SYSCFG_ITLINE1_SR_PVMOUT)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[2U], SYSCFG_ITLINE2_SR_RTC) == (SYSCFG_ITLINE2_SR_RTC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[2U], SYSCFG_ITLINE2_SR_TAMPER) == (SYSCFG_ITLINE2_SR_TAMPER)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[3U], SYSCFG_ITLINE3_SR_FLASH_ITF) == (SYSCFG_ITLINE3_SR_FLASH_ITF)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[3U], SYSCFG_ITLINE3_SR_FLASH_ECC) == (SYSCFG_ITLINE3_SR_FLASH_ECC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[4U], SYSCFG_ITLINE4_SR_CLK_CTRL) == (SYSCFG_ITLINE4_SR_CLK_CTRL)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[4U], SYSCFG_ITLINE4_SR_CRS) == (SYSCFG_ITLINE4_SR_CRS)) ? 1UL : 0UL);
}
#endif /* CRS */
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[5U], SYSCFG_ITLINE5_SR_EXTI0) == (SYSCFG_ITLINE5_SR_EXTI0)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[5U], SYSCFG_ITLINE5_SR_EXTI1) == (SYSCFG_ITLINE5_SR_EXTI1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[6U], SYSCFG_ITLINE6_SR_EXTI2) == (SYSCFG_ITLINE6_SR_EXTI2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[6U], SYSCFG_ITLINE6_SR_EXTI3) == (SYSCFG_ITLINE6_SR_EXTI3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI4) == (SYSCFG_ITLINE7_SR_EXTI4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI5) == (SYSCFG_ITLINE7_SR_EXTI5)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI6) == (SYSCFG_ITLINE7_SR_EXTI6)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI7) == (SYSCFG_ITLINE7_SR_EXTI7)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI8) == (SYSCFG_ITLINE7_SR_EXTI8)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI9) == (SYSCFG_ITLINE7_SR_EXTI9)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI10) == (SYSCFG_ITLINE7_SR_EXTI10)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI11) == (SYSCFG_ITLINE7_SR_EXTI11)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI12) == (SYSCFG_ITLINE7_SR_EXTI12)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI13) == (SYSCFG_ITLINE7_SR_EXTI13)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI14) == (SYSCFG_ITLINE7_SR_EXTI14)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[7U], SYSCFG_ITLINE7_SR_EXTI15) == (SYSCFG_ITLINE7_SR_EXTI15)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_UCPD1) == (SYSCFG_ITLINE8_SR_UCPD1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_UCPD2) == (SYSCFG_ITLINE8_SR_UCPD2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_USB) == (SYSCFG_ITLINE8_SR_USB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[9U], SYSCFG_ITLINE9_SR_DMA1_CH1) == (SYSCFG_ITLINE9_SR_DMA1_CH1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA1_CH2) == (SYSCFG_ITLINE10_SR_DMA1_CH2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[10U], SYSCFG_ITLINE10_SR_DMA1_CH3) == (SYSCFG_ITLINE10_SR_DMA1_CH3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH4) == (SYSCFG_ITLINE11_SR_DMA1_CH4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH5) == (SYSCFG_ITLINE11_SR_DMA1_CH5)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH6) == (SYSCFG_ITLINE11_SR_DMA1_CH6)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA1_CH7) == (SYSCFG_ITLINE11_SR_DMA1_CH7)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMAMUX1) == (SYSCFG_ITLINE11_SR_DMAMUX1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH1) == (SYSCFG_ITLINE11_SR_DMA2_CH1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH2) == (SYSCFG_ITLINE11_SR_DMA2_CH2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH3) == (SYSCFG_ITLINE11_SR_DMA2_CH3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH4) == (SYSCFG_ITLINE11_SR_DMA2_CH4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMA2_CH5) == (SYSCFG_ITLINE11_SR_DMA2_CH5)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_ADC) == (SYSCFG_ITLINE12_SR_ADC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_COMP1) == (SYSCFG_ITLINE12_SR_COMP1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_COMP2) == (SYSCFG_ITLINE12_SR_COMP2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[12U], SYSCFG_ITLINE12_SR_COMP3) == (SYSCFG_ITLINE12_SR_COMP3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_BRK) == (SYSCFG_ITLINE13_SR_TIM1_BRK)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_UPD) == (SYSCFG_ITLINE13_SR_TIM1_UPD)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_TRG) == (SYSCFG_ITLINE13_SR_TIM1_TRG)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[13U], SYSCFG_ITLINE13_SR_TIM1_CCU) == (SYSCFG_ITLINE13_SR_TIM1_CCU)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC) == (SYSCFG_ITLINE14_SR_TIM1_CC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[15U], SYSCFG_ITLINE15_SR_TIM2_GLB) == (SYSCFG_ITLINE15_SR_TIM2_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[16U], SYSCFG_ITLINE16_SR_TIM3_GLB) == (SYSCFG_ITLINE16_SR_TIM3_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[16U], SYSCFG_ITLINE16_SR_TIM4_GLB) == (SYSCFG_ITLINE16_SR_TIM4_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_DAC) == (SYSCFG_ITLINE17_SR_DAC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_TIM6_GLB) == (SYSCFG_ITLINE17_SR_TIM6_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_LPTIM1_GLB) == (SYSCFG_ITLINE17_SR_LPTIM1_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[18U], SYSCFG_ITLINE18_SR_TIM7_GLB) == (SYSCFG_ITLINE18_SR_TIM7_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[18U], SYSCFG_ITLINE18_SR_LPTIM2_GLB) == (SYSCFG_ITLINE18_SR_LPTIM2_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[19U], SYSCFG_ITLINE19_SR_TIM14_GLB) == (SYSCFG_ITLINE19_SR_TIM14_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[20U], SYSCFG_ITLINE20_SR_TIM15_GLB) == (SYSCFG_ITLINE20_SR_TIM15_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_TIM16_GLB) == (SYSCFG_ITLINE21_SR_TIM16_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_FDCAN1_IT0) == (SYSCFG_ITLINE21_SR_FDCAN1_IT0)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_FDCAN2_IT0) == (SYSCFG_ITLINE21_SR_FDCAN2_IT0)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[22U], SYSCFG_ITLINE22_SR_TIM17_GLB) == (SYSCFG_ITLINE22_SR_TIM17_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[22U], SYSCFG_ITLINE22_SR_FDCAN1_IT1) == (SYSCFG_ITLINE22_SR_FDCAN1_IT1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[22U], SYSCFG_ITLINE22_SR_FDCAN2_IT1) == (SYSCFG_ITLINE22_SR_FDCAN2_IT1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[23U], SYSCFG_ITLINE23_SR_I2C1_GLB) == (SYSCFG_ITLINE23_SR_I2C1_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C2_GLB) == (SYSCFG_ITLINE24_SR_I2C2_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C3_GLB) == (SYSCFG_ITLINE24_SR_I2C3_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[25U], SYSCFG_ITLINE25_SR_SPI1) == (SYSCFG_ITLINE25_SR_SPI1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[26U], SYSCFG_ITLINE26_SR_SPI2) == (SYSCFG_ITLINE26_SR_SPI2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[26U], SYSCFG_ITLINE26_SR_SPI3) == (SYSCFG_ITLINE26_SR_SPI3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[27U], SYSCFG_ITLINE27_SR_USART1_GLB) == (SYSCFG_ITLINE27_SR_USART1_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[28U], SYSCFG_ITLINE28_SR_USART2_GLB) == (SYSCFG_ITLINE28_SR_USART2_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[28U], SYSCFG_ITLINE28_SR_LPUART2_GLB) == (SYSCFG_ITLINE28_SR_LPUART2_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART3_GLB) == (SYSCFG_ITLINE29_SR_USART3_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART4_GLB) == (SYSCFG_ITLINE29_SR_USART4_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_LPUART1_GLB) == (SYSCFG_ITLINE29_SR_LPUART1_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART5_GLB) == (SYSCFG_ITLINE29_SR_USART5_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART6_GLB) == (SYSCFG_ITLINE29_SR_USART6_GLB)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[30U], SYSCFG_ITLINE30_SR_CEC) == (SYSCFG_ITLINE30_SR_CEC)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[31U], SYSCFG_ITLINE31_SR_AES) == (SYSCFG_ITLINE31_SR_AES)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[31U], SYSCFG_ITLINE31_SR_RNG) == (SYSCFG_ITLINE31_SR_RNG)) ? 1UL : 0UL);
}
...
/**
  ...
  * @note For STM32G081xx devices, the device ID is 0x460U
...
/**
  ...
  * @param  Value Between 0 and 0x3FU
  * @retval None
  */
