...
/** @defgroup PWR_LL_EC_PVDLEVEL PVDLEVEL
  * @{
  */
#define LL_PWR_PVDLLEVEL_0                  0x00000000UL                                /* VPVD0 > 2.05 V */
...
#define LL_PWR_PVDHLEVEL_0                  0x00000000UL                                 /* VPDD0 > 2.15 V */
...
/** @defgroup PWR_LL_EC_BATT_CHARG_RESISTOR BATT CHARG RESISTOR
  * @{
  */
#define LL_PWR_BATTCHARG_RESISTOR_5K       0x00000000UL
...
/** @defgroup PWR_LL_EC_GPIO_BIT GPIO BIT
  * @{
  */
#define LL_PWR_GPIO_BIT_0                  0x00000001UL
#define LL_PWR_GPIO_BIT_1                  0x00000002UL
#define LL_PWR_GPIO_BIT_2                  0x00000004UL
#define LL_PWR_GPIO_BIT_3                  0x00000008UL
#define LL_PWR_GPIO_BIT_4                  0x00000010UL
#define LL_PWR_GPIO_BIT_5                  0x00000020UL
#define LL_PWR_GPIO_BIT_6                  0x00000040UL
#define LL_PWR_GPIO_BIT_7                  0x00000080UL
#define LL_PWR_GPIO_BIT_8                  0x00000100UL
#define LL_PWR_GPIO_BIT_9                  0x00000200UL
#define LL_PWR_GPIO_BIT_10                 0x00000400UL
#define LL_PWR_GPIO_BIT_11                 0x00000800UL
#define LL_PWR_GPIO_BIT_12                 0x00001000UL
#define LL_PWR_GPIO_BIT_13                 0x00002000UL
#define LL_PWR_GPIO_BIT_14                 0x00004000UL
#define LL_PWR_GPIO_BIT_15                 0x00008000UL
/**
  * @}
  */
