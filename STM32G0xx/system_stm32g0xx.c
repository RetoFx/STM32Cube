...
/** @addtogroup STM32G0xx_System_Private_Variables
  ...
  */
  ...
  uint32_t const AHBPrescTable[16UL] = {0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 1UL, 2UL, 3UL, 4UL, 6UL, 7UL, 8UL, 9UL};
  uint32_t const APBPrescTable[8UL] =  {0UL, 0UL, 0UL, 0UL, 1UL, 2UL, 3UL, 4UL};
...
void SystemCoreClockUpdate(void)
{
  ...
  switch (RCC->CFGR & RCC_CFGR_SWS)
  {
    ...
    case 0x00000000UL:                   /* HSI used as system clock */
