...
/** @defgroup CRS_LL_EC_SYNC_DIV Synchronization Signal Divider
  * @{
  */
#define LL_CRS_SYNC_DIV_1                  0x00000000UL                               /*!< Synchro Signal not divided (default) */
...
/** @defgroup CRS_LL_EC_SYNC_SOURCE Synchronization Signal Source
  * @{
  */
#define LL_CRS_SYNC_SOURCE_GPIO            0x00000000UL             /*!< Synchro Signal source GPIO */
...
/** @defgroup CRS_LL_EC_SYNC_POLARITY Synchronization Signal Polarity
  * @{
  */
#define LL_CRS_SYNC_POLARITY_RISING        0x00000000UL           /*!< Synchro Active on rising edge (default) */
...
/** @defgroup CRS_LL_EC_FREQERRORDIR Frequency Error Direction
  * @{
  */
#define LL_CRS_FREQ_ERROR_DIR_UP           0x00000000UL         /*!< Upcounting direction, the actual frequency is above the target */
...
/**
  ...
  */
#define LL_CRS_RELOADVALUE_DEFAULT         0x0000BB7FUL

/**
  * @brief Reset value of Frequency error limit.
  */
#define LL_CRS_ERRORLIMIT_DEFAULT          0x00000022UL
...
/**
  ...
  */
#define LL_CRS_HSI48CALIBRATION_DEFAULT    0x00000040UL
/**
  * @}
  */
...
/**
  ...
  * @param  Value a number between Min_Data = 0 and Max_Data = 0xFFFFU
...
/**
  ...
  * @retval a number between Min_Data = 0 and Max_Data = 0xFFFFU
  */
...
/**
  ...
  * @param  ErrorLimitValue a number between Min_Data = 0 and Max_Data = 0xFFFFU
...
/**
  ...
  * @retval A number between Min_Data = 0x0000U and Max_Data = 0xFFFFU
  */
