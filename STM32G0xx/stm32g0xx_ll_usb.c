...
static HAL_StatusTypeDef USB_CoreReset(USB_DRD_TypeDef * const USBx);
#if (USE_USB_DOUBLE_BUFFER == 1U)
static HAL_StatusTypeDef USB_HC_BULK_DB_StartXfer(USB_DRD_TypeDef * const USBx,
                                                  USB_DRD_HCTypeDef * const hc,
                                                  uint32_t ch_reg,
                                                  uint32_t *len);

static HAL_StatusTypeDef USB_HC_ISO_DB_StartXfer(USB_DRD_TypeDef * const USBx,
                                                 USB_DRD_HCTypeDef * const hc,
                                                 uint32_t len);
...
/**
  ...
  * @retval None
  */
void USB_WritePMA(USB_DRD_TypeDef const * const USBx, uint8_t const * const pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes)
{
  UNUSED(USBx);
  uint32_t WrVal;
  uint32_t count;
...
/**
  ...
  * @retval None
  */
void USB_ReadPMA(USB_DRD_TypeDef const * const USBx, uint8_t * const pbUsrBuf, uint16_t wPMABufAddr, uint16_t wNBytes)
{
  UNUSED(USBx);
  uint32_t count;
  uint32_t RdVal;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef USB_HC_DoubleBuffer(USB_DRD_TypeDef * const USBx,
...
/**
  ...
  * @retval HAL state
  */
HAL_StatusTypeDef USB_HC_Init(USB_DRD_TypeDef * const USBx, uint8_t phy_ch_num,
