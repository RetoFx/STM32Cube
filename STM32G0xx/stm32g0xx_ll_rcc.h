...
#define EXTERNAL_CLOCK_VALUE    48000000UL /*!< Value of the I2S_CKIN external oscillator in Hz */
...
/** @defgroup RCC_LL_EC_SYS_CLKSOURCE  System clock switch
  * @{
  */
#define LL_RCC_SYS_CLKSOURCE_HSI           0x00000000UL                        /*!< HSI selection as system clock */
...
/** @defgroup RCC_LL_EC_SYS_CLKSOURCE_STATUS  System clock switch status
  * @{
  */
#define LL_RCC_SYS_CLKSOURCE_STATUS_HSI    0x00000000UL                         /*!< HSI used as system clock */
...
/** @defgroup RCC_LL_EC_SYSCLK_DIV  AHB prescaler
  * @{
  */
#define LL_RCC_SYSCLK_DIV_1                0x00000000UL                                                             /*!< SYSCLK not divided */
...
/** @defgroup RCC_LL_EC_APB1_DIV  APB low-speed prescaler (APB1)
  * @{
  */
#define LL_RCC_APB1_DIV_1                  0x00000000UL                                           /*!< HCLK not divided */
...
/** @defgroup RCC_LL_EC_HSI_DIV  HSI division factor
  * @{
  */
#define LL_RCC_HSI_DIV_1                  0x00000000UL                                /*!< HSI not divided */
...
/** @defgroup RCC_LL_EC_MCO1_DIV  MCO1 prescaler
  * @{
  */
#define LL_RCC_MCO1_DIV_1                  0x00000000UL                                                 /*!< MCO1 not divided */
...
/** @defgroup RCC_LL_EC_MCO2SOURCE  MCO2 SOURCE selection
  * @{
  */
#define LL_RCC_MCO2SOURCE_NOCLOCK          0x00000000UL                                                    /*!< MCO output disabled, no clock on MCO */
...
/** @defgroup RCC_LL_EC_MCO2_DIV  MCO2 prescaler
  * @{
  */
#define LL_RCC_MCO2_DIV_1                  0x00000000UL                                                    /*!< MCO2 not divided */
...
/** @defgroup RCC_LL_EC_USARTx_CLKSOURCE  Peripheral USART clock source selection
  * @{
  */
#define LL_RCC_USART1_CLKSOURCE_PCLK1      ((RCC_CCIPR_USART1SEL << 16U) | 0x00000000UL)            /*!< PCLK1 clock used as USART1 clock source */
...
#define LL_RCC_USART2_CLKSOURCE_PCLK1      ((RCC_CCIPR_USART2SEL << 16U) | 0x00000000UL)            /*!< PCLK1 clock used as USART2 clock source */
...
#define LL_RCC_USART3_CLKSOURCE_PCLK1      ((RCC_CCIPR_USART3SEL << 16U) | 0x00000000UL)           /*!< PCLK1 clock used as USART3 clock source */
...
/** @defgroup RCC_LL_EC_LPUARTx_CLKSOURCE Peripheral LPUART clock source selection
  ...
  */
#if defined(LPUART2)
#define LL_RCC_LPUART2_CLKSOURCE_PCLK1     ((RCC_CCIPR_LPUART2SEL << 16U) | 0x00000000UL)              /*!< PCLK1 clock used as LPUART2 clock source */
...
#endif /* LPUART2 */
#define LL_RCC_LPUART1_CLKSOURCE_PCLK1     ((RCC_CCIPR_LPUART1SEL << 16U) | 0x00000000UL)              /*!< PCLK1 clock used as LPUART1 clock source */
...
/** @defgroup RCC_LL_EC_I2Cx_CLKSOURCE Peripheral I2C clock source selection
  * @{
  */
#define LL_RCC_I2C1_CLKSOURCE_PCLK1        ((RCC_CCIPR_I2C1SEL << 16U) | 0x00000000UL)          /*!< PCLK1 clock used as I2C1 clock source */
...
#define LL_RCC_I2C2_CLKSOURCE_PCLK1        ((RCC_CCIPR_I2C2SEL << 16U) | 0x00000000UL)          /*!< PCLK1 clock used as I2C2 clock source */
...
#define LL_RCC_I2S1_CLKSOURCE_SYSCLK      ((RCC_CCIPR2_I2S1SEL << 16U) | 0x00000000UL)          /*!< SYSCLK clock used as I2S1 clock source */
...
#define LL_RCC_I2S2_CLKSOURCE_SYSCLK      ((RCC_CCIPR2_I2S2SEL << 16U) | 0x00000000UL)          /*!< SYSCLK clock used as I2S2 clock source */
...
#else
#define LL_RCC_I2S1_CLKSOURCE_SYSCLK      0x00000000UL                  /*!< SYSCLK clock used as I2S1 clock source */
...
/** @defgroup RCC_LL_EC_TIMx_CLKSOURCE Peripheral TIM clock source selection
  * @{
  */
#define LL_RCC_TIM1_CLKSOURCE_PCLK1        (RCC_CCIPR_TIM1SEL   | (0x00000000UL >> 16U))          /*!< PCLK1 clock used as TIM1 clock source */
...
/** @addtogroup RCC_LL_EC_TIMx_CLKSOURCE
  * @{
  */
#define LL_RCC_TIM15_CLKSOURCE_PCLK1       (RCC_CCIPR_TIM15SEL  | (0x00000000UL >> 16U))          /*!< PCLK1 clock used as TIM15 clock source */
...
/** @defgroup RCC_LL_EC_LPTIMx_CLKSOURCE Peripheral LPTIM clock source selection
  * @{
  */
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1      (RCC_CCIPR_LPTIM1SEL | (0x00000000UL >> 16U))           /*!< PCLK1 selected as LPTIM1 clock */
...
#define LL_RCC_LPTIM2_CLKSOURCE_PCLK1      (RCC_CCIPR_LPTIM2SEL | (0x00000000UL >> 16U))           /*!< PCLK1 selected as LPTIM2 clock */
...
/** @defgroup RCC_LL_EC_FDCAN_CLKSOURCE_HSI Peripheral FDCAN clock source selection
  * @{
  */
#define LL_RCC_FDCAN_CLKSOURCE_PCLK1         0x00000000UL                   /*!< PCLK1 oscillator clock used as FDCAN clock */
...
/** @defgroup RCC_LL_EC_RNG_CLKSOURCE Peripheral RNG clock source selection
  * @{
  */
#define LL_RCC_RNG_CLKSOURCE_NONE          0x00000000UL                   /*!< No clock used as RNG clock */
...
/** @defgroup RCC_LL_EC_RNG_CLK_DIV Peripheral RNG clock division factor
  * @{
  */
#define LL_RCC_RNG_CLK_DIV1                0x00000000UL                    /*!< RNG clock not divided  */
...
/** @defgroup RCC_LL_EC_ADC_CLKSOURCE Peripheral ADC clock source selection
  * @{
  */
#define LL_RCC_ADC_CLKSOURCE_SYSCLK        0x00000000UL                   /*!< SYSCLK used as ADC clock */
...
/** @defgroup RCC_LL_EC_PLLM_DIV  PLL division factor (PLLM)
  * @{
  */
#define LL_RCC_PLLM_DIV_1                  0x00000000UL                                 /*!< PLL division factor by 1 */
...
/**
  ...
  */
#define __LL_RCC_CALC_HSI_FREQ(__HSIDIV__) (HSI_VALUE / (1UL << ((__HSIDIV__)>> RCC_CR_HSIDIV_Pos)))
...
{
  MODIFY_REG(RCC->CCIPR, (LPUARTxSource >> 16U), (LPUARTxSource & 0x0000FFFFUL));
}
#endif /* LPUART1 */
...
{
  MODIFY_REG(RCC->CCIPR, (I2CxSource >> 16U), (I2CxSource & 0x0000FFFFUL));
}
...
{
  MODIFY_REG(RCC->CCIPR, (TIMxSource & 0xFFFF0000UL), (TIMxSource << 16U));
}
...
{
  MODIFY_REG(RCC->CCIPR2, (I2SxSource >> 16U), (I2SxSource & 0x0000FFFFUL));
}
