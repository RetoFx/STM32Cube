...
/** @defgroup SYSCFG_BootMode Boot Mode
  * @{
  */
#define SYSCFG_BOOT_MAINFLASH          0x00000000UL                      /*!< Main Flash memory mapped at 0x0000U 0000   */
#define SYSCFG_BOOT_SYSTEMFLASH        SYSCFG_CFGR1_MEM_MODE_0          /*!< System Flash memory mapped at 0x0000U 0000 */
#define SYSCFG_BOOT_SRAM               (SYSCFG_CFGR1_MEM_MODE_1 | SYSCFG_CFGR1_MEM_MODE_0)  /*!< Embedded SRAM mapped at 0x0000U 0000 */
...
/** @defgroup HAL_IR_POL_SEL IR output polarity selection
  * @{
  */
#define HAL_SYSCFG_IRDA_POLARITY_NOT_INVERTED     0x00000000UL                                /*!< 00: IR output polarity not inverted */
...
/** @defgroup SYSCFG_VREFBUF_VoltageScale VREFBUF Voltage Scale
  * @{
  */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0  0x00000000UL            /*!< Voltage reference scale 0: VREF_OUT1 around 2.048 V.
...
/** @defgroup SYSCFG_VREFBUF_HighImpedance VREFBUF High Impedance
  * @{
  */
#define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE  0x00000000UL        /*!< VREF_plus pin is internally connected to Voltage reference buffer output */
...
/** @defgroup HAL_ISR_Wrapper HAL ISR Wrapper
  ...
  * @{
  */
#define HAL_SYSCFG_ITLINE0                           0x00000000UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE1                           0x00000001UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE2                           0x00000002UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE3                           0x00000003UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE4                           0x00000004UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE5                           0x00000005UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE6                           0x00000006UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE7                           0x00000007UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE8                           0x00000008UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE9                           0x00000009UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE10                          0x0000000AUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE11                          0x0000000BUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE12                          0x0000000CUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE13                          0x0000000DUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE14                          0x0000000EUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE15                          0x0000000FUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE16                          0x00000010UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE17                          0x00000011UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE18                          0x00000012UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE19                          0x00000013UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE20                          0x00000014UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE21                          0x00000015UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE22                          0x00000016UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE23                          0x00000017UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE24                          0x00000018UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE25                          0x00000019UL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE26                          0x0000001AUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE27                          0x0000001BUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE28                          0x0000001CUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE29                          0x0000001DUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE30                          0x0000001EUL /*!< Internal define for macro handling */
#define HAL_SYSCFG_ITLINE31                          0x0000001FUL /*!< Internal define for macro handling */
...
#define HAL_ITLINE_RTC            ((HAL_SYSCFG_ITLINE2 << 0x18U) | SYSCFG_ITLINE2_SR_RTC)           /*!< RTC -> exti[19U] Interrupt */
#define HAL_ITLINE_TAMPER         ((HAL_SYSCFG_ITLINE2 << 0x18U) | SYSCFG_ITLINE2_SR_TAMPER)        /*!< TAMPER -> exti[21U] interrupt .... */
...
#if defined (COMP1)
#define HAL_ITLINE_COMP1          ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_COMP1)       /*!< COMP1 Interrupt -> exti[17U] */
#endif /* COMP1 */
#if defined (COMP2)
#define HAL_ITLINE_COMP2          ((HAL_SYSCFG_ITLINE12 << 0x18U) | SYSCFG_ITLINE12_SR_COMP2)       /*!< COMP2 Interrupt -> exti[18U] */
#endif /* COMP2 */
#if defined (COMP3)
...
#endif /* DAC1 */
#if defined(LPTIM1)
#define HAL_ITLINE_LPTIM1         ((HAL_SYSCFG_ITLINE17 << 0x18U) | SYSCFG_ITLINE17_SR_LPTIM1_GLB)  /*!< LPTIM1 Interrupt -> exti[29U] */
#endif /* LPTIM1 */
#if defined(TIM7)
#define HAL_ITLINE_TIM7           ((HAL_SYSCFG_ITLINE18 << 0x18U) | SYSCFG_ITLINE18_SR_TIM7_GLB)    /*!< TIM7 Interrupt */
#endif /* TIM7 */
#if defined(LPTIM2)
#define HAL_ITLINE_LPTIM2         ((HAL_SYSCFG_ITLINE18 << 0x18U) | SYSCFG_ITLINE18_SR_LPTIM2_GLB)  /*!< LPTIM2 Interrupt -> exti[30U] */
#endif /* LPTIM2 */
...
#endif /* FDCAN1 || FDCAN2 */
#define HAL_ITLINE_I2C1           ((HAL_SYSCFG_ITLINE23 << 0x18U) | SYSCFG_ITLINE23_SR_I2C1_GLB)    /*!< I2C1 Interrupt -> exti[23U] */
#define HAL_ITLINE_I2C2           ((HAL_SYSCFG_ITLINE24 << 0x18U) | SYSCFG_ITLINE24_SR_I2C2_GLB)    /*!< I2C2 Interrupt -> exti[24U] */
#if defined (I2C3)
#define HAL_ITLINE_I2C3           ((HAL_SYSCFG_ITLINE24 << 0x18U) | SYSCFG_ITLINE24_SR_I2C3_GLB)    /*!< I2C3 Interrupt -> exti[22U] */
#endif /* I2C3 */
...
#endif /* SPI3 */
#define HAL_ITLINE_USART1         ((HAL_SYSCFG_ITLINE27 << 0x18U) | SYSCFG_ITLINE27_SR_USART1_GLB)  /*!< USART1 GLB Interrupt -> exti[25U] */
#define HAL_ITLINE_USART2         ((HAL_SYSCFG_ITLINE28 << 0x18U) | SYSCFG_ITLINE28_SR_USART2_GLB)  /*!< USART2 GLB Interrupt -> exti[26U] */
#if defined (LPUART2)
#define HAL_ITLINE_LPUART2        ((HAL_SYSCFG_ITLINE28 << 0x18U) | SYSCFG_ITLINE28_SR_LPUART2_GLB)  /*!< LPUART2 GLB Interrupt -> exti[26U] */
#endif /* LPUART2 */
#if defined(USART3)
...
#endif /* USART4 */
#if defined (LPUART1)
#define HAL_ITLINE_LPUART1        ((HAL_SYSCFG_ITLINE29 << 0x18U) | SYSCFG_ITLINE29_SR_LPUART1_GLB) /*!< LPUART1 Interrupt -> exti[28U]*/
#endif /* LPUART1 */
#if defined (USART5)
...
#endif /* USART6 */
#if defined (CEC)
#define HAL_ITLINE_CEC            ((HAL_SYSCFG_ITLINE30 << 0x18U) | SYSCFG_ITLINE30_SR_CEC)         /*!< CEC Interrupt -> exti[27U] */
#endif /* CEC */
#if defined (RNG)
...
/**
  ...
  */
#define __HAL_GET_PENDING_IT(__SOURCE__)     (SYSCFG->IT_LINE_SR[((__SOURCE__) >> 0x18U)] & ((__SOURCE__) & 0x00FFFFFFUL))

/** @brief  Main Flash memory mapped at 0x00000000UL
  */
#define __HAL_SYSCFG_REMAPMEMORY_FLASH()     CLEAR_BIT(SYSCFG->CFGR1, SYSCFG_CFGR1_MEM_MODE)

/** @brief  System Flash memory mapped at 0x00000000UL
  */
#define __HAL_SYSCFG_REMAPMEMORY_SYSTEMFLASH() MODIFY_REG(SYSCFG->CFGR1, SYSCFG_CFGR1_MEM_MODE, SYSCFG_CFGR1_MEM_MODE_0)

/** @brief  Embedded SRAM mapped at 0x00000000UL
  */
...
#define __HAL_SYSCFG_GET_PENDING_IT(__SOURCE__)  \
  (SYSCFG->IT_LINE_SR[((__SOURCE__) >> 0x18U)] & ((__SOURCE__) & 0x00FFFFFFUL))
...
#define __HAL_SYSCFG_GET_IRDA_ENV_SELECTION()  ((SYSCFG->CFGR1) & 0x000000C0UL)

/** @brief  IROut Polarity Selection, using bit[5U] of SYSCFG_CFGR1 register
