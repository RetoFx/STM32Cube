...
/** @defgroup PWR_PVD_detection_level  Programmable Voltage Detection levels
  ...
  * @{
  */
#define PWR_PVDLEVEL_RISING_0               (0x00000000UL)                                           /*!< PVD threshold level 0 for rising detection */
...
#define PWR_PVDLEVEL_FALLING_0              (0x00000000UL)                                           /*!< PVD threshold level 0 for falling detection */
...
/** @defgroup PWR_PVD_Mode  PWR PVD interrupt and event mode
  * @{
  */
#define PWR_PVD_MODE_NORMAL                 (0x00000000UL)  /*!< basic mode is used */
#define PWR_PVD_MODE_IT_RISING              (0x00010001UL)  /*!< External Interrupt Mode with Rising edge trigger detection */
#define PWR_PVD_MODE_IT_FALLING             (0x00010002UL)  /*!< External Interrupt Mode with Falling edge trigger detection */
#define PWR_PVD_MODE_IT_RISING_FALLING      (0x00010003UL)  /*!< External Interrupt Mode with Rising/Falling edge trigger detection */
#define PWR_PVD_MODE_EVENT_RISING           (0x00020001UL)  /*!< Event Mode with Rising edge trigger detection */
#define PWR_PVD_MODE_EVENT_FALLING          (0x00020002UL)  /*!< Event Mode with Falling edge trigger detection */
#define PWR_PVD_MODE_EVENT_RISING_FALLING   (0x00020003UL)  /*!< Event Mode with Rising/Falling edge trigger detection */
/**
  * @}
  */
...
/** @addtogroup PWR_Flag  PWR Status Flags
  ...
  */
#if defined(PWR_PVM_SUPPORT)
#define PWR_FLAG_PVMOUSB                    (0x00020000UL | PWR_SR2_PVMO_USB)   /*!< USB Peripheral Voltage Monitoring output */
#endif /* PWR_PVM_SUPPORT */
/**
  * @}
  */
...
/** @defgroup PWREx_PVM_Mode_Mask PWR PVM Mode Mask
  * @{
  */
#define PVM_MODE_IT               ((uint32_t)0x00010000UL)  /*!< Mask for interruption yielded by PVM threshold crossing */
#define PVM_MODE_EVT              ((uint32_t)0x00020000UL)  /*!< Mask for event yielded by PVM threshold crossing        */
#define PVM_RISING_EDGE           ((uint32_t)0x00000001UL)  /*!< Mask for rising edge set as PVM trigger                 */
#define PVM_FALLING_EDGE          ((uint32_t)0x00000002UL)  /*!< Mask for falling edge set as PVM trigger                */
/**
  * @}
  */
...
#define IS_PWR_GPIO_BIT_NUMBER(__BIT_NUMBER__)  ((((__BIT_NUMBER__) & 0x0000FFFFUL) != 0x00U) && \
                                                 (((__BIT_NUMBER__) & 0xFFFF0000UL) == 0x00U))
#if defined (GPIOE)
...
#if defined(PWR_PVD_SUPPORT)
#define IS_PWR_PVD_LEVEL(LEVEL)                   (((LEVEL) & ~(PWR_CR2_PVDRT | PWR_CR2_PVDFT)) == 0x00000000UL)
...
HAL_StatusTypeDef HAL_PWREx_ConfigPVD(PWR_PVDTypeDef const * const sConfigPVD);
