...
#define HAL_FDCAN_ERROR_FIFO_EMPTY      ((uint32_t)0x00000100UL) /*!< Put element in full FIFO                                               */
#define HAL_FDCAN_ERROR_FIFO_FULL       ((uint32_t)0x00000200UL) /*!< Get element from empty FIFO                                            */
