...
typedef struct
{
  ...
  uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48 oscillator.
                                       This parameter must be a number between 0 and 0x7FU or a value of @ref RCCEx_CRS_HSI48CalibrationDefault */
...
#endif /* RCC_CCIPR_USART3SEL */
#if defined(LPUART1)
#define RCC_PERIPHCLK_LPUART1          0x00000010UL
#endif /* LPUART1 */
#define RCC_PERIPHCLK_I2C1             0x00000020UL
#if defined(RCC_CCIPR_I2C2SEL)
#define RCC_PERIPHCLK_I2C2             0x00000040UL
#endif /* RCC_CCIPR_I2C2SEL */
#if defined(RCC_CCIPR_LPTIM1SEL)
...
#endif /* RCC_CCIPR_LPTIM2SEL */
#define RCC_PERIPHCLK_I2S1             0x00000800UL
#if defined(LPUART2)
#define RCC_PERIPHCLK_LPUART2          0x00001000UL
#endif /* LPUART2 */
#if defined(RCC_CCIPR2_I2S2SEL)
#define RCC_PERIPHCLK_I2S2             0x00002000UL
#endif /* RCC_CCIPR2_I2S2SEL */
...
#define RCC_PERIPHCLK_CEC              0x00080000UL
#endif /* RCC_CCIPR_CECSEL */
#if defined(RCC_CCIPR_TIM1SEL)
#define RCC_PERIPHCLK_TIM1             0x00200000UL
#endif /* RCC_CCIPR_TIM1SEL */
#if defined(RCC_CCIPR_TIM15SEL)
#define RCC_PERIPHCLK_TIM15            0x00400000UL
#endif /* RCC_CCIPR_TIM15SEL */
#if defined(RCC_CCIPR2_USBSEL)
#define RCC_PERIPHCLK_USB              0x01000000UL
#endif /* RCC_CCIPR2_USBSEL */
#if defined(FDCAN1) || defined(FDCAN2)
#define RCC_PERIPHCLK_FDCAN            0x02000000UL
#endif /* FDCAN1 || FDCAN2 */
/**
  * @}
  */
...
/** @defgroup RCCEx_USART1_Clock_Source RCC USART1 Clock Source
  * @{
  */
#define RCC_USART1CLKSOURCE_PCLK1      0x00000000UL                                      /*!< APB clock selected as USART1 clock */
...
/** @defgroup RCCEx_USART2_Clock_Source RCC USART2 Clock Source
  * @{
  */
#define RCC_USART2CLKSOURCE_PCLK1      0x00000000UL                                      /*!< APB clock selected as USART2 clock */
...
/** @defgroup RCCEx_USART3_Clock_Source RCC USART3 Clock Source
  * @{
  */
#define RCC_USART3CLKSOURCE_PCLK1      0x00000000UL                                      /*!< APB clock selected as USART3 clock */
...
/** @defgroup RCCEx_LPUART1_Clock_Source RCC LPUART1 Clock Source
  * @{
  */
#define RCC_LPUART1CLKSOURCE_PCLK1     0x00000000UL                                        /*!< APB clock selected as LPUART1 clock */
...
/** @defgroup RCCEx_LPUART2_Clock_Source RCC LPUART2 Clock Source
  * @{
  */
#define RCC_LPUART2CLKSOURCE_PCLK1     0x00000000UL                                        /*!< APB clock selected as LPUART2 clock */
...
/** @defgroup RCCEx_I2C1_Clock_Source RCC I2C1 Clock Source
  * @{
  */
#define RCC_I2C1CLKSOURCE_PCLK1        0x00000000UL                                      /*!< APB clock selected as I2C1 clock */
...
/** @defgroup RCCEx_I2C2_Clock_Source RCC I2C2 Clock Source
  * @{
  */
#define RCC_I2C2CLKSOURCE_PCLK1        0x00000000UL                                      /*!< APB clock selected as I2C2 clock */
...
#define RCC_I2S1CLKSOURCE_SYSCLK       0x00000000UL                                      /*!< SYSCLK clock selected as I2S1 clock */
...
/** @defgroup RCCEx_I2S2_Clock_Source RCC I2S2 Clock Source
  * @{
  */
#define RCC_I2S2CLKSOURCE_SYSCLK       0x00000000UL                                      /*!< SYSCLK clock selected as I2S2 clock */
...
/** @defgroup RCCEx_LPTIM1_Clock_Source RCC LPTIM1 Clock Source
  * @{
  */
#define RCC_LPTIM1CLKSOURCE_PCLK1      0x00000000UL               /*!< APB clock selected as LPTimer 1 clock */
...
/** @defgroup RCCEx_LPTIM2_Clock_Source RCC LPTIM2 Clock Source
  * @{
  */
#define RCC_LPTIM2CLKSOURCE_PCLK1      0x00000000UL               /*!< APB clock selected as LPTimer 2 clock */
...
/** @defgroup RCCEx_RNG_Clock_Source RCC RNG Clock Source
  * @{
  */
#define RCC_RNGCLKSOURCE_NONE          0x00000000UL                             /*!< No clock selected */
...
/** @defgroup RCCEx_RNG_Division_factor RCC RNG Division factor
  * @{
  */
#define RCC_RNGCLK_DIV1           0x00000000UL                              /*!< RNG clock not divided  */
...
/** @defgroup RCCEx_FDCAN_Clock_Source RCC FDCAN Clock Source
  * @{
  */
#define RCC_FDCANCLKSOURCE_PCLK1        0x00000000UL                        /*!< PCLK1 selected as FDCAN clock */
...
#define RCC_USBCLKSOURCE_HSI48         0x00000000UL            /*!< HSI48 oscillator clock selected as USB clock */
...
#define RCC_ADCCLKSOURCE_SYSCLK       0x00000000UL             /*!< SYSCLK used as ADC clock */
...
/** @defgroup RCCEx_CEC_Clock_Source RCC CEC Clock Source
  * @{
  */
#define RCC_CECCLKSOURCE_HSI_DIV488          0x00000000UL      /*!< HSI oscillator clock divided by 488 used as default CEC clock */
...
/** @defgroup RCCEx_TIM1_Clock_Source RCC TIM1 Clock Source
  * @{
  */
#define RCC_TIM1CLKSOURCE_PCLK1       0x00000000UL             /*!< APB clock selected as Timer 1 clock */
...
/** @defgroup RCCEx_TIM15_Clock_Source RCC TIM15 Clock Source
  * @{
  */
#define RCC_TIM15CLKSOURCE_PCLK1      0x00000000UL             /*!< APB clock selected as Timer 15 clock */
