...
typedef struct
{
  uint32_t SignalFreeTime;               /*!< Set SFT field, specifies the Signal Free Time.
                                              ...
                                              0x0U is the default configuration
...
#endif /* USE_HAL_CEC_REGISTER_CALLBACKS */
{
  ...
  void (* RxCpltCallback)(struct __CEC_HandleTypeDef * const hcec,
                          uint32_t RxFrameSize);                 /*!< CEC Rx Transfer completed callback  */
  void (* ErrorCallback)(struct __CEC_HandleTypeDef * const hcec);      /*!< CEC error callback                  */

  void (* MspInitCallback)(struct __CEC_HandleTypeDef * const hcec);    /*!< CEC Msp Init callback               */
  void (* MspDeInitCallback)(struct __CEC_HandleTypeDef * const hcec);  /*!< CEC Msp DeInit callback             */
...
/**
  ...
  */
typedef  void (*pCEC_CallbackTypeDef)(CEC_HandleTypeDef * const hcec);  /*!< pointer to an CEC callback function */
typedef  void (*pCEC_RxCallbackTypeDef)(CEC_HandleTypeDef * const hcec,
...
/** @defgroup CEC_State_Definition CEC State Code Definition
  * @{
  */
#define   HAL_CEC_STATE_RESET      ((uint32_t)0x00000000UL)   /*!< Peripheral is not yet Initialized
                                                                 Value is allowed for gState and RxState  */
#define   HAL_CEC_STATE_READY      ((uint32_t)0x00000020UL)   /*!< Peripheral Initialized and ready for use
                                                                 Value is allowed for gState and RxState  */
#define   HAL_CEC_STATE_BUSY       ((uint32_t)0x00000024UL)   /*!< an internal process is ongoing
                                                                 Value is allowed for gState only         */
#define   HAL_CEC_STATE_BUSY_RX    ((uint32_t)0x00000022UL)   /*!< Data Reception process is ongoing
                                                                 Value is allowed for RxState only        */
#define   HAL_CEC_STATE_BUSY_TX    ((uint32_t)0x00000021UL)   /*!< Data Transmission process is ongoing
                                                                 Value is allowed for gState only         */
#define   HAL_CEC_STATE_BUSY_RX_TX ((uint32_t)0x00000023UL)   /*!< an internal process is ongoing
                                                                 Value is allowed for gState only         */
#define   HAL_CEC_STATE_ERROR      ((uint32_t)0x00000050UL)   /*!< Error Value is allowed for gState only   */
/**
  * @}
  */
...
#if (USE_HAL_CEC_REGISTER_CALLBACKS == 1U)
#define  HAL_CEC_ERROR_INVALID_CALLBACK ((uint32_t)0x00002000UL) /*!< Invalid Callback Error  */
#endif /* USE_HAL_CEC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup CEC_Signal_Free_Time  CEC Signal Free Time setting parameter
  * @{
  */
#define CEC_DEFAULT_SFT                    ((uint32_t)0x00000000UL)
#define CEC_0_5_BITPERIOD_SFT              ((uint32_t)0x00000001UL)
#define CEC_1_5_BITPERIOD_SFT              ((uint32_t)0x00000002UL)
#define CEC_2_5_BITPERIOD_SFT              ((uint32_t)0x00000003UL)
#define CEC_3_5_BITPERIOD_SFT              ((uint32_t)0x00000004UL)
#define CEC_4_5_BITPERIOD_SFT              ((uint32_t)0x00000005UL)
#define CEC_5_5_BITPERIOD_SFT              ((uint32_t)0x00000006UL)
#define CEC_6_5_BITPERIOD_SFT              ((uint32_t)0x00000007UL)
/**
  * @}
  */
...
/** @defgroup CEC_Tolerance CEC Receiver Tolerance
  * @{
  */
#define CEC_STANDARD_TOLERANCE             ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_BRERxStop CEC Reception Stop on Error
  * @{
  */
#define CEC_NO_RX_STOP_ON_BRE             ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_BREErrorBitGen  CEC Error Bit Generation if Bit Rise Error reported
  * @{
  */
#define CEC_BRE_ERRORBIT_NO_GENERATION     ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_LBPEErrorBitGen  CEC Error Bit Generation if Long Bit Period Error reported
  * @{
  */
#define CEC_LBPE_ERRORBIT_NO_GENERATION     ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_BroadCastMsgErrorBitGen  CEC Error Bit Generation on Broadcast message
  * @{
  */
#define CEC_BROADCASTERROR_ERRORBIT_GENERATION     ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_SFT_Option     CEC Signal Free Time start option
  * @{
  */
#define CEC_SFT_START_ON_TXSOM           ((uint32_t)0x00000000UL)
...
/** @defgroup CEC_Listening_Mode    CEC Listening mode option
  * @{
  */
#define CEC_REDUCED_LISTENING_MODE          ((uint32_t)0x00000000UL)
...
HAL_StatusTypeDef HAL_CEC_Init(CEC_HandleTypeDef * const hcec);
HAL_StatusTypeDef HAL_CEC_DeInit(CEC_HandleTypeDef * const hcec);
HAL_StatusTypeDef HAL_CEC_SetDeviceAddress(CEC_HandleTypeDef * const hcec, uint16_t CEC_OwnAddress);
void HAL_CEC_MspInit(CEC_HandleTypeDef * const hcec);
void HAL_CEC_MspDeInit(CEC_HandleTypeDef * const hcec);

#if (USE_HAL_CEC_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_CEC_RegisterCallback(CEC_HandleTypeDef * const hcec, HAL_CEC_CallbackIDTypeDef CallbackID,
                                           pCEC_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_CEC_UnRegisterCallback(CEC_HandleTypeDef * const hcec, HAL_CEC_CallbackIDTypeDef CallbackID);

HAL_StatusTypeDef HAL_CEC_RegisterRxCpltCallback(CEC_HandleTypeDef * const hcec, pCEC_RxCallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_CEC_UnRegisterRxCpltCallback(CEC_HandleTypeDef * const hcec);
#endif /* USE_HAL_CEC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_CEC_Transmit_IT(CEC_HandleTypeDef * const hcec, uint8_t InitiatorAddress, uint8_t DestinationAddress,
                                      uint8_t const * const pData, uint32_t Size);
uint32_t HAL_CEC_GetLastReceivedFrameSize(CEC_HandleTypeDef const * const hcec);
void HAL_CEC_ChangeRxBuffer(CEC_HandleTypeDef * const hcec, uint8_t * const Rxbuffer);
void HAL_CEC_IRQHandler(CEC_HandleTypeDef * const hcec);
void HAL_CEC_TxCpltCallback(CEC_HandleTypeDef * const hcec);
void HAL_CEC_RxCpltCallback(CEC_HandleTypeDef * const hcec, uint32_t RxFrameSize);
void HAL_CEC_ErrorCallback(CEC_HandleTypeDef * const hcec);
/**
  * @}
  */
...
HAL_CEC_StateTypeDef HAL_CEC_GetState(CEC_HandleTypeDef const * const hcec);
uint32_t HAL_CEC_GetError(CEC_HandleTypeDef const * const hcec);
/**
  * @}
  */
