...
/** @defgroup RTCEx_Smooth_calib_period_Definitions RTCEx Smooth calib period Definitions
  * @{
  */
#define RTC_SMOOTHCALIB_PERIOD_32SEC   0x00000000UL              /*!< If RTCCLK = 32768 Hz, Smooth calibation
...
/** @brief  Check whether the specified RTC flag is set or not.
  ...
  */
#define __HAL_RTC_GET_FLAG(__HANDLE__, __FLAG__)    (((((__FLAG__)) >> 8U) == 1U) ? ((((__HANDLE__)->Instance->ICSR & (1UL << (((uint16_t)(__FLAG__)) & RTC_FLAG_MASK))) != 0U) ? 1U : 0U) : \
                                                                                    ((((__HANDLE__)->Instance->SR   & (1UL << (((uint16_t)(__FLAG__)) & RTC_FLAG_MASK))) != 0U) ? 1U : 0U))
...
#define __HAL_RTC_WAKEUPTIMER_GET_FLAG(__HANDLE__, __FLAG__)( \
                                ((__FLAG__) == RTC_FLAG_WUTF)  ? (((((__HANDLE__)->Instance->SR)   & (RTC_SR_WUTF))    != 0) ? 1U : 0U): \
                                                                 (((((__HANDLE__)->Instance->ICSR) & (RTC_ICSR_WUTWF)) != 0U) ? 1U : 0U))
...
#define __HAL_RTC_TIMESTAMP_GET_FLAG(__HANDLE__, __FLAG__)( \
                                ((__FLAG__) == RTC_FLAG_TSF)   ? (((((__HANDLE__)->Instance->SR) & (RTC_SR_TSF))   != 0) ? 1U : 0U): \
                                                                 (((((__HANDLE__)->Instance->SR) & (RTC_SR_TSOVF)) != 0U) ? 1U : 0U))
