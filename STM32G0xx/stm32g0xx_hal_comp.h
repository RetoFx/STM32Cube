...
/** @defgroup COMP_WindowMode_Instance_Differentiator COMP window mode instance differentiator
  * @{
  */
#define COMP_WINDOWMODE_COMP2          0x00001000UL       /*!< COMP window mode using common input of COMP instance: COMP2 */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_COMP_RegisterCallback(COMP_HandleTypeDef * const hcomp, HAL_COMP_CallbackIDTypeDef CallbackID,
