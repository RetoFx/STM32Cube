...
#define USART_WORDLENGTH_8B                  (0x00000000UL)    /*!< 8-bit long USART frame */
...
/** @defgroup USARTEx_Slave_Select_management USARTEx Slave Select Management
  * @{
  */
#define USART_NSS_HARD                        0x00000000UL          /*!< SPI slave selection depends on NSS input pin              */
...
/** @defgroup USARTEx_Slave_Mode USARTEx Synchronous Slave mode enable
  ...
  * @{
  */
#define USART_SLAVEMODE_DISABLE   0x00000000UL     /*!< USART SPI Slave Mode Enable  */
...
/** @defgroup USARTEx_FIFO_mode USARTEx FIFO  mode
  ...
  * @{
  */
#define USART_FIFOMODE_DISABLE        0x00000000UL                   /*!< FIFO mode disable */
...
/** @defgroup USARTEx_TXFIFO_threshold_level USARTEx TXFIFO threshold level
  ...
  * @{
  */
#define USART_TXFIFO_THRESHOLD_1_8   0x00000000UL                               /*!< TXFIFO reaches 1/8 of its depth */
...
/** @defgroup USARTEx_RXFIFO_threshold_level USARTEx RXFIFO threshold level
  ...
  * @{
  */
#define USART_RXFIFO_THRESHOLD_1_8   0x00000000UL                               /*!< RXFIFO FIFO reaches 1/8 of its depth */
...
void HAL_USARTEx_RxFifoFullCallback(USART_HandleTypeDef * const husart);
void HAL_USARTEx_TxFifoEmptyCallback(USART_HandleTypeDef * const husart);
...
HAL_StatusTypeDef HAL_USARTEx_EnableSlaveMode(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USARTEx_DisableSlaveMode(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USARTEx_ConfigNSS(USART_HandleTypeDef * const husart, uint32_t NSSConfig);
HAL_StatusTypeDef HAL_USARTEx_EnableFifoMode(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USARTEx_DisableFifoMode(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USARTEx_SetTxFifoThreshold(USART_HandleTypeDef * const husart, uint32_t Threshold);
HAL_StatusTypeDef HAL_USARTEx_SetRxFifoThreshold(USART_HandleTypeDef * const husart, uint32_t Threshold);
