...
/** @addtogroup SPDIFRX_Private_Functions
  * @{
  */
static void  SPDIFRX_DMARxCplt(DMA_HandleTypeDef * const hdma);
static void  SPDIFRX_DMARxHalfCplt(DMA_HandleTypeDef * const hdma);
static void  SPDIFRX_DMACxCplt(DMA_HandleTypeDef * const hdma);
static void  SPDIFRX_DMACxHalfCplt(DMA_HandleTypeDef * const hdma);
static void  SPDIFRX_DMAError(DMA_HandleTypeDef * const hdma);
static void  SPDIFRX_ReceiveControlFlow_IT(SPDIFRX_HandleTypeDef * const hspdif);
static void  SPDIFRX_ReceiveDataFlow_IT(SPDIFRX_HandleTypeDef * const hspdif);
static HAL_StatusTypeDef  SPDIFRX_WaitOnFlagUntilTimeout(SPDIFRX_HandleTypeDef * const hspdif, uint32_t Flag,
...
/**
  ...
  * @retval None
  */
__weak void HAL_SPDIFRX_MspInit(SPDIFRX_HandleTypeDef * const hspdif)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SPDIFRX_MspDeInit(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
{
  uint32_t count = SPDIFRX_TIMEOUT_VALUE * (SystemCoreClock / 24UL / 1000UL);
...
/**
  ...
  * @retval None
  */
HAL_SPDIFRX_WEAK_CALLBACK(void, HAL_SPDIFRX_RxHalfCpltCallback)(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
/**
  ...
  * @retval None
  */
HAL_SPDIFRX_WEAK_CALLBACK(void, HAL_SPDIFRX_RxCpltCallback)(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
/**
  ...
  * @retval None
  */
HAL_SPDIFRX_WEAK_CALLBACK(void, HAL_SPDIFRX_CxHalfCpltCallback)(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
/**
  ...
  * @retval None
  */
HAL_SPDIFRX_WEAK_CALLBACK(void, HAL_SPDIFRX_CxCpltCallback)(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
/**
  ...
  * @retval None
  */
HAL_SPDIFRX_WEAK_CALLBACK(void, HAL_SPDIFRX_ErrorCallback)(SPDIFRX_HandleTypeDef * const hspdif)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hspdif);
...
static void SPDIFRX_DMARxCplt(DMA_HandleTypeDef * const hdma)
{
  SPDIFRX_HandleTypeDef * const hspdif = (SPDIFRX_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
