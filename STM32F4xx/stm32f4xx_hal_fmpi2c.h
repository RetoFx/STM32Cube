...
/** @defgroup FMPI2C_Error_Code_definition FMPI2C Error Code definition
  ...
  * @{
  */
#define HAL_FMPI2C_ERROR_NONE      (0x00000000UL)    /*!< No error              */
#define HAL_FMPI2C_ERROR_BERR      (0x00000001UL)    /*!< BERR error            */
#define HAL_FMPI2C_ERROR_ARLO      (0x00000002UL)    /*!< ARLO error            */
#define HAL_FMPI2C_ERROR_AF        (0x00000004UL)    /*!< ACKF error            */
#define HAL_FMPI2C_ERROR_OVR       (0x00000008UL)    /*!< OVR error             */
#define HAL_FMPI2C_ERROR_DMA       (0x00000010UL)    /*!< DMA transfer error    */
#define HAL_FMPI2C_ERROR_TIMEOUT   (0x00000020UL)    /*!< Timeout error         */
#define HAL_FMPI2C_ERROR_SIZE      (0x00000040UL)    /*!< Size Management error */
#define HAL_FMPI2C_ERROR_DMA_PARAM (0x00000080UL)    /*!< DMA Parameter Error   */
#if (USE_HAL_FMPI2C_REGISTER_CALLBACKS == 1U)
#define HAL_FMPI2C_ERROR_INVALID_CALLBACK  (0x00000100UL)    /*!< Invalid Callback error */
#endif /* USE_HAL_FMPI2C_REGISTER_CALLBACKS */
#define HAL_FMPI2C_ERROR_INVALID_PARAM     (0x00000200UL)    /*!< Invalid Parameters error  */
/**
  * @}
  */
...
typedef struct __FMPI2C_HandleTypeDef
{
  ...
  HAL_StatusTypeDef(*XferISR)(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags, uint32_t ITSources);
...
#if (USE_HAL_FMPI2C_REGISTER_CALLBACKS == 1U)
  void (* MasterTxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Master Tx Transfer completed callback */
  void (* MasterRxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Master Rx Transfer completed callback */
  void (* SlaveTxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Slave Tx Transfer completed callback  */
  void (* SlaveRxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Slave Rx Transfer completed callback  */
  void (* ListenCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Listen Complete callback              */
  void (* MemTxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Memory Tx Transfer completed callback */
  void (* MemRxCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Memory Rx Transfer completed callback */
  void (* ErrorCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Error callback                        */
  void (* AbortCpltCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Abort callback                        */

  void (* AddrCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t TransferDirection, uint16_t AddrMatchCode);
  /*!< FMPI2C Slave Address Match callback */

  void (* MspInitCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
  /*!< FMPI2C Msp Init callback                     */
  void (* MspDeInitCallback)(struct __FMPI2C_HandleTypeDef * const hfmpi2c);
...
/**
  ...
  */
typedef  void (*pFMPI2C_CallbackTypeDef)(FMPI2C_HandleTypeDef * const hfmpi2c);
/*!< pointer to an FMPI2C callback function */
typedef  void (*pFMPI2C_AddrCallbackTypeDef)(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t TransferDirection,
 ...
 */
#define  FMPI2C_OTHER_FRAME                (0x000000AAUL)
#define  FMPI2C_OTHER_AND_LAST_FRAME       (0x0000AA00UL)
/**
  * @}
  */
...
/** @defgroup FMPI2C_ADDRESSING_MODE FMPI2C Addressing Mode
  * @{
  */
#define FMPI2C_ADDRESSINGMODE_7BIT         (0x00000001UL)
#define FMPI2C_ADDRESSINGMODE_10BIT        (0x00000002UL)
/**
  * @}
  */
...
/** @defgroup FMPI2C_DUAL_ADDRESSING_MODE FMPI2C Dual Addressing Mode
  * @{
  */
#define FMPI2C_DUALADDRESS_DISABLE         (0x00000000UL)
...
/** @defgroup FMPI2C_GENERAL_CALL_ADDRESSING_MODE FMPI2C General Call Addressing Mode
  * @{
  */
#define FMPI2C_GENERALCALL_DISABLE         (0x00000000UL)
...
/** @defgroup FMPI2C_NOSTRETCH_MODE FMPI2C No-Stretch Mode
  * @{
  */
#define FMPI2C_NOSTRETCH_DISABLE           (0x00000000UL)
...
/** @defgroup FMPI2C_MEMORY_ADDRESS_SIZE FMPI2C Memory Address Size
  * @{
  */
#define FMPI2C_MEMADD_SIZE_8BIT            (0x00000001UL)
#define FMPI2C_MEMADD_SIZE_16BIT           (0x00000002UL)
/**
  * @}
  */
...
/** @defgroup FMPI2C_XFERDIRECTION FMPI2C Transfer Direction Master Point of View
  * @{
  */
#define FMPI2C_DIRECTION_TRANSMIT          (0x00000000UL)
#define FMPI2C_DIRECTION_RECEIVE           (0x00000001UL)
/**
  * @}
  */
...
#define  FMPI2C_SOFTEND_MODE               (0x00000000UL)
/**
  * @}
  */
...
/** @defgroup FMPI2C_START_STOP_MODE FMPI2C Start or Stop Mode
  * @{
  */
#define  FMPI2C_NO_STARTSTOP               (0x00000000UL)
#define  FMPI2C_GENERATE_STOP              (uint32_t)(0x80000000UL | FMPI2C_CR2_STOP)
#define  FMPI2C_GENERATE_START_READ        (uint32_t)(0x80000000UL | FMPI2C_CR2_START | FMPI2C_CR2_RD_WRN)
#define  FMPI2C_GENERATE_START_WRITE       (uint32_t)(0x80000000UL | FMPI2C_CR2_START)
/**
  * @}
  */
...
/** @brief  Check whether the specified FMPI2C flag is set or not.
  ...
  */
#define FMPI2C_FLAG_MASK  (0x0001FFFFUL)
...
void HAL_FMPI2C_MspInit(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_MspDeInit(FMPI2C_HandleTypeDef * const hfmpi2c);
...
void HAL_FMPI2C_EV_IRQHandler(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_ER_IRQHandler(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_MasterTxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_MasterRxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_SlaveTxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_SlaveRxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_AddrCallback(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t TransferDirection, uint16_t AddrMatchCode);
void HAL_FMPI2C_ListenCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_MemTxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_MemRxCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_ErrorCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
void HAL_FMPI2C_AbortCpltCallback(FMPI2C_HandleTypeDef * const hfmpi2c);
/**
  * @}
  */
...
#define IS_FMPI2C_OWN_ADDRESS1(ADDRESS1)             ((ADDRESS1) <= 0x000003FFUL)
