...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_LTDCEx_StructInitFromVideoConfig(LTDC_HandleTypeDef * const hltdc, DSI_VidCfgTypeDef const * const VidCfg)
{
  ...
  hltdc->Init.DEPolarity = VidCfg->DEPolarity << 29U;
  hltdc->Init.VSPolarity = VidCfg->VSPolarity << 29U;
  hltdc->Init.HSPolarity = VidCfg->HSPolarity << 29U;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_LTDCEx_StructInitFromAdaptedCommandConfig(LTDC_HandleTypeDef * const hltdc, DSI_CmdCfgTypeDef * const CmdCfg)
{
  /* Retrieve signal polarities from DSI */
...
#else
  /* Note 2: Code to be used in case LTDC polarities inversion updated in the specification */
  hltdc->Init.DEPolarity = CmdCfg->DEPolarity << 29U;
  hltdc->Init.VSPolarity = CmdCfg->VSPolarity << 29U;
  hltdc->Init.HSPolarity = CmdCfg->HSPolarity << 29U;
#endif /* POLARITIES_INVERSION_UPDATED */
  return HAL_OK;
}
