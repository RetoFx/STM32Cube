...
/** @defgroup DCMI_Error_Code DCMI Error Code
  * @{
  */
#define HAL_DCMI_ERROR_NONE      0x00000000UL    /*!< No error              */
#define HAL_DCMI_ERROR_OVR       0x00000001UL    /*!< Overrun error         */
#define HAL_DCMI_ERROR_SYNC      0x00000002UL    /*!< Synchronization error */
#define HAL_DCMI_ERROR_TIMEOUT   0x00000020UL    /*!< Timeout error         */
#define HAL_DCMI_ERROR_DMA       0x00000040UL    /*!< DMA error             */
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
...
/** @defgroup DCMI_Capture_Mode DCMI Capture Mode
  * @{
  */
#define DCMI_MODE_CONTINUOUS         0x00000000UL               /*!< The received data are transferred continuously
...
/** @defgroup DCMI_Synchronization_Mode DCMI Synchronization Mode
  * @{
  */
#define DCMI_SYNCHRO_HARDWARE        0x00000000UL               /*!< Hardware synchronization data capture (frame/line start/stop)
...
/** @defgroup DCMI_PIXCK_Polarity DCMI PIXCK Polarity
  * @{
  */
#define DCMI_PCKPOLARITY_FALLING     0x00000000UL                 /*!< Pixel clock active on Falling edge */
...
/** @defgroup DCMI_VSYNC_Polarity DCMI VSYNC Polarity
  * @{
  */
#define DCMI_VSPOLARITY_LOW          0x00000000UL                /*!< Vertical synchronization active Low  */
...
/** @defgroup DCMI_HSYNC_Polarity DCMI HSYNC Polarity
  * @{
  */
#define DCMI_HSPOLARITY_LOW          0x00000000UL                /*!< Horizontal synchronization active Low  */
...
/** @defgroup DCMI_MODE_JPEG DCMI MODE JPEG
  * @{
  */
#define DCMI_JPEG_DISABLE            0x00000000UL               /*!< Mode JPEG Disabled  */
...
/** @defgroup DCMI_Capture_Rate DCMI Capture Rate
  * @{
  */
#define DCMI_CR_ALL_FRAME            0x00000000UL                 /*!< All frames are captured        */
...
/** @defgroup DCMI_Extended_Data_Mode DCMI Extended Data Mode
  * @{
  */
#define DCMI_EXTEND_DATA_8B     0x00000000UL                                  /*!< Interface captures 8-bit data on every pixel clock  */
...
void              HAL_DCMI_VsyncCallback(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_HsyncCallback(DCMI_HandleTypeDef * const hdcmi);
