...
/** @defgroup QSPI_Private_Constants QSPI Private Constants
  * @{
  */
#define QSPI_FUNCTIONAL_MODE_INDIRECT_WRITE 0x00000000UL                     /*!<Indirect write mode*/
...
static void QSPI_DMARxCplt(DMA_HandleTypeDef * const hdma);
static void QSPI_DMATxCplt(DMA_HandleTypeDef * const hdma);
static void QSPI_DMARxHalfCplt(DMA_HandleTypeDef * const hdma);
static void QSPI_DMATxHalfCplt(DMA_HandleTypeDef * const hdma);
static void QSPI_DMAError(DMA_HandleTypeDef * const hdma);
static void QSPI_DMAAbortCplt(DMA_HandleTypeDef * const hdma);
static HAL_StatusTypeDef QSPI_WaitFlagStateUntilTimeout(QSPI_HandleTypeDef * const hqspi, uint32_t Flag, FlagStatus State, uint32_t Tickstart, uint32_t Timeout);
static HAL_StatusTypeDef QSPI_WaitFlagStateUntilTimeout_CPUCycle(QSPI_HandleTypeDef * const hqspi, uint32_t Flag, FlagStatus State, uint32_t Timeout);
static void QSPI_Config(QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef const * const cmd, uint32_t FunctionalMode);
...
/**
  ...
  * @retval None
  */
__weak void HAL_QSPI_MspInit(QSPI_HandleTypeDef * const hqspi)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_ErrorCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_AbortCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_CmdCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_RxCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_TxCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_RxHalfCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_TxHalfCpltCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_FifoThresholdCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_StatusMatchCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
/**
  ...
  * @retval None
  */
HAL_QSPI_WEAK_CALLBACK(void, HAL_QSPI_TimeOutCallback)(QSPI_HandleTypeDef * const hqspi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hqspi);
...
static void QSPI_DMARxCplt(DMA_HandleTypeDef * const hdma)
{
  QSPI_HandleTypeDef * const hqspi = (QSPI_HandleTypeDef *)(hdma->Parent);
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef QSPI_WaitFlagStateUntilTimeout(QSPI_HandleTypeDef * const hqspi, uint32_t Flag,
...
static HAL_StatusTypeDef QSPI_WaitFlagStateUntilTimeout_CPUCycle(QSPI_HandleTypeDef * const hqspi, uint32_t Flag, FlagStatus State, uint32_t Timeout)
{
  __IO uint32_t count = Timeout * (SystemCoreClock / 16UL / 1000UL);
   do
   {
     if (count-- == 0U)
     {
