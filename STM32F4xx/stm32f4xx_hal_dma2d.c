...
/** @addtogroup DMA2D_Private_Functions DMA2D Private Functions
  * @{
  */
static void DMA2D_SetConfig(DMA2D_HandleTypeDef * const hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width,
                            uint32_t Height);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_DMA2D_MspInit(DMA2D_HandleTypeDef * const hdma2d)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_DMA2D_MspDeInit(DMA2D_HandleTypeDef * const hdma2d)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdma2d);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DMA2D_CLUTStartLoad(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef const * const CLUTCfg, uint32_t LayerIdx)
{
  /* Check the parameters */
  assert_param(IS_DMA2D_LAYER(LayerIdx));
...
/**
  ...
  * @retval None
  */
HAL_DMA2D_WEAK_CALLBACK(void, HAL_DMA2D_LineEventCallback)(DMA2D_HandleTypeDef * const hdma2d)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdma2d);
...
/**
  ...
  * @retval None
  */
HAL_DMA2D_WEAK_CALLBACK(void, HAL_DMA2D_CLUTLoadingCpltCallback)(DMA2D_HandleTypeDef * const hdma2d)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdma2d);
...
{
  DMA2D_LayerCfgTypeDef const * pLayerCfg;
  uint32_t regMask;
  uint32_t regValue;
