...
HAL_StatusTypeDef  HAL_PCCARD_Init(PCCARD_HandleTypeDef * const hpccard, FMC_NAND_PCC_TimingTypeDef const * const ComSpaceTiming,
                                   FMC_NAND_PCC_TimingTypeDef const * const AttSpaceTiming, FMC_NAND_PCC_TimingTypeDef const * const IOSpaceTiming);
