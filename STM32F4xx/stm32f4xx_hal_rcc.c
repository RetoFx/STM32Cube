...
/* Private macro -------------------------------------------------------------*/
#define __HAL_RCC_MCO1_CLK_ENABLE()   __HAL_RCC_GPIOA_CLK_ENABLE()
#define MCO1_GPIO_PORT        GPIOA
#define MCO1_PIN              GPIO_PIN_8

#define __HAL_RCC_MCO2_CLK_ENABLE()   __HAL_RCC_GPIOC_CLK_ENABLE()
...
/**
  ...
  * @retval HAL status
  */
HAL_RCC_WEAK_DEINIT(HAL_StatusTypeDef, HAL_RCC_DeInit)(void)
{
  return HAL_OK;
}
...
/**
  ...
  * @retval HAL status
  */
__weak HAL_StatusTypeDef HAL_RCC_OscConfig(RCC_OscInitTypeDef const * const RCC_OscInitStruct)
{
  uint32_t tickstart;
  uint32_t pll_config;
  /* Check Null pointer */
...
/**
  ...
  * @retval None
  */
__weak void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef * const RCC_OscInitStruct)
{
