...
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
  void (* MasterTxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);           /*!< SMBUS Master Tx Transfer completed callback */
  void (* MasterRxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);           /*!< SMBUS Master Rx Transfer completed callback */
  void (* SlaveTxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);            /*!< SMBUS Slave Tx Transfer completed callback  */
  void (* SlaveRxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);            /*!< SMBUS Slave Rx Transfer completed callback  */
  void (* ListenCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);             /*!< SMBUS Listen Complete callback              */
  void (* MemTxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);              /*!< SMBUS Memory Tx Transfer completed callback */
  void (* MemRxCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);              /*!< SMBUS Memory Rx Transfer completed callback */
  void (* ErrorCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);                  /*!< SMBUS Error callback                        */
  void (* AbortCpltCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);              /*!< SMBUS Abort callback                        */
  void (* AddrCallback)(struct __SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection, uint16_t AddrMatchCode);  /*!< SMBUS Slave Address Match callback */
  void (* MspInitCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);                /*!< SMBUS Msp Init callback                     */
  void (* MspDeInitCallback)(struct __SMBUS_HandleTypeDef * const hsmbus);              /*!< SMBUS Msp DeInit callback                   */
...
/**
  ...
  */
typedef  void (*pSMBUS_CallbackTypeDef)(SMBUS_HandleTypeDef * const hsmbus); /*!< pointer to an I2C callback function */
typedef  void (*pSMBUS_AddrCallbackTypeDef)(SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection, uint16_t AddrMatchCode); /*!< pointer to an I2C Address Match callback function */
...
/** @defgroup SMBUS_Error_Code_definition SMBUS Error Code
  ...
  * @{
  */
#define HAL_SMBUS_ERROR_NONE              0x00000000UL    /*!< No error               */
#define HAL_SMBUS_ERROR_BERR              0x00000001UL    /*!< BERR error             */
#define HAL_SMBUS_ERROR_ARLO              0x00000002UL    /*!< ARLO error             */
#define HAL_SMBUS_ERROR_AF                0x00000004UL    /*!< AF error               */
#define HAL_SMBUS_ERROR_OVR               0x00000008UL    /*!< OVR error              */
#define HAL_SMBUS_ERROR_TIMEOUT           0x00000010UL    /*!< Timeout Error          */
#define HAL_SMBUS_ERROR_ALERT             0x00000020UL    /*!< Alert error            */
#define HAL_SMBUS_ERROR_PECERR            0x00000040UL    /*!< PEC error              */
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
#define HAL_SMBUS_ERROR_INVALID_CALLBACK  0x00000080UL    /*!< Invalid Callback error */
#endif /* USE_HAL_SMBUS_REGISTER_CALLBACKS */
...
/** @defgroup SMBUS_Analog_Filter SMBUS Analog Filter
  * @{
  */
#define SMBUS_ANALOGFILTER_ENABLE        0x00000000UL
 ...
 * @{
 */
#define SMBUS_ADDRESSINGMODE_7BIT        0x00004000UL
#define SMBUS_ADDRESSINGMODE_10BIT       (I2C_OAR1_ADDMODE | 0x00004000UL)
/**
  * @}
  */
...
/** @defgroup SMBUS_dual_addressing_mode  SMBUS dual addressing mode
  * @{
  */
#define SMBUS_DUALADDRESS_DISABLE        0x00000000UL
...
/** @defgroup SMBUS_general_call_addressing_mode SMBUS general call addressing mode
  * @{
  */
#define SMBUS_GENERALCALL_DISABLE        0x00000000UL
...
/** @defgroup SMBUS_nostretch_mode SMBUS nostretch mode
  * @{
  */
#define SMBUS_NOSTRETCH_DISABLE          0x00000000UL
...
/** @defgroup SMBUS_packet_error_check_mode SMBUS packet error check mode
  * @{
  */
#define SMBUS_PEC_DISABLE                0x00000000UL
...
/** @defgroup SMBUS_XferDirection_definition SMBUS XferDirection definition
  * @{
  */
#define SMBUS_DIRECTION_RECEIVE           0x00000000UL
#define SMBUS_DIRECTION_TRANSMIT          0x00000001UL
/**
  * @}
  */
...
/** @defgroup SMBUS_XferOptions_definition SMBUS XferOptions definition
  * @{
  */
#define  SMBUS_FIRST_FRAME                       0x00000001UL
#define  SMBUS_NEXT_FRAME                        0x00000002UL
#define  SMBUS_FIRST_AND_LAST_FRAME_NO_PEC       0x00000003UL
#define  SMBUS_LAST_FRAME_NO_PEC                 0x00000004UL
#define  SMBUS_FIRST_AND_LAST_FRAME_WITH_PEC     0x00000005UL
#define  SMBUS_LAST_FRAME_WITH_PEC               0x00000006UL
/**
  * @}
  */
...
/** @defgroup SMBUS_Flag_definition SMBUS Flag definition
  * @{
  */
#define SMBUS_FLAG_SMBALERT               0x00018000UL
#define SMBUS_FLAG_TIMEOUT                0x00014000UL
#define SMBUS_FLAG_PECERR                 0x00011000UL
#define SMBUS_FLAG_OVR                    0x00010800UL
#define SMBUS_FLAG_AF                     0x00010400UL
#define SMBUS_FLAG_ARLO                   0x00010200UL
#define SMBUS_FLAG_BERR                   0x00010100UL
#define SMBUS_FLAG_TXE                    0x00010080UL
#define SMBUS_FLAG_RXNE                   0x00010040UL
#define SMBUS_FLAG_STOPF                  0x00010010UL
#define SMBUS_FLAG_ADD10                  0x00010008UL
#define SMBUS_FLAG_BTF                    0x00010004UL
#define SMBUS_FLAG_ADDR                   0x00010002UL
#define SMBUS_FLAG_SB                     0x00010001UL
#define SMBUS_FLAG_DUALF                  0x00100080UL
#define SMBUS_FLAG_SMBHOST                0x00100040UL
#define SMBUS_FLAG_SMBDEFAULT             0x00100020UL
#define SMBUS_FLAG_GENCALL                0x00100010UL
#define SMBUS_FLAG_TRA                    0x00100004UL
#define SMBUS_FLAG_BUSY                   0x00100002UL
#define SMBUS_FLAG_MSL                    0x00100001UL
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_SMBUS_Init(SMBUS_HandleTypeDef * const hsmbus);
HAL_StatusTypeDef HAL_SMBUS_DeInit(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_MspInit(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_MspDeInit(SMBUS_HandleTypeDef * const hsmbus);

/* Callbacks Register/UnRegister functions  ************************************/
#if (USE_HAL_SMBUS_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_SMBUS_RegisterCallback(SMBUS_HandleTypeDef * const hsmbus, HAL_SMBUS_CallbackIDTypeDef CallbackID, pSMBUS_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_SMBUS_UnRegisterCallback(SMBUS_HandleTypeDef * const hsmbus, HAL_SMBUS_CallbackIDTypeDef CallbackID);

HAL_StatusTypeDef HAL_SMBUS_RegisterAddrCallback(SMBUS_HandleTypeDef * const hsmbus, pSMBUS_AddrCallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_SMBUS_UnRegisterAddrCallback(SMBUS_HandleTypeDef * const hsmbus);
#endif /* USE_HAL_SMBUS_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_SMBUS_IsDeviceReady(SMBUS_HandleTypeDef * const hsmbus, uint16_t DevAddress, uint32_t Trials, uint32_t Timeout);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_SMBUS_Master_Transmit_IT(SMBUS_HandleTypeDef * const hsmbus, uint16_t DevAddress, uint8_t const * const pData, uint16_t Size, uint32_t XferOptions);
HAL_StatusTypeDef HAL_SMBUS_Master_Receive_IT(SMBUS_HandleTypeDef * const hsmbus, uint16_t DevAddress, uint8_t * const pData, uint16_t Size, uint32_t XferOptions);
HAL_StatusTypeDef HAL_SMBUS_Master_Abort_IT(SMBUS_HandleTypeDef * const hsmbus, uint16_t DevAddress);
HAL_StatusTypeDef HAL_SMBUS_Slave_Transmit_IT(SMBUS_HandleTypeDef * const hsmbus, uint8_t const * const pData, uint16_t Size, uint32_t XferOptions);
HAL_StatusTypeDef HAL_SMBUS_Slave_Receive_IT(SMBUS_HandleTypeDef * const hsmbus, uint8_t * const pData, uint16_t Size, uint32_t XferOptions);

HAL_StatusTypeDef HAL_SMBUS_EnableAlert_IT(SMBUS_HandleTypeDef * const hsmbus);
HAL_StatusTypeDef HAL_SMBUS_DisableAlert_IT(SMBUS_HandleTypeDef * const hsmbus);
HAL_StatusTypeDef HAL_SMBUS_EnableListen_IT(SMBUS_HandleTypeDef * const hsmbus);
HAL_StatusTypeDef HAL_SMBUS_DisableListen_IT(SMBUS_HandleTypeDef * const hsmbus);

/****** Filter Configuration functions  */
#if  defined(I2C_FLTR_ANOFF)&&defined(I2C_FLTR_DNF)
HAL_StatusTypeDef HAL_SMBUS_ConfigAnalogFilter(SMBUS_HandleTypeDef * const hsmbus, uint32_t AnalogFilter);
HAL_StatusTypeDef HAL_SMBUS_ConfigDigitalFilter(SMBUS_HandleTypeDef * const hsmbus, uint32_t DigitalFilter);
#endif
/**
  * @}
  */
...
void HAL_SMBUS_EV_IRQHandler(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_ER_IRQHandler(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_MasterTxCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_MasterRxCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_SlaveTxCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_SlaveRxCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_AddrCallback(SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection, uint16_t AddrMatchCode);
void HAL_SMBUS_ListenCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_ErrorCallback(SMBUS_HandleTypeDef * const hsmbus);
void HAL_SMBUS_AbortCpltCallback(SMBUS_HandleTypeDef * const hsmbus);
...
HAL_SMBUS_StateTypeDef HAL_SMBUS_GetState(SMBUS_HandleTypeDef const * const hsmbus);
HAL_SMBUS_ModeTypeDef HAL_SMBUS_GetMode(SMBUS_HandleTypeDef const * const hsmbus);
uint32_t HAL_SMBUS_GetError(SMBUS_HandleTypeDef const * const hsmbus);
...
/** @defgroup SMBUS_Private_Constants SMBUS Private Constants
  * @{
  */
#define SMBUS_FLAG_MASK  0x0000FFFFUL
/**
  * @}
  */
...
#define SMBUS_FREQRANGE(__PCLK__)                  ((__PCLK__) / 1000000UL)
...
#define SMBUS_10BIT_ADDRESS(__ADDRESS__)           ((uint8_t)((uint16_t)((__ADDRESS__) & (uint16_t)0x00FFU)))

#define SMBUS_10BIT_HEADER_WRITE(__ADDRESS__)      ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) & (uint16_t)0x0300U)) >> 7U) | (uint16_t)0x00F0U)))

#define SMBUS_10BIT_HEADER_READ(__ADDRESS__)       ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) & (uint16_t)0x0300U)) >> 7U) | (uint16_t)(0x00F1U))))
...
#define IS_SMBUS_DIGITAL_FILTER(FILTER)            ((FILTER) <= 0x0000000FUL)
#endif
...
#define IS_SMBUS_CLOCK_SPEED(SPEED)                (((SPEED) > 0UL) && ((SPEED) <= 100000UL))

#define IS_SMBUS_OWN_ADDRESS1(ADDRESS1)            (((ADDRESS1) & 0xFFFFFC00UL) == 0U)

#define IS_SMBUS_OWN_ADDRESS2(ADDRESS2)            (((ADDRESS2) & 0xFFFFFF01UL) == 0U)
