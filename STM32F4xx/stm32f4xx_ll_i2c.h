...
#define LL_I2C_MAX_SPEED_STANDARD           100000UL
#define LL_I2C_MAX_SPEED_FAST               400000UL
/**
  * @}
  */
...
/** @defgroup I2C_LL_EC_OWNADDRESS1 Own Address 1 Length
  * @{
  */
#define LL_I2C_OWNADDRESS1_7BIT             0x00004000UL                                /*!< Own address 1 is a 7-bit address.   */
#define LL_I2C_OWNADDRESS1_10BIT            (uint32_t)(I2C_OAR1_ADDMODE | 0x00004000UL) /*!< Own address 1 is a 10-bit address.  */
/**
  * @}
  */
...
/** @defgroup I2C_LL_EC_DUTYCYCLE Fast Mode Duty Cycle
  * @{
  */
#define LL_I2C_DUTYCYCLE_2                  0x00000000UL             /*!< I2C fast mode Tlow/Thigh = 2        */
...
/** @defgroup I2C_LL_EC_CLOCK_SPEED_MODE Master Clock Speed Mode
  * @{
  */
#define LL_I2C_CLOCK_SPEED_STANDARD_MODE    0x00000000UL             /*!< Master clock speed range is standard mode */
...
/** @defgroup I2C_LL_EC_PERIPHERAL_MODE Peripheral Mode
  * @{
  */
#define LL_I2C_MODE_I2C                     0x00000000UL                                                 /*!< I2C Master or Slave mode                                    */
...
#define LL_I2C_NACK                         0x00000000UL             /*!< NACK is sent after current received byte.*/
/**
  * @}
  */
...
#define LL_I2C_DIRECTION_READ               0x00000000UL             /*!< Bus is in read transfer  */
/**
  * @}
  */
...
/**
  ...
  */
#define __LL_I2C_FREQ_HZ_TO_MHZ(__PCLK__)                               (uint32_t)((__PCLK__) / 1000000UL)
...
/**
  ...
  */
#define __LL_I2C_FREQ_MHZ_TO_HZ(__PCLK__)                               (uint32_t)((__PCLK__) * 1000000UL)
...
/**
  ...
  * @retval Value between Min_Data=0x02U and Max_Data=0x3FU
  */
#define __LL_I2C_RISE_TIME(__FREQRANGE__, __SPEED__)                    (uint32_t)(((__SPEED__) <= LL_I2C_MAX_SPEED_STANDARD) ? ((__FREQRANGE__) + 1UL) : ((((__FREQRANGE__) * 300UL) / 1000UL) + 1UL))
...
/**
  ...
  * @retval Value between Min_Data=0x004U and Max_Data=0xFFFU, except in FAST DUTY mode where Min_Data=0x001U.
  */
...
/**
  ...
  * @retval Value between Min_Data=0x004U and Max_Data=0xFFFU.
  */
...
/**
  ...
  *         @arg @ref LL_I2C_DUTYCYCLE_2
  *         @arg @ref LL_I2C_DUTYCYCLE_16_9
  * @retval Value between Min_Data=0x001U and Max_Data=0xFFFU
  */
#define __LL_I2C_SPEED_FAST_TO_CCR(__PCLK__, __SPEED__, __DUTYCYCLE__)  (uint32_t)(((__DUTYCYCLE__) == LL_I2C_DUTYCYCLE_2) ? \
                                                                            (((((__PCLK__) / ((__SPEED__) * 3UL)) & I2C_CCR_CCR) == 0U) ? 1U:((__PCLK__) / ((__SPEED__) * 3UL))) : \
                                                                            (((((__PCLK__) / ((__SPEED__) * 25UL)) & I2C_CCR_CCR) == 0U) ? 1U:((__PCLK__) / ((__SPEED__) * 25UL))))
...
/**
  ...
  */
#define __LL_I2C_10BIT_ADDRESS(__ADDRESS__)                             ((uint8_t)((uint16_t)((__ADDRESS__) & (uint16_t)(0x00FFU))))

/**
  * @brief  Convert a 10-Bits address to a 10-Bits header with Write direction.
  * @param  __ADDRESS__ This parameter must be a value of a 10-Bits slave address.
  * @retval Value between Min_Data=0xF0U and Max_Data=0xF6U
  */
#define __LL_I2C_10BIT_HEADER_WRITE(__ADDRESS__)                        ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) & (uint16_t)(0x0300U))) >> 7U) | (uint16_t)(0xF0U))))

/**
  * @brief  Convert a 10-Bits address to a 10-Bits header with Read direction.
  * @param  __ADDRESS__ This parameter must be a value of a 10-Bits slave address.
  * @retval Value between Min_Data=0xF1U and Max_Data=0xF7U
  */
#define __LL_I2C_10BIT_HEADER_READ(__ADDRESS__)                         ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((__ADDRESS__) & (uint16_t)(0x0300U))) >> 7U) | (uint16_t)(0xF1U))))
...
/**
  ...
  * @param  DigitalFilter This parameter must be a value between Min_Data=0x00U (Digital filter disabled) and Max_Data=0x0FU (Digital filter enabled and filtering capability up to 15*TPCLK1)
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_I2C_DMA_GetRegAddr(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @param  I2Cx I2C Instance.
  * @param  OwnAddress2 This parameter must be a value between Min_Data=0 and Max_Data=0x7FU.
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetOwnAddress2(I2C_TypeDef * const I2Cx, uint32_t OwnAddress2)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetPeriphClock(I2C_TypeDef * const I2Cx, uint32_t PeriphClock)
{
...
/**
  ...
  * @retval Value of Peripheral Clock (in Hz)
  */
__STATIC_INLINE uint32_t LL_I2C_GetPeriphClock(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetDutyCycle(I2C_TypeDef * const I2Cx, uint32_t DutyCycle)
{
...
/**
  ...
  *         @arg @ref LL_I2C_DUTYCYCLE_16_9
  */
__STATIC_INLINE uint32_t LL_I2C_GetDutyCycle(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetClockSpeedMode(I2C_TypeDef * const I2Cx, uint32_t ClockSpeedMode)
{
...
/**
  ...
  *         @arg @ref LL_I2C_CLOCK_SPEED_FAST_MODE
  */
__STATIC_INLINE uint32_t LL_I2C_GetClockSpeedMode(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @param  I2Cx I2C Instance.
  * @param  RiseTime This parameter must be a value between Min_Data=0x02U and Max_Data=0x3FU.
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetRiseTime(I2C_TypeDef * const I2Cx, uint32_t RiseTime)
{
...
/**
  ...
  * @retval Value between Min_Data=0x02U and Max_Data=0x3FU
  */
__STATIC_INLINE uint32_t LL_I2C_GetRiseTime(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @param  I2Cx I2C Instance.
  * @param  ClockPeriod This parameter must be a value between Min_Data=0x004U and Max_Data=0xFFFU, except in FAST DUTY mode where Min_Data=0x001U.
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetClockPeriod(I2C_TypeDef * const I2Cx, uint32_t ClockPeriod)
{
...
/**
  ...
  * @retval Value between Min_Data=0x004U and Max_Data=0xFFFU, except in FAST DUTY mode where Min_Data=0x001U.
  */
__STATIC_INLINE uint32_t LL_I2C_GetClockPeriod(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ConfigSpeed(I2C_TypeDef * const I2Cx, uint32_t PeriphClock, uint32_t ClockSpeed,
                                        uint32_t DutyCycle)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_SetMode(I2C_TypeDef * const I2Cx, uint32_t PeripheralMode)
{
...
/**
  ...
  *         @arg @ref LL_I2C_MODE_SMBUS_DEVICE_ARP
  */
__STATIC_INLINE uint32_t LL_I2C_GetMode(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableSMBusAlert(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableSMBusAlert(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusAlert(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableSMBusPEC(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableSMBusPEC(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusPEC(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableIT_EVT(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableIT_EVT(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_EVT(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableIT_BUF(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableIT_BUF(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledIT_BUF(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_BTF(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_SB(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_ADD10(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_AF(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_PECERR(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_TIMEOUT(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_ALERT(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_DUAL(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_SMBHOST(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveSMBusFlag_SMBDEFAULT(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_GENCALL(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsActiveFlag_MSL(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ClearFlag_AF(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_PECERR(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_TIMEOUT(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_ALERT(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableReset(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableReset(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsResetEnabled(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableBitPOS(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableBitPOS(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledBitPOS(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableLastDMA(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableLastDMA(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledLastDMA(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_EnableSMBusPECCompare(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_DisableSMBusPECCompare(I2C_TypeDef * const I2Cx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_I2C_IsEnabledSMBusPECCompare(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_I2C_GetSMBusPEC(I2C_TypeDef const * const I2Cx)
{
...
/**
  ...
  * @param  I2Cx I2C Instance.
  * @param  Data Value between Min_Data=0x0U and Max_Data=0xFFU
  * @retval None
  */
...
uint32_t LL_I2C_Init(I2C_TypeDef * const I2Cx, LL_I2C_InitTypeDef const * const I2C_InitStruct);
uint32_t LL_I2C_DeInit(I2C_TypeDef const * const I2Cx);
