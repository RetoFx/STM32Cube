...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 ===============================================================================
    [..]
         ...
         (+) The maximum frequency of the SYSCLK, HCLK, PCLK1 and PCLK2 is 180000000UL Hz.
  @endverbatim
  @internal
...
/**
  ...
  *         - PLLP: ensure that max frequency at 180000000UL Hz is reach (PLLVCO_output / PLLP)
