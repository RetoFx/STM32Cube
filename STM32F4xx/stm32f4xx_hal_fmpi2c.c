...
/** @defgroup FMPI2C_Private_Define FMPI2C Private Define
  * @{
  */
#define TIMING_CLEAR_MASK   (0xF0FFFFFFUL)  /*!< FMPI2C TIMING clear register Mask */
...
#define FMPI2C_NO_OPTION_FRAME     (0xFFFF0000UL)
/**
  * @}
  */
...
static void FMPI2C_DMAMasterTransmitCplt(DMA_HandleTypeDef * const hdma);
static void FMPI2C_DMAMasterReceiveCplt(DMA_HandleTypeDef * const hdma);
static void FMPI2C_DMASlaveTransmitCplt(DMA_HandleTypeDef * const hdma);
static void FMPI2C_DMASlaveReceiveCplt(DMA_HandleTypeDef * const hdma);
static void FMPI2C_DMAError(DMA_HandleTypeDef * const hdma);
static void FMPI2C_DMAAbort(DMA_HandleTypeDef * const hdma);


/* Private functions to handle IT transfer */
static void FMPI2C_ITAddrCplt(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags);
static void FMPI2C_ITMasterSeqCplt(FMPI2C_HandleTypeDef * const hfmpi2c);
static void FMPI2C_ITSlaveSeqCplt(FMPI2C_HandleTypeDef * const hfmpi2c);
static void FMPI2C_ITMasterCplt(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags);
static void FMPI2C_ITSlaveCplt(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags);
static void FMPI2C_ITListenCplt(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags);
static void FMPI2C_ITError(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ErrorCode);

/* Private functions to handle IT transfer */
static HAL_StatusTypeDef FMPI2C_RequestMemoryWrite(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress,
                                                   uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                                   uint32_t Tickstart);
static HAL_StatusTypeDef FMPI2C_RequestMemoryRead(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress,
                                                  uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                                  uint32_t Tickstart);

/* Private functions for FMPI2C transfer IRQ handler */
static HAL_StatusTypeDef FMPI2C_Master_ISR_IT(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                              uint32_t ITSources);
static HAL_StatusTypeDef FMPI2C_Mem_ISR_IT(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                           uint32_t ITSources);
static HAL_StatusTypeDef FMPI2C_Slave_ISR_IT(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                             uint32_t ITSources);
static HAL_StatusTypeDef FMPI2C_Master_ISR_DMA(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                               uint32_t ITSources);
static HAL_StatusTypeDef FMPI2C_Mem_ISR_DMA(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                            uint32_t ITSources);
static HAL_StatusTypeDef FMPI2C_Slave_ISR_DMA(struct __FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t ITFlags,
                                              uint32_t ITSources);

/* Private functions to handle flags during polling transfer */
static HAL_StatusTypeDef FMPI2C_WaitOnFlagUntilTimeout(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Flag, FlagStatus Status,
                                                       uint32_t Timeout, uint32_t Tickstart);
static HAL_StatusTypeDef FMPI2C_WaitOnTXISFlagUntilTimeout(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Timeout,
                                                           uint32_t Tickstart);
static HAL_StatusTypeDef FMPI2C_WaitOnRXNEFlagUntilTimeout(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Timeout,
                                                           uint32_t Tickstart);
static HAL_StatusTypeDef FMPI2C_WaitOnSTOPFlagUntilTimeout(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Timeout,
                                                           uint32_t Tickstart);
static HAL_StatusTypeDef FMPI2C_IsErrorOccurred(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Timeout,
                                                uint32_t Tickstart);

/* Private functions to centralize the enable/disable of Interrupts */
static void FMPI2C_Enable_IRQ(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t InterruptRequest);
static void FMPI2C_Disable_IRQ(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t InterruptRequest);

/* Private function to treat different error callback */
static void FMPI2C_TreatErrorCallback(FMPI2C_HandleTypeDef * const hfmpi2c);

/* Private function to flush TXDR register */
static void FMPI2C_Flush_TXDR(FMPI2C_HandleTypeDef * const hfmpi2c);

/* Private function to handle  start, restart or stop a transfer */
static void FMPI2C_TransferConfig(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t Size, uint32_t Mode,
                                  uint32_t Request);

/* Private function to Convert Specific options */
static void FMPI2C_ConvertOtherXferOptions(FMPI2C_HandleTypeDef * const hfmpi2c);
/**
  * @}
  */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Init(FMPI2C_HandleTypeDef * const hfmpi2c)
{
...
#if (USE_HAL_FMPI2C_REGISTER_CALLBACKS == 1U)
  ...
  hfmpi2c->Instance->OAR2 = (hfmpi2c->Init.DualAddressMode | hfmpi2c->Init.OwnAddress2 |
                             (hfmpi2c->Init.OwnAddress2Masks << 8U));
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_DeInit(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Check the FMPI2C handle allocation */
  if (hfmpi2c == NULL)
  {
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMPI2C_MspInit(FMPI2C_HandleTypeDef * const hfmpi2c)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMPI2C_MspDeInit(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_RegisterCallback(FMPI2C_HandleTypeDef * const hfmpi2c, HAL_FMPI2C_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_UnRegisterCallback(FMPI2C_HandleTypeDef * const hfmpi2c, HAL_FMPI2C_CallbackIDTypeDef CallbackID)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_RegisterAddrCallback(FMPI2C_HandleTypeDef * const hfmpi2c, pFMPI2C_AddrCallbackTypeDef pCallback)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_UnRegisterAddrCallback(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Transmit(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t const * const pData,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Receive(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t * const pData,
                                            uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Transmit(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t const * const pData, uint16_t Size,
                                            uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Receive(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t * const pData, uint16_t Size,
                                           uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Transmit_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t const * const pData,
                                                uint16_t Size)
{
  uint32_t xfermode;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Receive_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t * const pData,
                                               uint16_t Size)
{
  uint32_t xfermode;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Transmit_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t const * const pData, uint16_t Size)
{
  if (hfmpi2c->State == HAL_FMPI2C_STATE_READY)
  {
    /* Process Locked */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Receive_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t * const pData, uint16_t Size)
{
  if (hfmpi2c->State == HAL_FMPI2C_STATE_READY)
  {
    /* Process Locked */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Transmit_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t const * const pData,
                                                 uint16_t Size)
{
  uint32_t xfermode;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Receive_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t * const pData,
                                                uint16_t Size)
{
  uint32_t xfermode;
  HAL_StatusTypeDef dmaxferstatus;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Transmit_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t const * const pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Receive_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t * const pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Write(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                       uint16_t MemAddSize, uint8_t * const pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Read(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                      uint16_t MemAddSize, uint8_t * const pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Write_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                          uint16_t MemAddSize, uint8_t * const pData, uint16_t Size)
{
  /* Check the parameters */
  assert_param(IS_FMPI2C_MEMADD_SIZE(MemAddSize));
  ...
  if (hfmpi2c->State == HAL_FMPI2C_STATE_READY)
  {
    ...
    if (MemAddSize == FMPI2C_MEMADD_SIZE_8BIT)
    {
      ...
      hfmpi2c->Memaddress = 0xFFFFFFFFUL;
    }
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Read_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                         uint16_t MemAddSize, uint8_t * const pData, uint16_t Size)
{
  /* Check the parameters */
  assert_param(IS_FMPI2C_MEMADD_SIZE(MemAddSize));
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Write_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                           uint16_t MemAddSize, uint8_t * const pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Mem_Read_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint16_t MemAddress,
                                          uint16_t MemAddSize, uint8_t * const pData, uint16_t Size)
{
  HAL_StatusTypeDef dmaxferstatus;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_IsDeviceReady(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint32_t Trials,
                                           uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Transmit_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t const * const pData,
                                                    uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hfmpi2c->State == HAL_FMPI2C_STATE_READY)
  {
    ...
    if ((hfmpi2c->PreviousState == FMPI2C_STATE_MASTER_BUSY_TX) &&
        (IS_FMPI2C_TRANSFER_OTHER_OPTIONS_REQUEST(XferOptions) == 0U))
    {
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Transmit_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t const * const pData,
                                                     uint16_t Size, uint32_t XferOptions)
{
  uint32_t xfermode;
  uint32_t xferrequest = FMPI2C_GENERATE_START_WRITE;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Receive_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t * const pData,
                                                   uint16_t Size, uint32_t XferOptions)
{
  uint32_t xfermode;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Receive_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress, uint8_t * const pData,
                                                    uint16_t Size, uint32_t XferOptions)
{
  uint32_t xfermode;
  uint32_t xferrequest = FMPI2C_GENERATE_START_READ;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Seq_Transmit_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t const * const pData, uint16_t Size,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Seq_Transmit_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t const * const pData, uint16_t Size,
                                                    uint32_t XferOptions)
{
  /* Declaration of tmp to prevent undefined behavior of volatile usage */
  FlagStatus tmp;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Seq_Receive_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t * const pData, uint16_t Size,
                                                  uint32_t XferOptions)
{
  /* Declaration of tmp to prevent undefined behavior of volatile usage */
  FlagStatus tmp;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Slave_Seq_Receive_DMA(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t * const pData, uint16_t Size,
                                                   uint32_t XferOptions)
{
  /* Declaration of tmp to prevent undefined behavior of volatile usage */
  FlagStatus tmp;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_EnableListen_IT(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  if (hfmpi2c->State == HAL_FMPI2C_STATE_READY)
  {
    hfmpi2c->State = HAL_FMPI2C_STATE_LISTEN;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_DisableListen_IT(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Declaration of tmp to prevent undefined behavior of volatile usage */
  uint32_t tmp;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FMPI2C_Master_Abort_IT(FMPI2C_HandleTypeDef * const hfmpi2c, uint16_t DevAddress)
{
...
/**
  ...
  * @retval None
  */
void HAL_FMPI2C_EV_IRQHandler(FMPI2C_HandleTypeDef * const hfmpi2c) /* Derogation MISRAC2012-Rule-8.13 */
{
...
/**
  ...
  * @retval None
  */
void HAL_FMPI2C_ER_IRQHandler(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  uint32_t itflags   = READ_REG(hfmpi2c->Instance->ISR);
  uint32_t itsources = READ_REG(hfmpi2c->Instance->CR1);
  uint32_t tmperror;
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_MasterTxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_MasterRxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/** @brief  Slave Tx Transfer completed callback.
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_SlaveTxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_SlaveRxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_AddrCallback)(FMPI2C_HandleTypeDef * const hfmpi2c, uint8_t TransferDirection, uint16_t AddrMatchCode)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_ListenCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_MemTxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_MemRxCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_ErrorCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval None
  */
HAL_FMPI2C_WEAK_CALLBACK(void, HAL_FMPI2C_AbortCpltCallback)(FMPI2C_HandleTypeDef * const hfmpi2c)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmpi2c);
...
/**
  ...
  * @retval HAL state
  */
HAL_FMPI2C_StateTypeDef HAL_FMPI2C_GetState(FMPI2C_HandleTypeDef const * const hfmpi2c)
{
...
/**
  ...
  * @retval HAL mode
  */
HAL_FMPI2C_ModeTypeDef HAL_FMPI2C_GetMode(FMPI2C_HandleTypeDef const * const hfmpi2c)
{
  return hfmpi2c->Mode;
}
...
/**
  ...
  */
uint32_t HAL_FMPI2C_GetError(FMPI2C_HandleTypeDef const * const hfmpi2c)
{
           ...
           (FMPI2C_CHECK_IT_SOURCE(ITSources, FMPI2C_IT_RXI) != RESET))
  {
    ...
    *hfmpi2c->pBuffPtr = (uint8_t)hfmpi2c->Instance->RXDR;
    ...
    hfmpi2c->XferCount--;
           ...
           (FMPI2C_CHECK_IT_SOURCE(ITSources, FMPI2C_IT_TXI) != RESET))
  {
    if (hfmpi2c->Memaddress == 0xFFFFFFFFUL)
    {
      /* Write data to TXDR */
      hfmpi2c->Instance->TXDR = *hfmpi2c->pBuffPtr;
...
static void FMPI2C_DMAMasterTransmitCplt(DMA_HandleTypeDef * const hdma)
{
  ...
  FMPI2C_HandleTypeDef * const hfmpi2c = (FMPI2C_HandleTypeDef *)(((DMA_HandleTypeDef *)hdma)->Parent);
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef FMPI2C_IsErrorOccurred(FMPI2C_HandleTypeDef * const hfmpi2c, uint32_t Timeout, uint32_t Tickstart)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  *   This parameter must be a value between 0 and 255U.
                                  ...
                                  uint32_t Request)
{
  ...
  uint32_t tmp = ((uint32_t)(((uint32_t)DevAddress & FMPI2C_CR2_SADD) |
                             ...
                             (uint32_t)Mode | (uint32_t)Request) & (~0x80000000UL));
