...
/** @defgroup I2SEx_Private_Functions I2S Extended Private Functions
  * @{
  */
static void I2SEx_TxRxDMAHalfCplt(DMA_HandleTypeDef * const hdma);
static void I2SEx_TxRxDMACplt(DMA_HandleTypeDef * const hdma);
static void I2SEx_TxRxDMAError(DMA_HandleTypeDef * const hdma);
static void I2SEx_RxISR_I2S(I2S_HandleTypeDef * const hi2s);
static void I2SEx_RxISR_I2SExt(I2S_HandleTypeDef * const hi2s);
static void I2SEx_TxISR_I2S(I2S_HandleTypeDef * const hi2s);
static void I2SEx_TxISR_I2SExt(I2S_HandleTypeDef * const hi2s);
static HAL_StatusTypeDef I2SEx_FullDuplexWaitFlagStateUntilTimeout(I2S_HandleTypeDef * const hi2s,
                                                                   uint32_t Flag,
                                                                   uint32_t State,
                                                                   uint32_t Timeout,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive_IT(I2S_HandleTypeDef * const hi2s,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_I2SEx_TransmitReceive_DMA(I2S_HandleTypeDef * const hi2s,
                                                uint16_t const * const pTxData,
                                                uint16_t * const pRxData,
                                                uint16_t Size)
{
...
/**
  ...
  * @retval HAL status
  */
void HAL_I2SEx_FullDuplex_IRQHandler(I2S_HandleTypeDef * const hi2s)
{
...
/**
  ...
  * @retval None
  */
HAL_I2SEX_WEAK_CALLBACK(void, HAL_I2SEx_TxRxHalfCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
...
/**
  ...
  * @retval None
  */
HAL_I2SEX_WEAK_CALLBACK(void, HAL_I2SEx_TxRxCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
static void I2SEx_TxRxDMAHalfCplt(DMA_HandleTypeDef * const hdma)
{
  I2S_HandleTypeDef * const hi2s = (I2S_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
