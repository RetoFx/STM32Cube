...
#define PWR_REGULATOR_VOLTAGE_SCALE2         0x00000000UL            /* Scale 2 mode: the maximum value of fHCLK = 144 MHz. */
#else
...
/** @brief Macros to enable or disable the Over drive mode.
  ...
  */
#define __HAL_PWR_OVERDRIVE_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, ODEN_BIT_NUMBER, ENABLE)
#define __HAL_PWR_OVERDRIVE_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, ODEN_BIT_NUMBER, DISABLE)

/** @brief Macros to enable or disable the Over drive switching.
  * @note  These macros can be used only for STM32F42xx/STM3243xx devices.
  */
#define __HAL_PWR_OVERDRIVESWITCHING_ENABLE() HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, ODSWEN_BIT_NUMBER, ENABLE)
#define __HAL_PWR_OVERDRIVESWITCHING_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, ODSWEN_BIT_NUMBER, DISABLE)
