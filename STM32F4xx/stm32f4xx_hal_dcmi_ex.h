...
/** @defgroup DCMIEx_Byte_Select_Mode DCMI Byte Select Mode
  * @{
  */
#define DCMI_BSM_ALL                 0x00000000UL                                 /*!< Interface captures all received data                       */
...
/** @defgroup DCMIEx_Byte_Select_Start DCMI Byte Select Start
  * @{
  */
#define DCMI_OEBS_ODD               0x00000000UL              /*!< Interface captures first data from the frame/line start, second one being dropped  */
...
/** @defgroup DCMIEx_Line_Select_Mode DCMI Line Select Mode
  * @{
  */
#define DCMI_LSM_ALL                 0x00000000UL             /*!< Interface captures all received lines  */
...
/** @defgroup DCMIEx_Line_Select_Start DCMI Line Select Start
  * @{
  */
#define DCMI_OELS_ODD               0x00000000UL              /*!< Interface captures first line from the frame start, second one being dropped  */
