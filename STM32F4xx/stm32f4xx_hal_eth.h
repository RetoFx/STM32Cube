...
typedef struct
{
  ...
  GiantPacketSizeLimit;        /*!< Specifies the packet size that the MAC will declare it as Giant, If it's size is
                                                    ...
                                                    Min_Data = 0x618U (1518 byte) and Max_Data = 0x3FFFU (32 Kbyte). */
  ...
  uint32_t         ExtendedInterPacketGapVal;   /*!< Sets the Extended IPG between Packet during transmission.
                                                           This parameter can be a value from 0x0U to 0xFFU */
  ...
  PauseTime;                   /*!< This field holds the value to be used in the Pause Time field in the transmit control packet.
                                                   This parameter must be a number between
                                                   Min_Data = 0x0U and Max_Data = 0xFFFFU.*/
...
typedef enum
{
  HAL_ETH_PTP_POSITIVE_UPDATE   = 0x00000000UL,   /*!<  PTP positive time update       */
  HAL_ETH_PTP_NEGATIVE_UPDATE   = 0x00000001UL   /*!<  PTP negative time update       */
...
typedef  void (*pETH_txPtpCallbackTypeDef)(uint32_t *buffer,
                                           ETH_TimeStampTypeDef * const timestamp);  /*!< pointer to an ETH Tx Free function */
/**
  *
  */
...
/**
  ...
  */
#if (USE_HAL_ETH_REGISTER_CALLBACKS == 1U)
...
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
{
  ...
  void (* TxCpltCallback)(struct __ETH_HandleTypeDef * const heth);             /*!< ETH Tx Complete Callback */
  void (* RxCpltCallback)(struct __ETH_HandleTypeDef * const heth);            /*!< ETH Rx  Complete Callback     */
  void (* ErrorCallback)(struct __ETH_HandleTypeDef * const heth);             /*!< ETH Error Callback   */
  void (* PMTCallback)(struct __ETH_HandleTypeDef * const heth);               /*!< ETH Power Management Callback            */
  void (* WakeUpCallback)(struct __ETH_HandleTypeDef * const heth);            /*!< ETH Wake UP Callback   */

  void (* MspInitCallback)(struct __ETH_HandleTypeDef * const heth);             /*!< ETH Msp Init callback              */
  void (* MspDeInitCallback)(struct __ETH_HandleTypeDef * const heth);           /*!< ETH Msp DeInit callback            */
...
/**
  ...
  */
typedef  void (*pETH_CallbackTypeDef)(ETH_HandleTypeDef * const heth);  /*!< pointer to an ETH callback function */
...
#define ETH_DMATXDESC_IC                      0x40000000UL  /*!< Interrupt on Completion */
#define ETH_DMATXDESC_LS                      0x20000000UL  /*!< Last Segment */
#define ETH_DMATXDESC_FS                      0x10000000UL  /*!< First Segment */
#define ETH_DMATXDESC_DC                      0x08000000UL  /*!< Disable CRC */
#define ETH_DMATXDESC_DP                      0x04000000UL  /*!< Disable Padding */
...
#define ETH_DMATXDESC_TCH                     0x00100000UL  /*!< Second Address Chained */
#define ETH_DMATXDESC_TTSS                    0x00020000UL  /*!< Tx Time Stamp Status */
#define ETH_DMATXDESC_IHE                     0x00010000UL  /*!< IP Header Error */
#define ETH_DMATXDESC_ES                      0x00008000UL  /*!< Error summary: OR of the following bits: UE || ED || EC || LCO || NC || LCA || FF || JT */
#define ETH_DMATXDESC_JT                      0x00004000UL  /*!< Jabber Timeout */
#define ETH_DMATXDESC_FF                      0x00002000UL  /*!< Frame Flushed: DMA/MTL flushed the frame due to SW flush */
#define ETH_DMATXDESC_PCE                     0x00001000UL  /*!< Payload Checksum Error */
#define ETH_DMATXDESC_LCA                     0x00000800UL  /*!< Loss of Carrier: carrier lost during transmission */
#define ETH_DMATXDESC_NC                      0x00000400UL  /*!< No Carrier: no carrier signal from the transceiver */
#define ETH_DMATXDESC_LCO                     0x00000200UL  /*!< Late Collision: transmission aborted due to collision */
#define ETH_DMATXDESC_EC                      0x00000100UL  /*!< Excessive Collision: transmission aborted after 16 collisions */
#define ETH_DMATXDESC_VF                      0x00000080UL  /*!< VLAN Frame */
#define ETH_DMATXDESC_CC                      0x00000078UL  /*!< Collision Count */
#define ETH_DMATXDESC_ED                      0x00000004UL  /*!< Excessive Deferral */
#define ETH_DMATXDESC_UF                      0x00000002UL  /*!< Underflow Error: late data arrival from the memory */
#define ETH_DMATXDESC_DB                      0x00000001UL  /*!< Deferred Bit */
...
/**
  ...
  */
#define ETH_DMATXDESC_B1AP                    0xFFFFFFFFUL  /*!< Buffer1 Address Pointer */

/**
  * @brief  Bit definition of TDES3 register
  */
#define ETH_DMATXDESC_B2AP                    0xFFFFFFFFUL  /*!< Buffer2 Address Pointer */
...
#define ETH_DMAPTPTXDESC_TTSL                 0xFFFFFFFFUL  /* Transmit Time Stamp Low */

/* Bit definition of TDES7 register */
#define ETH_DMAPTPTXDESC_TTSH                 0xFFFFFFFFUL  /* Transmit Time Stamp High */
...
/**
  ...
  */
#define ETH_DMARXDESC_OWN         0x80000000UL  /*!< OWN bit: descriptor is owned by DMA engine  */
#define ETH_DMARXDESC_AFM         0x40000000UL  /*!< DA Filter Fail for the rx frame  */
#define ETH_DMARXDESC_FL          0x3FFF0000UL  /*!< Receive descriptor frame length  */
#define ETH_DMARXDESC_ES          0x00008000UL  /*!< Error summary: OR of the following bits: DE || OE || IPC || LC || RWT || RE || CE */
#define ETH_DMARXDESC_DE          0x00004000UL  /*!< Descriptor error: no more descriptors for receive frame  */
#define ETH_DMARXDESC_SAF         0x00002000UL  /*!< SA Filter Fail for the received frame */
#define ETH_DMARXDESC_LE          0x00001000UL  /*!< Frame size not matching with length field */
#define ETH_DMARXDESC_OE          0x00000800UL  /*!< Overflow Error: Frame was damaged due to buffer overflow */
#define ETH_DMARXDESC_VLAN        0x00000400UL  /*!< VLAN Tag: received frame is a VLAN frame */
#define ETH_DMARXDESC_FS          0x00000200UL  /*!< First descriptor of the frame  */
#define ETH_DMARXDESC_LS          0x00000100UL  /*!< Last descriptor of the frame  */
#define ETH_DMARXDESC_IPV4HCE     0x00000080UL  /*!< IPC Checksum Error: Rx Ipv4 header checksum error   */
#define ETH_DMARXDESC_LC          0x00000040UL  /*!< Late collision occurred during reception   */
#define ETH_DMARXDESC_FT          0x00000020UL  /*!< Frame type - Ethernet, otherwise 802.3    */
#define ETH_DMARXDESC_RWT         0x00000010UL  /*!< Receive Watchdog Timeout: watchdog timer expired during reception    */
#define ETH_DMARXDESC_RE          0x00000008UL  /*!< Receive error: error reported by MII interface  */
#define ETH_DMARXDESC_DBE         0x00000004UL  /*!< Dribble bit error: frame contains non int multiple of 8 bits  */
#define ETH_DMARXDESC_CE          0x00000002UL  /*!< CRC error */
#define ETH_DMARXDESC_MAMPCE      0x00000001UL  /*!< Rx MAC Address/Payload Checksum Error: Rx MAC address matched/ Rx Payload Checksum Error */
...
#define ETH_DMARXDESC_RCH         0x00004000UL  /*!< Second Address Chained */
#define ETH_DMARXDESC_RBS1        0x00001FFFUL  /*!< Receive Buffer1 Size */

/**
  * @brief  Bit definition of RDES2 register
  */
#define ETH_DMARXDESC_B1AP        0xFFFFFFFFUL  /*!< Buffer1 Address Pointer */

/**
  * @brief  Bit definition of RDES3 register
  */
#define ETH_DMARXDESC_B2AP        0xFFFFFFFFUL  /*!< Buffer2 Address Pointer */
...
#define ETH_DMAPTPRXDESC_PTPV                            0x00002000UL  /* PTP Version */
#define ETH_DMAPTPRXDESC_PTPFT                           0x00001000UL  /* PTP Frame Type */
#define ETH_DMAPTPRXDESC_PTPMT                           0x00000F00UL  /* PTP Message Type */
#define ETH_DMAPTPRXDESC_PTPMT_SYNC                      0x00000100UL  /* SYNC message
                                                                                   (all clock types) */
#define ETH_DMAPTPRXDESC_PTPMT_FOLLOWUP                  0x00000200UL  /* FollowUp message
                                                                                   (all clock types) */
#define ETH_DMAPTPRXDESC_PTPMT_DELAYREQ                  0x00000300UL  /* DelayReq message
                                                                                   (all clock types) */
#define ETH_DMAPTPRXDESC_PTPMT_DELAYRESP                 0x00000400UL  /* DelayResp message
                                                                                   (all clock types) */
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYREQ_ANNOUNCE        0x00000500UL  /* PdelayReq message
                                                                                   (peer-to-peer transparent clock)
                                                                                    or Announce message (Ordinary
                                                                                    or Boundary clock) */
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESP_MANAG          0x00000600UL  /* PdelayResp message
                                                                                   (peer-to-peer transparent clock)
                                                                                    or Management message (Ordinary
                                                                                    or Boundary clock)  */
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESPFOLLOWUP_SIGNAL 0x00000700UL  /* PdelayRespFollowUp message
                                                                                  (peer-to-peer transparent clock)
                                                                                   or Signaling message (Ordinary
                                                                                   or Boundary clock) */
#define ETH_DMAPTPRXDESC_IPV6PR                          0x00000080UL  /* IPv6 Packet Received */
#define ETH_DMAPTPRXDESC_IPV4PR                          0x00000040UL  /* IPv4 Packet Received */
#define ETH_DMAPTPRXDESC_IPCB                            0x00000020UL  /* IP Checksum Bypassed */
#define ETH_DMAPTPRXDESC_IPPE                            0x00000010UL  /* IP Payload Error */
#define ETH_DMAPTPRXDESC_IPHE                            0x00000008UL  /* IP Header Error */
#define ETH_DMAPTPRXDESC_IPPT                            0x00000007UL  /* IP Payload Type */
#define ETH_DMAPTPRXDESC_IPPT_UDP                        0x00000001UL  /* UDP payload encapsulated in
                                                                                   the IP datagram */
#define ETH_DMAPTPRXDESC_IPPT_TCP                        0x00000002UL  /* TCP payload encapsulated in
                                                                                   the IP datagram */
#define ETH_DMAPTPRXDESC_IPPT_ICMP                       0x00000003UL  /* ICMP payload encapsulated in
                                                                                     the IP datagram */

/* Bit definition of RDES6 register */
#define ETH_DMAPTPRXDESC_RTSL  0xFFFFFFFFUL  /* Receive Time Stamp Low */

/* Bit definition of RDES7 register */
#define ETH_DMAPTPRXDESC_RTSH  0xFFFFFFFFUL  /* Receive Time Stamp High */
...
#define HAL_ETH_ERROR_PARAM            0x00000001UL   /*!< Busy error          */
#define HAL_ETH_ERROR_BUSY             0x00000002UL   /*!< Parameter error     */
#define HAL_ETH_ERROR_TIMEOUT          0x00000004UL   /*!< Timeout error       */
#define HAL_ETH_ERROR_DMA              0x00000008UL   /*!< DMA transfer error  */
#define HAL_ETH_ERROR_MAC              0x00000010UL   /*!< MAC transfer error  */
#if (USE_HAL_ETH_REGISTER_CALLBACKS == 1U)
#define HAL_ETH_ERROR_INVALID_CALLBACK 0x00000020UL    /*!< Invalid Callback error  */
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup ETH_Tx_Packet_Attributes ETH Tx Packet Attributes
  * @{
  */
#define ETH_TX_PACKETS_FEATURES_CSUM          0x00000001UL
#define ETH_TX_PACKETS_FEATURES_SAIC          0x00000002UL
#define ETH_TX_PACKETS_FEATURES_VLANTAG       0x00000004UL
#define ETH_TX_PACKETS_FEATURES_INNERVLANTAG  0x00000008UL
#define ETH_TX_PACKETS_FEATURES_TSO           0x00000010UL
#define ETH_TX_PACKETS_FEATURES_CRCPAD        0x00000020UL
/**
  * @}
  */
...
#define ETH_CRC_PAD_INSERT       0x00000000UL
...
#define ETH_DMAARBITRATION_RX1_TX1   0x00000000UL
...
#define ETH_DMAARBITRATION_TX1_RX1   0x00000000UL
...
#define ETH_BURSTLENGTH_UNSPECIFIED     0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Tx_DMA_Burst_Length ETH Tx DMA Burst Length
  * @{
  */
#define ETH_TXDMABURSTLENGTH_1BEAT          0x00000100UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 1 */
#define ETH_TXDMABURSTLENGTH_2BEAT          0x00000200UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 2 */
#define ETH_TXDMABURSTLENGTH_4BEAT          0x00000400UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 4 */
#define ETH_TXDMABURSTLENGTH_8BEAT          0x00000800UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 8 */
#define ETH_TXDMABURSTLENGTH_16BEAT         0x00001000UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 16 */
#define ETH_TXDMABURSTLENGTH_32BEAT         0x00002000UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_4BEAT    0x01000100UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 4 */
#define ETH_TXDMABURSTLENGTH_4XPBL_8BEAT    0x01000200UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 8 */
#define ETH_TXDMABURSTLENGTH_4XPBL_16BEAT   0x01000400UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 16 */
#define ETH_TXDMABURSTLENGTH_4XPBL_32BEAT   0x01000800UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_64BEAT   0x01001000UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 64 */
#define ETH_TXDMABURSTLENGTH_4XPBL_128BEAT  0x01002000UL  /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction is 128 */
/**
  * @}
  */
...
/** @defgroup ETH_Rx_DMA_Burst_Length ETH Rx DMA Burst Length
  * @{
  */
#define ETH_RXDMABURSTLENGTH_1BEAT          0x00020000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 1 */
#define ETH_RXDMABURSTLENGTH_2BEAT          0x00040000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 2 */
#define ETH_RXDMABURSTLENGTH_4BEAT          0x00080000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_RXDMABURSTLENGTH_8BEAT          0x00100000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 8 */
#define ETH_RXDMABURSTLENGTH_16BEAT         0x00200000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 16 */
#define ETH_RXDMABURSTLENGTH_32BEAT         0x00400000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 32 */
#define ETH_RXDMABURSTLENGTH_4XPBL_4BEAT    0x01020000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_RXDMABURSTLENGTH_4XPBL_8BEAT    0x01040000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 8 */
#define ETH_RXDMABURSTLENGTH_4XPBL_16BEAT   0x01080000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 16 */
#define ETH_RXDMABURSTLENGTH_4XPBL_32BEAT   0x01100000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 32 */
#define ETH_RXDMABURSTLENGTH_4XPBL_64BEAT   0x01200000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 64 */
#define ETH_RXDMABURSTLENGTH_4XPBL_128BEAT  0x01400000UL  /*!< maximum number of beats to be transferred in one RxDMA transaction is 128 */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Status_Flags ETH DMA Status Flags
  * @{
  */
#define ETH_DMA_NO_ERROR_FLAG                     0x00000000UL
#define ETH_DMA_TX_DATA_TRANS_ERROR_FLAG          ETH_DMASR_EBS_DataTransfTx
#define ETH_DMA_RX_DATA_TRANS_ERROR_FLAG          0x00000000UL
#define ETH_DMA_READ_TRANS_ERROR_FLAG             ETH_DMASR_EBS_ReadTransf
#define ETH_DMA_WRITE_TRANS_ERROR_FLAG            0x00000000UL
#define ETH_DMA_DESC_ACCESS_ERROR_FLAG            ETH_DMASR_EBS_DescAccess
#define ETH_DMA_DATA_BUFF_ACCESS_ERROR_FLAG       0x00000000UL
...
/** @defgroup ETH_Speed  ETH Speed
  * @{
  */
#define ETH_SPEED_10M        0x00000000UL
#define ETH_SPEED_100M       0x00004000UL
/**
  * @}
  */
...
#define ETH_HALFDUPLEX_MODE       0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Back_Off_Limit ETH Back Off Limit
  * @{
  */
#define ETH_BACKOFFLIMIT_10  0x00000000UL
#define ETH_BACKOFFLIMIT_8   0x00000020UL
#define ETH_BACKOFFLIMIT_4   0x00000040UL
#define ETH_BACKOFFLIMIT_1   0x00000060UL
/**
  * @}
  */
...
/** @defgroup ETH_Source_Addr_Control ETH Source Addr Control
  * @{
  */
#define ETH_SOURCEADDRESS_DISABLE           0x00000000UL
...
/** @defgroup ETH_VLAN_Tag_Comparison ETH VLAN Tag Comparison
  * @{
  */
#define ETH_VLANTAGCOMPARISON_12BIT    0x00010000UL
#define ETH_VLANTAGCOMPARISON_16BIT    0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_AutoNegotiation ETH AutoNegotiation
  * @{
  */
#define ETH_AUTONEGOTIATION_ENABLE     0x00000001UL
#define ETH_AUTONEGOTIATION_DISABLE    0x00000000UL
...
/** @defgroup ETH_Rx_Mode ETH Rx Mode
  * @{
  */
#define ETH_RXPOLLING_MODE      0x00000000UL
#define ETH_RXINTERRUPT_MODE    0x00000001UL
/**
  * @}
  */
...
/** @defgroup ETH_Checksum_Mode ETH Checksum Mode
  * @{
  */
#define ETH_CHECKSUM_BY_HARDWARE      0x00000000UL
#define ETH_CHECKSUM_BY_SOFTWARE      0x00000001UL
/**
  * @}
  */
...
/** @defgroup ETH_Media_Interface ETH Media Interface
  * @{
  */
#define ETH_MEDIA_INTERFACE_MII       0x00000000UL
...
/** @defgroup ETH_Watchdog ETH Watchdog
  * @{
  */
#define ETH_WATCHDOG_ENABLE       0x00000000UL
#define ETH_WATCHDOG_DISABLE      0x00800000UL
/**
  * @}
  */
...
/** @defgroup ETH_Jabber ETH Jabber
  * @{
  */
#define ETH_JABBER_ENABLE    0x00000000UL
#define ETH_JABBER_DISABLE   0x00400000UL
/**
  * @}
  */
...
/** @defgroup ETH_Inter_Frame_Gap ETH Inter Frame Gap
  * @{
  */
#define ETH_INTERFRAMEGAP_96BIT   0x00000000UL  /*!< minimum IFG between frames during transmission is 96Bit */
#define ETH_INTERFRAMEGAP_88BIT   0x00020000UL  /*!< minimum IFG between frames during transmission is 88Bit */
#define ETH_INTERFRAMEGAP_80BIT   0x00040000UL  /*!< minimum IFG between frames during transmission is 80Bit */
#define ETH_INTERFRAMEGAP_72BIT   0x00060000UL  /*!< minimum IFG between frames during transmission is 72Bit */
#define ETH_INTERFRAMEGAP_64BIT   0x00080000UL  /*!< minimum IFG between frames during transmission is 64Bit */
#define ETH_INTERFRAMEGAP_56BIT   0x000A0000UL  /*!< minimum IFG between frames during transmission is 56Bit */
#define ETH_INTERFRAMEGAP_48BIT   0x000C0000UL  /*!< minimum IFG between frames during transmission is 48Bit */
#define ETH_INTERFRAMEGAP_40BIT   0x000E0000UL  /*!< minimum IFG between frames during transmission is 40Bit */
/**
  * @}
  */
...
/** @defgroup ETH_Carrier_Sense ETH Carrier Sense
  * @{
  */
#define ETH_CARRIERSENCE_ENABLE   0x00000000UL
#define ETH_CARRIERSENCE_DISABLE  0x00010000UL
/**
  * @}
  */
...
/** @defgroup ETH_Receive_Own ETH Receive Own
  * @{
  */
#define ETH_RECEIVEOWN_ENABLE     0x00000000UL
#define ETH_RECEIVEOWN_DISABLE    0x00002000UL
/**
  * @}
  */
...
/** @defgroup ETH_Loop_Back_Mode ETH Loop Back Mode
  * @{
  */
#define ETH_LOOPBACKMODE_ENABLE        0x00001000UL
#define ETH_LOOPBACKMODE_DISABLE       0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Checksum_Offload ETH Checksum Offload
  * @{
  */
#define ETH_CHECKSUMOFFLAOD_ENABLE     0x00000400UL
#define ETH_CHECKSUMOFFLAOD_DISABLE    0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Retry_Transmission ETH Retry Transmission
  * @{
  */
#define ETH_RETRYTRANSMISSION_ENABLE   0x00000000UL
#define ETH_RETRYTRANSMISSION_DISABLE  0x00000200UL
/**
  * @}
  */
...
/** @defgroup ETH_Automatic_Pad_CRC_Strip ETH Automatic Pad CRC Strip
  * @{
  */
#define ETH_AUTOMATICPADCRCSTRIP_ENABLE     0x00000080UL
#define ETH_AUTOMATICPADCRCSTRIP_DISABLE    0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Deferral_Check ETH Deferral Check
  * @{
  */
#define ETH_DEFFERRALCHECK_ENABLE       0x00000010UL
#define ETH_DEFFERRALCHECK_DISABLE      0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Receive_All ETH Receive All
  * @{
  */
#define ETH_RECEIVEALL_ENABLE     0x80000000UL
#define ETH_RECEIVEALL_DISABLE    0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Source_Addr_Filter ETH Source Addr Filter
  * @{
  */
#define ETH_SOURCEADDRFILTER_NORMAL_ENABLE       0x00000200UL
#define ETH_SOURCEADDRFILTER_INVERSE_ENABLE      0x00000300UL
#define ETH_SOURCEADDRFILTER_DISABLE             0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Pass_Control_Frames ETH Pass Control Frames
  * @{
  */
#define ETH_PASSCONTROLFRAMES_BLOCKALL                0x00000040UL  /*!< MAC filters all control frames from reaching the application */
#define ETH_PASSCONTROLFRAMES_FORWARDALL              0x00000080UL  /*!< MAC forwards all control frames to application even if they fail the Address Filter */
#define ETH_PASSCONTROLFRAMES_FORWARDPASSEDADDRFILTER 0x000000C0UL  /*!< MAC forwards control frames that pass the Address Filter. */
/**
  * @}
  */
...
/** @defgroup ETH_Broadcast_Frames_Reception ETH Broadcast Frames Reception
  * @{
  */
#define ETH_BROADCASTFRAMESRECEPTION_ENABLE     0x00000000UL
#define ETH_BROADCASTFRAMESRECEPTION_DISABLE    0x00000020UL
/**
  * @}
  */
...
/** @defgroup ETH_Destination_Addr_Filter ETH Destination Addr Filter
  * @{
  */
#define ETH_DESTINATIONADDRFILTER_NORMAL    0x00000000UL
#define ETH_DESTINATIONADDRFILTER_INVERSE   0x00000008UL
/**
  * @}
  */
...
/** @defgroup ETH_Promiscuous_Mode ETH Promiscuous Mode
  * @{
  */
#define ETH_PROMISCUOUS_MODE_ENABLE     0x00000001UL
#define ETH_PROMISCUOUS_MODE_DISABLE    0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Multicast_Frames_Filter ETH Multicast Frames Filter
  * @{
  */
#define ETH_MULTICASTFRAMESFILTER_PERFECTHASHTABLE    0x00000404UL
#define ETH_MULTICASTFRAMESFILTER_HASHTABLE           0x00000004UL
#define ETH_MULTICASTFRAMESFILTER_PERFECT             0x00000000UL
#define ETH_MULTICASTFRAMESFILTER_NONE                0x00000010UL
/**
  * @}
  */
...
/** @defgroup ETH_Unicast_Frames_Filter ETH Unicast Frames Filter
  * @{
  */
#define ETH_UNICASTFRAMESFILTER_PERFECTHASHTABLE 0x00000402UL
#define ETH_UNICASTFRAMESFILTER_HASHTABLE        0x00000002UL
#define ETH_UNICASTFRAMESFILTER_PERFECT          0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Zero_Quanta_Pause ETH Zero Quanta Pause
  * @{
  */
#define ETH_ZEROQUANTAPAUSE_ENABLE     0x00000000UL
#define ETH_ZEROQUANTAPAUSE_DISABLE    0x00000080UL
/**
  * @}
  */
...
/** @defgroup ETH_Pause_Low_Threshold ETH Pause Low Threshold
  * @{
  */
#define ETH_PAUSELOWTHRESHOLD_MINUS4        0x00000000UL  /*!< Pause time minus 4 slot times */
#define ETH_PAUSELOWTHRESHOLD_MINUS28       0x00000010UL  /*!< Pause time minus 28 slot times */
#define ETH_PAUSELOWTHRESHOLD_MINUS144      0x00000020UL  /*!< Pause time minus 144 slot times */
#define ETH_PAUSELOWTHRESHOLD_MINUS256      0x00000030UL  /*!< Pause time minus 256 slot times */
/**
  * @}
  */
...
/** @defgroup ETH_Unicast_Pause_Frame_Detect ETH Unicast Pause Frame Detect
  * @{
  */
#define ETH_UNICASTPAUSEFRAMEDETECT_ENABLE  0x00000008UL
#define ETH_UNICASTPAUSEFRAMEDETECT_DISABLE 0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Receive_Flow_Control ETH Receive Flow Control
  * @{
  */
#define ETH_RECEIVEFLOWCONTROL_ENABLE       0x00000004UL
#define ETH_RECEIVEFLOWCONTROL_DISABLE      0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_Transmit_Flow_Control ETH Transmit Flow Control
  * @{
  */
#define ETH_TRANSMITFLOWCONTROL_ENABLE      0x00000002UL
#define ETH_TRANSMITFLOWCONTROL_DISABLE     0x00000000UL
/**
  * @}
  */
...
/** @defgroup ETH_MAC_addresses_filter_SA_DA ETH MAC addresses filter SA DA
  * @{
  */
#define ETH_MAC_ADDRESSFILTER_SA       0x00000000UL
#define ETH_MAC_ADDRESSFILTER_DA       0x00000008UL
/**
  * @}
  */
...
/** @defgroup ETH_MAC_addresses_filter_Mask_bytes ETH MAC addresses filter Mask bytes
  * @{
  */
#define ETH_MAC_ADDRESSMASK_BYTE6      0x20000000UL  /*!< Mask MAC Address high reg bits [15:8] */
#define ETH_MAC_ADDRESSMASK_BYTE5      0x10000000UL  /*!< Mask MAC Address high reg bits [7:0] */
#define ETH_MAC_ADDRESSMASK_BYTE4      0x08000000UL  /*!< Mask MAC Address low reg bits [31:24] */
#define ETH_MAC_ADDRESSMASK_BYTE3      0x04000000UL  /*!< Mask MAC Address low reg bits [23:16] */
#define ETH_MAC_ADDRESSMASK_BYTE2      0x02000000UL  /*!< Mask MAC Address low reg bits [15:8] */
#define ETH_MAC_ADDRESSMASK_BYTE1      0x01000000UL  /*!< Mask MAC Address low reg bits [7:0] */
/**
  * @}
  */
...
/** @defgroup ETH_Transmit_Threshold_Control ETH Transmit Threshold Control
  * @{
  */
#define ETH_TRANSMITTHRESHOLDCONTROL_64BYTES     0x00000000UL  /*!< threshold level of the MTL Transmit FIFO is 64 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_128BYTES    0x00004000UL  /*!< threshold level of the MTL Transmit FIFO is 128 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_192BYTES    0x00008000UL  /*!< threshold level of the MTL Transmit FIFO is 192 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_256BYTES    0x0000C000UL  /*!< threshold level of the MTL Transmit FIFO is 256 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_40BYTES     0x00010000UL  /*!< threshold level of the MTL Transmit FIFO is 40 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_32BYTES     0x00014000UL  /*!< threshold level of the MTL Transmit FIFO is 32 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_24BYTES     0x00018000UL  /*!< threshold level of the MTL Transmit FIFO is 24 Bytes */
#define ETH_TRANSMITTHRESHOLDCONTROL_16BYTES     0x0001C000UL  /*!< threshold level of the MTL Transmit FIFO is 16 Bytes */
/**
  * @}
  */
...
/** @defgroup ETH_Receive_Threshold_Control ETH Receive Threshold Control
  * @{
  */
#define ETH_RECEIVEDTHRESHOLDCONTROL_64BYTES      0x00000000UL  /*!< threshold level of the MTL Receive FIFO is 64 Bytes */
#define ETH_RECEIVEDTHRESHOLDCONTROL_32BYTES      0x00000008UL  /*!< threshold level of the MTL Receive FIFO is 32 Bytes */
#define ETH_RECEIVEDTHRESHOLDCONTROL_96BYTES      0x00000010UL  /*!< threshold level of the MTL Receive FIFO is 96 Bytes */
#define ETH_RECEIVEDTHRESHOLDCONTROL_128BYTES     0x00000018UL  /*!< threshold level of the MTL Receive FIFO is 128 Bytes */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Arbitration ETH DMA Arbitration
  * @{
  */
#define ETH_DMAARBITRATION_ROUNDROBIN_RXTX_1_1   0x00000000UL
#define ETH_DMAARBITRATION_ROUNDROBIN_RXTX_2_1   0x00004000UL
#define ETH_DMAARBITRATION_ROUNDROBIN_RXTX_3_1   0x00008000UL
#define ETH_DMAARBITRATION_ROUNDROBIN_RXTX_4_1   0x0000C000UL
#define ETH_DMAARBITRATION_RXPRIORTX             0x00000002UL
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Tx_descriptor_segment ETH DMA Tx descriptor segment
  * @{
  */
#define ETH_DMATXDESC_LASTSEGMENTS      0x40000000UL  /*!< Last Segment */
#define ETH_DMATXDESC_FIRSTSEGMENT      0x20000000UL  /*!< First Segment */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Tx_descriptor_Checksum_Insertion_Control ETH DMA Tx descriptor Checksum Insertion Control
  * @{
  */
#define ETH_DMATXDESC_CHECKSUMBYPASS             0x00000000UL   /*!< Checksum engine bypass */
#define ETH_DMATXDESC_CHECKSUMIPV4HEADER         0x00400000UL   /*!< IPv4 header checksum insertion  */
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT  0x00800000UL   /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be present */
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL     0x00C00000UL   /*!< TCP/UDP/ICMP checksum fully in hardware including pseudo header */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Rx_descriptor_buffers ETH DMA Rx descriptor buffers
  * @{
  */
#define ETH_DMARXDESC_BUFFER1     0x00000000UL  /*!< DMA Rx Desc Buffer1 */
#define ETH_DMARXDESC_BUFFER2     0x00000001UL  /*!< DMA Rx Desc Buffer2 */
/**
  * @}
  */
...
/** @defgroup ETH_PMT_Flags ETH PMT Flags
  * @{
  */
#define ETH_PMT_FLAG_WUFFRPR      0x80000000UL  /*!< Wake-Up Frame Filter Register Pointer Reset */
#define ETH_PMT_FLAG_WUFR         0x00000040UL  /*!< Wake-Up Frame Received */
#define ETH_PMT_FLAG_MPR          0x00000020UL  /*!< Magic Packet Received */
/**
  * @}
  */
...
/** @defgroup ETH_MMC_Tx_Interrupts ETH MMC Tx Interrupts
  * @{
  */
#define ETH_MMC_IT_TGF       0x00200000UL  /*!< When Tx good frame counter reaches half the maximum value */
#define ETH_MMC_IT_TGFMSC    0x00008000UL  /*!< When Tx good multi col counter reaches half the maximum value */
#define ETH_MMC_IT_TGFSC     0x00004000UL  /*!< When Tx good single col counter reaches half the maximum value */
/**
  * @}
  */
...
/** @defgroup ETH_MMC_Rx_Interrupts ETH MMC Rx Interrupts
  * @{
  */
#define ETH_MMC_IT_RGUF      0x10020000UL  /*!< When Rx good unicast frames counter reaches half the maximum value */
#define ETH_MMC_IT_RFAE      0x10000040UL  /*!< When Rx alignment error counter reaches half the maximum value */
#define ETH_MMC_IT_RFCE      0x10000020UL  /*!< When Rx crc error counter reaches half the maximum value */
/**
  * @}
  */
...
/** @defgroup ETH_MAC_Flags ETH MAC Flags
  * @{
  */
#define ETH_MAC_FLAG_TST     0x00000200UL  /*!< Time stamp trigger flag (on MAC) */
#define ETH_MAC_FLAG_MMCT    0x00000040UL  /*!< MMC transmit flag  */
#define ETH_MAC_FLAG_MMCR    0x00000020UL  /*!< MMC receive flag */
#define ETH_MAC_FLAG_MMC     0x00000010UL  /*!< MMC flag (on MAC) */
#define ETH_MAC_FLAG_PMT     0x00000008UL  /*!< PMT flag (on MAC) */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Flags ETH DMA Flags
  * @{
  */
#define ETH_DMA_FLAG_TST               0x20000000UL  /*!< Time-stamp trigger interrupt (on DMA) */
#define ETH_DMA_FLAG_PMT               0x10000000UL  /*!< PMT interrupt (on DMA) */
#define ETH_DMA_FLAG_MMC               0x08000000UL  /*!< MMC interrupt (on DMA) */
#define ETH_DMA_FLAG_DATATRANSFERERROR 0x00800000UL  /*!< Error bits 0-Rx DMA, 1-Tx DMA */
#define ETH_DMA_FLAG_READWRITEERROR    0x01000000UL  /*!< Error bits 0-write transfer, 1-read transfer */
#define ETH_DMA_FLAG_ACCESSERROR       0x02000000UL  /*!< Error bits 0-data buffer, 1-desc. access */
#define ETH_DMA_FLAG_NIS               0x00010000UL  /*!< Normal interrupt summary flag */
#define ETH_DMA_FLAG_AIS               0x00008000UL  /*!< Abnormal interrupt summary flag */
#define ETH_DMA_FLAG_ER                0x00004000UL  /*!< Early receive flag */
#define ETH_DMA_FLAG_FBE               0x00002000UL  /*!< Fatal bus error flag */
#define ETH_DMA_FLAG_ET                0x00000400UL  /*!< Early transmit flag */
#define ETH_DMA_FLAG_RWT               0x00000200UL  /*!< Receive watchdog timeout flag */
#define ETH_DMA_FLAG_RPS               0x00000100UL  /*!< Receive process stopped flag */
#define ETH_DMA_FLAG_RBU               0x00000080UL  /*!< Receive buffer unavailable flag */
#define ETH_DMA_FLAG_R                 0x00000040UL  /*!< Receive flag */
#define ETH_DMA_FLAG_TU                0x00000020UL  /*!< Underflow flag */
#define ETH_DMA_FLAG_RO                0x00000010UL  /*!< Overflow flag */
#define ETH_DMA_FLAG_TJT               0x00000008UL  /*!< Transmit jabber timeout flag */
#define ETH_DMA_FLAG_TBU               0x00000004UL  /*!< Transmit buffer unavailable flag */
#define ETH_DMA_FLAG_TPS               0x00000002UL  /*!< Transmit process stopped flag */
#define ETH_DMA_FLAG_T                 0x00000001UL  /*!< Transmit flag */
/**
  * @}
  */
...
/** @defgroup ETH_MAC_Interrupts ETH MAC Interrupts
  * @{
  */
#define ETH_MAC_IT_TST       0x00000200UL  /*!< Time stamp trigger interrupt (on MAC) */
#define ETH_MAC_IT_MMCT      0x00000040UL  /*!< MMC transmit interrupt */
#define ETH_MAC_IT_MMCR      0x00000020UL  /*!< MMC receive interrupt */
#define ETH_MAC_IT_MMC       0x00000010UL  /*!< MMC interrupt (on MAC) */
#define ETH_MAC_IT_PMT       0x00000008UL  /*!< PMT interrupt (on MAC) */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_Interrupts ETH DMA Interrupts
  * @{
  */
#define ETH_DMA_IT_TST       0x20000000UL  /*!< Time-stamp trigger interrupt (on DMA) */
#define ETH_DMA_IT_PMT       0x10000000UL  /*!< PMT interrupt (on DMA) */
#define ETH_DMA_IT_MMC       0x08000000UL  /*!< MMC interrupt (on DMA) */
#define ETH_DMA_IT_NIS       0x00010000UL  /*!< Normal interrupt summary */
#define ETH_DMA_IT_AIS       0x00008000UL  /*!< Abnormal interrupt summary */
#define ETH_DMA_IT_ER        0x00004000UL  /*!< Early receive interrupt */
#define ETH_DMA_IT_FBE       0x00002000UL  /*!< Fatal bus error interrupt */
#define ETH_DMA_IT_ET        0x00000400UL  /*!< Early transmit interrupt */
#define ETH_DMA_IT_RWT       0x00000200UL  /*!< Receive watchdog timeout interrupt */
#define ETH_DMA_IT_RPS       0x00000100UL  /*!< Receive process stopped interrupt */
#define ETH_DMA_IT_RBU       0x00000080UL  /*!< Receive buffer unavailable interrupt */
#define ETH_DMA_IT_R         0x00000040UL  /*!< Receive interrupt */
#define ETH_DMA_IT_TU        0x00000020UL  /*!< Underflow interrupt */
#define ETH_DMA_IT_RO        0x00000010UL  /*!< Overflow interrupt */
#define ETH_DMA_IT_TJT       0x00000008UL  /*!< Transmit jabber timeout interrupt */
#define ETH_DMA_IT_TBU       0x00000004UL  /*!< Transmit buffer unavailable interrupt */
#define ETH_DMA_IT_TPS       0x00000002UL  /*!< Transmit process stopped interrupt */
#define ETH_DMA_IT_T         0x00000001UL  /*!< Transmit interrupt */
/**
  * @}
  */
...
/** @defgroup ETH_DMA_transmit_process_state ETH DMA transmit process state
  * @{
  */
#define ETH_DMA_TRANSMITPROCESS_STOPPED     0x00000000UL  /*!< Stopped - Reset or Stop Tx Command issued */
#define ETH_DMA_TRANSMITPROCESS_FETCHING    0x00100000UL  /*!< Running - fetching the Tx descriptor */
#define ETH_DMA_TRANSMITPROCESS_WAITING     0x00200000UL  /*!< Running - waiting for status */
#define ETH_DMA_TRANSMITPROCESS_READING     0x00300000UL  /*!< Running - reading the data from host memory */
#define ETH_DMA_TRANSMITPROCESS_SUSPENDED   0x00600000UL  /*!< Suspended - Tx Descriptor unavailable */
#define ETH_DMA_TRANSMITPROCESS_CLOSING     0x00700000UL  /*!< Running - closing Rx descriptor */
...
/** @defgroup ETH_DMA_receive_process_state ETH DMA receive process state
  * @{
  */
#define ETH_DMA_RECEIVEPROCESS_STOPPED      0x00000000UL  /*!< Stopped - Reset or Stop Rx Command issued */
#define ETH_DMA_RECEIVEPROCESS_FETCHING     0x00020000UL  /*!< Running - fetching the Rx descriptor */
#define ETH_DMA_RECEIVEPROCESS_WAITING      0x00060000UL  /*!< Running - waiting for packet */
#define ETH_DMA_RECEIVEPROCESS_SUSPENDED    0x00080000UL  /*!< Suspended - Rx Descriptor unavailable */
#define ETH_DMA_RECEIVEPROCESS_CLOSING      0x000A0000UL  /*!< Running - closing descriptor */
#define ETH_DMA_RECEIVEPROCESS_QUEUING      0x000E0000UL  /*!< Running - queuing the receive frame into host memory */
...
/** @defgroup ETH_DMA_overflow ETH DMA overflow
  * @{
  */
#define ETH_DMA_OVERFLOW_RXFIFOCOUNTER      0x10000000UL  /*!< Overflow bit for FIFO overflow counter */
#define ETH_DMA_OVERFLOW_MISSEDFRAMECOUNTER 0x00010000UL  /*!< Overflow bit for missed frame counter */
/**
  * @}
  */
/** @defgroup ETH_PTP_Config_Status ETH PTP Config Status
  * @{
  */
#define HAL_ETH_PTP_NOT_CONFIGURED        0x00000000UL    /*!< ETH PTP Configuration not done */
#define HAL_ETH_PTP_CONFIGURED            0x00000001UL    /*!< ETH PTP Configuration done     */
/**
  * @}
  */
...
#define ETH_WAKEUP_EXTI_LINE  0x00080000UL
...
HAL_StatusTypeDef HAL_ETH_Init(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_DeInit(ETH_HandleTypeDef * const heth);
void              HAL_ETH_MspInit(ETH_HandleTypeDef * const heth);
void              HAL_ETH_MspDeInit(ETH_HandleTypeDef * const heth);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_ETH_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_ETH_RegisterCallback(ETH_HandleTypeDef * const heth, HAL_ETH_CallbackIDTypeDef CallbackID,
                                           pETH_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_ETH_UnRegisterCallback(ETH_HandleTypeDef * const heth, HAL_ETH_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_ETH_Start(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_Start_IT(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_Stop(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_Stop_IT(ETH_HandleTypeDef * const heth);

HAL_StatusTypeDef HAL_ETH_ReadData(ETH_HandleTypeDef * const heth, void **pAppBuff);
HAL_StatusTypeDef HAL_ETH_RegisterRxAllocateCallback(ETH_HandleTypeDef * const heth,
                                                     pETH_rxAllocateCallbackTypeDef rxAllocateCallback);
HAL_StatusTypeDef HAL_ETH_UnRegisterRxAllocateCallback(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_RegisterRxLinkCallback(ETH_HandleTypeDef * const heth, pETH_rxLinkCallbackTypeDef rxLinkCallback);
HAL_StatusTypeDef HAL_ETH_UnRegisterRxLinkCallback(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_GetRxDataErrorCode(ETH_HandleTypeDef const * const heth, uint32_t * const pErrorCode);
HAL_StatusTypeDef HAL_ETH_RegisterTxFreeCallback(ETH_HandleTypeDef * const heth, pETH_txFreeCallbackTypeDef txFreeCallback);
HAL_StatusTypeDef HAL_ETH_UnRegisterTxFreeCallback(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_ReleaseTxPacket(ETH_HandleTypeDef * const heth);

#ifdef HAL_ETH_USE_PTP
HAL_StatusTypeDef HAL_ETH_PTP_SetConfig(ETH_HandleTypeDef * const heth, ETH_PTP_ConfigTypeDef * const ptpconfig);
HAL_StatusTypeDef HAL_ETH_PTP_GetConfig(ETH_HandleTypeDef * const heth, ETH_PTP_ConfigTypeDef * const ptpconfig);
HAL_StatusTypeDef HAL_ETH_PTP_SetTime(ETH_HandleTypeDef const * const heth, ETH_TimeTypeDef * const time);
HAL_StatusTypeDef HAL_ETH_PTP_GetTime(ETH_HandleTypeDef const * const heth, ETH_TimeTypeDef * const time);
HAL_StatusTypeDef HAL_ETH_PTP_AddTimeOffset(ETH_HandleTypeDef * const heth, ETH_PtpUpdateTypeDef ptpoffsettype,
                                            ETH_TimeTypeDef * const timeoffset);
HAL_StatusTypeDef HAL_ETH_PTP_InsertTxTimestamp(ETH_HandleTypeDef * const heth);
HAL_StatusTypeDef HAL_ETH_PTP_GetTxTimestamp(ETH_HandleTypeDef const * const heth, ETH_TimeStampTypeDef * const timestamp);
HAL_StatusTypeDef HAL_ETH_PTP_GetRxTimestamp(ETH_HandleTypeDef const * const heth, ETH_TimeStampTypeDef * const timestamp);
HAL_StatusTypeDef HAL_ETH_RegisterTxPtpCallback(ETH_HandleTypeDef * const heth, pETH_txPtpCallbackTypeDef txPtpCallback);
HAL_StatusTypeDef HAL_ETH_UnRegisterTxPtpCallback(ETH_HandleTypeDef * const heth);
#endif /* HAL_ETH_USE_PTP */

HAL_StatusTypeDef HAL_ETH_Transmit(ETH_HandleTypeDef * const heth, ETH_TxPacketConfigTypeDef const * const pTxConfig, uint32_t Timeout);
HAL_StatusTypeDef HAL_ETH_Transmit_IT(ETH_HandleTypeDef * const heth, ETH_TxPacketConfigTypeDef const * const pTxConfig);

HAL_StatusTypeDef HAL_ETH_WritePHYRegister(ETH_HandleTypeDef const * const heth, uint32_t PHYAddr, uint32_t PHYReg,
                                           uint32_t RegValue);
HAL_StatusTypeDef HAL_ETH_ReadPHYRegister(ETH_HandleTypeDef * const heth, uint32_t PHYAddr, uint32_t PHYReg,
                                          uint32_t * pRegValue);

void              HAL_ETH_IRQHandler(ETH_HandleTypeDef * const heth);
void              HAL_ETH_TxCpltCallback(ETH_HandleTypeDef * const heth);
void              HAL_ETH_RxCpltCallback(ETH_HandleTypeDef * const heth);
void              HAL_ETH_ErrorCallback(ETH_HandleTypeDef * const heth);
void              HAL_ETH_PMTCallback(ETH_HandleTypeDef * const heth);
void              HAL_ETH_WakeUpCallback(ETH_HandleTypeDef * const heth);
void              HAL_ETH_RxAllocateCallback(uint8_t **buff);
void              HAL_ETH_RxLinkCallback(void **pStart, void **pEnd, uint8_t *buff, uint16_t Length);
void              HAL_ETH_TxFreeCallback(uint32_t *buff);
void              HAL_ETH_TxPtpCallback(uint32_t *buff, ETH_TimeStampTypeDef * const timestamp);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_ETH_GetMACConfig(ETH_HandleTypeDef const * const heth, ETH_MACConfigTypeDef * const macconf);
HAL_StatusTypeDef HAL_ETH_GetDMAConfig(ETH_HandleTypeDef const * const heth, ETH_DMAConfigTypeDef * const dmaconf);
HAL_StatusTypeDef HAL_ETH_SetMACConfig(ETH_HandleTypeDef * const heth, ETH_MACConfigTypeDef * const macconf);
HAL_StatusTypeDef HAL_ETH_SetDMAConfig(ETH_HandleTypeDef * const heth, ETH_DMAConfigTypeDef * const dmaconf);
void              HAL_ETH_SetMDIOClockRange(ETH_HandleTypeDef * const heth);

/* MAC VLAN Processing APIs    ************************************************/
void              HAL_ETH_SetRxVLANIdentifier(ETH_HandleTypeDef * const heth, uint32_t ComparisonBits,
                                              uint32_t VLANIdentifier);

/* MAC L2 Packet Filtering APIs  **********************************************/
HAL_StatusTypeDef HAL_ETH_GetMACFilterConfig(ETH_HandleTypeDef const * const heth, ETH_MACFilterConfigTypeDef * const pFilterConfig);
HAL_StatusTypeDef HAL_ETH_SetMACFilterConfig(ETH_HandleTypeDef * const heth, ETH_MACFilterConfigTypeDef const * const pFilterConfig);
HAL_StatusTypeDef HAL_ETH_SetHashTable(ETH_HandleTypeDef * const heth, uint32_t * pHashTable);
HAL_StatusTypeDef HAL_ETH_SetSourceMACAddrMatch(ETH_HandleTypeDef const * const heth, uint32_t AddrNbr,
...
HAL_ETH_StateTypeDef HAL_ETH_GetState(ETH_HandleTypeDef const * const heth);
uint32_t             HAL_ETH_GetError(ETH_HandleTypeDef const * const heth);
uint32_t             HAL_ETH_GetDMAError(ETH_HandleTypeDef const * const heth);
uint32_t             HAL_ETH_GetMACError(ETH_HandleTypeDef const * const heth);
uint32_t             HAL_ETH_GetMACWakeUpSource(ETH_HandleTypeDef const * const heth);
/**
  * @}
  */
