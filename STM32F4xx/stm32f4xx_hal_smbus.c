...
#define SMBUS_NO_OPTION_FRAME       0xFFFF0000UL /*!< XferOptions default value */

#define SMBUS_SENDPEC_MODE          I2C_CR1_PEC
#define SMBUS_GET_PEC(__HANDLE__)             (((__HANDLE__)->Instance->SR2 & I2C_SR2_PEC) >> 8U)
...
static HAL_StatusTypeDef SMBUS_WaitOnFlagUntilTimeout(SMBUS_HandleTypeDef * const hsmbus, uint32_t Flag, FlagStatus Status, uint32_t Timeout, uint32_t Tickstart);
static void SMBUS_ITError(SMBUS_HandleTypeDef * const hsmbus);
static void SMBUS_Flush_DR(SMBUS_HandleTypeDef * const hsmbus);

/* Private functions for SMBUS transfer IRQ handler */
static HAL_StatusTypeDef SMBUS_MasterTransmit_TXE(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_MasterTransmit_BTF(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_MasterReceive_RXNE(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_MasterReceive_BTF(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Master_SB(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Master_ADD10(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Master_ADDR(SMBUS_HandleTypeDef * const hsmbus);

static HAL_StatusTypeDef SMBUS_SlaveTransmit_TXE(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_SlaveTransmit_BTF(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_SlaveReceive_RXNE(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_SlaveReceive_BTF(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Slave_ADDR(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Slave_STOPF(SMBUS_HandleTypeDef * const hsmbus);
static HAL_StatusTypeDef SMBUS_Slave_AF(SMBUS_HandleTypeDef * const hsmbus);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMBUS_MspInit(SMBUS_HandleTypeDef * const hsmbus)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMBUS_MspDeInit(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @param  hsmbus pointer to a SMBUS_HandleTypeDef structure that contains
  *                the configuration information for the specified SMBUSx peripheral.
  * @param  DigitalFilter Coefficient of digital noise filter between 0x00U and 0x0FU.
  * @retval HAL status
  */
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_MasterTxCpltCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_MasterRxCpltCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/** @brief  Slave Tx Transfer completed callback.
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_SlaveTxCpltCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_SlaveRxCpltCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_AddrCallback)(SMBUS_HandleTypeDef * const hsmbus, uint8_t TransferDirection, uint16_t AddrMatchCode)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_ListenCpltCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
HAL_SMBUS_WEAK_CALLBACK(void, HAL_SMBUS_ErrorCallback)(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMBUS_AbortCpltCallback(SMBUS_HandleTypeDef * const hsmbus)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmbus);
