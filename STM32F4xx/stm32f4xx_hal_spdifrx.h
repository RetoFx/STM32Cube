...
/**
  ...
  */
#if (USE_HAL_SPDIFRX_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_SPDIFRX_REGISTER_CALLBACKS == 1U)
  void (*RxHalfCpltCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);   /*!< SPDIFRX Data flow half completed
                                                                             callback */
  void (*RxCpltCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);       /*!< SPDIFRX Data flow completed callback */
  void (*CxHalfCpltCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);   /*!< SPDIFRX Control flow half completed
                                                                             callback */
  void (*CxCpltCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);       /*!< SPDIFRX Control flow completed callback */
  void (*ErrorCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);        /*!< SPDIFRX error callback */
  void (* MspInitCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);     /*!< SPDIFRX Msp Init callback  */
  void (* MspDeInitCallback)(struct __SPDIFRX_HandleTypeDef * const hspdif);   /*!< SPDIFRX Msp DeInit callback  */
#endif /* USE_HAL_SPDIFRX_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef  void (*pSPDIFRX_CallbackTypeDef)(SPDIFRX_HandleTypeDef * const hspdif);  /*!< pointer to an SPDIFRX callback
                                                                                function */
#endif /* USE_HAL_SPDIFRX_REGISTER_CALLBACKS */
/**
  * @}
...
/** @defgroup SPDIFRX_ErrorCode SPDIFRX Error Code
  * @{
  */
#define HAL_SPDIFRX_ERROR_NONE      ((uint32_t)0x00000000UL)  /*!< No error           */
#define HAL_SPDIFRX_ERROR_TIMEOUT   ((uint32_t)0x00000001UL)  /*!< Timeout error      */
#define HAL_SPDIFRX_ERROR_OVR       ((uint32_t)0x00000002UL)  /*!< OVR error          */
#define HAL_SPDIFRX_ERROR_PE        ((uint32_t)0x00000004UL)  /*!< Parity error       */
#define HAL_SPDIFRX_ERROR_DMA       ((uint32_t)0x00000008UL)  /*!< DMA transfer error */
#define HAL_SPDIFRX_ERROR_UNKNOWN   ((uint32_t)0x00000010UL)  /*!< Unknown Error error */
#if (USE_HAL_SPDIFRX_REGISTER_CALLBACKS == 1U)
#define  HAL_SPDIFRX_ERROR_INVALID_CALLBACK   ((uint32_t)0x00000020UL)    /*!< Invalid Callback error  */
#endif /* USE_HAL_SPDIFRX_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup SPDIFRX_Input_Selection SPDIFRX Input Selection
  * @{
  */
#define SPDIFRX_INPUT_IN0   ((uint32_t)0x00000000UL)
#define SPDIFRX_INPUT_IN1   ((uint32_t)0x00010000UL)
#define SPDIFRX_INPUT_IN2   ((uint32_t)0x00020000UL)
#define SPDIFRX_INPUT_IN3   ((uint32_t)0x00030000UL)
/**
  * @}
  */
...
/** @defgroup SPDIFRX_Max_Retries SPDIFRX Maximum Retries
  * @{
  */
#define SPDIFRX_MAXRETRIES_NONE   ((uint32_t)0x00000000UL)
#define SPDIFRX_MAXRETRIES_3      ((uint32_t)0x00001000UL)
#define SPDIFRX_MAXRETRIES_15     ((uint32_t)0x00002000UL)
#define SPDIFRX_MAXRETRIES_63     ((uint32_t)0x00003000UL)
/**
  * @}
  */
...
/** @defgroup SPDIFRX_Wait_For_Activity SPDIFRX Wait For Activity
  * @{
  */
#define SPDIFRX_WAITFORACTIVITY_OFF   ((uint32_t)0x00000000UL)
...
/** @defgroup SPDIFRX_PT_Mask SPDIFRX Preamble Type Mask
  * @{
  */
#define SPDIFRX_PREAMBLETYPEMASK_OFF    ((uint32_t)0x00000000UL)
...
/** @defgroup SPDIFRX_ChannelStatus_Mask  SPDIFRX Channel Status Mask
  * @{
  */
#define SPDIFRX_CHANNELSTATUS_OFF   ((uint32_t)0x00000000UL)       /* The channel status and user bits are copied
                                                                     into the SPDIF_DR */
...
/** @defgroup SPDIFRX_V_Mask SPDIFRX Validity Mask
  * @{
  */
#define SPDIFRX_VALIDITYMASK_OFF    ((uint32_t)0x00000000UL)
...
/** @defgroup SPDIFRX_PE_Mask  SPDIFRX Parity Error Mask
  * @{
  */
#define SPDIFRX_PARITYERRORMASK_OFF   ((uint32_t)0x00000000UL)
...
/** @defgroup SPDIFRX_Channel_Selection  SPDIFRX Channel Selection
  * @{
  */
#define SPDIFRX_CHANNEL_A   ((uint32_t)0x00000000UL)
...
/** @defgroup SPDIFRX_Data_Format SPDIFRX Data Format
  * @{
  */
#define SPDIFRX_DATAFORMAT_LSB      ((uint32_t)0x00000000UL)
#define SPDIFRX_DATAFORMAT_MSB      ((uint32_t)0x00000010UL)
#define SPDIFRX_DATAFORMAT_32BITS   ((uint32_t)0x00000020UL)
/**
  * @}
  */
...
/** @defgroup SPDIFRX_Stereo_Mode SPDIFRX Stereo Mode
  * @{
  */
#define SPDIFRX_STEREOMODE_DISABLE    ((uint32_t)0x00000000UL)
...
#define SPDIFRX_STATE_IDLE    ((uint32_t)0xFFFFFFFCUL)
#define SPDIFRX_STATE_SYNC    ((uint32_t)0x00000001UL)
...
HAL_StatusTypeDef HAL_SPDIFRX_Init(SPDIFRX_HandleTypeDef * const hspdif);
HAL_StatusTypeDef HAL_SPDIFRX_DeInit(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_MspInit(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_MspDeInit(SPDIFRX_HandleTypeDef * const hspdif);
HAL_StatusTypeDef HAL_SPDIFRX_SetDataFormat(SPDIFRX_HandleTypeDef * const hspdif, SPDIFRX_SetDataFormatTypeDef  sDataFormat);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_SPDIFRX_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_SPDIFRX_RegisterCallback(SPDIFRX_HandleTypeDef * const hspdif, HAL_SPDIFRX_CallbackIDTypeDef CallbackID,
                                               pSPDIFRX_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_SPDIFRX_UnRegisterCallback(SPDIFRX_HandleTypeDef * const hspdif,
...
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveDataFlow(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size,
                                              uint32_t Timeout);
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveControlFlow(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size,
                                                 uint32_t Timeout);

/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveControlFlow_IT(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveDataFlow_IT(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size);
void HAL_SPDIFRX_IRQHandler(SPDIFRX_HandleTypeDef * const hspdif);

/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveControlFlow_DMA(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SPDIFRX_ReceiveDataFlow_DMA(SPDIFRX_HandleTypeDef * const hspdif, uint32_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SPDIFRX_DMAStop(SPDIFRX_HandleTypeDef * const hspdif);

/* Callbacks used in non blocking modes (Interrupt and DMA) *******************/
void HAL_SPDIFRX_RxHalfCpltCallback(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_RxCpltCallback(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_ErrorCallback(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_CxHalfCpltCallback(SPDIFRX_HandleTypeDef * const hspdif);
void HAL_SPDIFRX_CxCpltCallback(SPDIFRX_HandleTypeDef * const hspdif);
/**
  * @}
  */
