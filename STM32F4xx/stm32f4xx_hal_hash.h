...
#endif /* (USE_HAL_HASH_REGISTER_CALLBACKS) */
{
  ...
  uint8_t const              *pHashKeyBuffPtr; /*!< Pointer to key buffer (HMAC only) */
...
#if (USE_HAL_HASH_REGISTER_CALLBACKS == 1U)
  void (* InCpltCallback)(struct __HASH_HandleTypeDef * const hhash);         /*!< HASH input completion callback */

  void (* DgstCpltCallback)(struct __HASH_HandleTypeDef * const hhash);       /*!< HASH digest computation completion callback */

  void (* ErrorCallback)(struct __HASH_HandleTypeDef * const hhash);          /*!< HASH error callback */

  void (* MspInitCallback)(struct __HASH_HandleTypeDef * const hhash);        /*!< HASH Msp Init callback */

  void (* MspDeInitCallback)(struct __HASH_HandleTypeDef * const hhash);      /*!< HASH Msp DeInit callback */
...
/**
  ...
  */
typedef  void (*pHASH_CallbackTypeDef)(HASH_HandleTypeDef * const hhash);  /*!< pointer to a HASH common callback functions */
#endif /* USE_HAL_HASH_REGISTER_CALLBACKS */
...
/** @defgroup HASH_Algo_Selection   HASH algorithm selection
  * @{
  */
#define HASH_ALGOSELECTION_SHA1      0x00000000UL /*!< HASH function is SHA1   */
...
/** @defgroup HASH_Algorithm_Mode   HASH algorithm mode
  * @{
  */
#define HASH_ALGOMODE_HASH         0x00000000UL /*!< Algorithm is HASH */
...
/** @defgroup HASH_Data_Type      HASH input data type
  * @{
  */
#define HASH_DATATYPE_32B          0x00000000UL /*!< 32-bit data. No swapping                     */
...
/** @defgroup HASH_HMAC_Long_key_only_for_HMAC_mode   HMAC key length type
  * @{
  */
#define HASH_HMAC_KEYTYPE_SHORTKEY      0x00000000UL /*!< HMAC Key size is <= 64 bytes */
...
/** @defgroup HASH_Error_Definition   HASH Error Definition
  * @{
  */
#define  HAL_HASH_ERROR_NONE             0x00000000UL   /*!< No error                */
#define  HAL_HASH_ERROR_IT               0x00000001UL   /*!< IT-based process error  */
#define  HAL_HASH_ERROR_DMA              0x00000002UL   /*!< DMA-based process error */
#if (USE_HAL_HASH_REGISTER_CALLBACKS == 1U)
#define  HAL_HASH_ERROR_INVALID_CALLBACK 0x00000004UL   /*!< Invalid Callback error  */
#endif /* USE_HAL_HASH_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_HASH_Init(HASH_HandleTypeDef * const hhash);
HAL_StatusTypeDef HAL_HASH_DeInit(HASH_HandleTypeDef * const hhash);
void HAL_HASH_MspInit(HASH_HandleTypeDef * const hhash);
void HAL_HASH_MspDeInit(HASH_HandleTypeDef * const hhash);
void HAL_HASH_InCpltCallback(HASH_HandleTypeDef * const hhash);
void HAL_HASH_DgstCpltCallback(HASH_HandleTypeDef * const hhash);
void HAL_HASH_ErrorCallback(HASH_HandleTypeDef * const hhash);
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_HASH_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_HASH_RegisterCallback(HASH_HandleTypeDef * const hhash, HAL_HASH_CallbackIDTypeDef CallbackID,
                                            pHASH_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_HASH_UnRegisterCallback(HASH_HandleTypeDef * const hhash, HAL_HASH_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_HASH_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_HASH_SHA1_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                      uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_MD5_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                     uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_MD5_Accmlt(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_SHA1_Accmlt(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_MD5_Accmlt_End(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                          uint8_t * const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_SHA1_Accmlt_End(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                           uint8_t * const pOutBuffer, uint32_t Timeout);
...
HAL_StatusTypeDef HAL_HASH_SHA1_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                         uint8_t * const pOutBuffer);
HAL_StatusTypeDef HAL_HASH_SHA1_Accmlt_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_SHA1_Accmlt_End_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                              uint8_t * const pOutBuffer);
HAL_StatusTypeDef HAL_HASH_MD5_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                        uint8_t * const pOutBuffer);
HAL_StatusTypeDef HAL_HASH_MD5_Accmlt_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_MD5_Accmlt_End_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                             uint8_t * const pOutBuffer);
void HAL_HASH_IRQHandler(HASH_HandleTypeDef * const hhash);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_HASH_SHA1_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_SHA1_Finish(HASH_HandleTypeDef * const hhash, uint8_t * const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_MD5_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_MD5_Finish(HASH_HandleTypeDef * const hhash, uint8_t * const pOutBuffer, uint32_t Timeout);
...
HAL_StatusTypeDef HAL_HMAC_SHA1_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                      uint32_t Timeout);
HAL_StatusTypeDef HAL_HMAC_MD5_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                     uint32_t Timeout);
...
HAL_StatusTypeDef HAL_HMAC_MD5_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                        uint8_t * const pOutBuffer);
HAL_StatusTypeDef HAL_HMAC_SHA1_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size,
                                         uint8_t * const pOutBuffer);
...
HAL_StatusTypeDef HAL_HMAC_SHA1_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HMAC_MD5_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size);
...
HAL_HASH_StateTypeDef HAL_HASH_GetState(HASH_HandleTypeDef const * const hhash);
HAL_StatusTypeDef HAL_HASH_GetStatus(HASH_HandleTypeDef const * const hhash);
void HAL_HASH_ContextSaving(HASH_HandleTypeDef * const hhash, uint8_t * const pMemBuffer);
void HAL_HASH_ContextRestoring(HASH_HandleTypeDef * const hhash, uint8_t const * const pMemBuffer);
void HAL_HASH_SwFeed_ProcessSuspend(HASH_HandleTypeDef * const hhash);
HAL_StatusTypeDef HAL_HASH_DMAFeed_ProcessSuspend(HASH_HandleTypeDef * const hhash);
uint32_t HAL_HASH_GetError(HASH_HandleTypeDef const * const hhash);
...
/* Private functions */
HAL_StatusTypeDef HASH_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                             uint32_t Timeout, uint32_t Algorithm);
HAL_StatusTypeDef HASH_Accumulate(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint32_t Algorithm);
HAL_StatusTypeDef HASH_Accumulate_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint32_t Algorithm);
HAL_StatusTypeDef HASH_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                uint32_t Algorithm);
HAL_StatusTypeDef HASH_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint32_t Algorithm);
HAL_StatusTypeDef HASH_Finish(HASH_HandleTypeDef * const hhash, uint8_t * const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HMAC_Start(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                             uint32_t Timeout, uint32_t Algorithm);
HAL_StatusTypeDef HMAC_Start_IT(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint8_t * const pOutBuffer,
                                uint32_t Algorithm);
HAL_StatusTypeDef HMAC_Start_DMA(HASH_HandleTypeDef * const hhash, uint8_t const * const pInBuffer, uint32_t Size, uint32_t Algorithm);
