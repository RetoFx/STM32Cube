...
HAL_StatusTypeDef FMC_NAND_DeInit(FMC_NAND_TypeDef * const Device, uint32_t Bank)
{
  ...
  /* Set the FMC_NAND_BANK3 registers to their reset values */
  WRITE_REG(Device->PCR,  0x00000018UL);
  WRITE_REG(Device->SR,   0x00000040UL);
  WRITE_REG(Device->PMEM, 0xFCFCFCFCUL);
  WRITE_REG(Device->PATT, 0xFCFCFCFCUL);
#endif
...
HAL_StatusTypeDef FMC_SDRAM_DeInit(FMC_SDRAM_TypeDef * const Device, uint32_t Bank)
{
  ...
  Device->SDCR[Bank] = 0x000002D0UL;
  Device->SDTR[Bank] = 0x0FFFFFFFUL;
  Device->SDCMR      = 0x00000000UL;
  Device->SDRTR      = 0x00000000UL;
  Device->SDSR       = 0x00000000UL;
