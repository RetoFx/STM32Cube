...
typedef struct
{
  ...
  uint8_t Reserved;                /*!< Reserved 0xFFU */
} LTDC_ColorTypeDef;
...
typedef struct
{
  ...
  uint32_t            HorizontalSync;            /*!< configures the number of Horizontal synchronization width.
                                                      ...
                                                      Min_Data = 0x000U and Max_Data = 0xFFFU. */

  uint32_t            VerticalSync;              /*!< configures the number of Vertical synchronization height.
                                                      This parameter must be a number between
                                                      Min_Data = 0x000U and Max_Data = 0x7FFU. */

  uint32_t            AccumulatedHBP;            /*!< configures the accumulated horizontal back porch width.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_HorizontalSync and Max_Data = 0xFFFU. */

  uint32_t            AccumulatedVBP;            /*!< configures the accumulated vertical back porch height.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_VerticalSync and Max_Data = 0x7FFU. */

  uint32_t            AccumulatedActiveW;        /*!< configures the accumulated active width.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_AccumulatedHBP and Max_Data = 0xFFFU. */

  uint32_t            AccumulatedActiveH;        /*!< configures the accumulated active height.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_AccumulatedVBP and Max_Data = 0x7FFU. */

  uint32_t            TotalWidth;                /*!< configures the total width.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_AccumulatedActiveW and Max_Data = 0xFFFU. */

  uint32_t            TotalHeigh;                /*!< configures the total height.
                                                      This parameter must be a number between
                                                      Min_Data = LTDC_AccumulatedActiveH and Max_Data = 0x7FFU. */
...
typedef struct
{
  ...
  uint32_t WindowY1;                   /*!< Configures the Window vertical Stop Position.
                                            This parameter must be a number between
                                            Min_Data = 0x0000U and Max_Data = 0x7FFU. */
  ...
  uint32_t Alpha;                      /*!< Specifies the constant alpha used for blending.
                                            This parameter must be a number between
                                            Min_Data = 0x00U and Max_Data = 0xFFU. */
  ...
  uint32_t ImageWidth;                 /*!< Configures the color frame buffer line length.
                                            This parameter must be a number between
                                            Min_Data = 0x0000U and Max_Data = 0x1FFFU. */
...
/**
  ...
  */
#if (USE_HAL_LTDC_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_LTDC_REGISTER_CALLBACKS == 1U)
  void (* LineEventCallback)(struct __LTDC_HandleTypeDef * const hltdc);     /*!< LTDC Line Event Callback    */
  void (* ReloadEventCallback)(struct __LTDC_HandleTypeDef * const hltdc);   /*!< LTDC Reload Event Callback  */
  void (* ErrorCallback)(struct __LTDC_HandleTypeDef * const hltdc);         /*!< LTDC Error Callback         */

  void (* MspInitCallback)(struct __LTDC_HandleTypeDef * const hltdc);       /*!< LTDC Msp Init callback      */
  void (* MspDeInitCallback)(struct __LTDC_HandleTypeDef * const hltdc);     /*!< LTDC Msp DeInit callback    */
...
/**
  ...
  */
typedef  void (*pLTDC_CallbackTypeDef)(LTDC_HandleTypeDef * const hltdc);  /*!< pointer to an LTDC callback function */
...
/** @defgroup LTDC_Error_Code LTDC Error Code
  * @{
  */
#define HAL_LTDC_ERROR_NONE               0x00000000UL   /*!< LTDC No error             */
#define HAL_LTDC_ERROR_TE                 0x00000001UL   /*!< LTDC Transfer error       */
#define HAL_LTDC_ERROR_FU                 0x00000002UL   /*!< LTDC FIFO Underrun        */
#define HAL_LTDC_ERROR_TIMEOUT            0x00000020UL   /*!< LTDC Timeout error        */
#if (USE_HAL_LTDC_REGISTER_CALLBACKS == 1U)
#define  HAL_LTDC_ERROR_INVALID_CALLBACK  0x00000040UL   /*!< LTDC Invalid Callback error  */
#endif /* USE_HAL_LTDC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup LTDC_Layer LTDC Layer
  * @{
  */
#define LTDC_LAYER_1                      0x00000000UL   /*!< LTDC Layer 1 */
#define LTDC_LAYER_2                      0x00000001UL   /*!< LTDC Layer 2 */
/**
  * @}
  */
...
/** @defgroup LTDC_HS_POLARITY LTDC HS POLARITY
  * @{
  */
#define LTDC_HSPOLARITY_AL                0x00000000UL   /*!< Horizontal Synchronization is active low. */
...
/** @defgroup LTDC_VS_POLARITY LTDC VS POLARITY
  * @{
  */
#define LTDC_VSPOLARITY_AL                0x00000000UL   /*!< Vertical Synchronization is active low. */
...
/** @defgroup LTDC_DE_POLARITY LTDC DE POLARITY
  * @{
  */
#define LTDC_DEPOLARITY_AL                0x00000000UL   /*!< Data Enable, is active low. */
...
/** @defgroup LTDC_PC_POLARITY LTDC PC POLARITY
  * @{
  */
#define LTDC_PCPOLARITY_IPC               0x00000000UL   /*!< input pixel clock. */
...
/** @defgroup LTDC_BACK_COLOR LTDC BACK COLOR
  * @{
  */
#define LTDC_COLOR                        0x000000FFUL   /*!< Color mask */
/**
  * @}
  */
...
/** @defgroup LTDC_BlendingFactor1 LTDC Blending Factor1
  * @{
  */
#define LTDC_BLENDING_FACTOR1_CA          0x00000400UL   /*!< Blending factor : Cte Alpha */
#define LTDC_BLENDING_FACTOR1_PAxCA       0x00000600UL   /*!< Blending factor : Cte Alpha x Pixel Alpha*/
/**
  * @}
  */
...
/** @defgroup LTDC_BlendingFactor2 LTDC Blending Factor2
  * @{
  */
#define LTDC_BLENDING_FACTOR2_CA          0x00000005UL   /*!< Blending factor : Cte Alpha */
#define LTDC_BLENDING_FACTOR2_PAxCA       0x00000007UL   /*!< Blending factor : Cte Alpha x Pixel Alpha*/
/**
  * @}
  */
...
/** @defgroup LTDC_Pixelformat LTDC Pixel format
  * @{
  */
#define LTDC_PIXEL_FORMAT_ARGB8888        0x00000000UL   /*!< ARGB8888 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_RGB888          0x00000001UL   /*!< RGB888 LTDC pixel format               */
#define LTDC_PIXEL_FORMAT_RGB565          0x00000002UL   /*!< RGB565 LTDC pixel format               */
#define LTDC_PIXEL_FORMAT_ARGB1555        0x00000003UL   /*!< ARGB1555 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_ARGB4444        0x00000004UL   /*!< ARGB4444 LTDC pixel format             */
#define LTDC_PIXEL_FORMAT_L8              0x00000005UL   /*!< L8 LTDC pixel format                   */
#define LTDC_PIXEL_FORMAT_AL44            0x00000006UL   /*!< AL44 LTDC pixel format                 */
#define LTDC_PIXEL_FORMAT_AL88            0x00000007UL   /*!< AL88 LTDC pixel format                 */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_LTDC_Init(LTDC_HandleTypeDef * const hltdc);
HAL_StatusTypeDef HAL_LTDC_DeInit(LTDC_HandleTypeDef * const hltdc);
void HAL_LTDC_MspInit(LTDC_HandleTypeDef * const hltdc);
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef * const hltdc);
void HAL_LTDC_ErrorCallback(LTDC_HandleTypeDef * const hltdc);
void HAL_LTDC_LineEventCallback(LTDC_HandleTypeDef * const hltdc);
void HAL_LTDC_ReloadEventCallback(LTDC_HandleTypeDef * const hltdc);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_LTDC_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_LTDC_RegisterCallback(LTDC_HandleTypeDef * const hltdc, HAL_LTDC_CallbackIDTypeDef CallbackID,
                                            pLTDC_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_LTDC_UnRegisterCallback(LTDC_HandleTypeDef * const hltdc, HAL_LTDC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_LTDC_REGISTER_CALLBACKS */
...
void  HAL_LTDC_IRQHandler(LTDC_HandleTypeDef * const hltdc);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_LTDC_ConfigLayer(LTDC_HandleTypeDef * const hltdc, LTDC_LayerCfgTypeDef const * const pLayerCfg, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetWindowSize(LTDC_HandleTypeDef * const hltdc, uint32_t XSize, uint32_t YSize, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetWindowPosition(LTDC_HandleTypeDef * const hltdc, uint32_t X0, uint32_t Y0, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetPixelFormat(LTDC_HandleTypeDef * const hltdc, uint32_t Pixelformat, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetAlpha(LTDC_HandleTypeDef * const hltdc, uint32_t Alpha, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetAddress(LTDC_HandleTypeDef * const hltdc, uint32_t Address, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetPitch(LTDC_HandleTypeDef * const hltdc, uint32_t LinePitchInPixels, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_ConfigColorKeying(LTDC_HandleTypeDef * const hltdc, uint32_t RGBValue, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_ConfigCLUT(LTDC_HandleTypeDef * const hltdc, uint32_t const * const pCLUT, uint32_t CLUTSize, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_EnableColorKeying(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_DisableColorKeying(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_EnableCLUT(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_DisableCLUT(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_ProgramLineEvent(LTDC_HandleTypeDef * const hltdc, uint32_t Line);
HAL_StatusTypeDef HAL_LTDC_EnableDither(LTDC_HandleTypeDef * const hltdc);
HAL_StatusTypeDef HAL_LTDC_DisableDither(LTDC_HandleTypeDef * const hltdc);
HAL_StatusTypeDef HAL_LTDC_Reload(LTDC_HandleTypeDef * const hltdc, uint32_t ReloadType);
HAL_StatusTypeDef HAL_LTDC_ConfigLayer_NoReload(LTDC_HandleTypeDef * const hltdc, LTDC_LayerCfgTypeDef const * const pLayerCfg,
                                                uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetWindowSize_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t XSize, uint32_t YSize,
                                                  uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetWindowPosition_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t X0, uint32_t Y0,
                                                      uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetPixelFormat_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t Pixelformat, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetAlpha_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t Alpha, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetAddress_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t Address, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_SetPitch_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t LinePitchInPixels, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_ConfigColorKeying_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t RGBValue, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_EnableColorKeying_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_DisableColorKeying_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_EnableCLUT_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_LTDC_DisableCLUT_NoReload(LTDC_HandleTypeDef * const hltdc, uint32_t LayerIdx);
...
HAL_LTDC_StateTypeDef HAL_LTDC_GetState(LTDC_HandleTypeDef const * const hltdc);
uint32_t              HAL_LTDC_GetError(LTDC_HandleTypeDef const * const hltdc);
/**
  * @}
  */
