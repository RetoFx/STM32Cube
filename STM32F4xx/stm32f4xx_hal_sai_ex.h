...
#define SAI_CLKSOURCE_PLLI2S             0x00000000UL
#define SAI_CLKSOURCE_EXT                0x00100000UL
#define SAI_CLKSOURCE_PLLR               0x00200000UL
#define SAI_CLKSOURCE_HS                 0x00300000UL
#else
#define SAI_CLKSOURCE_PLLSAI             0x00000000UL
#define SAI_CLKSOURCE_PLLI2S             0x00100000UL
#define SAI_CLKSOURCE_EXT                0x00200000UL
#define SAI_CLKSOURCE_NA                 0x00400000UL /*!< No applicable for STM32F446xx */
#endif
...
void SAI_BlockSynchroConfig(SAI_HandleTypeDef const * const hsai);
uint32_t SAI_GetInputClock(SAI_HandleTypeDef const * const hsai);
/**
  * @}
  */
