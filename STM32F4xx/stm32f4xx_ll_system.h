...
#define LL_SYSCFG_REMAP_SYSTEMFLASH        SYSCFG_MEMRMP_MEM_MODE_0                              /*!< System Flash memory mapped at 0x00000000UL            */
#if defined(FSMC_Bank1)
#define LL_SYSCFG_REMAP_FSMC               SYSCFG_MEMRMP_MEM_MODE_1                              /*!< FSMC(NOR/PSRAM 1 and 2) mapped at 0x00000000UL        */
#endif /* FSMC_Bank1 */
#if defined(FMC_Bank1)
#define LL_SYSCFG_REMAP_FMC                SYSCFG_MEMRMP_MEM_MODE_1                              /*!< FMC(NOR/PSRAM 1 and 2) mapped at 0x00000000UL         */
#define LL_SYSCFG_REMAP_SDRAM              SYSCFG_MEMRMP_MEM_MODE_2                              /*!< FMC/SDRAM mapped at 0x00000000UL                      */
#endif /* FMC_Bank1 */
#define LL_SYSCFG_REMAP_SRAM               (SYSCFG_MEMRMP_MEM_MODE_1 | SYSCFG_MEMRMP_MEM_MODE_0) /*!< SRAM1 mapped at 0x00000000UL                          */
...
* @{
*/
#define LL_SYSCFG_PMC_ETHMII               ((uint32_t)0x00000000UL)                                /*!< ETH Media MII interface */
...
/** @defgroup SYSTEM_LL_EC_BANKMODE SYSCFG BANK MODE
  * @{
  */
#define LL_SYSCFG_BANKMODE_BANK1          ((uint32_t)0x00000000UL)       /*!< Flash Bank 1 base address mapped at 0x0800U 0000 (AXI) and 0x0020U 0000 (TCM)
                                                                      and Flash Bank 2 base address mapped at 0x0810U 0000 (AXI) and 0x0030U 0000 (TCM)*/
#define LL_SYSCFG_BANKMODE_BANK2          SYSCFG_MEMRMP_UFB_MODE     /*!< Flash Bank 2 base address mapped at 0x0800U 0000 (AXI) and 0x0020U 0000(TCM)
                                                                      and Flash Bank 1 base address mapped at 0x0810U 0000 (AXI) and 0x0030U 0000(TCM) */
/**
  * @}
  */
...
#if defined(GPIOI)
#define LL_SYSCFG_EXTI_PORTI               ((uint32_t)8U)               /*!< EXTI PORT I                        */
#endif /* GPIOI */
#if defined(GPIOJ)
#define LL_SYSCFG_EXTI_PORTJ               (uint32_t)9U               /*!< EXTI PORT J                        */
#endif /* GPIOJ */
#if defined(GPIOK)
#define LL_SYSCFG_EXTI_PORTK               (uint32_t)10U              /*!< EXTI PORT k                        */
#endif /* GPIOK */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_EXTI_LINE SYSCFG EXTI LINE
  * @{
  */
#define LL_SYSCFG_EXTI_LINE0               (uint32_t)(0x000FUL << 16U | 0)  /*!< EXTI_POSITION_0  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE1               (uint32_t)(0x00F0UL << 16U | 0)  /*!< EXTI_POSITION_4  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE2               (uint32_t)(0x0F00UL << 16U | 0)  /*!< EXTI_POSITION_8  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE3               (uint32_t)(0xF000UL << 16U | 0)  /*!< EXTI_POSITION_12 | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE4               (uint32_t)(0x000FUL << 16U | 1)  /*!< EXTI_POSITION_0  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE5               (uint32_t)(0x00F0UL << 16U | 1)  /*!< EXTI_POSITION_4  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE6               (uint32_t)(0x0F00UL << 16U | 1)  /*!< EXTI_POSITION_8  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE7               (uint32_t)(0xF000UL << 16U | 1)  /*!< EXTI_POSITION_12 | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE8               (uint32_t)(0x000FUL << 16U | 2)  /*!< EXTI_POSITION_0  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE9               (uint32_t)(0x00F0UL << 16U | 2)  /*!< EXTI_POSITION_4  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE10              (uint32_t)(0x0F00UL << 16U | 2)  /*!< EXTI_POSITION_8  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE11              (uint32_t)(0xF000UL << 16U | 2)  /*!< EXTI_POSITION_12 | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE12              (uint32_t)(0x000FUL << 16U | 3)  /*!< EXTI_POSITION_0  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE13              (uint32_t)(0x00F0UL << 16U | 3)  /*!< EXTI_POSITION_4  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE14              (uint32_t)(0x0F00UL << 16U | 3)  /*!< EXTI_POSITION_8  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE15              (uint32_t)(0xF000UL << 16U | 3)  /*!< EXTI_POSITION_12 | EXTICR[3U] */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_DFSDM_BitStream_ClockSource SYSCFG MCHDLY BCKKSEL
  * @{
  */
#define LL_SYSCFG_BITSTREAM_CLOCK_TIM2OC1          (uint32_t)0x00000000UL
...
#define LL_SYSCFG_DFSDM1_DataIn0_PAD               (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D0SEL << 16U) | 0x00000000UL)
#define LL_SYSCFG_DFSDM1_DataIn0_DM                (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D0SEL << 16U) | SYSCFG_MCHDLYCR_DFSDM1D0SEL)
#define LL_SYSCFG_DFSDM2_DataIn0_PAD               (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D0SEL << 16U) | 0x00000000UL)
#define LL_SYSCFG_DFSDM2_DataIn0_DM                (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D0SEL << 16U) | SYSCFG_MCHDLYCR_DFSDM2D0SEL)
/**
  * @}
  */
...
#define LL_SYSCFG_DFSDM1_DataIn2_PAD               (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D2SEL << 16U) | 0x00000000UL)
#define LL_SYSCFG_DFSDM1_DataIn2_DM                (uint32_t)((SYSCFG_MCHDLYCR_DFSDM1D2SEL << 16U) | SYSCFG_MCHDLYCR_DFSDM1D2SEL)
#define LL_SYSCFG_DFSDM2_DataIn2_PAD               (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D2SEL << 16U) | 0x00000000UL)
#define LL_SYSCFG_DFSDM2_DataIn2_DM                (uint32_t)((SYSCFG_MCHDLYCR_DFSDM2D2SEL << 16U) | SYSCFG_MCHDLYCR_DFSDM2D2SEL)
/**
  * @}
  */
/** @defgroup SYSTEM_LL_DFSDM1_TIM4OC2_BitstreamDistribution  SYSCFG MCHDLY DFSDM1CK02SEL
  * @{
  */
#define LL_SYSCFG_DFSDM1_TIM4OC2_CLKIN0           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM1_TIM4OC1_BitstreamDistribution  SYSCFG MCHDLY DFSDM1CK13SEL
  * @{
  */
#define LL_SYSCFG_DFSDM1_TIM4OC1_CLKIN1           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM1_CLKIN_SourceSelection SYSCFG MCHDLY DFSDMCFG
  * @{
  */
#define LL_SYSCFG_DFSDM1_CKIN_PAD                 (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM1_CLKOUT_SourceSelection SYSCFG MCHDLY DFSDM1CKOSEL
  * @{
  */
#define LL_SYSCFG_DFSDM1_CKOUT                    (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_DataIn4_SourceSelection SYSCFG MCHDLY DFSDM2D4SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_DataIn4_PAD              (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_DataIn6_SourceSelection SYSCFG MCHDLY DFSDM2D6SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_DataIn6_PAD              (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC4_BitstreamDistribution  SYSCFG MCHDLY DFSDM2CK04SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_TIM3OC4_CLKIN0           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC3_BitstreamDistribution  SYSCFG MCHDLY DFSDM2CK15SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_TIM3OC3_CLKIN1           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC2_BitstreamDistribution  SYSCFG MCHDLY DFSDM2CK26SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_TIM3OC2_CLKIN2           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_TIM3OC1_BitstreamDistribution  SYSCFG MCHDLY DFSDM2CK37SEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_TIM3OC1_CLKIN3           (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_CLKIN_SourceSelection SYSCFG MCHDLY DFSDM2CFG
  * @{
  */
#define LL_SYSCFG_DFSDM2_CKIN_PAD                 (uint32_t)0x00000000UL
...
/** @defgroup SYSTEM_LL_DFSDM2_CLKOUT_SourceSelection SYSCFG MCHDLY DFSDM2CKOSEL
  * @{
  */
#define LL_SYSCFG_DFSDM2_CKOUT                    (uint32_t)0x00000000UL
...
/**
  ...
  * @note   SDRAM is accessible at 0x60000000UL and NOR/RAM
  *         is accessible at 0xC0000000UL
  * @retval None
  */
...
/**
  ...
  * @note   SDRAM is accessible at 0xC0000000UL (default mapping)
  *         and NOR/RAM is accessible at 0x60000000UL (default mapping)
  * @retval None
  */
...
#if defined(SYSCFG_MEMRMP_UFB_MODE)
/**
  * @brief  Select Flash bank mode (Bank flashed at 0x08000000UL)
...
/**
  * @brief  Get Flash bank mode (Bank flashed at 0x08000000UL)
...
{
  MODIFY_REG(SYSCFG->MCHDLYCR, (Source >> 16U), (Source & 0x0000FFFFUL));
}
/**
...
/**
  ...
  * @note For STM32F405/407xx and STM32F415/417xx devices, the device ID is 0x413U
  * @note For STM32F42xxx and STM32F43xxx devices, the device ID is 0x419U
  * @note For STM32F401xx devices, the device ID is 0x423U
  * @note For STM32F401xx devices, the device ID is 0x433U
  * @note For STM32F411xx devices, the device ID is 0x431U
  * @note For STM32F410xx devices, the device ID is 0x458U
  * @note For STM32F412xx devices, the device ID is 0x441U
  * @note For STM32F413xx and STM32423xx devices, the device ID is 0x463U
  * @note For STM32F446xx devices, the device ID is 0x421U
  * @note For STM32F469xx and STM32F479xx devices, the device ID is 0x434U
...
/**
  ...
  * @note This field indicates the revision of the device.
          For example, it is read as RevA -> 0x1000U, Cat 2 revZ -> 0x1001U, rev1 -> 0x1003U, rev2 ->0x1007U, revY -> 0x100FU for STM32F405/407xx and STM32F415/417xx devices
          For example, it is read as RevA -> 0x1000U, Cat 2 revY -> 0x1003U, rev1 -> 0x1007U, rev3 ->0x2001U for STM32F42xxx and STM32F43xxx devices
          For example, it is read as RevZ -> 0x1000U, Cat 2 revA -> 0x1001U for STM32F401xB/C devices
          For example, it is read as RevA -> 0x1000U, Cat 2 revZ -> 0x1001U for STM32F401xD/E devices
          For example, it is read as RevA -> 0x1000U for STM32F411xx,STM32F413/423xx,STM32F469/423xx, STM32F446xx and STM32F410xx devices
          For example, it is read as RevZ -> 0x1001U, Cat 2 revB -> 0x2000U, revC -> 0x3000U for STM32F412xx devices
