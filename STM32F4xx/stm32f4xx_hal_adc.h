...
#define HAL_ADC_STATE_AWD2              0x00020000UL    /*!< Not available on STM32F4 device: Out-of-window occurrence of analog watchdog 2 */
#define HAL_ADC_STATE_AWD3              0x00040000UL    /*!< Not available on STM32F4 device: Out-of-window occurrence of analog watchdog 3 */

/* States of ADC multi-mode */
#define HAL_ADC_STATE_MULTIMODE_SLAVE   0x00100000UL    /*!< Not available on STM32F4 device: ADC in multimode slave state, controlled by another ADC master ( */
...
#endif
{
  ...
  void (* InjectedConvCpltCallback)(struct __ADC_HandleTypeDef * const hadc);      /*!< ADC group injected conversion complete callback */
...
/** @defgroup ADC_ClockPrescaler  ADC Clock Prescaler
  * @{
  */
#define ADC_CLOCK_SYNC_PCLK_DIV2    0x00000000UL
...
/** @defgroup ADC_delay_between_2_sampling_phases ADC Delay Between 2 Sampling Phases
  * @{
  */
#define ADC_TWOSAMPLINGDELAY_5CYCLES    0x00000000UL
...
/** @defgroup ADC_Resolution ADC Resolution
  * @{
  */
#define ADC_RESOLUTION_12B  0x00000000UL
...
#define ADC_EXTERNALTRIGCONV_T1_CC1    0x00000000UL
...
/** @defgroup ADC_sampling_times  ADC Sampling Times
  * @{
  */
#define ADC_SAMPLETIME_3CYCLES    0x00000000UL
...
#define ADC_EOC_SINGLE_CONV           0x00000001UL
#define ADC_EOC_SINGLE_SEQ_CONV       0x00000002UL  /*!< reserved for future use */
/**
  * @}
  */
...
/** @defgroup ADC_channels_type ADC Channels Type
  * @{
  */
#define ADC_ALL_CHANNELS      0x00000001UL
#define ADC_REGULAR_CHANNELS  0x00000002UL /*!< reserved for future use */
#define ADC_INJECTED_CHANNELS 0x00000003UL /*!< reserved for future use */
/**
  * @}
  */
