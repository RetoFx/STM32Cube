...
/** @defgroup FLASH_Error_Code FLASH Error Code
  ...
  * @{
  */
#define HAL_FLASH_ERROR_NONE         0x00000000UL    /*!< No error                      */
#define HAL_FLASH_ERROR_RD           0x00000001UL    /*!< Read Protection error         */
#define HAL_FLASH_ERROR_PGS          0x00000002UL    /*!< Programming Sequence error    */
#define HAL_FLASH_ERROR_PGP          0x00000004UL    /*!< Programming Parallelism error */
#define HAL_FLASH_ERROR_PGA          0x00000008UL    /*!< Programming Alignment error   */
#define HAL_FLASH_ERROR_WRP          0x00000010UL    /*!< Write protection error        */
#define HAL_FLASH_ERROR_OPERATION    0x00000020UL    /*!< Operation Error               */
/**
  * @}
  */
...
/** @defgroup FLASH_Type_Program FLASH Type Program
  * @{
  */
#define FLASH_TYPEPROGRAM_BYTE        0x00000000UL  /*!< Program byte (8-bit) at a specified address           */
#define FLASH_TYPEPROGRAM_HALFWORD    0x00000001UL  /*!< Program a half-word (16-bit) at a specified address   */
#define FLASH_TYPEPROGRAM_WORD        0x00000002UL  /*!< Program a word (32-bit) at a specified address        */
#define FLASH_TYPEPROGRAM_DOUBLEWORD  0x00000003UL  /*!< Program a double word (64-bit) at a specified address */
/**
  * @}
  */
...
#define FLASH_IT_ERR                   0x02000000UL             /*!< Error Interrupt source                  */
/**
  * @}
  */
...
/** @defgroup FLASH_Program_Parallelism FLASH Program Parallelism
  * @{
  */
#define FLASH_PSIZE_BYTE           0x00000000UL
#define FLASH_PSIZE_HALF_WORD      0x00000100UL
#define FLASH_PSIZE_WORD           0x00000200UL
#define FLASH_PSIZE_DOUBLE_WORD    0x00000300UL
#define CR_PSIZE_MASK              0xFFFFFCFFUL
/**
  * @}
  */
...
#endif
#define __HAL_FLASH_SET_LATENCY(__LATENCY__) (FLASH->ACR = (uint8_t)(__LATENCY__))
