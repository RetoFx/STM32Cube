...
/** @defgroup RTC_LL_EC_TSINSEL  TIMESTAMP mapping
  * @{
  */
#define LL_RTC_TimeStampPin_Default        0x00000000UL           /*!< Use RTC_AF1 as TIMESTAMP */
...
/** @defgroup RTC_LL_EC_TAMP1INSEL  TAMPER1 mapping
  * @{
  */
#define LL_RTC_TamperPin_Default           0x00000000UL           /*!< Use RTC_AF1 as TAMPER1 */
#if defined(RTC_AF2_SUPPORT)
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_SetPin(RTC_TypeDef * const RTCx, uint32_t TSPin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetPin(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_SetPin(RTC_TypeDef * const RTCx, uint32_t TamperPin)
{
...
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetPin(RTC_TypeDef const * const RTCx)
{
