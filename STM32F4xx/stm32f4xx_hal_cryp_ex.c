...
#define CRYP_PHASE_INIT                 0x00000000UL
#define CRYP_PHASE_HEADER               CRYP_CR_GCM_CCMPH_0
#define CRYP_PHASE_PAYLOAD              CRYP_CR_GCM_CCMPH_1
#define CRYP_PHASE_FINAL                CRYP_CR_GCM_CCMPH

#define CRYP_OPERATINGMODE_ENCRYPT      0x00000000UL
...
#define CRYP_CCM_CTR0_0            0x07FFFFFFUL
#define CRYP_CCM_CTR0_3            0xFFFFFF00UL
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AESGCM_GenerateAuthTAG(CRYP_HandleTypeDef * const hcryp, uint32_t * const AuthTag, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AESCCM_GenerateAuthTAG(CRYP_HandleTypeDef * const hcryp, uint32_t * const AuthTag, uint32_t Timeout)
{
  uint32_t tagaddr = (uint32_t)AuthTag;
  uint32_t ctr0 [4U] = {0};
  ...
  if (hcryp->State == HAL_CRYP_STATE_READY)
  {
    ...
    ctr0[0U] = (hcryp->Init.B0[0U]) & CRYP_CCM_CTR0_0;
    ctr0[1U] = hcryp->Init.B0[1U];
    ctr0[2U] = hcryp->Init.B0[2U];
    ctr0[3U] = hcryp->Init.B0[3U] &  CRYP_CCM_CTR0_3;
    ...
    *(uint32_t *)(tagaddr) = hcryp->Instance->DOUT;
    ...
    if (hcryp->Init.DataType == CRYP_DATATYPE_8B)
    {
      ctr0[0U] = (__REV(hcryp->Init.B0[0U]) & CRYP_CCM_CTR0_0);
      ctr0[1U] = __REV(hcryp->Init.B0[1U]);
      ctr0[2U] = __REV(hcryp->Init.B0[2U]);
      ctr0[3U] = (__REV(hcryp->Init.B0[3U])& CRYP_CCM_CTR0_3);
    ...
    {
      ctr0[0U] = (__ROR((hcryp->Init.B0[0U]), 16U)& CRYP_CCM_CTR0_0);
      ctr0[1U] =   __ROR((hcryp->Init.B0[1U]), 16U);
      ctr0[2U] =   __ROR((hcryp->Init.B0[2U]), 16U);
      ctr0[3U] = (__ROR((hcryp->Init.B0[3U]), 16U)& CRYP_CCM_CTR0_3);
    ...
    {
      ctr0[0U] = (__RBIT(hcryp->Init.B0[0U])& CRYP_CCM_CTR0_0);
      ctr0[1U] = __RBIT(hcryp->Init.B0[1U]);
      ctr0[2U] = __RBIT(hcryp->Init.B0[2U]);
      ctr0[3U] = (__RBIT(hcryp->Init.B0[3U])& CRYP_CCM_CTR0_3);
...
/**
  ...
  * @retval None
  */
void  HAL_CRYPEx_EnableAutoKeyDerivation(CRYP_HandleTypeDef * const hcryp)
{
  if (hcryp->State == HAL_CRYP_STATE_READY)
  {
...
/**
  ...
  * @retval None
  */
void  HAL_CRYPEx_DisableAutoKeyDerivation(CRYP_HandleTypeDef * const hcryp)
{
  if (hcryp->State == HAL_CRYP_STATE_READY)
  {
