...
#define DFSDM_MSB_MASK                  0xFFFF0000UL
#define DFSDM_LSB_MASK                  0x0000FFFFUL
...
static uint32_t DFSDM_GetChannelFromInstance(DFSDM_Channel_TypeDef const * const Instance);
static void     DFSDM_RegConvStart(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter);
static void     DFSDM_RegConvStop(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter);
static void     DFSDM_InjConvStart(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter);
static void     DFSDM_InjConvStop(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter);
static void     DFSDM_DMARegularHalfConvCplt(DMA_HandleTypeDef * const hdma);
static void     DFSDM_DMARegularConvCplt(DMA_HandleTypeDef * const hdma);
static void     DFSDM_DMAInjectedHalfConvCplt(DMA_HandleTypeDef * const hdma);
static void     DFSDM_DMAInjectedConvCplt(DMA_HandleTypeDef * const hdma);
static void     DFSDM_DMAError(DMA_HandleTypeDef * const hdma);
...
/**
  ...
  * @retval None
  */
__weak void HAL_DFSDM_ChannelMspInit(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_DFSDM_ChannelMspDeInit(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_channel);
  /* NOTE : This function should not be modified, when the function is needed,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_ChannelPollForCkab(DFSDM_Channel_HandleTypeDef const * const hdfsdm_channel,
                                               uint32_t Timeout)
{
  uint32_t tickstart;
  uint32_t channel;
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_ChannelCkabCallback)(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_channel);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_ChannelScdStart(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel,
                                            uint32_t Threshold,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_ChannelPollForScd(DFSDM_Channel_HandleTypeDef const * const hdfsdm_channel,
                                              uint32_t Timeout)
{
  uint32_t tickstart;
  uint32_t channel;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_ChannelScdStart_IT(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel,
                                               uint32_t Threshold,
                                               uint32_t BreakSignal)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_ChannelScdCallback)(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_channel);
  /* NOTE : This function should not be modified, when the callback is needed,
...
/**
  ...
  * @retval HAL status.
  */
HAL_StatusTypeDef HAL_DFSDM_ChannelModifyOffset(DFSDM_Channel_HandleTypeDef * const hdfsdm_channel,
                                                int32_t Offset)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval None
  */
__weak void HAL_DFSDM_FilterMspInit(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
...
/**
  ...
  * @retval None
  */
__weak void HAL_DFSDM_FilterMspDeInit(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the function is needed,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_FilterPollForRegConversion(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter,
                                                       uint32_t                    Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_FilterPollForInjConversion(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter,
                                                       uint32_t                    Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DFSDM_FilterExdStart(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter,
                                           uint32_t                    Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterRegConvCpltCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterRegConvHalfCpltCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterInjConvCpltCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterInjConvHalfCpltCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterAwdCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter,
...
/**
  ...
  * @retval None
  */
HAL_DFSDM_WEAK_CALLBACK(void, HAL_DFSDM_FilterErrorCallback)(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdfsdm_filter);
  /* NOTE : This function should not be modified, when the callback is needed,
...
void HAL_DFSDM_ConfigMultiChannelDelay(DFSDM_MultiChannelConfigTypeDef const * const mchdlystruct)
{
  ...
  mchdlyreg = (SYSCFG->MCHDLYCR & 0x80103UL);
...
static void DFSDM_DMARegularHalfConvCplt(DMA_HandleTypeDef * const hdma)
{
  ...
  DFSDM_Filter_HandleTypeDef * const hdfsdm_filter = (DFSDM_Filter_HandleTypeDef *) ((DMA_HandleTypeDef *)hdma)->Parent;
