...
/**
  ...
  */
#define SDMMC_OCR_ADDR_OUT_OF_RANGE                   0x80000000UL
#define SDMMC_OCR_ADDR_MISALIGNED                     0x40000000UL
#define SDMMC_OCR_BLOCK_LEN_ERR                       0x20000000UL
#define SDMMC_OCR_ERASE_SEQ_ERR                       0x10000000UL
#define SDMMC_OCR_BAD_ERASE_PARAM                     0x08000000UL
#define SDMMC_OCR_WRITE_PROT_VIOLATION                0x04000000UL
#define SDMMC_OCR_LOCK_UNLOCK_FAILED                  0x01000000UL
#define SDMMC_OCR_COM_CRC_FAILED                      0x00800000UL
#define SDMMC_OCR_ILLEGAL_CMD                         0x00400000UL
#define SDMMC_OCR_CARD_ECC_FAILED                     0x00200000UL
#define SDMMC_OCR_CC_ERROR                            0x00100000UL
#define SDMMC_OCR_GENERAL_UNKNOWN_ERROR               0x00080000UL
#define SDMMC_OCR_STREAM_READ_UNDERRUN                0x00040000UL
#define SDMMC_OCR_STREAM_WRITE_OVERRUN                0x00020000UL
#define SDMMC_OCR_CID_CSD_OVERWRITE                   0x00010000UL
#define SDMMC_OCR_WP_ERASE_SKIP                       0x00008000UL
#define SDMMC_OCR_CARD_ECC_DISABLED                   0x00004000UL
#define SDMMC_OCR_ERASE_RESET                         0x00002000UL
#define SDMMC_OCR_AKE_SEQ_ERROR                       0x00000008UL
#define SDMMC_OCR_ERRORBITS                           0xFDFFE008UL
...
#define SDMMC_VOLTAGE_WINDOW_SD                       0x80100000UL
#define SDMMC_HIGH_CAPACITY                           0x40000000UL
#define SDMMC_STD_CAPACITY                            0x00000000UL
#define SDMMC_CHECK_PATTERN                           0x000001AAUL
#define SD_SWITCH_1_8V_CAPACITY                       0x01000000UL

#define SDMMC_MAX_VOLT_TRIAL                          0x0000FFFFUL

#define SDMMC_MAX_TRIAL                               0x0000FFFFUL

#define SDMMC_ALLZERO                                 0x00000000UL

#define SDMMC_WIDE_BUS_SUPPORT                        0x00040000UL
#define SDMMC_SINGLE_BUS_SUPPORT                      0x00010000UL
#define SDMMC_CARD_LOCKED                             0x02000000UL
...
#define SDMMC_0TO7BITS                                0x000000FFUL
#define SDMMC_8TO15BITS                               0x0000FF00UL
#define SDMMC_16TO23BITS                              0x00FF0000UL
#define SDMMC_24TO31BITS                              0xFF000000UL
#define SDMMC_MAX_DATA_LENGTH                         0x01FFFFFFUL

#define SDMMC_HALFFIFO                                0x00000008UL
#define SDMMC_HALFFIFOBYTES                           0x00000020UL

/**
  * @brief  Command Class supported
  */
#define SDIO_CCCC_ERASE                       0x00000020UL

#define SDIO_CMDTIMEOUT                       5000U         /* Command send and response timeout */
#define SDIO_MAXERASETIMEOUT                  63000U        /* Max erase Timeout 63 s            */
#define SDIO_STOPTRANSFERTIMEOUT              100000000UL    /* Timeout for STOP TRANSMISSION command */

/** @defgroup SDIO_LL_Clock_Edge Clock Edge
  * @{
  */
#define SDIO_CLOCK_EDGE_RISING               0x00000000UL
...
/** @defgroup SDIO_LL_Clock_Bypass Clock Bypass
  * @{
  */
#define SDIO_CLOCK_BYPASS_DISABLE             0x00000000UL
...
/** @defgroup SDIO_LL_Clock_Power_Save Clock Power Saving
  * @{
  */
#define SDIO_CLOCK_POWER_SAVE_DISABLE         0x00000000UL
...
/** @defgroup SDIO_LL_Bus_Wide Bus Width
  * @{
  */
#define SDIO_BUS_WIDE_1B                      0x00000000UL
...
/** @defgroup SDIO_LL_Hardware_Flow_Control Hardware Flow Control
  * @{
  */
#define SDIO_HARDWARE_FLOW_CONTROL_DISABLE    0x00000000UL
...
/** @defgroup SDIO_LL_Response_Type Response Type
  * @{
  */
#define SDIO_RESPONSE_NO                    0x00000000UL
...
/** @defgroup SDIO_LL_Wait_Interrupt_State Wait Interrupt
  * @{
  */
#define SDIO_WAIT_NO                        0x00000000UL
...
/** @defgroup SDIO_LL_CPSM_State CPSM State
  * @{
  */
#define SDIO_CPSM_DISABLE                   0x00000000UL
...
/** @defgroup SDIO_LL_Response_Registers Response Register
  * @{
  */
#define SDIO_RESP1                          0x00000000UL
#define SDIO_RESP2                          0x00000004UL
#define SDIO_RESP3                          0x00000008UL
#define SDIO_RESP4                          0x0000000CUL
...
/** @defgroup SDIO_LL_Data_Length Data Length
  * @{
  */
#define IS_SDIO_DATA_LENGTH(LENGTH) ((LENGTH) <= 0x01FFFFFFUL)
/**
  * @}
  */
...
/** @defgroup SDIO_LL_Data_Block_Size  Data Block Size
  * @{
  */
#define SDIO_DATABLOCK_SIZE_1B               0x00000000UL
...
/** @defgroup SDIO_LL_Transfer_Direction Transfer Direction
  * @{
  */
#define SDIO_TRANSFER_DIR_TO_CARD            0x00000000UL
...
/** @defgroup SDIO_LL_Transfer_Type Transfer Type
  * @{
  */
#define SDIO_TRANSFER_MODE_BLOCK             0x00000000UL
...
/** @defgroup SDIO_LL_Read_Wait_Mode Read Wait Mode
  * @{
  */
#define SDIO_READ_WAIT_MODE_DATA2                0x00000000UL
...
#define CLKEN_BIT_NUMBER           0x08U
#define CLKCR_CLKEN_BB            (PERIPH_BB_BASE + (CLKCR_OFFSET * 32U) + (CLKEN_BIT_NUMBER * 4U))

/* --- CMD Register ---*/
/* Alias word address of SDIOSUSPEND bit */
#define CMD_OFFSET                (SDIO_OFFSET + 0x0CU)
#define SDIOSUSPEND_BIT_NUMBER     0x0BU
#define CMD_SDIOSUSPEND_BB        (PERIPH_BB_BASE + (CMD_OFFSET * 32U) + (SDIOSUSPEND_BIT_NUMBER * 4U))

/* Alias word address of ENCMDCOMPL bit */
#define ENCMDCOMPL_BIT_NUMBER      0x0CU
#define CMD_ENCMDCOMPL_BB         (PERIPH_BB_BASE + (CMD_OFFSET * 32U) + (ENCMDCOMPL_BIT_NUMBER * 4U))

/* Alias word address of NIEN bit */
#define NIEN_BIT_NUMBER            0x0DU
#define CMD_NIEN_BB               (PERIPH_BB_BASE + (CMD_OFFSET * 32U) + (NIEN_BIT_NUMBER * 4U))

/* Alias word address of ATACMD bit */
#define ATACMD_BIT_NUMBER          0x0EU
#define CMD_ATACMD_BB             (PERIPH_BB_BASE + (CMD_OFFSET * 32U) + (ATACMD_BIT_NUMBER * 4U))

/* --- DCTRL Register ---*/
/* Alias word address of DMAEN bit */
#define DCTRL_OFFSET              (SDIO_OFFSET + 0x2CU)
#define DMAEN_BIT_NUMBER           0x03U
#define DCTRL_DMAEN_BB            (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (DMAEN_BIT_NUMBER * 4U))

/* Alias word address of RWSTART bit */
#define RWSTART_BIT_NUMBER         0x08U
#define DCTRL_RWSTART_BB          (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (RWSTART_BIT_NUMBER * 4U))

/* Alias word address of RWSTOP bit */
#define RWSTOP_BIT_NUMBER          0x09U
#define DCTRL_RWSTOP_BB           (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (RWSTOP_BIT_NUMBER * 4U))

/* Alias word address of RWMOD bit */
#define RWMOD_BIT_NUMBER           0x0AU
#define DCTRL_RWMOD_BB            (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (RWMOD_BIT_NUMBER * 4U))

/* Alias word address of SDIOEN bit */
#define SDIOEN_BIT_NUMBER          0x0BU
#define DCTRL_SDIOEN_BB           (PERIPH_BB_BASE + (DCTRL_OFFSET * 32U) + (SDIOEN_BIT_NUMBER * 4U))
/**
  * @}
  */
...
#define SDIO_INIT_CLK_DIV     ((uint8_t)0x76U)    /* 48MHz / (SDMMC_INIT_CLK_DIV + 2) < 400KHz */

/* SDIO Data Transfer Frequency (25MHz max) */
#define SDIO_TRANSFER_CLK_DIV ((uint8_t)0x0U)     /* 48MHz / (SDMMC_TRANSFER_CLK_DIV + 2) < 25MHz */
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
#define __SDIO_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->CLKCR, CLKEN_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->CLKCR, CLKEN_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_DMA_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, DMAEN_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_DMA_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, DMAEN_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_START_READWAIT_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, RWSTART_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_START_READWAIT_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, RWSTART_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_STOP_READWAIT_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, RWSTOP_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_STOP_READWAIT_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, RWSTOP_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_OPERATION_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, SDIOEN_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_OPERATION_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->DCTRL, SDIOEN_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_SUSPEND_CMD_ENABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, SDIOSUSPEND_BIT_NUMBER, ENABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_SUSPEND_CMD_DISABLE(__INSTANCE__)  HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, SDIOSUSPEND_BIT_NUMBER, DISABLE)
...
/**
  ...
  * @retval None
  */
#define __SDIO_CEATA_CMD_COMPLETION_ENABLE()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, ENCMDCOMPL_BIT_NUMBER, ENABLE)

/**
  * @brief  Disable the command completion signal.
  * @retval None
  */
#define __SDIO_CEATA_CMD_COMPLETION_DISABLE()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, ENCMDCOMPL_BIT_NUMBER, DISABLE)

/**
  * @brief  Enable the CE-ATA interrupt.
  * @retval None
  */
#define __SDIO_CEATA_ENABLE_IT()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, NIEN_BIT_NUMBER, 0UL)

/**
  * @brief  Disable the CE-ATA interrupt.
  * @retval None
  */
#define __SDIO_CEATA_DISABLE_IT()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, NIEN_BIT_NUMBER, 1UL)

/**
  * @brief  Enable send CE-ATA command (CMD61).
  * @retval None
  */
#define __SDIO_CEATA_SENDCMD_ENABLE()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, ATACMD_BIT_NUMBER, ENABLE)

/**
  * @brief  Disable send CE-ATA command (CMD61).
  * @retval None
  */
#define __SDIO_CEATA_SENDCMD_DISABLE()   HAL_PERIPH_BIT_BAND_WRITE(SDIO->CMD, ATACMD_BIT_NUMBER, DISABLE)
...
/** @addtogroup HAL_SDMMC_LL_Group1
  * @{
  */
HAL_StatusTypeDef SDIO_Init(SDIO_TypeDef * const SDIOx, SDIO_InitTypeDef Init);
/**
  * @}
  */
...
/** @addtogroup HAL_SDMMC_LL_Group2
  * @{
  */
uint32_t          SDIO_ReadFIFO(SDIO_TypeDef * const SDIOx);
HAL_StatusTypeDef SDIO_WriteFIFO(SDIO_TypeDef * const SDIOx, uint32_t const * const pWriteData);
/**
  * @}
  */
...
/** @addtogroup HAL_SDMMC_LL_Group3
  * @{
  */
HAL_StatusTypeDef SDIO_PowerState_ON(SDIO_TypeDef * const SDIOx);
HAL_StatusTypeDef SDIO_PowerState_OFF(SDIO_TypeDef * const SDIOx);
uint32_t          SDIO_GetPowerState(SDIO_TypeDef const * const SDIOx);

/* Command path state machine (CPSM) management functions */
HAL_StatusTypeDef SDIO_SendCommand(SDIO_TypeDef * const SDIOx, SDIO_CmdInitTypeDef const * const Command);
uint8_t           SDIO_GetCommandResponse(SDIO_TypeDef const * const SDIOx);
uint32_t          SDIO_GetResponse(SDIO_TypeDef const * const SDIOx, uint32_t Response);

/* Data path state machine (DPSM) management functions */
HAL_StatusTypeDef SDIO_ConfigData(SDIO_TypeDef * const SDIOx, SDIO_DataInitTypeDef * const Data);
uint32_t          SDIO_GetDataCounter(SDIO_TypeDef const * const SDIOx);
uint32_t          SDIO_GetFIFOCount(SDIO_TypeDef const * const SDIOx);

/* SDMMC Cards mode management functions */
HAL_StatusTypeDef SDIO_SetSDMMCReadWaitMode(SDIO_TypeDef * const SDIOx, uint32_t SDIO_ReadWaitMode);
/**
  * @}
  */
...
/** @addtogroup HAL_SDMMC_LL_Group4
  * @{
  */
uint32_t SDMMC_CmdBlockLength(SDIO_TypeDef * const SDIOx, uint32_t BlockSize);
uint32_t SDMMC_CmdReadSingleBlock(SDIO_TypeDef * const SDIOx, uint32_t ReadAdd);
uint32_t SDMMC_CmdReadMultiBlock(SDIO_TypeDef * const SDIOx, uint32_t ReadAdd);
uint32_t SDMMC_CmdWriteSingleBlock(SDIO_TypeDef * const SDIOx, uint32_t WriteAdd);
uint32_t SDMMC_CmdWriteMultiBlock(SDIO_TypeDef * const SDIOx, uint32_t WriteAdd);
uint32_t SDMMC_CmdEraseStartAdd(SDIO_TypeDef * const SDIOx, uint32_t StartAdd);
uint32_t SDMMC_CmdSDEraseStartAdd(SDIO_TypeDef * const SDIOx, uint32_t StartAdd);
uint32_t SDMMC_CmdEraseEndAdd(SDIO_TypeDef * const SDIOx, uint32_t EndAdd);
uint32_t SDMMC_CmdSDEraseEndAdd(SDIO_TypeDef * const SDIOx, uint32_t EndAdd);
uint32_t SDMMC_CmdErase(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdStopTransfer(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdSelDesel(SDIO_TypeDef * const SDIOx, uint64_t Addr);
uint32_t SDMMC_CmdGoIdleState(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdOperCond(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdAppCommand(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdAppOperCommand(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdBusWidth(SDIO_TypeDef * const SDIOx, uint32_t BusWidth);
uint32_t SDMMC_CmdSendSCR(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdSendCID(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdSendCSD(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdSetRelAdd(SDIO_TypeDef * const SDIOx, uint16_t * const pRCA);
uint32_t SDMMC_CmdSetRelAddMmc(SDIO_TypeDef * const SDIOx, uint16_t RCA);
uint32_t SDMMC_CmdSendStatus(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdStatusRegister(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_CmdOpCondition(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdSwitch(SDIO_TypeDef * const SDIOx, uint32_t Argument);
uint32_t SDMMC_CmdSendEXTCSD(SDIO_TypeDef * const SDIOx, uint32_t Argument);
/**
  * @}
  */
...
/** @addtogroup HAL_SDMMC_LL_Group5
  * @{
  */
uint32_t SDMMC_GetCmdResp1(SDIO_TypeDef * const SDIOx, uint8_t SD_CMD, uint32_t Timeout);
uint32_t SDMMC_GetCmdResp2(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_GetCmdResp3(SDIO_TypeDef * const SDIOx);
uint32_t SDMMC_GetCmdResp6(SDIO_TypeDef * const SDIOx, uint8_t SD_CMD, uint16_t * const pRCA);
uint32_t SDMMC_GetCmdResp7(SDIO_TypeDef * const SDIOx);
/**
  * @}
  */
