...
{
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, MRLVDS_BIT_NUMBER, ENABLE);
}
...
{
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, MRLVDS_BIT_NUMBER, DISABLE);
}
...
{
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, LPLVDS_BIT_NUMBER, ENABLE);
}
...
{
  HAL_PERIPH_BIT_BAND_WRITE(PWR->CR, LPLVDS_BIT_NUMBER, DISABLE);
}
