...
/** @defgroup I2S_Private_Functions I2S Private Functions
  * @{
  */
static void               I2S_DMATxCplt(DMA_HandleTypeDef * const hdma);
static void               I2S_DMATxHalfCplt(DMA_HandleTypeDef * const hdma);
static void               I2S_DMARxCplt(DMA_HandleTypeDef * const hdma);
static void               I2S_DMARxHalfCplt(DMA_HandleTypeDef * const hdma);
static void               I2S_DMAError(DMA_HandleTypeDef * const hdma);
static void               I2S_Transmit_IT(I2S_HandleTypeDef * const hi2s);
static void               I2S_Receive_IT(I2S_HandleTypeDef * const hi2s);
static void               I2S_IRQHandler(I2S_HandleTypeDef * const hi2s);
static HAL_StatusTypeDef  I2S_WaitFlagStateUntilTimeout(I2S_HandleTypeDef * const hi2s, uint32_t Flag, FlagStatus State,
                                                        uint32_t Timeout);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_I2S_Init(I2S_HandleTypeDef * const hi2s)
{
  ...
  if (hi2s->Init.AudioFreq != I2S_AUDIOFREQ_DEFAULT)
  {
    ...
    /* Get the Mask for the Odd bit (SPI_I2SPR[8U]) register */
...
/**
  ...
  * @retval None
  */
__weak void HAL_I2S_MspInit(I2S_HandleTypeDef * const hi2s)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_I2S_MspDeInit(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
/**
  ...
  * @retval None
  */
HAL_I2S_WEAK_CALLBACK(void, HAL_I2S_TxHalfCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
/**
  ...
  * @retval None
  */
HAL_I2S_WEAK_CALLBACK(void, HAL_I2S_TxCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
/**
  ...
  * @retval None
  */
HAL_I2S_WEAK_CALLBACK(void, HAL_I2S_RxHalfCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
/**
  ...
  * @retval None
  */
HAL_I2S_WEAK_CALLBACK(void, HAL_I2S_RxCpltCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
/**
  ...
  * @retval None
  */
HAL_I2S_WEAK_CALLBACK(void, HAL_I2S_ErrorCallback)(I2S_HandleTypeDef * const hi2s)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hi2s);
...
static void I2S_DMATxCplt(DMA_HandleTypeDef * const hdma)
{
  I2S_HandleTypeDef * const hi2s = (I2S_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent; /* Derogation MISRAC2012-Rule-11.5 */
