...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_OPAMPEx_SelfCalibrateAll(OPAMP_HandleTypeDef * const hopamp1, OPAMP_HandleTypeDef * const hopamp2, OPAMP_HandleTypeDef * const hopamp3)
{
  ...
  else
  {
      ...
      {
        tmp_opamp1_otr_otuser = 0x00000000UL;
      ...
      {
        tmp_opamp2_otr_otuser = 0x00000000UL;
      ...
      {
        tmp_opamp3_otr_otuser = 0x00000000UL;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_OPAMPEx_SelfCalibrateAll(OPAMP_HandleTypeDef * const hopamp1, OPAMP_HandleTypeDef * const hopamp2)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_OPAMPEx_Unlock(OPAMP_HandleTypeDef * const hopamp)
{
  HAL_StatusTypeDef status = HAL_OK;
