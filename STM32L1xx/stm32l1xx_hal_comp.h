...
/** @defgroup COMP_Output COMP Output
  * @{
  */
#define COMP_OUTPUT_TIM2IC4                     (0x00000000UL)                                               /*!< COMP2 output connected to TIM2 Input Capture 4 */
...
#define COMP_MODE_LOWSPEED          (0x00000000UL)           /*!< Low Speed */
...
/** @defgroup COMP_WindowMode COMP WindowMode
  * @{
  */
#define COMP_WINDOWMODE_DISABLE               (0x00000000UL)  /*!< Window mode disabled: COMP1 non-inverting input is independent */
...
/* voltage than the inverting input.                                          */
#define COMP_OUTPUTLEVEL_HIGH                  (0x00000001UL)
/**
  * @}
  */
...
/** @defgroup COMP_NonInvertingInputPull COMP NonInvertingInputPull
  * @{
  */
#define COMP_NONINVERTINGINPUT_NOPULL           (0x00000000UL)           /*!< No internal pull-up or pull-down resistor connected to comparator non inverting input */
