...
#define COMP_NONINVERTINGINPUT_NONE     (0x00000000UL)           /*!< In case of window mode: No I/O pin connection to COMP1 non-inverting input. Instead, connection to COMP2 non-inverting input. */
