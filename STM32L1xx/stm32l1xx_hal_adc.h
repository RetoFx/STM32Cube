...
#define HAL_ADC_STATE_REG_EOSMP         (0x00000800UL)    /*!< Not available on STM32L1 device: End Of Sampling flag raised  */
...
#define HAL_ADC_STATE_INJ_JQOVF         (0x00004000UL)    /*!< Not available on STM32L1 device: Injected queue overflow occurrence */

/* States of ADC analog watchdogs */
#define HAL_ADC_STATE_AWD1              (0x00010000UL)    /*!< Out-of-window occurrence of analog watchdog 1 */
#define HAL_ADC_STATE_AWD2              (0x00020000UL)    /*!< Not available on STM32L1 device: Out-of-window occurrence of analog watchdog 2 */
#define HAL_ADC_STATE_AWD3              (0x00040000UL)    /*!< Not available on STM32L1 device: Out-of-window occurrence of analog watchdog 3 */

/* States of ADC multi-mode */
#define HAL_ADC_STATE_MULTIMODE_SLAVE   (0x00100000UL)    /*!< Not available on STM32L1 device: ADC in multimode slave state, controlled by another ADC master ( */
...
/** @defgroup ADC_ClockPrescaler ADC ClockPrescaler
  * @{
  */
#define ADC_CLOCK_ASYNC_DIV1          (0x00000000UL)                   /*!< ADC asynchronous clock derived from ADC dedicated HSI without prescaler */
...
#define ADC_SOFTWARE_START               (0x00000010UL)
/**
  * @}
  */
...
/** @defgroup ADC_EOCSelection ADC EOCSelection
  * @{
  */
#define ADC_EOC_SEQ_CONV            (0x00000000UL)
...
#define ADC_AUTOWAIT_DISABLE                (0x00000000UL)
...
#define ADC_AUTOWAIT_255_APBCLOCKCYCLES     ((uint32_t)(ADC_CR2_DELS_2 | ADC_CR2_DELS_1 | ADC_CR2_DELS_0)) /*!< Insert a delay between ADC conversions: 255U APB clock cycles */
...
/** @defgroup ADC_LowPowerAutoPowerOff ADC LowPowerAutoPowerOff
  * @{
  */
#define ADC_AUTOPOWEROFF_DISABLE            (0x00000000UL)
...
/** @defgroup ADC_ChannelsBank ADC ChannelsBank
  ...
  */
#if defined(STM32L100xC) || defined (STM32L151xC) || defined (STM32L152xC) || defined (STM32L162xC) || defined(STM32L151xCA) || defined (STM32L151xD) || defined (STM32L152xCA) || defined (STM32L152xD) || defined (STM32L162xCA) || defined (STM32L162xD) || defined(STM32L151xE) || defined(STM32L151xDX) || defined (STM32L152xE) || defined (STM32L152xDX) || defined (STM32L162xE) || defined (STM32L162xDX)
#define ADC_CHANNELS_BANK_A                 (0x00000000UL)
...
#define ADC_CHANNEL_0           (0x00000000UL)                                                                                     /* Channel different in bank A and bank B */
...
/** @defgroup ADC_sampling_times ADC sampling times
  * @{
  */
#define ADC_SAMPLETIME_4CYCLES      (0x00000000UL)                                     /*!< Sampling time 4 ADC clock cycles */
...
#define ADC_REGULAR_RANK_17   (0x00000011UL)
#define ADC_REGULAR_RANK_18   (0x00000012UL)
#define ADC_REGULAR_RANK_19   (0x00000013UL)
#define ADC_REGULAR_RANK_20   (0x00000014UL)
#define ADC_REGULAR_RANK_21   (0x00000015UL)
#define ADC_REGULAR_RANK_22   (0x00000016UL)
#define ADC_REGULAR_RANK_23   (0x00000017UL)
#define ADC_REGULAR_RANK_24   (0x00000018UL)
#define ADC_REGULAR_RANK_25   (0x00000019UL)
#define ADC_REGULAR_RANK_26   (0x0000001AUL)
#define ADC_REGULAR_RANK_27   (0x0000001BUL)
#if defined(STM32L100xC) || defined (STM32L151xC) || defined (STM32L152xC) || defined (STM32L162xC) || defined(STM32L151xCA) || defined (STM32L151xD) || defined (STM32L152xCA) || defined (STM32L152xD) || defined (STM32L162xCA) || defined (STM32L162xD) || defined(STM32L151xE) || defined(STM32L151xDX) || defined (STM32L152xE) || defined (STM32L152xDX) || defined (STM32L162xE) || defined (STM32L162xDX)
#define ADC_REGULAR_RANK_28   (0x0000001CUL)
#endif /* STM32L100xC || STM32L151xC || STM32L152xC || STM32L162xC || STM32L151xCA || STM32L151xD || STM32L152xCA || STM32L152xD || STM32L162xCA || STM32L162xD || STM32L151xE || STM32L151xDX || STM32L152xE || STM32L152xDX || STM32L162xE || STM32L162xDX */
/**
  * @}
  */
...
/* External triggers of regular group for ADC1 */
#define ADC_EXTERNALTRIG_T9_CC2         (0x00000000UL)
...
#define ADC_SQR1_L_SHIFT(_NbrOfConversion_)                                    \
  (((_NbrOfConversion_) - (uint8_t)1U) << POSITION_VAL(ADC_SQR1_L))
...
#define ADC_JSQR_RK_JL(_CHANNELNB_, _RANKNB_, _JSQR_JL_)                       \
  ((_CHANNELNB_) << (5U * ((4 - ((_JSQR_JL_) - (_RANKNB_))) - 1U)))
...
#define ADC_CR1_DISCONTINUOUS_NUM(_NBR_DISCONTINUOUS_CONV_)                    \
  (((_NBR_DISCONTINUOUS_CONV_) - 1U) << POSITION_VAL(ADC_CR1_DISCNUM))
...
HAL_StatusTypeDef ADC_Enable(ADC_HandleTypeDef * const hadc);
HAL_StatusTypeDef ADC_ConversionStop_Disable(ADC_HandleTypeDef * const hadc);
/**
  * @}
  */
