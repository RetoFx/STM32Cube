...
void SMARTCARD_InitCallbacksToDefault(SMARTCARD_HandleTypeDef * const hsc);
#endif /* USE_HAL_SMARTCARD_REGISTER_CALLBACKS */
static void SMARTCARD_EndTxTransfer(SMARTCARD_HandleTypeDef * const hsc);
static void SMARTCARD_EndRxTransfer(SMARTCARD_HandleTypeDef * const hsc);
static void SMARTCARD_SetConfig (SMARTCARD_HandleTypeDef * const hsc);
static HAL_StatusTypeDef SMARTCARD_Transmit_IT(SMARTCARD_HandleTypeDef * const hsc);
static HAL_StatusTypeDef SMARTCARD_EndTransmit_IT(SMARTCARD_HandleTypeDef * const hsc);
static HAL_StatusTypeDef SMARTCARD_Receive_IT(SMARTCARD_HandleTypeDef * const hsc);
...
static HAL_StatusTypeDef SMARTCARD_WaitOnFlagUntilTimeout(SMARTCARD_HandleTypeDef * const hsc, uint32_t Flag, FlagStatus Status, uint32_t Tickstart, uint32_t Timeout);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMARTCARD_MspInit(SMARTCARD_HandleTypeDef * const hsc)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMARTCARD_MspDeInit(SMARTCARD_HandleTypeDef * const hsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsc);
...
HAL_StatusTypeDef HAL_SMARTCARD_Transmit_DMA(SMARTCARD_HandleTypeDef * const hsc, uint8_t const * const pData, uint16_t Size)
{
  ...
  if(hsc->gState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    HAL_DMA_Start_IT(hsc->hdmatx, *(uint32_t const *)tmp, (uint32_t)&hsc->Instance->DR, Size);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_TxCpltCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsc);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_RxCpltCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsc);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_ErrorCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsc);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortCpltCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsc);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortTransmitCpltCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
    /* Prevent unused argument(s) compilation warning */
    UNUSED(hsc);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortReceiveCpltCallback)(SMARTCARD_HandleTypeDef * const hsc)
{
    /* Prevent unused argument(s) compilation warning */
    UNUSED(hsc);
...
static void SMARTCARD_DMATransmitCplt(DMA_HandleTypeDef * const hdma)
{
  SMARTCARD_HandleTypeDef * const hsc = ( SMARTCARD_HandleTypeDef * )((DMA_HandleTypeDef * )hdma)->Parent;
