...
#define __COMP_IS_INSTANCE_ODD(__COMP_INSTANCE__)                              \
  ((~((uint32_t)(__COMP_INSTANCE__) - COMP_BASE)) & 0x00000001UL)
...
/** @defgroup COMP_LL_EC_INPUT_PLUS Comparator inputs - Input plus (input non-inverting) selection
  * @{
  */
#define LL_COMP_INPUT_PLUS_NONE         (0x00000000UL)           /*!< Comparator input plus connected not connected */
...
/** @defgroup COMP_LL_EC_INPUT_PULLING_RESISTOR Comparator input - Pulling resistor
  * @{
  */
#define LL_COMP_INPUT_MINUS_PULL_NO        (0x00000000UL)           /*!< Comparator input minus not connected to any pulling resistor */
...
#define LL_COMP_OUTPUT_TIM2_IC4         (0x00000000UL)                                                /*!< COMP output connected to TIM2 input capture 4  (specific to COMP instance: COMP2) */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_COMP_SetInputPullingResistor(COMP_TypeDef * const COMPx, uint32_t InputPullingResistor)
{
...
/**
  ...
  *         (1) Available only on COMP instance: COMP1.
  */
__STATIC_INLINE uint32_t LL_COMP_GetInputPullingResistor(COMP_TypeDef const * const COMPx)
{
  /* On this STM32 series, only COMP instance COMP1 has input pulling         */
