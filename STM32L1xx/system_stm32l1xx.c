...
/** @addtogroup STM32L1xx_System_Private_Defines
  ...
  */
  ...
  #define HSI_VALUE               16000000UL /*!< Default value of the Internal oscillator in Hz.
                                                This value can be provided and adapted by the user application. */
#endif /* HSI_VALUE */
...
/** @addtogroup STM32L1xx_System_Private_Variables
  ...
  */
uint32_t SystemCoreClock        = 2097000UL;
uint8_t const PLLMulTable[9U]    = {3U, 4U, 6U, 8U, 12U, 16U, 24U, 32U, 48U};
...
void SystemInit (void)
{
	/*!< Set MSION bit */
	/*
	RCC->CR |= (uint32_t)0x00000100UL;
	*/
	RCC->CR |= RCC_CR_MSION;

	/*!< Reset SW[1:0], HPRE[3:0], PPRE1[2:0], PPRE2[2:0], MCOSEL[2:0] and MCOPRE[2:0] bits */
	/*
	RCC->CFGR &= (uint32_t)0x88FFC00CUL;
	*/
	...
	/*
	RCC->CR &= (uint32_t)0xEEFEFFFEUL;
	*/
	RCC->CR &= ~( (0U * RCC_CR_RTCPRE_1)
				| (0U * RCC_CR_RTCPRE_0)
				| (1U * RCC_CR_CSSON)
				| (0U * RCC_CR_PLLRDY)
				| (1U * RCC_CR_PLLON)
	...
	*/
	...
	/*
	RCC->CFGR &= (uint32_t)0xFF02FFFFUL;
	*/
...
*/
  ...
  RCC->AHBENR   = 0x000080D8UL;

  /* Delay after an RCC peripheral clock enabling */
  tmpreg = READ_BIT(RCC->AHBENR, RCC_AHBENR_GPIODEN);

  /* Connect PDx pins to FSMC Alternate function */
  GPIOD->AFR[0U]  = 0x00CC00CCUL;
  GPIOD->AFR[1U]  = 0xCCCCCCCCUL;
  /* Configure PDx pins in Alternate function mode */
  GPIOD->MODER   = 0xAAAA0A0AUL;
  /* Configure PDx pins speed to 40 MHz */
  GPIOD->OSPEEDR = 0xFFFF0F0FUL;
  ...
  GPIOG->AFR[1U]  = 0x00000C00UL;
  /* Configure PGx pins in Alternate function mode */
  GPIOG->MODER   = 0x00200AAAUL;
  /* Configure PGx pins speed to 40 MHz */
  GPIOG->OSPEEDR = 0x00300FFFUL;
...
/*-- FSMC Configuration ------------------------------------------------------*/
  ...
  FSMC_Bank1->BTCR[4U]  = 0x00001011UL;
  FSMC_Bank1->BTCR[5U]  = 0x00000300UL;
  FSMC_Bank1E->BWTR[4U] = 0x0FFFFFFFUL;
/*
