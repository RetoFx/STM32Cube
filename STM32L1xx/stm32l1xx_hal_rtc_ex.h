...
/** @defgroup RTCEx_Backup_Registers_Definitions RTCEx Backup Registers Definitions
  * @{
  */
#define RTC_BKP_DR0                       0x00000000UL
#define RTC_BKP_DR1                       0x00000001UL
#define RTC_BKP_DR2                       0x00000002UL
#define RTC_BKP_DR3                       0x00000003UL
#define RTC_BKP_DR4                       0x00000004UL
#if RTC_BKP_NUMBER > 5U
#define RTC_BKP_DR5                       0x00000005UL
#define RTC_BKP_DR6                       0x00000006UL
#define RTC_BKP_DR7                       0x00000007UL
#define RTC_BKP_DR8                       0x00000008UL
#define RTC_BKP_DR9                       0x00000009UL
#define RTC_BKP_DR10                      0x0000000AUL
#define RTC_BKP_DR11                      0x0000000BUL
#define RTC_BKP_DR12                      0x0000000CUL
#define RTC_BKP_DR13                      0x0000000DUL
#define RTC_BKP_DR14                      0x0000000EUL
#define RTC_BKP_DR15                      0x0000000FUL
#if RTC_BKP_NUMBER > 16U
#define RTC_BKP_DR16                      0x00000010UL
#define RTC_BKP_DR17                      0x00000011UL
#define RTC_BKP_DR18                      0x00000012UL
#define RTC_BKP_DR19                      0x00000013UL
#if RTC_BKP_NUMBER > 20U
#define RTC_BKP_DR20                      0x00000014UL
#define RTC_BKP_DR21                      0x00000015UL
#define RTC_BKP_DR22                      0x00000016UL
#define RTC_BKP_DR23                      0x00000017UL
#define RTC_BKP_DR24                      0x00000018UL
#define RTC_BKP_DR25                      0x00000019UL
#define RTC_BKP_DR26                      0x0000001AUL
#define RTC_BKP_DR27                      0x0000001BUL
#define RTC_BKP_DR28                      0x0000001CUL
#define RTC_BKP_DR29                      0x0000001DUL
#define RTC_BKP_DR30                      0x0000001EUL
#define RTC_BKP_DR31                      0x0000001FUL
...
/** @defgroup RTCEx_Tamper_Pin_Selection RTC tamper Pins Selection
  * @{
  */
#define RTC_TAMPERPIN_DEFAULT               0x00000000UL
/**
  * @}
  */
...
/** @defgroup RTCEx_Tamper_Trigger_Definitions RTCEx Tamper Triggers Definitions
  * @{
  */
#define RTC_TAMPERTRIGGER_RISINGEDGE       0x00000000UL
#define RTC_TAMPERTRIGGER_FALLINGEDGE      0x00000002UL
#if defined(RTC_TAFCR_TAMPFLT)
...
/** @defgroup RTCEx_Coarse_Calibration_Definitions RTCEx Coarse Calib Definitions
  * @{
  */
#define RTC_CALIBSIGN_POSITIVE            0x00000000UL
...
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef * const hrtc, uint32_t RTC_TimeStampEdge);
HAL_StatusTypeDef HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef * const hrtc, uint32_t RTC_TimeStampEdge);
...
HAL_StatusTypeDef HAL_RTCEx_SetCoarseCalib(RTC_HandleTypeDef * const hrtc, uint32_t CalibSign, uint32_t Value);
HAL_StatusTypeDef HAL_RTCEx_DeactivateCoarseCalib(RTC_HandleTypeDef * const hrtc);
#if defined(RTC_SMOOTHCALIB_SUPPORT)
...
#else /* RTC_CR_COSEL */
HAL_StatusTypeDef HAL_RTCEx_SetCalibrationOutPut(RTC_HandleTypeDef * const hrtc);
#endif /* RTC_CR_COSEL */
