...
#define ADC_SQR5_REGOFFSET                 0x00000400UL
...
#define ADC_SMPR3_REGOFFSET                0x04000000UL
#if defined(ADC_SMPR0_SMP31)
#define ADC_SMPR0_REGOFFSET                0x28000000UL   /* SMPR0 register offset from SMPR1 is 20 registers. On STM32L1, parameter not available on all devices: only on STM32L1 Cat.4 and Cat.5. */
...
/** @defgroup ADC_LL_EC_LP_MODE_AUTOWAIT  ADC instance - Low power mode auto wait (auto delay)
  * @{
  */
#define LL_ADC_LP_AUTOWAIT_NONE               0x00000000UL                                        /*!< ADC low power mode auto wait not activated */
...
#define LL_ADC_LP_AUTOWAIT_255_APBCLOCKCYCLES (ADC_CR2_DELS_2 | ADC_CR2_DELS_1 | ADC_CR2_DELS_0) /*!< ADC low power mode auto wait: Insert a delay between ADC conversions: 255U APB clock cycles */
/**
  * @}
  */
...
/** @defgroup ADC_LL_EC_LP_MODE_AUTOPOWEROFF  ADC instance - Low power mode auto power-off
  * @{
  */
#define LL_ADC_LP_AUTOPOWEROFF_NONE                 0x00000000UL                                  /*!< ADC low power mode auto power-off not activated */
...
/** @defgroup ADC_LL_EC_CHANNELS_BANK ADC instance - Channels bank
  * @{
  */
#define LL_ADC_CHANNELS_BANK_A             0x00000000UL   /*!< ADC channels bank A */
...
/** @defgroup ADC_LL_EC_CHANNEL_SAMPLINGTIME  Channel - Sampling time
  * @{
  */
#define LL_ADC_SAMPLINGTIME_4CYCLES        0x00000000UL                                              /*!< Sampling time 4 ADC clock cycles */
...
/** @defgroup ADC_LL_EC_CHANNEL_ROUTING_SELECTION  Channel - Routing selection
  * @{
  */
#define LL_ADC_CHANNEL_ROUTING_DEFAULT     0x00000000UL  /*!< ADC channel routing default: slow channel */
#define LL_ADC_CHANNEL_ROUTING_DIRECT      0x00000001UL  /*!< ADC channel routing direct: fast channel. */
/**
  * @}
  */
#endif
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetLowPowerModeAutoWait(ADC_TypeDef * const ADCx, uint32_t LowPowerModeAutoWait)
{
...
/**
  ...
  *         @arg @ref LL_ADC_LP_AUTOWAIT_255_APBCLOCKCYCLES
  */
__STATIC_INLINE uint32_t LL_ADC_GetLowPowerModeAutoWait(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetLowPowerModeAutoPowerOff(ADC_TypeDef * const ADCx, uint32_t LowPowerModeAutoPowerOff)
{
...
/**
  ...
  *         @arg @ref LL_ADC_LP_AUTOPOWEROFF_IDLE_AUTOWAIT_PHASES
  */
__STATIC_INLINE uint32_t LL_ADC_GetLowPowerModeAutoPowerOff(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetChannelsBank(ADC_TypeDef * const ADCx, uint32_t ChannelsBank)
{
...
/**
  ...
  *         @arg @ref LL_ADC_CHANNELS_BANK_B
  */
__STATIC_INLINE uint32_t LL_ADC_GetChannelsBank(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  */
__STATIC_INLINE void LL_ADC_SetChannelRouting(ADC_TypeDef * const ADCx, uint32_t Channel, uint32_t Routing)
{
...
/**
  ...
  *         @arg @ref LL_ADC_CHANNEL_ROUTING_DIRECT
  */
__STATIC_INLINE uint32_t LL_ADC_GetChannelRouting(ADC_TypeDef const * const ADCx, uint32_t Channel)
{
  /* Note: Bit is located in comparator IP, but dedicated to ADC */
