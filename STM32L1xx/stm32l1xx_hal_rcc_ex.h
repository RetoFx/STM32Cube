...
#define LSECSSON_BIT_NUMBER      RCC_CSR_LSECSSON_Pos
#define CSR_LSECSSON_BB         ((uint32_t)(PERIPH_BB_BASE + (RCC_CSR_OFFSET_BB * 32U) + (LSECSSON_BIT_NUMBER * 4U)))
...
#define RCC_PERIPHCLK_LCD           (0x00000002UL)
