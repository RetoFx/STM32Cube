...
#define SYSCFG_BOOT_MAINFLASH          (0x00000000UL)
...
#define TIM_SELECT_NONE  (0x00000000UL)    /*!< None selected */
...
#define RI_INPUTCAPTUREROUTING_0   (0x00000000UL) /* PA0       PA1      PA2       PA3      */
#define RI_INPUTCAPTUREROUTING_1   (0x00000001UL) /* PA4       PA5      PA6       PA7      */
#define RI_INPUTCAPTUREROUTING_2   (0x00000002UL) /* PA8       PA9      PA10      PA11     */
#define RI_INPUTCAPTUREROUTING_3   (0x00000003UL) /* PA12      PA13     PA14      PA15     */
#define RI_INPUTCAPTUREROUTING_4   (0x00000004UL) /* PC0       PC1      PC2       PC3      */
#define RI_INPUTCAPTUREROUTING_5   (0x00000005UL) /* PC4       PC5      PC6       PC7      */
#define RI_INPUTCAPTUREROUTING_6   (0x00000006UL) /* PC8       PC9      PC10      PC11     */
#define RI_INPUTCAPTUREROUTING_7   (0x00000007UL) /* PC12      PC13     PC14      PC15     */
#define RI_INPUTCAPTUREROUTING_8   (0x00000008UL) /* PD0       PD1      PD2       PD3      */
#define RI_INPUTCAPTUREROUTING_9   (0x00000009UL) /* PD4       PD5      PD6       PD7      */
#define RI_INPUTCAPTUREROUTING_10  (0x0000000AUL) /* PD8       PD9      PD10      PD11     */
#define RI_INPUTCAPTUREROUTING_11  (0x0000000BUL) /* PD12      PD13     PD14      PD15     */
#define RI_INPUTCAPTUREROUTING_12  (0x0000000CUL) /* PE0       PE1      PE2       PE3      */
#define RI_INPUTCAPTUREROUTING_13  (0x0000000DUL) /* PE4       PE5      PE6       PE7      */
#define RI_INPUTCAPTUREROUTING_14  (0x0000000EUL) /* PE8       PE9      PE10      PE11     */
#define RI_INPUTCAPTUREROUTING_15  (0x0000000FUL) /* PE12      PE13     PE14      PE15     */
...
/** @defgroup RI_IOSwitch IO Switch
  * @{
  */
#define RI_ASCR1_REGISTER       (0x80000000UL)
...
/** @defgroup RI_Pin PIN define
  * @{
  */
#define RI_PIN_0                 ((uint16_t)0x0001U)  /*!< Pin 0 selected */
#define RI_PIN_1                 ((uint16_t)0x0002U)  /*!< Pin 1 selected */
#define RI_PIN_2                 ((uint16_t)0x0004U)  /*!< Pin 2 selected */
#define RI_PIN_3                 ((uint16_t)0x0008U)  /*!< Pin 3 selected */
#define RI_PIN_4                 ((uint16_t)0x0010U)  /*!< Pin 4 selected */
#define RI_PIN_5                 ((uint16_t)0x0020U)  /*!< Pin 5 selected */
#define RI_PIN_6                 ((uint16_t)0x0040U)  /*!< Pin 6 selected */
#define RI_PIN_7                 ((uint16_t)0x0080U)  /*!< Pin 7 selected */
#define RI_PIN_8                 ((uint16_t)0x0100U)  /*!< Pin 8 selected */
#define RI_PIN_9                 ((uint16_t)0x0200U)  /*!< Pin 9 selected */
#define RI_PIN_10                ((uint16_t)0x0400U)  /*!< Pin 10 selected */
#define RI_PIN_11                ((uint16_t)0x0800U)  /*!< Pin 11 selected */
#define RI_PIN_12                ((uint16_t)0x1000U)  /*!< Pin 12 selected */
#define RI_PIN_13                ((uint16_t)0x2000U)  /*!< Pin 13 selected */
#define RI_PIN_14                ((uint16_t)0x4000U)  /*!< Pin 14 selected */
#define RI_PIN_15                ((uint16_t)0x8000U)  /*!< Pin 15 selected */
#define RI_PIN_ALL               ((uint16_t)0xFFFFU)  /*!< All pins selected */

#define IS_RI_PIN(__PIN__) ((__PIN__) != (uint16_t)0x00U)
...
#if defined(FSMC_R_BASE)
/** @brief  FSMC Bank1 (NOR/PSRAM 1 and 2) mapped at 0x00000000UL
  */
...
#define __HAL_RI_IOSWITCH_CLOSE(__IOSWITCH__) do { assert_param(IS_RI_IOSWITCH(__IOSWITCH__)); \
            if ((__IOSWITCH__) >> 31U != 0 ) \
            { \
              SET_BIT(RI->ASCR1, (__IOSWITCH__) & 0x7FFFFFFFUL); \
            } \
            else \
            { \
...
#define __HAL_RI_IOSWITCH_OPEN(__IOSWITCH__) do { assert_param(IS_RI_IOSWITCH(__IOSWITCH__)); \
            if ((__IOSWITCH__) >> 31U != 0 ) \
            { \
              CLEAR_BIT(RI->ASCR1, (__IOSWITCH__) & 0x7FFFFFFFUL); \
            } \
            else \
            { \
