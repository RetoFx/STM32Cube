...
#define RCC_OSCILLATORTYPE_MSI             (0x00000010UL)
/**
  * @}
  */
...
/** @defgroup RCC_MSI_Config MSI Config
  * @{
  */
#define RCC_MSI_OFF                      (0x00000000UL)
#define RCC_MSI_ON                       (0x00000001UL)

#define RCC_MSICALIBRATION_DEFAULT       (0x00000000UL)   /* Default MSI calibration trimming value */
...
/** @defgroup RCC_HAL_EC_RTC_HSE_DIV RTC HSE Prescaler
  * @{
  */
#define RCC_RTC_HSE_DIV_2               0x00000000UL /*!< HSE is divided by 2 for RTC clock  */
...
/** @brief  Macro to enable Internal Multi Speed oscillator (MSI).
  ...
  *         system clock source.
  */
#define __HAL_RCC_MSI_ENABLE()  HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_MSION_BIT_NUMBER, ENABLE)
...
/** @brief  Macro to disable the Internal Multi Speed oscillator (MSI).
  ...
  *         clock cycles.
  */
#define __HAL_RCC_MSI_DISABLE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CR, RCC_MSION_BIT_NUMBER, DISABLE)
...
/** @brief Macro to enable the the RTC clock.
  ...
  */
#define __HAL_RCC_RTC_ENABLE()          HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_RTCEN_BIT_NUMBER, ENABLE)

/** @brief Macro to disable the the RTC clock.
  * @note  These macros must be used only after the RTC clock source was selected.
  */
#define __HAL_RCC_RTC_DISABLE()         HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_RTCEN_BIT_NUMBER, DISABLE)
...
/** @brief  Macro to force the Backup domain reset.
  ...
  */
#define __HAL_RCC_BACKUPRESET_FORCE()   HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_RTCRST_BIT_NUMBER, ENABLE)

/** @brief  Macros to release the Backup domain reset.
  */
#define __HAL_RCC_BACKUPRESET_RELEASE() HAL_PERIPH_BIT_BAND_WRITE(RCC->CSR, RCC_RTCRST_BIT_NUMBER, DISABLE)
...
/** @brief  Check RCC flag is set or not.
  ...
  */
#define __HAL_RCC_GET_FLAG(__FLAG__) (((((__FLAG__) >> 5U) == CR_REG_INDEX) ? RCC->CR :RCC->CSR) & (1UL << ((__FLAG__) & RCC_FLAG_MASK)))
