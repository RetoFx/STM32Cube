...
typedef enum
{
  ...
  HAL_OPAMP_STATE_BUSYLOCKED          = 0x00000005UL  /*!< OPAMP is locked
...
#if (USE_HAL_OPAMP_REGISTER_CALLBACKS == 1U)
void (* MspInitCallback)                (struct __OPAMP_HandleTypeDef * const hopamp);
void (* MspDeInitCallback)              (struct __OPAMP_HandleTypeDef * const hopamp);
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef void (*pOPAMP_CallbackTypeDef)(OPAMP_HandleTypeDef * const hopamp);
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */
...
/** @defgroup OPAMP_Mode OPAMP Mode
  * @{
  */
#define OPAMP_STANDALONE_MODE            0x00000000UL  /*!< OPAMP standalone mode */
#define OPAMP_FOLLOWER_MODE              0x00000001UL  /*!< OPAMP follower mode */
...
/** @defgroup OPAMP_NonInvertingInput OPAMP NonInvertingInput
  * @{
  */
#define OPAMP_NONINVERTINGINPUT_IO0       0x00000000UL   /*!< Comparator non-inverting input connected to dedicated IO pin low-leakage */
#define OPAMP_NONINVERTINGINPUT_DAC_CH1   0x00000001UL   /*!< Comparator non-inverting input connected internally to DAC channel 1. Available only on OPAMP1 and OPAMP2. */
#define OPAMP_NONINVERTINGINPUT_DAC_CH2   0x00000002UL   /*!< Comparator non-inverting input connected internally to DAC channel 2. Available only on OPAMP2 and OPAMP3 (OPAMP3 availability depends on STM32L1 devices). */
...
#define OPAMP_INVERTINGINPUT_IO0         0x00000000UL   /*!< Comparator inverting input connected to dedicated IO pin low-leakage */
#define OPAMP_INVERTINGINPUT_IO1         0x00000001UL   /*!< Comparator inverting input connected to alternative IO pin available on some device packages */
...
/** @defgroup OPAMP_PowerMode OPAMP PowerMode
  * @{
  */
#define OPAMP_POWERMODE_NORMAL        0x00000000UL
#define OPAMP_POWERMODE_LOWPOWER      0x00000001UL
...
/** @defgroup OPAMP_PowerSupplyRange OPAMP PowerSupplyRange
  * @{
  */
#define OPAMP_POWERSUPPLY_LOW          0x00000000UL             /*!< Power supply range low (VDDA lower than 2.4V) */
...
/** @defgroup OPAMP_FactoryTrimming OPAMP FactoryTrimming
  * @{
  */
#define OPAMP_FACTORYTRIMMING_DUMMY    0xFFFFFFFFUL                                      /*!< Dummy value if trimming value could not be retrieved */
...
/* Unit: ms.                                                                  */
#define OPAMP_TRIMMING_DELAY               ((uint32_t)1U)
...
HAL_StatusTypeDef HAL_OPAMP_Init(OPAMP_HandleTypeDef * const hopamp);
HAL_StatusTypeDef HAL_OPAMP_DeInit (OPAMP_HandleTypeDef * const hopamp);
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef * const hopamp);
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef * const hopamp);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_OPAMP_Start(OPAMP_HandleTypeDef * const hopamp);
HAL_StatusTypeDef HAL_OPAMP_Stop(OPAMP_HandleTypeDef * const hopamp);
HAL_StatusTypeDef HAL_OPAMP_SelfCalibrate(OPAMP_HandleTypeDef * const hopamp);
...
HAL_StatusTypeDef HAL_OPAMP_RegisterCallback(OPAMP_HandleTypeDef * const hopamp, HAL_OPAMP_CallbackIDTypeDef CallbackID, pOPAMP_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_OPAMP_UnRegisterCallback(OPAMP_HandleTypeDef * const hopamp, HAL_OPAMP_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */

HAL_StatusTypeDef HAL_OPAMP_Lock(OPAMP_HandleTypeDef * const hopamp);
HAL_OPAMP_TrimmingValueTypeDef HAL_OPAMP_GetTrimOffset(OPAMP_HandleTypeDef const * const hopamp, uint32_t trimmingoffset);
...
HAL_OPAMP_StateTypeDef HAL_OPAMP_GetState(OPAMP_HandleTypeDef const * const hopamp);
