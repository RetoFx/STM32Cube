...
/** @addtogroup PWR_Private_Constants
  * @{
  */
#define PWR_EXTI_LINE_PVD  (0x00010000UL)  /*!< External interrupt line 16 Connected to the PVD EXTI Line */
...
#define CR_LPRUN_BB              ((uint32_t)(PERIPH_BB_BASE + (PWR_CR_OFFSET_BB * 32U) + (LPRUN_BIT_NUMBER * 4U)))
...
#define CR_FWU_BB                ((uint32_t)(PERIPH_BB_BASE + (PWR_CR_OFFSET_BB * 32U) + (FWU_BIT_NUMBER * 4U)))

/* Alias word address of ULP bit */
#define ULP_BIT_NUMBER           POSITION_VAL(PWR_CR_ULP)
#define CR_ULP_BB                ((uint32_t)(PERIPH_BB_BASE + (PWR_CR_OFFSET_BB * 32U) + (ULP_BIT_NUMBER * 4U)))
/**
  * @}
  */
...
#define CSR_EWUP_BB(VAL)         ((uint32_t)(PERIPH_BB_BASE + (PWR_CSR_OFFSET_BB * 32U) + (POSITION_VAL(VAL) * 4)))
/**
  * @}
  */
...
/** @defgroup PWR_Regulator_state_in_SLEEP_STOP_mode PWR Regulator state in SLEEP/STOP mode
  * @{
  */
#define PWR_MAINREGULATOR_ON           (0x00000000UL)
...
void HAL_PWR_ConfigPVD(PWR_PVDTypeDef const * const sConfigPVD);
