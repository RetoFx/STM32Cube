...
#define OPAMP_CSR_RESET_VALUE            ((uint32_t)0x00000000UL)
...
HAL_OPAMP_TrimmingValueTypeDef HAL_OPAMP_GetTrimOffset(OPAMP_HandleTypeDef const * const hopamp, uint32_t trimmingoffset)
{
  ...
  __IO uint32_t const * tmp_opamp_reg_trimming;  /* Selection of register of trimming depending on power mode: OTR or
  LPOTR */
