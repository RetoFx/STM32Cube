...
/** @defgroup LPTIM_LL_Private_variables LPTIM Private variables
  * @{
  */
static uint8_t const LL_LPTIM_OFFSET_TAB_CCMRx[] =
{
...
static uint8_t const LL_LPTIM_OFFSET_TAB_ICx[8U][4U] =
{
  {2, 7, 9, 13},
  {3, 5, 6, 8},
  {2, 3, 4, 5},
...
/** @defgroup LPTIM_LL_EC_UPDATE_MODE Update Mode
  * @{
  */
#define LL_LPTIM_UPDATE_MODE_IMMEDIATE        0x00000000UL        /*!<Preload is disabled: registers are updated after each APB bus write access*/
...
/** @defgroup LPTIM_LL_EC_COUNTER_MODE Counter Mode
  * @{
  */
#define LL_LPTIM_COUNTER_MODE_INTERNAL        0x00000000UL          /*!<The counter is incremented following each internal clock pulse*/
...
/** @defgroup LPTIM_LL_EC_OUTPUT_WAVEFORM Output Waveform Type
  * @{
  */
#define LL_LPTIM_OUTPUT_WAVEFORM_PWM          0x00000000UL     /*!<LPTIM  generates either a PWM waveform or a One pulse waveform depending on chosen operating mode CONTINUOUS or SINGLE*/
...
/** @defgroup LPTIM_LL_EC_OUTPUT_POLARITY Output Polarity
  * @{
  */
#define LL_LPTIM_OUTPUT_POLARITY_REGULAR      0x00000000UL             /*!<The LPTIM output reflects the compare results between LPTIMx_ARR and LPTIMx_CCRx registers*/
...
/** @defgroup TIM_LL_EC_CHANNEL Channel
  * @{
  */
#define LL_LPTIM_CHANNEL_CH1                  0x00000000UL     /*!< LPTIM input/output channel 1 */
#define LL_LPTIM_CHANNEL_CH2                  0x00000001UL     /*!< LPTIM input/output channel 2 */
#define LL_LPTIM_CHANNEL_CH3                  0x00000002UL     /*!< LPTIM input/output channel 3 */
#define LL_LPTIM_CHANNEL_CH4                  0x00000003UL     /*!< LPTIM input/output channel 4 */
/**
  * @}
  */
...
/** @defgroup LPTIM_LL_EC_PRESCALER Prescaler Value
  * @{
  */
#define LL_LPTIM_PRESCALER_DIV1               0x00000000UL                               /*!<Prescaler division factor is set to 1*/
...
/** @defgroup LPTIM_LL_EC_TRIG_SOURCE Trigger Source
  * @{
  */
#define LL_LPTIM_TRIG_SOURCE_GPIO             0x00000000UL                                                          /*!<External input trigger is connected to TIMx_ETR input*/
...
/** @defgroup LPTIM_LL_EC_TRIG_FILTER Trigger Filter
  * @{
  */
#define LL_LPTIM_TRIG_FILTER_NONE             0x00000000UL         /*!<Any trigger active level change is considered as a valid trigger*/
...
/** @defgroup LPTIM_LL_EC_CLK_SOURCE Clock Source
  * @{
  */
#define LL_LPTIM_CLK_SOURCE_INTERNAL          0x00000000UL      /*!<LPTIM is clocked by internal clock source (APB clock or any of the embedded oscillators)*/
...
/** @defgroup LPTIM_LL_EC_CLK_FILTER Clock Filter
  * @{
  */
#define LL_LPTIM_CLK_FILTER_NONE              0x00000000UL        /*!<Any external clock signal level change is considered as a valid transition*/
...
/** @defgroup LPTIM_LL_EC_CLK_POLARITY Clock Polarity
  * @{
  */
#define LL_LPTIM_CLK_POLARITY_RISING          0x00000000UL        /*!< The rising edge is the active edge used for counting*/
...
/** @defgroup LPTIM_LL_EC_ENCODER_MODE Encoder Mode
  * @{
  */
#define LL_LPTIM_ENCODER_MODE_RISING          0x00000000UL        /*!< The rising edge is the active edge used for counting*/
...
ErrorStatus LL_LPTIM_DeInit(LPTIM_TypeDef const * const LPTIMx);
void LL_LPTIM_StructInit(LL_LPTIM_InitTypeDef * const LPTIM_InitStruct);
ErrorStatus LL_LPTIM_Init(LPTIM_TypeDef * const LPTIMx, LL_LPTIM_InitTypeDef const * const LPTIM_InitStruct);
/**
  * @}
  */
#endif /* USE_FULL_LL_DRIVER */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_Enable(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_Disable(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabled(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_StartCounter(LPTIM_TypeDef * const LPTIMx, uint32_t OperatingMode)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableResetAfterRead(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledResetAfterRead(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ResetCounter(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetUpdateMode(LPTIM_TypeDef * const LPTIMx, uint32_t UpdateMode)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_UPDATE_MODE_ENDOFPERIOD
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetUpdateMode(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @param  AutoReload Value between Min_Data=0x0001U and Max_Data=0xFFFFU
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetAutoReload(LPTIM_TypeDef * const LPTIMx, uint32_t AutoReload)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @retval AutoReload Value between Min_Data=0x0001U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetAutoReload(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @param  Repetition Value between Min_Data=0x00U and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetRepetition(LPTIM_TypeDef * const LPTIMx, uint32_t Repetition)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @retval Repetition Value between Min_Data=0x00U and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetRepetition(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_CC_EnableChannel(LPTIM_TypeDef * const LPTIMx, uint32_t Channel)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_CC_DisableChannel(LPTIM_TypeDef * const LPTIMx, uint32_t Channel)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_CC_IsEnabledChannel(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @param  CompareValue Value between Min_Data=0x00U and Max_Data=0xFFFFU
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH1(LPTIM_TypeDef * const LPTIMx, uint32_t CompareValue)
{
...
/**
  ...
  * @param  LPTIMx Low-Power Timer instance
  * @retval CompareValue Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH1(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH2(LPTIM_TypeDef * const LPTIMx, uint32_t CompareValue)
{
...
/**
  ...
  * @retval CompareValue Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH2(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH3(LPTIM_TypeDef * const LPTIMx, uint32_t CompareValue)
{
...
/**
  ...
  * @retval CompareValue Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH3(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH4(LPTIM_TypeDef * const LPTIMx, uint32_t CompareValue)
{
...
/**
  ...
  * @retval CompareValue Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH4(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetCounter(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetCounterMode(LPTIM_TypeDef * const LPTIMx, uint32_t CounterMode)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_COUNTER_MODE_EXTERNAL
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetCounterMode(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetWaveform(LPTIM_TypeDef * const LPTIMx, uint32_t Waveform)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_OUTPUT_WAVEFORM_SETONCE
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetWaveform(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_OC_SetPolarity(LPTIM_TypeDef * const LPTIMx, uint32_t Channel, uint32_t Polarity)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  *         @arg @ref LL_LPTIM_OUTPUT_POLARITY_INVERSE
  */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetPolarity(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
  const __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetPrescaler(LPTIM_TypeDef * const LPTIMx, uint32_t Prescaler)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_PRESCALER_DIV128
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetPrescaler(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetInput1Src(LPTIM_TypeDef * const LPTIMx, uint32_t Src)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetInput2Src(LPTIM_TypeDef * const LPTIMx, uint32_t Src)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetRemap(LPTIM_TypeDef * const LPTIMx, uint32_t Src)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_IC_SetPolarity(LPTIM_TypeDef * const LPTIMx, uint32_t Channel, uint32_t Polarity)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  *         @arg @ref LL_LPTIM_ICPOLARITY_RISING_FALLING
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetPolarity(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
  const __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_IC_SetFilter(LPTIM_TypeDef * const LPTIMx, uint32_t Channel, uint32_t Filter)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  *         @arg @ref LL_LPTIM_ICFLT_CLOCK_DIV8
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetFilter(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
  const __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_IC_SetPrescaler(LPTIM_TypeDef * const LPTIMx, uint32_t Channel, uint32_t Prescaler)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  *         @arg @ref LL_LPTIM_ICPSC_DIV8
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetPrescaler(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
  const __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void  LL_LPTIM_CC_SetChannelMode(LPTIM_TypeDef * const LPTIMx, uint32_t Channel, uint32_t CCMode)
{
  __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  *         @arg @ref LL_LPTIM_CCMODE_INPUTCAPTURE
  */
__STATIC_INLINE uint32_t  LL_LPTIM_CC_GetChannelMode(LPTIM_TypeDef const * const LPTIMx, uint32_t Channel)
{
  const __IO uint32_t * pReg = (__IO uint32_t *)((uint32_t)((uint32_t)(&LPTIMx->CCMR1) + LL_LPTIM_OFFSET_TAB_CCMRx[Channel]));
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH1(LPTIM_TypeDef const * const LPTIMx)
{
  return (uint32_t)(READ_BIT(LPTIMx->CCR1, LPTIM_CCR1_CCR1));
}
...
/**
  ...
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH2(LPTIM_TypeDef const * const LPTIMx)
{
  return (uint32_t)(READ_BIT(LPTIMx->CCR2, LPTIM_CCR2_CCR2));
}
...
/**
  ...
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH3(LPTIM_TypeDef const * const LPTIMx)
{
  return (uint32_t)(READ_BIT(LPTIMx->CCR3, LPTIM_CCR3_CCR3));
}
...
/**
  ...
  * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
  */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH4(LPTIM_TypeDef const * const LPTIMx)
{
  return (uint32_t)(READ_BIT(LPTIMx->CCR4, LPTIM_CCR4_CCR4));
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableTimeout(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableTimeout(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledTimeout(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_TrigSw(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ConfigTrigger(LPTIM_TypeDef * const LPTIMx, uint32_t Source, uint32_t Filter, uint32_t Polarity)
{
...
/**
  ...
  *
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerSource(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_TRIG_FILTER_8
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerFilter(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_TRIG_POLARITY_RISING_FALLING
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetTriggerPolarity(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetClockSource(LPTIM_TypeDef * const LPTIMx, uint32_t ClockSource)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_CLK_SOURCE_EXTERNAL
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockSource(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ConfigClock(LPTIM_TypeDef * const LPTIMx, uint32_t ClockFilter, uint32_t ClockPolarity)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_CLK_POLARITY_RISING_FALLING
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockPolarity(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_CLK_FILTER_8
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetClockFilter(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_SetEncoderMode(LPTIM_TypeDef * const LPTIMx, uint32_t EncoderMode)
{
...
/**
  ...
  *         @arg @ref LL_LPTIM_ENCODER_MODE_RISING_FALLING
  */
__STATIC_INLINE uint32_t LL_LPTIM_GetEncoderMode(LPTIM_TypeDef const * const LPTIMx)
{
  return (uint32_t)(READ_BIT(LPTIMx->CFGR, LPTIM_CFGR_CKPOL));
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableEncoderMode(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableEncoderMode(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledEncoderMode(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC1(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC2(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC3(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC3(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC4(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC4(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC1O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC2O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC3O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC3O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CC4O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC4O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_ARRM(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_ARRM(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_EXTTRIG(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_EXTTRIG(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CMP1OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP1OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CMP2OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP2OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CMP3OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP3OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_CMP4OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP4OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_DIEROK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_DIEROK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_ARROK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_ARROK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_UP(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_UP(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_DOWN(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_DOWN(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_REPOK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_REPOK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_ClearFlag_UE(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_UE(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC1(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC1(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC2(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC2(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC3(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC3(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC3(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC4(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC4(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC4(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC1O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC1O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC2O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC2O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC3O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC3O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC3O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CC4O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CC4O(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC4O(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_ARRM(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_ARRM(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARRM(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_EXTTRIG(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_EXTTRIG(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_EXTTRIG(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CMP1OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CMP1OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP1OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CMP2OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CMP2OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP2OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CMP3OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CMP3OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP3OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_CMP4OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_CMP4OK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP4OK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_ARROK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_ARROK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit(1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARROK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_UP(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_UP(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit(1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UP(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_DOWN(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_DOWN(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit(1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_DOWN(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_REPOK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_REPOK(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit(1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_REPOK(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableIT_UE(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableIT_UE(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  *@ retval State of bit(1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UE(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableDMAReq_UPDATE(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableDMAReq_UPDATE(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_UPDATE(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableDMAReq_CC1(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableDMAReq_CC1(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC1(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableDMAReq_CC2(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableDMAReq_CC2(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC2(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableDMAReq_CC3(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableDMAReq_CC3(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC3(LPTIM_TypeDef const * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_EnableDMAReq_CC4(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPTIM_DisableDMAReq_CC4(LPTIM_TypeDef * const LPTIMx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC4(LPTIM_TypeDef const * const LPTIMx)
{
