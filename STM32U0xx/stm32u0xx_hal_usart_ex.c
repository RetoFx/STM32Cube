...
/** @defgroup USARTEx_Private_Functions USARTEx Private Functions
  * @{
  */
static void USARTEx_SetNbDataToProcess(USART_HandleTypeDef * const husart);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
HAL_USARTEX_WEAK_CALLBACK(void, HAL_USARTEx_RxFifoFullCallback)(USART_HandleTypeDef * const husart)
{
...
/**
  ...
  * @retval None
  */
HAL_USARTEX_WEAK_CALLBACK(void, HAL_USARTEx_TxFifoEmptyCallback)(USART_HandleTypeDef * const husart)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(husart);
