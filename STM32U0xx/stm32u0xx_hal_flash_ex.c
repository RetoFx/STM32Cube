...
void                      FLASH_OB_GetOEMKeyCRC(uint32_t * const OEM1KeyCRC, uint32_t * const OEM2KEYCRC);
static void               FLASH_OB_HDPConfig(uint32_t BootEntry, uint32_t HDPEndPage, uint32_t HDPEn);
static void               FLASH_OB_GetHDPConfig(uint32_t * const BootEntry, uint32_t * const HDPEndPage, uint32_t * const HDPEn);
...
/**
  ...
  * @param   HDPEndPage specifies the end page of the hide protection area
  * @param   HDPEn      specifies the status of the hide protection area (Enabled(other) or disabled(0xB4U))
  * @retval None
  */
static void FLASH_OB_GetHDPConfig(uint32_t * const BootEntry, uint32_t * const HDPEndPage, uint32_t * const HDPEn)
{
...
/**
  ...
  * @retval None
  */
void HAL_FLASH_OB_GetOEMKeyCRC(uint32_t RDPKeyType, uint32_t * const OEMKeyCRC)
{
  uint32_t regvalue;
...
/**
  ...
  * @retval None
  */
void HAL_FLASHEx_ConfigHDPExtension(FLASH_HDPExtensionTypeDef const * const pHDPExtension)
{
...
/**
  ...
  * @retval None
  */
void HAL_FLASHEx_GetHDPExtensionConfig(FLASH_HDPExtensionTypeDef * const pHDPExtension)
{
  uint32_t regvalue;
