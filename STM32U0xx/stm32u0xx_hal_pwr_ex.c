...
#if defined (GPIOE)
/* PORTE pins mask */
#define PWR_PORTE_AVAILABLE_PINS  0x00000388UL   /* PE3, PE7..PE9 */
#endif /* GPIOE */
#if defined (PWR_PDCRD_PD0)
#define PWR_PORTD_AVAILABLE_PINS  0x00003F7FUL   /* PD0..PD6, PD8..PD13 */
#else
#define PWR_PORTD_AVAILABLE_PINS  0x00000004UL   /* PD2 */
#endif /* PWR_PDCRD_PD0 */
/* PORTF pins mask */
#define PWR_PORTF_AVAILABLE_PINS  0x0000000FUL   /* PF0..PF3 */
