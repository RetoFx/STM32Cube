...
extern uint8_t const  AHBPrescTable[16U];    /*!< AHB prescalers table values */
extern uint8_t const  APBPrescTable[8U];     /*!< APB prescalers table values */
extern uint32_t const MSIRangeTable[12U];    /*!< MSI ranges table values     */
