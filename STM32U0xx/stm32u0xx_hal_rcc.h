...
/** @defgroup RCC_LSI_Div LSI Div
  * @{
  */
#define RCC_LSI_DIV1                   (0x00000000UL)       /*!< LSI clock is not divided */
...
/** @defgroup RCC_HSIK_Config HSIK Config
  * @{
  */
#define RCC_HSIK_OFF                   (0x00000000UL)       /*!< HSIK clock deactivation */
...
/** @defgroup RCC_HSIASFS_Config HSIASFS Config
  * @{
  */
#define RCC_HSIASFS_OFF                (0x00000000UL)         /*!< HSIASFS clock deactivation */
...
/** @defgroup RCC_HSECSS_Config HSECSS Config
  * @{
  */
#define RCC_HSECSS_OFF                 (0x00000000UL)         /*!< HSECSS clock deactivation */
...
/** @defgroup RCC_PLL_Config  RCC PLL Config
  * @{
  */
#define RCC_PLL_NONE                 (0x00000000UL)
#define RCC_PLL_OFF                  (0x00000001UL)
...
/** @defgroup RCC_PLLM_Clock_Divider PLLM Clock Divider
  * @{
  */
#define RCC_PLLM_DIV1       0x00000000UL                                                    /*!< PLLM division factor = 8  */
...
/** @defgroup RCC_PLL_Clock_Source  RCC PLL Clock Source
  * @{
  */
#define RCC_PLLSOURCE_NONE             (0x00000000UL)
...
/** @defgroup RCC_System_Clock_Source System Clock Source
  * @{
  */
#define RCC_SYSCLKSOURCE_MSI            (0x00000000UL)                     /*!< MSI selection as system clock */
...
/** @defgroup RCC_System_Clock_Source_Status System Clock Source Status
  * @{
  */
#define RCC_SYSCLKSOURCE_STATUS_MSI      (0x00000000UL)                      /*!< MSI used as system clock */
...
/** @defgroup RCC_AHB_Clock_Source AHB Clock Source
  * @{
  */
#define RCC_SYSCLK_DIV1       (0x00000000UL)                                                           /*!< SYSCLK not divided */
...
/** @defgroup RCC_APB_Clock_Source APB Clock Source
  * @{
  */
#define RCC_HCLK_DIV1                  (0x00000000UL)                                         /*!< HCLK not divided */
...
/** @defgroup RCC_MCO2_Clock_Source MCO2 Clock Source
  * @{
  */
#define RCC_MCO2SOURCE_NOCLOCK         (0x00000000UL)                                                   /*!< MCO2 output disabled, no clock on MCO2 */
...
/** @defgroup RCC_MCO1_Clock_Prescaler MCO1 Clock Prescaler
  * @{
  */
#define RCC_MCO1DIV_1         (0x00000000UL)                                                  /*!< MCO divided by 1 */
...
/** @defgroup RCC_MCO2_Clock_Prescaler MCO2 Clock Prescaler
  * @{
  */
#define RCC_MCO2DIV_1         (0x00000000UL)                                                  /*!< MCO divided by 1 */
...
#define __HAL_RCC_AHB_FORCE_RESET()     do { \
                                                 WRITE_REG(RCC->AHBRSTR, 0xFFFFFFFFUL); \
                                               } while(0U)
...
#define __HAL_RCC_AHB_RELEASE_RESET()     do { \
                                                 WRITE_REG(RCC->AHBRSTR, 0x00000000UL); \
                                               } while(0U)
...
#define __HAL_RCC_IOP_FORCE_RESET()     do { \
                                                 WRITE_REG(RCC->IOPRSTR, 0xFFFFFFFFUL); \
                                               } while(0U)
...
#define __HAL_RCC_IOP_RELEASE_RESET()     do { \
                                                 WRITE_REG(RCC->IOPRSTR, 0x00000000UL); \
                                               } while(0U)
...
#define __HAL_RCC_APB1_GRP1_FORCE_RESET()     do { \
                                                   WRITE_REG(RCC->APBRSTR1, 0xFFFFFFFFUL); \
                                                 } while(0U)
...
#define __HAL_RCC_APB1_GRP1_RELEASE_RESET()     do { \
                                                     WRITE_REG(RCC->APBRSTR1, 0x00000000UL); \
                                                   } while(0U)
...
#define __HAL_RCC_APB1_GRP2_FORCE_RESET()          WRITE_REG(RCC->APBRSTR2, 0xFFFFFFFFUL)
...
#define __HAL_RCC_APB1_GRP2_RELEASE_RESET()        WRITE_REG(RCC->APBRSTR2, 0x00000000UL)
