...
/**
  ...
  * @retval None
  */
__weak void HAL_TSC_MspInit(TSC_HandleTypeDef * const htsc)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_TSC_MspDeInit(TSC_HandleTypeDef * const htsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htsc);
...
/**
  ...
  * @retval None
  */
HAL_TSC_WEAK_CALLBACK(void, HAL_TSC_ConvCpltCallback)(TSC_HandleTypeDef * const htsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htsc);
...
/**
  ...
  * @retval None
  */
HAL_TSC_WEAK_CALLBACK(void, HAL_TSC_ErrorCallback)(TSC_HandleTypeDef * const htsc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htsc);
