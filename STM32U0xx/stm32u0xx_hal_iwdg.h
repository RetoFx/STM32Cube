...
/**
  ...
  */
#if (USE_HAL_IWDG_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_IWDG_REGISTER_CALLBACKS == 1U)
  void (* EwiCallback)(struct __IWDG_HandleTypeDef * const hiwdg);                  /*!< IWDG Early WakeUp Interrupt callback */
  void (* MspInitCallback)(struct __IWDG_HandleTypeDef * const hiwdg);              /*!< IWDG Msp Init callback */
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
} IWDG_HandleTypeDef;
...
/**
  ...
  */
typedef void (*pIWDG_CallbackTypeDef)(IWDG_HandleTypeDef * const hppp);  /*!< pointer to a IWDG common callback functions */
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
...
/** @defgroup IWDG_Prescaler IWDG Prescaler
  * @{
  */
#define IWDG_PRESCALER_4                0x00000000UL                                     /*!< IWDG prescaler set to 4   */
...
/** @defgroup IWDG_EWI_Mode IWDG Early Wakeup Interrupt Mode
  * @{
  */
#define IWDG_EWI_DISABLE                0x00000000UL       /*!< EWI Disable */
/**
  * @}
  */
...
/** @defgroup IWDG_Active_Status IWDG Active Status
  * @{
  */
#define IWDG_STATUS_DISABLE             0x00000000UL
...
HAL_StatusTypeDef     HAL_IWDG_Init(IWDG_HandleTypeDef * const hiwdg);
void                  HAL_IWDG_MspInit(IWDG_HandleTypeDef * const hiwdg);
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_IWDG_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef     HAL_IWDG_RegisterCallback(IWDG_HandleTypeDef * const hiwdg, HAL_IWDG_CallbackIDTypeDef CallbackID,
                                                pIWDG_CallbackTypeDef pCallback);
HAL_StatusTypeDef     HAL_IWDG_UnRegisterCallback(IWDG_HandleTypeDef * const hiwdg, HAL_IWDG_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_IWDG_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef     HAL_IWDG_Refresh(IWDG_HandleTypeDef * const hiwdg);
uint32_t              HAL_IWDG_GetActiveStatus(IWDG_HandleTypeDef const * const hiwdg);
void                  HAL_IWDG_IRQHandler(IWDG_HandleTypeDef * const hiwdg);
void                  HAL_IWDG_EarlyWakeupCallback(IWDG_HandleTypeDef * const hiwdg);
/**
  * @}
  */
