...
/** @defgroup RCC_LL_EC_SYS_CLKSOURCE  System clock switch
  * @{
  */
#define LL_RCC_SYS_CLKSOURCE_MSI           (0x00000000UL)                     /*!< MSI selection as system clock */
...
/** @defgroup RCC_LL_EC_SYS_CLKSOURCE_STATUS  System clock switch status
  * @{
  */
#define LL_RCC_SYS_CLKSOURCE_STATUS_MSI    (0x00000000UL)                      /*!< MSI used as system clock */
...
/** @defgroup RCC_LL_EC_APB1_DIV  APB low-speed prescaler (APB1)
  * @{
  */
#define LL_RCC_APB1_DIV_1         (0x00000000UL)                                         /*!< APB not divided */
...
/** @defgroup RCC_LL_EC_MCO1SOURCE  MCO1 SOURCE selection
  * @{
  */
#define LL_RCC_MCO1SOURCE_NOCLOCK    (uint32_t)((RCC_CFGR_MCO1SEL>> 16U) | 0x00000000UL)            /*!< MCO output disabled, no clock on MCO */
...
#define LL_RCC_MCO1_DIV_1        (uint32_t)((RCC_CFGR_MCO1PRE>> 16U) | 0x00000000UL)             /*!< MCO not divided */
...
/** @defgroup RCC_LL_EC_MCO2SOURCE  MCO2 SOURCE selection
  * @{
  */
#define LL_RCC_MCO2SOURCE_NOCLOCK    (uint32_t)((RCC_CFGR_MCO2SEL>> 16U) | 0x00000000UL)           /*!< MCO output disabled, no clock on MCO2 */
...
#define LL_RCC_MCO2_DIV_1         (uint32_t)((RCC_CFGR_MCO2PRE>> 16U) | 0x00000000UL)           /*!< MCO not divided */
...
/** @defgroup RCC_LL_EC_LPUARTx_CLKSOURCE Peripheral LPUART clock source selection
  ...
  */
#if defined (LPUART3)
#define LL_RCC_LPUART3_CLKSOURCE_PCLK1     ((RCC_CCIPR_LPUART3SEL << 16U) | 0x00000000UL)             /*!< PCLK clock used as LPUART3 clock source */
...
#endif /* LPUART3 */
#define LL_RCC_LPUART2_CLKSOURCE_PCLK1     ((RCC_CCIPR_LPUART2SEL << 16U) | 0x00000000UL)             /*!< PCLK clock used as LPUART2 clock source */
...
#define LL_RCC_LPUART1_CLKSOURCE_PCLK1     ((RCC_CCIPR_LPUART1SEL << 16U) | 0x00000000UL)             /*!< PCLK clock used as LPUART1 clock source */
...
/** @defgroup RCC_LL_EC_TIMx_CLKSOURCE Peripheral TIM clock source selection
  * @{
  */
#define LL_RCC_TIM1_CLKSOURCE_PCLK1     (RCC_CCIPR_TIM1SEL   | (0x00000000UL >> 16U))        /*!< PCLK clock used as TIM1 clock source */
...
/** @addtogroup RCC_LL_EC_TIMx_CLKSOURCE
  * @{
  */
#define LL_RCC_TIM15_CLKSOURCE_PCLK1    (RCC_CCIPR_TIM15SEL   | (0x00000000UL >> 16U))          /*!< PCLK clock used as TIM15 clock source */
...
/** @defgroup RCC_LL_EC_LPTIMx_CLKSOURCE Peripheral LPTIM clock source selection
  * @{
  */
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1   (RCC_CCIPR_LPTIM1SEL | (0x00000000UL >> 16U))           /*!< PCLK selected as LPTIM1 clock */
...
#define LL_RCC_LPTIM2_CLKSOURCE_PCLK1   (RCC_CCIPR_LPTIM2SEL | (0x00000000UL >> 16U))           /*!< PCLK selected as LPTIM2 clock */
...
#if defined (LPTIM3)
#define LL_RCC_LPTIM3_CLKSOURCE_PCLK1   (RCC_CCIPR_LPTIM3SEL | (0x00000000UL >> 16U))           /*!< PCLK selected as LPTIM3 clock */
...
/** @defgroup RCC_LL_EC_ADC_CLKSOURCE  Peripheral ADC clock source selection
  * @{
  */
#define LL_RCC_ADC_CLKSOURCE_SYSCLK        0x00000000UL          /*!< SYSCLK clock used as ADC clock source */
...
#define LL_RCC_USART3_CLKSOURCE            0x00000000UL         /*!< To be used for USART3 Clock frequency retrieval */
#define LL_RCC_USART4_CLKSOURCE            0x00000001UL         /*!< To be used for USART4 Clock frequency retrieval */
/**
  * @}
  */
...
__STATIC_INLINE void LL_RCC_ConfigMCO(uint32_t MCOxSource, uint32_t MCOxPrescaler)
{
  MODIFY_REG(RCC->CFGR, (MCOxSource << 16U) | (MCOxPrescaler << 16U),
             (MCOxSource & 0xFFFF0000UL) | (MCOxPrescaler & 0xFFFF0000UL));
}
...
__STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource)
{
  ...
  MODIFY_REG(*reg, 3UL << ((I2CxSource & 0x00FF0000UL) >> 16U),
             ((I2CxSource & 0x000000FFUL) << ((I2CxSource & 0x00FF0000UL) >> 16U)));
}
...
__STATIC_INLINE uint32_t LL_RCC_GetI2CClockSource(uint32_t I2Cx)
{
  ...
  return (uint32_t)((READ_BIT(*reg, 3UL << ((I2Cx & 0x0000FF0000UL) >> 16U)) >> ((I2Cx & 0x0000FF0000UL) >> 16U)) |
                    (I2Cx & 0xFFFF0000UL));
}
