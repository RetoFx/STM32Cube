...
typedef struct
{
  ...
  uint32_t                     Period;            /*!< Specifies the period value to be loaded into the active
                                                  ...
                                                  Min_Data = 0x0001U and Max_Data = 0xFFFFU.  */
  ...
  uint32_t                     RepetitionCounter;/*!< Specifies the repetition counter value.
                                                  ...
                                                  Note: When using repetition counter the UpdateMode field must be
                                                        ...
                                                        behavior may occur.
                                                  This parameter must be a number between Min_Data = 0x00U and
                                                  Max_Data = 0xFFU. */
} LPTIM_InitTypeDef;
...
/**
  ...
  */
#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1U)
...
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
{
  ...
  DMA_HandleTypeDef             *hdma[5U];          /*!< DMA Handlers array, This array is accessed by a @ref LPTIM_DMA_Handle_index */
  ...
  __IO  HAL_LPTIM_ChannelStateTypeDef   ChannelState[4U];  /*!< LPTIM channel operation state                       */

#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1U)
  void (* MspInitCallback)(struct __LPTIM_HandleTypeDef * const hlptim);            /*!< LPTIM Base Msp Init Callback                 */
  void (* MspDeInitCallback)(struct __LPTIM_HandleTypeDef * const hlptim);          /*!< LPTIM Base Msp DeInit Callback               */
  void (* CompareMatchCallback)(struct __LPTIM_HandleTypeDef * const hlptim);       /*!< Compare match Callback                       */
  void (* AutoReloadMatchCallback)(struct __LPTIM_HandleTypeDef * const hlptim);    /*!< Auto-reload match Callback                   */
  void (* TriggerCallback)(struct __LPTIM_HandleTypeDef * const hlptim);            /*!< External trigger event detection Callback    */
  void (* CompareWriteCallback)(struct __LPTIM_HandleTypeDef * const hlptim);       /*!< Compare register write complete Callback     */
  void (* AutoReloadWriteCallback)(struct __LPTIM_HandleTypeDef * const hlptim);    /*!< Auto-reload register write complete Callback */
  void (* DirectionUpCallback)(struct __LPTIM_HandleTypeDef * const hlptim);        /*!< Up-counting direction change Callback        */
  void (* DirectionDownCallback)(struct __LPTIM_HandleTypeDef * const hlptim);      /*!< Down-counting direction change Callback      */
  void (* UpdateEventCallback)(struct __LPTIM_HandleTypeDef * const hlptim);        /*!< Update event detection Callback              */
  void (* RepCounterWriteCallback)(struct __LPTIM_HandleTypeDef * const hlptim);    /*!< Repetition counter register write complete Callback */
  void (* UpdateEventHalfCpltCallback)(struct __LPTIM_HandleTypeDef * const hlptim);/*!< Update event half complete detection Callback */
  void (* ErrorCallback)(struct __LPTIM_HandleTypeDef * const hlptim);              /*!< LPTIM Error Callback                         */
  void (* IC_CaptureCallback)(struct __LPTIM_HandleTypeDef * const hlptim);         /*!< Input capture Callback                       */
  void (* IC_CaptureHalfCpltCallback)(struct __LPTIM_HandleTypeDef * const htim);   /*!< Input Capture half complete Callback         */
  void (* IC_OverCaptureCallback)(struct __LPTIM_HandleTypeDef * const hlptim);     /*!< Over capture Callback                        */
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
} LPTIM_HandleTypeDef;
...
/**
  ...
  */
typedef  void (*pLPTIM_CallbackTypeDef)(LPTIM_HandleTypeDef * const hlptim);  /*!< pointer to the LPTIM callback function */
...
/** @defgroup LPTIM_Clock_Source LPTIM Clock Source
  * @{
  */
#define LPTIM_CLOCKSOURCE_APBCLOCK_LPOSC        0x00000000UL
...
/** @defgroup LPTIM_Clock_Prescaler LPTIM Clock Prescaler
  * @{
  */
#define LPTIM_PRESCALER_DIV1                    0x00000000UL
...
/** @defgroup LPTIM_Clock_Sample_Time LPTIM Clock Sample Time
  * @{
  */
#define LPTIM_CLOCKSAMPLETIME_DIRECTTRANSITION  0x00000000UL
...
/** @defgroup LPTIM_Clock_Polarity LPTIM Clock Polarity
  * @{
  */
#define LPTIM_CLOCKPOLARITY_RISING              0x00000000UL
...
/** @defgroup LPTIM_Trigger_Source LPTIM Trigger Source
  * @{
  */
#define LPTIM_TRIGSOURCE_SOFTWARE               0x0000FFFFUL
#define LPTIM_TRIGSOURCE_0                      0x00000000UL
...
/** @defgroup LPTIM_Trigger_Sample_Time LPTIM Trigger Sample Time
  * @{
  */
#define LPTIM_TRIGSAMPLETIME_DIRECTTRANSITION  0x00000000UL
...
#define LPTIM_UPDATE_IMMEDIATE                  0x00000000UL
...
#define LPTIM_COUNTERSOURCE_INTERNAL            0x00000000UL
...
#define LPTIM_INPUT1SOURCE_GPIO          0x00000000UL                                      /*!< For LPTIM1, LPTIM2 and LPTIM3 */
...
#define LPTIM_INPUT2SOURCE_GPIO          0x00000000UL                                      /*!< For LPTIM1 and LPTIM3 */
#if defined(COMP2)
...
/** @defgroup LPTIM_DMA_Handle_index LPTIM DMA Handle Index
  * @{
  */
#define LPTIM_DMA_ID_UPDATE                ((uint16_t) 0x0000U)       /*!< Index of the DMA handle used for Update DMA requests */
#define LPTIM_DMA_ID_CC1                   ((uint16_t) 0x0001U)       /*!< Index of the DMA handle used for Capture/Update event 1 DMA request */
#define LPTIM_DMA_ID_CC2                   ((uint16_t) 0x0002U)       /*!< Index of the DMA handle used for Capture/Update event 2 DMA request */
#define LPTIM_DMA_ID_CC3                   ((uint16_t) 0x0003U)       /*!< Index of the DMA handle used for Capture/Update event 3 DMA request */
#define LPTIM_DMA_ID_CC4                   ((uint16_t) 0x0004U)       /*!< Index of the DMA handle used for Capture/Update event 4 DMA request */
/**
  * @}
  */
...
/** @defgroup LPTIM_Output_Compare_Polarity LPTIM Output Compare Polarity
  * @{
  */
#define LPTIM_OCPOLARITY_HIGH                    0x00000000UL                    /*!< Capture/Compare output polarity */
#define LPTIM_OCPOLARITY_LOW                     0x00000001UL                    /*!< Capture/Compare output polarity */
/**
  * @}
  */
...
#define __HAL_LPTIM_RESET_HANDLE_STATE(__HANDLE__) do {                                                        \
                                                        ...
                                                        (__HANDLE__)->ChannelState[0U]  = HAL_LPTIM_CHANNEL_STATE_RESET; \
                                                        (__HANDLE__)->ChannelState[1U]  = HAL_LPTIM_CHANNEL_STATE_RESET; \
                                                        (__HANDLE__)->ChannelState[2U]  = HAL_LPTIM_CHANNEL_STATE_RESET; \
                                                        (__HANDLE__)->ChannelState[3U]  = HAL_LPTIM_CHANNEL_STATE_RESET; \
...
HAL_StatusTypeDef HAL_LPTIM_Init(LPTIM_HandleTypeDef * const hlptim);
HAL_StatusTypeDef HAL_LPTIM_DeInit(LPTIM_HandleTypeDef * const hlptim);

/* MSP functions  *************************************************************/
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef * const hlptim);
/**
  * @}
  */
...
/** @addtogroup LPTIM_Exported_Functions_Group2
  ...
  */
/* Config functions  **********************************************************/
HAL_StatusTypeDef HAL_LPTIM_OC_ConfigChannel(LPTIM_HandleTypeDef * const hlptim, LPTIM_OC_ConfigTypeDef const * const sConfig,
                                             uint32_t Channel);

/* Start/Stop operation functions  *********************************************/
/* ################################# PWM Mode ################################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_PWM_Start(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_PWM_Stop(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_PWM_Start_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_PWM_Stop_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_PWM_Start_DMA(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel, uint32_t const * const pData,
                                          uint32_t Length);
HAL_StatusTypeDef HAL_LPTIM_PWM_Stop_DMA(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);

/* ############################# One Pulse Mode ##############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_OnePulse_Start(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_OnePulse_Stop(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_OnePulse_Start_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_OnePulse_Stop_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);

/* ############################## Set once Mode ##############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_SetOnce_Start(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_SetOnce_Stop(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_SetOnce_Start_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_SetOnce_Stop_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);

/* ############################### Encoder Mode ##############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_Encoder_Start(LPTIM_HandleTypeDef * const hlptim);
HAL_StatusTypeDef HAL_LPTIM_Encoder_Stop(LPTIM_HandleTypeDef * const hlptim);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_Encoder_Start_IT(LPTIM_HandleTypeDef * const hlptim);
HAL_StatusTypeDef HAL_LPTIM_Encoder_Stop_IT(LPTIM_HandleTypeDef * const hlptim);

/* ############################# Time out  Mode ##############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_TimeOut_Start(LPTIM_HandleTypeDef * const hlptim, uint32_t Timeout);
HAL_StatusTypeDef HAL_LPTIM_TimeOut_Stop(LPTIM_HandleTypeDef * const hlptim);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_TimeOut_Start_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Timeout);
HAL_StatusTypeDef HAL_LPTIM_TimeOut_Stop_IT(LPTIM_HandleTypeDef * const hlptim);

/* ############################## Counter Mode ###############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_Counter_Start(LPTIM_HandleTypeDef * const hlptim);
HAL_StatusTypeDef HAL_LPTIM_Counter_Stop(LPTIM_HandleTypeDef * const hlptim);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_Counter_Start_IT(LPTIM_HandleTypeDef * const hlptim);
HAL_StatusTypeDef HAL_LPTIM_Counter_Stop_IT(LPTIM_HandleTypeDef * const hlptim);

/* ############################## Input Capture Mode ###############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_IC_ConfigChannel(LPTIM_HandleTypeDef * const hlptim, LPTIM_IC_ConfigTypeDef const * const sConfig,
                                             uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_IC_Start(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_IC_Stop(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_LPTIM_IC_Start_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_IC_Stop_IT(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
HAL_StatusTypeDef HAL_LPTIM_IC_Start_DMA(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel, uint32_t * const pData,
                                         uint32_t Length);
HAL_StatusTypeDef HAL_LPTIM_IC_Stop_DMA(LPTIM_HandleTypeDef * const hlptim, uint32_t Channel);
/**
  * @}
  */
...
uint32_t HAL_LPTIM_ReadCounter(LPTIM_HandleTypeDef const * const hlptim);
uint32_t HAL_LPTIM_ReadAutoReload(LPTIM_HandleTypeDef const * const hlptim);
uint32_t HAL_LPTIM_ReadCapturedValue(LPTIM_HandleTypeDef const * const hlptim, uint32_t Channel);
uint8_t HAL_LPTIM_IC_GetOffset(LPTIM_HandleTypeDef const * const hlptim, uint32_t Channel);
/**
  * @}
  */
...
/** @addtogroup LPTIM_Exported_Functions_Group4
  ...
  */
/* LPTIM IRQ functions  *******************************************************/
void HAL_LPTIM_IRQHandler(LPTIM_HandleTypeDef * const hlptim);

/* CallBack functions  ********************************************************/
void HAL_LPTIM_CompareMatchCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_AutoReloadMatchCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_TriggerCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_CompareWriteCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_AutoReloadWriteCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_DirectionUpCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_DirectionDownCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_ErrorCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_UpdateEventCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_UpdateEventHalfCpltCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_RepCounterWriteCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_IC_CaptureCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_IC_CaptureHalfCpltCallback(LPTIM_HandleTypeDef * const hlptim);
void HAL_LPTIM_IC_OverCaptureCallback(LPTIM_HandleTypeDef * const hlptim);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_LPTIM_RegisterCallback(LPTIM_HandleTypeDef * const lphtim, HAL_LPTIM_CallbackIDTypeDef CallbackID,
                                             pLPTIM_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_LPTIM_UnRegisterCallback(LPTIM_HandleTypeDef * const lphtim, HAL_LPTIM_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_LPTIM_StateTypeDef HAL_LPTIM_GetState(LPTIM_HandleTypeDef const * const hlptim);
/**
  * @}
  */
...
#define LPTIM_CHANNEL_STATE_GET(__INSTANCE__, __CHANNEL__) \
  (((__CHANNEL__) == LPTIM_CHANNEL_1) ? (__INSTANCE__)->ChannelState[0U] : \
   ((__CHANNEL__) == LPTIM_CHANNEL_2) ? (__INSTANCE__)->ChannelState[1U] : \
   ((__CHANNEL__) == LPTIM_CHANNEL_3) ? (__INSTANCE__)->ChannelState[2U] : \
   (__INSTANCE__)->ChannelState[3U])

#define LPTIM_CHANNEL_STATE_SET(__INSTANCE__, __CHANNEL__, __CHANNEL_STATE__) \
  (((__CHANNEL__) == LPTIM_CHANNEL_1) ? ((__INSTANCE__)->ChannelState[0U] = (__CHANNEL_STATE__)) : \
   ((__CHANNEL__) == LPTIM_CHANNEL_2) ? ((__INSTANCE__)->ChannelState[1U] = (__CHANNEL_STATE__)) : \
   ((__CHANNEL__) == LPTIM_CHANNEL_3) ? ((__INSTANCE__)->ChannelState[2U] = (__CHANNEL_STATE__))  : \
   ((__INSTANCE__)->ChannelState[3U] = (__CHANNEL_STATE__)))

#define LPTIM_CHANNEL_STATE_SET_ALL(__INSTANCE__,  __CHANNEL_STATE__) \
 do { \
                                                                           (__INSTANCE__)->ChannelState[0U]  = (__CHANNEL_STATE__);  \
                                                                           (__INSTANCE__)->ChannelState[1U]  = (__CHANNEL_STATE__);  \
                                                                           (__INSTANCE__)->ChannelState[2U]  = (__CHANNEL_STATE__);  \
                                                                           (__INSTANCE__)->ChannelState[3U]  = (__CHANNEL_STATE__);  \
                                                                         } while(0U)
