...
#define OPAMP_POWERMODE_LPOTR_REGOFFSET     0x00000002UL
...
/** @defgroup OPAMP_LL_EC_POWERSUPPLY_RANGE OPAMP power supply range
  * @{
  */
#define LL_OPAMP_POWERSUPPLY_RANGE_LOW   0x00000000UL            /*!< Power supply range low  */
...
/** @defgroup OPAMP_LL_EC_POWERMODE OPAMP power mode
  * @{
  */
#define LL_OPAMP_POWERMODE_NORMALPOWER_NORMALSPEED        0x00000000UL                        /*!< OPAMP power mode normal speed normal    */
...
/** @defgroup OPAMP_LL_EC_INPUT_NONINVERTING OPAMP input non-inverting
  * @{
  */
#define LL_OPAMP_INPUT_NONINVERT_IO0       0x00000000UL           /*!< OPAMP non inverting input connected to GPIO pin (pin PA0 for OPAMP1)             */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_OPAMP_SetTrimmingValue(OPAMP_TypeDef * const OPAMPx, uint32_t PowerMode, uint32_t TransistorsDiffPair,
...
/**
  ...
  * @retval 0x0U...0x1FU
  */
__STATIC_INLINE uint32_t LL_OPAMP_GetTrimmingValue(OPAMP_TypeDef const * const OPAMPx, uint32_t PowerMode,
