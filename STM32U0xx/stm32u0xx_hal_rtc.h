...
#endif /* (USE_HAL_RTC_REGISTER_CALLBACKS) */
{
  ...
  void (* Tamper4EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Tamper 4 Event callback */
  void (* Tamper5EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Tamper 5 Event callback */
...
/** @defgroup RTC_ALARM_Flag_AutoClear_Definitions RTC Alarms Flag Auto Clear Definitions
  * @{
  */
#define ALARM_FLAG_AUTOCLR_ENABLE                         0x00000001UL
#define ALARM_FLAG_AUTOCLR_DISABLE                        0x00000000UL
/**
  * @}
  */
...
#define RTC_ALARMSUBSECONDMASK_SS14      (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | \
                                          RTC_ALRMASSR_MASKSS_3)                         /*!< SS[14U] not used in Alarm
...
/** @defgroup RTC_Flags_Definitions RTC Flags Definitions
  ...
  * @{
  */
#define RTC_FLAG_RECALPF                    0x00000110UL    /*!< Recalibration pending Flag */
#define RTC_FLAG_INITF                      0x00000106UL    /*!< Initialization flag */
#define RTC_FLAG_RSF                        0x00000105UL    /*!< Registers synchronization flag */
#define RTC_FLAG_INITS                      0x00000104UL    /*!< Initialization status flag */
#define RTC_FLAG_SHPF                       0x00000103UL    /*!< Shift operation pending flag */
#define RTC_FLAG_WUTWF                      0x00000102UL    /*!< Wakeup timer write flag */
#define RTC_FLAG_SSRUF                      0x00000206UL    /*!< SSR underflow flag */
#define RTC_FLAG_ITSF                       0x00000205UL    /*!< Internal Time-stamp flag */
#define RTC_FLAG_TSOVF                      0x00000204UL    /*!< Time-stamp overflow flag */
#define RTC_FLAG_TSF                        0x00000203UL    /*!< Time-stamp flag */
#define RTC_FLAG_WUTF                       0x00000202UL    /*!< Wakeup timer flag */
#define RTC_FLAG_ALRBF                      0x00000201UL    /*!< Alarm B flag */
#define RTC_FLAG_ALRAF                      0x00000200UL    /*!< Alarm A flag */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef const * const hrtc, RTC_AlarmTypeDef * const sAlarm, uint32_t Alarm,
                                   uint32_t Format);
...
/** @defgroup RTC_Private_Functions RTC Private Functions
  * @{
  */
HAL_StatusTypeDef  RTC_EnterInitMode(RTC_HandleTypeDef const * const hrtc);
