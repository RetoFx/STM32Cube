...
static HAL_StatusTypeDef LPTIM_OC1_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_OC_ConfigTypeDef const * const sConfig);
static HAL_StatusTypeDef LPTIM_OC2_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_OC_ConfigTypeDef const * const sConfig);
static HAL_StatusTypeDef LPTIM_OC3_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_OC_ConfigTypeDef const * const sConfig);
static HAL_StatusTypeDef LPTIM_OC4_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_OC_ConfigTypeDef const * const sConfig);
static void LPTIM_IC1_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_IC_ConfigTypeDef const * const sConfig);
static void LPTIM_IC2_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_IC_ConfigTypeDef const * const sConfig);
static void LPTIM_IC3_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_IC_ConfigTypeDef const * const sConfig);
static void LPTIM_IC4_SetConfig(LPTIM_HandleTypeDef * const hlptim, LPTIM_IC_ConfigTypeDef const * const sConfig);
#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1U)
static void LPTIM_ResetCallback(LPTIM_HandleTypeDef * const lptim);
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
static HAL_StatusTypeDef LPTIM_WaitForFlag(LPTIM_HandleTypeDef const * const hlptim, uint32_t flag);
void LPTIM_DMAError(DMA_HandleTypeDef * const hdma);
void LPTIM_DMACaptureCplt(DMA_HandleTypeDef * const hdma);
void LPTIM_DMACaptureHalfCplt(DMA_HandleTypeDef * const hdma);
void LPTIM_DMAUpdateEventCplt(DMA_HandleTypeDef * const hdma);
void LPTIM_DMAUpdateEventHalfCplt(DMA_HandleTypeDef * const hdma);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef * const hlptim)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  *         This parameter must be a value between 0x0000U and 0xFFFFU.
  * @retval HAL status
  */
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_CompareMatchCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_AutoReloadMatchCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_TriggerCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_CompareWriteCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_AutoReloadWriteCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_DirectionUpCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
HAL_LPTIM_WEAK_CALLBACK(void, HAL_LPTIM_DirectionDownCallback)(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_UpdateEventCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_RepCounterWriteCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_IC_CaptureCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_IC_OverCaptureCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_IC_CaptureHalfCpltCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_UpdateEventHalfCpltCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_LPTIM_ErrorCallback(LPTIM_HandleTypeDef * const hlptim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hlptim);
...
void LPTIM_DMAError(DMA_HandleTypeDef * const hdma)
{
  LPTIM_HandleTypeDef * const hlptim = (LPTIM_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
