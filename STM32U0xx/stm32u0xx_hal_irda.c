...
void IRDA_InitCallbacksToDefault(IRDA_HandleTypeDef * const hirda);
#endif /* USE_HAL_IRDA_REGISTER_CALLBACKS */
static HAL_StatusTypeDef IRDA_SetConfig(IRDA_HandleTypeDef * const hirda);
static HAL_StatusTypeDef IRDA_CheckIdleState(IRDA_HandleTypeDef * const hirda);
static HAL_StatusTypeDef IRDA_WaitOnFlagUntilTimeout(IRDA_HandleTypeDef * const hirda, uint32_t Flag, FlagStatus Status,
                                                     uint32_t Tickstart, uint32_t Timeout);
#if defined(HAL_DMA_MODULE_ENABLED)
static void IRDA_EndTxTransfer(IRDA_HandleTypeDef * const hirda);
#endif /* HAL_DMA_MODULE_ENABLED */
static void IRDA_EndRxTransfer(IRDA_HandleTypeDef * const hirda);
#if defined(HAL_DMA_MODULE_ENABLED)
static void IRDA_DMATransmitCplt(DMA_HandleTypeDef * const hdma);
static void IRDA_DMATransmitHalfCplt(DMA_HandleTypeDef * const hdma);
static void IRDA_DMAReceiveCplt(DMA_HandleTypeDef * const hdma);
static void IRDA_DMAReceiveHalfCplt(DMA_HandleTypeDef * const hdma);
static void IRDA_DMAError(DMA_HandleTypeDef * const hdma);
static void IRDA_DMAAbortOnError(DMA_HandleTypeDef * const hdma);
static void IRDA_DMATxAbortCallback(DMA_HandleTypeDef * const hdma);
static void IRDA_DMARxAbortCallback(DMA_HandleTypeDef * const hdma);
static void IRDA_DMATxOnlyAbortCallback(DMA_HandleTypeDef * const hdma);
static void IRDA_DMARxOnlyAbortCallback(DMA_HandleTypeDef * const hdma);
#endif /* HAL_DMA_MODULE_ENABLED */
static void IRDA_Transmit_IT(IRDA_HandleTypeDef * const hirda);
static void IRDA_EndTransmit_IT(IRDA_HandleTypeDef * const hirda);
static void IRDA_Receive_IT(IRDA_HandleTypeDef * const hirda);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_IRDA_MspInit(IRDA_HandleTypeDef * const hirda)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_IRDA_MspDeInit(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_TxCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_TxHalfCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_RxCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_RxHalfCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_ErrorCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_AbortCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_AbortTransmitCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
/**
  ...
  * @retval None
  */
HAL_IRDA_WEAK_CALLBACK(void, HAL_IRDA_AbortReceiveCpltCallback)(IRDA_HandleTypeDef * const hirda)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hirda);
...
static HAL_StatusTypeDef IRDA_SetConfig(IRDA_HandleTypeDef * const hirda)
{
  ...
  static uint16_t const IRDAPrescTable[12U] = {1U, 2U, 4U, 6U, 8U, 10U, 12U, 16U, 32U, 64U, 128U, 256U};
  uint32_t pclk;
...
static void IRDA_DMATransmitCplt(DMA_HandleTypeDef * const hdma)
{
  IRDA_HandleTypeDef * const hirda = (IRDA_HandleTypeDef *)(hdma->Parent);
...
static void IRDA_DMARxOnlyAbortCallback(DMA_HandleTypeDef * const hdma)
{
  IRDA_HandleTypeDef * const hirda = (IRDA_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
