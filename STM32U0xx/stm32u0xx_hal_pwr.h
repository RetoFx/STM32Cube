...
/** @defgroup PWR_PVD_EVENT_LINE  PWR PVD event line
  * @{
  */
#define PWR_EVENT_LINE_PVD                         0x00010000UL                                                               /*!< Event line 16 Connected to the PVD Event Line */
/**
  * @}
  */
...
/** @brief  Check whether or not a specific PWR flag is set.
  ...
  */
#define __HAL_PWR_GET_FLAG(__FLAG__)   ( (((__FLAG__) >> 8U) == 1U)        ? \
                                         ((PWR->SR1 & (1UL << ((__FLAG__) & 0xFFU))) >> ( (__FLAG__) & 0xFFU))  : \
                                         ((PWR->SR2 & (1UL << ((__FLAG__) & 0xFFU))) >> ( (__FLAG__) & 0xFFU)) )
