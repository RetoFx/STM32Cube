...
/** @defgroup PWREx_PVM_EXTI_LINE PWR PVM external interrupts lines
  ...
  */
#if defined(USB_DRD_FS)
#define PWR_EXTI_LINE_PVM1       0x00100000UL     /*!< External interrupt line 19 Connected to the PVM USB EXTI Line */
#endif /* USB_DRD_FS */
#define PWR_EXTI_LINE_PVM3       0x00200000UL     /*!< External interrupt line 20 Connected to the PVM ADC EXTI Line  */
#define PWR_EXTI_LINE_PVM4       0x00400000UL     /*!< External interrupt line 21 Connected to the PVM DAC EXTI Line  */
/**
  * @}
  */
...
/** @defgroup PWREx_PVM_EVENT_LINE PWR PVM event lines
  ...
  */
#if defined(USB_DRD_FS)
#define PWR_EVENT_LINE_PVM1                  0x00100000UL      /*!< Event line 19 Connected to the PVM USB EXTI Line */
#endif /* USB_DRD_FS */
#define PWR_EVENT_LINE_PVM3                  0x00200000UL      /*!< Event line 20 Connected to the PVM ADC EXTI Line */
#define PWR_EVENT_LINE_PVM4                  0x00400000UL      /*!< Event line 21 Connected to the PVM DAC EXTI Line */
/**
  * @}
  */
