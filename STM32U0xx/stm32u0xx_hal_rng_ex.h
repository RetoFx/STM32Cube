...
typedef struct
{
  uint32_t        Config1;           /*!< Config1 must be a value between 0 and 0x3FU */
  uint32_t        Config2;           /*!< Config2 must be a value between 0 and 0x7U */
  uint32_t        Config3;           /*!< Config3 must be a value between 0 and 0xFU */
  ...
  uint32_t        HealthTest;           /*!< RNG health test control must be a value
                                             between 0x0FFCABFFUL and 0x00005200UL */
} RNG_ConfigTypeDef;
...
/** @addtogroup RNGEx_Exported_Functions_Group1
  * @{
  */
HAL_StatusTypeDef HAL_RNGEx_SetConfig(RNG_HandleTypeDef * const hrng, RNG_ConfigTypeDef const * const pConf);
HAL_StatusTypeDef HAL_RNGEx_GetConfig(RNG_HandleTypeDef * const hrng, RNG_ConfigTypeDef * const pConf);
HAL_StatusTypeDef HAL_RNGEx_LockConfig(RNG_HandleTypeDef * const hrng);
...
/** @addtogroup RNGEx_Exported_Functions_Group2
  * @{
  */
HAL_StatusTypeDef HAL_RNGEx_RecoverSeedError(RNG_HandleTypeDef * const hrng);
