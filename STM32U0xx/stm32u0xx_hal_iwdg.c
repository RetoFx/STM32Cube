/**
  ...
  ******************************************************************************
  ...
  [..]
    ...
    (+) Whenever the key value 0x0000U AAAA is written in the IWDG_KR register,
...
HAL_StatusTypeDef HAL_IWDG_Init(IWDG_HandleTypeDef * const hiwdg)
{
  ...
  if (hiwdg->Init.EWI == IWDG_EWI_DISABLE)
  {
     ...
     * Set Watchdog Early Wakeup Comparator to 0x00U */
...
/**
  ...
  * @retval None
  */
__weak void HAL_IWDG_MspInit(IWDG_HandleTypeDef * const hiwdg)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_IWDG_EarlyWakeupCallback(IWDG_HandleTypeDef * const hiwdg)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hiwdg);
