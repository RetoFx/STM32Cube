...
typedef enum
{
  ...
  HAL_OPAMP_STATE_BUSYLOCKED          = 0x00000005UL  /*!< OPAMP is locked. Only system reset allows reconfiguring the opamp */
...
#define OPAMP_NONINVERTINGINPUT_IO0         0x00000000UL             /*!< OPAMP non-inverting input connected to dedicated IO pin       */
...
/** @defgroup OPAMP_InvertingInput OPAMP Inverting Input
  * @{
  */
#define OPAMP_INVERTINGINPUT_IO0              0x00000000UL            /*!< OPAMP inverting input connected to dedicated IO pin low-leakage                         */
...
/** @defgroup OPAMP_PowerMode OPAMP PowerMode
  * @{
  */
#define OPAMP_POWERMODE_NORMALPOWER_NORMALSPEED        0x00000000UL                         /*!< OPAMP power mode normal speed normal    */
...
#define OPAMP_INPUT_NONINVERTING              ((uint32_t)8U)  /*!< Non inverting input */
...
#if (USE_HAL_OPAMP_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_OPAMP_RegisterCallback(OPAMP_HandleTypeDef * const hopamp, HAL_OPAMP_CallbackIDTypeDef CallbackID,
