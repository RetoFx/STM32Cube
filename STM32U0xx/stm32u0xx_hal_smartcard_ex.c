...
static void SMARTCARDEx_SetNbDataToProcess(SMARTCARD_HandleTypeDef * const hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARDEX_WEAK_CALLBACK(void, HAL_SMARTCARDEx_RxFifoFullCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARDEX_WEAK_CALLBACK(void, HAL_SMARTCARDEx_TxFifoEmptyCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
