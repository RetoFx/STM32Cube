...
#define USART_BRR_MAX  0x0000FFFFUL  /*!< USART BRR maximum authorized value */
/**
  * @}
  */
...
void SMARTCARD_InitCallbacksToDefault(SMARTCARD_HandleTypeDef * const hsmartcard);
#endif /* USE_HAL_SMARTCARD_REGISTER_CALLBACKS */
static HAL_StatusTypeDef SMARTCARD_SetConfig(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_AdvFeatureConfig(SMARTCARD_HandleTypeDef * const hsmartcard);
static HAL_StatusTypeDef SMARTCARD_CheckIdleState(SMARTCARD_HandleTypeDef * const hsmartcard);
static HAL_StatusTypeDef SMARTCARD_WaitOnFlagUntilTimeout(SMARTCARD_HandleTypeDef * const hsmartcard, uint32_t Flag,
                                                          FlagStatus Status, uint32_t Tickstart, uint32_t Timeout);
static void SMARTCARD_EndTxTransfer(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_EndRxTransfer(SMARTCARD_HandleTypeDef * const hsmartcard);
#if defined(HAL_DMA_MODULE_ENABLED)
static void SMARTCARD_DMATransmitCplt(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMAReceiveCplt(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMAError(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMAAbortOnError(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMATxAbortCallback(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMARxAbortCallback(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMATxOnlyAbortCallback(DMA_HandleTypeDef * const hdma);
static void SMARTCARD_DMARxOnlyAbortCallback(DMA_HandleTypeDef * const hdma);
#endif /* HAL_DMA_MODULE_ENABLED */
static void SMARTCARD_TxISR(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_TxISR_FIFOEN(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_EndTransmit_IT(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_RxISR(SMARTCARD_HandleTypeDef * const hsmartcard);
static void SMARTCARD_RxISR_FIFOEN(SMARTCARD_HandleTypeDef * const hsmartcard);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMARTCARD_MspInit(SMARTCARD_HandleTypeDef * const hsmartcard)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SMARTCARD_MspDeInit(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
                                        ...
                                        uint32_t Timeout)
{
  ...
  if (hsmartcard->RxState == HAL_SMARTCARD_STATE_READY)
  {
    ...
    while (hsmartcard->RxXferCount > 0U)
    {
      ...
      *ptmpdata = (uint8_t)(hsmartcard->Instance->RDR & (uint8_t)0x00FFU);
      ptmpdata++;
    }
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_TxCpltCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_RxCpltCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_ErrorCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortCpltCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortTransmitCpltCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
/**
  ...
  * @retval None
  */
HAL_SMARTCARD_WEAK_CALLBACK(void, HAL_SMARTCARD_AbortReceiveCpltCallback)(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsmartcard);
...
static HAL_StatusTypeDef SMARTCARD_SetConfig(SMARTCARD_HandleTypeDef * const hsmartcard)
{
  ...
  static uint16_t const SMARTCARDPrescTable[12U] = {1U, 2U, 4U, 6U, 8U, 10U, 12U, 16U, 32U, 64U, 128U, 256U};
  uint32_t pclk;
...
static void SMARTCARD_DMATransmitCplt(DMA_HandleTypeDef * const hdma)
{
  SMARTCARD_HandleTypeDef * const hsmartcard = (SMARTCARD_HandleTypeDef *)(hdma->Parent);
  hsmartcard->TxXferCount = 0U;
