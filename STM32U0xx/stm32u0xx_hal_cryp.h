...
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
{
  ...
  uint32_t const              *pCrypInBuffPtr_saved;   /*!< copy of CRYP input pointer when processing is suspended */
  ...
  uint32_t                    IV_saved[4U];             /*!< copy of Initialisation Vector registers */

  uint32_t                    SUSPxR_saved[8U];         /*!< copy of suspension registers */

  uint32_t                    CR_saved;                /*!< copy of CRYP control register  when processing is suspended*/

  uint32_t                    Key_saved[8U];            /*!< copy of key registers */
...
#define CRYP_DATAWIDTHUNIT_BYTE   0x00000001UL  /*!< By default, size unit is byte */
...
#define CRYP_HEADERWIDTHUNIT_WORD   0x00000000UL  /*!< By default, header size unit is word */
#define CRYP_HEADERWIDTHUNIT_BYTE   0x00000001UL  /*!< By default, header size unit is byte */
...
#define CRYP_AES_ECB            0x00000000UL                       /*!< Electronic codebook chaining algorithm                   */
...
#define CRYP_KEYSIZE_128B         0x00000000UL          /*!< 128-bit long key */
...
#define CRYP_DATATYPE_32B         0x00000000UL  /*!< 32-bit data type (no swapping)        */
...
#define CRYP_KEYIVCONFIG_ALWAYS        0x00000000UL            /*!< Peripheral Key and IV configuration to do systematically */
#define CRYP_KEYIVCONFIG_ONCE          0x00000001UL            /*!< Peripheral Key and IV configuration to do only once      */
