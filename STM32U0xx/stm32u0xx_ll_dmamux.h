...
#define LL_DMAMUX_REQ_ADC                 0x00000005UL  /*!< DMAMUX ADC request             */
#if defined(AES)
...
#endif /* AES */
#define LL_DMAMUX_REQ_DAC_CH1             0x00000008UL  /*!< DMAMUX DAC_CH1       request    */
#define LL_DMAMUX_REQ_I2C1_RX             0x00000009UL  /*!< DMAMUX I2C1 RX       request   */
#define LL_DMAMUX_REQ_I2C1_TX             0x0000000AUL  /*!< DMAMUX I2C1 TX       request   */
#define LL_DMAMUX_REQ_I2C2_RX             0x0000000BUL  /*!< DMAMUX I2C2 RX       request   */
#define LL_DMAMUX_REQ_I2C2_TX             0x0000000CUL  /*!< DMAMUX I2C2 TX       request   */
#define LL_DMAMUX_REQ_I2C3_RX             0x0000000DUL  /*!< DMAMUX I2C3 RX       request   */
#define LL_DMAMUX_REQ_I2C3_TX             0x0000000EUL  /*!< DMAMUX I2C3 TX       request   */
#if defined(I2C4)
#define LL_DMAMUX_REQ_I2C4_RX             0x0000000FUL  /*!< DMAMUX I2C4 RX       request   */
#define LL_DMAMUX_REQ_I2C4_TX             0x00000010UL  /*!< DMAMUX I2C4 TX       request   */
#endif /* I2C4 */
#define LL_DMAMUX_REQ_LPTIM1_IC1          0x00000011UL  /*!< DMAMUX LPTIM1 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC2          0x00000012UL  /*!< DMAMUX LPTIM1 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC3          0x00000013UL  /*!< DMAMUX LPTIM1 IC3    request   */
#define LL_DMAMUX_REQ_LPTIM1_IC4          0x00000014UL  /*!< DMAMUX LPTIM1 IC4    request   */
#define LL_DMAMUX_REQ_LPTIM1_UE           0x00000015UL  /*!< DMAMUX LPTIM1 UE     request   */
#define LL_DMAMUX_REQ_LPTIM2_IC1          0x00000016UL  /*!< DMAMUX LPTIM2 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM2_IC2          0x00000017UL  /*!< DMAMUX LPTIM2 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM2_UE           0x00000018UL  /*!< DMAMUX LPTIM2 UE     request   */
#if defined(LPTIM3)
#define LL_DMAMUX_REQ_LPTIM3_IC1          0x00000019UL  /*!< DMAMUX LPTIM3 IC1    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC2          0x0000001AUL  /*!< DMAMUX LPTIM3 IC2    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC3          0x0000001BUL  /*!< DMAMUX LPTIM3 IC3    request   */
#define LL_DMAMUX_REQ_LPTIM3_IC4          0x0000001CUL  /*!< DMAMUX LPTIM3 IC4    request   */
#define LL_DMAMUX_REQ_LPTIM3_UE           0x0000001DUL  /*!< DMAMUX LPTIM3 UE     request   */
#endif /* LPTIM3 */
#define LL_DMAMUX_REQ_LPUART1_RX          0x0000001EUL  /*!< DMAMUX LPUART1 RX    request   */
#define LL_DMAMUX_REQ_LPUART1_TX          0x0000001FUL  /*!< DMAMUX LPUART1 TX    request   */
#define LL_DMAMUX_REQ_LPUART2_RX          0x00000020UL  /*!< DMAMUX LPUART2 RX    request   */
#define LL_DMAMUX_REQ_LPUART2_TX          0x00000021UL  /*!< DMAMUX LPUART2 TX    request   */
#if defined(LPUART3)
#define LL_DMAMUX_REQ_LPUART3_RX          0x00000022UL  /*!< DMAMUX LPUART3 RX    request   */
#define LL_DMAMUX_REQ_LPUART3_TX          0x00000023UL  /*!< DMAMUX LPUART3 TX    request   */
#endif /* LPUART */
#define LL_DMAMUX_REQ_SPI1_RX             0x00000024UL  /*!< DMAMUX SPI1 RX       request   */
#define LL_DMAMUX_REQ_SPI1_TX             0x00000025UL  /*!< DMAMUX SPI1 TX       request   */
#define LL_DMAMUX_REQ_SPI2_RX             0x00000026UL  /*!< DMAMUX SPI2 RX       request   */
#define LL_DMAMUX_REQ_SPI2_TX             0x00000027UL  /*!< DMAMUX SPI2 TX       request   */
#if defined(SPI3)
#define LL_DMAMUX_REQ_SPI3_RX             0x00000028UL  /*!< DMAMUX SPI3 RX       request   */
#define LL_DMAMUX_REQ_SPI3_TX             0x00000029UL  /*!< DMAMUX SPI3 TX       request   */
#endif /* SPI3 */
...
#define LL_DMAMUX_REQ_TIM1_TRIG_COM       0x0000002EUL  /*!< DMAMUX TIM1 TRIG COM request   */
#define LL_DMAMUX_REQ_TIM1_UP             0x0000002FUL  /*!< DMAMUX TIM1 UP       request   */
#define LL_DMAMUX_REQ_TIM2_CH1            0x00000030UL  /*!< DMAMUX TIM2 CH1      request   */
#define LL_DMAMUX_REQ_TIM2_CH2            0x00000031UL  /*!< DMAMUX TIM2 CH2      request   */
#define LL_DMAMUX_REQ_TIM2_CH3            0x00000032UL  /*!< DMAMUX TIM2 CH3      request   */
#define LL_DMAMUX_REQ_TIM2_CH4            0x00000033UL  /*!< DMAMUX TIM2 CH4      request   */
#define LL_DMAMUX_REQ_TIM2_TRIG           0x00000034UL  /*!< DMAMUX TIM2 TRIG     request   */
#define LL_DMAMUX_REQ_TIM2_UP             0x00000035UL  /*!< DMAMUX TIM2 UP       request   */
#define LL_DMAMUX_REQ_TIM3_CH1            0x00000036UL  /*!< DMAMUX TIM3 CH1      request   */
#define LL_DMAMUX_REQ_TIM3_CH2            0x00000037UL  /*!< DMAMUX TIM3 CH2      request   */
#define LL_DMAMUX_REQ_TIM3_CH3            0x00000038UL  /*!< DMAMUX TIM3 CH3      request   */
#define LL_DMAMUX_REQ_TIM3_CH4            0x00000039UL  /*!< DMAMUX TIM3 CH4      request   */
#define LL_DMAMUX_REQ_TIM3_TRIG           0x0000003AUL  /*!< DMAMUX TIM3 TRIG     request   */
#define LL_DMAMUX_REQ_TIM3_UP             0x0000003BUL  /*!< DMAMUX TIM3 UP       request   */
#define LL_DMAMUX_REQ_TIM6_UP             0x0000003CUL  /*!< DMAMUX TIM6 UP       request   */
#define LL_DMAMUX_REQ_TIM7_UP             0x0000003DUL  /*!< DMAMUX TIM7 UP       request   */
#define LL_DMAMUX_REQ_TIM15_CH1           0x0000003EUL  /*!< DMAMUX TIM15 CH1     request   */
#define LL_DMAMUX_REQ_TIM15_CH2           0x0000003FUL  /*!< DMAMUX TIM15 CH2     request   */
#define LL_DMAMUX_REQ_TIM15_TRIG_COM      0x00000040UL  /*!< DMAMUX TIM15 TRIG COMrequest   */
#define LL_DMAMUX_REQ_TIM15_UP            0x00000041UL  /*!< DMAMUX TIM15 UP      request   */
#define LL_DMAMUX_REQ_TIM16_CH1           0x00000042UL  /*!< DMAMUX TIM16 CH1     request   */
#define LL_DMAMUX_REQ_TIM16_COM           0x00000043UL  /*!< DMAMUX TIM16 COM     request   */
#define LL_DMAMUX_REQ_TIM16_UP            0x00000044UL  /*!< DMAMUX TIM16 UP      request   */
#define LL_DMAMUX_REQ_USART1_RX           0x00000045UL  /*!< DMAMUX USART1 RX     request   */
#define LL_DMAMUX_REQ_USART1_TX           0x00000046UL  /*!< DMAMUX USART1 TX     request   */
#define LL_DMAMUX_REQ_USART2_RX           0x00000047UL  /*!< DMAMUX USART2 RX     request   */
#define LL_DMAMUX_REQ_USART2_TX           0x00000048UL  /*!< DMAMUX USART2 TX     request   */
#define LL_DMAMUX_REQ_USART3_RX           0x00000049UL  /*!< DMAMUX USART3 RX     request   */
#define LL_DMAMUX_REQ_USART3_TX           0x0000004AUL  /*!< DMAMUX USART3 TX     request   */
#define LL_DMAMUX_REQ_USART4_RX           0x0000004BUL  /*!< DMAMUX USART4 RX     request   */
#define LL_DMAMUX_REQ_USART4_TX           0x0000004CUL  /*!< DMAMUX USART4 TX     request   */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMAMUX_SetSyncRequestNb(DMAMUX_Channel_TypeDef const * const DMAMUXx, uint32_t Channel,
                                                uint32_t RequestNb)
{
  (void)(DMAMUXx);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMAMUX_SetSyncPolarity(DMAMUX_Channel_TypeDef const * const DMAMUXx, uint32_t Channel,
                                               uint32_t Polarity)
{
  (void)(DMAMUXx);
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledRequestGen(DMAMUX_Channel_TypeDef const * const DMAMUXx,
...
/**
  ...
  *         @arg @ref LL_DMAMUX_REQ_GEN_POL_RISING_FALLING
  */
__STATIC_INLINE uint32_t LL_DMAMUX_GetRequestGenPolarity(DMAMUX_Channel_TypeDef const * const DMAMUXx,
                                                         uint32_t RequestGenChannel)
{
  (void)(DMAMUXx);
