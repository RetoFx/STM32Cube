...
/** @defgroup SYSTEM_LL_EC_IR_MOD SYSCFG IR Modulation
  * @{
  */
#define LL_SYSCFG_IR_MOD_TIM16       0x00000000UL                                        /*!< 00: Timer16 is selected as IRDA Modulation envelope source */
...
/** @defgroup SYSTEM_LL_EC_TSCIOCONTROL SYSCFG TSC IOCONTROL
  * @{
  */
#define LL_SYSCFG_TSCIOCONTROL_REG      0x00000000UL                 /*!< I/O configured through the corresponding control register */
...
/** @defgroup SYSTEM_LL_EC_KEY FLASH KEY
  * @{
  */
#define FLASH_KEY1    0x45670123UL  /*!< Flash Unlock key1 */
#define FLASH_KEY2    0xCDEF89ABUL  /*!< Flash Unlock key2 */
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[0U], SYSCFG_ITLINE0_SR_WWDG) == (SYSCFG_ITLINE0_SR_WWDG)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVMOUT1) == (SYSCFG_ITLINE1_SR_PVMOUT1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVMOUT3) == (SYSCFG_ITLINE1_SR_PVMOUT3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[1U], SYSCFG_ITLINE1_SR_PVMOUT4) == (SYSCFG_ITLINE1_SR_PVMOUT4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[4U], SYSCFG_ITLINE4_SR_RCC) == (SYSCFG_ITLINE4_SR_RCC)) ? 1UL : 0UL);
}
#if defined(CRS)
/**
  * @brief  Check if Reset and clock control interrupt occurred or not.
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[8U], SYSCFG_ITLINE8_SR_USBFS) == (SYSCFG_ITLINE8_SR_USBFS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[11U], SYSCFG_ITLINE11_SR_DMAMUX) == (SYSCFG_ITLINE11_SR_DMAMUX)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC1) == (SYSCFG_ITLINE14_SR_TIM1_CC1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC2) == (SYSCFG_ITLINE14_SR_TIM1_CC2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC3) == (SYSCFG_ITLINE14_SR_TIM1_CC3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[14U], SYSCFG_ITLINE14_SR_TIM1_CC4) == (SYSCFG_ITLINE14_SR_TIM1_CC4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[15U], SYSCFG_ITLINE15_SR_TIM2) == (SYSCFG_ITLINE15_SR_TIM2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[16U], SYSCFG_ITLINE16_SR_TIM3) == (SYSCFG_ITLINE16_SR_TIM3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_TIM6) == (SYSCFG_ITLINE17_SR_TIM6)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[17U], SYSCFG_ITLINE17_SR_LPTIM1) == (SYSCFG_ITLINE17_SR_LPTIM1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[18U], SYSCFG_ITLINE18_SR_TIM7) == (SYSCFG_ITLINE18_SR_TIM7)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[18U], SYSCFG_ITLINE18_SR_LPTIM2) == (SYSCFG_ITLINE18_SR_LPTIM2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[19U], SYSCFG_ITLINE19_SR_TIM15) == (SYSCFG_ITLINE19_SR_TIM15)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[19U], SYSCFG_ITLINE19_SR_LPTIM3) == (SYSCFG_ITLINE19_SR_LPTIM3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[20U], SYSCFG_ITLINE20_SR_TIM16) == (SYSCFG_ITLINE20_SR_TIM16)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_TSC_MCE) == (SYSCFG_ITLINE21_SR_TSC_MCE)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[21U], SYSCFG_ITLINE21_SR_TSC_EOA) == (SYSCFG_ITLINE21_SR_TSC_EOA)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[22U], SYSCFG_ITLINE22_SR_LCD) == (SYSCFG_ITLINE22_SR_LCD)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[23U], SYSCFG_ITLINE23_SR_I2C1) == (SYSCFG_ITLINE23_SR_I2C1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C2) == (SYSCFG_ITLINE24_SR_I2C2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C3) == (SYSCFG_ITLINE24_SR_I2C3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[24U], SYSCFG_ITLINE24_SR_I2C4) == (SYSCFG_ITLINE24_SR_I2C4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[27U], SYSCFG_ITLINE27_SR_USART1) == (SYSCFG_ITLINE27_SR_USART1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[28U], SYSCFG_ITLINE28_SR_USART2) == (SYSCFG_ITLINE28_SR_USART2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[28U], SYSCFG_ITLINE28_SR_LPUART2) == (SYSCFG_ITLINE28_SR_LPUART2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_USART3) == (SYSCFG_ITLINE29_SR_USART3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[29U], SYSCFG_ITLINE29_SR_LPUART1) == (SYSCFG_ITLINE29_SR_LPUART1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[30U], SYSCFG_ITLINE30_SR_USART4) == (SYSCFG_ITLINE30_SR_USART4)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(SYSCFG->IT_LINE_SR[30U], SYSCFG_ITLINE30_SR_LPUART3) == (SYSCFG_ITLINE30_SR_LPUART3)) ? 1UL : 0UL);
}
...
/**
  ...
  * @note For STM32U083xx devices, the device ID is 0x460U
