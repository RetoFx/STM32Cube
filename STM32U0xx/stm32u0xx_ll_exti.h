...
#else
#define LL_EXTI_LINE_ALL_0_31          0xFBB3FFFFUL             /*!< ALL Extended line */
...
#else
#define LL_EXTI_LINE_ALL_32_63         0x0000002EUL             /*!< line 36 & line 32 are reserved*/
#endif /* EXTI_IMR2_IM36 & EXTI_IMR2_IM32 */
#define LL_EXTI_LINE_ALL               ((uint32_t)0xFFFFFFFFUL)  /*!< All Extended line */
#if defined(USE_FULL_LL_DRIVER)
#define LL_EXTI_LINE_NONE              ((uint32_t)0x00000000UL)  /*!< None Extended line */
#endif /*USE_FULL_LL_DRIVER*/
...
/** @defgroup SYSTEM_LL_EC_EXTI_LINE EXTI CONFIG LINE
  * @{
  */
#define LL_EXTI_CONFIG_LINE0               (uint32_t)(0U  << 16U | 0U)  /*!< EXTI_POSITION_0  | EXTICR[0U] */
#define LL_EXTI_CONFIG_LINE1               (uint32_t)(8U  << 16U | 0U)  /*!< EXTI_POSITION_8  | EXTICR[0U] */
#define LL_EXTI_CONFIG_LINE2               (uint32_t)(16UL << 16U | 0U)  /*!< EXTI_POSITION_16 | EXTICR[0U] */
#define LL_EXTI_CONFIG_LINE3               (uint32_t)(24UL << 16U | 0U)  /*!< EXTI_POSITION_24 | EXTICR[0U] */
#define LL_EXTI_CONFIG_LINE4               (uint32_t)(0U  << 16U | 1U)  /*!< EXTI_POSITION_0  | EXTICR[1U] */
#define LL_EXTI_CONFIG_LINE5               (uint32_t)(8U  << 16U | 1U)  /*!< EXTI_POSITION_8  | EXTICR[1U] */
#define LL_EXTI_CONFIG_LINE6               (uint32_t)(16UL << 16U | 1U)  /*!< EXTI_POSITION_16 | EXTICR[1U] */
#define LL_EXTI_CONFIG_LINE7               (uint32_t)(24UL << 16U | 1U)  /*!< EXTI_POSITION_24 | EXTICR[1U] */
#define LL_EXTI_CONFIG_LINE8               (uint32_t)(0U  << 16U | 2U)  /*!< EXTI_POSITION_0  | EXTICR[2U] */
#define LL_EXTI_CONFIG_LINE9               (uint32_t)(8U  << 16U | 2U)  /*!< EXTI_POSITION_8  | EXTICR[2U] */
#define LL_EXTI_CONFIG_LINE10              (uint32_t)(16UL << 16U | 2U)  /*!< EXTI_POSITION_16 | EXTICR[2U] */
#define LL_EXTI_CONFIG_LINE11              (uint32_t)(24UL << 16U | 2U)  /*!< EXTI_POSITION_24 | EXTICR[2U] */
#define LL_EXTI_CONFIG_LINE12              (uint32_t)(0U  << 16U | 3U)  /*!< EXTI_POSITION_0  | EXTICR[3U] */
#define LL_EXTI_CONFIG_LINE13              (uint32_t)(8U  << 16U | 3U)  /*!< EXTI_POSITION_8  | EXTICR[3U] */
#define LL_EXTI_CONFIG_LINE14              (uint32_t)(16UL << 16U | 3U)  /*!< EXTI_POSITION_16 | EXTICR[3U] */
#define LL_EXTI_CONFIG_LINE15              (uint32_t)(24UL << 16U | 3U)  /*!< EXTI_POSITION_24 | EXTICR[3U] */
/**
  * @}
  */
/**
...
{
  MODIFY_REG(EXTI->EXTICR[Line & 0xFFU], EXTI_EXTICR1_EXTI0 << (Line >> 16U), Port << (Line >> 16U));
}
...
{
  return (uint32_t)(READ_BIT(EXTI->EXTICR[Line & 0xFFU], (EXTI_EXTICR1_EXTI0 << (Line >> 16U))) >> (Line >> 16U));
}
/**
  * @}
  */
