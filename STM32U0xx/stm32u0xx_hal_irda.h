...
/**
  ...
  */
#if (USE_HAL_IRDA_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_IRDA_REGISTER_CALLBACKS == 1U)
  void (* TxHalfCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);        /*!< IRDA Tx Half Complete Callback        */

  void (* TxCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);            /*!< IRDA Tx Complete Callback             */

  void (* RxHalfCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);        /*!< IRDA Rx Half Complete Callback        */

  void (* RxCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);            /*!< IRDA Rx Complete Callback             */

  void (* ErrorCallback)(struct __IRDA_HandleTypeDef * const hirda);             /*!< IRDA Error Callback                   */

  void (* AbortCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);         /*!< IRDA Abort Complete Callback          */

  void (* AbortTransmitCpltCallback)(struct __IRDA_HandleTypeDef * const hirda); /*!< IRDA Abort Transmit Complete Callback */

  void (* AbortReceiveCpltCallback)(struct __IRDA_HandleTypeDef * const hirda);  /*!< IRDA Abort Receive Complete Callback  */


  void (* MspInitCallback)(struct __IRDA_HandleTypeDef * const hirda);           /*!< IRDA Msp Init callback                */

  void (* MspDeInitCallback)(struct __IRDA_HandleTypeDef * const hirda);         /*!< IRDA Msp DeInit callback              */
#endif  /* USE_HAL_IRDA_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef  void (*pIRDA_CallbackTypeDef)(IRDA_HandleTypeDef * const hirda);  /*!< pointer to an IRDA callback function */
...
/** @defgroup IRDA_State_Definition IRDA State Code Definition
  * @{
  */
#define HAL_IRDA_STATE_RESET                0x00000000UL   /*!< Peripheral is not initialized
                                                               Value is allowed for gState and RxState */
#define HAL_IRDA_STATE_READY                0x00000020UL   /*!< Peripheral Initialized and ready for use
                                                               Value is allowed for gState and RxState */
#define HAL_IRDA_STATE_BUSY                 0x00000024UL   /*!< An internal process is ongoing
                                                               Value is allowed for gState only */
#define HAL_IRDA_STATE_BUSY_TX              0x00000021UL   /*!< Data Transmission process is ongoing
                                                               Value is allowed for gState only */
#define HAL_IRDA_STATE_BUSY_RX              0x00000022UL   /*!< Data Reception process is ongoing
                                                               Value is allowed for RxState only */
#define HAL_IRDA_STATE_BUSY_TX_RX           0x00000023UL   /*!< Data Transmission and Reception process is ongoing
                                                               Not to be used for neither gState nor RxState.
                                                               Value is result of combination (Or) between
                                                               gState and RxState values */
#define HAL_IRDA_STATE_TIMEOUT              0x000000A0UL   /*!< Timeout state
                                                               Value is allowed for gState only */
#define HAL_IRDA_STATE_ERROR                0x000000E0UL   /*!< Error
                                                               Value is allowed for gState only */
/**
  * @}
  */
...
/** @defgroup IRDA_Error_Definition IRDA Error Code Definition
  * @{
  */
#define HAL_IRDA_ERROR_NONE                 (0x00000000UL)          /*!< No error                */
#define HAL_IRDA_ERROR_PE                   (0x00000001UL)          /*!< Parity error            */
#define HAL_IRDA_ERROR_NE                   (0x00000002UL)          /*!< Noise error             */
#define HAL_IRDA_ERROR_FE                   (0x00000004UL)          /*!< frame error             */
#define HAL_IRDA_ERROR_ORE                  (0x00000008UL)          /*!< Overrun error           */
#if defined(HAL_DMA_MODULE_ENABLED)
#define HAL_IRDA_ERROR_DMA                  (0x00000010UL)          /*!< DMA transfer error      */
#endif /* HAL_DMA_MODULE_ENABLED */
#define HAL_IRDA_ERROR_BUSY                 (0x00000020UL)          /*!< Busy Error              */
#if (USE_HAL_IRDA_REGISTER_CALLBACKS == 1U)
#define HAL_IRDA_ERROR_INVALID_CALLBACK     (0x00000040UL)          /*!< Invalid Callback error  */
#endif /* USE_HAL_IRDA_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup IRDA_Parity IRDA Parity
  * @{
  */
#define IRDA_PARITY_NONE                    0x00000000UL                      /*!< No parity   */
...
/** @defgroup IRDA_Low_Power IRDA Low Power
  * @{
  */
#define IRDA_POWERMODE_NORMAL               0x00000000UL       /*!< IRDA normal power mode */
...
/** @defgroup IRDA_ClockPrescaler IRDA Clock Prescaler
  * @{
  */
#define IRDA_PRESCALER_DIV1    0x00000000UL  /*!< fclk_pres = fclk     */
#define IRDA_PRESCALER_DIV2    0x00000001UL  /*!< fclk_pres = fclk/2   */
#define IRDA_PRESCALER_DIV4    0x00000002UL  /*!< fclk_pres = fclk/4   */
#define IRDA_PRESCALER_DIV6    0x00000003UL  /*!< fclk_pres = fclk/6   */
#define IRDA_PRESCALER_DIV8    0x00000004UL  /*!< fclk_pres = fclk/8   */
#define IRDA_PRESCALER_DIV10   0x00000005UL  /*!< fclk_pres = fclk/10  */
#define IRDA_PRESCALER_DIV12   0x00000006UL  /*!< fclk_pres = fclk/12  */
#define IRDA_PRESCALER_DIV16   0x00000007UL  /*!< fclk_pres = fclk/16  */
#define IRDA_PRESCALER_DIV32   0x00000008UL  /*!< fclk_pres = fclk/32  */
#define IRDA_PRESCALER_DIV64   0x00000009UL  /*!< fclk_pres = fclk/64  */
#define IRDA_PRESCALER_DIV128  0x0000000AUL  /*!< fclk_pres = fclk/128 */
#define IRDA_PRESCALER_DIV256  0x0000000BUL  /*!< fclk_pres = fclk/256 */
/**
  * @}
  */
...
/** @defgroup IRDA_State IRDA State
  * @{
  */
#define IRDA_STATE_DISABLE                  0x00000000UL     /*!< IRDA disabled  */
...
/** @defgroup IRDA_Mode IRDA Mode
  * @{
  */
#define IRDA_MODE_DISABLE                   0x00000000UL      /*!< Associated UART disabled in IRDA mode */
...
/** @defgroup IRDA_One_Bit IRDA One Bit Sampling
  * @{
  */
#define IRDA_ONE_BIT_SAMPLE_DISABLE         0x00000000UL       /*!< One-bit sampling disabled */
...
/** @defgroup IRDA_DMA_Tx IRDA DMA Tx
  * @{
  */
#define IRDA_DMA_TX_DISABLE                 0x00000000UL       /*!< IRDA DMA TX disabled */
...
/** @defgroup IRDA_DMA_Rx IRDA DMA Rx
  * @{
  */
#define IRDA_DMA_RX_DISABLE                 0x00000000UL       /*!< IRDA DMA RX disabled */
...
#define __HAL_IRDA_GET_IT(__HANDLE__, __INTERRUPT__) \
  ((((__HANDLE__)->Instance->ISR& (0x01UL << (((__INTERRUPT__) & IRDA_ISR_MASK)>>IRDA_ISR_POS))) != 0U) ? SET : RESET)
...
/** @brief  Ensure that IRDA Baud rate is less or equal to maximum value.
  ...
  */
#define IS_IRDA_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) < 115201UL)
...
HAL_StatusTypeDef HAL_IRDA_Init(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_DeInit(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_MspInit(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_MspDeInit(IRDA_HandleTypeDef * const hirda);

#if (USE_HAL_IRDA_REGISTER_CALLBACKS == 1U)
/* Callbacks Register/UnRegister functions  ***********************************/
HAL_StatusTypeDef HAL_IRDA_RegisterCallback(IRDA_HandleTypeDef * const hirda, HAL_IRDA_CallbackIDTypeDef CallbackID,
                                            pIRDA_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_IRDA_UnRegisterCallback(IRDA_HandleTypeDef * const hirda, HAL_IRDA_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_IRDA_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_IRDA_Transmit(IRDA_HandleTypeDef * const hirda, uint8_t const * const pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_IRDA_Receive(IRDA_HandleTypeDef * const hirda, uint8_t * const pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_IRDA_Transmit_IT(IRDA_HandleTypeDef * const hirda, uint8_t const * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_IRDA_Receive_IT(IRDA_HandleTypeDef * const hirda, uint8_t * const pData, uint16_t Size);
#if defined(HAL_DMA_MODULE_ENABLED)
HAL_StatusTypeDef HAL_IRDA_Transmit_DMA(IRDA_HandleTypeDef * const hirda, uint8_t const * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_IRDA_Receive_DMA(IRDA_HandleTypeDef * const hirda, uint8_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_IRDA_DMAPause(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_DMAResume(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_DMAStop(IRDA_HandleTypeDef * const hirda);
#endif /* HAL_DMA_MODULE_ENABLED */
/* Transfer Abort functions */
HAL_StatusTypeDef HAL_IRDA_Abort(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_AbortTransmit(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_AbortReceive(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_Abort_IT(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_AbortTransmit_IT(IRDA_HandleTypeDef * const hirda);
HAL_StatusTypeDef HAL_IRDA_AbortReceive_IT(IRDA_HandleTypeDef * const hirda);

void HAL_IRDA_IRQHandler(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_TxCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_RxCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_TxHalfCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_RxHalfCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_ErrorCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_AbortCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_AbortTransmitCpltCallback(IRDA_HandleTypeDef * const hirda);
void HAL_IRDA_AbortReceiveCpltCallback(IRDA_HandleTypeDef * const hirda);
...
HAL_IRDA_StateTypeDef HAL_IRDA_GetState(IRDA_HandleTypeDef const * const hirda);
uint32_t              HAL_IRDA_GetError(IRDA_HandleTypeDef const * const hirda);
