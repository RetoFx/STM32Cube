...
#define OPTIONBYTE_HDP                  0x00000008UL  /*!< HDP option byte configuration */
#define OPTIONBYTE_RDPKEY               0x00000010UL  /*!< RDP OEM KEYs option byte configuration */
...
/** @defgroup FLASH_OB_SEC_BOOT_LOCK FLASH Option Bytes Secure boot lock
  * @{
  */
#define OB_BOOT_LOCK_DISABLE        0x00000000UL               /*!< Boot Lock is free */
