...
/** @defgroup RNG_LL_CED Clock Error Detection
  * @{
  */
#define LL_RNG_CED_ENABLE         0x00000000UL              /*!< Clock error detection enabled  */
...
/** @defgroup RNG_LL_ARDIS Auto reset disable
  * @{
  */
#define LL_RNG_ARDIS_ENABLE         0x00000000UL              /*!< ARDIS enabled automatic reset to clear SECS bit*/
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_Enable(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_Disable(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabled(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_EnableClkErrorDetect(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_DisableClkErrorDetect(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledClkErrorDetect(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_EnableCondReset(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_DisableCondReset(RNG_TypeDef * const RNGx)
{
  CLEAR_BIT(RNGx->CR, RNG_CR_CONDRST);
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledCondReset(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_ConfigLock(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsConfigLocked(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_EnableNistCompliance(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_DisableNistCompliance(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledNistCompliance(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @param  Config1 Value between 0 and 0x3FU
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetConfig1(RNG_TypeDef * const RNGx, uint32_t Config1)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @retval Returned Value expressed on 6 bits : Value between 0 and 0x3FU
  */
__STATIC_INLINE uint32_t LL_RNG_GetConfig1(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @param  Config2 Value between 0 and 0x7U
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetConfig2(RNG_TypeDef * const RNGx, uint32_t Config2)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @retval Returned Value expressed on 3 bits : Value between 0 and 0x7U
  */
__STATIC_INLINE uint32_t LL_RNG_GetConfig2(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @param  Config3 Value between 0 and 0xFU
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetConfig3(RNG_TypeDef * const RNGx, uint32_t Config3)
{
...
/**
  ...
  * @param  RNGx RNG Instance
  * @retval Returned Value expressed on 4 bits : Value between 0 and 0xFU
  */
__STATIC_INLINE uint32_t LL_RNG_GetConfig3(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetClockDivider(RNG_TypeDef * const RNGx, uint32_t Divider)
{
...
/**
  ...
  *         @arg @ref LL_RNG_CLKDIV_BY_32768
  */
__STATIC_INLINE uint32_t LL_RNG_GetClockDivider(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_DRDY(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_CECS(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_SECS(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_CEIS(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsActiveFlag_SEIS(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_ClearFlag_CEIS(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_ClearFlag_SEIS(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_EnableIT(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_DisableIT(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledIT(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RNG_ReadRandData32(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_EnableArdis(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_DisableArdis(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsEnabledArdis(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetHealthConfig(RNG_TypeDef * const RNGx, uint32_t HTCFG)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RNG_GetHealthConfig(RNG_TypeDef const * const RNGx)
{
...
/** @defgroup RNG_LL_EF_Init Initialization and de-initialization functions
  * @{
  */
ErrorStatus LL_RNG_Init(RNG_TypeDef * const RNGx, LL_RNG_InitTypeDef const * const RNG_InitStruct);
void LL_RNG_StructInit(LL_RNG_InitTypeDef * const RNG_InitStruct);
ErrorStatus LL_RNG_DeInit(RNG_TypeDef const * const RNGx);
