...
/** @defgroup EXTI_Private_Constants EXTI Private Constants
  * @{
  */
#define EXTI_MODE_OFFSET                    0x08U   /* 0x20U: offset between MCU IMR/EMR registers */
#define EXTI_CONFIG_OFFSET                  0x08U   /* 0x20U: offset between MCU Rising/Falling configuration registers */
/**
  * @}
  */
