...
/**
  ...
  */
#if (USE_HAL_PSSI_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_PSSI_REGISTER_CALLBACKS == 1U)
  void (* TxCpltCallback)(struct __PSSI_HandleTypeDef * const hpssi);    /*!< PSSI transfer complete callback. */
  void (* RxCpltCallback)(struct __PSSI_HandleTypeDef * const hpssi);    /*!< PSSI transfer complete callback. */
  void (* ErrorCallback)(struct __PSSI_HandleTypeDef * const hpssi);     /*!< PSSI transfer complete callback. */
  void (* AbortCpltCallback)(struct __PSSI_HandleTypeDef * const hpssi); /*!< PSSI transfer error callback.    */

  void (* MspInitCallback)(struct __PSSI_HandleTypeDef * const hpssi);   /*!< PSSI Msp Init callback.          */
  void (* MspDeInitCallback)(struct __PSSI_HandleTypeDef * const hpssi); /*!< PSSI Msp DeInit callback.        */
#endif /* USE_HAL_PSSI_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef  void (*pPSSI_CallbackTypeDef)(PSSI_HandleTypeDef * const hpssi);  /*!< Pointer to a PSSI common callback function */
...
/** @defgroup PSSI_Error_Code PSSI Error Code
  * @{
  */
#define HAL_PSSI_ERROR_NONE             0x00000000UL /*!< No error                */
#define HAL_PSSI_ERROR_NOT_SUPPORTED    0x00000001UL /*!< Not supported operation */
#define HAL_PSSI_ERROR_UNDER_RUN        0x00000002UL /*!< FIFO Under-run error    */
#define HAL_PSSI_ERROR_OVER_RUN         0x00000004UL /*!< FIFO Over-run  error    */
#define HAL_PSSI_ERROR_DMA              0x00000008UL /*!< Dma     error           */
#define HAL_PSSI_ERROR_TIMEOUT          0x00000010UL /*!< Timeout error           */
#if (USE_HAL_PSSI_REGISTER_CALLBACKS == 1U)
#define HAL_PSSI_ERROR_INVALID_CALLBACK 0x00000020UL /*!< Invalid callback error  */
#endif /* USE_HAL_PSSI_REGISTER_CALLBACKS */
...
#define HAL_PSSI_8BITS                  0x00000000UL   /*!<  8 Bits  */
#define HAL_PSSI_16BITS                 0x00000001UL   /*!< 16 Bits  */
#define HAL_PSSI_32BITS                 0x00000002UL   /*!< 32 Bits  */
/**
  * @}
  */
...
#define HAL_PSSI_8LINES                 0x00000000UL   /*!< 8 data lines  */
...
/** @defgroup PSSI_MODE PSSI mode
  * @{
  */
#define HAL_PSSI_UNIDIRECTIONAL         0x00000000UL /*!< Uni-directional mode */
#define HAL_PSSI_BIDIRECTIONAL          0x00000001UL /*!< Bi-directional mode  */
/**
  * @}
  */
...
#define PSSI_MAX_NBYTE_SIZE         0x10000UL         /* 64 KB */
#define PSSI_TIMEOUT_TRANSMIT       0x0000FFFFUL      /*!< Timeout Value   */

#define PSSI_CR_OUTEN_INPUT         0x00000000UL      /*!< Input Mode      */
...
HAL_StatusTypeDef HAL_PSSI_Init(PSSI_HandleTypeDef * const hpssi);
HAL_StatusTypeDef HAL_PSSI_DeInit(PSSI_HandleTypeDef * const hpssi);
void              HAL_PSSI_MspInit(PSSI_HandleTypeDef * const hpssi);
void              HAL_PSSI_MspDeInit(PSSI_HandleTypeDef * const hpssi);
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_PSSI_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_PSSI_RegisterCallback(PSSI_HandleTypeDef * const hpssi, HAL_PSSI_CallbackIDTypeDef CallbackID,
                                            pPSSI_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_PSSI_UnRegisterCallback(PSSI_HandleTypeDef * const hpssi, HAL_PSSI_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_PSSI_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_PSSI_Transmit(PSSI_HandleTypeDef * const hpssi, uint8_t const * const pData, uint32_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_PSSI_Receive(PSSI_HandleTypeDef * const hpssi, uint8_t * const pData, uint32_t Size, uint32_t Timeout);
#if defined(HAL_DMA_MODULE_ENABLED)
HAL_StatusTypeDef HAL_PSSI_Transmit_DMA(PSSI_HandleTypeDef * const hpssi, uint32_t const * const pData, uint32_t Size);
HAL_StatusTypeDef HAL_PSSI_Receive_DMA(PSSI_HandleTypeDef * const hpssi, uint32_t * const pData, uint32_t Size);
HAL_StatusTypeDef HAL_PSSI_Abort_DMA(PSSI_HandleTypeDef * const hpssi);
#endif /*HAL_DMA_MODULE_ENABLED*/
...
HAL_PSSI_StateTypeDef HAL_PSSI_GetState(PSSI_HandleTypeDef const * const hpssi);
uint32_t              HAL_PSSI_GetError(PSSI_HandleTypeDef const * const hpssi);
...
void HAL_PSSI_IRQHandler(PSSI_HandleTypeDef * const hpssi);
void HAL_PSSI_TxCpltCallback(PSSI_HandleTypeDef * const hpssi);
void HAL_PSSI_RxCpltCallback(PSSI_HandleTypeDef * const hpssi);
void HAL_PSSI_ErrorCallback(PSSI_HandleTypeDef * const hpssi);
void HAL_PSSI_AbortCpltCallback(PSSI_HandleTypeDef * const hpssi);
