...
/** @defgroup RTC_LL_Private_Constants RTC Private Constants
  ...
  */
/* Masks Definition */
#define RTC_LL_INIT_MASK              0xFFFFFFFFUL
#define RTC_LL_RSF_MASK               0xFFFFFF5FUL
...
typedef struct
{
  ...
  uint32_t AsynchPrescaler; /*!< Specifies the RTC Asynchronous Predivider value.
                              This parameter must be a number between Min_Data = 0x00U and Max_Data = 0x7FU

                              This feature can be modified afterwards using unitary function
                              @ref LL_RTC_SetAsynchPrescaler(). */

  uint32_t SynchPrescaler;  /*!< Specifies the RTC Synchronous Predivider value.
                              This parameter must be a number between Min_Data = 0x00U and Max_Data = 0x7FFFU
...
/** @defgroup RTC_LL_EC_FORMAT FORMAT
  * @{
  */
#define LL_RTC_FORMAT_BIN                  0x00000000UL /*!< Binary data format */
#define LL_RTC_FORMAT_BCD                  0x00000001UL /*!< BCD data format */
/**
  * @}
  */
...
/** @defgroup RTC_LL_EC_ALMA_WEEKDAY_SELECTION RTC Alarm A Date WeekDay
  * @{
  */
#define LL_RTC_ALMA_DATEWEEKDAYSEL_DATE    0x00000000UL             /*!< Alarm A Date is selected */
...
/** @defgroup RTC_LL_EC_ALMB_WEEKDAY_SELECTION RTC Alarm B Date WeekDay
  * @{
  */
#define LL_RTC_ALMB_DATEWEEKDAYSEL_DATE    0x00000000UL             /*!< Alarm B Date is selected */
...
/** @defgroup RTC_LL_EC_HOURFORMAT  HOUR FORMAT
  * @{
  */
#define LL_RTC_HOURFORMAT_24HOUR           0x00000000UL           /*!< 24 hour/day format */
...
/** @defgroup RTC_LL_EC_ALARMOUT  ALARM OUTPUT
  * @{
  */
#define LL_RTC_ALARMOUT_DISABLE            0x00000000UL             /*!< Output disabled */
...
#define LL_RTC_ALARM_OUTPUTTYPE_PUSHPULL   0x00000000UL            /*!< RTC_ALARM is push-pull output */
#else /* #if defined(STM32L412xx) || defined(STM32L422xx) || defined (STM32L4P5xx) || defined (STM32L4Q5xx) */
#define LL_RTC_ALARM_OUTPUTTYPE_OPENDRAIN  0x00000000UL            /*!< RTC_ALARM is open-drain output */
...
/** @defgroup RTC_LL_EC_OUTPUTPOLARITY_PIN  OUTPUT POLARITY PIN
  * @{
  */
#define LL_RTC_OUTPUTPOLARITY_PIN_HIGH     0x00000000UL           /*!< Pin is high when ALRAF/ALRBF/WUTF is asserted (depending on OSEL)*/
...
/** @defgroup RTC_LL_EC_TIME_FORMAT TIME FORMAT
  * @{
  */
#define LL_RTC_TIME_FORMAT_AM_OR_24        0x00000000UL           /*!< AM or 24-hour format */
...
/** @defgroup RTC_LL_EC_SHIFT_SECOND  SHIFT SECOND
  * @{
  */
#define LL_RTC_SHIFT_SECOND_DELAY          0x00000000UL           /* Delay (seconds) = SUBFS / (PREDIV_S + 1) */
...
/** @defgroup RTC_LL_EC_ALMA_MASK  ALARMA MASK
  * @{
  */
#define LL_RTC_ALMA_MASK_NONE              0x00000000UL             /*!< No masks applied on Alarm A*/
...
/** @defgroup RTC_LL_EC_ALMA_TIME_FORMAT  ALARMA TIME FORMAT
  * @{
  */
#define LL_RTC_ALMA_TIME_FORMAT_AM         0x00000000UL           /*!< AM or 24-hour format */
...
#define LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES   RTC_ALRMASSR_SSCLR   /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFU FFFF to
                                                                          RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFFU FFFF
...
/** @defgroup RTC_LL_EC_ALMB_MASK  ALARMB MASK
  * @{
  */
#define LL_RTC_ALMB_MASK_NONE              0x00000000UL             /*!< No masks applied on Alarm B*/
...
/** @defgroup RTC_LL_EC_ALMB_TIME_FORMAT  ALARMB TIME FORMAT
  * @{
  */
#define LL_RTC_ALMB_TIME_FORMAT_AM         0x00000000UL           /*!< AM or 24-hour format */
...
#define LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES   RTC_ALRMBSSR_SSCLR   /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFFU FFFF to
                                                                          RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFFU FFFF
                                                                          when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
  * @}
...
/** @defgroup RTC_LL_EC_TIMESTAMP_EDGE  TIMESTAMP EDGE
  * @{
  */
#define LL_RTC_TIMESTAMP_EDGE_RISING       0x00000000UL           /*!< RTC_TS input rising edge generates a time-stamp event */
...
/** @defgroup RTC_LL_EC_TS_TIME_FORMAT  TIMESTAMP TIME FORMAT
  * @{
  */
#define LL_RTC_TS_TIME_FORMAT_AM           0x00000000UL           /*!< AM or 24-hour format */
...
/** @defgroup RTC_LL_EC_TAMPER_DURATION  TAMPER DURATION
  * @{
  */
#define LL_RTC_TAMPER_DURATION_1RTCCLK     0x00000000UL            /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK cycle  */
...
/** @defgroup RTC_LL_EC_TAMPER_FILTER  TAMPER FILTER
  * @{
  */
#define LL_RTC_TAMPER_FILTER_DISABLE       0x00000000UL             /*!< Tamper filter is disabled */
...
/** @defgroup RTC_LL_EC_TAMPER_SAMPLFREQDIV  TAMPER SAMPLING FREQUENCY DIVIDER
  * @{
  */
#define LL_RTC_TAMPER_SAMPLFREQDIV_32768   0x00000000UL                                     /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 32768 */
...
/** @defgroup RTC_LL_EC_WAKEUPCLOCK_DIV  WAKEUP CLOCK DIV
  * @{
  */
#define LL_RTC_WAKEUPCLOCK_DIV_16          0x00000000UL                           /*!< RTC/16 clock is selected */
...
/** @defgroup RTC_LL_EC_BKP  BACKUP
  * @{
  */
#define LL_RTC_BKP_DR0                     0x00000000UL
#define LL_RTC_BKP_DR1                     0x00000001UL
#define LL_RTC_BKP_DR2                     0x00000002UL
#define LL_RTC_BKP_DR3                     0x00000003UL
#define LL_RTC_BKP_DR4                     0x00000004UL
#if RTC_BKP_NUMBER > 5
#define LL_RTC_BKP_DR5                     0x00000005UL
#define LL_RTC_BKP_DR6                     0x00000006UL
#define LL_RTC_BKP_DR7                     0x00000007UL
#define LL_RTC_BKP_DR8                     0x00000008UL
#define LL_RTC_BKP_DR9                     0x00000009UL
#define LL_RTC_BKP_DR10                    0x0000000AUL
#define LL_RTC_BKP_DR11                    0x0000000BUL
#define LL_RTC_BKP_DR12                    0x0000000CUL
#define LL_RTC_BKP_DR13                    0x0000000DUL
#define LL_RTC_BKP_DR14                    0x0000000EUL
#define LL_RTC_BKP_DR15                    0x0000000FUL
#endif /* RTC_BKP_NUMBER > 5 */

#if RTC_BKP_NUMBER > 16
#define LL_RTC_BKP_DR16                    0x00000010UL
#define LL_RTC_BKP_DR17                    0x00000011UL
#define LL_RTC_BKP_DR18                    0x00000012UL
#define LL_RTC_BKP_DR19                    0x00000013UL
#endif /* RTC_BKP_NUMBER > 16 */

#if RTC_BKP_NUMBER > 20
#define LL_RTC_BKP_DR20                    0x00000014UL
#define LL_RTC_BKP_DR21                    0x00000015UL
#define LL_RTC_BKP_DR22                    0x00000016UL
#define LL_RTC_BKP_DR23                    0x00000017UL
#define LL_RTC_BKP_DR24                    0x00000018UL
#define LL_RTC_BKP_DR25                    0x00000019UL
#define LL_RTC_BKP_DR26                    0x0000001AUL
#define LL_RTC_BKP_DR27                    0x0000001BUL
#define LL_RTC_BKP_DR28                    0x0000001CUL
#define LL_RTC_BKP_DR29                    0x0000001DUL
#define LL_RTC_BKP_DR30                    0x0000001EUL
#define LL_RTC_BKP_DR31                    0x0000001FUL
...
/** @defgroup RTC_LL_EC_CALIB_OUTPUT  Calibration output
  * @{
  */
#define LL_RTC_CALIB_OUTPUT_NONE           0x00000000UL                 /*!< Calibration output disabled */
...
/** @defgroup RTC_LL_EC_CALIB_INSERTPULSE  Calibration pulse insertion
  * @{
  */
#define LL_RTC_CALIB_INSERTPULSE_NONE      0x00000000UL           /*!< No RTCCLK pulses are added */
...
/** @defgroup RTC_LL_EC_CALIB_PERIOD  Calibration period
  * @{
  */
#define LL_RTC_CALIB_PERIOD_32SEC          0x00000000UL           /*!< Use a 32-second calibration cycle period */
...
/** @defgroup RTC_LL_EC_CALIB_LOWPOWER  Calibration low power
  * @{
  */
#define LL_RTC_CALIB_LOWPOWER_NONE         0x00000000UL           /*!< High conso mode */
...
/** @defgroup RTC_LL_EC_BINARY_MODE  Binary mode (Sub Second Register)
  * @{
  */
#define LL_RTC_BINARY_NONE  0x00000000UL     /*!< Free running BCD calendar mode (Binary mode disabled). */
...
/** @defgroup RTC_LL_EC_BINARY_MIX_BCDU  Calendar second incrementation in Binary mix mode
  * @{
  */
#define LL_RTC_BINARY_MIX_BCDU_0  0x00000000UL                    /*!<  1s calendar increment is generated each time SS[7:0] = 0 */
...
/**
  ...
  */
#define __LL_RTC_GET_WEEKDAY(__RTC_DATE__) (((__RTC_DATE__) >> RTC_OFFSET_WEEKDAY) & 0x000000FFUL)

/**
  * @brief  Helper macro to retrieve Year in BCD format
  * @param  __RTC_DATE__ Value returned by @ref  LL_RTC_DATE_Get
  * @retval Year in BCD format (0x00U . . . 0x99U)
  */
#define __LL_RTC_GET_YEAR(__RTC_DATE__) ((__RTC_DATE__) & 0x000000FFUL)
...
/**
  ...
  */
#define __LL_RTC_GET_MONTH(__RTC_DATE__) (((__RTC_DATE__) >>RTC_OFFSET_MONTH) & 0x000000FFUL)

/**
  * @brief  Helper macro to retrieve Day in BCD format
  * @param  __RTC_DATE__ Value returned by @ref  LL_RTC_DATE_Get
  * @retval Day in BCD format (0x01U . . . 0x31U)
  */
#define __LL_RTC_GET_DAY(__RTC_DATE__) (((__RTC_DATE__) >>RTC_OFFSET_DAY) & 0x000000FFUL)
...
/**
  ...
  * @retval Hours in BCD format (0x01U. . .0x12U or between Min_Data=0x00U and Max_Data=0x23U)
  */
#define __LL_RTC_GET_HOUR(__RTC_TIME__) (((__RTC_TIME__) >> RTC_OFFSET_HOUR) & 0x000000FFUL)

/**
  * @brief  Helper macro to retrieve minute in BCD format
  * @param  __RTC_TIME__ RTC time returned by @ref LL_RTC_TIME_Get function
  * @retval Minutes in BCD format (0x00U. . .0x59U)
  */
#define __LL_RTC_GET_MINUTE(__RTC_TIME__) (((__RTC_TIME__) >> RTC_OFFSET_MINUTE) & 0x000000FFUL)

/**
  * @brief  Helper macro to retrieve second in BCD format
  * @param  __RTC_TIME__ RTC time returned by @ref LL_RTC_TIME_Get function
  * @retval Seconds in  format (0x00U. . .0x59U)
  */
#define __LL_RTC_GET_SECOND(__RTC_TIME__) ((__RTC_TIME__) & 0x000000FFUL)
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetHourFormat(RTC_TypeDef * const RTCx, uint32_t HourFormat)
{
...
/**
  ...
  *         @arg @ref LL_RTC_HOURFORMAT_AMPM
  */
__STATIC_INLINE uint32_t LL_RTC_GetHourFormat(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetAlarmOutEvent(RTC_TypeDef * const RTCx, uint32_t AlarmOutput)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALARMOUT_WAKEUP
  */
__STATIC_INLINE uint32_t LL_RTC_GetAlarmOutEvent(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetAlarmOutputType(RTC_TypeDef * const RTCx, uint32_t Output)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALARM_OUTPUTTYPE_PUSHPULL
  */
__STATIC_INLINE uint32_t LL_RTC_GetAlarmOutputType(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableInitMode(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableInitMode(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetBinaryMode(RTC_TypeDef * const RTCx, uint32_t BinaryMode)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_GetBinaryMode(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetBinMixBCDU(RTC_TypeDef * const RTCx, uint32_t BinMixBcdU)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE uint32_t LL_RTC_GetBinMixBCDU(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetOutputPolarity(RTC_TypeDef * const RTCx, uint32_t Polarity)
{
...
/**
  ...
  *         @arg @ref LL_RTC_OUTPUTPOLARITY_PIN_LOW
  */
__STATIC_INLINE uint32_t LL_RTC_GetOutputPolarity(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableShadowRegBypass(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableShadowRegBypass(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_IsShadowRegBypassEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableRefClock(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableRefClock(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  AsynchPrescaler Value between Min_Data = 0 and Max_Data = 0x7FU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetAsynchPrescaler(RTC_TypeDef * const RTCx, uint32_t AsynchPrescaler)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  SynchPrescaler Value between Min_Data = 0 and Max_Data = 0x7FFFU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_SetSynchPrescaler(RTC_TypeDef * const RTCx, uint32_t SynchPrescaler)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data = 0 and Max_Data = 0x7FU
  */
__STATIC_INLINE uint32_t LL_RTC_GetAsynchPrescaler(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data = 0 and Max_Data = 0x7FFFU
  */
__STATIC_INLINE uint32_t LL_RTC_GetSynchPrescaler(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableWriteProtection(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableWriteProtection(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableTamperOutput(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableTamperOutput(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsTamperOutputEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableAlarmPullUp(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableAlarmPullUp(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsAlarmPullUpEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableOutput2(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableOutput2(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsOutput2Enabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableOutRemap(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableOutRemap(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_SetFormat(RTC_TypeDef * const RTCx, uint32_t TimeFormat)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TIME_FORMAT_PM
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_GetFormat(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Hours Value between Min_Data=0x01U and Max_Data=0x12U or between Min_Data=0x00U and Max_Data=0x23U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_SetHour(RTC_TypeDef * const RTCx, uint32_t Hours)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x01U and Max_Data=0x12U or between Min_Data=0x00U and Max_Data=0x23U
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_GetHour(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Minutes Value between Min_Data=0x00U and Max_Data=0x59U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_SetMinute(RTC_TypeDef * const RTCx, uint32_t Minutes)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_GetMinute(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Seconds Value between Min_Data=0x00U and Max_Data=0x59U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_SetSecond(RTC_TypeDef * const RTCx, uint32_t Seconds)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_GetSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_Config(RTC_TypeDef * const RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
  uint32_t temp = 0U;
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_Get(RTC_TypeDef const * const RTCx)
{
  uint32_t temp = 0U;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_EnableDayLightStore(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_DisableDayLightStore(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_IsDayLightStoreEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_DecHour(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_IncHour(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval If binary mode is none, Value between Min_Data=0x0U and Max_Data=0x7FFFU
  *         else Value between Min_Data=0x0U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_TIME_GetSubSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  Fraction Number of Seconds Fractions (any value from 0 to 0x7FFFU)
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TIME_Synchronize(RTC_TypeDef * const RTCx, uint32_t ShiftSecond, uint32_t Fraction)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Year Value between Min_Data=0x00U and Max_Data=0x99U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DATE_SetYear(RTC_TypeDef * const RTCx, uint32_t Year)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x00U and Max_Data=0x99U
  */
__STATIC_INLINE uint32_t LL_RTC_DATE_GetYear(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DATE_SetWeekDay(RTC_TypeDef * const RTCx, uint32_t WeekDay)
{
...
/**
  ...
  *         @arg @ref LL_RTC_WEEKDAY_SUNDAY
  */
__STATIC_INLINE uint32_t LL_RTC_DATE_GetWeekDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DATE_SetMonth(RTC_TypeDef * const RTCx, uint32_t Month)
{
...
/**
  ...
  *         @arg @ref LL_RTC_MONTH_DECEMBER
  */
__STATIC_INLINE uint32_t LL_RTC_DATE_GetMonth(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Day Value between Min_Data=0x01U and Max_Data=0x31U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DATE_SetDay(RTC_TypeDef * const RTCx, uint32_t Day)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x01U and Max_Data=0x31U
  */
__STATIC_INLINE uint32_t LL_RTC_DATE_GetDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DATE_Config(RTC_TypeDef * const RTCx, uint32_t WeekDay, uint32_t Day, uint32_t Month, uint32_t Year)
{
  uint32_t temp = 0U;
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_DATE_Get(RTC_TypeDef const * const RTCx)
{
  uint32_t temp = 0U;
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_Enable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_Disable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetMask(RTC_TypeDef * const RTCx, uint32_t Mask)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMA_MASK_ALL
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetMask(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_EnableWeekday(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_DisableWeekday(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetDay(RTC_TypeDef * const RTCx, uint32_t Day)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x31U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetWeekDay(RTC_TypeDef * const RTCx, uint32_t WeekDay)
{
...
/**
  ...
  *         @arg @ref LL_RTC_WEEKDAY_SUNDAY
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetWeekDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetTimeFormat(RTC_TypeDef * const RTCx, uint32_t TimeFormat)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMA_TIME_FORMAT_PM
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetTimeFormat(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetHour(RTC_TypeDef * const RTCx, uint32_t Hours)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x12U or between Min_Data=0x00U and Max_Data=0x23U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetHour(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetMinute(RTC_TypeDef * const RTCx, uint32_t Minutes)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetMinute(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetSecond(RTC_TypeDef * const RTCx, uint32_t Seconds)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_ConfigTime(RTC_TypeDef * const RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
  uint32_t temp = 0U;
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetTime(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Mask If binary mode is none, Value between Min_Data=0x0U and Max_Data=0xFU
  *              else Value between Min_Data=0x0U and Max_Data=0x3FU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetSubSecondMask(RTC_TypeDef * const RTCx, uint32_t Mask)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval If binary mode is none, Value between Min_Data=0x0U and Max_Data=0xFU
  *         else Value between Min_Data=0x0U and Max_Data=0x3FU
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetSubSecondMask(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetBinAutoClr(RTC_TypeDef * const RTCx, uint32_t BinaryAutoClr)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetBinAutoClr(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Subsecond  If binary mode is none, Value between Min_Data=0x0U and Max_Data=0x7FFFU
  *                    else Value between Min_Data=0x0U and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetSubSecond(RTC_TypeDef * const RTCx, uint32_t Subsecond)
{
...
/**
  ...
  *         else Value between Min_Data=0x0U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetSubSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Subsecond Value between Min_Data=0x00U and Max_Data=0x7FFFU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMA_SetSubSecond(RTC_TypeDef * const RTCx, uint32_t Subsecond)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x00U and Max_Data=0x7FFFU
  */
__STATIC_INLINE uint32_t LL_RTC_ALMA_GetSubSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_Enable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_Disable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetMask(RTC_TypeDef * const RTCx, uint32_t Mask)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMB_MASK_ALL
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetMask(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_EnableWeekday(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_DisableWeekday(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetDay(RTC_TypeDef * const RTCx, uint32_t Day)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x31U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetWeekDay(RTC_TypeDef * const RTCx, uint32_t WeekDay)
{
...
/**
  ...
  *         @arg @ref LL_RTC_WEEKDAY_SUNDAY
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetWeekDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetTimeFormat(RTC_TypeDef * const RTCx, uint32_t TimeFormat)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMB_TIME_FORMAT_PM
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetTimeFormat(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetHour(RTC_TypeDef * const RTCx, uint32_t Hours)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x12U or between Min_Data=0x00U and Max_Data=0x23U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetHour(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Minutes between Min_Data=0x00U and Max_Data=0x59U
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetMinute(RTC_TypeDef * const RTCx, uint32_t Minutes)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetMinute(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetSecond(RTC_TypeDef * const RTCx, uint32_t Seconds)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_ConfigTime(RTC_TypeDef * const RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
  uint32_t temp = 0U;
...
/**
  ...
  * @retval Combination of hours, minutes and seconds.
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetTime(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetSubSecondMask(RTC_TypeDef * const RTCx, uint32_t Mask)
{
...
/**
  ...
  *         else Value between Min_Data=0x0U and Max_Data=0x3FU
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetSubSecondMask(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetBinAutoClr(RTC_TypeDef * const RTCx, uint32_t BinaryAutoClr)
{
...
/**
  ...
  *         @arg @ref LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetBinAutoClr(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ALMB_SetSubSecond(RTC_TypeDef * const RTCx, uint32_t Subsecond)
{
...
/**
  ...
  *         else Value between Min_Data=0x0U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_ALMB_GetSubSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_EnableInternalEvent(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_DisableInternalEvent(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_Enable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_Disable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_SetActiveEdge(RTC_TypeDef * const RTCx, uint32_t Edge)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TIMESTAMP_EDGE_FALLING
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetActiveEdge(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetTimeFormat(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x12U or between Min_Data=0x00U and Max_Data=0x23U
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetHour(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetMinute(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0x59U
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval Combination of hours, minutes and seconds.
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetTime(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  *         @arg @ref LL_RTC_WEEKDAY_SUNDAY
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetWeekDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  *         @arg @ref LL_RTC_MONTH_DECEMBER
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetMonth(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x01U and Max_Data=0x31U
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetDay(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetDate(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  *         else Value between Min_Data=0x0U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_TS_GetSubSecond(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_WAKEUP_Enable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_WAKEUP_Disable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_WAKEUP_IsEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_WAKEUP_SetClock(RTC_TypeDef * const RTCx, uint32_t WakeupClock)
{
...
/**
  ...
  *         @arg @ref LL_RTC_WAKEUPCLOCK_CKSPRE_WUT
  */
__STATIC_INLINE uint32_t LL_RTC_WAKEUP_GetClock(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  Value Value between Min_Data=0x00U and Max_Data=0xFFFFU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_WAKEUP_SetAutoReload(RTC_TypeDef * const RTCx, uint32_t Value)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_RTC_WAKEUP_GetAutoReload(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_WAKEUP_SetAutoClr(RTC_TypeDef * const RTCx, uint32_t Value)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_RTC_WAKEUP_GetAutoClr(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_SetOutputFreq(RTC_TypeDef * const RTCx, uint32_t Frequency)
{
...
/**
  ...
  *         @arg @ref LL_RTC_CALIB_OUTPUT_512HZ
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_GetOutputFreq(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_SetPulse(RTC_TypeDef * const RTCx, uint32_t Pulse)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_IsPulseInserted(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_SetPeriod(RTC_TypeDef * const RTCx, uint32_t Period)
{
...
/**
  ...
  *         @arg @ref LL_RTC_CALIB_PERIOD_8SEC
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_GetPeriod(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @param  CalibMinus Value between Min_Data=0x00U and Max_Data=0x1FFU
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_SetMinus(RTC_TypeDef * const RTCx, uint32_t CalibMinus)
{
...
/**
  ...
  * @param  RTCx RTC Instance
  * @retval Value between Min_Data=0x00U and Max_Data= 0x1FFU
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_GetMinus(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_LowPower_Enable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_CAL_LowPower_Disable(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_CAL_LowPower_IsEnabled(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_EnableOnTamper(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TS_DisableOnTamper(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_Enable(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_Disable(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_EnableMask(TAMP_TypeDef * const TAMPx, uint32_t Mask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_DisableMask(TAMP_TypeDef * const TAMPx, uint32_t Mask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_EnableEraseBKP(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_DisableEraseBKP(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_DisablePullUp(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_EnablePullUp(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_SetPrecharge(TAMP_TypeDef * const TAMPx, uint32_t Duration)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_DURATION_8RTCCLK
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetPrecharge(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_SetFilterCount(TAMP_TypeDef * const TAMPx, uint32_t FilterCount)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_FILTER_8SAMPLE
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetFilterCount(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_SetSamplingFreq(TAMP_TypeDef * const TAMPx, uint32_t SamplingFreq)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_SAMPLFREQDIV_256
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetSamplingFreq(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_EnableActiveLevel(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
  SET_BIT(TAMPx->CR2, Tamper);
}
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_TAMPER_DisableActiveLevel(TAMP_TypeDef * const TAMPx, uint32_t Tamper)
{
  CLEAR_BIT(TAMPx->CR2, Tamper);
}
...
/**
  ...
  * @param  Data Value between Min_Data=0x00U and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_RTC_BKP_SetRegister(TAMP_TypeDef * const TAMPx, uint32_t BackupRegister, uint32_t Data)
{
  uint32_t tmp = 0U;
...
/**
  ...
  *         @arg @ref LL_RTC_BKP_DR3
  *         @arg @ref LL_RTC_BKP_DR4
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_BKP_GetRegister(TAMP_TypeDef const * const TAMPx, uint32_t BackupRegister)
{
  uint32_t tmp = 0U;
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITS(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_RECALP(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TSOV(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TS(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_WUT(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRB(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRA(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SSRU(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_ITS(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TSOV(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TS(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_WUT(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_ALRB(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_ALRA(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_SSRU(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_INIT(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_RS(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_RS(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ICSR, (~((RTC_ICSR_RSF | RTC_ICSR_INIT) & 0x000000FFUL) | (RTCx->ICSR & RTC_ICSR_INIT)));
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_INITS(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SHP(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_WUTW(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRAM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_SSRUM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRBM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_WUTM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TSM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TSOVM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ITSM(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP1(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP2(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP3(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP1M(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP2M(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP3M(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP1(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP2(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMP3(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TS(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TS(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_WUT(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_WUT(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_ALRB(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_ALRB(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_ALRA(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_ALRA(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_SSRU(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_SSRU(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_SSRU(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TS(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_WUT(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ALRB(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ALRA(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP1(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP1(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP2(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP2(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP1(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP2(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP3(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP3(TAMP_TypeDef * const TAMPx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP3(TAMP_TypeDef const * const TAMPx)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_DURATION_8RTCCLK
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetPrecharge(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_FILTER_8SAMPLE
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetFilterCount(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  *         @arg @ref LL_RTC_TAMPER_SAMPLFREQDIV_256
  */
__STATIC_INLINE uint32_t LL_RTC_TAMPER_GetSamplingFreq(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_BAK_SetRegister(RTC_TypeDef * const RTCx, uint32_t BackupRegister, uint32_t Data)
{
  uint32_t tmp = 0U;
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_RTC_BAK_GetRegister(RTC_TypeDef const * const RTCx, uint32_t BackupRegister)
{
  uint32_t tmp = 0U;
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP3(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP2(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_TAMP1(RTC_TypeDef const * const RTCx)
{
...
__STATIC_INLINE void LL_RTC_ClearFlag_ITS(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_ITSF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TAMP3F | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
#endif /* RTC_TAMPER3_SUPPORT */
...
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TAMP2F | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
#endif /* RTC_TAMPER2_SUPPORT */
...
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TAMP1F | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
#endif /* RTC_TAMPER1_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_TSOV(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TSOVF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_TS(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_TSF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_WUT(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_WUTF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
#endif /* RTC_WAKEUP_SUPPORT */
...
__STATIC_INLINE void LL_RTC_ClearFlag_ALRB(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_ALRBF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_ALRA(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_ALRAF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
__STATIC_INLINE void LL_RTC_ClearFlag_RS(RTC_TypeDef * const RTCx)
{
  WRITE_REG(RTCx->ISR, (~((RTC_ISR_RSF | RTC_ISR_INIT) & 0x0000FFFFUL) | (RTCx->ISR & RTC_ISR_INIT)));
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRBW(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsActiveFlag_ALRAW(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP(RTC_TypeDef * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP3(RTC_TypeDef const * const RTCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP2(RTC_TypeDef const * const RTCx)
{
  return (READ_BIT(RTCx->TAMPCR,
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP1(RTC_TypeDef const * const RTCx)
{
  return (READ_BIT(RTCx->TAMPCR,
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_TAMP(RTC_TypeDef const * const RTCx)
{
  return (READ_BIT(RTCx->TAMPCR,
...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef * const RTCx);
ErrorStatus LL_RTC_Init(RTC_TypeDef * const RTCx, LL_RTC_InitTypeDef const * const RTC_InitStruct);
void        LL_RTC_StructInit(LL_RTC_InitTypeDef * const RTC_InitStruct);
ErrorStatus LL_RTC_TIME_Init(RTC_TypeDef * const RTCx, uint32_t RTC_Format, LL_RTC_TimeTypeDef * const RTC_TimeStruct);
void        LL_RTC_TIME_StructInit(LL_RTC_TimeTypeDef * const RTC_TimeStruct);
ErrorStatus LL_RTC_DATE_Init(RTC_TypeDef * const RTCx, uint32_t RTC_Format, LL_RTC_DateTypeDef * const RTC_DateStruct);
void        LL_RTC_DATE_StructInit(LL_RTC_DateTypeDef * const RTC_DateStruct);
ErrorStatus LL_RTC_ALMA_Init(RTC_TypeDef * const RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
ErrorStatus LL_RTC_ALMB_Init(RTC_TypeDef * const RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
void        LL_RTC_ALMA_StructInit(LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
void        LL_RTC_ALMB_StructInit(LL_RTC_AlarmTypeDef * const RTC_AlarmStruct);
ErrorStatus LL_RTC_EnterInitMode(RTC_TypeDef * const RTCx);
ErrorStatus LL_RTC_ExitInitMode(RTC_TypeDef * const RTCx);
ErrorStatus LL_RTC_WaitForSynchro(RTC_TypeDef * const RTCx);
