...
#if (USE_HAL_GFXMMU_REGISTER_CALLBACKS == 1U)
  void (*ErrorCallback)     (struct __GFXMMU_HandleTypeDef * const hgfxmmu); /*!< GFXMMU error callback */
  void (*MspInitCallback)   (struct __GFXMMU_HandleTypeDef * const hgfxmmu); /*!< GFXMMU MSP init callback */
  void (*MspDeInitCallback) (struct __GFXMMU_HandleTypeDef * const hgfxmmu); /*!< GFXMMU MSP de-init callback */
#endif
...
/**
  ...
  */
typedef void (*pGFXMMU_CallbackTypeDef)(GFXMMU_HandleTypeDef * const hgfxmmu);
#endif
...
/** @defgroup GFXMMU_BlocksPerLine GFXMMU blocks per line
  * @{
  */
#define GFXMMU_256BLOCKS 0x00000000UL     /*!< 256 blocks of 16 bytes per line */
...
/** @defgroup GFXMMU_Error_Code GFXMMU Error Code
  * @{
  */
#define GFXMMU_ERROR_NONE             0x00000000UL    /*!< No error */
...
#if (USE_HAL_GFXMMU_REGISTER_CALLBACKS == 1U)
#define GFXMMU_ERROR_INVALID_CALLBACK 0x00000100UL    /*!< Invalid callback error */
#endif
/**
  * @}
  */
...
/** @defgroup GFXMMU_LutLineStatus GFXMMU LUT line status
  * @{
  */
#define GFXMMU_LUT_LINE_DISABLE 0x00000000UL     /*!< LUT line disabled */
...
HAL_StatusTypeDef HAL_GFXMMU_Init(GFXMMU_HandleTypeDef * const hgfxmmu);
HAL_StatusTypeDef HAL_GFXMMU_DeInit(GFXMMU_HandleTypeDef * const hgfxmmu);
void HAL_GFXMMU_MspInit(GFXMMU_HandleTypeDef * const hgfxmmu);
void HAL_GFXMMU_MspDeInit(GFXMMU_HandleTypeDef * const hgfxmmu);
#if (USE_HAL_GFXMMU_REGISTER_CALLBACKS == 1U)
/* GFXMMU callbacks register/unregister functions *****************************/
HAL_StatusTypeDef HAL_GFXMMU_RegisterCallback(GFXMMU_HandleTypeDef  const * const hgfxmmu,
                                              HAL_GFXMMU_CallbackIDTypeDef CallbackID,
                                              pGFXMMU_CallbackTypeDef      pCallback);
HAL_StatusTypeDef HAL_GFXMMU_UnRegisterCallback(GFXMMU_HandleTypeDef  const * const hgfxmmu,
                                                HAL_GFXMMU_CallbackIDTypeDef CallbackID);
#endif
/**
  * @}
...
/** @addtogroup GFXMMU_Exported_Functions_Group2 Operations functions
  ...
  */
/* Operation functions ********************************************************/
HAL_StatusTypeDef HAL_GFXMMU_ConfigLut(GFXMMU_HandleTypeDef * const hgfxmmu,
                                       uint32_t FirstLine,
                                       uint32_t LinesNumber,
                                       uint32_t Address);

HAL_StatusTypeDef HAL_GFXMMU_DisableLutLines(GFXMMU_HandleTypeDef * const hgfxmmu,
                                             uint32_t FirstLine,
                                             uint32_t LinesNumber);

HAL_StatusTypeDef HAL_GFXMMU_ConfigLutLine(GFXMMU_HandleTypeDef * const hgfxmmu, GFXMMU_LutLineTypeDef const * const lutLine);

HAL_StatusTypeDef HAL_GFXMMU_ModifyBuffers(GFXMMU_HandleTypeDef * const hgfxmmu, GFXMMU_BuffersTypeDef const * const Buffers);

void HAL_GFXMMU_IRQHandler(GFXMMU_HandleTypeDef * const hgfxmmu);

void HAL_GFXMMU_ErrorCallback(GFXMMU_HandleTypeDef * const hgfxmmu);
/**
  * @}
  */
...
/** @defgroup GFXMMU_Exported_Functions_Group3 State functions
  ...
  */
/* State function *************************************************************/
HAL_GFXMMU_StateTypeDef HAL_GFXMMU_GetState(GFXMMU_HandleTypeDef const * const hgfxmmu);

uint32_t HAL_GFXMMU_GetError(GFXMMU_HandleTypeDef const * const hgfxmmu);
/**
  * @}
  */
