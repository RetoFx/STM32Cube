...
#define LL_RNG_HTCFG   0x17590ABCUL /*!< Magic number */
/**
  * @}
  */
/* Private variables ---------------------------------------------------------*/
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetConditioningResetBit(RNG_TypeDef * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_ResetConditioningResetBit(RNG_TypeDef * const RNGx)
{
  CLEAR_BIT(RNGx->CR, RNG_CR_CONDRST);
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsResetConditioningBitSet(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_RNG_IsNistComplianceEnabled(RNG_TypeDef const * const RNGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_RNG_SetHealthconfiguration(RNG_TypeDef * const RNGx, uint32_t HTCFG)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RNG_GetHealthconfiguration(RNG_TypeDef const * const RNGx)
{
