...
/** @defgroup  LCD_ErrorCode LCD Error Code
  * @{
  */
#define HAL_LCD_ERROR_NONE       (0x00000000UL)    /*!< No error */
#define HAL_LCD_ERROR_FCRSF      (0x00000001UL)    /*!< Synchro flag timeout error */
#define HAL_LCD_ERROR_UDR        (0x00000002UL)    /*!< Update display request flag timeout error */
#define HAL_LCD_ERROR_UDD        (0x00000004UL)    /*!< Update display done flag timeout error */
#define HAL_LCD_ERROR_ENS        (0x00000008UL)    /*!< LCD enabled status flag timeout error */
#define HAL_LCD_ERROR_RDY        (0x00000010UL)    /*!< LCD Booster ready timeout error */
/**
  * @}
  */
...
/** @defgroup LCD_Prescaler LCD Prescaler
  * @{
  */
#define LCD_PRESCALER_1        (0x00000000UL)  /*!< CLKPS = LCDCLK        */
#define LCD_PRESCALER_2        (0x00400000UL)  /*!< CLKPS = LCDCLK/2      */
#define LCD_PRESCALER_4        (0x00800000UL)  /*!< CLKPS = LCDCLK/4      */
#define LCD_PRESCALER_8        (0x00C00000UL)  /*!< CLKPS = LCDCLK/8      */
#define LCD_PRESCALER_16       (0x01000000UL)  /*!< CLKPS = LCDCLK/16     */
#define LCD_PRESCALER_32       (0x01400000UL)  /*!< CLKPS = LCDCLK/32     */
#define LCD_PRESCALER_64       (0x01800000UL)  /*!< CLKPS = LCDCLK/64     */
#define LCD_PRESCALER_128      (0x01C00000UL)  /*!< CLKPS = LCDCLK/128    */
#define LCD_PRESCALER_256      (0x02000000UL)  /*!< CLKPS = LCDCLK/256    */
#define LCD_PRESCALER_512      (0x02400000UL)  /*!< CLKPS = LCDCLK/512    */
#define LCD_PRESCALER_1024     (0x02800000UL)  /*!< CLKPS = LCDCLK/1024   */
#define LCD_PRESCALER_2048     (0x02C00000UL)  /*!< CLKPS = LCDCLK/2048   */
#define LCD_PRESCALER_4096     (0x03000000UL)  /*!< CLKPS = LCDCLK/4096   */
#define LCD_PRESCALER_8192     (0x03400000UL)  /*!< CLKPS = LCDCLK/8192   */
#define LCD_PRESCALER_16384    (0x03800000UL)  /*!< CLKPS = LCDCLK/16384  */
#define LCD_PRESCALER_32768    (0x03C00000UL)  /*!< CLKPS = LCDCLK/32768  */
/**
  * @}
  */
...
/** @defgroup LCD_Divider LCD Divider
  * @{
  */
#define LCD_DIVIDER_16    (0x00000000UL)  /*!< LCD frequency = CLKPS/16 */
#define LCD_DIVIDER_17    (0x00040000UL)  /*!< LCD frequency = CLKPS/17 */
#define LCD_DIVIDER_18    (0x00080000UL)  /*!< LCD frequency = CLKPS/18 */
#define LCD_DIVIDER_19    (0x000C0000UL)  /*!< LCD frequency = CLKPS/19 */
#define LCD_DIVIDER_20    (0x00100000UL)  /*!< LCD frequency = CLKPS/20 */
#define LCD_DIVIDER_21    (0x00140000UL)  /*!< LCD frequency = CLKPS/21 */
#define LCD_DIVIDER_22    (0x00180000UL)  /*!< LCD frequency = CLKPS/22 */
#define LCD_DIVIDER_23    (0x001C0000UL)  /*!< LCD frequency = CLKPS/23 */
#define LCD_DIVIDER_24    (0x00200000UL)  /*!< LCD frequency = CLKPS/24 */
#define LCD_DIVIDER_25    (0x00240000UL)  /*!< LCD frequency = CLKPS/25 */
#define LCD_DIVIDER_26    (0x00280000UL)  /*!< LCD frequency = CLKPS/26 */
#define LCD_DIVIDER_27    (0x002C0000UL)  /*!< LCD frequency = CLKPS/27 */
#define LCD_DIVIDER_28    (0x00300000UL)  /*!< LCD frequency = CLKPS/28 */
#define LCD_DIVIDER_29    (0x00340000UL)  /*!< LCD frequency = CLKPS/29 */
#define LCD_DIVIDER_30    (0x00380000UL)  /*!< LCD frequency = CLKPS/30 */
#define LCD_DIVIDER_31    (0x003C0000UL)  /*!< LCD frequency = CLKPS/31 */
/**
  * @}
  */
...
/** @defgroup LCD_Duty LCD Duty
  * @{
  */
#define LCD_DUTY_STATIC                 (0x00000000UL)                     /*!< Static duty */
...
/** @defgroup LCD_Bias LCD Bias
  * @{
  */
#define LCD_BIAS_1_4                    (0x00000000UL) /*!< 1/4 Bias */
...
/** @defgroup LCD_Voltage_Source LCD Voltage Source
  * @{
  */
#define LCD_VOLTAGESOURCE_INTERNAL      (0x00000000UL)  /*!< Internal voltage source for the LCD */
...
/** @defgroup LCD_BlinkMode LCD Blink Mode
  * @{
  */
#define LCD_BLINKMODE_OFF               (0x00000000UL)           /*!< Blink disabled                                     */
#define LCD_BLINKMODE_SEG0_COM0         (LCD_FCR_BLINK_0)       /*!< Blink enabled on SEG[0U], COM[0U] (1 pixel)          */
#define LCD_BLINKMODE_SEG0_ALLCOM       (LCD_FCR_BLINK_1)       /*!< Blink enabled on SEG[0U], all COM (up to
...
/** @defgroup LCD_BlinkFrequency LCD Blink Frequency
  * @{
  */
#define LCD_BLINKFREQUENCY_DIV8         (0x00000000UL)                         /*!< The Blink frequency = fLCD/8    */
...
/** @defgroup LCD_Contrast LCD Contrast
  * @{
  */
#define LCD_CONTRASTLEVEL_0               (0x00000000UL)                 /*!< Maximum Voltage = 2.60V    */
...
/** @defgroup LCD_RAMRegister LCD RAMRegister
  * @{
  */
#define LCD_RAM_REGISTER0               (0x00000000UL) /*!< LCD RAM Register 0  */
#define LCD_RAM_REGISTER1               (0x00000001UL) /*!< LCD RAM Register 1  */
#define LCD_RAM_REGISTER2               (0x00000002UL) /*!< LCD RAM Register 2  */
#define LCD_RAM_REGISTER3               (0x00000003UL) /*!< LCD RAM Register 3  */
#define LCD_RAM_REGISTER4               (0x00000004UL) /*!< LCD RAM Register 4  */
#define LCD_RAM_REGISTER5               (0x00000005UL) /*!< LCD RAM Register 5  */
#define LCD_RAM_REGISTER6               (0x00000006UL) /*!< LCD RAM Register 6  */
#define LCD_RAM_REGISTER7               (0x00000007UL) /*!< LCD RAM Register 7  */
#define LCD_RAM_REGISTER8               (0x00000008UL) /*!< LCD RAM Register 8  */
#define LCD_RAM_REGISTER9               (0x00000009UL) /*!< LCD RAM Register 9  */
#define LCD_RAM_REGISTER10              (0x0000000AUL) /*!< LCD RAM Register 10 */
#define LCD_RAM_REGISTER11              (0x0000000BUL) /*!< LCD RAM Register 11 */
#define LCD_RAM_REGISTER12              (0x0000000CUL) /*!< LCD RAM Register 12 */
#define LCD_RAM_REGISTER13              (0x0000000DUL) /*!< LCD RAM Register 13 */
#define LCD_RAM_REGISTER14              (0x0000000EUL) /*!< LCD RAM Register 14 */
#define LCD_RAM_REGISTER15              (0x0000000FUL) /*!< LCD RAM Register 15 */
/**
  * @}
  */
...
#define LCD_HIGHDRIVE_DISABLE             ((uint32_t)0x00000000UL)        /*!< High drive disabled */
...
#define LCD_MUXSEGMENT_DISABLE            (0x00000000UL)                 /*!< SEG pin multiplexing disabled                 */
...
/**
  ...
  *     @arg LCD_BLINKMODE_SEG0_COM0:     Blink enabled on SEG[0U], COM[0U] (1 pixel)
  *     @arg LCD_BLINKMODE_SEG0_ALLCOM:   Blink enabled on SEG[0U], all COM (up to 8
...
/** @addtogroup LCD_Exported_Functions_Group1
  * @{
  */
HAL_StatusTypeDef    HAL_LCD_DeInit(LCD_HandleTypeDef * const hlcd);
HAL_StatusTypeDef    HAL_LCD_Init(LCD_HandleTypeDef * const hlcd);
void                 HAL_LCD_MspInit(LCD_HandleTypeDef * const hlcd);
void                 HAL_LCD_MspDeInit(LCD_HandleTypeDef * const hlcd);
/**
  * @}
  */
...
/** @addtogroup LCD_Exported_Functions_Group2
  * @{
  */
HAL_StatusTypeDef    HAL_LCD_Write(LCD_HandleTypeDef * const hlcd, uint32_t RAMRegisterIndex, uint32_t RAMRegisterMask, uint32_t Data);
HAL_StatusTypeDef    HAL_LCD_Clear(LCD_HandleTypeDef * const hlcd);
HAL_StatusTypeDef    HAL_LCD_UpdateDisplayRequest(LCD_HandleTypeDef * const hlcd);
/**
  * @}
  */
...
/** @addtogroup LCD_Exported_Functions_Group3
  * @{
  */
HAL_LCD_StateTypeDef HAL_LCD_GetState(LCD_HandleTypeDef const * const hlcd);
uint32_t             HAL_LCD_GetError(LCD_HandleTypeDef const * const hlcd);
/**
  * @}
  */
...
HAL_StatusTypeDef     LCD_WaitForSynchro(LCD_HandleTypeDef * const hlcd);
