...
/** @defgroup CORTEX_Preemption_Priority_Group CORTEX Preemption Priority Group
  * @{
  */
#define NVIC_PRIORITYGROUP_0         ((uint32_t)0x00000007UL) /*!< 0 bit  for pre-emption priority,
                                                                 4 bits for subpriority */
#define NVIC_PRIORITYGROUP_1         ((uint32_t)0x00000006UL) /*!< 1 bit  for pre-emption priority,
                                                                 3 bits for subpriority */
#define NVIC_PRIORITYGROUP_2         ((uint32_t)0x00000005UL) /*!< 2 bits for pre-emption priority,
                                                                 2 bits for subpriority */
#define NVIC_PRIORITYGROUP_3         ((uint32_t)0x00000004UL) /*!< 3 bits for pre-emption priority,
                                                                 1 bit  for subpriority */
#define NVIC_PRIORITYGROUP_4         ((uint32_t)0x00000003UL) /*!< 4 bits for pre-emption priority,
...
#define  MPU_TEX_LEVEL4              ((uint8_t)0x04U)
/**
  * @}
  */
...
void HAL_MPU_ConfigRegion(MPU_Region_InitTypeDef const * const MPU_Init);
#endif /* __MPU_PRESENT */
/**
  * @}
  */
...
#define IS_NVIC_DEVICE_IRQ(IRQ)                ((IRQ) >= 0)
