...
typedef struct
{
  ...
  uint32_t ReloadValue;           /*!< Specifies the value to be loaded in the frequency error counter with each SYNC event.
                                     ...
                                     This parameter must be a number between 0 and 0xFFFFU or a value of @ref RCCEx_CRS_ReloadValueDefault .*/

  uint32_t ErrorLimitValue;       /*!< Specifies the value to be used to evaluate the captured frequency error value.
                                     This parameter must be a number between 0 and 0xFFU or a value of @ref RCCEx_CRS_ErrorLimitDefault */

  uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48 oscillator.
                                     This parameter must be a number between 0 and 0x7FU for STM32L412xx/L422xx, between 0 and 0x3FU otherwise,
...
/** @defgroup RCCEx_LSCO_Clock_Source Low Speed Clock Source
  * @{
  */
#define RCC_LSCOSOURCE_LSI             0x00000000UL         /*!< LSI selection for low speed clock output */
...
/** @defgroup RCCEx_Periph_Clock_Selection Periph Clock Selection
  * @{
  */
#define RCC_PERIPHCLK_USART1           0x00000001UL
#define RCC_PERIPHCLK_USART2           0x00000002UL
#if defined(USART3)
#define RCC_PERIPHCLK_USART3           0x00000004UL
#endif
#if defined(UART4)
#define RCC_PERIPHCLK_UART4            0x00000008UL
#endif
#if defined(UART5)
#define RCC_PERIPHCLK_UART5            0x00000010UL
#endif
#define RCC_PERIPHCLK_LPUART1          0x00000020UL
#define RCC_PERIPHCLK_I2C1             0x00000040UL
#if defined(I2C2)
#define RCC_PERIPHCLK_I2C2             0x00000080UL
#endif
#define RCC_PERIPHCLK_I2C3             0x00000100UL
#define RCC_PERIPHCLK_LPTIM1           0x00000200UL
#define RCC_PERIPHCLK_LPTIM2           0x00000400UL
#if defined(SAI1)
#define RCC_PERIPHCLK_SAI1             0x00000800UL
#endif
#if defined(SAI2)
#define RCC_PERIPHCLK_SAI2             0x00001000UL
#endif
#if defined(USB_OTG_FS) || defined(USB)
#define RCC_PERIPHCLK_USB              0x00002000UL
#endif
#define RCC_PERIPHCLK_ADC              0x00004000UL
#if defined(SWPMI1)
#define RCC_PERIPHCLK_SWPMI1           0x00008000UL
#endif
#if defined(DFSDM1_Filter0)
#define RCC_PERIPHCLK_DFSDM1           0x00010000UL
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define RCC_PERIPHCLK_DFSDM1AUDIO      0x00200000UL
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
#endif
#define RCC_PERIPHCLK_RTC              0x00020000UL
#define RCC_PERIPHCLK_RNG              0x00040000UL
#if defined(SDMMC1)
#define RCC_PERIPHCLK_SDMMC1           0x00080000UL
#endif
#if defined(I2C4)
#define RCC_PERIPHCLK_I2C4             0x00100000UL
#endif
#if defined(LTDC)
#define RCC_PERIPHCLK_LTDC             0x00400000UL
#endif
#if defined(DSI)
#define RCC_PERIPHCLK_DSI              0x00800000UL
#endif
#if defined(OCTOSPI1) || defined(OCTOSPI2)
#define RCC_PERIPHCLK_OSPI             0x01000000UL
#endif
/**
  * @}
  */
...
/** @defgroup RCCEx_USART1_Clock_Source USART1 Clock Source
  * @{
  */
#define RCC_USART1CLKSOURCE_PCLK2      0x00000000UL
...
/** @defgroup RCCEx_USART2_Clock_Source USART2 Clock Source
  * @{
  */
#define RCC_USART2CLKSOURCE_PCLK1      0x00000000UL
...
/** @defgroup RCCEx_USART3_Clock_Source USART3 Clock Source
  * @{
  */
#define RCC_USART3CLKSOURCE_PCLK1      0x00000000UL
...
/** @defgroup RCCEx_UART4_Clock_Source UART4 Clock Source
  * @{
  */
#define RCC_UART4CLKSOURCE_PCLK1       0x00000000UL
...
/** @defgroup RCCEx_UART5_Clock_Source UART5 Clock Source
  * @{
  */
#define RCC_UART5CLKSOURCE_PCLK1       0x00000000UL
...
/** @defgroup RCCEx_LPUART1_Clock_Source LPUART1 Clock Source
  * @{
  */
#define RCC_LPUART1CLKSOURCE_PCLK1     0x00000000UL
...
/** @defgroup RCCEx_I2C1_Clock_Source I2C1 Clock Source
  * @{
  */
#define RCC_I2C1CLKSOURCE_PCLK1        0x00000000UL
...
/** @defgroup RCCEx_I2C2_Clock_Source I2C2 Clock Source
  * @{
  */
#define RCC_I2C2CLKSOURCE_PCLK1        0x00000000UL
...
/** @defgroup RCCEx_I2C3_Clock_Source I2C3 Clock Source
  * @{
  */
#define RCC_I2C3CLKSOURCE_PCLK1        0x00000000UL
...
/** @defgroup RCCEx_I2C4_Clock_Source I2C4 Clock Source
  * @{
  */
#define RCC_I2C4CLKSOURCE_PCLK1        0x00000000UL
...
/** @defgroup RCCEx_SAI1_Clock_Source SAI1 Clock Source
  * @{
  */
#define RCC_SAI1CLKSOURCE_PLLSAI1      0x00000000UL
#if defined(RCC_PLLSAI2_SUPPORT)
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
/** @defgroup RCCEx_SAI2_Clock_Source SAI2 Clock Source
  * @{
  */
#define RCC_SAI2CLKSOURCE_PLLSAI1      0x00000000UL
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
/** @defgroup RCCEx_LPTIM2_Clock_Source LPTIM2 Clock Source
  * @{
  */
#define RCC_LPTIM2CLKSOURCE_PCLK1      0x00000000UL
...
#define RCC_SDMMC1CLKSOURCE_HSI48      0x00000000UL  /*!< HSI48 clock selected as SDMMC1 clock          */
#else
#define RCC_SDMMC1CLKSOURCE_NONE       0x00000000UL  /*!< No clock selected as SDMMC1 clock             */
...
/** @defgroup RCCEx_RNG_Clock_Source RNG Clock Source
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define RCC_RNGCLKSOURCE_HSI48         0x00000000UL
#else
#define RCC_RNGCLKSOURCE_NONE          0x00000000UL
#endif /* RCC_HSI48_SUPPORT */
#if defined(RCC_PLLSAI1_SUPPORT)
...
/** @defgroup RCCEx_USB_Clock_Source USB Clock Source
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define RCC_USBCLKSOURCE_HSI48         0x00000000UL
#else
#define RCC_USBCLKSOURCE_NONE          0x00000000UL
#endif /* RCC_HSI48_SUPPORT */
#if defined(RCC_PLLSAI1_SUPPORT)
...
/** @defgroup RCCEx_ADC_Clock_Source ADC Clock Source
  * @{
  */
#define RCC_ADCCLKSOURCE_NONE         0x00000000UL
#if defined(RCC_PLLSAI1_SUPPORT)
...
#else
#define RCC_ADCCLKSOURCE_SYSCLK       0x30000000UL
...
/** @defgroup RCCEx_SWPMI1_Clock_Source SWPMI1 Clock Source
  * @{
  */
#define RCC_SWPMI1CLKSOURCE_PCLK1      0x00000000UL
...
/** @defgroup RCCEx_DFSDM1_Audio_Clock_Source DFSDM1 Audio Clock Source
  * @{
  */
#define RCC_DFSDM1AUDIOCLKSOURCE_SAI1   0x00000000UL
...
/** @defgroup RCCEx_LTDC_Clock_Source LTDC Clock Source
  * @{
  */
#define RCC_LTDCCLKSOURCE_PLLSAI2_DIV2  0x00000000UL
...
/** @defgroup RCCEx_OSPI_Clock_Source OctoSPI Clock Source
  * @{
  */
#define RCC_OSPICLKSOURCE_SYSCLK    0x00000000UL
...
/** @defgroup RCCEx_CRS_Status RCCEx CRS Status
  * @{
  */
#define RCC_CRS_NONE                   0x00000000UL
#define RCC_CRS_TIMEOUT                0x00000001UL
#define RCC_CRS_SYNCOK                 0x00000002UL
#define RCC_CRS_SYNCWARN               0x00000004UL
#define RCC_CRS_SYNCERR                0x00000008UL
#define RCC_CRS_SYNCMISS               0x00000010UL
#define RCC_CRS_TRIMOVF                0x00000020UL
/**
  * @}
  */
...
/** @defgroup RCCEx_CRS_SynchroSource RCCEx CRS SynchroSource
  * @{
  */
#define RCC_CRS_SYNC_SOURCE_GPIO       0x00000000UL             /*!< Synchro Signal source GPIO */
...
/** @defgroup RCCEx_CRS_SynchroDivider RCCEx CRS SynchroDivider
  * @{
  */
#define RCC_CRS_SYNC_DIV1        0x00000000UL                               /*!< Synchro Signal not divided (default) */
...
/** @defgroup RCCEx_CRS_SynchroPolarity RCCEx CRS SynchroPolarity
  * @{
  */
#define RCC_CRS_SYNC_POLARITY_RISING   0x00000000UL         /*!< Synchro Active on rising edge (default) */
...
/** @defgroup RCCEx_CRS_ReloadValueDefault RCCEx CRS ReloadValueDefault
  * @{
  */
#define RCC_CRS_RELOADVALUE_DEFAULT    0x0000BB7FUL   /*!< The reset value of the RELOAD field corresponds
...
/** @defgroup RCCEx_CRS_ErrorLimitDefault RCCEx CRS ErrorLimitDefault
  * @{
  */
#define RCC_CRS_ERRORLIMIT_DEFAULT     0x00000022UL   /*!< Default Frequency error limit */
/**
  * @}
  */
...
/** @defgroup RCCEx_CRS_HSI48CalibrationDefault RCCEx CRS HSI48CalibrationDefault
  ...
  */
#if defined(STM32L412xx) || defined(STM32L422xx)
#define RCC_CRS_HSI48CALIBRATION_DEFAULT 0x00000040UL /*!< The default value is 64, which corresponds to the middle of the trimming interval.
                                                          The trimming step is specified in the product datasheet. A higher TRIM value
                                                          corresponds to a higher output frequency */
#else
#define RCC_CRS_HSI48CALIBRATION_DEFAULT 0x00000020UL /*!< The default value is 32, which corresponds to the middle of the trimming interval.
                                                          The trimming step is specified in the product datasheet. A higher TRIM value
                                                          corresponds to a higher output frequency */
#endif
/**
...
/** @defgroup RCCEx_CRS_FreqErrorDirection RCCEx CRS FreqErrorDirection
  * @{
  */
#define RCC_CRS_FREQERRORDIR_UP        0x00000000UL   /*!< Upcounting direction, the actual frequency is above the target */
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI1(RCC_PLLSAI1InitTypeDef * const PLLSAI1Init);
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI2(RCC_PLLSAI2InitTypeDef * const PLLSAI2Init);
...
void              HAL_RCCEx_CRSConfig(RCC_CRSInitTypeDef const * const pInit);
void              HAL_RCCEx_CRSSoftwareSynchronizationGenerate(void);
void              HAL_RCCEx_CRSGetSynchronizationInfo(RCC_CRSSynchroInfoTypeDef * const pSynchroInfo);
