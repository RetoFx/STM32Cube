...
#if defined (STM32L4P5xx) || defined (STM32L4Q5xx)
  void (* SSRUEventCallback)(struct __RTC_HandleTypeDef * const hrtc);                      /*!< RTC SSRU Event callback               */
#endif
...
#define RTC_OUTPUT_TYPE_OPENDRAIN           0x00000000UL
#endif
/**
  * @}
  */
...
/** @defgroup RTC_Input_parameter_format_definitions RTC input or output data format for date (Year, Month, Weekday) and time (Hours, Minutes, Seconds).
  ...
  * @{
  */
#define RTC_FORMAT_BIN                      0x00000000UL /* This parameter will trigger a SW conversion to fit with the native BCD format of the HW Calendar.
                                                           It should not be confused with the Binary mode @ref RTCEx_Binary_Mode. */

#define RTC_FORMAT_BCD                      0x00000001UL /* Native format of the HW Calendar.
                                                           It should not be confused with the Binary mode @ref RTCEx_Binary_Mode. */
/**
  * @}
  */
...
#define RTC_ALARMSUBSECONDMASK_SS14         (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3)  /*!< SS[14U] is don't care in Alarm
...
#if defined (STM32L4P5xx) || defined (STM32L4Q5xx)
#define RTC_FLAG_SSRUF                      (0x00000200UL | RTC_SR_SSRUF_Pos)     /*!< SSR underflow flag */
#endif
...
#define RTC_ICSR_RESERVED_MASK              0x000100FCUL
#define RTC_RSF_MASK                        (~(RTC_ICSR_INIT | RTC_ICSR_RSF))
#elif defined (STM32L4P5xx) || defined (STM32L4Q5xx)
#define RTC_ICSR_RESERVED_MASK              0x00011FFCUL
#define RTC_RSF_MASK                        (~(RTC_ICSR_INIT | RTC_ICSR_RSF))
#else
#define RTC_ISR_RESERVED_MASK               0x0003FFFFUL
