...
#define TIMx_OR1_RMP_MASK  0x0000FFFFUL
#if defined(ADC3)
...
/** @defgroup TIM_LL_EC_ETRSOURCE External Trigger Source
  * @{
  */
#define LL_TIM_ETRSOURCE_LEGACY                0x00000000UL                                       /*!< ETR legacy mode */
...
#define LL_TIM_TIM2_ITR1_RMP_NONE          0x00000000UL                                                 /*!< No internal trigger on TIM2_ITR1 */
...
/** @defgroup TIM_LL_EC_OCREF_CLR_INT OCREF clear input selection
  * @{
  */
#define LL_TIM_OCREF_CLR_INT_NC     0x00000000UL         /*!< OCREF_CLR_INT is not connected */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_TIM_ConfigBRK(TIM_TypeDef * const TIMx, uint32_t BreakPolarity,
