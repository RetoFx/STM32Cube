...
#define DAC_TRIGGER_NONE        0x00000000UL                                      /*!< Conversion is automatic once the DAC_DHRxxxx register
...
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef * const hdac, DAC_ChannelConfTypeDef const * const sConfig, uint32_t Channel);
/**
  * @}
  */
