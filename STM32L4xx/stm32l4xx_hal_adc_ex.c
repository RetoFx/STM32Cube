...
/**
  ...
  * @retval HAL state
  */
HAL_StatusTypeDef HAL_ADCEx_Calibration_SetValue(ADC_HandleTypeDef * const hadc, uint32_t SingleDiff,
...
/**
  ...
  * @retval None
  */
HAL_ADCEX_WEAK_CALLBACK(void, HAL_ADCEx_EndOfSamplingCallback)(ADC_HandleTypeDef * const hadc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hadc);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef * const hadc,
                                                  ADC_InjectionConfTypeDef const * const pConfigInjected)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ...
  if (LL_ADC_IsEnabled(hadc->Instance) == 0UL)
  {
    ...
    /* Note: ADC channel number masked with value "0x1FU" to ensure shift value within 32 bits range */
    if (pConfigInjected->InjectedSingleDiff == ADC_DIFFERENTIAL_ENDED)
    {
      /* Set sampling time of the selected ADC channel */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef * const hadc, ADC_MultiModeTypeDef const * const pMultimode)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ADC_Common_TypeDef *tmpADC_Common;
  ADC_HandleTypeDef tmp_hadc_slave;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_EnableInjectedQueue(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tmp_adc_is_conversion_on_going_regular;
  uint32_t tmp_adc_is_conversion_on_going_injected;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_DisableInjectedQueue(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tmp_adc_is_conversion_on_going_regular;
  uint32_t tmp_adc_is_conversion_on_going_injected;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_DisableVoltageRegulator(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_ADCEx_EnterADCDeepPowerDownMode(ADC_HandleTypeDef * const hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
