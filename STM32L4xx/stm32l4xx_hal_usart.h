...
#endif /* USART_CR1_FIFOEN */
  void (*RxISR)(struct __USART_HandleTypeDef * const husart);   /*!< Function pointer on Rx IRQ handler  */

  void (*TxISR)(struct __USART_HandleTypeDef * const husart);   /*!< Function pointer on Tx IRQ handler  */
...
#if (USE_HAL_USART_REGISTER_CALLBACKS == 1U)
  void (* TxHalfCpltCallback)(struct __USART_HandleTypeDef * const husart);        /*!< USART Tx Half Complete Callback        */
  void (* TxCpltCallback)(struct __USART_HandleTypeDef * const husart);            /*!< USART Tx Complete Callback             */
  void (* RxHalfCpltCallback)(struct __USART_HandleTypeDef * const husart);        /*!< USART Rx Half Complete Callback        */
  void (* RxCpltCallback)(struct __USART_HandleTypeDef * const husart);            /*!< USART Rx Complete Callback             */
  void (* TxRxCpltCallback)(struct __USART_HandleTypeDef * const husart);          /*!< USART Tx Rx Complete Callback          */
  void (* ErrorCallback)(struct __USART_HandleTypeDef * const husart);             /*!< USART Error Callback                   */
  void (* AbortCpltCallback)(struct __USART_HandleTypeDef * const husart);         /*!< USART Abort Complete Callback          */
#if defined(USART_CR1_FIFOEN)
  void (* RxFifoFullCallback)(struct __USART_HandleTypeDef * const husart);        /*!< USART Rx Fifo Full Callback            */
  void (* TxFifoEmptyCallback)(struct __USART_HandleTypeDef * const husart);       /*!< USART Tx Fifo Empty Callback           */
#endif /* USART_CR1_FIFOEN */

  void (* MspInitCallback)(struct __USART_HandleTypeDef * const husart);           /*!< USART Msp Init callback                */
  void (* MspDeInitCallback)(struct __USART_HandleTypeDef * const husart);         /*!< USART Msp DeInit callback              */
...
/**
  ...
  */
typedef  void (*pUSART_CallbackTypeDef)(USART_HandleTypeDef * const husart);  /*!< pointer to an USART callback function */
...
/** @defgroup USART_Error_Definition   USART Error Definition
  * @{
  */
#define HAL_USART_ERROR_NONE             (0x00000000UL)    /*!< No error                  */
#define HAL_USART_ERROR_PE               (0x00000001UL)    /*!< Parity error              */
#define HAL_USART_ERROR_NE               (0x00000002UL)    /*!< Noise error               */
#define HAL_USART_ERROR_FE               (0x00000004UL)    /*!< Frame error               */
#define HAL_USART_ERROR_ORE              (0x00000008UL)    /*!< Overrun error             */
#define HAL_USART_ERROR_DMA              (0x00000010UL)    /*!< DMA transfer error        */
#if defined(USART_CR2_SLVEN)
#define HAL_USART_ERROR_UDR              (0x00000020UL)    /*!< SPI slave underrun error  */
#endif /* USART_CR2_SLVEN */
#if (USE_HAL_USART_REGISTER_CALLBACKS == 1U)
#define HAL_USART_ERROR_INVALID_CALLBACK (0x00000040UL)    /*!< Invalid Callback error    */
#endif /* USE_HAL_USART_REGISTER_CALLBACKS */
#define  HAL_USART_ERROR_RTO              (0x00000080UL)    /*!< Receiver Timeout error  */
/**
  * @}
  */
...
#define USART_STOPBITS_1                     0x00000000UL                          /*!< USART frame with 1 stop bit    */
...
/** @defgroup USART_Parity    USART Parity
  * @{
  */
#define USART_PARITY_NONE                   0x00000000UL                      /*!< No parity   */
...
/** @defgroup USART_Clock  USART Clock
  * @{
  */
#define USART_CLOCK_DISABLE                 0x00000000UL       /*!< USART clock disable */
...
/** @defgroup USART_Clock_Polarity  USART Clock Polarity
  * @{
  */
#define USART_POLARITY_LOW                  0x00000000UL      /*!< Driver enable signal is active high */
...
/** @defgroup USART_Clock_Phase   USART Clock Phase
  * @{
  */
#define USART_PHASE_1EDGE                   0x00000000UL      /*!< USART frame phase on first clock transition  */
...
/** @defgroup USART_Last_Bit  USART Last Bit
  * @{
  */
#define USART_LASTBIT_DISABLE               0x00000000UL      /*!< USART frame last data bit clock pulse not output to SCLK pin */
...
/** @defgroup USART_ClockPrescaler  USART Clock Prescaler
  * @{
  */
#define USART_PRESCALER_DIV1    0x00000000UL  /*!< fclk_pres = fclk     */
#define USART_PRESCALER_DIV2    0x00000001UL  /*!< fclk_pres = fclk/2   */
#define USART_PRESCALER_DIV4    0x00000002UL  /*!< fclk_pres = fclk/4   */
#define USART_PRESCALER_DIV6    0x00000003UL  /*!< fclk_pres = fclk/6   */
#define USART_PRESCALER_DIV8    0x00000004UL  /*!< fclk_pres = fclk/8   */
#define USART_PRESCALER_DIV10   0x00000005UL  /*!< fclk_pres = fclk/10  */
#define USART_PRESCALER_DIV12   0x00000006UL  /*!< fclk_pres = fclk/12  */
#define USART_PRESCALER_DIV16   0x00000007UL  /*!< fclk_pres = fclk/16  */
#define USART_PRESCALER_DIV32   0x00000008UL  /*!< fclk_pres = fclk/32  */
#define USART_PRESCALER_DIV64   0x00000009UL  /*!< fclk_pres = fclk/64  */
#define USART_PRESCALER_DIV128  0x0000000AUL  /*!< fclk_pres = fclk/128 */
#define USART_PRESCALER_DIV256  0x0000000BUL  /*!< fclk_pres = fclk/256 */
...
#define __HAL_USART_GET_IT(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->ISR \
                                                         & (0x01UL << (((__INTERRUPT__) & USART_ISR_MASK)>> \
...
#define __HAL_USART_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x01U) ? \
                                                                 ...
                                                                 (((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x02U) ? \
                                                                  ...
                                                                  (__HANDLE__)->Instance->CR3)) & (0x01UL << \
...
#define IS_USART_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) <= 15000000UL)
#else
#define IS_USART_BAUDRATE(__BAUDRATE__) ((__BAUDRATE__) <= 10000000UL)
...
/**
  ...
  */
#define IS_USART_MODE(__MODE__) ((((__MODE__) & 0xFFFFFFF3UL) == 0x00U) && ((__MODE__) != 0x00U))
...
HAL_StatusTypeDef HAL_USART_Init(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USART_DeInit(USART_HandleTypeDef * const husart);
void HAL_USART_MspInit(USART_HandleTypeDef * const husart);
void HAL_USART_MspDeInit(USART_HandleTypeDef * const husart);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_USART_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_USART_RegisterCallback(USART_HandleTypeDef * const husart, HAL_USART_CallbackIDTypeDef CallbackID,
                                             pUSART_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_USART_UnRegisterCallback(USART_HandleTypeDef * const husart, HAL_USART_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_USART_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_USART_Transmit(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint16_t Size,
                                     uint32_t Timeout);
HAL_StatusTypeDef HAL_USART_Receive(USART_HandleTypeDef * const husart, uint8_t * const pRxData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_USART_TransmitReceive(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint8_t * const pRxData,
                                            uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_USART_Transmit_IT(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint16_t Size);
HAL_StatusTypeDef HAL_USART_Receive_IT(USART_HandleTypeDef * const husart, uint8_t * const pRxData, uint16_t Size);
HAL_StatusTypeDef HAL_USART_TransmitReceive_IT(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint8_t * const pRxData,
                                               uint16_t Size);
HAL_StatusTypeDef HAL_USART_Transmit_DMA(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint16_t Size);
HAL_StatusTypeDef HAL_USART_Receive_DMA(USART_HandleTypeDef * const husart, uint8_t * const pRxData, uint16_t Size);
HAL_StatusTypeDef HAL_USART_TransmitReceive_DMA(USART_HandleTypeDef * const husart, uint8_t const * const pTxData, uint8_t * const pRxData,
                                                uint16_t Size);
HAL_StatusTypeDef HAL_USART_DMAPause(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USART_DMAResume(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USART_DMAStop(USART_HandleTypeDef * const husart);
/* Transfer Abort functions */
HAL_StatusTypeDef HAL_USART_Abort(USART_HandleTypeDef * const husart);
HAL_StatusTypeDef HAL_USART_Abort_IT(USART_HandleTypeDef * const husart);

void HAL_USART_IRQHandler(USART_HandleTypeDef * const husart);
void HAL_USART_TxHalfCpltCallback(USART_HandleTypeDef * const husart);
void HAL_USART_TxCpltCallback(USART_HandleTypeDef * const husart);
void HAL_USART_RxCpltCallback(USART_HandleTypeDef * const husart);
void HAL_USART_RxHalfCpltCallback(USART_HandleTypeDef * const husart);
void HAL_USART_TxRxCpltCallback(USART_HandleTypeDef * const husart);
void HAL_USART_ErrorCallback(USART_HandleTypeDef * const husart);
void HAL_USART_AbortCpltCallback(USART_HandleTypeDef * const husart);
...
HAL_USART_StateTypeDef HAL_USART_GetState(USART_HandleTypeDef const * const husart);
uint32_t               HAL_USART_GetError(USART_HandleTypeDef const * const husart);
