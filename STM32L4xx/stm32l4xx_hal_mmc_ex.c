...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_MMCEx_ConfigDMAMultiBuffer(MMC_HandleTypeDef * const hmmc, uint32_t * const pDataBuffer0, uint32_t * const pDataBuffer1, uint32_t BufferSize)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_MMCEx_ReadBlocksDMAMultiBuffer(MMC_HandleTypeDef * const hmmc, uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
...
/**
  ...
  * @retval HAL status
*/
HAL_StatusTypeDef HAL_MMCEx_WriteBlocksDMAMultiBuffer(MMC_HandleTypeDef * const hmmc, uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
  uint32_t DmaBase0_reg, DmaBase1_reg;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_MMCEx_ChangeDMABuffer(MMC_HandleTypeDef * const hmmc, HAL_MMCEx_DMABuffer_MemoryTypeDef Buffer, uint32_t * const pDataBuffer)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_MMCEx_Read_DMADoubleBuffer0CpltCallback(MMC_HandleTypeDef * const hmmc)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_MMCEx_Read_DMADoubleBuffer1CpltCallback(MMC_HandleTypeDef * const hmmc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hmmc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_MMCEx_Write_DMADoubleBuffer0CpltCallback(MMC_HandleTypeDef * const hmmc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hmmc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_MMCEx_Write_DMADoubleBuffer1CpltCallback(MMC_HandleTypeDef * const hmmc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hmmc);
