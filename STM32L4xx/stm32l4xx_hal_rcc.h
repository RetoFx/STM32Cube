...
#define RCC_OSCILLATORTYPE_MSI         0x00000010UL   /*!< MSI to configure */
...
/** @defgroup RCC_LSI_Div LSI Div
  * @{
  */
#define RCC_LSI_DIV1                   0x00000000UL       /*!< LSI clock not divided    */
...
/** @defgroup RCC_MSI_Config MSI Config
  * @{
  */
#define RCC_MSI_OFF                    0x00000000UL   /*!< MSI clock deactivation */
...
/** @defgroup RCC_Stop_WakeUpClock Wake-Up from STOP Clock
  * @{
  */
#define RCC_STOP_WAKEUPCLOCK_MSI       0x00000000UL           /*!< MSI selection after wake-up from STOP */
...
#define __HAL_RCC_PLL_PLLM_CONFIG(__PLLM__) \
                  MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLM, ((__PLLM__) - 1U) << 4U)
