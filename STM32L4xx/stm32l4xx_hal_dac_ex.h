...
HAL_StatusTypeDef HAL_DACEx_SetUserTrimming(DAC_HandleTypeDef * const hdac, DAC_ChannelConfTypeDef * const sConfig, uint32_t Channel, uint32_t NewTrimmingValue);
