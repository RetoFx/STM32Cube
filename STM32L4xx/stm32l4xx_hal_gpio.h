...
#define GPIO_PIN_MASK              ((uint32_t)0x0000FFFFUL) /* PIN mask for assert test */
/**
  * @}
  */
...
#define GPIO_MODE_ANALOG_ADC_CONTROL    (MODE_ANALOG | 0x8UL)                                       /*!< Analog Mode for ADC conversion (0x0000000BUL)*/
