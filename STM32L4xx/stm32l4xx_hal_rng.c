...
#define RNG_HTCFG_1   0x17590ABCUL /*!< Magic number */
#if defined(RNG_VER_3_1) || defined(RNG_VER_3_0)
#define RNG_HTCFG     0x000CAA74UL /*!< Recommended value for NIST compliance, refer to application note AN4230 */
#else /* RNG_VER_3_2 */
#define RNG_HTCFG     0x00007274UL /*!< Recommended value for NIST compliance, refer to application note AN4230 */
...
/**
  ...
  * @retval None
  */
__weak void HAL_RNG_MspInit(RNG_HandleTypeDef * const hrng)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_RNG_MspDeInit(RNG_HandleTypeDef * const hrng)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrng);
  /* NOTE : This function should not be modified. When the callback is needed,
...
/**
  ...
  * @retval Random value
  */
uint32_t HAL_RNG_GetRandomNumber(RNG_HandleTypeDef * const hrng)
{
...
/**
  ...
  */
uint32_t HAL_RNG_GetRandomNumber_IT(RNG_HandleTypeDef * const hrng)
{
...
/**
  ...
  * @retval None
  */
HAL_RNG_WEAK_CALLBACK(void, HAL_RNG_ReadyDataCallback)(RNG_HandleTypeDef * const hrng, uint32_t random32bit)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrng);
  UNUSED(random32bit);
...
/**
  ...
  * @retval None
  */
HAL_RNG_WEAK_CALLBACK(void, HAL_RNG_ErrorCallback)(RNG_HandleTypeDef * const hrng)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrng);
  /* NOTE : This function should not be modified. When the callback is needed,
