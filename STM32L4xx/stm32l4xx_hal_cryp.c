...
static HAL_StatusTypeDef CRYP_SetInitVector(CRYP_HandleTypeDef * const hcryp);
static HAL_StatusTypeDef CRYP_SetKey(CRYP_HandleTypeDef * const hcryp);
static HAL_StatusTypeDef CRYP_AES_IT(CRYP_HandleTypeDef * const hcryp);
