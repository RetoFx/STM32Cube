...
#define PWR_PORTH_AVAILABLE_PINS   ((uint32_t)0x0000000BUL) /* PH0/PH1/PH3 */
...
#define PWR_PORTH_AVAILABLE_PINS   ((uint32_t)0x00000003UL) /* PH0/PH1 */
...
#define PWR_PORTH_AVAILABLE_PINS   ((uint32_t)0x0000FFFFUL) /* PH0..PH15 */
#endif
...
#define PWR_PORTI_AVAILABLE_PINS   ((uint32_t)0x00000FFFUL) /* PI0..PI11 */
#endif
...
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  ...
  if (VoltageScaling == PWR_REGULATOR_VOLTAGE_SCALE1_BOOST)
  {
    ...
    if (READ_BIT(PWR->CR1, PWR_CR1_VOS) == PWR_REGULATOR_VOLTAGE_SCALE2)
    {
      ...
      wait_loop_index = ((PWR_FLAG_SETTING_DELAY_US * SystemCoreClock) / 1000000UL) + 1U;
...
/**
  ...
  * @retval None
  */
HAL_PWREX_WEAK_CALLBACK(void, HAL_PWREx_PVM1Callback)(void)
{
...
/**
  ...
  * @retval None
  */
HAL_PWREX_WEAK_CALLBACK(void, HAL_PWREx_PVM2Callback)(void)
{
  /* NOTE : This function should not be modified; when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_PWREX_WEAK_CALLBACK(void, HAL_PWREx_PVM3Callback)(void)
{
  /* NOTE : This function should not be modified; when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_PWREX_WEAK_CALLBACK(void, HAL_PWREx_PVM4Callback)(void)
{
  /* NOTE : This function should not be modified; when the callback is needed,
