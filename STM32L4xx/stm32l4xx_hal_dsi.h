...
typedef struct
{
  ...
  uint32_t CommandSize;                  /*!< Maximum allowed size for an LTDC write memory command, measured in
                                              pixels. This parameter can be any value between 0x00U and 0xFFFFU   */
...
/**
  ...
  */
#if (USE_HAL_DSI_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_DSI_REGISTER_CALLBACKS == 1U)
  void (* TearingEffectCallback)(struct __DSI_HandleTypeDef * const hdsi);   /*!< DSI Tearing Effect Callback */
  void (* EndOfRefreshCallback)(struct __DSI_HandleTypeDef * const hdsi);    /*!< DSI End Of Refresh Callback */
  void (* ErrorCallback)(struct __DSI_HandleTypeDef * const hdsi);           /*!< DSI Error Callback          */

  void (* MspInitCallback)(struct __DSI_HandleTypeDef * const hdsi);         /*!< DSI Msp Init callback       */
  void (* MspDeInitCallback)(struct __DSI_HandleTypeDef * const hdsi);       /*!< DSI Msp DeInit callback     */
...
/**
  ...
  */
typedef  void (*pDSI_CallbackTypeDef)(DSI_HandleTypeDef * const hdsi);  /*!< pointer to an DSI callback function */
...
/** @defgroup DSI_Color_Mode DSI Color Mode
  * @{
  */
#define DSI_COLOR_MODE_FULL       0x00000000UL
...
/** @defgroup DSI_ShutDown DSI ShutDown
  * @{
  */
#define DSI_DISPLAY_ON            0x00000000UL
...
/** @defgroup DSI_LP_Command DSI LP Command
  * @{
  */
#define DSI_LP_COMMAND_DISABLE    0x00000000UL
...
/** @defgroup DSI_LP_HFP DSI LP HFP
  * @{
  */
#define DSI_LP_HFP_DISABLE        0x00000000UL
...
/** @defgroup DSI_LP_HBP DSI LP HBP
  * @{
  */
#define DSI_LP_HBP_DISABLE        0x00000000UL
...
/** @defgroup DSI_LP_VACT DSI LP VACT
  * @{
  */
#define DSI_LP_VACT_DISABLE       0x00000000UL
...
/** @defgroup DSI_LP_VFP DSI LP VFP
  * @{
  */
#define DSI_LP_VFP_DISABLE       0x00000000UL
...
/** @defgroup DSI_LP_VBP DSI LP VBP
  * @{
  */
#define DSI_LP_VBP_DISABLE       0x00000000UL
...
/** @defgroup DSI_LP_VSYNC DSI LP VSYNC
  * @{
  */
#define DSI_LP_VSYNC_DISABLE     0x00000000UL
...
/** @defgroup DSI_FBTA_acknowledge DSI FBTA Acknowledge
  * @{
  */
#define DSI_FBTAA_DISABLE        0x00000000UL
...
/** @defgroup DSI_TearingEffectSource DSI Tearing Effect Source
  * @{
  */
#define DSI_TE_DSILINK           0x00000000UL
...
/** @defgroup DSI_TearingEffectPolarity DSI Tearing Effect Polarity
  * @{
  */
#define DSI_TE_RISING_EDGE       0x00000000UL
...
/** @defgroup DSI_Vsync_Polarity DSI Vsync Polarity
  * @{
  */
#define DSI_VSYNC_FALLING        0x00000000UL
...
/** @defgroup DSI_AutomaticRefresh DSI Automatic Refresh
  * @{
  */
#define DSI_AR_DISABLE           0x00000000UL
...
/** @defgroup DSI_TE_AcknowledgeRequest DSI TE Acknowledge Request
  * @{
  */
#define DSI_TE_ACKNOWLEDGE_DISABLE 0x00000000UL
...
/** @defgroup DSI_AcknowledgeRequest DSI Acknowledge Request
  * @{
  */
#define DSI_ACKNOWLEDGE_DISABLE   0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortWriteNoP DSI LP LPGen Short Write NoP
  * @{
  */
#define DSI_LP_GSW0P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortWriteOneP DSI LP LPGen Short Write OneP
  * @{
  */
#define DSI_LP_GSW1P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortWriteTwoP DSI LP LPGen Short Write TwoP
  * @{
  */
#define DSI_LP_GSW2P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortReadNoP DSI LP LPGen Short Read NoP
  * @{
  */
#define DSI_LP_GSR0P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortReadOneP DSI LP LPGen Short Read OneP
  * @{
  */
#define DSI_LP_GSR1P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenShortReadTwoP DSI LP LPGen Short Read TwoP
  * @{
  */
#define DSI_LP_GSR2P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPGenLongWrite DSI LP LPGen LongWrite
  * @{
  */
#define DSI_LP_GLW_DISABLE       0x00000000UL
...
/** @defgroup DSI_LP_LPDcsShortWriteNoP DSI LP LPDcs Short Write NoP
  * @{
  */
#define DSI_LP_DSW0P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPDcsShortWriteOneP DSI LP LPDcs Short Write OneP
  * @{
  */
#define DSI_LP_DSW1P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPDcsShortReadNoP DSI LP LPDcs Short Read NoP
  * @{
  */
#define DSI_LP_DSR0P_DISABLE     0x00000000UL
...
/** @defgroup DSI_LP_LPDcsLongWrite DSI LP LPDcs Long Write
  * @{
  */
#define DSI_LP_DLW_DISABLE       0x00000000UL
...
/** @defgroup DSI_LP_LPMaxReadPacket DSI LP LPMax Read Packet
  * @{
  */
#define DSI_LP_MRDP_DISABLE      0x00000000UL
...
/** @defgroup DSI_HS_PrespMode DSI HS Presp Mode
  * @{
  */
#define DSI_HS_PM_DISABLE        0x00000000UL
...
/** @defgroup DSI_Automatic_Clk_Lane_Control DSI Automatic Clk Lane Control
  * @{
  */
#define DSI_AUTO_CLK_LANE_CTRL_DISABLE 0x00000000UL
...
/** @defgroup DSI_Color_Coding DSI Color Coding
  * @{
  */
#define DSI_RGB565                 0x00000000UL /*!< The values 0x00000001UL and 0x00000002UL can also be used for the RGB565 color mode configuration */
#define DSI_RGB666                 0x00000003UL /*!< The value 0x00000004UL can also be used for the RGB666 color mode configuration                 */
#define DSI_RGB888                 0x00000005UL
/**
  * @}
  */
...
#define DSI_LOOSELY_PACKED_DISABLE 0x00000000UL
/**
  * @}
  */
...
/** @defgroup DSI_HSYNC_Polarity DSI HSYNC Polarity
  * @{
  */
#define DSI_HSYNC_ACTIVE_HIGH       0x00000000UL
...
/** @defgroup DSI_VSYNC_Active_Polarity DSI VSYNC Active Polarity
  * @{
  */
#define DSI_VSYNC_ACTIVE_HIGH       0x00000000UL
...
/** @defgroup DSI_DATA_ENABLE_Polarity DSI DATA ENABLE Polarity
  * @{
  */
#define DSI_DATA_ENABLE_ACTIVE_HIGH 0x00000000UL
...
/** @defgroup DSI_PLL_IDF DSI PLL IDF
  * @{
  */
#define DSI_PLL_IN_DIV1             0x00000001UL
#define DSI_PLL_IN_DIV2             0x00000002UL
#define DSI_PLL_IN_DIV3             0x00000003UL
#define DSI_PLL_IN_DIV4             0x00000004UL
#define DSI_PLL_IN_DIV5             0x00000005UL
#define DSI_PLL_IN_DIV6             0x00000006UL
#define DSI_PLL_IN_DIV7             0x00000007UL
/**
  * @}
  */
...
/** @defgroup DSI_PLL_ODF DSI PLL ODF
  * @{
  */
#define DSI_PLL_OUT_DIV1            0x00000000UL
#define DSI_PLL_OUT_DIV2            0x00000001UL
#define DSI_PLL_OUT_DIV4            0x00000002UL
#define DSI_PLL_OUT_DIV8            0x00000003UL
/**
  * @}
  */
...
/** @defgroup DSI_SHORT_WRITE_PKT_Data_Type DSI SHORT WRITE PKT Data Type
  * @{
  */
#define DSI_DCS_SHORT_PKT_WRITE_P0  0x00000005UL /*!< DCS short write, no parameters      */
#define DSI_DCS_SHORT_PKT_WRITE_P1  0x00000015UL /*!< DCS short write, one parameter      */
#define DSI_GEN_SHORT_PKT_WRITE_P0  0x00000003UL /*!< Generic short write, no parameters  */
#define DSI_GEN_SHORT_PKT_WRITE_P1  0x00000013UL /*!< Generic short write, one parameter  */
#define DSI_GEN_SHORT_PKT_WRITE_P2  0x00000023UL /*!< Generic short write, two parameters */
/**
  * @}
  */
...
/** @defgroup DSI_LONG_WRITE_PKT_Data_Type DSI LONG WRITE PKT Data Type
  * @{
  */
#define DSI_DCS_LONG_PKT_WRITE      0x00000039UL /*!< DCS long write     */
#define DSI_GEN_LONG_PKT_WRITE      0x00000029UL /*!< Generic long write */
/**
  * @}
  */
...
/** @defgroup DSI_SHORT_READ_PKT_Data_Type DSI SHORT READ PKT Data Type
  * @{
  */
#define DSI_DCS_SHORT_PKT_READ      0x00000006UL /*!< DCS short read                     */
#define DSI_GEN_SHORT_PKT_READ_P0   0x00000004UL /*!< Generic short read, no parameters  */
#define DSI_GEN_SHORT_PKT_READ_P1   0x00000014UL /*!< Generic short read, one parameter  */
#define DSI_GEN_SHORT_PKT_READ_P2   0x00000024UL /*!< Generic short read, two parameters */
/**
  * @}
  */
...
#define HAL_DSI_ERROR_ACK               0x00000001UL /*!< Acknowledge errors             */
#define HAL_DSI_ERROR_PHY               0x00000002UL /*!< PHY related errors             */
#define HAL_DSI_ERROR_TX                0x00000004UL /*!< Transmission error             */
#define HAL_DSI_ERROR_RX                0x00000008UL /*!< Reception error                */
#define HAL_DSI_ERROR_ECC               0x00000010UL /*!< ECC errors                     */
#define HAL_DSI_ERROR_CRC               0x00000020UL /*!< CRC error                      */
#define HAL_DSI_ERROR_PSE               0x00000040UL /*!< Packet Size error              */
#define HAL_DSI_ERROR_EOT               0x00000080UL /*!< End Of Transmission error      */
#define HAL_DSI_ERROR_OVF               0x00000100UL /*!< FIFO overflow error            */
#define HAL_DSI_ERROR_GEN               0x00000200UL /*!< Generic FIFO related errors    */
#if (USE_HAL_DSI_REGISTER_CALLBACKS == 1U)
#define HAL_DSI_ERROR_INVALID_CALLBACK  0x00000400UL /*!< DSI Invalid Callback error      */
#endif /* USE_HAL_DSI_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup DSI_Lane_Group DSI Lane Group
  * @{
  */
#define DSI_CLOCK_LANE              0x00000000UL
#define DSI_DATA_LANES              0x00000001UL
/**
  * @}
  */
...
/** @defgroup DSI_Communication_Delay DSI Communication Delay
  * @{
  */
#define DSI_SLEW_RATE_HSTX          0x00000000UL
#define DSI_SLEW_RATE_LPTX          0x00000001UL
#define DSI_HS_DELAY                0x00000002UL
/**
  * @}
  */
...
/** @defgroup DSI_CustomLane DSI CustomLane
  * @{
  */
#define DSI_SWAP_LANE_PINS          0x00000000UL
#define DSI_INVERT_HS_SIGNAL        0x00000001UL
/**
  * @}
  */
...
/** @defgroup DSI_Lane_Select DSI Lane Select
  * @{
  */
#define DSI_CLK_LANE                0x00000000UL
#define DSI_DATA_LANE0              0x00000001UL
#define DSI_DATA_LANE1              0x00000002UL
/**
  * @}
  */
...
/** @defgroup DSI_PHY_Timing DSI PHY Timing
  * @{
  */
#define DSI_TCLK_POST               0x00000000UL
#define DSI_TLPX_CLK                0x00000001UL
#define DSI_THS_EXIT                0x00000002UL
#define DSI_TLPX_DATA               0x00000003UL
#define DSI_THS_ZERO                0x00000004UL
#define DSI_THS_TRAIL               0x00000005UL
#define DSI_THS_PREPARE             0x00000006UL
#define DSI_TCLK_ZERO               0x00000007UL
#define DSI_TCLK_PREPARE            0x00000008UL
/**
  * @}
  */
...
/** @defgroup DSI_Group1 Initialization and Configuration functions
  ...
  * @{
  */
HAL_StatusTypeDef HAL_DSI_Init(DSI_HandleTypeDef * const hdsi, DSI_PLLInitTypeDef const * const PLLInit);
HAL_StatusTypeDef HAL_DSI_DeInit(DSI_HandleTypeDef * const hdsi);
void HAL_DSI_MspInit(DSI_HandleTypeDef * const hdsi);
void HAL_DSI_MspDeInit(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_ConfigErrorMonitor(DSI_HandleTypeDef * const hdsi, uint32_t ActiveErrors);
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_DSI_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_DSI_RegisterCallback(DSI_HandleTypeDef * const hdsi, HAL_DSI_CallbackIDTypeDef CallbackID,
                                           pDSI_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_DSI_UnRegisterCallback(DSI_HandleTypeDef * const hdsi, HAL_DSI_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_DSI_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup DSI_Group2 IO operation functions
  ...
  * @{
  */
void HAL_DSI_IRQHandler(DSI_HandleTypeDef * const hdsi);
void HAL_DSI_TearingEffectCallback(DSI_HandleTypeDef * const hdsi);
void HAL_DSI_EndOfRefreshCallback(DSI_HandleTypeDef * const hdsi);
void HAL_DSI_ErrorCallback(DSI_HandleTypeDef * const hdsi);
/**
  * @}
  */
...
/** @defgroup DSI_Group3 Peripheral Control functions
  ...
  * @{
  */
HAL_StatusTypeDef HAL_DSI_SetGenericVCID(DSI_HandleTypeDef * const hdsi, uint32_t VirtualChannelID);
HAL_StatusTypeDef HAL_DSI_ConfigVideoMode(DSI_HandleTypeDef * const hdsi, DSI_VidCfgTypeDef const * const VidCfg);
HAL_StatusTypeDef HAL_DSI_ConfigAdaptedCommandMode(DSI_HandleTypeDef * const hdsi, DSI_CmdCfgTypeDef const * const CmdCfg);
HAL_StatusTypeDef HAL_DSI_ConfigCommand(DSI_HandleTypeDef * const hdsi, DSI_LPCmdTypeDef const * const LPCmd);
HAL_StatusTypeDef HAL_DSI_ConfigFlowControl(DSI_HandleTypeDef * const hdsi, uint32_t FlowControl);
HAL_StatusTypeDef HAL_DSI_ConfigPhyTimer(DSI_HandleTypeDef * const hdsi, DSI_PHY_TimerTypeDef const * const PhyTimers);
HAL_StatusTypeDef HAL_DSI_ConfigHostTimeouts(DSI_HandleTypeDef * const hdsi, DSI_HOST_TimeoutTypeDef const * const HostTimeouts);
HAL_StatusTypeDef HAL_DSI_Start(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_Stop(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_Refresh(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_ColorMode(DSI_HandleTypeDef * const hdsi, uint32_t ColorMode);
HAL_StatusTypeDef HAL_DSI_Shutdown(DSI_HandleTypeDef * const hdsi, uint32_t Shutdown);
HAL_StatusTypeDef HAL_DSI_ShortWrite(DSI_HandleTypeDef * const hdsi,
                                     uint32_t ChannelID,
                                     uint32_t Mode,
                                     uint32_t Param1,
                                     uint32_t Param2);
HAL_StatusTypeDef HAL_DSI_LongWrite(DSI_HandleTypeDef * const hdsi,
                                    uint32_t ChannelID,
                                    uint32_t Mode,
                                    uint32_t NbParams,
                                    uint32_t Param1,
                                    uint8_t const * const ParametersTable);
HAL_StatusTypeDef HAL_DSI_Read(DSI_HandleTypeDef * const hdsi,
                               uint32_t ChannelNbr,
                               uint8_t * const Array,
                               uint32_t Size,
                               uint32_t Mode,
                               uint32_t DCSCmd,
                               uint8_t const * const ParametersTable);
HAL_StatusTypeDef HAL_DSI_EnterULPMData(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_ExitULPMData(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_EnterULPM(DSI_HandleTypeDef * const hdsi);
HAL_StatusTypeDef HAL_DSI_ExitULPM(DSI_HandleTypeDef * const hdsi);

HAL_StatusTypeDef HAL_DSI_PatternGeneratorStart(DSI_HandleTypeDef * const hdsi, uint32_t Mode, uint32_t Orientation);
HAL_StatusTypeDef HAL_DSI_PatternGeneratorStop(DSI_HandleTypeDef * const hdsi);

HAL_StatusTypeDef HAL_DSI_SetSlewRateAndDelayTuning(DSI_HandleTypeDef * const hdsi, uint32_t CommDelay, uint32_t Lane,
                                                    uint32_t Value);
HAL_StatusTypeDef HAL_DSI_SetLowPowerRXFilter(DSI_HandleTypeDef * const hdsi, uint32_t Frequency);
HAL_StatusTypeDef HAL_DSI_SetSDD(DSI_HandleTypeDef * const hdsi, FunctionalState State);
HAL_StatusTypeDef HAL_DSI_SetLanePinsConfiguration(DSI_HandleTypeDef * const hdsi, uint32_t CustomLane, uint32_t Lane,
                                                   FunctionalState State);
HAL_StatusTypeDef HAL_DSI_SetPHYTimings(DSI_HandleTypeDef * const hdsi, uint32_t Timing, FunctionalState State,
                                        uint32_t Value);
HAL_StatusTypeDef HAL_DSI_ForceTXStopMode(DSI_HandleTypeDef * const hdsi, uint32_t Lane, FunctionalState State);
HAL_StatusTypeDef HAL_DSI_ForceRXLowPower(DSI_HandleTypeDef * const hdsi, FunctionalState State);
HAL_StatusTypeDef HAL_DSI_ForceDataLanesInRX(DSI_HandleTypeDef * const hdsi, FunctionalState State);
HAL_StatusTypeDef HAL_DSI_SetPullDown(DSI_HandleTypeDef * const hdsi, FunctionalState State);
HAL_StatusTypeDef HAL_DSI_SetContentionDetectionOff(DSI_HandleTypeDef * const hdsi, FunctionalState State);
...
/** @defgroup DSI_Group4 Peripheral State and Errors functions
  ...
  * @{
  */
uint32_t HAL_DSI_GetError(DSI_HandleTypeDef const * const hdsi);
HAL_DSI_StateTypeDef HAL_DSI_GetState(DSI_HandleTypeDef const * const hdsi);
...
/** @defgroup DSI_Private_Constants DSI Private Constants
  * @{
  */
#define DSI_MAX_RETURN_PKT_SIZE (0x00000037UL) /*!< Maximum return packet configuration */
/**
  * @}
  */
