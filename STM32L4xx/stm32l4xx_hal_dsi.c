...
static void DSI_ConfigPacketHeader(DSI_TypeDef * const DSIx, uint32_t ChannelID, uint32_t DataType, uint32_t Data0,
                                   uint32_t Data1);

static HAL_StatusTypeDef DSI_ShortWrite(DSI_HandleTypeDef * const hdsi,
                                        uint32_t ChannelID,
                                        uint32_t Mode,
                                        uint32_t Param1,
                                        uint32_t Param2);
...
/**
  ...
  * @retval None
  */
static void DSI_ConfigPacketHeader(DSI_TypeDef * const DSIx,
                                   uint32_t ChannelID,
                                   uint32_t DataType,
                                   uint32_t Data0,
                                   uint32_t Data1)
...
HAL_StatusTypeDef HAL_DSI_Init(DSI_HandleTypeDef * const hdsi, DSI_PLLInitTypeDef const * const PLLInit)
{
  ...
  unitIntervalx4 = (4000000UL * tempIDF * ((1UL << (0x3U & PLLInit->PLLODF)))) / ((HSE_VALUE / 1000U) * PLLInit->PLLNDIV);
...
/**
  ...
  * @retval None
  */
__weak void HAL_DSI_MspInit(DSI_HandleTypeDef * const hdsi)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_DSI_MspDeInit(DSI_HandleTypeDef * const hdsi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdsi);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DSI_WEAK_CALLBACK(void, HAL_DSI_TearingEffectCallback)(DSI_HandleTypeDef * const hdsi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdsi);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DSI_WEAK_CALLBACK(void, HAL_DSI_EndOfRefreshCallback)(DSI_HandleTypeDef * const hdsi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdsi);
  /* NOTE : This function Should not be modified, when the callback is needed,
...
/**
  ...
  * @retval None
  */
HAL_DSI_WEAK_CALLBACK(void, HAL_DSI_ErrorCallback)(DSI_HandleTypeDef * const hdsi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdsi);
  /* NOTE : This function Should not be modified, when the callback is needed,
                                    ...
                                    uint8_t const * const ParametersTable)
{
  ...
  uint32_t tickstart;
  uint32_t fifoword;
  uint8_t const * pparams = ParametersTable;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DSI_SetPHYTimings(DSI_HandleTypeDef * const hdsi, uint32_t Timing, FunctionalState State, uint32_t Value)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
