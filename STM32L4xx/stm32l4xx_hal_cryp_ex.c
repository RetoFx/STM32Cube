 ...
 * @{
 */
static HAL_StatusTypeDef CRYP_ProcessData(CRYP_HandleTypeDef * const hcryp, uint8_t const * const Input, uint16_t Ilength, uint8_t * const Output, uint32_t Timeout);
static HAL_StatusTypeDef CRYP_ReadKey(CRYP_HandleTypeDef * const hcryp, uint8_t * Output, uint32_t Timeout);
static void CRYP_SetDMAConfig(CRYP_HandleTypeDef * const hcryp, uint32_t inputaddr, uint16_t Size, uint32_t outputaddr);
static void CRYP_Authentication_SetDMAConfig(CRYP_HandleTypeDef * const hcryp, uint32_t inputaddr, uint16_t Size, uint32_t outputaddr);
static void CRYP_Authentication_DMAInCplt(DMA_HandleTypeDef * const hdma);
static void CRYP_Authentication_DMAError(DMA_HandleTypeDef * const hdma);
static void CRYP_Authentication_DMAOutCplt(DMA_HandleTypeDef * const hdma);
...
static void CRYP_Padding(CRYP_HandleTypeDef * const hcryp, uint32_t difflength, uint32_t polling);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
HAL_CRYPTEX_WEAK_CALLBACK(void, HAL_CRYPEx_ComputationCpltCallback)(CRYP_HandleTypeDef * const hcryp)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES(CRYP_HandleTypeDef * const hcryp, uint8_t const * const pInputData, uint16_t Size, uint8_t * const pOutputData, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES_IT(CRYP_HandleTypeDef * const hcryp,  uint8_t const * const pInputData, uint16_t Size, uint8_t * const pOutputData)
{
  uint32_t inputaddr;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES_DMA(CRYP_HandleTypeDef * const hcryp,  uint8_t const * const pInputData, uint16_t Size, uint8_t * const pOutputData)
{
  uint32_t inputaddr;
  uint32_t outputaddr;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES_Auth(CRYP_HandleTypeDef * const hcryp, uint8_t const * const pInputData, uint64_t Size, uint8_t * const pOutputData, uint32_t Timeout)
{
  uint32_t index             ;
  uint32_t inputaddr         ;
  uint32_t outputaddr        ;
  ...
  if (hcryp->State == HAL_CRYP_STATE_READY)
  {
    ...
    else if (hcryp->Init.GCMCMACPhase == CRYP_HEADER_PHASE)
    {
      ...
      if ((hcryp->Init.ChainingMode == CRYP_CHAINMODE_AES_CMAC) && (Size != 0U))
      {
        ...
        } /* for(index=0; (index < Size); index += 16U) */
      }
    ...
    else
    {
     ...
     /* By default, clear NPBLB field */
      ...
      if (hcryp->Init.ChainingMode == CRYP_CHAINMODE_AES_GCM_GMAC)
      {
        ...
        {
          hcryp->Instance->DINR = __RBIT((uint32_t)(headerlength>> 32U));
          hcryp->Instance->DINR = __RBIT((uint32_t)headerlength);
          hcryp->Instance->DINR = __RBIT((uint32_t)(inputlength>> 32U));
          hcryp->Instance->DINR = __RBIT((uint32_t)inputlength);
        }
        else if(hcryp->Init.DataType == CRYP_DATATYPE_8B)
        {
          hcryp->Instance->DINR = __REV((uint32_t)(headerlength>> 32U));
          hcryp->Instance->DINR = __REV((uint32_t)headerlength);
          hcryp->Instance->DINR = __REV((uint32_t)(inputlength>> 32U));
          hcryp->Instance->DINR = __REV((uint32_t)inputlength);
        }
        else if(hcryp->Init.DataType == CRYP_DATATYPE_16B)
        {
          hcryp->Instance->DINR = __ROR((uint32_t)(headerlength>> 32U), 16);
          hcryp->Instance->DINR = __ROR((uint32_t)headerlength, 16);
          hcryp->Instance->DINR = __ROR((uint32_t)(inputlength>> 32U), 16);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES_Auth_IT(CRYP_HandleTypeDef * const hcryp, uint8_t const * const pInputData, uint64_t Size, uint8_t * const pOutputData)
{
  ...
  mask[0U][0U] = 0xFF000000UL;  mask[0U][1U] = 0xFFFF0000UL;  mask[0U][2U] = 0xFFFFFF00UL;  /* 32-bit data */
  mask[1U][0U] = 0x0000FF00UL;  mask[1U][1U] = 0x0000FFFFUL;  mask[1U][2U] = 0xFF00FFFFUL;  /* 16-bit data */
  mask[2U][0U] = 0x000000FFUL;  mask[2U][1U] = 0x0000FFFFUL;  mask[2U][2U] = 0x00FFFFFFUL;  /* 8-bit data  */
  mask[3U][0U] = 0x000000FFUL;  mask[3U][1U] = 0x0000FFFFUL;  mask[3U][2U] = 0x00FFFFFFUL;  /* Bit data    */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYPEx_AES_Auth_DMA(CRYP_HandleTypeDef * const hcryp, uint8_t const * const pInputData, uint64_t Size, uint8_t * const pOutputData)
{
  uint32_t inputaddr      ;
  uint32_t outputaddr     ;
  uint32_t tagaddr        ;
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Read_IVRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t * const Output)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Write_IVRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t const * const Input)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Read_SuspendRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t * const Output)
{
  uint32_t outputaddr = (uint32_t)Output;
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Write_SuspendRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t const * const Input)
{
  uint32_t ivaddr = (uint32_t)Input;
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Read_KeyRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t * const Output, uint32_t KeySize)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Write_KeyRegisters(CRYP_HandleTypeDef * const hcryp, uint8_t const * const Input, uint32_t KeySize)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Read_ControlRegister(CRYP_HandleTypeDef * const hcryp, uint8_t * const Output)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_Write_ControlRegister(CRYP_HandleTypeDef * const hcryp, uint8_t const * const Input)
{
...
/**
  ...
  * @retval None
  */
void HAL_CRYPEx_ProcessSuspend(CRYP_HandleTypeDef * const hcryp)
{
...
{
  uint32_t difflength;
  CRYP_HandleTypeDef * const hcryp = (CRYP_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;   /* Derogation MisraC2012 R.11.5 */
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef CRYP_AES_Auth_IT(CRYP_HandleTypeDef * const hcryp)
{
  uint32_t inputaddr         ;
  uint32_t outputaddr        ;
  uint32_t index             ;
