...
static HAL_StatusTypeDef RCCEx_PLLSAI1_Config(RCC_PLLSAI1InitTypeDef const * const PllSai1, uint32_t Divider);

#endif /* RCC_PLLSAI1_SUPPORT */

#if defined(RCC_PLLSAI2_SUPPORT)

static HAL_StatusTypeDef RCCEx_PLLSAI2_Config(RCC_PLLSAI2InitTypeDef const * const PllSai2, uint32_t Divider);
...
/**
  ...
  * @retval none
  */
HAL_RCCEX_WEAK_CALLBACK(void, HAL_RCCEx_LSECSS_Callback)(void)
{
