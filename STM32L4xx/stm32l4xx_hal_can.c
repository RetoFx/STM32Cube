...
#define CAN_WAKEUP_TIMEOUT_COUNTER 1000000UL
/**
  * @}
  */
/* Private macro -------------------------------------------------------------*/
...
/**
  ...
  * @retval None
  */
__weak void HAL_CAN_MspInit(CAN_HandleTypeDef * const hcan)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_CAN_MspDeInit(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
HAL_StatusTypeDef HAL_CAN_ConfigFilter(CAN_HandleTypeDef * const hcan, CAN_FilterTypeDef const * const sFilterConfig)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    filternbrbitpos = (uint32_t)1UL << (sFilterConfig->FilterBank & 0x1FU);
    ...
    if (sFilterConfig->FilterScale == CAN_FILTERSCALE_16BIT)
    {
      ...
      can_ip->sFilterRegister[sFilterConfig->FilterBank].FR1 =
        ((0x0000FFFFUL & (uint32_t)sFilterConfig->FilterMaskIdLow) << 16U) |
        (0x0000FFFFUL & (uint32_t)sFilterConfig->FilterIdLow);

      /* Second 16-bit identifier and Second 16-bit mask */
      /* Or Third 16-bit identifier and Fourth 16-bit identifier */
      can_ip->sFilterRegister[sFilterConfig->FilterBank].FR2 =
        ((0x0000FFFFUL & (uint32_t)sFilterConfig->FilterMaskIdHigh) << 16U) |
        (0x0000FFFFUL & (uint32_t)sFilterConfig->FilterIdHigh);
    }
    ...
    if (sFilterConfig->FilterScale == CAN_FILTERSCALE_32BIT)
    {
      ...
      can_ip->sFilterRegister[sFilterConfig->FilterBank].FR1 =
        ((0x0000FFFFUL & (uint32_t)sFilterConfig->FilterIdHigh) << 16U) |
        (0x0000FFFFUL & (uint32_t)sFilterConfig->FilterIdLow);

      /* 32-bit mask or Second 32-bit identifier */
      can_ip->sFilterRegister[sFilterConfig->FilterBank].FR2 =
        ((0x0000FFFFUL & (uint32_t)sFilterConfig->FilterMaskIdHigh) << 16U) |
        (0x0000FFFFUL & (uint32_t)sFilterConfig->FilterMaskIdLow);
    }
        ...
        ((tsr & CAN_TSR_TME2) != 0U))
    {
      ...
      *pTxMailbox = (uint32_t)1UL << transmitmailbox;
      ...
      WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDHR,
                ((uint32_t)aData[7U] << CAN_TDH0R_DATA7_Pos) |
                ((uint32_t)aData[6U] << CAN_TDH0R_DATA6_Pos) |
                ((uint32_t)aData[5U] << CAN_TDH0R_DATA5_Pos) |
                ((uint32_t)aData[4U] << CAN_TDH0R_DATA4_Pos));
      WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDLR,
                ((uint32_t)aData[3U] << CAN_TDL0R_DATA3_Pos) |
                ((uint32_t)aData[2U] << CAN_TDL0R_DATA2_Pos) |
                ((uint32_t)aData[1U] << CAN_TDL0R_DATA1_Pos) |
                ((uint32_t)aData[0U] << CAN_TDL0R_DATA0_Pos));
                                       ...
                                       CAN_RxHeaderTypeDef * const pHeader, uint8_t aData[])
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    /* Get the data */
    aData[0U] = (uint8_t)((CAN_RDL0R_DATA0 & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> CAN_RDL0R_DATA0_Pos);
    aData[1U] = (uint8_t)((CAN_RDL0R_DATA1 & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> CAN_RDL0R_DATA1_Pos);
    aData[2U] = (uint8_t)((CAN_RDL0R_DATA2 & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> CAN_RDL0R_DATA2_Pos);
    aData[3U] = (uint8_t)((CAN_RDL0R_DATA3 & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> CAN_RDL0R_DATA3_Pos);
    aData[4U] = (uint8_t)((CAN_RDH0R_DATA4 & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> CAN_RDH0R_DATA4_Pos);
    aData[5U] = (uint8_t)((CAN_RDH0R_DATA5 & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> CAN_RDH0R_DATA5_Pos);
    aData[6U] = (uint8_t)((CAN_RDH0R_DATA6 & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> CAN_RDH0R_DATA6_Pos);
    aData[7U] = (uint8_t)((CAN_RDH0R_DATA7 & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> CAN_RDH0R_DATA7_Pos);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox0CompleteCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox1CompleteCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox2CompleteCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox0AbortCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox1AbortCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_TxMailbox2AbortCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_RxFifo0MsgPendingCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_RxFifo0FullCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_RxFifo1MsgPendingCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_RxFifo1FullCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_SleepCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_WakeUpFromRxMsgCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
...
/**
  ...
  * @retval None
  */
HAL_CAN_WEAK_CALLBACK(void, HAL_CAN_ErrorCallback)(CAN_HandleTypeDef * const hcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcan);
