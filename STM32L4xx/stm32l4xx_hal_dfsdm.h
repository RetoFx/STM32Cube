...
/** @defgroup DFSDM_Filter_ExtTrigger DFSDM filter external trigger
  ...
  */
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx)
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO  0x00000000UL                                       /*!< For DFSDM filter 0, 1, 2 and 3 */
...
#define DFSDM_FILTER_EXT_TRIG_EXTI15     DFSDM_FLTCR1_JEXTSEL                              /*!< For DFSDM filter 0, 1, 2 and 3 */
      ...
      defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO  0x00000000UL                                       /*!< For all DFSDM filters */
...
/* The DFSDM channels are defined as follows:
   ...
   e.g. for channel 5 definition:
        - the channel mask is 0x00000020UL (bit 5 is set)
        - the channel number 5 is 0x00050000UL
        --> Consequently, channel 5 definition is 0x00000020UL | 0x00050000UL = 0x00050020UL */
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx) || \
    defined(STM32L4P5xx) || defined(STM32L4Q5xx)
...
#define DFSDM_CHANNEL_2                              0x00020004UL
#define DFSDM_CHANNEL_3                              0x00030008UL
#define DFSDM_CHANNEL_4                              0x00040010UL
#define DFSDM_CHANNEL_5                              0x00050020UL
#define DFSDM_CHANNEL_6                              0x00060040UL
#define DFSDM_CHANNEL_7                              0x00070080UL
...
HAL_StatusTypeDef HAL_DFSDM_FilterAwdStart_IT(DFSDM_Filter_HandleTypeDef * const hdfsdm_filter,
                                              DFSDM_Filter_AwdParamTypeDef const * const awdParam);
