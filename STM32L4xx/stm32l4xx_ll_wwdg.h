...
/** @defgroup WWDG_LL_EC_PRESCALER  PRESCALER
  * @{
  */
#define LL_WWDG_PRESCALER_1                 0x00000000UL                                               /*!< WWDG counter clock = (PCLK1/4096)/1 */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_Enable(WWDG_TypeDef * const WWDGx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_WWDG_IsEnabled(WWDG_TypeDef const * const WWDGx)
{
...
/**
  ...
  *         A reset is produced when it rolls over from 0x40U to 0x3FU (bit T6 becomes cleared)
  *         Setting the counter lower then 0x40U causes an immediate reset (if WWDG enabled)
  * @rmtoll CR           T             LL_WWDG_SetCounter
  * @param  WWDGx WWDG Instance
  * @param  Counter 0..0x7FU (7 bit counter value)
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_SetCounter(WWDG_TypeDef * const WWDGx, uint32_t Counter)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_WWDG_GetCounter(WWDG_TypeDef const * const WWDGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_SetPrescaler(WWDG_TypeDef * const WWDGx, uint32_t Prescaler)
{
...
/**
  ...
  *         @arg @ref LL_WWDG_PRESCALER_8
  */
__STATIC_INLINE uint32_t LL_WWDG_GetPrescaler(WWDG_TypeDef const * const WWDGx)
{
...
/**
  ...
  *         Physically is possible to set the Window lower then 0x40U but it is not recommended.
  *         To generate an immediate reset, it is possible to set the Counter lower than 0x40U.
  * @rmtoll CFR          W             LL_WWDG_SetWindow
  * @param  WWDGx WWDG Instance
  * @param  Window 0x00U..0x7FU (7 bit Window value)
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_SetWindow(WWDG_TypeDef * const WWDGx, uint32_t Window)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_WWDG_GetWindow(WWDG_TypeDef const * const WWDGx)
{
...
/**
  ...
  * @note   This bit is set by hardware when the counter has reached the value 0x40U.
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_WWDG_IsActiveFlag_EWKUP(WWDG_TypeDef const * const WWDGx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_ClearFlag_EWKUP(WWDG_TypeDef * const WWDGx)
{
...
/**
  ...
  * @note   When set, an interrupt occurs whenever the counter reaches value 0x40U.
  *         This interrupt is only cleared by hardware after a reset
  * @rmtoll CFR          EWI           LL_WWDG_EnableIT_EWKUP
  * @param  WWDGx WWDG Instance
  * @retval None
  */
__STATIC_INLINE void LL_WWDG_EnableIT_EWKUP(WWDG_TypeDef * const WWDGx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_WWDG_IsEnabledIT_EWKUP(WWDG_TypeDef const * const WWDGx)
{
