...
#define LL_DAC_TRIG_EXT_TIM6_TRGO          0x00000000UL                                                         /*!< DAC channel conversion trigger from external IP: TIM6 TRGO. */
...
#define __LL_DAC_DIGITAL_SCALE(__DAC_RESOLUTION__)                             \
  ((0x00000FFFUL) >> ((__DAC_RESOLUTION__) << 1U))
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DAC_ConvertDualData12LeftAligned(DAC_TypeDef * const DACx, uint32_t DataChannel1, uint32_t DataChannel2)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DAC_ConvertDualData8RightAligned(DAC_TypeDef * const DACx, uint32_t DataChannel1, uint32_t DataChannel2)
{
