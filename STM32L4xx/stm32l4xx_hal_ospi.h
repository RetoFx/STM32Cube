...
typedef struct
{
  ...
  uint32_t Refresh;                   /*!< It enables the refresh rate feature. The chip select is released every
                                           ...
                                           This parameter can be a value between 0 and 0xFFFFFFFFUL */
#endif
} OSPI_InitTypeDef;
...
#if defined (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U)
  void (* ErrorCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* AbortCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* FifoThresholdCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* CmdCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* RxCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* TxCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* RxHalfCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* TxHalfCpltCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* StatusMatchCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* TimeOutCallback)(struct __OSPI_HandleTypeDef * const hospi);

  void (* MspInitCallback)(struct __OSPI_HandleTypeDef * const hospi);
  void (* MspDeInitCallback)(struct __OSPI_HandleTypeDef * const hospi);
#endif /* (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U) */
} OSPI_HandleTypeDef;
...
typedef struct
{
  ...
  uint32_t NbData;                    /*!< It indicates the number of data transferred with this command.
                                           ...
                                           This parameter can be a value between 1 and 0xFFFFFFFFUL */
...
typedef struct
{
  uint32_t Match;              /*!< Specifies the value to be compared with the masked status register to get a match.
                                    This parameter can be any value between 0 and 0xFFFFFFFFUL */
...
/**
  ...
  */
typedef void (*pOSPI_CallbackTypeDef)(OSPI_HandleTypeDef * const hospi);
#endif /* (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U) */
/**
  * @}
  */
...
/** @defgroup OSPI_State OSPI State
  * @{
  */
#define HAL_OSPI_STATE_RESET                 ((uint32_t)0x00000000UL)      /*!< Initial state                                                          */
#define HAL_OSPI_STATE_HYPERBUS_INIT         ((uint32_t)0x00000001UL)      /*!< Initialization done in hyperbus mode but timing configuration not done */
#define HAL_OSPI_STATE_READY                 ((uint32_t)0x00000002UL)      /*!< Driver ready to be used                                                */
#define HAL_OSPI_STATE_CMD_CFG               ((uint32_t)0x00000004UL)      /*!< Command (regular or hyperbus) configured, ready for an action          */
#define HAL_OSPI_STATE_READ_CMD_CFG          ((uint32_t)0x00000014UL)      /*!< Read command configuration done, not the write command configuration   */
#define HAL_OSPI_STATE_WRITE_CMD_CFG         ((uint32_t)0x00000024UL)      /*!< Write command configuration done, not the read command configuration   */
#define HAL_OSPI_STATE_BUSY_CMD              ((uint32_t)0x00000008UL)      /*!< Command without data on-going                                          */
#define HAL_OSPI_STATE_BUSY_TX               ((uint32_t)0x00000018UL)      /*!< Indirect Tx on-going                                                   */
#define HAL_OSPI_STATE_BUSY_RX               ((uint32_t)0x00000028UL)      /*!< Indirect Rx on-going                                                   */
#define HAL_OSPI_STATE_BUSY_AUTO_POLLING     ((uint32_t)0x00000048UL)      /*!< Auto-polling on-going                                                  */
#define HAL_OSPI_STATE_BUSY_MEM_MAPPED       ((uint32_t)0x00000088UL)      /*!< Memory-mapped on-going                                                 */
#define HAL_OSPI_STATE_ABORT                 ((uint32_t)0x00000100UL)      /*!< Abort on-going                                                         */
#define HAL_OSPI_STATE_ERROR                 ((uint32_t)0x00000200UL)      /*!< Blocking error, driver should be re-initialized                        */
/**
  * @}
  */
...
/** @defgroup OSPI_ErrorCode OSPI Error Code
  * @{
  */
#define HAL_OSPI_ERROR_NONE                  ((uint32_t)0x00000000UL)                                         /*!< No error                                   */
#define HAL_OSPI_ERROR_TIMEOUT               ((uint32_t)0x00000001UL)                                         /*!< Timeout error                              */
#define HAL_OSPI_ERROR_TRANSFER              ((uint32_t)0x00000002UL)                                         /*!< Transfer error                             */
#define HAL_OSPI_ERROR_DMA                   ((uint32_t)0x00000004UL)                                         /*!< DMA transfer error                         */
#define HAL_OSPI_ERROR_INVALID_PARAM         ((uint32_t)0x00000008UL)                                         /*!< Invalid parameters error                   */
#define HAL_OSPI_ERROR_INVALID_SEQUENCE      ((uint32_t)0x00000010UL)                                         /*!< Sequence of the state machine is incorrect */
#if defined (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U)
#define HAL_OSPI_ERROR_INVALID_CALLBACK      ((uint32_t)0x00000020UL)                                         /*!< Invalid callback error                     */
#endif /* (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U)*/
/**
  * @}
  */
...
/** @defgroup OSPI_DualQuad OSPI Dual-Quad
  * @{
  */
#define HAL_OSPI_DUALQUAD_DISABLE            ((uint32_t)0x00000000UL)                                         /*!< Dual-Quad mode disabled */
...
/** @defgroup OSPI_MemoryType OSPI Memory Type
  * @{
  */
#define HAL_OSPI_MEMTYPE_MICRON              ((uint32_t)0x00000000UL)                                         /*!< Micron mode       */
...
/** @defgroup OSPI_FreeRunningClock OSPI Free Running Clock
  * @{
  */
#define HAL_OSPI_FREERUNCLK_DISABLE          ((uint32_t)0x00000000UL)                                         /*!< CLK is not free running               */
...
/** @defgroup OSPI_ClockMode OSPI Clock Mode
  * @{
  */
#define HAL_OSPI_CLOCK_MODE_0                ((uint32_t)0x00000000UL)                                         /*!< CLK must stay low while nCS is high  */
...
/** @defgroup OSPI_SampleShifting OSPI Sample Shifting
  * @{
  */
#define HAL_OSPI_SAMPLE_SHIFTING_NONE        ((uint32_t)0x00000000UL)                                         /*!< No shift        */
...
/** @defgroup OSPI_DelayHoldQuarterCycle OSPI Delay Hold Quarter Cycle
  * @{
  */
#define HAL_OSPI_DHQC_DISABLE                ((uint32_t)0x00000000UL)                                         /*!< No Delay             */
...
/** @defgroup OSPI_DelayBlockBypass OSPI Delay Block Bypaas
  * @{
  */
#define HAL_OSPI_DELAY_BLOCK_USED            ((uint32_t)0x00000000UL)                                         /*!< Sampling clock is delayed by the delay block */
...
/** @defgroup OSPI_OperationType OSPI Operation Type
  * @{
  */
#define HAL_OSPI_OPTYPE_COMMON_CFG           ((uint32_t)0x00000000UL)                                         /*!< Common configuration (indirect or auto-polling mode) */
#define HAL_OSPI_OPTYPE_READ_CFG             ((uint32_t)0x00000001UL)                                         /*!< Read configuration (memory-mapped mode)              */
#define HAL_OSPI_OPTYPE_WRITE_CFG            ((uint32_t)0x00000002UL)                                         /*!< Write configuration (memory-mapped mode)             */
/**
  * @}
  */
...
/** @defgroup OSPI_FlashID OSPI Flash Id
  * @{
  */
#define HAL_OSPI_FLASH_ID_1                  ((uint32_t)0x00000000UL)                                         /*!< FLASH 1 selected */
...
/** @defgroup OSPI_InstructionMode OSPI Instruction Mode
  * @{
  */
#define HAL_OSPI_INSTRUCTION_NONE            ((uint32_t)0x00000000UL)                                         /*!< No instruction               */
...
/** @defgroup OSPI_InstructionSize OSPI Instruction Size
  * @{
  */
#define HAL_OSPI_INSTRUCTION_8_BITS          ((uint32_t)0x00000000UL)                                         /*!< 8-bit instruction  */
...
/** @defgroup OSPI_InstructionDtrMode OSPI Instruction DTR Mode
  * @{
  */
#define HAL_OSPI_INSTRUCTION_DTR_DISABLE     ((uint32_t)0x00000000UL)                                         /*!< DTR mode disabled for instruction phase */
...
/** @defgroup OSPI_AddressMode OSPI Address Mode
  * @{
  */
#define HAL_OSPI_ADDRESS_NONE                ((uint32_t)0x00000000UL)                                         /*!< No address               */
...
/** @defgroup OSPI_AddressSize OSPI Address Size
  * @{
  */
#define HAL_OSPI_ADDRESS_8_BITS              ((uint32_t)0x00000000UL)                                         /*!< 8-bit address  */
...
/** @defgroup OSPI_AddressDtrMode OSPI Address DTR Mode
  * @{
  */
#define HAL_OSPI_ADDRESS_DTR_DISABLE         ((uint32_t)0x00000000UL)                                         /*!< DTR mode disabled for address phase */
...
/** @defgroup OSPI_AlternateBytesMode OSPI Alternate Bytes Mode
  * @{
  */
#define HAL_OSPI_ALTERNATE_BYTES_NONE        ((uint32_t)0x00000000UL)                                         /*!< No alternate bytes               */
...
/** @defgroup OSPI_AlternateBytesSize OSPI Alternate Bytes Size
  * @{
  */
#define HAL_OSPI_ALTERNATE_BYTES_8_BITS      ((uint32_t)0x00000000UL)                                         /*!< 8-bit alternate bytes  */
...
/** @defgroup OSPI_AlternateBytesDtrMode OSPI Alternate Bytes DTR Mode
  * @{
  */
#define HAL_OSPI_ALTERNATE_BYTES_DTR_DISABLE ((uint32_t)0x00000000UL)                                         /*!< DTR mode disabled for alternate bytes phase */
...
/** @defgroup OSPI_DataMode OSPI Data Mode
  * @{
  */
#define HAL_OSPI_DATA_NONE                   ((uint32_t)0x00000000UL)                                         /*!< No data               */
...
/** @defgroup OSPI_DataDtrMode OSPI Data DTR Mode
  * @{
  */
#define HAL_OSPI_DATA_DTR_DISABLE            ((uint32_t)0x00000000UL)                                         /*!< DTR mode disabled for data phase */
...
/** @defgroup OSPI_DQSMode OSPI DQS Mode
  * @{
  */
#define HAL_OSPI_DQS_DISABLE                 ((uint32_t)0x00000000UL)                                         /*!< DQS disabled */
...
/** @defgroup OSPI_SIOOMode OSPI SIOO Mode
  * @{
  */
#define HAL_OSPI_SIOO_INST_EVERY_CMD         ((uint32_t)0x00000000UL)                                         /*!< Send instruction on every transaction       */
...
/** @defgroup OSPI_WriteZeroLatency OSPI Hyperbus Write Zero Latency Activation
  * @{
  */
#define HAL_OSPI_LATENCY_ON_WRITE            ((uint32_t)0x00000000UL)                                         /*!< Latency on write accesses    */
...
/** @defgroup OSPI_LatencyMode OSPI Hyperbus Latency Mode
  * @{
  */
#define HAL_OSPI_VARIABLE_LATENCY            ((uint32_t)0x00000000UL)                                         /*!< Variable initial latency */
...
/** @defgroup OSPI_AddressSpace OSPI Hyperbus Address Space
  * @{
  */
#define HAL_OSPI_MEMORY_ADDRESS_SPACE        ((uint32_t)0x00000000UL)                                         /*!< HyperBus memory mode   */
...
/** @defgroup OSPI_MatchMode OSPI Match Mode
  * @{
  */
#define HAL_OSPI_MATCH_MODE_AND              ((uint32_t)0x00000000UL)                                         /*!< AND match mode between unmasked bits */
...
/** @defgroup OSPI_AutomaticStop OSPI Automatic Stop
  * @{
  */
#define HAL_OSPI_AUTOMATIC_STOP_DISABLE      ((uint32_t)0x00000000UL)                                         /*!< AutoPolling stops only with abort or OSPI disabling */
...
/** @defgroup OSPI_TimeOutActivation OSPI Timeout Activation
  * @{
  */
#define HAL_OSPI_TIMEOUT_COUNTER_DISABLE     ((uint32_t)0x00000000UL)                                         /*!< Timeout counter disabled, nCS remains active               */
...
/** @defgroup OSPIM_IOPort OSPI IO Manager IO Port
  * @{
  */
#define HAL_OSPIM_IOPORT_NONE              ((uint32_t)0x00000000UL)                                          /*!< IOs not used */
...
/** @addtogroup OSPI_Exported_Functions_Group1
  * @{
  */
HAL_StatusTypeDef     HAL_OSPI_Init(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_MspInit(OSPI_HandleTypeDef * const hospi);
HAL_StatusTypeDef     HAL_OSPI_DeInit(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_MspDeInit(OSPI_HandleTypeDef * const hospi);
...
void                  HAL_OSPI_IRQHandler(OSPI_HandleTypeDef * const hospi);

/* OSPI command configuration functions */
HAL_StatusTypeDef     HAL_OSPI_Command(OSPI_HandleTypeDef * const hospi, OSPI_RegularCmdTypeDef const * const cmd, uint32_t Timeout);
HAL_StatusTypeDef     HAL_OSPI_Command_IT(OSPI_HandleTypeDef * const hospi, OSPI_RegularCmdTypeDef const * const cmd);
HAL_StatusTypeDef     HAL_OSPI_HyperbusCfg(OSPI_HandleTypeDef * const hospi, OSPI_HyperbusCfgTypeDef const * const cfg, uint32_t Timeout);
HAL_StatusTypeDef     HAL_OSPI_HyperbusCmd(OSPI_HandleTypeDef * const hospi, OSPI_HyperbusCmdTypeDef const * const cmd, uint32_t Timeout);

/* OSPI indirect mode functions */
HAL_StatusTypeDef     HAL_OSPI_Transmit(OSPI_HandleTypeDef * const hospi, uint8_t const * const pData, uint32_t Timeout);
HAL_StatusTypeDef     HAL_OSPI_Receive(OSPI_HandleTypeDef * const hospi, uint8_t * const pData, uint32_t Timeout);
HAL_StatusTypeDef     HAL_OSPI_Transmit_IT(OSPI_HandleTypeDef * const hospi, uint8_t const * const pData);
HAL_StatusTypeDef     HAL_OSPI_Receive_IT(OSPI_HandleTypeDef * const hospi, uint8_t * const pData);
HAL_StatusTypeDef     HAL_OSPI_Transmit_DMA(OSPI_HandleTypeDef * const hospi, uint8_t const * const pData);
HAL_StatusTypeDef     HAL_OSPI_Receive_DMA(OSPI_HandleTypeDef * const hospi, uint8_t * const pData);

/* OSPI status flag polling mode functions */
HAL_StatusTypeDef     HAL_OSPI_AutoPolling(OSPI_HandleTypeDef * const hospi, OSPI_AutoPollingTypeDef const * const cfg, uint32_t Timeout);
HAL_StatusTypeDef     HAL_OSPI_AutoPolling_IT(OSPI_HandleTypeDef * const hospi, OSPI_AutoPollingTypeDef const * const cfg);

/* OSPI memory-mapped mode functions */
HAL_StatusTypeDef     HAL_OSPI_MemoryMapped(OSPI_HandleTypeDef * const hospi, OSPI_MemoryMappedTypeDef const * const cfg);

/* Callback functions in non-blocking modes ***********************************/
void                  HAL_OSPI_ErrorCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_AbortCpltCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_FifoThresholdCallback(OSPI_HandleTypeDef * const hospi);

/* OSPI indirect mode functions */
void                  HAL_OSPI_CmdCpltCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_RxCpltCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_TxCpltCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_RxHalfCpltCallback(OSPI_HandleTypeDef * const hospi);
void                  HAL_OSPI_TxHalfCpltCallback(OSPI_HandleTypeDef * const hospi);

/* OSPI status flag polling mode functions */
void                  HAL_OSPI_StatusMatchCallback(OSPI_HandleTypeDef * const hospi);

/* OSPI memory-mapped mode functions */
void                  HAL_OSPI_TimeOutCallback(OSPI_HandleTypeDef * const hospi);

#if defined (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U)
/* OSPI callback registering/unregistering */
HAL_StatusTypeDef     HAL_OSPI_RegisterCallback(OSPI_HandleTypeDef * const hospi, HAL_OSPI_CallbackIDTypeDef CallbackID,
                                                pOSPI_CallbackTypeDef pCallback);
HAL_StatusTypeDef     HAL_OSPI_UnRegisterCallback(OSPI_HandleTypeDef * const hospi, HAL_OSPI_CallbackIDTypeDef CallbackID);
#endif /* (USE_HAL_OSPI_REGISTER_CALLBACKS) && (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U) */
/**
  * @}
  */
...
/** @addtogroup OSPI_Exported_Functions_Group3
  * @{
  */
HAL_StatusTypeDef     HAL_OSPI_Abort(OSPI_HandleTypeDef * const hospi);
HAL_StatusTypeDef     HAL_OSPI_Abort_IT(OSPI_HandleTypeDef * const hospi);
HAL_StatusTypeDef     HAL_OSPI_SetFifoThreshold(OSPI_HandleTypeDef * const hospi, uint32_t Threshold);
uint32_t              HAL_OSPI_GetFifoThreshold(OSPI_HandleTypeDef const * const hospi);
HAL_StatusTypeDef     HAL_OSPI_SetTimeout(OSPI_HandleTypeDef * const hospi, uint32_t Timeout);
uint32_t              HAL_OSPI_GetError(OSPI_HandleTypeDef const * const hospi);
uint32_t              HAL_OSPI_GetState(OSPI_HandleTypeDef const * const hospi);
...
/** @addtogroup OSPI_Exported_Functions_Group4
  * @{
  */
HAL_StatusTypeDef     HAL_OSPIM_Config(OSPI_HandleTypeDef * const hospi, OSPIM_CfgTypeDef const * const cfg, uint32_t Timeout);
