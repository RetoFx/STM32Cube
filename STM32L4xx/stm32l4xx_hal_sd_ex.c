...
/**
  ...
  */
uint32_t HAL_SDEx_HighSpeed(SD_HandleTypeDef * const hsd)
{
...
/**
  ...
  * @retval None
  */
HAL_SDEX_WEAK_CALLBACK(void, HAL_SDEx_DriveTransceiver_1_8V_Callback)(FlagStatus status)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDEx_ConfigDMAMultiBuffer(SD_HandleTypeDef * const hsd, uint32_t * const pDataBuffer0, uint32_t * const pDataBuffer1, uint32_t BufferSize)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDEx_ReadBlocksDMAMultiBuffer(SD_HandleTypeDef * const hsd, uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
...
/**
  ...
  * @retval HAL status
*/
HAL_StatusTypeDef HAL_SDEx_WriteBlocksDMAMultiBuffer(SD_HandleTypeDef * const hsd, uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
  uint32_t DmaBase0_reg, DmaBase1_reg;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_SDEx_ChangeDMABuffer(SD_HandleTypeDef * const hsd, HAL_SDEx_DMABuffer_MemoryTypeDef Buffer, uint32_t * const pDataBuffer)
{
...
/**
  ...
  * @retval None
  */
HAL_SDEX_WEAK_CALLBACK(void, HAL_SDEx_Read_DMADoubleBuffer0CpltCallback)(SD_HandleTypeDef * const hsd)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsd);
...
/**
  ...
  * @retval None
  */
HAL_SDEX_WEAK_CALLBACK(void, HAL_SDEx_Read_DMADoubleBuffer1CpltCallback)(SD_HandleTypeDef * const hsd)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsd);
...
/**
  ...
  * @retval None
  */
HAL_SDEX_WEAK_CALLBACK(void, HAL_SDEx_Write_DMADoubleBuffer0CpltCallback)(SD_HandleTypeDef * const hsd)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsd);
...
/**
  ...
  * @retval None
  */
HAL_SDEX_WEAK_CALLBACK(void, HAL_SDEx_Write_DMADoubleBuffer1CpltCallback)(SD_HandleTypeDef * const hsd)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hsd);
