...
/** @defgroup SDMMC_LL_Exported_Constants SDMMC_LL Exported Constants
  * @{
  */
#define SDMMC_ERROR_NONE                     ((uint32_t)0x00000000UL)   /*!< No error                                                      */
#define SDMMC_ERROR_CMD_CRC_FAIL             ((uint32_t)0x00000001UL)   /*!< Command response received (but CRC check failed)              */
#define SDMMC_ERROR_DATA_CRC_FAIL            ((uint32_t)0x00000002UL)   /*!< Data block sent/received (CRC check failed)                   */
#define SDMMC_ERROR_CMD_RSP_TIMEOUT          ((uint32_t)0x00000004UL)   /*!< Command response timeout                                      */
#define SDMMC_ERROR_DATA_TIMEOUT             ((uint32_t)0x00000008UL)   /*!< Data timeout                                                  */
#define SDMMC_ERROR_TX_UNDERRUN              ((uint32_t)0x00000010UL)   /*!< Transmit FIFO underrun                                        */
#define SDMMC_ERROR_RX_OVERRUN               ((uint32_t)0x00000020UL)   /*!< Receive FIFO overrun                                          */
#define SDMMC_ERROR_ADDR_MISALIGNED          ((uint32_t)0x00000040UL)   /*!< Misaligned address                                            */
#define SDMMC_ERROR_BLOCK_LEN_ERR            ((uint32_t)0x00000080UL)   /*!< Transferred block length is not allowed for the card or the
                                                                            number of transferred bytes does not match the block length   */
#define SDMMC_ERROR_ERASE_SEQ_ERR            ((uint32_t)0x00000100UL)   /*!< An error in the sequence of erase command occurs              */
#define SDMMC_ERROR_BAD_ERASE_PARAM          ((uint32_t)0x00000200UL)   /*!< An invalid selection for erase groups                         */
#define SDMMC_ERROR_WRITE_PROT_VIOLATION     ((uint32_t)0x00000400UL)   /*!< Attempt to program a write protect block                      */
#define SDMMC_ERROR_LOCK_UNLOCK_FAILED       ((uint32_t)0x00000800UL)   /*!< Sequence or password error has been detected in unlock
                                                                            command or if there was an attempt to access a locked card    */
#define SDMMC_ERROR_COM_CRC_FAILED           ((uint32_t)0x00001000UL)   /*!< CRC check of the previous command failed                      */
#define SDMMC_ERROR_ILLEGAL_CMD              ((uint32_t)0x00002000UL)   /*!< Command is not legal for the card state                       */
#define SDMMC_ERROR_CARD_ECC_FAILED          ((uint32_t)0x00004000UL)   /*!< Card internal ECC was applied but failed to correct the data  */
#define SDMMC_ERROR_CC_ERR                   ((uint32_t)0x00008000UL)   /*!< Internal card controller error                                */
#define SDMMC_ERROR_GENERAL_UNKNOWN_ERR      ((uint32_t)0x00010000UL)   /*!< General or unknown error                                      */
#define SDMMC_ERROR_STREAM_READ_UNDERRUN     ((uint32_t)0x00020000UL)   /*!< The card could not sustain data reading in stream rmode       */
#define SDMMC_ERROR_STREAM_WRITE_OVERRUN     ((uint32_t)0x00040000UL)   /*!< The card could not sustain data programming in stream mode    */
#define SDMMC_ERROR_CID_CSD_OVERWRITE        ((uint32_t)0x00080000UL)   /*!< CID/CSD overwrite error                                       */
#define SDMMC_ERROR_WP_ERASE_SKIP            ((uint32_t)0x00100000UL)   /*!< Only partial address space was erased                         */
#define SDMMC_ERROR_CARD_ECC_DISABLED        ((uint32_t)0x00200000UL)   /*!< Command has been executed without using internal ECC          */
#define SDMMC_ERROR_ERASE_RESET              ((uint32_t)0x00400000UL)   /*!< Erase sequence was cleared before executing because an out
                                                                            of erase sequence command was received                        */
#define SDMMC_ERROR_AKE_SEQ_ERR              ((uint32_t)0x00800000UL)   /*!< Error in sequence of authentication                           */
#define SDMMC_ERROR_INVALID_VOLTRANGE        ((uint32_t)0x01000000UL)   /*!< Error in case of invalid voltage range                        */
#define SDMMC_ERROR_ADDR_OUT_OF_RANGE        ((uint32_t)0x02000000UL)   /*!< Error when addressed block is out of range                    */
#define SDMMC_ERROR_REQUEST_NOT_APPLICABLE   ((uint32_t)0x04000000UL)   /*!< Error when command request is not applicable                  */
#define SDMMC_ERROR_INVALID_PARAMETER        ((uint32_t)0x08000000UL)   /*!< the used parameter is not valid                               */
#define SDMMC_ERROR_UNSUPPORTED_FEATURE      ((uint32_t)0x10000000UL)   /*!< Error when feature is not insupported                         */
#define SDMMC_ERROR_BUSY                     ((uint32_t)0x20000000UL)   /*!< Error when transfer process is busy                           */
#define SDMMC_ERROR_DMA                      ((uint32_t)0x40000000UL)   /*!< Error while DMA transfer                                      */
#define SDMMC_ERROR_TIMEOUT                  ((uint32_t)0x80000000UL)   /*!< Timeout error                                                 */
...
/**
  ...
  */
#define SDMMC_OCR_ADDR_OUT_OF_RANGE        ((uint32_t)0x80000000UL)
#define SDMMC_OCR_ADDR_MISALIGNED          ((uint32_t)0x40000000UL)
#define SDMMC_OCR_BLOCK_LEN_ERR            ((uint32_t)0x20000000UL)
#define SDMMC_OCR_ERASE_SEQ_ERR            ((uint32_t)0x10000000UL)
#define SDMMC_OCR_BAD_ERASE_PARAM          ((uint32_t)0x08000000UL)
#define SDMMC_OCR_WRITE_PROT_VIOLATION     ((uint32_t)0x04000000UL)
#define SDMMC_OCR_LOCK_UNLOCK_FAILED       ((uint32_t)0x01000000UL)
#define SDMMC_OCR_COM_CRC_FAILED           ((uint32_t)0x00800000UL)
#define SDMMC_OCR_ILLEGAL_CMD              ((uint32_t)0x00400000UL)
#define SDMMC_OCR_CARD_ECC_FAILED          ((uint32_t)0x00200000UL)
#define SDMMC_OCR_CC_ERROR                 ((uint32_t)0x00100000UL)
#define SDMMC_OCR_GENERAL_UNKNOWN_ERROR    ((uint32_t)0x00080000UL)
#define SDMMC_OCR_STREAM_READ_UNDERRUN     ((uint32_t)0x00040000UL)
#define SDMMC_OCR_STREAM_WRITE_OVERRUN     ((uint32_t)0x00020000UL)
#define SDMMC_OCR_CID_CSD_OVERWRITE        ((uint32_t)0x00010000UL)
#define SDMMC_OCR_WP_ERASE_SKIP            ((uint32_t)0x00008000UL)
#define SDMMC_OCR_CARD_ECC_DISABLED        ((uint32_t)0x00004000UL)
#define SDMMC_OCR_ERASE_RESET              ((uint32_t)0x00002000UL)
#define SDMMC_OCR_AKE_SEQ_ERROR            ((uint32_t)0x00000008UL)
#define SDMMC_OCR_ERRORBITS                ((uint32_t)0xFDFFE008UL)

/**
  * @brief  Masks for R6 Response
  */
#define SDMMC_R6_GENERAL_UNKNOWN_ERROR     ((uint32_t)0x00002000UL)
#define SDMMC_R6_ILLEGAL_CMD               ((uint32_t)0x00004000UL)
#define SDMMC_R6_COM_CRC_FAILED            ((uint32_t)0x00008000UL)

#define SDMMC_VOLTAGE_WINDOW_SD            ((uint32_t)0x80100000UL)
#define SDMMC_HIGH_CAPACITY                ((uint32_t)0x40000000UL)
#define SDMMC_STD_CAPACITY                 ((uint32_t)0x00000000UL)
#define SDMMC_CHECK_PATTERN                ((uint32_t)0x000001AAUL)
#define SD_SWITCH_1_8V_CAPACITY            ((uint32_t)0x01000000UL)
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define SDMMC_DDR50_SWITCH_PATTERN         ((uint32_t)0x80FFFF04UL)
#define SDMMC_SDR104_SWITCH_PATTERN        ((uint32_t)0x80FF1F03UL)
#define SDMMC_SDR50_SWITCH_PATTERN         ((uint32_t)0x80FF1F02UL)
#define SDMMC_SDR25_SWITCH_PATTERN         ((uint32_t)0x80FFFF01UL)
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */

#define SDMMC_MAX_VOLT_TRIAL               ((uint32_t)0x0000FFFFUL)

#define SDMMC_MAX_TRIAL                    ((uint32_t)0x0000FFFFUL)

#define SDMMC_ALLZERO                      ((uint32_t)0x00000000UL)

#define SDMMC_WIDE_BUS_SUPPORT             ((uint32_t)0x00040000UL)
#define SDMMC_SINGLE_BUS_SUPPORT           ((uint32_t)0x00010000UL)
#define SDMMC_CARD_LOCKED                  ((uint32_t)0x02000000UL)

#define SDMMC_DATATIMEOUT                  ((uint32_t)0xFFFFFFFFUL)

#define SDMMC_0TO7BITS                     ((uint32_t)0x000000FFUL)
#define SDMMC_8TO15BITS                    ((uint32_t)0x0000FF00UL)
#define SDMMC_16TO23BITS                   ((uint32_t)0x00FF0000UL)
#define SDMMC_24TO31BITS                   ((uint32_t)0xFF000000UL)
#define SDMMC_MAX_DATA_LENGTH              ((uint32_t)0x01FFFFFFUL)

#define SDMMC_HALFFIFO                     ((uint32_t)0x00000008UL)
#define SDMMC_HALFFIFOBYTES                ((uint32_t)0x00000020UL)

/**
  * @brief  Command Class supported
  */
#define SDMMC_CCCC_ERASE                   ((uint32_t)0x00000020UL)
...
#define SDMMC_STOPTRANSFERTIMEOUT          ((uint32_t)100000000UL)   /* Timeout for STOP TRANSMISSION command */

/** @defgroup SDMMC_LL_Clock_Edge Clock Edge
  * @{
  */
#define SDMMC_CLOCK_EDGE_RISING               ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Clock_Bypass Clock Bypass
  * @{
  */
#define SDMMC_CLOCK_BYPASS_DISABLE             ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Clock_Power_Save Clock Power Saving
  * @{
  */
#define SDMMC_CLOCK_POWER_SAVE_DISABLE         ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Bus_Wide Bus Width
  * @{
  */
#define SDMMC_BUS_WIDE_1B                      ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Speed_Mode
  * @{
  */
#define SDMMC_SPEED_MODE_AUTO                  ((uint32_t)0x00000000UL)
#define SDMMC_SPEED_MODE_DEFAULT               ((uint32_t)0x00000001UL)
#define SDMMC_SPEED_MODE_HIGH                  ((uint32_t)0x00000002UL)
#define SDMMC_SPEED_MODE_ULTRA                 ((uint32_t)0x00000003UL)
#define SDMMC_SPEED_MODE_DDR                   ((uint32_t)0x00000004UL)
...
/** @defgroup SDMMC_LL_Hardware_Flow_Control Hardware Flow Control
  * @{
  */
#define SDMMC_HARDWARE_FLOW_CONTROL_DISABLE    ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Transceiver Transceiver
  * @{
  */
#define SDMMC_TRANSCEIVER_DISABLE    ((uint32_t)0x00000000UL)
#define SDMMC_TRANSCEIVER_ENABLE     ((uint32_t)0x00000001UL)
...
/** @defgroup SDMMC_LL_Response_Type Response Type
  * @{
  */
#define SDMMC_RESPONSE_NO                    ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Wait_Interrupt_State Wait Interrupt
  * @{
  */
#define SDMMC_WAIT_NO                        ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_CPSM_State CPSM State
  * @{
  */
#define SDMMC_CPSM_DISABLE                   ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Response_Registers Response Register
  * @{
  */
#define SDMMC_RESP1                          ((uint32_t)0x00000000UL)
#define SDMMC_RESP2                          ((uint32_t)0x00000004UL)
#define SDMMC_RESP3                          ((uint32_t)0x00000008UL)
#define SDMMC_RESP4                          ((uint32_t)0x0000000CUL)
...
/** @defgroup SDMMC_Internal_DMA_Mode  SDMMC Internal DMA Mode
  * @{
  */
#define SDMMC_DISABLE_IDMA              ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Data_Length Data Length
  * @{
  */
#define IS_SDMMC_DATA_LENGTH(LENGTH) ((LENGTH) <= 0x01FFFFFFUL)
/**
  * @}
  */
...
/** @defgroup SDMMC_LL_Data_Block_Size  Data Block Size
  * @{
  */
#define SDMMC_DATABLOCK_SIZE_1B               ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Transfer_Direction Transfer Direction
  * @{
  */
#define SDMMC_TRANSFER_DIR_TO_CARD            ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Transfer_Type Transfer Type
  * @{
  */
#define SDMMC_TRANSFER_MODE_BLOCK             ((uint32_t)0x00000000UL)
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
/** @defgroup SDMMC_LL_DPSM_State DPSM State
  * @{
  */
#define SDMMC_DPSM_DISABLE                    ((uint32_t)0x00000000UL)
...
/** @defgroup SDMMC_LL_Read_Wait_Mode Read Wait Mode
  * @{
  */
#define SDMMC_READ_WAIT_MODE_DATA2                ((uint32_t)0x00000000UL)
...
#define SDMMC_INIT_CLK_DIV     ((uint8_t)0x76U)    /* 48MHz / (SDMMC_INIT_CLK_DIV + 2) < 400KHz */

/* SDMMC Data Transfer Frequency (25MHz max) */
#define SDMMC_TRANSFER_CLK_DIV ((uint8_t)0x0U)     /* 48MHz / (SDMMC_TRANSFER_CLK_DIV + 2) < 25MHz */
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
...
/** @addtogroup HAL_SDMMC_LL_Group1
  * @{
  */
HAL_StatusTypeDef SDMMC_Init(SDMMC_TypeDef * const SDMMCx, SDMMC_InitTypeDef Init);
/**
  * @}
  */
...
HAL_StatusTypeDef SDMMC_WriteFIFO(SDMMC_TypeDef * const SDMMCx, uint32_t const * const pWriteData);
/**
  * @}
  */
...
/** @addtogroup HAL_SDMMC_LL_Group3
  * @{
  */
HAL_StatusTypeDef SDMMC_PowerState_ON(SDMMC_TypeDef * const SDMMCx);
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
HAL_StatusTypeDef SDMMC_PowerState_Cycle(SDMMC_TypeDef * const SDMMCx);
#endif /* !STM32L4P5xx && !STM32L4Q5xx && !STM32L4R5xx && !STM32L4R7xx && !STM32L4R9xx && !STM32L4S5xx && !STM32L4S7xx && !STM32L4S9xx */
HAL_StatusTypeDef SDMMC_PowerState_OFF(SDMMC_TypeDef * const SDMMCx);
uint32_t          SDMMC_GetPowerState(SDMMC_TypeDef const * const SDMMCx);

/* Command path state machine (CPSM) management functions */
HAL_StatusTypeDef SDMMC_SendCommand(SDMMC_TypeDef * const SDMMCx, SDMMC_CmdInitTypeDef const * const Command);
uint8_t           SDMMC_GetCommandResponse(SDMMC_TypeDef const * const SDMMCx);
uint32_t          SDMMC_GetResponse(SDMMC_TypeDef const * const SDMMCx, uint32_t Response);

/* Data path state machine (DPSM) management functions */
HAL_StatusTypeDef SDMMC_ConfigData(SDMMC_TypeDef * const SDMMCx, SDMMC_DataInitTypeDef * const Data);
uint32_t          SDMMC_GetDataCounter(SDMMC_TypeDef const * const SDMMCx);
uint32_t          SDMMC_GetFIFOCount(SDMMC_TypeDef const * const SDMMCx);

/* SDMMC Cards mode management functions */
HAL_StatusTypeDef SDMMC_SetSDMMCReadWaitMode(SDMMC_TypeDef * const SDMMCx, uint32_t SDMMC_ReadWaitMode);

/* SDMMC Commands management functions */
uint32_t SDMMC_CmdBlockLength(SDMMC_TypeDef * const SDMMCx, uint32_t BlockSize);
uint32_t SDMMC_CmdReadSingleBlock(SDMMC_TypeDef * const SDMMCx, uint32_t ReadAdd);
uint32_t SDMMC_CmdReadMultiBlock(SDMMC_TypeDef * const SDMMCx, uint32_t ReadAdd);
uint32_t SDMMC_CmdWriteSingleBlock(SDMMC_TypeDef * const SDMMCx, uint32_t WriteAdd);
uint32_t SDMMC_CmdWriteMultiBlock(SDMMC_TypeDef * const SDMMCx, uint32_t WriteAdd);
uint32_t SDMMC_CmdEraseStartAdd(SDMMC_TypeDef * const SDMMCx, uint32_t StartAdd);
uint32_t SDMMC_CmdSDEraseStartAdd(SDMMC_TypeDef * const SDMMCx, uint32_t StartAdd);
uint32_t SDMMC_CmdEraseEndAdd(SDMMC_TypeDef * const SDMMCx, uint32_t EndAdd);
uint32_t SDMMC_CmdSDEraseEndAdd(SDMMC_TypeDef * const SDMMCx, uint32_t EndAdd);
uint32_t SDMMC_CmdErase(SDMMC_TypeDef * const SDMMCx, uint32_t EraseType);
uint32_t SDMMC_CmdStopTransfer(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_CmdSelDesel(SDMMC_TypeDef * const SDMMCx, uint64_t Addr);
uint32_t SDMMC_CmdGoIdleState(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_CmdOperCond(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_CmdAppCommand(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdAppOperCommand(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdBusWidth(SDMMC_TypeDef * const SDMMCx, uint32_t BusWidth);
uint32_t SDMMC_CmdSendSCR(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_CmdSendCID(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_CmdSendCSD(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdSetRelAdd(SDMMC_TypeDef * const SDMMCx, uint16_t * const pRCA);
uint32_t SDMMC_CmdSetRelAddMmc(SDMMC_TypeDef * const SDMMCx, uint16_t RCA);
uint32_t SDMMC_CmdSleepMmc(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdSendStatus(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdStatusRegister(SDMMC_TypeDef * const SDMMCx);
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
uint32_t SDMMC_CmdVoltageSwitch(SDMMC_TypeDef * const SDMMCx);
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
uint32_t SDMMC_CmdOpCondition(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdSwitch(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);
uint32_t SDMMC_CmdSendEXTCSD(SDMMC_TypeDef * const SDMMCx, uint32_t Argument);

/* SDMMC Responses management functions */
uint32_t SDMMC_GetCmdResp1(SDMMC_TypeDef * const SDMMCx, uint8_t SD_CMD, uint32_t Timeout);
uint32_t SDMMC_GetCmdResp2(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_GetCmdResp3(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_GetCmdResp7(SDMMC_TypeDef * const SDMMCx);
uint32_t SDMMC_GetCmdResp6(SDMMC_TypeDef * const SDMMCx, uint8_t SD_CMD, uint16_t * const pRCA);
