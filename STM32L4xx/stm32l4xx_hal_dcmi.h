...
/**
  ...
  */
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
  void    (* FrameEventCallback) ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Frame Event Callback */
  void    (* VsyncEventCallback) ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Vsync Event Callback */
  void    (* LineEventCallback ) ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Line Event Callback  */
  void    (* ErrorCallback)      ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Error Callback       */
  void    (* MspInitCallback)    ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Msp Init callback    */
  void    (* MspDeInitCallback)  ( struct __DCMI_HandleTypeDef * const hdcmi);  /*!< DCMI Msp DeInit callback  */
#endif  /* USE_HAL_DCMI_REGISTER_CALLBACKS */
...
typedef void (*pDCMI_CallbackTypeDef)(DCMI_HandleTypeDef * const hdcmi);
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
...
/** @defgroup DCMI_Error_Code DCMI Error Code
  * @{
  */
#define HAL_DCMI_ERROR_NONE             ((uint32_t)0x00000000UL)  /*!< No error              */
#define HAL_DCMI_ERROR_OVR              ((uint32_t)0x00000001UL)  /*!< Overrun error         */
#define HAL_DCMI_ERROR_SYNC             ((uint32_t)0x00000002UL)  /*!< Synchronization error */
#define HAL_DCMI_ERROR_TIMEOUT          ((uint32_t)0x00000020UL)  /*!< Timeout error         */
#define HAL_DCMI_ERROR_DMA              ((uint32_t)0x00000040UL)  /*!< DMA error             */
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
#define HAL_DCMI_ERROR_INVALID_CALLBACK ((uint32_t)0x00000080UL)  /*!< Invalid callback error */
#endif
/**
  * @}
  */
...
/** @defgroup DCMI_Capture_Mode DCMI Capture Mode
  * @{
  */
#define DCMI_MODE_CONTINUOUS           ((uint32_t)0x00000000UL) /*!< The received data are transferred continuously
...
/** @defgroup DCMI_Synchronization_Mode DCMI Synchronization Mode
  * @{
  */
#define DCMI_SYNCHRO_HARDWARE        ((uint32_t)0x00000000UL)  /*!< Hardware synchronization data capture (frame/line start/stop)
...
/** @defgroup DCMI_PIXCK_Polarity DCMI Pixel Clock Polarity
  * @{
  */
#define DCMI_PCKPOLARITY_FALLING    ((uint32_t)0x00000000UL)     /*!< Pixel clock active on Falling edge */
...
/** @defgroup DCMI_VSYNC_Polarity DCMI VSYNC Polarity
  * @{
  */
#define DCMI_VSPOLARITY_LOW     ((uint32_t)0x00000000UL)    /*!< Vertical synchronization active Low  */
...
/** @defgroup DCMI_HSYNC_Polarity DCMI HSYNC Polarity
  * @{
  */
#define DCMI_HSPOLARITY_LOW     ((uint32_t)0x00000000UL)    /*!< Horizontal synchronization active Low  */
...
/** @defgroup DCMI_JPEG_Mode DCMI JPEG Mode
  * @{
  */
#define DCMI_JPEG_DISABLE   ((uint32_t)0x00000000UL)   /*!< JPEG mode disabled  */
...
/** @defgroup DCMI_Capture_Rate DCMI Capture Rate
  * @{
  */
#define DCMI_CR_ALL_FRAME            ((uint32_t)0x00000000UL)     /*!< All frames are captured        */
...
/** @defgroup DCMI_Extended_Data_Mode DCMI Extended Data Mode
  * @{
  */
#define DCMI_EXTEND_DATA_8B     ((uint32_t)0x00000000UL)                      /*!< Interface captures 8-bit data on every pixel clock  */
...
/** @defgroup DCMI_Byte_Select_Mode DCMI Byte Select Mode
  * @{
  */
#define DCMI_BSM_ALL                 ((uint32_t)0x00000000UL) /*!< Interface captures all received data */
...
/** @defgroup DCMI_Byte_Select_Start DCMI Byte Select Start
  * @{
  */
#define DCMI_OEBS_ODD               ((uint32_t)0x00000000UL)  /*!< Interface captures first data from the frame/line start, second one being dropped */
...
/** @defgroup DCMI_Line_Select_Mode DCMI Line Select Mode
  * @{
  */
#define DCMI_LSM_ALL                 ((uint32_t)0x00000000UL) /*!< Interface captures all received lines */
...
/** @defgroup DCMI_Line_Select_Start DCMI Line Select Start
  * @{
  */
#define DCMI_OELS_ODD               ((uint32_t)0x00000000UL) /*!< Interface captures first line from the frame start, second one being dropped */
...
HAL_StatusTypeDef HAL_DCMI_Init(DCMI_HandleTypeDef * const hdcmi);
HAL_StatusTypeDef HAL_DCMI_DeInit(DCMI_HandleTypeDef * const hdcmi);
void       HAL_DCMI_MspInit(DCMI_HandleTypeDef * const hdcmi);
void       HAL_DCMI_MspDeInit(DCMI_HandleTypeDef * const hdcmi);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_DCMI_RegisterCallback(DCMI_HandleTypeDef * const hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID, pDCMI_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_DCMI_UnRegisterCallback(DCMI_HandleTypeDef * const hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_DCMI_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_DCMI_Start_DMA(DCMI_HandleTypeDef * const hdcmi, uint32_t DCMI_Mode, uint32_t pData, uint32_t Length);
HAL_StatusTypeDef HAL_DCMI_Stop(DCMI_HandleTypeDef * const hdcmi);
HAL_StatusTypeDef HAL_DCMI_Suspend(DCMI_HandleTypeDef * const hdcmi);
HAL_StatusTypeDef HAL_DCMI_Resume(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_ErrorCallback(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_LineEventCallback(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_FrameEventCallback(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_VsyncEventCallback(DCMI_HandleTypeDef * const hdcmi);
void              HAL_DCMI_IRQHandler(DCMI_HandleTypeDef * const hdcmi);
/**
  * @}
  */
...
HAL_StatusTypeDef     HAL_DCMI_ConfigCrop(DCMI_HandleTypeDef * const hdcmi, uint32_t X0, uint32_t Y0, uint32_t XSize, uint32_t YSize);
HAL_StatusTypeDef     HAL_DCMI_EnableCrop(DCMI_HandleTypeDef * const hdcmi);
HAL_StatusTypeDef     HAL_DCMI_DisableCrop(DCMI_HandleTypeDef * const hdcmi);
HAL_StatusTypeDef     HAL_DCMI_ConfigSyncUnmask(DCMI_HandleTypeDef * const hdcmi, DCMI_SyncUnmaskTypeDef const * const SyncUnmask);
/**
  * @}
  */
...
HAL_DCMI_StateTypeDef HAL_DCMI_GetState(DCMI_HandleTypeDef const * const hdcmi);
uint32_t              HAL_DCMI_GetError(DCMI_HandleTypeDef const * const hdcmi);
/**
  * @}
  */
