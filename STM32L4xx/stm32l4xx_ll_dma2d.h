...
typedef struct
{
  ...
  uint32_t OutputBlue;           /*!< Specifies the Blue value of the output image.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0xFFU if ARGB8888 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0xFFU if RGB888 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x1FU if RGB565 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x1FU if ARGB1555 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x0FU if ARGB4444 color mode is selected.
  ...
  uint32_t OutputGreen;          /*!< Specifies the Green value of the output image.
                                      ...
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0xFFU if RGB888 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x3FU if RGB565 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x1FU if ARGB1555 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x0FU if ARGB4444 color mode is selected.
  ...
  uint32_t OutputAlpha;          /*!< Specifies the Alpha channel of the output image.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0xFFU if ARGB8888 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x01U if ARGB1555 color mode is selected.
                                      - This parameter must be a number between:
                                        Min_Data = 0x00U and Max_Data = 0x0FU if ARGB4444 color mode is selected.
  ...
  uint32_t OutputMemoryAddress;  /*!< Specifies the memory address.
                                      - This parameter must be a number between:
                                        Min_Data = 0x0000U and Max_Data = 0xFFFFFFFFUL.
  ...
  uint32_t LineOffset;           /*!< Specifies the output line offset value.
                                      - This parameter must be a number between:
                                      Min_Data = 0x0000U and Max_Data = 0x3FFFU on devices
                                      where the Line Offset Mode feature is available.
                                      else between Min_Data = 0x0000U and Max_Data = 0xFFFFU on other devices.
  ...
  uint32_t NbrOfLines;           /*!< Specifies the number of lines of the area to be transferred.
                                      - This parameter must be a number between:
                                        Min_Data = 0x0000U and Max_Data = 0xFFFFU.
  ...
  uint32_t NbrOfPixelsPerLines;  /*!< Specifies the number of pixels per lines of the area to be transferred.
                                      - This parameter must be a number between Min_Data = 0x0000U and Max_Data = 0x3FFFU.
...
/** @defgroup DMA2D_LL_EC_MODE Mode
  * @{
  */
#define LL_DMA2D_MODE_M2M                       0x00000000UL                       /*!< DMA2D memory to memory transfer mode */
...
/** @defgroup DMA2D_LL_EC_OUTPUT_COLOR_MODE Output Color Mode
  * @{
  */
#define LL_DMA2D_OUTPUT_MODE_ARGB8888     0x00000000UL                           /*!< ARGB8888 */
...
/** @defgroup DMA2D_LL_EC_INPUT_COLOR_MODE Input Color Mode
  * @{
  */
#define LL_DMA2D_INPUT_MODE_ARGB8888      0x00000000UL                                                /*!< ARGB8888 */
...
/** @defgroup DMA2D_LL_EC_ALPHA_MODE Alpha Mode
  * @{
  */
#define LL_DMA2D_ALPHA_MODE_NO_MODIF       0x00000000UL             /*!< No modification of the alpha channel value */
...
/** @defgroup DMA2D_LL_EC_OUTPUT_SWAP_MODE Swap Mode
  * @{
  */
#define LL_DMA2D_SWAP_MODE_REGULAR        0x00000000UL                      /*!< Regular order */
...
/** @defgroup DMA2D_LL_EC_RED_BLUE_SWAP Red Blue Swap
  * @{
  */
#define LL_DMA2D_RB_MODE_REGULAR          0x00000000UL                      /*!< RGB or ARGB */
...
/** @defgroup DMA2D_LL_EC_ALPHA_INVERSION Alpha Inversion
  * @{
  */
#define LL_DMA2D_ALPHA_REGULAR          0x00000000UL                     /*!< Regular alpha  */
...
/** @defgroup DMA2D_LL_EC_LINE_OFFSET_MODE Line Offset Mode
  * @{
  */
#define LL_DMA2D_LINE_OFFSET_PIXELS     0x00000000UL                     /*!< Line offsets are expressed in pixels  */
...
/** @defgroup DMA2D_LL_EC_CLUT_COLOR_MODE CLUT Color Mode
  * @{
  */
#define LL_DMA2D_CLUT_COLOR_MODE_ARGB8888          0x00000000UL                     /*!< ARGB8888 */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_Start(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsTransferOngoing(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_Suspend(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_Resume(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsSuspended(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_Abort(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsAborted(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetMode(DMA2D_TypeDef * const DMA2Dx, uint32_t Mode)
{
...
/**
  ...
  *         (*) value not defined in all devices.
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputColorMode(DMA2D_TypeDef * const DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB4444
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputColorMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputRBSwapMode(DMA2D_TypeDef * const DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputRBSwapMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputAlphaInvMode(DMA2D_TypeDef * const DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputAlphaInvMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputSwapMode(DMA2D_TypeDef * const DMA2Dx, uint32_t OutputSwapMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_SWAP_MODE_TWO_BY_TWO
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputSwapMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetLineOffsetMode(DMA2D_TypeDef * const DMA2Dx, uint32_t LineOffsetMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_LINE_OFFSET_BYTES
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetLineOffsetMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0xFFFFU
  @else
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0x3FFFU
  @endif
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetLineOffset(DMA2D_TypeDef * const DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  @if DMA2D_LINE_OFFSET_MODE_SUPPORT
  * @retval Line offset value between Min_Data=0 and Max_Data=0xFFFFU
  @else
  * @retval Line offset value between Min_Data=0 and Max_Data=0x3FFFU
  @endif
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetLineOffset(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  NbrOfPixelsPerLines Value between Min_Data=0 and Max_Data=0x3FFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetNbrOfPixelsPerLines(DMA2D_TypeDef * const DMA2Dx, uint32_t NbrOfPixelsPerLines)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Number of pixels per lines value between Min_Data=0 and Max_Data=0x3FFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetNbrOfPixelsPerLines(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  NbrOfLines Value between Min_Data=0 and Max_Data=0xFFFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetNbrOfLines(DMA2D_TypeDef * const DMA2Dx, uint32_t NbrOfLines)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Number of lines value between Min_Data=0 and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetNbrOfLines(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputMemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputMemAddr(DMA2D_TypeDef * const DMA2Dx, uint32_t OutputMemoryAddress)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Output memory address value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputMemAddr(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputColor Value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetOutputColor(DMA2D_TypeDef * const DMA2Dx, uint32_t OutputColor)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Output color value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetOutputColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  LineWatermark Value between Min_Data=0 and Max_Data=0xFFFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetLineWatermark(DMA2D_TypeDef * const DMA2Dx, uint32_t LineWatermark)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Line watermark value between Min_Data=0 and Max_Data=0xFFFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetLineWatermark(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  DeadTime Value between Min_Data=0 and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_SetDeadTime(DMA2D_TypeDef * const DMA2Dx, uint32_t DeadTime)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Dead time value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_GetDeadTime(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableDeadTime(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableDeadTime(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledDeadTime(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  MemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetMemAddr(DMA2D_TypeDef * const DMA2Dx, uint32_t MemoryAddress)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground memory address value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetMemAddr(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_EnableCLUTLoad(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_IsEnabledCLUTLoad(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetColorMode(DMA2D_TypeDef * const DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_INPUT_MODE_A4
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetColorMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetAlphaMode(DMA2D_TypeDef * const DMA2Dx, uint32_t AphaMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_ALPHA_MODE_COMBINE
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetAlphaMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  Alpha Value between Min_Data=0 and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetAlpha(DMA2D_TypeDef * const DMA2Dx, uint32_t Alpha)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Alpha value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetAlpha(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetRBSwapMode(DMA2D_TypeDef * const DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetRBSwapMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetAlphaInvMode(DMA2D_TypeDef * const DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetAlphaInvMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0x3FFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetLineOffset(DMA2D_TypeDef * const DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground line offset value between Min_Data=0 and Max_Data=0x3FFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetLineOffset(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  Red   Value between Min_Data=0 and Max_Data=0xFFU
  * @param  Green Value between Min_Data=0 and Max_Data=0xFFU
  * @param  Blue  Value between Min_Data=0 and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Red, uint32_t Green, uint32_t Blue)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetRedColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Red)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Red color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetRedColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetGreenColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Green)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Green color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetGreenColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetBlueColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Blue)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Blue color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetBlueColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTMemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetCLUTMemAddr(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTMemoryAddress)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground CLUT memory address value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetCLUTMemAddr(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTSize Value between Min_Data=0 and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetCLUTSize(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTSize)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground CLUT size value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetCLUTSize(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_FGND_SetCLUTColorMode(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTColorMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB888
  */
__STATIC_INLINE uint32_t LL_DMA2D_FGND_GetCLUTColorMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetMemAddr(DMA2D_TypeDef * const DMA2Dx, uint32_t MemoryAddress)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Background memory address value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_DMA2D_BGND_GetMemAddr(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_EnableCLUTLoad(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_BGND_IsEnabledCLUTLoad(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetColorMode(DMA2D_TypeDef * const DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_INPUT_MODE_A4
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetColorMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetAlphaMode(DMA2D_TypeDef * const DMA2Dx, uint32_t AphaMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_ALPHA_MODE_COMBINE
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetAlphaMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetAlpha(DMA2D_TypeDef * const DMA2Dx, uint32_t Alpha)
{
...
/**
  ...
  * @retval Alpha value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetAlpha(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetRBSwapMode(DMA2D_TypeDef * const DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetRBSwapMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetAlphaInvMode(DMA2D_TypeDef * const DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetAlphaInvMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetLineOffset(DMA2D_TypeDef * const DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Background line offset value between Min_Data=0 and Max_Data=0x3FFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetLineOffset(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Red, uint32_t Green, uint32_t Blue)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetRedColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Red)
{
...
/**
  ...
  * @retval Red color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetRedColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetGreenColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Green)
{
...
/**
  ...
  * @retval Green color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetGreenColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetBlueColor(DMA2D_TypeDef * const DMA2Dx, uint32_t Blue)
{
...
/**
  ...
  * @retval Blue color value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetBlueColor(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetCLUTMemAddr(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTMemoryAddress)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Background CLUT memory address value between Min_Data=0 and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetCLUTMemAddr(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetCLUTSize(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTSize)
{
...
/**
  ...
  * @param  DMA2Dx DMA2D Instance
  * @retval Background CLUT size value between Min_Data=0 and Max_Data=0xFFU
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetCLUTSize(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_BGND_SetCLUTColorMode(DMA2D_TypeDef * const DMA2Dx, uint32_t CLUTColorMode)
{
...
/**
  ...
  *         @arg @ref LL_DMA2D_CLUT_COLOR_MODE_RGB888
  */
__STATIC_INLINE uint32_t  LL_DMA2D_BGND_GetCLUTColorMode(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_CE(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_CTC(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_CAE(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TW(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TC(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsActiveFlag_TE(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_CE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_CTC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_CAE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_TW(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_TC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_ClearFlag_TE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_CE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_CTC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_CAE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_TW(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_TC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_EnableIT_TE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_CE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_CTC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_CAE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_TW(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_TC(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DMA2D_DisableIT_TE(DMA2D_TypeDef * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_CE(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_CTC(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_CAE(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_TW(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_TC(DMA2D_TypeDef const * const DMA2Dx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DMA2D_IsEnabledIT_TE(DMA2D_TypeDef const * const DMA2Dx)
{
...
ErrorStatus LL_DMA2D_DeInit(DMA2D_TypeDef const * const DMA2Dx);
ErrorStatus LL_DMA2D_Init(DMA2D_TypeDef * const DMA2Dx, LL_DMA2D_InitTypeDef const * const DMA2D_InitStruct);
void LL_DMA2D_StructInit(LL_DMA2D_InitTypeDef * const DMA2D_InitStruct);
void LL_DMA2D_ConfigLayer(DMA2D_TypeDef * const DMA2Dx, LL_DMA2D_LayerCfgTypeDef * const DMA2D_LayerCfg, uint32_t LayerIdx);
void LL_DMA2D_LayerCfgStructInit(LL_DMA2D_LayerCfgTypeDef * const DMA2D_LayerCfg);
void LL_DMA2D_ConfigOutputColor(DMA2D_TypeDef * const DMA2Dx, LL_DMA2D_ColorTypeDef * const DMA2D_ColorStruct);
uint32_t LL_DMA2D_GetOutputBlueColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputGreenColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputRedColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode);
uint32_t LL_DMA2D_GetOutputAlphaColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode);
void LL_DMA2D_ConfigSize(DMA2D_TypeDef * const DMA2Dx, uint32_t NbrOfLines, uint32_t NbrOfPixelsPerLines);
