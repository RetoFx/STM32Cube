...
#define HSE_VALUE    8000000UL   /*!< Value of the HSE oscillator in Hz */
#endif /* HSE_VALUE */
...
#define HSI48_VALUE  48000000UL  /*!< Value of the HSI48 oscillator in Hz */
#endif /* HSI48_VALUE */
...
/** @defgroup RCC_LL_EC_LSEDRIVE  LSE oscillator drive capability
  * @{
  */
#define LL_RCC_LSEDRIVE_LOW                0x00000000UL             /*!< Xtal mode lower driving capability */
...
/** @defgroup RCC_LL_EC_LSCO_CLKSOURCE  LSCO Selection
  * @{
  */
#define LL_RCC_LSCO_CLKSOURCE_LSI          0x00000000UL                 /*!< LSI selection for low speed clock  */
...
/** @defgroup RCC_LL_EC_STOP_WAKEUPCLOCK  Wakeup from Stop and CSS backup clock selection
  * @{
  */
#define LL_RCC_STOP_WAKEUPCLOCK_MSI        0x00000000UL             /*!< MSI selection after wake-up from STOP */
...
/** @defgroup RCC_LL_EC_MCO1SOURCE  MCO1 SOURCE selection
  * @{
  */
#define LL_RCC_MCO1SOURCE_NOCLOCK          0x00000000UL                            /*!< MCO output disabled, no clock on MCO */
...
/** @defgroup RCC_LL_EC_LPUART1_CLKSOURCE  Peripheral LPUART clock source selection
  * @{
  */
#define LL_RCC_LPUART1_CLKSOURCE_PCLK1     0x00000000UL                     /*!< PCLK1 clock used as LPUART1 clock source */
...
/** @defgroup RCC_LL_EC_SDMMC1_KERNELCLKSOURCE  Peripheral SDMMC kernel clock source selection
  * @{
  */
#define LL_RCC_SDMMC1_KERNELCLKSOURCE_48CLK  0x00000000UL          /*!< 48MHz clock from internal multiplexor used as SDMMC1 clock source */
...
/** @defgroup RCC_LL_EC_SDMMC1_CLKSOURCE  Peripheral SDMMC clock source selection
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define LL_RCC_SDMMC1_CLKSOURCE_HSI48      0x00000000UL          /*!< HSI48 clock used as SDMMC1 clock source */
#else
#define LL_RCC_SDMMC1_CLKSOURCE_NONE       0x00000000UL          /*!< No clock used as SDMMC1 clock source */
#endif
#if defined(RCC_PLLSAI1_SUPPORT)
...
/** @defgroup RCC_LL_EC_RNG_CLKSOURCE  Peripheral RNG clock source selection
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define LL_RCC_RNG_CLKSOURCE_HSI48         0x00000000UL          /*!< HSI48 clock used as RNG clock source */
#else
#define LL_RCC_RNG_CLKSOURCE_NONE          0x00000000UL          /*!< No clock used as RNG clock source */
#endif
#if defined(RCC_PLLSAI1_SUPPORT)
...
/** @defgroup RCC_LL_EC_USB_CLKSOURCE  Peripheral USB clock source selection
  ...
  */
#if defined(RCC_HSI48_SUPPORT)
#define LL_RCC_USB_CLKSOURCE_HSI48         0x00000000UL          /*!< HSI48 clock used as USB clock source */
#else
#define LL_RCC_USB_CLKSOURCE_NONE          0x00000000UL          /*!< No clock used as USB clock source */
#endif
#if defined(RCC_PLLSAI1_SUPPORT)
...
/** @defgroup RCC_LL_EC_ADC_CLKSOURCE  Peripheral ADC clock source selection
  * @{
  */
#define LL_RCC_ADC_CLKSOURCE_NONE          0x00000000UL          /*!< No clock used as ADC clock source */
#if defined(RCC_PLLSAI1_SUPPORT)
...
#else
#define LL_RCC_ADC_CLKSOURCE_SYSCLK        0x30000000UL          /*!< SYSCLK clock used as ADC clock source */
#endif
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_SWPMI1_CLKSOURCE  Peripheral SWPMI1 clock source selection
  * @{
  */
#define LL_RCC_SWPMI1_CLKSOURCE_PCLK1      0x00000000UL          /*!< PCLK1 used as SWPMI1 clock source */
...
/** @defgroup RCC_LL_EC_DFSDM1_AUDIO_CLKSOURCE  Peripheral DFSDM1 Audio clock source selection
  * @{
  */
#define LL_RCC_DFSDM1_AUDIO_CLKSOURCE_SAI1 0x00000000UL             /*!< SAI1 clock used as DFSDM1 Audio clock */
...
#define LL_RCC_DFSDM1_CLKSOURCE_PCLK2      0x00000000UL          /*!< PCLK2 used as DFSDM1 clock source */
...
/** @defgroup RCC_LL_EC_LTDC_CLKSOURCE  Peripheral LTDC clock source selection
  * @{
  */
#define LL_RCC_LTDC_CLKSOURCE_PLLSAI2R_DIV2  0x00000000UL              /*!< PLLSAI2DIVR divided by 2 used as LTDC clock source */
...
/** @defgroup RCC_LL_EC_OCTOSPI  Peripheral OCTOSPI get clock source
  * @{
  */
#define LL_RCC_OCTOSPI_CLKSOURCE_SYSCLK    0x00000000UL           /*!< SYSCLK used as OctoSPI clock source */
...
#else
#define LL_RCC_ADC_CLKSOURCE               0x30000000UL /*!< ADC Clock source selection */
#endif
/**
  * @}
  */
...
/** @defgroup RCC_LL_EC_PLLSOURCE  PLL, PLLSAI1 and PLLSAI2 entry clock source
  * @{
  */
#define LL_RCC_PLLSOURCE_NONE              0x00000000UL             /*!< No clock */
...
/** @defgroup RCC_LL_EC_PLLM_DIV  PLL division factor
  * @{
  */
#define LL_RCC_PLLM_DIV_1                  0x00000000UL                                                    /*!< Main PLL division factor for PLLM input by 1 */
...
/** @defgroup RCC_LL_EC_PLLR_DIV  PLL division factor (PLLR)
  * @{
  */
#define LL_RCC_PLLR_DIV_2                  0x00000000UL            /*!< Main PLL division factor for PLLCLK (system clock) by 2 */
...
#else
#define LL_RCC_PLLP_DIV_7                  0x00000000UL            /*!< Main PLL division factor for PLLP output by 7 */
...
/** @defgroup RCC_LL_EC_PLLQ_DIV  PLL division factor (PLLQ)
  * @{
  */
#define LL_RCC_PLLQ_DIV_2                  0x00000000UL             /*!< Main PLL division factor for PLLQ output by 2 */
...
/** @defgroup RCC_LL_EC_PLLSAI1M  PLLSAI1 division factor (PLLSAI1M)
  * @{
  */
#define LL_RCC_PLLSAI1M_DIV_1              0x00000000UL                                             /*!< PLLSAI1 division factor for PLLSAI1M input by 1 */
...
/** @defgroup RCC_LL_EC_PLLSAI1Q  PLLSAI1 division factor (PLLSAI1Q)
  * @{
  */
#define LL_RCC_PLLSAI1Q_DIV_2              0x00000000UL                  /*!< PLLSAI1 division factor for PLLSAI1Q output by 2 */
...
#else
#define LL_RCC_PLLSAI1P_DIV_7              0x00000000UL                /*!< PLLSAI1 division factor for PLLSAI1P output by 7 */
...
/** @defgroup RCC_LL_EC_PLLSAI1R  PLLSAI1 division factor (PLLSAI1R)
  * @{
  */
#define LL_RCC_PLLSAI1R_DIV_2              0x00000000UL                  /*!< PLLSAI1 division factor for PLLSAI1R output by 2 */
...
/** @defgroup RCC_LL_EC_PLLSAI2M  PLLSAI1 division factor (PLLSAI2M)
  * @{
  */
#define LL_RCC_PLLSAI2M_DIV_1              0x00000000UL                                             /*!< PLLSAI2 division factor for PLLSAI2M input by 1 */
...
/** @defgroup RCC_LL_EC_PLLSAI2Q  PLLSAI2 division factor (PLLSAI2Q)
  * @{
  */
#define LL_RCC_PLLSAI2Q_DIV_2              0x00000000UL                  /*!< PLLSAI2 division factor for PLLSAI2Q output by 2 */
...
#else
#define LL_RCC_PLLSAI2P_DIV_7              0x00000000UL                /*!< PLLSAI2 division factor for PLLSAI2P output by 7 */
...
/** @defgroup RCC_LL_EC_PLLSAI2R  PLLSAI2 division factor (PLLSAI2R)
  * @{
  */
#define LL_RCC_PLLSAI2R_DIV_2              0x00000000UL                  /*!< PLLSAI2 division factor for PLLSAI2R output by 2 */
...
/** @defgroup RCC_LL_EC_PLLSAI2DIVR  PLLSAI2DIVR division factor (PLLSAI2DIVR)
  * @{
  */
#define LL_RCC_PLLSAI2DIVR_DIV_2           0x00000000UL                     /*!< PLLSAI2 division factor for PLLSAI2DIVR output by 2 */
...
/** @defgroup RCC_LL_EC_LSIPREDIV  LSI division factor
  * @{
  */
#define LL_RCC_LSI_PREDIV_1                0x00000000UL         /*!< LSI division factor by 1   */
...
/**
  ...
  * @retval Between Min_Data = 0x00U and Max_Data = 0x1FFU
  */
...
{
  MODIFY_REG(RCC->CCIPR, (USARTxSource >> 16U), (USARTxSource & 0x0000FFFFUL));
}
...
{
  MODIFY_REG(RCC->CCIPR, (UARTxSource >> 16U), (UARTxSource & 0x0000FFFFUL));
}
#endif /* UART4 || UART5 */
...
__STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource)
{
  ...
  MODIFY_REG(*reg, 3UL << ((I2CxSource & 0x001F0000UL) >> 16U), ((I2CxSource & 0x000000FFUL) << ((I2CxSource & 0x001F0000UL) >> 16U)));
}
...
{
  MODIFY_REG(RCC->CCIPR, (LPTIMxSource & 0xFFFF0000UL), (LPTIMxSource << 16U));
}
...
{
#if defined(RCC_CCIPR2_SAI1SEL)
  MODIFY_REG(RCC->CCIPR2, (SAIxSource >> 16U), (SAIxSource & 0x0000FFFFUL));
#else
  MODIFY_REG(RCC->CCIPR, (SAIxSource & 0xFFFF0000UL), (SAIxSource << 16U));
#endif /* RCC_CCIPR2_SAI1SEL */
}
#endif /* RCC_CCIPR_SAI1SEL || RCC_CCIPR2_SAI1SEL */
...
{
  __IO uint32_t const *reg = (__IO uint32_t *)(uint32_t)(RCC_BASE + 0x88U + (I2Cx >> 24U));
  return (uint32_t)((READ_BIT(*reg, 3UL << ((I2Cx & 0x001F0000UL) >> 16U)) >> ((I2Cx & 0x001F0000UL) >> 16U)) | (I2Cx & 0xFFFF0000UL));
}
