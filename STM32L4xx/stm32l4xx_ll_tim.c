...
/** @defgroup TIM_LL_Private_Functions TIM Private Functions
  * @{
  */
static ErrorStatus OC1Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus OC2Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus OC3Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus OC4Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus OC5Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus OC6Config(TIM_TypeDef * const TIMx, LL_TIM_OC_InitTypeDef const * const TIM_OCInitStruct);
static ErrorStatus IC1Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct);
static ErrorStatus IC2Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct);
static ErrorStatus IC3Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct);
static ErrorStatus IC4Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct);
/**
  * @}
  */
...
void LL_TIM_StructInit(LL_TIM_InitTypeDef * const TIM_InitStruct)
{
  ...
  TIM_InitStruct->RepetitionCounter = 0x00000000UL;
}
...
void LL_TIM_OC_StructInit(LL_TIM_OC_InitTypeDef * const TIM_OC_InitStruct)
{
  ...
  TIM_OC_InitStruct->CompareValue = 0x00000000UL;
...
/**
  ...
  *         structure to their default values.
  * @param  TIM_IC_InitStruct pointer to a @ref LL_TIM_IC_InitTypeDef structure (the input channel configuration
  *         data structure)
  * @retval None
  */
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_IC_InitStruct pointer to the the TIMx input channel 1 configuration data structure
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: TIMx registers are de-initialized
  *          - ERROR: not applicable
  */
static ErrorStatus IC1Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct)
{
  /* Check the parameters */
  assert_param(IS_TIM_CC1_INSTANCE(TIMx));
  assert_param(IS_LL_TIM_IC_POLARITY(TIM_IC_InitStruct->ICPolarity));
  assert_param(IS_LL_TIM_ACTIVEINPUT(TIM_IC_InitStruct->ICActiveInput));
  assert_param(IS_LL_TIM_ICPSC(TIM_IC_InitStruct->ICPrescaler));
  assert_param(IS_LL_TIM_IC_FILTER(TIM_IC_InitStruct->ICFilter));
  ...
  MODIFY_REG(TIMx->CCMR1,
             ...
             (TIM_IC_InitStruct->ICActiveInput | TIM_IC_InitStruct->ICFilter | TIM_IC_InitStruct->ICPrescaler) >> 16U);

  /* Select the Polarity and set the CC1E Bit */
  MODIFY_REG(TIMx->CCER,
             (TIM_CCER_CC1P | TIM_CCER_CC1NP),
             (TIM_IC_InitStruct->ICPolarity | TIM_CCER_CC1E));
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_IC_InitStruct pointer to the the TIMx input channel 2 configuration data structure
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: TIMx registers are de-initialized
  *          - ERROR: not applicable
  */
static ErrorStatus IC2Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct)
{
  ...
  MODIFY_REG(TIMx->CCMR1,
             ...
             (TIM_IC_InitStruct->ICActiveInput | TIM_IC_InitStruct->ICFilter | TIM_IC_InitStruct->ICPrescaler) >> 8U);

  /* Select the Polarity and set the CC2E Bit */
  MODIFY_REG(TIMx->CCER,
             (TIM_CCER_CC2P | TIM_CCER_CC2NP),
             ((TIM_IC_InitStruct->ICPolarity << 4U) | TIM_CCER_CC2E));
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_IC_InitStruct pointer to the the TIMx input channel 3 configuration data structure
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: TIMx registers are de-initialized
  *          - ERROR: not applicable
  */
static ErrorStatus IC3Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct)
{
  ...
  MODIFY_REG(TIMx->CCER,
             ...
             ((TIM_IC_InitStruct->ICPolarity << 8U) | TIM_CCER_CC3E));
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_IC_InitStruct pointer to the the TIMx input channel 4 configuration data structure
  * @retval An ErrorStatus enumeration value:
  *          - SUCCESS: TIMx registers are de-initialized
  *          - ERROR: not applicable
  */
static ErrorStatus IC4Config(TIM_TypeDef * const TIMx, LL_TIM_IC_InitTypeDef const * const TIM_IC_InitStruct)
{
  ...
  MODIFY_REG(TIMx->CCER,
             ...
             ((TIM_IC_InitStruct->ICPolarity << 12U) | TIM_CCER_CC4E));
