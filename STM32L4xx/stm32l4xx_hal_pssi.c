...
void PSSI_DMATransmitCplt(DMA_HandleTypeDef * const hdma);
void PSSI_DMAReceiveCplt(DMA_HandleTypeDef * const hdma);
void PSSI_DMAError(DMA_HandleTypeDef * const hdma);
void PSSI_DMAAbort(DMA_HandleTypeDef * const hdma);
#endif /*HAL_DMA_MODULE_ENABLED*/

/* Private functions to handle IT transfer */
static void PSSI_Error(PSSI_HandleTypeDef * const hpssi, uint32_t ErrorCode);
...
static HAL_StatusTypeDef PSSI_WaitOnStatusUntilTimeout(PSSI_HandleTypeDef * const hpssi, uint32_t Flag, FlagStatus Status,
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_MspInit(PSSI_HandleTypeDef * const hpssi)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_MspDeInit(PSSI_HandleTypeDef * const hpssi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpssi);
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_TxCpltCallback(PSSI_HandleTypeDef * const hpssi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpssi);
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_RxCpltCallback(PSSI_HandleTypeDef * const hpssi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpssi);
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_ErrorCallback(PSSI_HandleTypeDef * const hpssi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpssi);
...
/**
  ...
  * @retval None
  */
__weak void HAL_PSSI_AbortCpltCallback(PSSI_HandleTypeDef * const hpssi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hpssi);
...
void PSSI_DMATransmitCplt(DMA_HandleTypeDef * const hdma)
{
  ...
  PSSI_HandleTypeDef * const hpssi = (PSSI_HandleTypeDef *)(((DMA_HandleTypeDef *)hdma)->Parent);
