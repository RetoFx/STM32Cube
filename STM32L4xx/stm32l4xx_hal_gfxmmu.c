...
/**
  ...
  * @retval None.
  */
__weak void HAL_GFXMMU_MspInit(GFXMMU_HandleTypeDef * const hgfxmmu)
{
...
/**
  ...
  * @retval None.
  */
__weak void HAL_GFXMMU_MspDeInit(GFXMMU_HandleTypeDef * const hgfxmmu)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hgfxmmu);
...
/**
  ...
  * @retval None.
  */
HAL_GFXMMU_WEAK_CALLBACK(void, HAL_GFXMMU_ErrorCallback)(GFXMMU_HandleTypeDef * const hgfxmmu)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hgfxmmu);
