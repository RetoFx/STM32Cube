...
#else /* #if (USE_HAL_RTC_REGISTER_CALLBACKS == 1U) */
    if (hrtc->State == HAL_RTC_STATE_RESET)
    {
      /* Allocate lock resource and initialize it */
      hrtc->Lock = HAL_UNLOCKED;
...
#endif /* #if (USE_HAL_RTC_REGISTER_CALLBACKS == 1U) */
...
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef * const hrtc)
{
  ...
  if (hrtc != NULL)
  {
    ...
    if (status == HAL_OK)
    {
      ...
      hrtc->Instance->TR = 0x00000000UL;
      hrtc->Instance->DR = ((uint32_t)(RTC_DR_WDU_0 | RTC_DR_MU_0 | RTC_DR_DU_0));
      hrtc->Instance->CR &= 0x00000000UL;

      hrtc->Instance->WUTR = RTC_WUTR_WUT;
      hrtc->Instance->PRER = ((uint32_t)(RTC_PRER_PREDIV_A | 0x000000FFUL));
      hrtc->Instance->ALRMAR = 0x00000000UL;
      hrtc->Instance->ALRMBR = 0x00000000UL;
      hrtc->Instance->SHIFTR = 0x00000000UL;
      hrtc->Instance->CALR = 0x00000000UL;
      hrtc->Instance->ALRMASSR = 0x00000000UL;
      hrtc->Instance->ALRMBSSR = 0x00000000UL;
      ...
      if (status == HAL_OK)
      {
        ...
        ((TAMP_TypeDef *)((uint32_t)hrtc->Instance + hrtc->TampOffset))->CR1 = 0xFFFF0000UL;
        ((TAMP_TypeDef *)((uint32_t)hrtc->Instance + hrtc->TampOffset))->CR2 = 0x00000000UL;
#else
        /* Reset Tamper configuration register */
        hrtc->Instance->TAMPCR = 0x00000000UL;

        /* Reset Option register */
        hrtc->Instance->OR = 0x00000000UL;
#endif
...
/**
  ...
  * @retval None
  */
__weak void HAL_RTC_MspInit(RTC_HandleTypeDef * const hrtc)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_RTC_MspDeInit(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
...
/**
  ...
  *          if Binary mode is RTC_BINARY_ONLY, this parameter is not used and RTC_SSR will be automatically reset to 0xFFFFFFFFUL
...
/**
  ...
  * @retval None
  */
HAL_RTC_WEAK_CALLBACK(void, HAL_RTC_AlarmAEventCallback)(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
