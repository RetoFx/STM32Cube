...
/**
  ...
  * @retval Output Blue color value between Min_Data=0 and Max_Data=0xFFU
  */
...
/**
  ...
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB1555
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB4444
  * @retval Output Green color value between Min_Data=0 and Max_Data=0xFFU
  */
...
/**
  ...
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB1555
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB4444
  * @retval Output Red color value between Min_Data=0 and Max_Data=0xFFU
  */
uint32_t LL_DMA2D_GetOutputRedColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode)
{
  ...
  if (ColorMode == LL_DMA2D_OUTPUT_MODE_ARGB8888)
  {
    color = (uint32_t)(READ_BIT(DMA2Dx->OCOLR, 0xFF0000UL) >> 16U);
  }
  else if (ColorMode == LL_DMA2D_OUTPUT_MODE_RGB888)
  {
    color = (uint32_t)(READ_BIT(DMA2Dx->OCOLR, 0xFF0000UL) >> 16U);
...
/**
  ...
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB1555
  *         @arg @ref LL_DMA2D_OUTPUT_MODE_ARGB4444
  * @retval Output Alpha color value between Min_Data=0 and Max_Data=0xFFU
  */
uint32_t LL_DMA2D_GetOutputAlphaColor(DMA2D_TypeDef const * const DMA2Dx, uint32_t ColorMode)
{
  ...
  if (ColorMode == LL_DMA2D_OUTPUT_MODE_ARGB8888)
  {
    color = (uint32_t)(READ_BIT(DMA2Dx->OCOLR, 0xFF000000UL) >> 24U);
  }
