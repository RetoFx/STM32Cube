...
#define LL_SYSCFG_REMAP_FMC                SYSCFG_MEMRMP_MEM_MODE_1                              /*!< FMC bank 1 (NOR/PSRAM 1 and 2) mapped at 0x00000000UL */
#endif /* FMC_Bank1_R */
#define LL_SYSCFG_REMAP_QUADSPI            (SYSCFG_MEMRMP_MEM_MODE_2 | SYSCFG_MEMRMP_MEM_MODE_1) /*!< QUADSPI memory mapped at 0x00000000UL                 */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_BANKMODE SYSCFG BANK MODE
  * @{
  */
#define LL_SYSCFG_BANKMODE_BANK1           0x00000000UL               /*!< Flash Bank1 mapped at 0x08000000UL (and aliased @0x00000000UL)
                                                                      and Flash Bank2 mapped at 0x08080000UL (and aliased at 0x00080000UL) */
#define LL_SYSCFG_BANKMODE_BANK2           SYSCFG_MEMRMP_FB_MODE     /*!< Flash Bank2 mapped at 0x08000000UL (and aliased @0x00000000UL)
                                                                      and Flash Bank1 mapped at 0x08080000UL (and aliased at 0x00080000UL) */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_EXTI_LINE SYSCFG EXTI LINE
  * @{
  */
#define LL_SYSCFG_EXTI_LINE0               (uint32_t)((0x000FUL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U)  /* !< EXTI_POSITION_0  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE1               (uint32_t)((0x00F0UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U)  /* !< EXTI_POSITION_4  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE2               (uint32_t)((0x0F00UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U)  /* !< EXTI_POSITION_8  | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE3               (uint32_t)((0xF000UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 0U)  /* !< EXTI_POSITION_12 | EXTICR[0U] */
#define LL_SYSCFG_EXTI_LINE4               (uint32_t)((0x000FUL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U)  /* !< EXTI_POSITION_0  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE5               (uint32_t)((0x00F0UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U)  /* !< EXTI_POSITION_4  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE6               (uint32_t)((0x0F00UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U)  /* !< EXTI_POSITION_8  | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE7               (uint32_t)((0xF000UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 1U)  /* !< EXTI_POSITION_12 | EXTICR[1U] */
#define LL_SYSCFG_EXTI_LINE8               (uint32_t)((0x000FUL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U)  /* !< EXTI_POSITION_0  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE9               (uint32_t)((0x00F0UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U)  /* !< EXTI_POSITION_4  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE10              (uint32_t)((0x0F00UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U)  /* !< EXTI_POSITION_8  | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE11              (uint32_t)((0xF000UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 2U)  /* !< EXTI_POSITION_12 | EXTICR[2U] */
#define LL_SYSCFG_EXTI_LINE12              (uint32_t)((0x000FUL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U)  /* !< EXTI_POSITION_0  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE13              (uint32_t)((0x00F0UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U)  /* !< EXTI_POSITION_4  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE14              (uint32_t)((0x0F00UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U)  /* !< EXTI_POSITION_8  | EXTICR[3U] */
#define LL_SYSCFG_EXTI_LINE15              (uint32_t)((0xF000UL << LL_EXTI_REGISTER_PINPOS_SHFT) | 3U)  /* !< EXTI_POSITION_12 | EXTICR[3U] */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_VOLTAGE VREFBUF VOLTAGE
  * @{
  */
#define LL_VREFBUF_VOLTAGE_SCALE0          ((uint32_t)0x00000000UL) /*!< Voltage reference scale 0 (VREF_OUT1) */
...
/**
  ...
  * @retval Values between Min_Data=0x00U and Max_Data=0xFFFFU (ex: device ID is 0x6415U)
  */
