...
/* Private define ------------------------------------------------------------*/
#define OSPI_FUNCTIONAL_MODE_INDIRECT_WRITE ((uint32_t)0x00000000UL)         /*!< Indirect write mode    */
...
#define OSPI_CFG_STATE_MASK  0x00000004UL
#define OSPI_BUSY_STATE_MASK 0x00000008UL
...
static void              OSPI_DMACplt(DMA_HandleTypeDef * const hdma);
static void              OSPI_DMAHalfCplt(DMA_HandleTypeDef * const hdma);
static void              OSPI_DMAError(DMA_HandleTypeDef * const hdma);
static void              OSPI_DMAAbortCplt(DMA_HandleTypeDef * const hdma);
static HAL_StatusTypeDef OSPI_WaitFlagStateUntilTimeout(OSPI_HandleTypeDef * const hospi, uint32_t Flag, FlagStatus State,
                                                        uint32_t Tickstart, uint32_t Timeout);
static HAL_StatusTypeDef OSPI_ConfigCmd(OSPI_HandleTypeDef * const hospi, OSPI_RegularCmdTypeDef const * const cmd);
static HAL_StatusTypeDef OSPIM_GetConfig(uint8_t instance_nb, OSPIM_CfgTypeDef const * const cfg);
/**
  @endcond
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_OSPI_MspInit(OSPI_HandleTypeDef * const hospi)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_ErrorCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_AbortCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_FifoThresholdCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_CmdCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_RxCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_TxCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_RxHalfCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_TxHalfCpltCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_StatusMatchCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
/**
  ...
  * @retval None
  */
HAL_OSPI_WEAK_CALLBACK(void, HAL_OSPI_TimeOutCallback)(OSPI_HandleTypeDef * const hospi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hospi);
...
static void OSPI_DMACplt(DMA_HandleTypeDef * const hdma)
{
  OSPI_HandleTypeDef * const hospi = (OSPI_HandleTypeDef *)(hdma->Parent);
  hospi->XferCount = 0U;
...
{
  OSPI_HandleTypeDef * const hospi = (OSPI_HandleTypeDef *)(hdma->Parent);
  hospi->XferCount = (hospi->XferCount >> 1U);
...
/**
  ...
  * @retval HAL status
  */
static HAL_StatusTypeDef OSPI_WaitFlagStateUntilTimeout(OSPI_HandleTypeDef * const hospi, uint32_t Flag,
