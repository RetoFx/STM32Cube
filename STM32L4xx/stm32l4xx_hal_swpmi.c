...
static void SWPMI_DMATransmitCplt(DMA_HandleTypeDef * const hdma);
static void SWPMI_DMATxHalfCplt(DMA_HandleTypeDef * const hdma);
static void SWPMI_DMAReceiveCplt(DMA_HandleTypeDef * const hdma);
static void SWPMI_DMARxHalfCplt(DMA_HandleTypeDef * const hdma);
static void SWPMI_DMAError(DMA_HandleTypeDef * const hdma);
static void SWPMI_DMAAbortOnError(DMA_HandleTypeDef * const hdma);
static void SWPMI_Transmit_IT(SWPMI_HandleTypeDef * const hswpmi);
static void SWPMI_EndTransmit_IT(SWPMI_HandleTypeDef * const hswpmi);
static void SWPMI_Receive_IT(SWPMI_HandleTypeDef * const hswpmi);
static void SWPMI_EndReceive_IT(SWPMI_HandleTypeDef * const hswpmi);
static void SWPMI_EndTransmitReceive_IT(SWPMI_HandleTypeDef * const hswpmi);
static HAL_StatusTypeDef SWPMI_WaitOnFlagSetUntilTimeout(SWPMI_HandleTypeDef * const hswpmi, uint32_t Flag, uint32_t Tickstart, uint32_t Timeout);
...
HAL_StatusTypeDef HAL_SWPMI_Init(SWPMI_HandleTypeDef * const hswpmi)
{
  ...
  else
  {
    ...
    WRITE_REG(hswpmi->Instance->ICR, 0x019FU);
    ...
    if (hswpmi->Init.VoltageClass == SWPMI_VOLTAGE_CLASS_B)
    {
      ...
      wait_loop_index = (300U * (SystemCoreClock / (1000000UL * 4U))) + 150U;
...
/**
  ...
  * @retval None
  */
__weak void HAL_SWPMI_MspInit(SWPMI_HandleTypeDef * const hswpmi)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_SWPMI_MspDeInit(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
/**
  ...
  * @retval None
  */
HAL_SWPMI_WEAK_CALLBACK(void, HAL_SWPMI_TxCpltCallback)(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
/**
  ...
  * @retval None
  */
HAL_SWPMI_WEAK_CALLBACK(void, HAL_SWPMI_TxHalfCpltCallback)(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
/**
  ...
  * @retval None
  */
HAL_SWPMI_WEAK_CALLBACK(void, HAL_SWPMI_RxCpltCallback)(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
/**
  ...
  * @retval None
  */
HAL_SWPMI_WEAK_CALLBACK(void, HAL_SWPMI_RxHalfCpltCallback)(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
/**
  ...
  * @retval None
  */
HAL_SWPMI_WEAK_CALLBACK(void, HAL_SWPMI_ErrorCallback)(SWPMI_HandleTypeDef * const hswpmi)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hswpmi);
...
static void SWPMI_DMATransmitCplt(DMA_HandleTypeDef * const hdma)
{
  SWPMI_HandleTypeDef * const hswpmi = (SWPMI_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
  uint32_t tickstart;
