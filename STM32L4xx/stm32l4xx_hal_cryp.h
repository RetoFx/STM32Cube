...
/**
  ...
  */
#define HAL_CRYP_ERROR_NONE      ((uint32_t)0x00000000UL)  /*!< No error        */
#define HAL_CRYP_WRITE_ERROR     ((uint32_t)0x00000001UL)  /*!< Write error     */
#define HAL_CRYP_READ_ERROR      ((uint32_t)0x00000002UL)  /*!< Read error      */
#define HAL_CRYP_DMA_ERROR       ((uint32_t)0x00000004UL)  /*!< DMA error       */
#define HAL_CRYP_BUSY_ERROR      ((uint32_t)0x00000008UL)  /*!< Busy flag error */
#if (USE_HAL_CRYP_REGISTER_CALLBACKS == 1U)
#define  HAL_CRYP_ERROR_INVALID_CALLBACK ((uint32_t)0x00000010UL)   /*!< Invalid Callback error  */
...
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
{
      ...
      uint8_t const            *pCrypInBuffPtr;  /*!< Pointer to CRYP processing (encryption, decryption,...) input buffer */
...
#if (USE_HAL_CRYP_REGISTER_CALLBACKS == 1U)
  void    (* InCpltCallback)( struct __CRYP_HandleTypeDef * const hcryp);    /*!< CRYP input DMA transfer completion callback */

  void    (* OutCpltCallback)( struct __CRYP_HandleTypeDef * const hcryp);   /*!< CRYP output DMA transfer completion callback */

  void    (* CompCpltCallback)( struct __CRYP_HandleTypeDef * const hcryp);  /*!< CRYP computation completion callback */
...
/**
  ...
  */
typedef  void (*pCRYP_CallbackTypeDef)(CRYP_HandleTypeDef * const hcryp); /*!< pointer to a CRYP common callback functions */
#endif /* USE_HAL_CRYP_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup CRYP_Key_Size  Key size selection
  * @{
  */
#define CRYP_KEYSIZE_128B         ((uint32_t)0x00000000UL)  /*!< 128-bit long key */
...
/** @defgroup CRYP_Data_Type  AES Data Type selection
  * @{
  */
#define CRYP_DATATYPE_32B         ((uint32_t)0x00000000UL)  /*!< 32-bit data type (no swapping)        */
...
/**
  ...
  * @{
  */
#define CRYP_AES_DISABLE                 ((uint32_t)0x00000000UL)   /*!< Disable AES */
...
/** @defgroup CRYP_AES_OperatingMode AES operating mode
  * @{
  */
#define CRYP_ALGOMODE_ENCRYPT                   ((uint32_t)0x00000000UL)  /*!< Encryption mode                                              */
...
#define CRYP_ALGOMODE_TAG_GENERATION            ((uint32_t)0x00000000UL)  /*!< GMAC or CMAC (when applicable) authentication tag generation */
/**
  * @}
  */
...
/** @defgroup CRYP_AES_ChainingMode AES chaining mode
  * @{
  */
#define CRYP_CHAINMODE_AES_ECB            ((uint32_t)0x00000000UL)            /*!< Electronic codebook chaining algorithm                   */
...
/** @defgroup CRYP_Key_Write AES decryption key write-up flag
  * @{
  */
#define CRYP_KEY_WRITE_ENABLE            ((uint32_t)0x00000000UL)  /*!< Enable decryption key writing  */
#define CRYP_KEY_WRITE_DISABLE           ((uint32_t)0x00000001UL)  /*!< Disable decryption key writing */
/**
  * @}
  */
...
/** @defgroup CRYP_DMAIN DMA Input phase management enable state
  * @{
  */
#define CRYP_DMAIN_DISABLE             ((uint32_t)0x00000000UL)    /*!< Disable DMA Input phase management */
...
/** @defgroup CRYP_DMAOUT DMA Output phase management enable state
  * @{
  */
#define CRYP_DMAOUT_DISABLE             ((uint32_t)0x00000000UL)   /*!< Disable DMA Output phase management */
...
/** @defgroup CRYP_GCM_CMAC_Phase GCM/GMAC and CCM/CMAC (when applicable) processing phase selection
  * @{
  */
#define CRYP_GCM_INIT_PHASE             ((uint32_t)0x00000000UL)  /*!< GCM/GMAC (or CCM) init phase   */
...
#define CRYP_INIT_PHASE                 ((uint32_t)0x00000000UL)  /*!< Init phase    */
