...
typedef struct
{
  ...
  uint32_t             OutputOffset;       /*!< Specifies the Offset value.
                                                ...
                                                Min_Data = 0x0000U and Max_Data = 0x3FFFU. */
...
typedef struct
{
  ...
  uint32_t             InputAlpha;        /*!< Specifies the DMA2D foreground or background alpha value and color value
                                               ...
                                               This parameter must be a number between Min_Data = 0x00U
                                               and Max_Data = 0xFFU except for the color modes detailed below.
                                               @note In case of A8 or A4 color mode (ARGB),
                                               this parameter must be a number between
                                               Min_Data = 0x00000000UL and Max_Data = 0xFFFFFFFFUL where
...
typedef struct __DMA2D_HandleTypeDef
{
  ...
  void (* XferCpltCallback)(struct __DMA2D_HandleTypeDef * const hdma2d);        /*!< DMA2D transfer complete callback.      */

  void (* XferErrorCallback)(struct __DMA2D_HandleTypeDef * const hdma2d);       /*!< DMA2D transfer error callback.         */

#if (USE_HAL_DMA2D_REGISTER_CALLBACKS == 1U)
  void (* LineEventCallback)(struct __DMA2D_HandleTypeDef * const hdma2d);       /*!< DMA2D line event callback.             */

  void (* CLUTLoadingCpltCallback)(struct __DMA2D_HandleTypeDef * const hdma2d); /*!< DMA2D CLUT loading completion callback */

  void (* MspInitCallback)(struct __DMA2D_HandleTypeDef * const hdma2d);         /*!< DMA2D Msp Init callback.               */

  void (* MspDeInitCallback)(struct __DMA2D_HandleTypeDef * const hdma2d);       /*!< DMA2D Msp DeInit callback.             */
...
/**
  ...
  */
typedef void (*pDMA2D_CallbackTypeDef)(DMA2D_HandleTypeDef * const hdma2d); /*!< Pointer to a DMA2D common callback function */
#endif /* USE_HAL_DMA2D_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup DMA2D_Error_Code DMA2D Error Code
  * @{
  */
#define HAL_DMA2D_ERROR_NONE        0x00000000UL  /*!< No error             */
#define HAL_DMA2D_ERROR_TE          0x00000001UL  /*!< Transfer error       */
#define HAL_DMA2D_ERROR_CE          0x00000002UL  /*!< Configuration error  */
#define HAL_DMA2D_ERROR_CAE         0x00000004UL  /*!< CLUT access error    */
#define HAL_DMA2D_ERROR_TIMEOUT     0x00000020UL  /*!< Timeout error        */
#if (USE_HAL_DMA2D_REGISTER_CALLBACKS == 1U)
#define HAL_DMA2D_ERROR_INVALID_CALLBACK 0x00000040UL  /*!< Invalid callback error  */
...
/** @defgroup DMA2D_Mode DMA2D Mode
  * @{
  */
#define DMA2D_M2M                   0x00000000UL                         /*!< DMA2D memory to memory transfer mode */
...
/** @defgroup DMA2D_Output_Color_Mode DMA2D Output Color Mode
  * @{
  */
#define DMA2D_OUTPUT_ARGB8888       0x00000000UL                           /*!< ARGB8888 DMA2D color mode */
...
/** @defgroup DMA2D_Input_Color_Mode DMA2D Input Color Mode
  * @{
  */
#define DMA2D_INPUT_ARGB8888        0x00000000UL  /*!< ARGB8888 color mode */
#define DMA2D_INPUT_RGB888          0x00000001UL  /*!< RGB888 color mode   */
#define DMA2D_INPUT_RGB565          0x00000002UL  /*!< RGB565 color mode   */
#define DMA2D_INPUT_ARGB1555        0x00000003UL  /*!< ARGB1555 color mode */
#define DMA2D_INPUT_ARGB4444        0x00000004UL  /*!< ARGB4444 color mode */
#define DMA2D_INPUT_L8              0x00000005UL  /*!< L8 color mode       */
#define DMA2D_INPUT_AL44            0x00000006UL  /*!< AL44 color mode     */
#define DMA2D_INPUT_AL88            0x00000007UL  /*!< AL88 color mode     */
#define DMA2D_INPUT_L4              0x00000008UL  /*!< L4 color mode       */
#define DMA2D_INPUT_A8              0x00000009UL  /*!< A8 color mode       */
#define DMA2D_INPUT_A4              0x0000000AUL  /*!< A4 color mode       */
/**
  * @}
  */
...
/** @defgroup DMA2D_Alpha_Mode DMA2D Alpha Mode
  * @{
  */
#define DMA2D_NO_MODIF_ALPHA        0x00000000UL  /*!< No modification of the alpha channel value                     */
#define DMA2D_REPLACE_ALPHA         0x00000001UL  /*!< Replace original alpha channel value by programmed alpha value */
#define DMA2D_COMBINE_ALPHA         0x00000002UL  /*!< Replace original alpha channel value by programmed alpha value
...
/** @defgroup DMA2D_Alpha_Inverted DMA2D Alpha Inversion
  * @{
  */
#define DMA2D_REGULAR_ALPHA         0x00000000UL  /*!< No modification of the alpha channel value */
#define DMA2D_INVERTED_ALPHA        0x00000001UL  /*!< Invert the alpha channel value */
/**
  * @}
  */
...
/** @defgroup DMA2D_RB_Swap DMA2D Red and Blue Swap
  * @{
  */
#define DMA2D_RB_REGULAR            0x00000000UL  /*!< Select regular mode (RGB or ARGB) */
#define DMA2D_RB_SWAP               0x00000001UL  /*!< Select swap mode (BGR or ABGR) */
/**
  * @}
  */
...
/** @defgroup DMA2D_Line_Offset_Mode DMA2D Line Offset Mode
  * @{
  */
#define DMA2D_LOM_PIXELS            0x00000000UL    /*!< Line offsets expressed in pixels */
...
/** @defgroup DMA2D_Bytes_Swap DMA2D Bytes Swap
  * @{
  */
#define DMA2D_BYTES_REGULAR         0x00000000UL      /*!< Bytes in regular order in output FIFO */
...
/** @defgroup DMA2D_CLUT_CM DMA2D CLUT Color Mode
  * @{
  */
#define DMA2D_CCM_ARGB8888          0x00000000UL  /*!< ARGB8888 DMA2D CLUT color mode */
#define DMA2D_CCM_RGB888            0x00000001UL  /*!< RGB888 DMA2D CLUT color mode   */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_DMA2D_Init(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_DeInit(DMA2D_HandleTypeDef * const hdma2d);
void              HAL_DMA2D_MspInit(DMA2D_HandleTypeDef * const hdma2d);
void              HAL_DMA2D_MspDeInit(DMA2D_HandleTypeDef * const hdma2d);
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_DMA2D_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_DMA2D_RegisterCallback(DMA2D_HandleTypeDef * const hdma2d, HAL_DMA2D_CallbackIDTypeDef CallbackID,
                                             pDMA2D_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_DMA2D_UnRegisterCallback(DMA2D_HandleTypeDef * const hdma2d, HAL_DMA2D_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_DMA2D_REGISTER_CALLBACKS */
...
HAL_StatusTypeDef HAL_DMA2D_Start(DMA2D_HandleTypeDef * const hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width,
                                  uint32_t Height);
HAL_StatusTypeDef HAL_DMA2D_BlendingStart(DMA2D_HandleTypeDef * const hdma2d, uint32_t SrcAddress1, uint32_t SrcAddress2,
                                          uint32_t DstAddress, uint32_t Width,  uint32_t Height);
HAL_StatusTypeDef HAL_DMA2D_Start_IT(DMA2D_HandleTypeDef * const hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width,
                                     uint32_t Height);
HAL_StatusTypeDef HAL_DMA2D_BlendingStart_IT(DMA2D_HandleTypeDef * const hdma2d, uint32_t SrcAddress1, uint32_t SrcAddress2,
                                             uint32_t DstAddress, uint32_t Width, uint32_t Height);
HAL_StatusTypeDef HAL_DMA2D_Suspend(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_Resume(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_Abort(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_EnableCLUT(DMA2D_HandleTypeDef * const hdma2d, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTStartLoad(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef const * const CLUTCfg,
                                          uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTStartLoad_IT(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef const * const CLUTCfg,
                                             uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTLoad(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTLoad_IT(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTLoading_Abort(DMA2D_HandleTypeDef * const hdma2d, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTLoading_Suspend(DMA2D_HandleTypeDef * const hdma2d, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_CLUTLoading_Resume(DMA2D_HandleTypeDef * const hdma2d, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_PollForTransfer(DMA2D_HandleTypeDef * const hdma2d, uint32_t Timeout);
void              HAL_DMA2D_IRQHandler(DMA2D_HandleTypeDef * const hdma2d);
void              HAL_DMA2D_LineEventCallback(DMA2D_HandleTypeDef * const hdma2d);
void              HAL_DMA2D_CLUTLoadingCpltCallback(DMA2D_HandleTypeDef * const hdma2d);
...
HAL_StatusTypeDef HAL_DMA2D_ConfigLayer(DMA2D_HandleTypeDef * const hdma2d, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_ConfigCLUT(DMA2D_HandleTypeDef * const hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx);
HAL_StatusTypeDef HAL_DMA2D_ProgramLineEvent(DMA2D_HandleTypeDef * const hdma2d, uint32_t Line);
HAL_StatusTypeDef HAL_DMA2D_EnableDeadTime(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_DisableDeadTime(DMA2D_HandleTypeDef * const hdma2d);
HAL_StatusTypeDef HAL_DMA2D_ConfigDeadTime(DMA2D_HandleTypeDef * const hdma2d, uint8_t DeadTime);
...
HAL_DMA2D_StateTypeDef HAL_DMA2D_GetState(DMA2D_HandleTypeDef const * const hdma2d);
uint32_t               HAL_DMA2D_GetError(DMA2D_HandleTypeDef const * const hdma2d);
...
/** @defgroup DMA2D_Color_Value DMA2D Color Value
  * @{
  */
#define DMA2D_COLOR_VALUE                 0x000000FFUL  /*!< Color value mask */
/**
  * @}
  */
...
/** @defgroup DMA2D_Layers DMA2D Layers
  * @{
  */
#define DMA2D_BACKGROUND_LAYER             0x00000000UL   /*!< DMA2D Background Layer (layer 0) */
#define DMA2D_FOREGROUND_LAYER             0x00000001UL   /*!< DMA2D Foreground Layer (layer 1) */
/**
  * @}
  */
