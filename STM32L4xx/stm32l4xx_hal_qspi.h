...
#endif
{
  ...
  uint8_t const              *pTxBuffPtr;      /* Pointer to QSPI Tx transfer Buffer */
...
#if (USE_HAL_QSPI_REGISTER_CALLBACKS == 1U)
  void (* ErrorCallback)        (struct __QSPI_HandleTypeDef * const hqspi);
  void (* AbortCpltCallback)    (struct __QSPI_HandleTypeDef * const hqspi);
  void (* FifoThresholdCallback)(struct __QSPI_HandleTypeDef * const hqspi);
  void (* CmdCpltCallback)      (struct __QSPI_HandleTypeDef * const hqspi);
  void (* RxCpltCallback)       (struct __QSPI_HandleTypeDef * const hqspi);
  void (* TxCpltCallback)       (struct __QSPI_HandleTypeDef * const hqspi);
  void (* RxHalfCpltCallback)   (struct __QSPI_HandleTypeDef * const hqspi);
  void (* TxHalfCpltCallback)   (struct __QSPI_HandleTypeDef * const hqspi);
  void (* StatusMatchCallback)  (struct __QSPI_HandleTypeDef * const hqspi);
  void (* TimeOutCallback)      (struct __QSPI_HandleTypeDef * const hqspi);

  void (* MspInitCallback)      (struct __QSPI_HandleTypeDef * const hqspi);
  void (* MspDeInitCallback)    (struct __QSPI_HandleTypeDef * const hqspi);
#endif
}QSPI_HandleTypeDef;
...
typedef struct
{
  uint32_t Instruction;        /* Specifies the Instruction to be sent
                                  This parameter can be a value (8-bit) between 0x00U and 0xFFU */
  uint32_t Address;            /* Specifies the Address to be sent (Size from 1 to 4 bytes according AddressSize)
                                  This parameter can be a value (32-bits) between 0x0U and 0xFFFFFFFFUL */
  ...
  uint32_t NbData;             /* Specifies the number of data to transfer. (This is the number of bytes)
                                  This parameter can be any value between 0 and 0xFFFFFFFFUL (0 means undefined length
                                  until end of memory)*/
...
typedef enum
{
  ...
  HAL_QSPI_MSP_DEINIT_CB_ID     = 0x0B0U   /*!< QSPI MspDeInit Callback ID        */
}HAL_QSPI_CallbackIDTypeDef;

/**
  * @brief  HAL QSPI Callback pointer definition
  */
typedef void (*pQSPI_CallbackTypeDef)(QSPI_HandleTypeDef * const hqspi);
#endif
/**
  * @}
  */
...
/** @defgroup QSPI_ErrorCode QSPI Error Code
  * @{
  */
#define HAL_QSPI_ERROR_NONE             0x00000000UL /*!< No error                 */
#define HAL_QSPI_ERROR_TIMEOUT          0x00000001UL /*!< Timeout error            */
#define HAL_QSPI_ERROR_TRANSFER         0x00000002UL /*!< Transfer error           */
#define HAL_QSPI_ERROR_DMA              0x00000004UL /*!< DMA transfer error       */
#define HAL_QSPI_ERROR_INVALID_PARAM    0x00000008UL /*!< Invalid parameters error */
#if (USE_HAL_QSPI_REGISTER_CALLBACKS == 1U)
#define HAL_QSPI_ERROR_INVALID_CALLBACK 0x00000010UL /*!< Invalid callback error   */
#endif
/**
  * @}
  */
...
/** @defgroup QSPI_SampleShifting QSPI Sample Shifting
  * @{
  */
#define QSPI_SAMPLE_SHIFTING_NONE      0x00000000UL                   /*!<No clock cycle shift to sample data*/
...
/** @defgroup QSPI_ChipSelectHighTime QSPI ChipSelect High Time
  * @{
  */
#define QSPI_CS_HIGH_TIME_1_CYCLE      0x00000000UL                                         /*!<nCS stay high for at least 1 clock cycle between commands*/
...
/** @defgroup QSPI_ClockMode QSPI Clock Mode
  * @{
  */
#define QSPI_CLOCK_MODE_0              0x00000000UL                    /*!<Clk stays low while nCS is released*/
...
/** @defgroup QSPI_Flash_Select QSPI Flash Select
  * @{
  */
#define QSPI_FLASH_ID_1                0x00000000UL                 /*!<FLASH 1 selected*/
...
#define QSPI_DUALFLASH_DISABLE         0x00000000UL                /*!<Dual-flash mode disabled*/
/**
  * @}
  */
...
/** @defgroup QSPI_AddressSize QSPI Address Size
  * @{
  */
#define QSPI_ADDRESS_8_BITS            0x00000000UL                      /*!<8-bit address*/
...
/** @defgroup QSPI_AlternateBytesSize QSPI Alternate Bytes Size
  * @{
  */
#define QSPI_ALTERNATE_BYTES_8_BITS    0x00000000UL                      /*!<8-bit alternate bytes*/
...
* @{
*/
#define QSPI_INSTRUCTION_NONE          0x00000000UL                     /*!<No instruction*/
...
* @{
*/
#define QSPI_ADDRESS_NONE              0x00000000UL                      /*!<No address*/
...
* @{
*/
#define QSPI_ALTERNATE_BYTES_NONE      0x00000000UL                      /*!<No alternate bytes*/
...
/** @defgroup QSPI_DataMode QSPI Data Mode
  * @{
  */
#define QSPI_DATA_NONE                 0x00000000UL                     /*!<No data*/
...
/** @defgroup QSPI_DdrMode QSPI DDR Mode
  * @{
  */
#define QSPI_DDR_MODE_DISABLE          0x00000000UL                  /*!<Double data rate mode disabled*/
...
/** @defgroup QSPI_DdrHoldHalfCycle QSPI DDR Data Output Delay
  * @{
  */
#define QSPI_DDR_HHC_ANALOG_DELAY      0x00000000UL                  /*!<Delay the data output using analog delay in DDR mode*/
...
/** @defgroup QSPI_SIOOMode QSPI Send Instruction Mode
  * @{
  */
#define QSPI_SIOO_INST_EVERY_CMD       0x00000000UL                  /*!<Send instruction on every transaction*/
...
/** @defgroup QSPI_MatchMode QSPI Match Mode
  * @{
  */
#define QSPI_MATCH_MODE_AND            0x00000000UL                /*!<AND match mode between unmasked bits*/
...
/** @defgroup QSPI_AutomaticStop QSPI Automatic Stop
  * @{
  */
#define QSPI_AUTOMATIC_STOP_DISABLE    0x00000000UL                 /*!<AutoPolling stops only with abort or QSPI disabling*/
...
/** @defgroup QSPI_TimeOutActivation QSPI Timeout Activation
  * @{
  */
#define QSPI_TIMEOUT_COUNTER_DISABLE   0x00000000UL                 /*!<Timeout counter disabled, nCS remains active*/
...
HAL_StatusTypeDef     HAL_QSPI_Init     (QSPI_HandleTypeDef * const hqspi);
HAL_StatusTypeDef     HAL_QSPI_DeInit   (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_MspInit  (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_MspDeInit(QSPI_HandleTypeDef * const hqspi);
/**
  * @}
  */
...
void                  HAL_QSPI_IRQHandler(QSPI_HandleTypeDef * const hqspi);

/* QSPI indirect mode */
HAL_StatusTypeDef     HAL_QSPI_Command      (QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef const * const cmd, uint32_t Timeout);
HAL_StatusTypeDef     HAL_QSPI_Transmit     (QSPI_HandleTypeDef * const hqspi, uint8_t const * const pData, uint32_t Timeout);
HAL_StatusTypeDef     HAL_QSPI_Receive      (QSPI_HandleTypeDef * const hqspi, uint8_t * const pData, uint32_t Timeout);
HAL_StatusTypeDef     HAL_QSPI_Command_IT   (QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef const * const cmd);
HAL_StatusTypeDef     HAL_QSPI_Transmit_IT  (QSPI_HandleTypeDef * const hqspi, uint8_t const * const pData);
HAL_StatusTypeDef     HAL_QSPI_Receive_IT   (QSPI_HandleTypeDef * const hqspi, uint8_t * const pData);
HAL_StatusTypeDef     HAL_QSPI_Transmit_DMA (QSPI_HandleTypeDef * const hqspi, uint8_t const * const pData);
HAL_StatusTypeDef     HAL_QSPI_Receive_DMA  (QSPI_HandleTypeDef * const hqspi, uint8_t * const pData);

/* QSPI status flag polling mode */
HAL_StatusTypeDef     HAL_QSPI_AutoPolling   (QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef * const cmd, QSPI_AutoPollingTypeDef const * const cfg, uint32_t Timeout);
HAL_StatusTypeDef     HAL_QSPI_AutoPolling_IT(QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef * const cmd, QSPI_AutoPollingTypeDef const * const cfg);

/* QSPI memory-mapped mode */
HAL_StatusTypeDef     HAL_QSPI_MemoryMapped(QSPI_HandleTypeDef * const hqspi, QSPI_CommandTypeDef const * const cmd, QSPI_MemoryMappedTypeDef const * const cfg);

/* Callback functions in non-blocking modes ***********************************/
void                  HAL_QSPI_ErrorCallback        (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_AbortCpltCallback    (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_FifoThresholdCallback(QSPI_HandleTypeDef * const hqspi);

/* QSPI indirect mode */
void                  HAL_QSPI_CmdCpltCallback      (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_RxCpltCallback       (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_TxCpltCallback       (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_RxHalfCpltCallback   (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_TxHalfCpltCallback   (QSPI_HandleTypeDef * const hqspi);

/* QSPI status flag polling mode */
void                  HAL_QSPI_StatusMatchCallback  (QSPI_HandleTypeDef * const hqspi);

/* QSPI memory-mapped mode */
void                  HAL_QSPI_TimeOutCallback      (QSPI_HandleTypeDef * const hqspi);

#if (USE_HAL_QSPI_REGISTER_CALLBACKS == 1U)
/* QSPI callback registering/unregistering */
HAL_StatusTypeDef     HAL_QSPI_RegisterCallback     (QSPI_HandleTypeDef * const hqspi, HAL_QSPI_CallbackIDTypeDef CallbackId, pQSPI_CallbackTypeDef pCallback);
HAL_StatusTypeDef     HAL_QSPI_UnRegisterCallback   (QSPI_HandleTypeDef * const hqspi, HAL_QSPI_CallbackIDTypeDef CallbackId);
#endif
/**
  * @}
  */
...
HAL_QSPI_StateTypeDef HAL_QSPI_GetState        (QSPI_HandleTypeDef const * const hqspi);
uint32_t              HAL_QSPI_GetError        (QSPI_HandleTypeDef const * const hqspi);
HAL_StatusTypeDef     HAL_QSPI_Abort           (QSPI_HandleTypeDef * const hqspi);
HAL_StatusTypeDef     HAL_QSPI_Abort_IT        (QSPI_HandleTypeDef * const hqspi);
void                  HAL_QSPI_SetTimeout      (QSPI_HandleTypeDef * const hqspi, uint32_t Timeout);
HAL_StatusTypeDef     HAL_QSPI_SetFifoThreshold(QSPI_HandleTypeDef * const hqspi, uint32_t Threshold);
uint32_t              HAL_QSPI_GetFifoThreshold(QSPI_HandleTypeDef const * const hqspi);
#if defined(QUADSPI_CR_DFM)
HAL_StatusTypeDef     HAL_QSPI_SetFlashID      (QSPI_HandleTypeDef * const hqspi, uint32_t FlashID);
#endif
/**
  * @}
  */
