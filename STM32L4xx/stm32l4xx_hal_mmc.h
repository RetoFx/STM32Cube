...
typedef enum
{
  HAL_MMC_STATE_RESET                  = ((uint32_t)0x00000000UL),  /*!< MMC not yet initialized or disabled  */
  HAL_MMC_STATE_READY                  = ((uint32_t)0x00000001UL),  /*!< MMC initialized and ready for use    */
  HAL_MMC_STATE_TIMEOUT                = ((uint32_t)0x00000002UL),  /*!< MMC Timeout state                    */
  HAL_MMC_STATE_BUSY                   = ((uint32_t)0x00000003UL),  /*!< MMC process ongoing                  */
  HAL_MMC_STATE_PROGRAMMING            = ((uint32_t)0x00000004UL),  /*!< MMC Programming State                */
  HAL_MMC_STATE_RECEIVING              = ((uint32_t)0x00000005UL),  /*!< MMC Receinving State                 */
  HAL_MMC_STATE_TRANSFER               = ((uint32_t)0x00000006UL),  /*!< MMC Transfer State                   */
  HAL_MMC_STATE_ERROR                  = ((uint32_t)0x0000000FUL)   /*!< MMC is in error state                */
...
#define HAL_MMC_CARD_IDLE           0x00000000UL  /*!< Card is in idle state (can't be checked by CMD13)           */
#define HAL_MMC_CARD_READY          0x00000001UL  /*!< Card is in ready state (can't be checked by CMD13)          */
#define HAL_MMC_CARD_IDENTIFICATION 0x00000002UL  /*!< Card is in identification state (can't be checked by CMD13) */
#define HAL_MMC_CARD_STANDBY        0x00000003UL  /*!< Card is in standby state                                    */
#define HAL_MMC_CARD_TRANSFER       0x00000004UL  /*!< Card is in transfer state                                   */
#define HAL_MMC_CARD_SENDING        0x00000005UL  /*!< Card is sending an operation                                */
#define HAL_MMC_CARD_RECEIVING      0x00000006UL  /*!< Card is receiving operation information                     */
#define HAL_MMC_CARD_PROGRAMMING    0x00000007UL  /*!< Card is in programming state                                */
#define HAL_MMC_CARD_DISCONNECTED   0x00000008UL  /*!< Card is disconnected                                        */
#define HAL_MMC_CARD_BUSTEST        0x00000009UL  /*!< Card is in bus test state                                   */
#define HAL_MMC_CARD_SLEEP          0x0000000AUL  /*!< Card is in sleep state (can't be checked by CMD13)          */
#define HAL_MMC_CARD_ERROR          0x000000FFUL  /*!< Card response Error (can't be checked by CMD13)             */
/**
  * @}
  */
...
#endif /* USE_HAL_MMC_REGISTER_CALLBACKS */
{
  ...
  uint32_t                     Ext_CSD[128U];

#if defined (USE_HAL_MMC_REGISTER_CALLBACKS) && (USE_HAL_MMC_REGISTER_CALLBACKS == 1U)
  void (* TxCpltCallback)                 (struct __MMC_HandleTypeDef * const hmmc);
  void (* RxCpltCallback)                 (struct __MMC_HandleTypeDef * const hmmc);
  void (* ErrorCallback)                  (struct __MMC_HandleTypeDef * const hmmc);
  void (* AbortCpltCallback)              (struct __MMC_HandleTypeDef * const hmmc);
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
  void (* Read_DMADblBuf0CpltCallback)    (struct __MMC_HandleTypeDef * const hmmc);
  void (* Read_DMADblBuf1CpltCallback)    (struct __MMC_HandleTypeDef * const hmmc);
  void (* Write_DMADblBuf0CpltCallback)   (struct __MMC_HandleTypeDef * const hmmc);
  void (* Write_DMADblBuf1CpltCallback)   (struct __MMC_HandleTypeDef * const hmmc);
#endif

  void (* MspInitCallback)                (struct __MMC_HandleTypeDef * const hmmc);
  void (* MspDeInitCallback)              (struct __MMC_HandleTypeDef * const hmmc);
#endif
}MMC_HandleTypeDef;
...
/** @defgroup MMC_Exported_Types_Group7 MMC Callback pointer definition
  * @{
  */
typedef void (*pMMC_CallbackTypeDef)           (MMC_HandleTypeDef * const hmmc);
/**
  * @}
  */
#endif
...
/** @defgroup MMC_Exported_Constansts_Group2 MMC context enumeration
  * @{
  */
#define   MMC_CONTEXT_NONE                 ((uint32_t)0x00000000UL)  /*!< None                             */
#define   MMC_CONTEXT_READ_SINGLE_BLOCK    ((uint32_t)0x00000001UL)  /*!< Read single block operation      */
#define   MMC_CONTEXT_READ_MULTIPLE_BLOCK  ((uint32_t)0x00000002UL)  /*!< Read multiple blocks operation   */
#define   MMC_CONTEXT_WRITE_SINGLE_BLOCK   ((uint32_t)0x00000010UL)  /*!< Write single block operation     */
#define   MMC_CONTEXT_WRITE_MULTIPLE_BLOCK ((uint32_t)0x00000020UL)  /*!< Write multiple blocks operation  */
#define   MMC_CONTEXT_IT                   ((uint32_t)0x00000008UL)  /*!< Process in Interrupt mode        */
#define   MMC_CONTEXT_DMA                  ((uint32_t)0x00000080UL)  /*!< Process in DMA mode              */
...
/**
  * @brief
  */
#define MMC_HIGH_VOLTAGE_RANGE         0x80FF8000UL  /*!< High voltage in byte mode    */
#define MMC_DUAL_VOLTAGE_RANGE         0x80FF8080UL  /*!< Dual voltage in byte mode    */
#define MMC_LOW_VOLTAGE_RANGE          0x80000080UL  /*!< Low voltage in byte mode     */
#define EMMC_HIGH_VOLTAGE_RANGE        0xC0FF8000UL  /*!< High voltage in sector mode  */
#define EMMC_DUAL_VOLTAGE_RANGE        0xC0FF8080UL  /*!< Dual voltage in sector mode  */
#define EMMC_LOW_VOLTAGE_RANGE         0xC0000080UL  /*!< Low voltage in sector mode   */
#define MMC_INVALID_VOLTAGE_RANGE      0x0001FF01UL
/**
  * @}
  */
...
/** @defgroup MMC_Exported_Constansts_Group4 MMC Memory Cards
  * @{
  */
#define  MMC_LOW_CAPACITY_CARD     ((uint32_t)0x00000000UL)   /*!< MMC Card Capacity <=2Gbytes   */
#define  MMC_HIGH_CAPACITY_CARD    ((uint32_t)0x00000001UL)   /*!< MMC Card Capacity >2Gbytes and <2Tbytes   */
...
/** @defgroup MMC_Exported_Constansts_Group5 MMC Erase Type
  * @{
  */
#define HAL_MMC_ERASE             0x00000000UL  /*!< Erase the erase groups identified by CMD35 & 36                                   */
#define HAL_MMC_TRIM              0x00000001UL  /*!< Erase the write blocks identified by CMD35 & 36                                   */
#define HAL_MMC_DISCARD           0x00000003UL  /*!< Discard the write blocks identified by CMD35 & 36                                 */
#define HAL_MMC_SECURE_ERASE      0x80000000UL  /*!< Perform a secure purge according SRT on the erase groups identified by CMD35 & 36 */
#define HAL_MMC_SECURE_TRIM_STEP1 0x80000001UL  /*!< Mark the write blocks identified by CMD35 & 36 for secure erase                   */
#define HAL_MMC_SECURE_TRIM_STEP2 0x80008000UL  /*!< Perform a secure purge according SRT on the write blocks previously identified    */
...
/** @defgroup MMC_Exported_Constansts_Group6 MMC Secure Removal Type
  * @{
  */
#define HAL_MMC_SRT_ERASE                   0x00000001UL  /*!< Information removed by an erase                                                                */
#define HAL_MMC_SRT_WRITE_CHAR_ERASE        0x00000002UL  /*!< Information removed by an overwriting with a character followed by an erase                    */
#define HAL_MMC_SRT_WRITE_CHAR_COMPL_RANDOM 0x00000004UL  /*!< Information removed by an overwriting with a character, its complement then a random character */
#define HAL_MMC_SRT_VENDOR_DEFINED          0x00000008UL  /*!< Information removed using a vendor defined                                                     */
...
void HAL_MMC_MspInit(MMC_HandleTypeDef * const hmmc);
void HAL_MMC_MspDeInit(MMC_HandleTypeDef * const hmmc);
...
void HAL_MMC_TxCpltCallback(MMC_HandleTypeDef * const hmmc);
void HAL_MMC_RxCpltCallback(MMC_HandleTypeDef * const hmmc);
void HAL_MMC_ErrorCallback(MMC_HandleTypeDef * const hmmc);
void HAL_MMC_AbortCallback(MMC_HandleTypeDef * const hmmc);
