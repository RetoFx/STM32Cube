...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_REG_SetDFSDMTransfer(ADC_TypeDef * const ADCx, uint32_t DFSDMTransfer)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_DFSDM_TRANSFER_ENABLE
  */
__STATIC_INLINE uint32_t LL_ADC_REG_GetDFSDMTransfer(ADC_TypeDef const * const ADCx)
{
...
__STATIC_INLINE void LL_ADC_REG_SetTrigSource(ADC_TypeDef * const ADCx, uint32_t TriggerSource)
{
  LL_ADC_REG_SetTriggerSource(ADCx, TriggerSource);
}
__STATIC_INLINE void LL_ADC_INJ_SetTrigSource(ADC_TypeDef * const ADCx, uint32_t TriggerSource)
{
