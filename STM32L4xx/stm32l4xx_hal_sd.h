...
typedef enum
{
  HAL_SD_STATE_RESET                  = ((uint32_t)0x00000000UL),  /*!< SD not yet initialized or disabled  */
  HAL_SD_STATE_READY                  = ((uint32_t)0x00000001UL),  /*!< SD initialized and ready for use    */
  HAL_SD_STATE_TIMEOUT                = ((uint32_t)0x00000002UL),  /*!< SD Timeout state                    */
  HAL_SD_STATE_BUSY                   = ((uint32_t)0x00000003UL),  /*!< SD process ongoing                  */
  HAL_SD_STATE_PROGRAMMING            = ((uint32_t)0x00000004UL),  /*!< SD Programming State                */
  HAL_SD_STATE_RECEIVING              = ((uint32_t)0x00000005UL),  /*!< SD Receiving State                  */
  HAL_SD_STATE_TRANSFER               = ((uint32_t)0x00000006UL),  /*!< SD Transfer State                   */
  HAL_SD_STATE_ERROR                  = ((uint32_t)0x0000000FUL)   /*!< SD is in error state                */
}HAL_SD_StateTypeDef;
/**
  * @}
  */
...
#define HAL_SD_CARD_READY          0x00000001UL  /*!< Card state is ready                     */
#define HAL_SD_CARD_IDENTIFICATION 0x00000002UL  /*!< Card is in identification state         */
#define HAL_SD_CARD_STANDBY        0x00000003UL  /*!< Card is in standby state                */
#define HAL_SD_CARD_TRANSFER       0x00000004UL  /*!< Card is in transfer state               */
#define HAL_SD_CARD_SENDING        0x00000005UL  /*!< Card is sending an operation            */
#define HAL_SD_CARD_RECEIVING      0x00000006UL  /*!< Card is receiving operation information */
#define HAL_SD_CARD_PROGRAMMING    0x00000007UL  /*!< Card is in programming state            */
#define HAL_SD_CARD_DISCONNECTED   0x00000008UL  /*!< Card is disconnected                    */
#define HAL_SD_CARD_ERROR          0x000000FFUL  /*!< Card response Error                     */
/**
  * @}
  */
...
#endif /* USE_HAL_SD_REGISTER_CALLBACKS */
{
  ...
  uint32_t                     CSD[4U];           /*!< SD card specific data table         */

  uint32_t                     CID[4U];           /*!< SD card identification number table */

#if defined (USE_HAL_SD_REGISTER_CALLBACKS) && (USE_HAL_SD_REGISTER_CALLBACKS == 1U)
  void (* TxCpltCallback)                 (struct __SD_HandleTypeDef * const hsd);
  void (* RxCpltCallback)                 (struct __SD_HandleTypeDef * const hsd);
  void (* ErrorCallback)                  (struct __SD_HandleTypeDef * const hsd);
  void (* AbortCpltCallback)              (struct __SD_HandleTypeDef * const hsd);
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
  void (* Read_DMADblBuf0CpltCallback)    (struct __SD_HandleTypeDef * const hsd);
  void (* Read_DMADblBuf1CpltCallback)    (struct __SD_HandleTypeDef * const hsd);
  void (* Write_DMADblBuf0CpltCallback)   (struct __SD_HandleTypeDef * const hsd);
  void (* Write_DMADblBuf1CpltCallback)   (struct __SD_HandleTypeDef * const hsd);

  void (* DriveTransceiver_1_8V_Callback) (FlagStatus status);
#endif

  void (* MspInitCallback)                (struct __SD_HandleTypeDef * const hsd);
  void (* MspDeInitCallback)              (struct __SD_HandleTypeDef * const hsd);
#endif /* USE_HAL_SD_REGISTER_CALLBACKS */
}SD_HandleTypeDef;
...
/** @defgroup SD_Exported_Types_Group8 SD Callback pointer definition
  * @{
  */
typedef void (*pSD_CallbackTypeDef)           (SD_HandleTypeDef * const hsd);
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
/** @defgroup SD_Exported_Constansts_Group2 SD context enumeration
  * @{
  */
#define   SD_CONTEXT_NONE                 ((uint32_t)0x00000000UL)  /*!< None                             */
#define   SD_CONTEXT_READ_SINGLE_BLOCK    ((uint32_t)0x00000001UL)  /*!< Read single block operation      */
#define   SD_CONTEXT_READ_MULTIPLE_BLOCK  ((uint32_t)0x00000002UL)  /*!< Read multiple blocks operation   */
#define   SD_CONTEXT_WRITE_SINGLE_BLOCK   ((uint32_t)0x00000010UL)  /*!< Write single block operation     */
#define   SD_CONTEXT_WRITE_MULTIPLE_BLOCK ((uint32_t)0x00000020UL)  /*!< Write multiple blocks operation  */
#define   SD_CONTEXT_IT                   ((uint32_t)0x00000008UL)  /*!< Process in Interrupt mode        */
#define   SD_CONTEXT_DMA                  ((uint32_t)0x00000080UL)  /*!< Process in DMA mode              */
...
/** @defgroup SD_Exported_Constansts_Group3 SD Supported Memory Cards
  ...
  */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define CARD_NORMAL_SPEED        ((uint32_t)0x00000000UL)    /*!< Normal Speed Card <12.5Mo/s , Spec Version 1.01    */
#define CARD_HIGH_SPEED          ((uint32_t)0x00000100UL)    /*!< High Speed Card <25Mo/s , Spec version 2.00        */
#define CARD_ULTRA_HIGH_SPEED    ((uint32_t)0x00000200UL)    /*!< UHS-I SD Card <50Mo/s for SDR50, DDR5 Cards
                                                                 and <104Mo/s for SDR104, Spec version 3.01          */
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */

#define CARD_SDSC                  ((uint32_t)0x00000000UL)  /*!< SD Standard Capacity <2Go                          */
#define CARD_SDHC_SDXC             ((uint32_t)0x00000001UL)  /*!< SD High Capacity <32Go, SD Extended Capacity <2To  */
#define CARD_SECURED               ((uint32_t)0x00000003UL)
...
/** @defgroup SD_Exported_Constansts_Group4 SD Supported Version
  * @{
  */
#define CARD_V1_X                  ((uint32_t)0x00000000UL)
#define CARD_V2_X                  ((uint32_t)0x00000001UL)
/**
  * @}
  */
...
void              HAL_SD_MspInit  (SD_HandleTypeDef * const hsd);
void              HAL_SD_MspDeInit(SD_HandleTypeDef * const hsd);
/**
  * @}
  */
...
void              HAL_SD_TxCpltCallback(SD_HandleTypeDef * const hsd);
void              HAL_SD_RxCpltCallback(SD_HandleTypeDef * const hsd);
void              HAL_SD_ErrorCallback  (SD_HandleTypeDef * const hsd);
void              HAL_SD_AbortCallback  (SD_HandleTypeDef * const hsd);
