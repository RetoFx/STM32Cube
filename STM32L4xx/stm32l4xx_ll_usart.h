...
/** @defgroup USART_LL_EC_FIFOTHRESHOLD FIFO Threshold
  * @{
  */
#define LL_USART_FIFOTHRESHOLD_1_8              0x00000000UL /*!< FIFO reaches 1/8 of its depth */
#define LL_USART_FIFOTHRESHOLD_1_4              0x00000001UL /*!< FIFO reaches 1/4 of its depth */
#define LL_USART_FIFOTHRESHOLD_1_2              0x00000002UL /*!< FIFO reaches 1/2 of its depth */
#define LL_USART_FIFOTHRESHOLD_3_4              0x00000003UL /*!< FIFO reaches 3/4 of its depth */
#define LL_USART_FIFOTHRESHOLD_7_8              0x00000004UL /*!< FIFO reaches 7/8 of its depth */
#define LL_USART_FIFOTHRESHOLD_8_8              0x00000005UL /*!< FIFO becomes empty for TX and full for RX */
/**
  * @}
  */
...
/** @defgroup USART_LL_EC_DIRECTION Communication Direction
  * @{
  */
#define LL_USART_DIRECTION_NONE                 0x00000000UL                        /*!< Transmitter and Receiver are disabled */
...
/** @defgroup USART_LL_EC_PARITY Parity Control
  * @{
  */
#define LL_USART_PARITY_NONE                    0x00000000UL                          /*!< Parity control disabled */
...
/** @defgroup USART_LL_EC_WAKEUP Wakeup
  * @{
  */
#define LL_USART_WAKEUP_IDLELINE                0x00000000UL           /*!<  USART wake up from Mute mode on Idle Line */
...
#define LL_USART_DATAWIDTH_8B                   0x00000000UL             /*!< 8 bits word length : Start bit, 8 data bits, n stop bits */
...
/** @defgroup USART_LL_EC_OVERSAMPLING Oversampling
  * @{
  */
#define LL_USART_OVERSAMPLING_16                0x00000000UL            /*!< Oversampling by 16 */
...
#define LL_USART_CLOCK_DISABLE                  0x00000000UL            /*!< Clock signal not provided */
...
/** @defgroup USART_LL_EC_LASTCLKPULSE Last Clock Pulse
  * @{
  */
#define LL_USART_LASTCLKPULSE_NO_OUTPUT         0x00000000UL           /*!< The clock pulse of the last data bit is not output to the SCLK pin */
...
/** @defgroup USART_LL_EC_PHASE Clock Phase
  * @{
  */
#define LL_USART_PHASE_1EDGE                    0x00000000UL           /*!< The first clock transition is the first data capture edge */
...
/** @defgroup USART_LL_EC_POLARITY Clock Polarity
  * @{
  */
#define LL_USART_POLARITY_LOW                   0x00000000UL           /*!< Steady low value on SCLK pin outside transmission window*/
...
/** @defgroup USART_LL_EC_PRESCALER Clock Source Prescaler
  * @{
  */
#define LL_USART_PRESCALER_DIV1                 0x00000000UL                                                                   /*!< Input clock not divided   */
...
#define LL_USART_STOPBITS_1                     0x00000000UL                                /*!< 1 stop bit */
...
/** @defgroup USART_LL_EC_TXRX TX RX Pins Swap
  * @{
  */
#define LL_USART_TXRX_STANDARD                  0x00000000UL           /*!< TX/RX pins are used as defined in standard pinout */
...
/** @defgroup USART_LL_EC_RXPIN_LEVEL RX Pin Active Level Inversion
  * @{
  */
#define LL_USART_RXPIN_LEVEL_STANDARD           0x00000000UL           /*!< RX pin signal works using the standard logic levels */
...
/** @defgroup USART_LL_EC_TXPIN_LEVEL TX Pin Active Level Inversion
  * @{
  */
#define LL_USART_TXPIN_LEVEL_STANDARD           0x00000000UL           /*!< TX pin signal works using the standard logic levels */
...
/** @defgroup USART_LL_EC_BINARY_LOGIC Binary Data Inversion
  * @{
  */
#define LL_USART_BINARY_LOGIC_POSITIVE          0x00000000UL           /*!< Logical data from the data register are send/received in positive/direct logic. (1=H, 0=L) */
...
/** @defgroup USART_LL_EC_BITORDER Bit Order
  * @{
  */
#define LL_USART_BITORDER_LSBFIRST              0x00000000UL           /*!< data is transmitted/received with data bit 0 first, following the start bit */
...
/** @defgroup USART_LL_EC_AUTOBAUD_DETECT_ON Autobaud Detection
  * @{
  */
#define LL_USART_AUTOBAUD_DETECT_ON_STARTBIT    0x00000000UL                                 /*!< Measurement of the start bit is used to detect the baud rate */
...
#define LL_USART_AUTOBAUD_DETECT_ON_7F_FRAME    USART_CR2_ABRMODE_1                         /*!< 0x7FU frame detection */
#define LL_USART_AUTOBAUD_DETECT_ON_55_FRAME    (USART_CR2_ABRMODE_1 | USART_CR2_ABRMODE_0) /*!< 0x55U frame detection */
/**
  * @}
  */
...
/** @defgroup USART_LL_EC_ADDRESS_DETECT Address Length Detection
  * @{
  */
#define LL_USART_ADDRESS_DETECT_4B              0x00000000UL           /*!< 4-bit address detection method selected */
...
/** @defgroup USART_LL_EC_HWCONTROL Hardware Control
  * @{
  */
#define LL_USART_HWCONTROL_NONE                 0x00000000UL                          /*!< CTS and RTS hardware flow control disabled */
...
/** @defgroup USART_LL_EC_WAKEUP_ON Wakeup Activation
  * @{
  */
#define LL_USART_WAKEUP_ON_ADDRESS              0x00000000UL                             /*!< Wake up active on address match */
...
/** @defgroup USART_LL_EC_IRDA_POWER IrDA Power
  * @{
  */
#define LL_USART_IRDA_POWER_NORMAL              0x00000000UL           /*!< IrDA normal power mode */
...
/** @defgroup USART_LL_EC_LINBREAK_DETECT LIN Break Detection Length
  * @{
  */
#define LL_USART_LINBREAK_DETECT_10B            0x00000000UL           /*!< 10-bit break detection method selected */
...
/** @defgroup USART_LL_EC_DE_POLARITY Driver Enable Polarity
  * @{
  */
#define LL_USART_DE_POLARITY_HIGH               0x00000000UL           /*!< DE signal is active high */
...
/** @defgroup USART_LL_EC_DMA_REG_DATA DMA Register Data
  * @{
  */
#define LL_USART_DMA_REG_DATA_TRANSMIT          0x00000000UL          /*!< Get address of data register used for transmission */
#define LL_USART_DMA_REG_DATA_RECEIVE           0x00000001UL          /*!< Get address of data register used for reception */
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_Enable(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_Disable(USART_TypeDef * const USARTx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabled(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableFIFO(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableFIFO(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledFIFO(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetTXFIFOThreshold(USART_TypeDef * const USARTx, uint32_t Threshold)
{
...
/**
  ...
  *         @arg @ref LL_USART_FIFOTHRESHOLD_8_8
  */
__STATIC_INLINE uint32_t LL_USART_GetTXFIFOThreshold(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetRXFIFOThreshold(USART_TypeDef * const USARTx, uint32_t Threshold)
{
...
/**
  ...
  *         @arg @ref LL_USART_FIFOTHRESHOLD_8_8
  */
__STATIC_INLINE uint32_t LL_USART_GetRXFIFOThreshold(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigFIFOsThreshold(USART_TypeDef * const USARTx, uint32_t TXThreshold, uint32_t RXThreshold)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableInStopMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableInStopMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledInStopMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableClockInStopMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableClockInStopMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsClockEnabledInStopMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDirectionRx(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDirectionRx(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDirectionTx(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDirectionTx(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetTransferDirection(USART_TypeDef * const USARTx, uint32_t TransferDirection)
{
...
/**
  ...
  *         @arg @ref LL_USART_DIRECTION_TX_RX
  */
__STATIC_INLINE uint32_t LL_USART_GetTransferDirection(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetParity(USART_TypeDef * const USARTx, uint32_t Parity)
{
...
/**
  ...
  *         @arg @ref LL_USART_PARITY_ODD
  */
__STATIC_INLINE uint32_t LL_USART_GetParity(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetWakeUpMethod(USART_TypeDef * const USARTx, uint32_t Method)
{
...
/**
  ...
  *         @arg @ref LL_USART_WAKEUP_ADDRESSMARK
  */
__STATIC_INLINE uint32_t LL_USART_GetWakeUpMethod(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetDataWidth(USART_TypeDef * const USARTx, uint32_t DataWidth)
{
...
/**
  ...
  *         @arg @ref LL_USART_DATAWIDTH_9B
  */
__STATIC_INLINE uint32_t LL_USART_GetDataWidth(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableMuteMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableMuteMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledMuteMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetOverSampling(USART_TypeDef * const USARTx, uint32_t OverSampling)
{
...
/**
  ...
  *         @arg @ref LL_USART_OVERSAMPLING_8
  */
__STATIC_INLINE uint32_t LL_USART_GetOverSampling(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetLastClkPulseOutput(USART_TypeDef * const USARTx, uint32_t LastBitClockPulse)
{
...
/**
  ...
  *         @arg @ref LL_USART_LASTCLKPULSE_OUTPUT
  */
__STATIC_INLINE uint32_t LL_USART_GetLastClkPulseOutput(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetClockPhase(USART_TypeDef * const USARTx, uint32_t ClockPhase)
{
...
/**
  ...
  *         @arg @ref LL_USART_PHASE_2EDGE
  */
__STATIC_INLINE uint32_t LL_USART_GetClockPhase(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetClockPolarity(USART_TypeDef * const USARTx, uint32_t ClockPolarity)
{
...
/**
  ...
  *         @arg @ref LL_USART_POLARITY_HIGH
  */
__STATIC_INLINE uint32_t LL_USART_GetClockPolarity(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigClock(USART_TypeDef * const USARTx, uint32_t Phase, uint32_t Polarity, uint32_t LBCPOutput)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetPrescaler(USART_TypeDef * const USARTx, uint32_t PrescalerValue)
{
...
/**
  ...
  *         @arg @ref LL_USART_PRESCALER_DIV256
  */
__STATIC_INLINE uint32_t LL_USART_GetPrescaler(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableSCLKOutput(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableSCLKOutput(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSCLKOutput(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetStopBitsLength(USART_TypeDef * const USARTx, uint32_t StopBits)
{
...
/**
  ...
  *         @arg @ref LL_USART_STOPBITS_2
  */
__STATIC_INLINE uint32_t LL_USART_GetStopBitsLength(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigCharacter(USART_TypeDef * const USARTx, uint32_t DataWidth, uint32_t Parity,
                                              uint32_t StopBits)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetTXRXSwap(USART_TypeDef * const USARTx, uint32_t SwapConfig)
{
...
/**
  ...
  *         @arg @ref LL_USART_TXRX_SWAPPED
  */
__STATIC_INLINE uint32_t LL_USART_GetTXRXSwap(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetRXPinLevel(USART_TypeDef * const USARTx, uint32_t PinInvMethod)
{
...
/**
  ...
  *         @arg @ref LL_USART_RXPIN_LEVEL_INVERTED
  */
__STATIC_INLINE uint32_t LL_USART_GetRXPinLevel(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetTXPinLevel(USART_TypeDef * const USARTx, uint32_t PinInvMethod)
{
...
/**
  ...
  *         @arg @ref LL_USART_TXPIN_LEVEL_INVERTED
  */
__STATIC_INLINE uint32_t LL_USART_GetTXPinLevel(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetBinaryDataLogic(USART_TypeDef * const USARTx, uint32_t DataLogic)
{
...
/**
  ...
  *         @arg @ref LL_USART_BINARY_LOGIC_NEGATIVE
  */
__STATIC_INLINE uint32_t LL_USART_GetBinaryDataLogic(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetTransferBitOrder(USART_TypeDef * const USARTx, uint32_t BitOrder)
{
...
/**
  ...
  *         @arg @ref LL_USART_BITORDER_MSBFIRST
  */
__STATIC_INLINE uint32_t LL_USART_GetTransferBitOrder(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableAutoBaudRate(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableAutoBaudRate(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledAutoBaud(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetAutoBaudRateMode(USART_TypeDef * const USARTx, uint32_t AutoBaudRateMode)
{
...
/**
  ...
  *         @arg @ref LL_USART_AUTOBAUD_DETECT_ON_55_FRAME
  */
__STATIC_INLINE uint32_t LL_USART_GetAutoBaudRateMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableRxTimeout(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableRxTimeout(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledRxTimeout(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigNodeAddress(USART_TypeDef * const USARTx, uint32_t AddressLen, uint32_t NodeAddress)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_GetNodeAddress(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  *         @arg @ref LL_USART_ADDRESS_DETECT_7B
  */
__STATIC_INLINE uint32_t LL_USART_GetNodeAddressLen(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableRTSHWFlowCtrl(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableRTSHWFlowCtrl(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableCTSHWFlowCtrl(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableCTSHWFlowCtrl(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetHWFlowCtrl(USART_TypeDef * const USARTx, uint32_t HardwareFlowControl)
{
...
/**
  ...
  *         @arg @ref LL_USART_HWCONTROL_RTS_CTS
  */
__STATIC_INLINE uint32_t LL_USART_GetHWFlowCtrl(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableOneBitSamp(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableOneBitSamp(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledOneBitSamp(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableOverrunDetect(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableOverrunDetect(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledOverrunDetect(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetWKUPType(USART_TypeDef * const USARTx, uint32_t Type)
{
...
/**
  ...
  *         @arg @ref LL_USART_WAKEUP_ON_RXNE
  */
__STATIC_INLINE uint32_t LL_USART_GetWKUPType(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  */
#if defined(USART_PRESC_PRESCALER)
__STATIC_INLINE void LL_USART_SetBaudRate(USART_TypeDef * const USARTx, uint32_t PeriphClk, uint32_t PrescalerValue,
                                          uint32_t OverSampling,
                                          uint32_t BaudRate)
#else
__STATIC_INLINE void LL_USART_SetBaudRate(USART_TypeDef * const USARTx, uint32_t PeriphClk, uint32_t OverSampling,
                                          uint32_t BaudRate)
#endif /* USART_PRESC_PRESCALER */
{
  uint32_t usartdiv;
...
/**
  ...
  */
#if defined(USART_PRESC_PRESCALER)
__STATIC_INLINE uint32_t LL_USART_GetBaudRate(USART_TypeDef const * const USARTx, uint32_t PeriphClk, uint32_t PrescalerValue,
                                              uint32_t OverSampling)
#else
__STATIC_INLINE uint32_t LL_USART_GetBaudRate(USART_TypeDef const * const USARTx, uint32_t PeriphClk, uint32_t OverSampling)
#endif /* USART_PRESC_PRESCALER */
{
  uint32_t usartdiv;
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  Timeout Value between Min_Data=0x00U and Max_Data=0x00FFFFFFUL
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetRxTimeout(USART_TypeDef * const USARTx, uint32_t Timeout)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @retval Value between Min_Data=0x00U and Max_Data=0x00FFFFFFUL
  */
__STATIC_INLINE uint32_t LL_USART_GetRxTimeout(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  BlockLength Value between Min_Data=0x00U and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetBlockLength(USART_TypeDef * const USARTx, uint32_t BlockLength)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_GetBlockLength(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIrda(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIrda(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIrda(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetIrdaPowerMode(USART_TypeDef * const USARTx, uint32_t PowerMode)
{
...
/**
  ...
  *         @arg @ref LL_USART_PHASE_2EDGE
  */
__STATIC_INLINE uint32_t LL_USART_GetIrdaPowerMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  PrescalerValue Value between Min_Data=0x00U and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetIrdaPrescaler(USART_TypeDef * const USARTx, uint32_t PrescalerValue)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @retval Irda prescaler value (Value between Min_Data=0x00U and Max_Data=0xFFU)
  */
__STATIC_INLINE uint32_t LL_USART_GetIrdaPrescaler(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableSmartcardNACK(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableSmartcardNACK(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSmartcardNACK(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableSmartcard(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableSmartcard(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSmartcard(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetSmartcardAutoRetryCount(USART_TypeDef * const USARTx, uint32_t AutoRetryCount)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardAutoRetryCount(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetSmartcardPrescaler(USART_TypeDef * const USARTx, uint32_t PrescalerValue)
{
  MODIFY_REG(USARTx->GTPR, USART_GTPR_PSC, (uint16_t)PrescalerValue);
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardPrescaler(USART_TypeDef const * const USARTx)
{
  return (uint32_t)(READ_BIT(USARTx->GTPR, USART_GTPR_PSC));
}
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  GuardTime Value between Min_Data=0x00U and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetSmartcardGuardTime(USART_TypeDef * const USARTx, uint32_t GuardTime)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @retval Smartcard Guard time value (Value between Min_Data=0x00U and Max_Data=0xFFU)
  */
__STATIC_INLINE uint32_t LL_USART_GetSmartcardGuardTime(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableHalfDuplex(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableHalfDuplex(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledHalfDuplex(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableSPISlave(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableSPISlave(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSPISlave(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableSPISlaveSelect(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableSPISlaveSelect(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledSPISlaveSelect(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetLINBrkDetectionLen(USART_TypeDef * const USARTx, uint32_t LINBDLength)
{
...
/**
  ...
  *         @arg @ref LL_USART_LINBREAK_DETECT_11B
  */
__STATIC_INLINE uint32_t LL_USART_GetLINBrkDetectionLen(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableLIN(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableLIN(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledLIN(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetDEDeassertionTime(USART_TypeDef * const USARTx, uint32_t Time)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_GetDEDeassertionTime(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetDEAssertionTime(USART_TypeDef * const USARTx, uint32_t Time)
{
...
/**
  ...
  * @retval Time value expressed on 5 bits ([4:0] bits) : Value between Min_Data=0 and Max_Data=31
  */
__STATIC_INLINE uint32_t LL_USART_GetDEAssertionTime(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDEMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDEMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDEMode(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_SetDESignalPolarity(USART_TypeDef * const USARTx, uint32_t Polarity)
{
...
/**
  ...
  *         @arg @ref LL_USART_DE_POLARITY_LOW
  */
__STATIC_INLINE uint32_t LL_USART_GetDESignalPolarity(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigAsyncMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigSyncMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigLINMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigHalfDuplexMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigSmartcardMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigIrdaMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ConfigMultiProcessMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_PE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_FE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_NE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ORE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_IDLE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXNE_RXFNE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXNE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TC(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXE_TXFNF(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_LBD(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_nCTS(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_CTS(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RTO(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_EOB(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_UDR(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ABRE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_ABR(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_BUSY(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_CM(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_SBK(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RWU(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_WKUP(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TEACK(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_REACK(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXFE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXFF(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TCBGT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_TXFT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsActiveFlag_RXFT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_PE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_FE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_NE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_ORE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_IDLE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_TXFE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_TC(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_TCBGT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_LBD(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_nCTS(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_RTO(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_EOB(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_UDR(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_CM(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_ClearFlag_WKUP(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_IDLE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_RXNE_RXFNE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_RXNE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TC(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TXE_TXFNF(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TXE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_PE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_CM(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_RTO(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_EOB(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TXFE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_RXFF(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_LBD(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_ERROR(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_CTS(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_WKUP(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TXFT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_TCBGT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableIT_RXFT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_IDLE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_RXNE_RXFNE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_RXNE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TC(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TXE_TXFNF(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TXE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_PE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_CM(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_RTO(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_EOB(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TXFE(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_RXFF(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_LBD(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_ERROR(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_CTS(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_WKUP(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TXFT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_TCBGT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableIT_RXFT(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_IDLE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXNE_RXFNE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXNE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TC(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXE_TXFNF(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_PE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_CM(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RTO(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_EOB(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXFE(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXFF(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_LBD(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_ERROR(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_CTS(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_WKUP(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TXFT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_TCBGT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledIT_RXFT(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDMAReq_RX(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDMAReq_RX(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMAReq_RX(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDMAReq_TX(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDMAReq_TX(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMAReq_TX(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_EnableDMADeactOnRxErr(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_DisableDMADeactOnRxErr(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_USART_IsEnabledDMADeactOnRxErr(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_USART_DMA_GetRegAddr(USART_TypeDef const * const USARTx, uint32_t Direction)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00U and Max_Data=0xFFU
  */
__STATIC_INLINE uint8_t LL_USART_ReceiveData8(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  */
__STATIC_INLINE uint16_t LL_USART_ReceiveData9(USART_TypeDef const * const USARTx)
{
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  Value between Min_Data=0x00U and Max_Data=0xFFU
  * @retval None
  */
__STATIC_INLINE void LL_USART_TransmitData8(USART_TypeDef * const USARTx, uint8_t Value)
{
  USARTx->TDR = Value;
}
...
/**
  ...
  * @param  USARTx USART Instance
  * @param  Value between Min_Data=0x00U and Max_Data=0x1FFU
  * @retval None
  */
__STATIC_INLINE void LL_USART_TransmitData9(USART_TypeDef * const USARTx, uint16_t Value)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_RequestAutoBaudRate(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_RequestBreakSending(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_RequestEnterMuteMode(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_RequestRxDataFlush(USART_TypeDef * const USARTx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_USART_RequestTxDataFlush(USART_TypeDef * const USARTx)
{
...
/** @defgroup USART_LL_EF_Init Initialization and de-initialization functions
  * @{
  */
ErrorStatus LL_USART_DeInit(USART_TypeDef const * const USARTx);
ErrorStatus LL_USART_Init(USART_TypeDef * const USARTx, LL_USART_InitTypeDef const * const USART_InitStruct);
void        LL_USART_StructInit(LL_USART_InitTypeDef * const USART_InitStruct);
ErrorStatus LL_USART_ClockInit(USART_TypeDef * const USARTx, LL_USART_ClockInitTypeDef const * const USART_ClockInitStruct);
void        LL_USART_ClockStructInit(LL_USART_ClockInitTypeDef * const USART_ClockInitStruct);
/**
  * @}
  */
#endif /* USE_FULL_LL_DRIVER */
