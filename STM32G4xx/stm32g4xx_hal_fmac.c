...
static HAL_StatusTypeDef FMAC_Reset(FMAC_HandleTypeDef * const hfmac);
static void FMAC_ResetDataPointers(FMAC_HandleTypeDef * const hfmac);
static void FMAC_ResetOutputStateAndDataPointers(FMAC_HandleTypeDef * const hfmac);
static void FMAC_ResetInputStateAndDataPointers(FMAC_HandleTypeDef * const hfmac);
static HAL_StatusTypeDef FMAC_FilterConfig(FMAC_HandleTypeDef * const hfmac, FMAC_FilterConfigTypeDef * const pConfig,
                                           uint8_t PreloadAccess);
static HAL_StatusTypeDef FMAC_FilterPreload(FMAC_HandleTypeDef * const hfmac, int16_t * pInput, uint8_t InputSize,
                                            int16_t * pOutput, uint8_t OutputSize, uint8_t PreloadAccess);
static void FMAC_WritePreloadDataIncrementPtr(FMAC_HandleTypeDef * const hfmac, int16_t ** const ppData, uint8_t Size);
static HAL_StatusTypeDef FMAC_WaitOnStartUntilTimeout(FMAC_HandleTypeDef * const hfmac, uint32_t Tickstart, uint32_t Timeout);
static HAL_StatusTypeDef FMAC_AppendFilterDataUpdateState(FMAC_HandleTypeDef * const hfmac, int16_t * const pInput,
                                                          uint16_t * const pInputSize);
static HAL_StatusTypeDef FMAC_ConfigFilterOutputBufferUpdateState(FMAC_HandleTypeDef * const hfmac, int16_t * const pOutput,
                                                                  uint16_t * const pOutputSize);
static void FMAC_WriteDataIncrementPtr(FMAC_HandleTypeDef * const hfmac, uint16_t MaxSizeToWrite);
static void FMAC_ReadDataIncrementPtr(FMAC_HandleTypeDef * const hfmac, uint16_t MaxSizeToRead);
static void FMAC_DMAHalfGetData(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAGetData(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAHalfOutputDataReady(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAOutputDataReady(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAFilterConfig(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAFilterPreload(DMA_HandleTypeDef * const hdma);
static void FMAC_DMAError(DMA_HandleTypeDef * const hdma);
...
/**
  ...
  */
HAL_StatusTypeDef HAL_FMAC_Init(FMAC_HandleTypeDef * const hfmac)
{
...
#if (USE_HAL_FMAC_REGISTER_CALLBACKS == 1U)
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_DeInit(FMAC_HandleTypeDef * const hfmac)
{
  /* Check the FMAC handle allocation */
  if (hfmac == NULL)
  {
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_MspInit(FMAC_HandleTypeDef * const hfmac)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_MspDeInit(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_RegisterCallback(FMAC_HandleTypeDef * const hfmac, HAL_FMAC_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_UnRegisterCallback(FMAC_HandleTypeDef * const hfmac, HAL_FMAC_CallbackIDTypeDef CallbackID)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterConfig(FMAC_HandleTypeDef * const hfmac, FMAC_FilterConfigTypeDef * const pConfig)
{
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterConfig_DMA(FMAC_HandleTypeDef * const hfmac, FMAC_FilterConfigTypeDef * const pConfig)
{
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterPreload(FMAC_HandleTypeDef * const hfmac, int16_t * const pInput, uint8_t InputSize,
                                         int16_t * const pOutput, uint8_t OutputSize)
{
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterPreload_DMA(FMAC_HandleTypeDef * const hfmac, int16_t * const pInput, uint8_t InputSize,
                                             int16_t * const pOutput, uint8_t OutputSize)
{
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterStart(FMAC_HandleTypeDef * const hfmac, int16_t * const pOutput, uint16_t * const pOutputSize)
{
  uint32_t tmpcr = 0U;
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_AppendFilterData(FMAC_HandleTypeDef * const hfmac, int16_t * const pInput, uint16_t * const pInputSize)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_ConfigFilterOutputBuffer(FMAC_HandleTypeDef * const hfmac, int16_t * const pOutput, uint16_t * const pOutputSize)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_PollFilterData(FMAC_HandleTypeDef * const hfmac, uint32_t Timeout)
{
  uint32_t tickstart;
  uint8_t inpolling;
...
/**
  ...
  * @retval HAL_StatusTypeDef HAL status
  */
HAL_StatusTypeDef HAL_FMAC_FilterStop(FMAC_HandleTypeDef * const hfmac)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_ErrorCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_HalfGetDataCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_GetDataCallback(FMAC_HandleTypeDef const * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_HalfOutputDataReadyCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_OutputDataReadyCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_FilterConfigCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FMAC_FilterPreloadCallback(FMAC_HandleTypeDef * const hfmac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfmac);
...
/**
  ...
  * @retval None
  */
void HAL_FMAC_IRQHandler(FMAC_HandleTypeDef * const hfmac)
{
  uint32_t itsource;
...
/**
  ...
  */
HAL_FMAC_StateTypeDef HAL_FMAC_GetState(FMAC_HandleTypeDef const * const hfmac)
{
  /* Return FMAC state */
  return hfmac->State;
}
...
/**
  ...
  */
uint32_t HAL_FMAC_GetError(FMAC_HandleTypeDef const * const hfmac)
{
...
static void FMAC_DMAHalfGetData(DMA_HandleTypeDef * const hdma)
{
  FMAC_HandleTypeDef * const hfmac = (FMAC_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
