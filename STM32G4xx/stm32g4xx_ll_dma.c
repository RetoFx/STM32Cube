...
void LL_DMA_StructInit(LL_DMA_InitTypeDef * const DMA_InitStruct)
{
  ...
  DMA_InitStruct->PeriphOrM2MSrcAddress  = (uint32_t)0x00000000UL;
  DMA_InitStruct->MemoryOrM2MDstAddress  = (uint32_t)0x00000000UL;
  ...
  DMA_InitStruct->NbData                 = (uint32_t)0x00000000UL;
