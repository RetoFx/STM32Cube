...
/** @defgroup CORDIC_Private_Functions CORDIC Private Functions
  * @{
  */
static void CORDIC_WriteInDataIncrementPtr(CORDIC_HandleTypeDef const * const hcordic, int32_t const ** const ppInBuff);
static void CORDIC_ReadOutDataIncrementPtr(CORDIC_HandleTypeDef const * const hcordic, int32_t ** const ppOutBuff);
static void CORDIC_DMAInCplt(DMA_HandleTypeDef * const hdma);
static void CORDIC_DMAOutCplt(DMA_HandleTypeDef * const hdma);
static void CORDIC_DMAError(DMA_HandleTypeDef * const hdma);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_CORDIC_MspInit(CORDIC_HandleTypeDef * const hcordic)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_CORDIC_MspDeInit(CORDIC_HandleTypeDef * const hcordic)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcordic);
...
HAL_StatusTypeDef HAL_CORDIC_RegisterCallback(CORDIC_HandleTypeDef * const hcordic, HAL_CORDIC_CallbackIDTypeDef CallbackID,
                                              void (* pCallback)(CORDIC_HandleTypeDef * const _hcordic))
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_CORDIC_ErrorCallback(CORDIC_HandleTypeDef * const hcordic)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcordic);
...
/**
  ...
  * @retval None
  */
__weak void HAL_CORDIC_CalculateCpltCallback(CORDIC_HandleTypeDef * const hcordic)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hcordic);
...
static void CORDIC_DMAInCplt(DMA_HandleTypeDef * const hdma)
{
  CORDIC_HandleTypeDef * const hcordic = (CORDIC_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
