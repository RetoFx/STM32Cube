...
/** @defgroup RCC_LL_EC_LPTIM1_CLKSOURCE  Peripheral LPTIM clock source selection
  * @{
  */
#define LL_RCC_LPTIM1_CLKSOURCE_PCLK1      0x00000000UL                                            /*!< PCLK1 clock used as LPTIM1 clock source */
...
/** @defgroup RCC_LL_EC_SAI1_CLKSOURCE  Peripheral SAI clock source selection
  * @{
  */
#define LL_RCC_SAI1_CLKSOURCE_SYSCLK       0x00000000UL                                           /*!< System clock used as SAI1 clock source */
...
/** @defgroup RCC_LL_EC_I2S_CLKSOURCE  Peripheral I2S clock source selection
  * @{
  */
#define LL_RCC_I2S_CLKSOURCE_SYSCLK       0x00000000UL                                          /*!< System clock used as I2S clock source */
...
/** @defgroup RCC_LL_EC_FDCAN_CLKSOURCE  Peripheral FDCAN clock source selection
  * @{
  */
#define LL_RCC_FDCAN_CLKSOURCE_HSE        0x00000000UL             /*!< HSE clock used as FDCAN clock source */
...
/** @defgroup RCC_LL_EC_QUADSPI  Peripheral QUADSPI get clock source
  * @{
  */
#define LL_RCC_QUADSPI_CLKSOURCE_SYSCLK    0x00000000UL              /*!< SYSCLK used as QuadSPI clock source */
...
{
  MODIFY_REG(RCC->CCIPR, 3UL << ((ADCxSource & 0x001F0000UL) >> 16U), ((ADCxSource & 0x000000FFUL) << ((ADCxSource & 0x001F0000UL) >> 16U)));
}
...
{
  return (uint32_t)((READ_BIT(RCC->CCIPR, 3UL << ((ADCx & 0x001F0000UL) >> 16U)) >> ((ADCx & 0x001F0000UL) >> 16U)) | (ADCx & 0xFFFF0000UL));
}
