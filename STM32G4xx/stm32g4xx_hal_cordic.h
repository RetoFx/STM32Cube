...
/**
  ...
  */
#if (USE_HAL_CORDIC_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_CORDIC_REGISTER_CALLBACKS == 1U)
  void (* ErrorCallback)(struct __CORDIC_HandleTypeDef * const hcordic);          /*!< CORDIC error callback */
  void (* CalculateCpltCallback)(struct __CORDIC_HandleTypeDef * const hcordic);  /*!< CORDIC calculate complete callback */

  void (* MspInitCallback)(struct __CORDIC_HandleTypeDef * const hcordic);        /*!< CORDIC Msp Init callback */
  void (* MspDeInitCallback)(struct __CORDIC_HandleTypeDef * const hcordic);      /*!< CORDIC Msp DeInit callback */
...
/**
  ...
  */
typedef  void (*pCORDIC_CallbackTypeDef)(CORDIC_HandleTypeDef * const hcordic);  /*!< pointer to a CORDIC callback function */
...
/** @defgroup CORDIC_Error_Code CORDIC Error code
  * @{
  */
#define HAL_CORDIC_ERROR_NONE              ((uint32_t)0x00000000UL)   /*!< No error                */
#define HAL_CORDIC_ERROR_PARAM             ((uint32_t)0x00000001UL)   /*!< Wrong parameter error   */
#define HAL_CORDIC_ERROR_NOT_READY         ((uint32_t)0x00000002UL)   /*!< Peripheral not ready    */
#define HAL_CORDIC_ERROR_TIMEOUT           ((uint32_t)0x00000004UL)   /*!< Timeout error           */
#define HAL_CORDIC_ERROR_DMA               ((uint32_t)0x00000008UL)   /*!< DMA error               */
#if (USE_HAL_CORDIC_REGISTER_CALLBACKS == 1U)
#define HAL_CORDIC_ERROR_INVALID_CALLBACK  ((uint32_t)0x00000010UL)   /*!< Invalid Callback error  */
#endif /* USE_HAL_CORDIC_REGISTER_CALLBACKS */
...
/** @defgroup CORDIC_Function CORDIC Function
  * @{
  */
#define CORDIC_FUNCTION_COSINE      (0x00000000UL)                                                          /*!< Cosine */
...
#define CORDIC_SCALE_0              (0x00000000UL)
...
/** @defgroup CORDIC_Nb_Write CORDIC Number of 32-bit write required for one calculation
  * @{
  */
#define CORDIC_NBWRITE_1           (0x00000000UL)             /*!< One 32-bits write containing either only one
...
/** @defgroup CORDIC_Nb_Read CORDIC Number of 32-bit read required after one calculation
  * @{
  */
#define CORDIC_NBREAD_1            (0x00000000UL)             /*!< One 32-bits read containing either only one
...
/** @defgroup CORDIC_In_Size CORDIC input data size
  * @{
  */
#define CORDIC_INSIZE_32BITS       (0x00000000UL)             /*!< 32 bits input data size (Q1.31 format) */
...
/** @defgroup CORDIC_Out_Size CORDIC Results Size
  * @{
  */
#define CORDIC_OUTSIZE_32BITS      (0x00000000UL)             /*!< 32 bits output data size (Q1.31 format) */
...
/** @defgroup CORDIC_DMA_Direction CORDIC DMA direction
  * @{
  */
#define CORDIC_DMA_DIR_NONE        ((uint32_t)0x00000000UL)   /*!< DMA direction : none */
#define CORDIC_DMA_DIR_IN          ((uint32_t)0x00000001UL)   /*!< DMA direction : Input of CORDIC */
#define CORDIC_DMA_DIR_OUT         ((uint32_t)0x00000002UL)   /*!< DMA direction : Output of CORDIC */
#define CORDIC_DMA_DIR_IN_OUT      ((uint32_t)0x00000003UL)   /*!< DMA direction : Input and Output of CORDIC */
...
HAL_StatusTypeDef HAL_CORDIC_Init(CORDIC_HandleTypeDef * const hcordic);
HAL_StatusTypeDef HAL_CORDIC_DeInit(CORDIC_HandleTypeDef * const hcordic);
void HAL_CORDIC_MspInit(CORDIC_HandleTypeDef * const hcordic);
void HAL_CORDIC_MspDeInit(CORDIC_HandleTypeDef * const hcordic);

#if (USE_HAL_CORDIC_REGISTER_CALLBACKS == 1U)
/* Callbacks Register/UnRegister functions  ***********************************/
HAL_StatusTypeDef HAL_CORDIC_RegisterCallback(CORDIC_HandleTypeDef * const hcordic, HAL_CORDIC_CallbackIDTypeDef CallbackID,
                                              pCORDIC_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_CORDIC_UnRegisterCallback(CORDIC_HandleTypeDef * const hcordic, HAL_CORDIC_CallbackIDTypeDef CallbackID);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_CORDIC_Configure(CORDIC_HandleTypeDef * const hcordic, CORDIC_ConfigTypeDef const * const sConfig);
HAL_StatusTypeDef HAL_CORDIC_Calculate(CORDIC_HandleTypeDef * const hcordic, int32_t const * const pInBuff, int32_t * const pOutBuff,
                                       uint32_t NbCalc, uint32_t Timeout);
HAL_StatusTypeDef HAL_CORDIC_CalculateZO(CORDIC_HandleTypeDef * const hcordic, int32_t const * const pInBuff, int32_t * const pOutBuff,
                                         uint32_t NbCalc, uint32_t Timeout);
HAL_StatusTypeDef HAL_CORDIC_Calculate_IT(CORDIC_HandleTypeDef * const hcordic, int32_t const * const pInBuff, int32_t * const pOutBuff,
                                          uint32_t NbCalc);
HAL_StatusTypeDef HAL_CORDIC_Calculate_DMA(CORDIC_HandleTypeDef * const hcordic, int32_t const * const pInBuff, int32_t * const pOutBuff,
...
/** @addtogroup CORDIC_Exported_Functions_Group3
  ...
  */
/* Callback functions *********************************************************/
void HAL_CORDIC_ErrorCallback(CORDIC_HandleTypeDef * const hcordic);
void HAL_CORDIC_CalculateCpltCallback(CORDIC_HandleTypeDef * const hcordic);
/**
  * @}
  */
...
void HAL_CORDIC_IRQHandler(CORDIC_HandleTypeDef * const hcordic);
/**
  * @}
  */
...
HAL_CORDIC_StateTypeDef HAL_CORDIC_GetState(CORDIC_HandleTypeDef const * const hcordic);
uint32_t HAL_CORDIC_GetError(CORDIC_HandleTypeDef const * const hcordic);
