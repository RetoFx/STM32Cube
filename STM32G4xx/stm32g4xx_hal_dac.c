...
#define HFSEL_ENABLE_THRESHOLD_80MHZ   80000000UL  /* 80 MHz        */
#define HFSEL_ENABLE_THRESHOLD_160MHZ  160000000UL /* 160 MHz       */
...
/**
  ...
  * @retval None
  */
__weak void HAL_DAC_MspInit(DAC_HandleTypeDef * const hdac)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_DAC_MspDeInit(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DAC_WEAK_CALLBACK(void, HAL_DAC_ConvCpltCallbackCh1)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DAC_WEAK_CALLBACK(void, HAL_DAC_ConvHalfCpltCallbackCh1)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DAC_WEAK_CALLBACK(void, HAL_DAC_ErrorCallbackCh1)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DAC_WEAK_CALLBACK(void, HAL_DAC_DMAUnderrunCallbackCh1)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
{
  DAC_HandleTypeDef * const hdac = (DAC_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
