...
// Include the profile specific settings:
  ...
  #include "./a-profile/cmsis_lint_a.h"
#elif __ARM_ARCH_PROFILE == 'R'
  #include "./r-profile/cmsis_lint_r.h"
#elif __ARM_ARCH_PROFILE == 'M'
  #include "./m-profile/cmsis_lint_m.h"
#else
