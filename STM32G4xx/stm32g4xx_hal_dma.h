...
#define HAL_DMA_ERROR_NO_XFER          0x00000004UL    /*!< Abort requested with no Xfer ongoing  */
...
#define HAL_DMA_ERROR_SYNC             0x00000200UL    /*!< DMAMUX sync overrun  error              */
#define HAL_DMA_ERROR_REQGEN           0x00000400UL    /*!< DMAMUX request generator overrun  error */
/**
  * @}
  */
...
#define DMA_FLAG_GL8                      0x10000000UL
#define DMA_FLAG_TC8                      0x20000000UL
#define DMA_FLAG_HT8                      0x40000000UL
#define DMA_FLAG_TE8                      0x80000000UL
#endif /* DMA1_Channel8 */
/**
  * @}
  */
...
#define IS_DMA_BUFFER_SIZE(SIZE) (((SIZE) >= 0x1U) && ((SIZE) < 0x40000UL))
