...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_DualStart(DAC_HandleTypeDef * const hdac)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_DualStop(DAC_HandleTypeDef * const hdac)
{
  /* Check the DAC peripheral handle */
  if (hdac == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_DualStart_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel,
                                          uint32_t const * const pData, uint32_t Length, uint32_t Alignment)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_DualStop_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel)
{
  HAL_StatusTypeDef status;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_SawtoothWaveGenerate(DAC_HandleTypeDef * const hdac, uint32_t Channel, uint32_t Polarity,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_SawtoothWaveDataReset(DAC_HandleTypeDef * const hdac, uint32_t Channel)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_SawtoothWaveDataStep(DAC_HandleTypeDef * const hdac, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_DACEX_WEAK_CALLBACK(void, HAL_DACEx_ConvCpltCallbackCh2)(DAC_HandleTypeDef * const hdac)
{
...
/**
  ...
  * @retval None
  */
HAL_DACEX_WEAK_CALLBACK(void, HAL_DACEx_ConvHalfCpltCallbackCh2)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DACEX_WEAK_CALLBACK(void, HAL_DACEx_ErrorCallbackCh2)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  * @retval None
  */
HAL_DACEX_WEAK_CALLBACK(void, HAL_DACEx_DMAUnderrunCallbackCh2)(DAC_HandleTypeDef * const hdac)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hdac);
...
/**
  ...
  */
HAL_StatusTypeDef HAL_DACEx_SelfCalibrate(DAC_HandleTypeDef * const hdac, DAC_ChannelConfTypeDef * const sConfig, uint32_t Channel)
{
  HAL_StatusTypeDef status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DACEx_SetUserTrimming(DAC_HandleTypeDef * const hdac, DAC_ChannelConfTypeDef * const sConfig, uint32_t Channel,
 ...
 */
uint32_t HAL_DACEx_GetTrimOffset(DAC_HandleTypeDef const * const hdac, uint32_t Channel)
{
  /* Check the parameter */
  assert_param(IS_DAC_CHANNEL(hdac->Instance, Channel));
...
/**
  ...
  * @retval None
  */
void DAC_DMAConvCpltCh2(DMA_HandleTypeDef * const hdma)
{
...
/**
  ...
  * @retval None
  */
void DAC_DMAHalfConvCpltCh2(DMA_HandleTypeDef * const hdma)
{
  DAC_HandleTypeDef * const hdac = (DAC_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
...
/**
  ...
  * @retval None
  */
void DAC_DMAErrorCh2(DMA_HandleTypeDef * const hdma)
{
  DAC_HandleTypeDef * const hdac = (DAC_HandleTypeDef *)((DMA_HandleTypeDef *)hdma)->Parent;
