...
__STATIC_FORCEINLINE void __TZ_set_STACKSEAL_S (uint32_t* stackTop) {
  *((uint64_t *)stackTop) = __TZ_STACK_SEAL_VALUE;
  ...
  #define __ICCARM_INTRINSICS_VERSION__  0U
#endif

#if (__ICCARM_INTRINSICS_VERSION__ == 2U)
...
__STATIC_FORCEINLINE void __TZ_set_CONTROL_NS(uint32_t const control)
{
...
#else /* __ICCARM_INTRINSICS_VERSION__ == 2U */
  ...
  #include <intrinsics.h>
   ...
   /* Avoid clash between intrinsics.h and arm_math.h when compiling for Cortex-M0. */
    ...
    __STATIC_INLINE uint8_t __CLZ(uint32_t const data)
    {
  ...
  #if (!defined(__ARM_ARCH_6M__) || __ARM_ARCH_6M__==0U)
  ...
  /* __CORTEX_M is defined in core_cm0.h, core_cm3.h and core_cm4.h. */
    ...
    __IAR_FT void __set_BASEPRI_MAX(uint32_t const value)
    {
...
#endif   /* __ICCARM_INTRINSICS_VERSION__ == 2U */

#define __BKPT(value)    __asm volatile ("BKPT     %0" : : "i"(value))

#if __IAR_M0_FAMILY
  __STATIC_INLINE int32_t __SSAT(int32_t const val, uint32_t const sat)
  {
    if ((sat >= 1U) && (sat <= 32U))
    {
  ...
  __STATIC_INLINE uint32_t __USAT(int32_t const val, uint32_t const sat)
  {
    if (sat <= 31U)
    {
