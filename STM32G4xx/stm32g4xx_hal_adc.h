...
typedef struct
{
  ...
  uint32_t GainCompensation;      /*!< Specify the ADC gain compensation coefficient to be applied to ADC raw conversion
                                       ...
                                       This parameter value can be
                                        ...
                                        1 -> 0x3FFFU Gain compensation will be enabled and coefficient set to specified
                                                    value
...
typedef struct
{
  ...
  uint32_t Offset;                 /*!< Define the offset to be applied on the raw converted data.
                                        ...
                                        must be a number between Min_Data = 0x000U and Max_Data = 0xFFFU,
...
typedef struct
{
  ...
  uint32_t HighThreshold;     /*!< Configure the ADC analog watchdog High threshold value.
                                   ...
                                   number between Min_Data = 0x000U and Max_Data = 0xFFFU, 0x3FFU, 0xFFU or 0x3FU
                                   respectively.
...
#endif /* USE_HAL_ADC_REGISTER_CALLBACKS */
{
  ...
  void (* ConvHalfCpltCallback)(struct __ADC_HandleTypeDef * const hadc);          /*!< ADC conversion DMA half-transfer
                                                                                 callback */
  ...
  void (* InjectedConvCpltCallback)(struct __ADC_HandleTypeDef * const hadc);      /*!< ADC group injected conversion complete
                                                                                 callback */
  void (* InjectedQueueOverflowCallback)(struct __ADC_HandleTypeDef * const hadc); /*!< ADC group injected context queue
                                                                                 overflow callback */
  void (* LevelOutOfWindow2Callback)(struct __ADC_HandleTypeDef * const hadc);     /*!< ADC analog watchdog 2 callback */
  void (* LevelOutOfWindow3Callback)(struct __ADC_HandleTypeDef * const hadc);     /*!< ADC analog watchdog 3 callback */
  void (* EndOfSamplingCallback)(struct __ADC_HandleTypeDef * const hadc);         /*!< ADC end of sampling callback */
...
HAL_StatusTypeDef HAL_ADC_RegisterCallback(ADC_HandleTypeDef * const hadc, HAL_ADC_CallbackIDTypeDef CallbackID,
...
HAL_StatusTypeDef HAL_ADC_StartSampling(ADC_HandleTypeDef * const hadc);
HAL_StatusTypeDef HAL_ADC_StopSampling(ADC_HandleTypeDef * const hadc);
...
HAL_StatusTypeDef       HAL_ADC_ConfigChannel(ADC_HandleTypeDef * const hadc, ADC_ChannelConfTypeDef const * const pConfig);
HAL_StatusTypeDef       HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef * const hadc,
                                                ADC_AnalogWDGConfTypeDef const * const pAnalogWDGConfig);
...
/** @addtogroup ADC_Private_Functions ADC Private Functions
  * @{
  */
HAL_StatusTypeDef ADC_ConversionStop(ADC_HandleTypeDef * const hadc, uint32_t ConversionGroup);
HAL_StatusTypeDef ADC_Enable(ADC_HandleTypeDef * const hadc);
HAL_StatusTypeDef ADC_Disable(ADC_HandleTypeDef * const hadc);
