...
/**
  ...
  */
#if (USE_HAL_DAC_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_DAC_REGISTER_CALLBACKS == 1U)
  void (* ConvCpltCallbackCh1)(struct __DAC_HandleTypeDef * const hdac);
  void (* ConvHalfCpltCallbackCh1)(struct __DAC_HandleTypeDef * const hdac);
  void (* ErrorCallbackCh1)(struct __DAC_HandleTypeDef * const hdac);
  void (* DMAUnderrunCallbackCh1)(struct __DAC_HandleTypeDef * const hdac);

  void (* ConvCpltCallbackCh2)(struct __DAC_HandleTypeDef * const hdac);
  void (* ConvHalfCpltCallbackCh2)(struct __DAC_HandleTypeDef * const hdac);
  void (* ErrorCallbackCh2)(struct __DAC_HandleTypeDef * const hdac);
  void (* DMAUnderrunCallbackCh2)(struct __DAC_HandleTypeDef * const hdac);


  void (* MspInitCallback)(struct __DAC_HandleTypeDef * const hdac);
  void (* MspDeInitCallback)(struct __DAC_HandleTypeDef * const hdac);
#endif /* USE_HAL_DAC_REGISTER_CALLBACKS */
...
/**
  ...
  */
typedef void (*pDAC_CallbackTypeDef)(DAC_HandleTypeDef * const hdac);
#endif /* USE_HAL_DAC_REGISTER_CALLBACKS */
...
/** @defgroup DAC_output_buffer DAC output buffer
  * @{
  */
#define DAC_OUTPUTBUFFER_ENABLE            0x00000000UL
...
/** @defgroup DAC_Channel_selection DAC Channel selection
  * @{
  */
#define DAC_CHANNEL_1                      0x00000000UL

#define DAC_CHANNEL_2                      0x00000010UL
...
/** @defgroup DAC_data_alignment DAC data alignment
  * @{
  */
#define DAC_ALIGN_12B_R                    0x00000000UL
#define DAC_ALIGN_12B_L                    0x00000004UL
#define DAC_ALIGN_8B_R                     0x00000008UL
...
/** @defgroup DAC_ConnectOnChipPeripheral DAC ConnectOnChipPeripheral
  * @{
  */
#define DAC_CHIPCONNECT_EXTERNAL       (1UL << 0U) /*!< DAC channel output is connected to an external pin.*/
#define DAC_CHIPCONNECT_INTERNAL       (1UL << 1U) /*!< DAC channel  output is connected to on-chip peripherals (via
                                                       internal paths) and to an external pin. */
#define DAC_CHIPCONNECT_BOTH           (1UL << 2U) /*!< DAC channel  output is connected to on-chip peripherals (via
                                                       internal paths) and to an external pin.
...
HAL_StatusTypeDef HAL_DAC_Init(DAC_HandleTypeDef * const hdac);
HAL_StatusTypeDef HAL_DAC_DeInit(DAC_HandleTypeDef * const hdac);
void HAL_DAC_MspInit(DAC_HandleTypeDef * const hdac);
void HAL_DAC_MspDeInit(DAC_HandleTypeDef * const hdac);
...
HAL_StatusTypeDef HAL_DAC_Start(DAC_HandleTypeDef * const hdac, uint32_t Channel);
HAL_StatusTypeDef HAL_DAC_Stop(DAC_HandleTypeDef * const hdac, uint32_t Channel);
HAL_StatusTypeDef HAL_DAC_Start_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel, uint32_t const * const pData, uint32_t Length,
                                    uint32_t Alignment);
HAL_StatusTypeDef HAL_DAC_Stop_DMA(DAC_HandleTypeDef * const hdac, uint32_t Channel);
void HAL_DAC_IRQHandler(DAC_HandleTypeDef * const hdac);
HAL_StatusTypeDef HAL_DAC_SetValue(DAC_HandleTypeDef * const hdac, uint32_t Channel, uint32_t Alignment, uint32_t Data);

void HAL_DAC_ConvCpltCallbackCh1(DAC_HandleTypeDef * const hdac);
void HAL_DAC_ConvHalfCpltCallbackCh1(DAC_HandleTypeDef * const hdac);
void HAL_DAC_ErrorCallbackCh1(DAC_HandleTypeDef * const hdac);
void HAL_DAC_DMAUnderrunCallbackCh1(DAC_HandleTypeDef * const hdac);

#if (USE_HAL_DAC_REGISTER_CALLBACKS == 1U)
/* DAC callback registering/unregistering */
HAL_StatusTypeDef     HAL_DAC_RegisterCallback(DAC_HandleTypeDef * const hdac, HAL_DAC_CallbackIDTypeDef CallbackID,
                                               pDAC_CallbackTypeDef pCallback);
HAL_StatusTypeDef     HAL_DAC_UnRegisterCallback(DAC_HandleTypeDef * const hdac, HAL_DAC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_DAC_REGISTER_CALLBACKS */
...
uint32_t HAL_DAC_GetValue(DAC_HandleTypeDef const * const hdac, uint32_t Channel);
HAL_StatusTypeDef HAL_DAC_ConfigChannel(DAC_HandleTypeDef * const hdac,
                                        DAC_ChannelConfTypeDef const * const sConfig, uint32_t Channel);
/**
  * @}
  */
...
HAL_DAC_StateTypeDef HAL_DAC_GetState(DAC_HandleTypeDef const * const hdac);
uint32_t HAL_DAC_GetError(DAC_HandleTypeDef const * const hdac);
...
/** @defgroup DAC_Private_Functions DAC Private Functions
  * @{
  */
void DAC_DMAConvCpltCh1(DMA_HandleTypeDef * const hdma);
void DAC_DMAErrorCh1(DMA_HandleTypeDef * const hdma);
void DAC_DMAHalfConvCpltCh1(DMA_HandleTypeDef * const hdma);
/**
  * @}
  */
