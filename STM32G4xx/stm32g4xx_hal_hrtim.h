...
#if (USE_HAL_HRTIM_REGISTER_CALLBACKS == 1U)
...
#if (USE_HAL_HRTIM_REGISTER_CALLBACKS == 1U)
  void (* Fault1Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 1 interrupt callback function pointer                         */
  void (* Fault2Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 2 interrupt callback function pointer                         */
  void (* Fault3Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 3 interrupt callback function pointer                         */
  void (* Fault4Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 4 interrupt callback function pointer                         */
  void (* Fault5Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 5 interrupt callback function pointer                         */
  void (* Fault6Callback)(struct __HRTIM_HandleTypeDef * const hhrtim);                               /*!< Fault 6 interrupt callback function pointer                         */
  void (* SystemFaultCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                          /*!< System fault interrupt callback function pointer                    */
  void (* DLLCalibrationReadyCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                   /*!< DLL Ready interrupt callback function pointer                       */
  void (* BurstModePeriodCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                      /*!< Burst mode period interrupt callback function pointer               */
  void (* SynchronizationEventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                 /*!< Sync Input interrupt callback function pointer                      */
  void (* ErrorCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                                /*!< DMA error callback function pointer                                 */

  void (* RegistersUpdateCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);   /*!< Timer x Update interrupt callback function pointer                  */
  void (* RepetitionEventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);   /*!< Timer x Repetition interrupt callback function pointer              */
  void (* Compare1EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Compare 1 match interrupt callback function pointer         */
  void (* Compare2EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Compare 2 match interrupt callback function pointer         */
  void (* Compare3EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Compare 3 match interrupt callback function pointer         */
  void (* Compare4EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Compare 4 match interrupt callback function pointer         */
  void (* Capture1EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Capture 1 interrupts callback function pointer              */
  void (* Capture2EventCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);     /*!< Timer x Capture 2 interrupts callback function pointer              */
  void (* DelayedProtectionCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx); /*!< Timer x Delayed protection interrupt callback function pointer      */
  void (* CounterResetCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);      /*!< Timer x counter reset/roll-over interrupt callback function pointer */
  void (* Output1SetCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);        /*!< Timer x output 1 set interrupt callback function pointer            */
  void (* Output1ResetCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);      /*!< Timer x output 1 reset interrupt callback function pointer          */
  void (* Output2SetCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);        /*!< Timer x output 2 set interrupt callback function pointer            */
  void (* Output2ResetCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);      /*!< Timer x output 2 reset interrupt callback function pointer          */
  void (* BurstDMATransferCallback)(struct __HRTIM_HandleTypeDef * const hhrtim, uint32_t TimerIdx);  /*!< Timer x Burst DMA completed interrupt callback function pointer     */

  void (* MspInitCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                              /*!< HRTIM MspInit callback function pointer                             */
  void (* MspDeInitCallback)(struct __HRTIM_HandleTypeDef * const hhrtim);                            /*!< HRTIM MspInit callback function pointer                             */
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
} HRTIM_HandleTypeDef;
...
typedef struct
{
  ...
  uint32_t RepetitionCounter;        /*!< Specifies the timer repetition period.
                                          This parameter must be a number between Min_Data = 0x00U and Max_Data = 0xFFU. */
...
typedef struct
{
  uint32_t Value;     /*!< Holds the counter value when the capture event occurred.
                           This parameter can be a number between 0x0U and 0xFFFFU */
...
typedef struct
{
  ...
  uint32_t RisingValue;      /*!< Specifies the dead-time following a rising edge.
                                  This parameter can be a number between 0x0U and 0x1FFU */
...
typedef struct
{
  uint32_t Threshold;     /*!< Specifies the Fault counter Threshold.
                               This parameter can be a number between 0x0U and 0xFU  */
...
typedef struct
{
  ...
  uint32_t Period;         /*!< Specifies burst mode repetition period.
                                This parameter can be a number between 0x1U and 0xFFFFU  */
...
typedef struct
{
  ...
  uint32_t Counter;        /*!< Specifies the External Event Counter Threshold.
                                This parameter can be a number between 0x0U and 0x3FU  */
...
/**
  ...
  */
typedef void (* pHRTIM_CallbackTypeDef)(HRTIM_HandleTypeDef * const hhrtim);       /*!< HRTIM related callback function pointer         */

typedef void (* pHRTIM_TIMxCallbackTypeDef)(HRTIM_HandleTypeDef * const hhrtim,    /*!< HRTIM Timer x related callback function pointer */
                                            uint32_t TimerIdx);
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
...
/** @defgroup HRTIM_Compare_Unit HRTIM Compare Unit
  ...
  */
#define HRTIM_COMPAREUNIT_1 0x00000001UL  /*!< Compare unit 1 identifier */
#define HRTIM_COMPAREUNIT_2 0x00000002UL  /*!< Compare unit 2 identifier */
#define HRTIM_COMPAREUNIT_3 0x00000004UL  /*!< Compare unit 3 identifier */
#define HRTIM_COMPAREUNIT_4 0x00000008UL  /*!< Compare unit 4 identifier */
 /**
  * @}
  */
...
/** @defgroup HRTIM_Capture_Unit HRTIM Capture Unit
  ...
  */
#define HRTIM_CAPTUREUNIT_1 0x00000001UL  /*!< Capture unit 1 identifier */
#define HRTIM_CAPTUREUNIT_2 0x00000002UL  /*!< Capture unit 2 identifier */
/**
  * @}
  */
...
/** @defgroup HRTIM_Timer_Output HRTIM Timer Output
  ...
  */
#define HRTIM_OUTPUT_TA1  0x00000001UL  /*!< Timer A - Output 1 identifier */
#define HRTIM_OUTPUT_TA2  0x00000002UL  /*!< Timer A - Output 2 identifier */
#define HRTIM_OUTPUT_TB1  0x00000004UL  /*!< Timer B - Output 1 identifier */
#define HRTIM_OUTPUT_TB2  0x00000008UL  /*!< Timer B - Output 2 identifier */
#define HRTIM_OUTPUT_TC1  0x00000010UL  /*!< Timer C - Output 1 identifier */
#define HRTIM_OUTPUT_TC2  0x00000020UL  /*!< Timer C - Output 2 identifier */
#define HRTIM_OUTPUT_TD1  0x00000040UL  /*!< Timer D - Output 1 identifier */
#define HRTIM_OUTPUT_TD2  0x00000080UL  /*!< Timer D - Output 2 identifier */
#define HRTIM_OUTPUT_TE1  0x00000100UL  /*!< Timer E - Output 1 identifier */
#define HRTIM_OUTPUT_TE2  0x00000200UL  /*!< Timer E - Output 2 identifier */
#define HRTIM_OUTPUT_TF1  0x00000400UL  /*!< Timer F - Output 1 identifier */
#define HRTIM_OUTPUT_TF2  0x00000800UL  /*!< Timer F - Output 2 identifier */
/**
  * @}
  */
...
/** @defgroup HRTIM_ADC_Trigger HRTIM ADC Trigger
  ...
  */
#define HRTIM_ADCTRIGGER_1  0x00000001UL  /*!< ADC trigger 1 identifier */
#define HRTIM_ADCTRIGGER_2  0x00000002UL  /*!< ADC trigger 2 identifier */
#define HRTIM_ADCTRIGGER_3  0x00000004UL  /*!< ADC trigger 3 identifier */
#define HRTIM_ADCTRIGGER_4  0x00000008UL  /*!< ADC trigger 4 identifier */
/**
  * @}
  */
...
/** @defgroup HRTIM_ADC_Ext_Trigger HRTIM ADC Extended Trigger
  ...
  */
#define HRTIM_ADCTRIGGER_5  0x00000010UL  /*!< ADC trigger 5 identifier  */
#define HRTIM_ADCTRIGGER_6  0x00000020UL  /*!< ADC trigger 6 identifier  */
#define HRTIM_ADCTRIGGER_7  0x00000040UL  /*!< ADC trigger 7 identifier  */
#define HRTIM_ADCTRIGGER_8  0x00000080UL  /*!< ADC trigger 8 identifier  */
#define HRTIM_ADCTRIGGER_9  0x00000100UL  /*!< ADC trigger 9 identifier  */
#define HRTIM_ADCTRIGGER_10 0x00000200UL  /*!< ADC trigger 10 identifier */
...
/** @defgroup HRTIM_External_Event_Channels HRTIM External Event Channels
  ...
  */
#define HRTIM_EVENT_NONE    (0x00000000UL)     /*!< Undefined event channel */
#define HRTIM_EVENT_1       (0x00000001UL)     /*!< External event channel 1  identifier */
#define HRTIM_EVENT_2       (0x00000002UL)     /*!< External event channel 2  identifier */
#define HRTIM_EVENT_3       (0x00000003UL)     /*!< External event channel 3  identifier */
#define HRTIM_EVENT_4       (0x00000004UL)     /*!< External event channel 4  identifier */
#define HRTIM_EVENT_5       (0x00000005UL)     /*!< External event channel 5  identifier */
#define HRTIM_EVENT_6       (0x00000006UL)     /*!< External event channel 6  identifier */
#define HRTIM_EVENT_7       (0x00000007UL)     /*!< External event channel 7  identifier */
#define HRTIM_EVENT_8       (0x00000008UL)     /*!< External event channel 8  identifier */
#define HRTIM_EVENT_9       (0x00000009UL)     /*!< External event channel 9  identifier */
#define HRTIM_EVENT_10      (0x0000000AUL)     /*!< External event channel 10 identifier */
/**
  * @}
  */
...
/**
  ...
  */
#define HRTIM_PRESCALERRATIO_MUL32    (0x00000000UL)  /*!< fHRCK: fHRTIM x 32U = 4.608 GHz - Resolution: 217 ps - Min PWM frequency: 70.3 kHz (fHRTIM=144MHz) */
#define HRTIM_PRESCALERRATIO_MUL16    (0x00000001UL)  /*!< fHRCK: fHRTIM x 16U = 2.304 GHz - Resolution: 434 ps - Min PWM frequency: 35.1 KHz (fHRTIM=144MHz) */
#define HRTIM_PRESCALERRATIO_MUL8     (0x00000002UL)  /*!< fHRCK: fHRTIM x 8U = 1.152 GHz - Resolution: 868 ps - Min PWM frequency: 17.6 kHz (fHRTIM=144MHz)  */
#define HRTIM_PRESCALERRATIO_MUL4     (0x00000003UL)  /*!< fHRCK: fHRTIM x 4U = 576 MHz - Resolution: 1.73 ns - Min PWM frequency: 8.8 kHz (fHRTIM=144MHz)    */
#define HRTIM_PRESCALERRATIO_MUL2     (0x00000004UL)  /*!< fHRCK: fHRTIM x 2U = 288 MHz - Resolution: 3.47 ns - Min PWM frequency: 4.4 kHz (fHRTIM=144MHz)    */
#define HRTIM_PRESCALERRATIO_DIV1     (0x00000005UL)  /*!< fHRCK: fHRTIM = 144 MHz - Resolution: 6.95 ns - Min PWM frequency: 2.2 kHz (fHRTIM=144MHz)         */
#define HRTIM_PRESCALERRATIO_DIV2     (0x00000006UL)  /*!< fHRCK: fHRTIM / 2U = 72 MHz - Resolution: 13.88 ns- Min PWM frequency: 1.1 kHz (fHRTIM=144MHz)     */
#define HRTIM_PRESCALERRATIO_DIV4     (0x00000007UL)  /*!< fHRCK: fHRTIM / 4U = 36 MHz - Resolution: 27.7 ns- Min PWM frequency: 550Hz (fHRTIM=144MHz)        */
/**
  * @}
  */
...
/** @defgroup HRTIM_Counter_Operating_Mode HRTIM Counter Operating Mode
  ...
  */
#define HRTIM_MODE_CONTINUOUS               (0x00000008UL)  /*!< The timer operates in continuous (free-running) mode */
#define HRTIM_MODE_SINGLESHOT               (0x00000000UL)  /*!< The timer operates in non retriggerable single-shot mode */
#define HRTIM_MODE_SINGLESHOT_RETRIGGERABLE (0x00000010UL)  /*!< The timer operates in retriggerable single-shot mode */
/**
  * @}
  */
...
/** @defgroup HRTIM_Half_Mode_Enable HRTIM Half Mode Enable
  ...
  */
#define HRTIM_HALFMODE_DISABLED (0x00000000UL)  /*!< Half mode is disabled */
#define HRTIM_HALFMODE_ENABLED  (0x00000020UL)  /*!< Half mode is enabled */
/**
  * @}
  */
...
/** @defgroup HRTIM_Start_On_Sync_Input_Event HRTIM Start On Sync Input Event
  ...
  */
#define HRTIM_SYNCSTART_DISABLED (0x00000000UL)           /*!< Synchronization input event has effect on the timer */
...
/** @defgroup HRTIM_Reset_On_Sync_Input_Event HRTIM Reset On Sync Input Event
  ...
  * @brief Constants defining the timer behavior following the synchronization event
  */
#define HRTIM_SYNCRESET_DISABLED (0x00000000UL)           /*!< Synchronization input event has effect on the timer */
...
/** @defgroup HRTIM_DAC_Synchronization HRTIM DAC Synchronization
  ...
  */
#define HRTIM_DACSYNC_NONE          0x00000000UL                                 /*!< No DAC synchronization event generated */
...
/** @defgroup HRTIM_Register_Preload_Enable HRTIM Register Preload Enable
  ...
  */
#define HRTIM_PRELOAD_DISABLED (0x00000000UL)           /*!< Preload disabled: the write access is directly done into the active register */
...
/** @defgroup HRTIM_Update_Gating HRTIM Update Gating
  ...
  */
#define HRTIM_UPDATEGATING_INDEPENDENT     0x00000000UL                                                           /*!< Update done independently from the DMA burst transfer completion */
...
/** @defgroup HRTIM_Timer_Burst_Mode HRTIM Timer Burst Mode
  ...
  * @brief Constants defining how the timer behaves during a burst
            mode operation.
  */
#define HRTIM_TIMERBURSTMODE_MAINTAINCLOCK 0x00000000UL           /*!< Timer counter clock is maintained and the timer operates normally */
...
/** @defgroup HRTIM_Timer_UpDown_Mode HRTIM Timer UpDown Mode
  ...
  */
#define HRTIM_TIMERUPDOWNMODE_UP           0x00000000UL           /*!< Timer counter is operating in up-counting mode */
#define HRTIM_TIMERUPDOWNMODE_UPDOWN       0x00000001UL           /*!< Timer counter is operating in up-down counting mode */
/**
  * @}
  */
...
/** @defgroup HRTIM_Timer_TrigHalf_Mode HRTIM Timer Triggered-Half Mode
  ...
  * @brief Constants defining how the timer counter operates
  */
#define HRTIM_TIMERTRIGHALF_DISABLED       0x00000000UL           /*!< Timer Compare 2 register is behaving in standard mode */
...
/** @defgroup HRTIM_Timer_GreaterCMP3_Mode HRTIM Timer Greater than Compare 3 PWM Mode
  ...
  */
#define HRTIM_TIMERGTCMP3_EQUAL            0x00000000UL           /*!< Timer Compare 3 event is generated when counter is equal */
...
/** @defgroup HRTIM_Timer_GreaterCMP1_Mode HRTIM Timer Greater than Compare 1 PWM Mode
  ...
  * @brief Constants defining how the timer compare operates
  */
#define HRTIM_TIMERGTCMP1_EQUAL            0x00000000UL           /*!< Timer Compare 1 event is generated when counter is equal */
...
/** @defgroup HRTIM_Timer_DualChannelDac_Reset HRTIM Dual Channel Dac Reset Trigger
  ...
  */
#define HRTIM_TIMER_DCDR_COUNTER           0x00000000UL           /*!< the trigger is generated on counter reset or roll-over event */
...
/** @defgroup HRTIM_Timer_DualChannelDac_Step HRTIM Dual Channel Dac Step Trigger
 ...
 is generated
  */
#define HRTIM_TIMER_DCDS_CMP2              0x00000000UL           /*!< the trigger is generated on compare 2 event */
...
/** @defgroup HRTIM_Timer_DualChannelDac_Enable HRTIM Dual Channel DAC Trigger Enable
  ...
  */
#define HRTIM_TIMER_DCDE_DISABLED          0x00000000UL           /*!< the Dual channel DAC trigger is disabled */
...
/** @defgroup HRTIM_Timer_Repetition_Update HRTIM Timer Repetition Update
  ...
  *        reset events)
  */
#define HRTIM_UPDATEONREPETITION_DISABLED  0x00000000UL           /*!< Update on repetition disabled */
...
/** @defgroup HRTIM_Timer_Push_Pull_Mode HRTIM Timer Push Pull Mode
  ...
  *        a timer.
  */
#define HRTIM_TIMPUSHPULLMODE_DISABLED     0x00000000UL           /*!< Push-Pull mode disabled */
...
/** @defgroup HRTIM_Timer_Fault_Enabling HRTIM Timer Fault Enabling
  ...
  */
#define HRTIM_TIMFAULTENABLE_NONE     0x00000000UL           /*!< No fault enabled */
...
/** @defgroup HRTIM_Timer_Fault_Lock HRTIM Timer Fault Lock
  ...
  */
#define HRTIM_TIMFAULTLOCK_READWRITE (0x00000000UL)           /*!< Timer fault enabling bits are read/write */
...
/** @defgroup HRTIM_Timer_Deadtime_Insertion HRTIM Timer Dead-time Insertion
  ...
  */
#define HRTIM_TIMDEADTIMEINSERTION_DISABLED   (0x00000000UL)           /*!< Output 1 and output 2 signals are independent */
...
/** @defgroup HRTIM_Timer_Delayed_Protection_Mode HRTIM Timer Delayed Protection Mode
  ...
  */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DISABLED          (0x00000000UL)                                                                           /*!< No action */
...
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DISABLED            (0x00000000UL)                                                                             /*!< No action */
...
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DISABLED              (0x00000000UL)                                                                             /*!< No action */
...
/** @defgroup HRTIM_Timer_Update_Trigger HRTIM Timer Update Trigger
  ...
  */
#define HRTIM_TIMUPDATETRIGGER_NONE     0x00000000UL          /*!< Register update is disabled */
...
/** @defgroup HRTIM_Timer_Reset_Trigger HRTIM Timer Reset Trigger
  ...
  */
#define HRTIM_TIMRESETTRIGGER_NONE        0x00000000UL            /*!< No counter reset trigger */
...
/** @defgroup HRTIM_Timer_Reset_Update HRTIM Timer Reset Update
  ...
  *        in continuous mode
  */
#define HRTIM_TIMUPDATEONRESET_DISABLED 0x00000000UL           /*!< Update by timer x reset / roll-over disabled */
...
/** @defgroup HRTIM_Timer_RollOver_Mode HRTIM Timer RollOver Mode
  ...
  */
#define HRTIM_TIM_FEROM_BOTH      0x00000000UL              /*!< Roll-over event used by  */
...
#define HRTIM_TIM_BMROM_BOTH      0x00000000UL              /*!< Roll-over event used in the Burst mode controller */
...
#define HRTIM_TIM_ADROM_BOTH      0x00000000UL              /*!< Roll-over event which triggers */
#define HRTIM_TIM_ADROM_CREST     (HRTIM_TIMCR2_ADROM_1)   /*!< the */
#define HRTIM_TIM_ADROM_VALLEY    (HRTIM_TIMCR2_ADROM_0)   /*!< ADC */
#define HRTIM_TIM_OUTROM_BOTH     0x00000000UL              /*!< Roll-over event which sets and/or resets the outputs */
...
#define HRTIM_TIM_ROM_BOTH        0x00000000UL              /*!< Roll-over event with the following destinations: IRQ and DMA requests,*/
...
/** @defgroup HRTIM_Compare_Unit_Auto_Delayed_Mode HRTIM Compare Unit Auto Delayed Mode
  ...
  */
#define HRTIM_AUTODELAYEDMODE_REGULAR                 (0x00000000UL)                                   /*!< standard compare mode */
...
/** @defgroup HRTIM_Simple_OC_Mode HRTIM Simple OC Mode
  ...
  */
#define HRTIM_BASICOCMODE_TOGGLE    (0x00000001UL)  /*!< Output toggles when the timer counter reaches the compare value */
#define HRTIM_BASICOCMODE_INACTIVE  (0x00000002UL)  /*!< Output forced to active level when the timer counter reaches the compare value */
#define HRTIM_BASICOCMODE_ACTIVE    (0x00000003UL)  /*!< Output forced to inactive level when the timer counter reaches the compare value */
...
/** @defgroup HRTIM_Output_Polarity HRTIM Output Polarity
  ...
  */
#define HRTIM_OUTPUTPOLARITY_HIGH    (0x00000000UL)           /*!< Output is active HIGH */
...
/** @defgroup HRTIM_Output_Set_Source HRTIM Output Set Source
  ...
  */
#define HRTIM_OUTPUTSET_NONE       0x00000000UL                      /*!< Reset the output set crossbar */
...
/** @defgroup HRTIM_Output_Reset_Source HRTIM Output Reset Source
  ...
  */
#define HRTIM_OUTPUTRESET_NONE       0x00000000UL                      /*!< Reset the output reset crossbar */
...
/** @defgroup HRTIM_Output_Idle_Mode HRTIM Output Idle Mode
  ...
  */
#define HRTIM_OUTPUTIDLEMODE_NONE     0x00000000UL           /*!< The output is not affected by the burst mode operation */
...
/** @defgroup HRTIM_Output_IDLE_Level HRTIM Output IDLE Level
  ...
  */
#define HRTIM_OUTPUTIDLELEVEL_INACTIVE   0x00000000UL           /*!< Output at inactive level when in IDLE state */
...
/** @defgroup HRTIM_Output_FAULT_Level HRTIM Output FAULT Level
  ...
  */
#define HRTIM_OUTPUTFAULTLEVEL_NONE      0x00000000UL                                  /*!< The output is not affected by the fault input */
...
/** @defgroup HRTIM_Output_Chopper_Mode_Enable HRTIM Output Chopper Mode Enable
  ...
  * @brief Constants defining whether or not chopper mode is enabled for a timer
           output
  */
#define HRTIM_OUTPUTCHOPPERMODE_DISABLED   0x00000000UL           /*!< Output signal is not altered  */
...
/** @defgroup HRTIM_Output_Burst_Mode_Entry_Delayed HRTIM Output Burst Mode Entry Delayed
  ...
  */
#define HRTIM_OUTPUTBURSTMODEENTRY_REGULAR   0x00000000UL           /*!< The programmed Idle state is applied immediately to the Output */
...
/** @defgroup HRTIM_Output_Balanced_Idle_Auto_Resume HRTIM Output Balanced Idle Automatic Resume
  ...
  */
#define HRTIM_OUTPUTBIAR_DISABLED   0x00000000UL            /*!< output is not automatically re-enabled */
...
/** @defgroup HRTIM_Capture_Unit_Trigger HRTIM Capture Unit Trigger
  ...
  */
#define HRTIM_CAPTURETRIGGER_NONE         0x00000000UL              /*!< Capture trigger is disabled */
...
/** @defgroup HRTIM_Capture_Unit_TimerF_Trigger HRTIM Capture Unit TimerF Trigger
  ...
  *        capture of the timing unit counter
  */
#define HRTIM_CAPTURETRIGGER_TF1_SET       ((uint64_t)(HRTIM_CPT1CR_TF1SET  ) << 32U)  /*!< Capture is triggered by TF1 output inactive to active transition */
#define HRTIM_CAPTURETRIGGER_TF1_RESET     ((uint64_t)(HRTIM_CPT1CR_TF1RST  ) << 32U)  /*!< Capture is triggered by TF1 output active to inactive transition */
#define HRTIM_CAPTURETRIGGER_TIMERF_CMP1   ((uint64_t)(HRTIM_CPT1CR_TIMFCMP1) << 32U)  /*!< Timer F Compare 1 triggers Capture */
#define HRTIM_CAPTURETRIGGER_TIMERF_CMP2   ((uint64_t)(HRTIM_CPT1CR_TIMFCMP2) << 32U)  /*!< Timer F Compare 2 triggers Capture */
/**
  * @}
  */
...
/** @defgroup HRTIM_Timer_External_Event_Filter HRTIM Timer External Event Filter
  ...
  *        by a timer
  */
#define HRTIM_TIMEEVFLT_NONE                            (0x00000000UL)
...
/** @defgroup HRTIM_Timer_External_Event_Latch HRTIM Timer External Event Latch
  ...
  */
#define HRTIM_TIMEVENTLATCH_DISABLED    (0x00000000UL)           /*!< Event is ignored if it happens during a blank, or passed through during a window */
...
/** @defgroup HRTIM_Timer_External_Event_ResetMode HRTIM Timer External Counter Reset Mode
  ...
  */
#define HRTIM_EVENTCOUNTER_RSTMODE_UNCONDITIONAL   (0x00000000UL)   /*!< External Event Counter is reset on each reset / roll-over event */
#define HRTIM_EVENTCOUNTER_RSTMODE_CONDITIONAL     (0x00000001UL)   /*!< External Event Counter is reset on each reset / roll-over event only
...
/** @defgroup HRTIM_Timer_ReSyncUpdate HRTIM Timer Re-Synchronized update
  ...
  */
#define HRTIM_TIMERESYNC_UPDATE_UNCONDITIONAL   (0x00000000UL)   /*!< update taken into account immediately */
#define HRTIM_TIMERESYNC_UPDATE_CONDITIONAL     (0x00000001UL)   /*!< update taken into account on the following Reset/Roll-over event */
/**
  * @}
  */
...
/** @defgroup HRTIM_Deadtime_Prescaler_Ratio HRTIM Dead-time Prescaler Ratio
  ...
  */
#define HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL8    (0x00000000UL)                                                   /*!< fDTG = fHRTIM * 8U */
...
/** @defgroup HRTIM_Deadtime_Rising_Sign HRTIM Dead-time Rising Sign
  ...
  */
#define HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE    (0x00000000UL)           /*!< Positive dead-time on rising edge */
...
/** @defgroup HRTIM_Deadtime_Rising_Lock HRTIM Dead-time Rising Lock
  ...
  */
#define HRTIM_TIMDEADTIME_RISINGLOCK_WRITE    (0x00000000UL)           /*!< Dead-time rising value and sign is writeable */
...
/** @defgroup HRTIM_Deadtime_Rising_Sign_Lock HRTIM Dead-time Rising Sign Lock
  ...
  *        protected
  */
#define HRTIM_TIMDEADTIME_RISINGSIGNLOCK_WRITE    (0x00000000UL)           /*!< Dead-time rising sign is writeable */
...
/** @defgroup HRTIM_Deadtime_Falling_Sign HRTIM Dead-time Falling Sign
  ...
  */
#define HRTIM_TIMDEADTIME_FALLINGSIGN_POSITIVE    (0x00000000UL)           /*!< Positive dead-time on falling edge */
...
/** @defgroup HRTIM_Deadtime_Falling_Lock HRTIM Dead-time Falling Lock
  ...
  *        value) is write protected
  */
#define HRTIM_TIMDEADTIME_FALLINGLOCK_WRITE    (0x00000000UL)           /*!< Dead-time falling value and sign is writeable */
...
/** @defgroup HRTIM_Deadtime_Falling_Sign_Lock HRTIM Dead-time Falling Sign Lock
  ...
  *        protected
  */
#define HRTIM_TIMDEADTIME_FALLINGSIGNLOCK_WRITE    (0x00000000UL)           /*!< Dead-time falling sign is writeable */
...
/** @defgroup HRTIM_Chopper_Frequency HRTIM Chopper Frequency
  ...
  */
#define HRTIM_CHOPPER_PRESCALERRATIO_DIV16  (0x000000UL)                                                                     /*!< fCHPFRQ = fHRTIM / 16  */
...
/** @defgroup HRTIM_Chopper_Duty_Cycle HRTIM Chopper Duty Cycle
  ...
  */
#define HRTIM_CHOPPER_DUTYCYCLE_0    (0x000000UL)                                                       /*!< Only 1st pulse is present */
...
/** @defgroup HRTIM_Chopper_Start_Pulse_Width HRTIM Chopper Start Pulse Width
  ...
  */
#define HRTIM_CHOPPER_PULSEWIDTH_16   (0x000000UL)                                                                          /*!< tSTPW = tHRTIM x 16  */
...
/** @defgroup HRTIM_Synchronization_Options HRTIM Synchronization Options
  ...
  */
#define HRTIM_SYNCOPTION_NONE   0x00000000UL   /*!< HRTIM instance doesn't handle external synchronization signals (SYNCIN, SYNCOUT) */
#define HRTIM_SYNCOPTION_MASTER 0x00000001UL   /*!< HRTIM instance acts as a MASTER, i.e. generates external synchronization output (SYNCOUT)*/
#define HRTIM_SYNCOPTION_SLAVE  0x00000002UL   /*!< HRTIM instance acts as a SLAVE, i.e. it is synchronized by external sources (SYNCIN) */
/**
  * @}
  */
...
/** @defgroup HRTIM_Synchronization_Input_Source HRTIM Synchronization Input Source
  ...
  */
#define HRTIM_SYNCINPUTSOURCE_NONE           0x00000000UL                                  /*!< disabled. HRTIM is not synchronized and runs in standalone mode */
...
/** @defgroup HRTIM_Synchronization_Output_Source HRTIM Synchronization Output Source
  ...
  */
#define HRTIM_SYNCOUTPUTSOURCE_MASTER_START 0x00000000UL                                    /*!< A pulse is sent on HRTIM_SCOUT output and hrtim_out_sync2 upon master timer start event      */
...
/** @defgroup HRTIM_Synchronization_Output_Polarity HRTIM Synchronization Output Polarity
  ...
  */
#define HRTIM_SYNCOUTPUTPOLARITY_NONE      0x00000000UL                                   /*!< Synchronization output event is disabled */
...
/** @defgroup HRTIM_External_Event_Sources HRTIM External Event Sources
  ...
  */
#define HRTIM_EEV1SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 1 */
#define HRTIM_EEV2SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 2 */
#define HRTIM_EEV3SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 3 */
#define HRTIM_EEV4SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 4 */
#define HRTIM_EEV5SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 5 */
#define HRTIM_EEV6SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 6 */
#define HRTIM_EEV7SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 7 */
#define HRTIM_EEV8SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 8 */
#define HRTIM_EEV9SRC_GPIO        0x00000000UL                                   /*!< External event source 1U for External Event 9 */
#define HRTIM_EEV10SRC_GPIO       0x00000000UL                                   /*!< External event source 1U for External Event 10 */
...
/** @defgroup HRTIM_External_Event_Polarity HRTIM External Event Polarity
  ...
  */
#define HRTIM_EVENTPOLARITY_HIGH    (0x00000000UL)           /*!< External event is active high */
...
/** @defgroup HRTIM_External_Event_Sensitivity HRTIM External Event Sensitivity
  ...
  */
#define HRTIM_EVENTSENSITIVITY_LEVEL          (0x00000000UL)                                  /*!< External event is active on level */
...
/** @defgroup HRTIM_External_Event_Fast_Mode HRTIM External Event Fast Mode
  ...
  * @brief Constants defining whether or not an external event is programmed in
           fast mode
  */
#define HRTIM_EVENTFASTMODE_DISABLE    (0x00000000UL)               /*!< External Event is re-synchronized by the HRTIM logic before acting on outputs */
...
/** @defgroup HRTIM_External_Event_Filter HRTIM External Event Filter
  ...
  */
#define HRTIM_EVENTFILTER_NONE      (0x00000000UL)                                                                         /*!< Filter disabled */
...
/** @defgroup HRTIM_External_Event_Prescaler HRTIM External Event Prescaler
  ...
  */
#define HRTIM_EVENTPRESCALER_DIV1    (0x00000000UL)                                   /*!< fEEVS=fHRTIM */
...
/** @defgroup HRTIM_Fault_Sources HRTIM Fault Sources
  ...
  */
#define HRTIM_FAULTSOURCE_DIGITALINPUT      (0x00000000UL)              /*!< Fault input is FLT input pin */
#define HRTIM_FAULTSOURCE_INTERNAL          (0x00000001UL)              /*!< Fault input is FLT_Int signal (e.g. internal comparator) */
#define HRTIM_FAULTSOURCE_EEVINPUT          (0x00000002UL)              /*!< Fault input is EEV pin */
/**
  * @}
  */
...
/** @defgroup HRTIM_Fault_Polarity HRTIM Fault Polarity
  ...
  */
#define HRTIM_FAULTPOLARITY_LOW     (0x00000000UL)            /*!< Fault input is active low */
...
/** @defgroup HRTIM_Fault_Blanking HRTIM Fault Blanking Source
  ...
  */
#define HRTIM_FAULTBLANKINGMODE_RSTALIGNED  (0x00000000UL)     /*!< Fault blanking source is Reset-aligned window */
#define HRTIM_FAULTBLANKINGMODE_MOVING      (0x00000001UL)     /*!< Fault blanking source is Moving window */
/**
  * @}
  */
...
/** @defgroup HRTIM_Fault_ResetMode HRTIM Fault Reset Mode
  ...
  */
#define HRTIM_FAULTCOUNTERRST_UNCONDITIONAL  (0x00000000UL)       /*!< Fault counter is reset on each reset / roll-over event */
#define HRTIM_FAULTCOUNTERRST_CONDITIONAL    (0x00000001UL)       /*!< Fault counter is reset on each reset / roll-over event only if no fault occurred during last countingperiod.*/
/**
  * @}
  */
...
/** @defgroup HRTIM_Fault_Blanking_Control  HRTIM Fault Blanking Control
  ...
  */
#define HRTIM_FAULTBLANKINGCTL_DISABLED 0x00000000UL /*!< No blanking on Fault */
#define HRTIM_FAULTBLANKINGCTL_ENABLED  0x00000001UL /*!< Fault blanking mode */
/**
  * @}
  */
...
/** @defgroup HRTIM_Fault_Filter HRTIM Fault Filter
  ...
  */
#define HRTIM_FAULTFILTER_NONE      (0x00000000UL)                                                                                    /*!< Filter disabled */
...
/** @defgroup HRTIM_Fault_Lock HRTIM Fault Lock
  ...
  * @brief Constants defining whether or not the fault programming bits are
           write protected
  */
#define HRTIM_FAULTLOCK_READWRITE       (0x00000000UL)               /*!< Fault settings bits are read/write */
...
/** @defgroup HRTIM_External_Fault_Prescaler HRTIM External Fault Prescaler
  ...
  */
#define HRTIM_FAULTPRESCALER_DIV1    (0x00000000UL)                                     /*!< fFLTS=fHRTIM */
...
/** @defgroup HRTIM_Burst_Mode_Operating_Mode HRTIM Burst Mode Operating Mode
  ...
  */
#define HRTIM_BURSTMODE_SINGLESHOT (0x00000000UL)           /*!< Burst mode operates in single shot mode */
...
/** @defgroup HRTIM_Burst_Mode_Clock_Source HRTIM Burst Mode Clock Source
  ...
  */
#define HRTIM_BURSTMODECLOCKSOURCE_MASTER     (0x00000000UL)                                                   /*!< Master timer counter reset/roll-over is used as clock source for the burst mode counter */
...
#define HRTIM_BURSTMODECLOCKSOURCE_TIM16_OC   (HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_1)                       /*!< On-chip Event 1 (BMClk[1U]), acting as a burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_TIM17_OC   (HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_1 | HRTIM_BMCR_BMCLK_0)  /*!< On-chip Event 2 (BMClk[2U]), acting as a burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_TIM7_TRGO  (HRTIM_BMCR_BMCLK_3)                                            /*!< On-chip Event 3 (BMClk[3U]), acting as a burst mode counter clock */
...
/** @defgroup HRTIM_Burst_Mode_Prescaler HRTIM Burst Mode Prescaler
  ...
  */
#define HRTIM_BURSTMODEPRESCALER_DIV1     (0x00000000UL)                                                                           /*!< fBRST = fHRTIM */
...
#define HRTIM_BURSTMODEPRESCALER_DIV32768 (HRTIM_BMCR_BMPRSC_3 | HRTIM_BMCR_BMPRSC_2 | HRTIM_BMCR_BMPRSC_1 | HRTIM_BMCR_BMPRSC_0) /*!< fBRST = fHRTIM/32768UL */
/**
  * @}
  */
...
/** @defgroup HRTIM_Burst_Mode_Register_Preload_Enable HRTIM Burst Mode Register Preload Enable
  ...
  */
#define HRIM_BURSTMODEPRELOAD_DISABLED (0x00000000UL)  /*!< Preload disabled: the write access is directly done into active registers */
...
/** @defgroup HRTIM_Burst_Mode_Trigger HRTIM Burst Mode Trigger
  ...
  *        mode operation
  */
#define HRTIM_BURSTMODETRIGGER_NONE               0x00000000UL             /*!<  No trigger */
...
/** @defgroup HRTIM_ADC_Trigger_Update_Source HRTIM ADC Trigger Update Source
  ...
  */
#define HRTIM_ADCTRIGGERUPDATE_MASTER  0x00000000UL                                   /*!< Master timer */
...
/** @defgroup HRTIM_ADC_Trigger_Event HRTIM ADC Trigger Event
  ...
  */
#define HRTIM_ADCTRIGGEREVENT13_NONE           0x00000000UL              /*!< No ADC trigger event */
...
#define HRTIM_ADCTRIGGEREVENT24_NONE           0x00000000UL               /*!< No ADC trigger event */
...
/** @defgroup HRTIM_DLL_Calibration_Rate HRTIM DLL Calibration Rate
  ...
  */
#define HRTIM_SINGLE_CALIBRATION    0xFFFFFFFFUL                                    /*!< Non periodic DLL calibration */
#define HRTIM_CALIBRATIONRATE_0     0x00000000UL                                    /*!< Periodic DLL calibration: T = 1048576U * tHRTIM (6.168 ms) */
...
/** @defgroup HRTIM_Burst_DMA_Registers_Update HRTIM Burst DMA Registers Update
  ...
  *        DMA operation
  */
#define HRTIM_BURSTDMA_NONE  0x00000000UL               /*!< No register is updated by Burst DMA accesses */
...
/** @defgroup HRTIM_Burst_Mode_Control HRTIM Burst Mode Control
  ...
  */
#define HRTIM_BURSTMODECTL_DISABLED 0x00000000UL          /*!< Burst mode disabled */
...
/** @defgroup HRTIM_Fault_Mode_Control  HRTIM Fault Mode Control
  ...
  */
#define HRTIM_FAULTMODECTL_DISABLED 0x00000000UL /*!< Fault channel is disabled */
#define HRTIM_FAULTMODECTL_ENABLED  0x00000001UL /*!< Fault channel is  enabled */
/**
  * @}
  */
...
/** @defgroup HRTIM_Output_Level HRTIM Output Level
  ...
  */
#define HRTIM_OUTPUTLEVEL_ACTIVE     (0x00000001UL) /*!< Force the output to its active state */
#define HRTIM_OUTPUTLEVEL_INACTIVE   (0x00000002UL) /*!< Force the output to its inactive state */
...
/** @defgroup HRTIM_Output_State HRTIM Output State
  ...
  */
#define HRTIM_OUTPUTSTATE_IDLE     (0x00000001UL)  /*!< Main operating mode, where the output can take the active or
                                                              inactive level as programmed in the crossbar unit */
#define HRTIM_OUTPUTSTATE_RUN      (0x00000002UL)  /*!< Default operating state (e.g. after an HRTIM reset, when the
                                                              outputs are disabled by software or during a burst mode operation */
#define HRTIM_OUTPUTSTATE_FAULT    (0x00000003UL)  /*!< Safety state, entered in case of a shut-down request on
                                                              FAULTx inputs */
/**
  * @}
  */
...
/** @defgroup HRTIM_Burst_Mode_Status HRTIM Burst Mode Status
  ...
  */
#define HRTIM_BURSTMODESTATUS_NORMAL   0x00000000UL          /*!< Normal operation */
...
/** @defgroup HRTIM_Current_Push_Pull_Status HRTIM Current Push Pull Status
  ...
  *        in push-pull mode
  */
#define HRTIM_PUSHPULL_CURRENTSTATUS_OUTPUT1    0x00000000UL            /*!< Signal applied on output 1 and output 2 forced inactive */
...
/** @defgroup HRTIM_Idle_Push_Pull_Status HRTIM Idle Push Pull Status
  ...
  */
#define HRTIM_PUSHPULL_IDLESTATUS_OUTPUT1    0x00000000UL               /*!< Protection occurred when the output 1 was active and output 2 forced inactive */
...
/** @defgroup HRTIM_Common_Interrupt_Enable HRTIM Common Interrupt Enable
  * @{
  */
#define HRTIM_IT_NONE           0x00000000UL           /*!< No interrupt enabled */
...
/** @defgroup HRTIM_Master_Interrupt_Enable HRTIM Master Interrupt Enable
  * @{
  */
#define HRTIM_MASTER_IT_NONE         0x00000000UL           /*!< No interrupt enabled */
...
/** @defgroup HRTIM_Timing_Unit_Interrupt_Enable HRTIM Timing Unit Interrupt Enable
  * @{
  */
#define HRTIM_TIM_IT_NONE       0x00000000UL               /*!< No interrupt enabled */
...
/** @defgroup HRTIM_Master_DMA_Request_Enable HRTIM Master DMA Request Enable
  * @{
  */
#define HRTIM_MASTER_DMA_NONE         0x00000000UL            /*!< No DMA request enable */
...
/** @defgroup HRTIM_Timing_Unit_DMA_Request_Enable HRTIM Timing Unit DMA Request Enable
  * @{
  */
#define HRTIM_TIM_DMA_NONE       0x00000000UL               /*!< No DMA request enable */
...
/** @addtogroup HRTIM_Private_Constants
  * @{
  */
#define HRTIM_CAPTUREFTRIGGER_NONE         0x00000000UL                  /*!< 32bit value Capture trigger is disabled */
...
#define IS_HRTIM_TIMERID(TIMERID) (((TIMERID) & 0xFF80FFFFUL) == 0x00000000UL)
...
#define IS_HRTIM_OUTPUT(OUTPUT) (((OUTPUT) & 0xFFFFF000UL) == 0x00000000UL)
...
#define IS_HRTIM_TIMFAULTENABLE(TIMFAULTENABLE) (((TIMFAULTENABLE) & 0xFFFFFFC0UL) == 0x00000000UL)
...
#define IS_HRTIM_TIMUPDATETRIGGER(TIMUPDATETRIGGER) (((TIMUPDATETRIGGER) & 0xFE06FFFFUL) == 0x00000000UL)

#define IS_HRTIM_TIMRESETTRIGGER(TIMRESETTRIGGER) (((TIMRESETTRIGGER) & 0x00000000UL) == 0x00000000UL)
...
#define IS_HRTIM_OUTPUTPULSE(OUTPUTPULSE) ((OUTPUTPULSE) <= 0x0000FFFFUL)
...
#define IS_HRTIM_TIMER_BURSTDMA(TIMER, BURSTDMA)                                            \
    ((((TIMER) == HRTIM_TIMERINDEX_MASTER)  && (((BURSTDMA) & 0xFFFFC000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)) \
  || (((TIMER) == HRTIM_TIMERINDEX_TIMER_F) && (((BURSTDMA) & 0xFF800000UL) == 0x00000000UL)))

#define IS_HRTIM_BURSTMODECTL(BURSTMODECTL) \
    (((BURSTMODECTL) == HRTIM_BURSTMODECTL_DISABLED)  || \
     ((BURSTMODECTL) == HRTIM_BURSTMODECTL_ENABLED))

#define IS_HRTIM_TIMERUPDATE(TIMERUPDATE) (((TIMERUPDATE) & 0xFFFFFF80UL) == 0x00000000UL)

#define IS_HRTIM_TIMERRESET(TIMERRESET) (((TIMERRESET) & 0xFFFF80FFUL) == 0x00000000UL)

#define IS_HRTIM_TIMERSWAP(TIMERSWAP) (((TIMERSWAP) & 0xFFC0FFFFUL) == 0x00000000UL)

#define IS_HRTIM_IT(IT) (((IT) & 0xFFFCFF80UL) == 0x00000000UL)

#define IS_HRTIM_MASTER_IT(MASTER_IT) (((MASTER_IT) & 0xFFFFFF80UL) == 0x00000000UL)


#define IS_HRTIM_TIM_IT(TIM_IT) (((TIM_IT) & 0xFFFF8020UL) == 0x00000000UL)


#define IS_HRTIM_MASTER_DMA(MASTER_DMA) (((MASTER_DMA) & 0xFF80FFFFUL) == 0x00000000UL)

#define IS_HRTIM_TIM_DMA(TIM_DMA) (((TIM_DMA) & 0x8020FFFFUL) == 0x00000000UL)
/**
  * @}
  */
...
/** @brief  Sets the HRTIM timer Counter Register value on runtime
  ...
  *                   This parameter can be one of the following values:
  *                   @arg 0x6U for master timer
  *                   @arg 0x0U to 0x5U for timers A to F
...
HAL_StatusTypeDef HAL_HRTIM_Init(HRTIM_HandleTypeDef * const hhrtim);

HAL_StatusTypeDef HAL_HRTIM_DeInit (HRTIM_HandleTypeDef * const hhrtim);

void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef * const hhrtim);

void HAL_HRTIM_MspDeInit(HRTIM_HandleTypeDef * const hhrtim);

HAL_StatusTypeDef HAL_HRTIM_TimeBaseConfig(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx,
                                           HRTIM_TimeBaseCfgTypeDef const * const pTimeBaseCfg);

HAL_StatusTypeDef HAL_HRTIM_DLLCalibrationStart(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t CalibrationRate);

HAL_StatusTypeDef HAL_HRTIM_DLLCalibrationStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                   uint32_t CalibrationRate);

HAL_StatusTypeDef HAL_HRTIM_PollForDLLCalibration(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t Timeout);
...
HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStart(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx);

HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStop(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t TimerIdx);

HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx);

HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx);

HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStart_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t TimerIdx,
                                               uint32_t SrcAddr,
                                               uint32_t DestAddr,
                                               uint32_t Length);

HAL_StatusTypeDef HAL_HRTIM_SimpleBaseStop_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx);
...
HAL_StatusTypeDef HAL_HRTIM_SimpleOCChannelConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t TimerIdx,
                                                 uint32_t OCChannel,
                                                 HRTIM_SimpleOCChannelCfgTypeDef const * const pSimpleOCChannelCfg);

HAL_StatusTypeDef HAL_HRTIM_SimpleOCStart(HRTIM_HandleTypeDef * const hhrtim,
                                         uint32_t TimerIdx,
                                         uint32_t OCChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOCStop(HRTIM_HandleTypeDef * const hhrtim,
                                        uint32_t TimerIdx,
                                        uint32_t OCChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOCStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx,
                                            uint32_t OCChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOCStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx,
                                           uint32_t OCChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOCStart_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t OCChannel,
                                             uint32_t SrcAddr,
                                             uint32_t DestAddr,
...
HAL_StatusTypeDef HAL_HRTIM_SimpleOCStop_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx,
                                            uint32_t OCChannel);
...
HAL_StatusTypeDef HAL_HRTIM_SimplePWMChannelConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t TimerIdx,
                                                  uint32_t PWMChannel,
                                                  HRTIM_SimplePWMChannelCfgTypeDef const * const pSimplePWMChannelCfg);

HAL_StatusTypeDef HAL_HRTIM_SimplePWMStart(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t TimerIdx,
                                          uint32_t PWMChannel);

HAL_StatusTypeDef HAL_HRTIM_SimplePWMStop(HRTIM_HandleTypeDef * const hhrtim,
                                         uint32_t TimerIdx,
                                         uint32_t PWMChannel);

HAL_StatusTypeDef HAL_HRTIM_SimplePWMStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t PWMChannel);

HAL_StatusTypeDef HAL_HRTIM_SimplePWMStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx,
                                            uint32_t PWMChannel);

HAL_StatusTypeDef HAL_HRTIM_SimplePWMStart_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx,
                                              uint32_t PWMChannel,
                                              uint32_t SrcAddr,
                                              uint32_t DestAddr,
...
HAL_StatusTypeDef HAL_HRTIM_SimplePWMStop_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t PWMChannel);
...
HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureChannelConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                      uint32_t TimerIdx,
                                                      uint32_t CaptureChannel,
                                                      HRTIM_SimpleCaptureChannelCfgTypeDef const * const pSimpleCaptureChannelCfg);

HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStart(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx,
                                              uint32_t CaptureChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStop(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t CaptureChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t TimerIdx,
                                                 uint32_t CaptureChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t TimerIdx,
                                                uint32_t CaptureChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStart_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t TimerIdx,
                                                  uint32_t CaptureChannel,
                                                  uint32_t SrcAddr,
                                                  uint32_t DestAddr,
...
HAL_StatusTypeDef HAL_HRTIM_SimpleCaptureStop_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t TimerIdx,
                                                 uint32_t CaptureChannel);
...
HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseChannelConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                       uint32_t TimerIdx,
                                                       uint32_t OnePulseChannel,
                                                       HRTIM_SimpleOnePulseChannelCfgTypeDef const * const pSimpleOnePulseChannelCfg);

HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseStart(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t TimerIdx,
                                               uint32_t OnePulseChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseStop(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx,
                                             uint32_t OnePulseChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t TimerIdx,
                                                  uint32_t OnePulseChannel);

HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t TimerIdx,
                                                 uint32_t OnePulseChannel);
...
* @{
*/
HAL_StatusTypeDef HAL_HRTIM_BurstModeConfig(HRTIM_HandleTypeDef * const hhrtim,
                                            HRTIM_BurstModeCfgTypeDef const * const pBurstModeCfg);

HAL_StatusTypeDef HAL_HRTIM_EventConfig(HRTIM_HandleTypeDef * const hhrtim,
                                        uint32_t Event,
                                        HRTIM_EventCfgTypeDef const * const pEventCfg);

HAL_StatusTypeDef HAL_HRTIM_EventPrescalerConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Prescaler);

HAL_StatusTypeDef HAL_HRTIM_FaultConfig(HRTIM_HandleTypeDef * const hhrtim,
                                        uint32_t Fault,
                                        HRTIM_FaultCfgTypeDef const * const pFaultCfg);

HAL_StatusTypeDef HAL_HRTIM_FaultPrescalerConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Prescaler);

HAL_StatusTypeDef HAL_HRTIM_FaultBlankingConfigAndEnable(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t Fault,
                                               HRTIM_FaultBlankingCfgTypeDef const * const pFaultBlkCfg);

HAL_StatusTypeDef HAL_HRTIM_FaultCounterConfig(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t Fault,
                                               HRTIM_FaultBlankingCfgTypeDef const * const pFaultBlkCfg);

HAL_StatusTypeDef HAL_HRTIM_FaultCounterReset(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t Fault);

HAL_StatusTypeDef HAL_HRTIM_SwapTimerOutput(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t Timers);
void HAL_HRTIM_FaultModeCtl(HRTIM_HandleTypeDef * const hhrtim,
                            uint32_t Faults,
                            uint32_t Enable);

HAL_StatusTypeDef HAL_HRTIM_ADCTriggerConfig(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t ADCTrigger,
                                             HRTIM_ADCTriggerCfgTypeDef const * const pADCTriggerCfg);

HAL_StatusTypeDef HAL_HRTIM_ADCPostScalerConfig(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t ADCTrigger,
                                             uint32_t Postscaler);

HAL_StatusTypeDef HAL_HRTIM_RollOverModeConfig(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t RollOverCfg);

HAL_StatusTypeDef HAL_HRTIM_OutputSwapEnable(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_OutputSwapDisable(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t Timers);
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_HRTIM_WaveformTimerConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t TimerIdx,
                                                HRTIM_TimerCfgTypeDef const * const pTimerCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformTimerControl(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t TimerIdx,
                                                HRTIM_TimerCtlTypeDef const * const pTimerCtl);

HAL_StatusTypeDef HAL_HRTIM_TimerDualChannelDacConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t TimerIdx,
                                                HRTIM_TimerCtlTypeDef const * const pTimerCtl);

HAL_StatusTypeDef HAL_HRTIM_WaveformCompareConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t TimerIdx,
                                                  uint32_t CompareUnit,
                                                  HRTIM_CompareCfgTypeDef const * const pCompareCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformCaptureConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                  uint32_t TimerIdx,
                                                  uint32_t CaptureUnit,
                                                  HRTIM_CaptureCfgTypeDef const * const pCaptureCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformOutputConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t TimerIdx,
                                                 uint32_t Output,
                                                 HRTIM_OutputCfgTypeDef const * const pOutputCfg);

HAL_StatusTypeDef HAL_HRTIM_WaveformSetOutputLevel(HRTIM_HandleTypeDef * const hhrtim,
                                                   uint32_t TimerIdx,
                                                   uint32_t Output,
                                                   uint32_t OutputLevel);

HAL_StatusTypeDef HAL_HRTIM_TimerEventFilteringConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                      uint32_t TimerIdx,
                                                      uint32_t Event,
                                                      HRTIM_TimerEventFilteringCfgTypeDef const * const pTimerEventFilteringCfg);

HAL_StatusTypeDef HAL_HRTIM_ExtEventCounterConfig(HRTIM_HandleTypeDef * const hhrtim,
                                                     uint32_t TimerIdx,
                                                     uint32_t EventCounter,
                                                     HRTIM_ExternalEventCfgTypeDef const * const pTimerExternalEventCfg);

HAL_StatusTypeDef HAL_HRTIM_ExtEventCounterEnable(HRTIM_HandleTypeDef * const hhrtim,
                                                      uint32_t TimerIdx,
                                                      uint32_t EventCounter);

HAL_StatusTypeDef HAL_HRTIM_ExtEventCounterDisable(HRTIM_HandleTypeDef * const hhrtim,
                                                      uint32_t TimerIdx,
                                                      uint32_t EventCounter);

HAL_StatusTypeDef HAL_HRTIM_ExtEventCounterReset(HRTIM_HandleTypeDef * const hhrtim,
                                                           uint32_t TimerIdx,
                                                           uint32_t EventCounter);

HAL_StatusTypeDef HAL_HRTIM_DeadTimeConfig(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx,
                                           HRTIM_DeadTimeCfgTypeDef const * const pDeadTimeCfg);

HAL_StatusTypeDef HAL_HRTIM_ChopperModeConfig(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx,
                                              HRTIM_ChopperModeCfgTypeDef const * const pChopperModeCfg);

HAL_StatusTypeDef HAL_HRTIM_BurstDMAConfig(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx,
                                           uint32_t RegistersToUpdate);


HAL_StatusTypeDef HAL_HRTIM_WaveformCountStart(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformCountStop(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformCountStart_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformCountStop_IT(HRTIM_HandleTypeDef * const hhrtim,
                                                 uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformCountStart_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                                     uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformCountStop_DMA(HRTIM_HandleTypeDef * const hhrtim,
                                                    uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_WaveformOutputStart(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t OutputsToStart);

HAL_StatusTypeDef HAL_HRTIM_WaveformOutputStop(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t OutputsToStop);

HAL_StatusTypeDef HAL_HRTIM_BurstModeCtl(HRTIM_HandleTypeDef * const hhrtim,
                                         uint32_t Enable);

HAL_StatusTypeDef HAL_HRTIM_BurstModeSoftwareTrigger(HRTIM_HandleTypeDef * const hhrtim);

HAL_StatusTypeDef HAL_HRTIM_SoftwareCapture(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx,
                                            uint32_t CaptureUnit);

HAL_StatusTypeDef HAL_HRTIM_SoftwareUpdate(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_SoftwareReset(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_BurstDMATransfer(HRTIM_HandleTypeDef * const hhrtim,
                                             uint32_t TimerIdx,
                                             uint32_t BurstBufferAddress,
                                             uint32_t BurstBufferLength);

HAL_StatusTypeDef HAL_HRTIM_UpdateEnable(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t Timers);

HAL_StatusTypeDef HAL_HRTIM_UpdateDisable(HRTIM_HandleTypeDef * const hhrtim,
                                          uint32_t Timers);
...
HAL_HRTIM_StateTypeDef HAL_HRTIM_GetState(HRTIM_HandleTypeDef const * const hhrtim);

uint32_t HAL_HRTIM_GetCapturedValue(HRTIM_HandleTypeDef const * const hhrtim,
                                    uint32_t TimerIdx,
                                    uint32_t CaptureUnit);

uint32_t HAL_HRTIM_GetCapturedDir(HRTIM_HandleTypeDef const * const hhrtim,
                                    uint32_t TimerIdx,
                                    uint32_t CaptureUnit);

HRTIM_CaptureValueTypeDef HAL_HRTIM_GetCaptured(HRTIM_HandleTypeDef const * const hhrtim,
                                    uint32_t TimerIdx,
                                    uint32_t CaptureUnit);

uint32_t HAL_HRTIM_WaveformGetOutputLevel(HRTIM_HandleTypeDef const * const hhrtim,
                                          uint32_t TimerIdx,
                                          uint32_t Output);

uint32_t HAL_HRTIM_WaveformGetOutputState(HRTIM_HandleTypeDef const * const hhrtim,
                                          uint32_t TimerIdx,
                                          uint32_t Output);

uint32_t HAL_HRTIM_GetDelayedProtectionStatus(HRTIM_HandleTypeDef const * const hhrtim,
                                              uint32_t TimerIdx,
                                              uint32_t Output);

uint32_t HAL_HRTIM_GetBurstStatus(HRTIM_HandleTypeDef const * const hhrtim);

uint32_t HAL_HRTIM_GetCurrentPushPullStatus(HRTIM_HandleTypeDef const * const hhrtim,
                                            uint32_t TimerIdx);

uint32_t HAL_HRTIM_GetIdlePushPullStatus(HRTIM_HandleTypeDef const * const hhrtim,
                                         uint32_t TimerIdx);
...
*/
/* IRQ handler */
void HAL_HRTIM_IRQHandler(HRTIM_HandleTypeDef * const hhrtim,
                          uint32_t TimerIdx);

/* HRTIM events related callback functions */
void HAL_HRTIM_Fault1Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_Fault2Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_Fault3Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_Fault4Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_Fault5Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_Fault6Callback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_SystemFaultCallback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_DLLCalibrationReadyCallback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_BurstModePeriodCallback(HRTIM_HandleTypeDef * const hhrtim);
void HAL_HRTIM_SynchronizationEventCallback(HRTIM_HandleTypeDef * const hhrtim);

/* Timer events related callback functions */
void HAL_HRTIM_RegistersUpdateCallback(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx);
void HAL_HRTIM_RepetitionEventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                              uint32_t TimerIdx);
void HAL_HRTIM_Compare1EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_Compare2EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_Compare3EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_Compare4EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_Capture1EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_Capture2EventCallback(HRTIM_HandleTypeDef * const hhrtim,
                                            uint32_t TimerIdx);
void HAL_HRTIM_DelayedProtectionCallback(HRTIM_HandleTypeDef * const hhrtim,
                                                uint32_t TimerIdx);
void HAL_HRTIM_CounterResetCallback(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx);
void HAL_HRTIM_Output1SetCallback(HRTIM_HandleTypeDef * const hhrtim,
                                         uint32_t TimerIdx);
void HAL_HRTIM_Output1ResetCallback(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx);
void HAL_HRTIM_Output2SetCallback(HRTIM_HandleTypeDef * const hhrtim,
                                         uint32_t TimerIdx);
void HAL_HRTIM_Output2ResetCallback(HRTIM_HandleTypeDef * const hhrtim,
                                           uint32_t TimerIdx);
void HAL_HRTIM_BurstDMATransferCallback(HRTIM_HandleTypeDef * const hhrtim,
                                               uint32_t TimerIdx);
void HAL_HRTIM_ErrorCallback(HRTIM_HandleTypeDef * const hhrtim);

#if (USE_HAL_HRTIM_REGISTER_CALLBACKS == 1U)
HAL_StatusTypeDef HAL_HRTIM_RegisterCallback(HRTIM_HandleTypeDef * const hhrtim,
...
HAL_StatusTypeDef HAL_HRTIM_TIMxUnRegisterCallback(HRTIM_HandleTypeDef * const hhrtim,
                                                   HAL_HRTIM_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
