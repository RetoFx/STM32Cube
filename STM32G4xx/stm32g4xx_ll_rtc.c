...
#define RTC_ASYNCH_PRESC_DEFAULT     ((uint32_t) 0x0000007FUL)
#define RTC_SYNCH_PRESC_DEFAULT      ((uint32_t) 0x000000FFUL)
...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef * const RTCx)
{
  ...
  if (LL_RTC_EnterInitMode(RTCx) != ERROR)
  {
    ...
    WRITE_REG(RTCx->TR,       0x00000000UL);
...
#else
    WRITE_REG(RTCx->CR, 0x00000000UL);
#endif /* RTC_WAKEUP_SUPPORT */
    WRITE_REG(RTCx->PRER, (RTC_PRER_PREDIV_A | RTC_SYNCH_PRESC_DEFAULT));
    WRITE_REG(RTCx->ALRMAR,   0x00000000UL);
    WRITE_REG(RTCx->ALRMBR,   0x00000000UL);
    WRITE_REG(RTCx->SHIFTR,   0x00000000UL);
    WRITE_REG(RTCx->CALR,     0x00000000UL);
    WRITE_REG(RTCx->ALRMASSR, 0x00000000UL);
    WRITE_REG(RTCx->ALRMBSSR, 0x00000000UL);
  ...
  WRITE_REG(TAMP->CR1,      0xFFFF0000UL);
  WRITE_REG(TAMP->CR2,     0x00000000UL);
#if defined (RTC_OTHER_SUPPORT)
  WRITE_REG(TAMP->CR3,     0x00000000UL);
  WRITE_REG(TAMP->SMCR,     0x00000000UL);
  WRITE_REG(TAMP->PRIVCR,   0x00000000UL);
#endif /* RTC_OTHER_SUPPORT */
  WRITE_REG(TAMP->FLTCR,    0x00000000UL);
#if defined (RTC_ACTIVE_TAMPER_SUPPORT)
  WRITE_REG(TAMP->ATCR1,    0x00000000UL);
  WRITE_REG(TAMP->ATCR2,    0x00000000UL);
#endif /* RTC_ACTIVE_TAMPER_SUPPORT */
  WRITE_REG(TAMP->IER,      0x00000000UL);
  WRITE_REG(TAMP->SCR,      0xFFFFFFFFUL);
#if defined (RTC_OPTION_REG_SUPPORT)
  WRITE_REG(TAMP->OR,       0x00000000UL);
