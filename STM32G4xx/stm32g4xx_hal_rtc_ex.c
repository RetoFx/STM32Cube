...
/**
  ...
  * @retval None
  */
__weak void HAL_RTCEx_InternalTamper1EventCallback(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_RTCEx_InternalTamper2EventCallback(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
...
/**
  ...
  * @retval None
  */
__weak void HAL_RTCEx_InternalTamper7EventCallback(RTC_HandleTypeDef * const hrtc)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
