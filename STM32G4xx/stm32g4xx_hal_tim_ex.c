...
static void TIM_DMADelayPulseNCplt(DMA_HandleTypeDef * const hdma);
static void TIM_DMAErrorCCxN(DMA_HandleTypeDef * const hdma);
static void TIM_CCxNChannelCmd(TIM_TypeDef * const TIMx, uint32_t Channel, uint32_t ChannelNState);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_HallSensor_MspInit(TIM_HandleTypeDef * const htim)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_HallSensor_MspDeInit(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakInput(TIM_HandleTypeDef * const htim,
                                             uint32_t BreakInput,
...
/**
  ...
  *           - ARR and CCRx values are limited to 0xFFEFU in dithering mode for 16b timers
...
/**
  ...
  *           - ARR: ARR[15:4] holds the non-dithered part, and ARR[3:0] the dither part for 16b timers
  *           - CCRx: CCRx[15:4] holds the non-dithered part, and CCRx[3:0] the dither part for 16b timers
  *           - ARR and CCRx values are limited to 0xFFEFU in dithering mode
  *             (corresponds to 4094 for the integer part and 15 for the dithered part).
...
/**
  ...
  *         This parameter can be a number between Min_Data = 0x0U and Max_Data = 0x7U
  * @param  PulseWidth  Pulse width
  *         This parameter can be a number between Min_Data = 0x00U and Max_Data = 0xFFU
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_OC_ConfigPulseOnCompare(TIM_HandleTypeDef * const htim,
...
/**
  ...
  * @note   This parameter can be a number between Min_Data = 0x00U and Max_Data = 0xFFU
  * @retval HAL status
  */
                                               ...
                                               TIMEx_EncoderIndexConfigTypeDef const * const sEncoderIndexConfig)
{
  ...
  MODIFY_REG(htim->Instance->ECR,
             ...
             (sEncoderIndexConfig->Direction |
              ((sEncoderIndexConfig->FirstIndexEnable == ENABLE) ? (0x1UL << TIM_ECR_FIDX_Pos) : 0U) |
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_CommutCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_CommutHalfCpltCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
HAL_TIMEX_WEAK_CALLBACK(void, HAL_TIMEx_BreakCallback)(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
HAL_TIMEX_WEAK_CALLBACK(void, HAL_TIMEx_Break2Callback)(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_EncoderIndexCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_DirectionChangeCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_IndexErrorCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
...
/**
  ...
  * @retval None
  */
__weak void HAL_TIMEx_TransitionErrorCallback(TIM_HandleTypeDef * const htim)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(htim);
