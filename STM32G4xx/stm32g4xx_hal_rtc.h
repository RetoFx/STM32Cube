...
#if (USE_HAL_RTC_REGISTER_CALLBACKS == 1U)
  void (* AlarmAEventCallback)(struct __RTC_HandleTypeDef * const hrtc);                   /*!< RTC Alarm A Event callback           */
  void (* AlarmBEventCallback)(struct __RTC_HandleTypeDef * const hrtc);                   /*!< RTC Alarm B Event callback           */
  void (* TimeStampEventCallback)(struct __RTC_HandleTypeDef * const hrtc);                /*!< RTC TimeStamp Event callback         */
  void (* WakeUpTimerEventCallback)(struct __RTC_HandleTypeDef * const hrtc);              /*!< RTC WakeUpTimer Event callback       */

  void (* Tamper1EventCallback)(struct __RTC_HandleTypeDef * const hrtc);                  /*!< RTC Tamper 1 Event callback          */
  void (* Tamper2EventCallback)(struct __RTC_HandleTypeDef * const hrtc);                  /*!< RTC Tamper 2 Event callback          */
#if (RTC_TAMP_NB == 3)
  void (* Tamper3EventCallback)(struct __RTC_HandleTypeDef * const hrtc);                  /*!< RTC Tamper 3 Event callback          */
#endif /* RTC_TAMP_NB */
  void (* InternalTamper1EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 1 Event callback */
#ifdef RTC_TAMP_INT_2_SUPPORT
  void (* InternalTamper2EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 2 Event callback */
#endif /* RTC_TAMP_INT_2_SUPPORT */
  void (* InternalTamper3EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 3 Event callback */
  void (* InternalTamper4EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 4 Event callback */
  void (* InternalTamper5EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 5 Event callback */
#ifdef RTC_TAMP_INT_6_SUPPORT
  void (* InternalTamper6EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 6 Event callback */
#endif /* RTC_TAMP_INT_6_SUPPORT */
#ifdef RTC_TAMP_INT_7_SUPPORT
  void (* InternalTamper7EventCallback)(struct __RTC_HandleTypeDef * const hrtc);          /*!< RTC Internal Tamper 7 Event callback */
#endif /* RTC_TAMP_INT_7_SUPPORT */

  void (* MspInitCallback)(struct __RTC_HandleTypeDef * const hrtc);                       /*!< RTC Msp Init callback                */
  void (* MspDeInitCallback)(struct __RTC_HandleTypeDef * const hrtc);                     /*!< RTC Msp DeInit callback              */
...
/**
  ...
  */
typedef  void (*pRTC_CallbackTypeDef)(RTC_HandleTypeDef * const hrtc); /*!< pointer to an RTC callback function */
#endif /* USE_HAL_RTC_REGISTER_CALLBACKS */
...
/** @defgroup RTC_Hour_Formats RTC Hour Formats
  * @{
  */
#define RTC_HOURFORMAT_24                   0x00000000UL
...
/** @defgroup RTCEx_Output_selection_Definitions RTCEx Output Selection Definition
  * @{
  */
#define RTC_OUTPUT_DISABLE                  0x00000000UL
...
/** @defgroup RTC_Output_Polarity_Definitions RTC Output Polarity Definitions
  * @{
  */
#define RTC_OUTPUT_POLARITY_HIGH            0x00000000UL
...
/** @defgroup RTC_Output_Type_ALARM_OUT RTC Output Type ALARM OUT
  * @{
  */
#define RTC_OUTPUT_TYPE_PUSHPULL            0x00000000UL
...
/** @defgroup RTC_Output_PullUp_ALARM_OUT RTC Output Pull-Up ALARM OUT
  * @{
  */
#define RTC_OUTPUT_PULLUP_NONE              0x00000000UL
...
/** @defgroup RTC_Output_ALARM_OUT_Remap RTC Output ALARM OUT Remap
  * @{
  */
#define RTC_OUTPUT_REMAP_NONE               0x00000000UL
...
#define RTC_DAYLIGHTSAVING_NONE             0x00000000UL
/**
  * @}
  */
...
/** @defgroup RTC_StoreOperation_Definitions RTC StoreOperation Definitions
  * @{
  */
#define RTC_STOREOPERATION_RESET            0x00000000UL
...
/** @defgroup RTC_Input_parameter_format_definitions RTC Input Parameter Format Definitions
  * @{
  */
#define RTC_FORMAT_BIN                      0x00000000UL
#define RTC_FORMAT_BCD                      0x00000001UL
/**
  * @}
  */
...
/** @defgroup RTC_AlarmDateWeekDay_Definitions RTC AlarmDateWeekDay Definitions
  * @{
  */
#define RTC_ALARMDATEWEEKDAYSEL_DATE        0x00000000UL
...
/** @defgroup RTC_AlarmMask_Definitions RTC AlarmMask Definitions
  * @{
  */
#define RTC_ALARMMASK_NONE                  0x00000000UL
...
/** @defgroup RTC_Alarm_Sub_Seconds_Masks_Definitions RTC Alarm Sub Seconds Masks Definitions
  * @{
  */
#define RTC_ALARMSUBSECONDMASK_ALL          0x00000000UL                                                              /*!< All Alarm SS fields are masked.
...
#define RTC_ALARMSUBSECONDMASK_SS14         (RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3)  /*!< SS[14U] not used in Alarm
...
/** @defgroup RTC_Flags_Definitions RTC Flags Definitions
  ...
  * @{
  */
#define RTC_FLAG_RECALPF                    (0x00000100UL | RTC_ICSR_RECALPF_Pos) /*!< Recalibration pending Flag */
#define RTC_FLAG_INITF                      (0x00000100UL | RTC_ICSR_INITF_Pos)   /*!< Initialization flag */
#define RTC_FLAG_RSF                        (0x00000100UL | RTC_ICSR_RSF_Pos)     /*!< Registers synchronization flag */
#define RTC_FLAG_INITS                      (0x00000100UL | RTC_ICSR_INITS_Pos)   /*!< Initialization status flag */
#define RTC_FLAG_SHPF                       (0x00000100UL | RTC_ICSR_SHPF_Pos)    /*!< Shift operation pending flag */
#define RTC_FLAG_WUTWF                      (0x00000100UL | RTC_ICSR_WUTWF_Pos)   /*!< Wakeup timer write flag */
#define RTC_FLAG_ALRBWF                     (0x00000100UL | RTC_ICSR_ALRBWF_Pos)  /*!< Alarm B write flag */
#define RTC_FLAG_ALRAWF                     (0x00000100UL | RTC_ICSR_ALRAWF_Pos)  /*!< Alarm A write flag */
#define RTC_FLAG_ITSF                       (0x00000200UL | RTC_SR_ITSF_Pos)      /*!< Internal Time-stamp flag */
#define RTC_FLAG_TSOVF                      (0x00000200UL | RTC_SR_TSOVF_Pos)     /*!< Time-stamp overflow flag */
#define RTC_FLAG_TSF                        (0x00000200UL | RTC_SR_TSF_Pos)       /*!< Time-stamp flag */
#define RTC_FLAG_WUTF                       (0x00000200UL | RTC_SR_WUTF_Pos)      /*!< Wakeup timer flag */
#define RTC_FLAG_ALRBF                      (0x00000200UL | RTC_SR_ALRBF_Pos)     /*!< Alarm B flag */
#define RTC_FLAG_ALRAF                      (0x00000200UL | RTC_SR_ALRAF_Pos)     /*!< Alarm A flag */
 /**
  * @}
  */
...
HAL_StatusTypeDef HAL_RTC_Init(RTC_HandleTypeDef * const hrtc);
HAL_StatusTypeDef HAL_RTC_DeInit(RTC_HandleTypeDef * const hrtc);

void HAL_RTC_MspInit(RTC_HandleTypeDef * const hrtc);
void HAL_RTC_MspDeInit(RTC_HandleTypeDef * const hrtc);
#if (USE_HAL_RTC_REGISTER_CALLBACKS == 1U)

/* Callbacks Register/UnRegister functions  ***********************************/
HAL_StatusTypeDef HAL_RTC_RegisterCallback(RTC_HandleTypeDef * const hrtc, HAL_RTC_CallbackIDTypeDef CallbackID,
                                           pRTC_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_RTC_UnRegisterCallback(RTC_HandleTypeDef * const hrtc, HAL_RTC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_RTC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
HAL_StatusTypeDef HAL_RTC_SetTime(RTC_HandleTypeDef * const hrtc, RTC_TimeTypeDef * const sTime, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_GetTime(RTC_HandleTypeDef const * const hrtc, RTC_TimeTypeDef * const sTime, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_SetDate(RTC_HandleTypeDef * const hrtc, RTC_DateTypeDef * const sDate, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_GetDate(RTC_HandleTypeDef const * const hrtc, RTC_DateTypeDef * const sDate, uint32_t Format);
void              HAL_RTC_DST_Add1Hour(RTC_HandleTypeDef const * const hrtc);
void              HAL_RTC_DST_Sub1Hour(RTC_HandleTypeDef const * const hrtc);
void              HAL_RTC_DST_SetStoreOperation(RTC_HandleTypeDef const * const hrtc);
void              HAL_RTC_DST_ClearStoreOperation(RTC_HandleTypeDef const * const hrtc);
uint32_t          HAL_RTC_DST_ReadStoreOperation(RTC_HandleTypeDef const * const hrtc);
/**
  * @}
  */
...
/** @defgroup RTC_Exported_Functions_Group3 RTC Alarm functions
  ...
  */
/* RTC Alarm functions ********************************************************/
HAL_StatusTypeDef HAL_RTC_SetAlarm(RTC_HandleTypeDef * const hrtc, RTC_AlarmTypeDef * const sAlarm, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_SetAlarm_IT(RTC_HandleTypeDef * const hrtc, RTC_AlarmTypeDef * const sAlarm, uint32_t Format);
HAL_StatusTypeDef HAL_RTC_DeactivateAlarm(RTC_HandleTypeDef * const hrtc, uint32_t Alarm);
HAL_StatusTypeDef HAL_RTC_GetAlarm(RTC_HandleTypeDef const * const hrtc, RTC_AlarmTypeDef * const sAlarm, uint32_t Alarm, uint32_t Format);
void              HAL_RTC_AlarmIRQHandler(RTC_HandleTypeDef * const hrtc);
HAL_StatusTypeDef HAL_RTC_PollForAlarmAEvent(RTC_HandleTypeDef * const hrtc, uint32_t Timeout);
void              HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef * const hrtc);
/**
  * @}
  */
...
HAL_StatusTypeDef   HAL_RTC_WaitForSynchro(RTC_HandleTypeDef const * const hrtc);
/**
  * @}
  */
...
HAL_RTCStateTypeDef HAL_RTC_GetState(RTC_HandleTypeDef const * const hrtc);
/**
  * @}
  */
...
/** @defgroup RTC_Private_Functions RTC Private Functions
  * @{
  */
HAL_StatusTypeDef  RTC_EnterInitMode(RTC_HandleTypeDef * const hrtc);
HAL_StatusTypeDef  RTC_ExitInitMode(RTC_HandleTypeDef * const hrtc);
