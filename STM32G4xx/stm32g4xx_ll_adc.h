...
/** @defgroup ADC_LL_EC_HELPER_MACRO  Definitions of constants used by helper macro
  * @{
  */
#define LL_ADC_TEMPERATURE_CALC_ERROR      ((int16_t)0x7FFFU)  /* Temperature calculation error using helper macro
...
#define __LL_ADC_CALC_TEMPERATURE(__VREFANALOG_VOLTAGE__, \
                                  ...
                                  __ADC_RESOLUTION__) \
((((int32_t)*TEMPSENSOR_CAL2_ADDR - (int32_t)*TEMPSENSOR_CAL1_ADDR) != 0U) ?       \
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetCommonPathInternalChAdd(ADC_Common_TypeDef * const ADCxy_COMMON, uint32_t PathInternal)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetCommonPathInternalChRem(ADC_Common_TypeDef * const ADCxy_COMMON, uint32_t PathInternal)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetOffsetSign(ADC_TypeDef * const ADCx, uint32_t Offsety, uint32_t OffsetSign)
{
  __IO uint32_t * preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  *         @arg @ref LL_ADC_OFFSET_SIGN_POSITIVE
  */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetSign(ADC_TypeDef const * const ADCx, uint32_t Offsety)
{
  const __IO uint32_t * preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetOffsetSaturation(ADC_TypeDef * const ADCx, uint32_t Offsety, uint32_t OffsetSaturation)
{
  __IO uint32_t * preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  *         @arg @ref LL_ADC_OFFSET_SATURATION_DISABLE
  */
__STATIC_INLINE uint32_t LL_ADC_GetOffsetSaturation(ADC_TypeDef const * const ADCx, uint32_t Offsety)
{
  const __IO uint32_t * preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetGainCompensation(ADC_TypeDef * const ADCx, uint32_t GainCompensation)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_ADC_GetGainCompensation(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetSamplingTimeCommonConfig(ADC_TypeDef * const ADCx, uint32_t SamplingTimeCommonConfig)
{
...
/**
  ...
  *         @arg @ref LL_ADC_SAMPLINGTIME_COMMON_3C5_REPL_2C5
  */
__STATIC_INLINE uint32_t LL_ADC_GetSamplingTimeCommonConfig(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_REG_SetSamplingMode(ADC_TypeDef * const ADCx, uint32_t SamplingMode)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_SAMPLING_MODE_TRIGGER_CONTROLED
  */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSamplingMode(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x000U and Max_Data=0xFFFU
  */
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDThresholds(ADC_TypeDef const * const ADCx,
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetAWDFilteringConfiguration(ADC_TypeDef * const ADCx, uint32_t AWDy, uint32_t FilteringConfig)
{
  /* Prevent unused argument(s) compilation warning */
  (void)(AWDy);
...
/**
  ...
  *         @arg @ref LL_ADC_AWD_FILTERING_8SAMPLES
  */
__STATIC_INLINE uint32_t LL_ADC_GetAWDFilteringConfiguration(ADC_TypeDef const * const ADCx, uint32_t AWDy)
{
  /* Prevent unused argument(s) compilation warning */
  (void)(AWDy);
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetOverSamplingScope(ADC_TypeDef * const ADCx, uint32_t OvsScope)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_GRP_INJ_REG_RESUMED
  */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingScope(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_SetOverSamplingDiscont(ADC_TypeDef * const ADCx, uint32_t OverSamplingDiscont)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_REG_DISCONT
  */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingDiscont(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_ConfigOverSamplingRatioShift(ADC_TypeDef * const ADCx, uint32_t Ratio, uint32_t Shift)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_RATIO_256
  */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingRatio(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_SHIFT_RIGHT_8
  */
__STATIC_INLINE uint32_t LL_ADC_GetOverSamplingShift(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_EnableDeepPowerDown(ADC_TypeDef * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_DisableDeepPowerDown(ADC_TypeDef * const ADCx)
{
  /* Note: Write register with some additional bits forced to state reset     */
  /*       instead of modifying only the selected bit for this function,      */
  /*       to not interfere with bits with HW property "rs".                  */
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_ADC_IsDeepPowerDownEnabled(ADC_TypeDef const * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_REG_StartSamplingPhase(ADC_TypeDef * const ADCx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_REG_StopSamplingPhase(ADC_TypeDef * const ADCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00000000UL and Max_Data=0xFFFFFFFFUL
  */
__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(ADC_Common_TypeDef const * const ADCxy_COMMON,
...
ErrorStatus LL_ADC_CommonInit(ADC_Common_TypeDef * const ADCxy_COMMON, LL_ADC_CommonInitTypeDef const * const pADC_CommonInitStruct);
void        LL_ADC_CommonStructInit(LL_ADC_CommonInitTypeDef * const pADC_CommonInitStruct);
...
ErrorStatus LL_ADC_Init(ADC_TypeDef * const ADCx, LL_ADC_InitTypeDef const * const pADC_InitStruct);
void        LL_ADC_StructInit(LL_ADC_InitTypeDef * const pADC_InitStruct);

/* Initialization of some features of ADC instance and ADC group regular */
ErrorStatus LL_ADC_REG_Init(ADC_TypeDef * const ADCx, LL_ADC_REG_InitTypeDef const * const pADC_RegInitStruct);
void        LL_ADC_REG_StructInit(LL_ADC_REG_InitTypeDef * const pADC_RegInitStruct);

/* Initialization of some features of ADC instance and ADC group injected */
ErrorStatus LL_ADC_INJ_Init(ADC_TypeDef * const ADCx, LL_ADC_INJ_InitTypeDef const * const pADC_InjInitStruct);
void        LL_ADC_INJ_StructInit(LL_ADC_INJ_InitTypeDef * const pADC_InjInitStruct);
