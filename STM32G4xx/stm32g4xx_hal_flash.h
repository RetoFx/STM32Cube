...
/** @defgroup FLASH_Banks FLASH Banks
  * @{
  */
#define FLASH_BANK_1              0x00000001UL              /*!< Bank 1   */
#if defined (FLASH_OPTR_DBANK)
#define FLASH_BANK_2              0x00000002UL              /*!< Bank 2   */
...
/** @defgroup FLASH_OB_Boot_Lock FLASH Boot Lock
  * @{
  */
#define OB_BOOT_LOCK_DISABLE      0x00000000UL              /*!< Boot Lock Disable */
...
/** @defgroup FLASH_OB_USER_Type FLASH Option Bytes User Type
  * @{
  */
#define OB_USER_BOR_LEV           0x00000001UL              /*!< BOR reset Level */
#define OB_USER_nRST_STOP         0x00000002UL              /*!< Reset generated when entering the stop mode */
#define OB_USER_nRST_STDBY        0x00000004UL              /*!< Reset generated when entering the standby mode */
#define OB_USER_IWDG_SW           0x00000008UL              /*!< Independent watchdog selection */
#define OB_USER_IWDG_STOP         0x00000010UL              /*!< Independent watchdog counter freeze in stop mode */
#define OB_USER_IWDG_STDBY        0x00000020UL              /*!< Independent watchdog counter freeze in standby mode */
#define OB_USER_WWDG_SW           0x00000040UL              /*!< Window watchdog selection */
#if defined (FLASH_OPTR_DBANK)
#define OB_USER_BFB2              0x00000080UL              /*!< Dual-bank boot */
#define OB_USER_DBANK             0x00000100UL              /*!< Single bank with 128-bits data or two banks with 64-bits data */
#endif
#if defined (FLASH_OPTR_PB4_PUPEN)
#define OB_USER_PB4_PUPEN         0x00000100UL              /*!< USB power delivery dead-battery/TDI pull-up */
#endif
#define OB_USER_nBOOT1            0x00000200UL              /*!< Boot configuration */
#define OB_USER_SRAM_PE           0x00000400UL              /*!< SRAM parity check enable (first 32kB of SRAM1 + CCM SRAM) */
#define OB_USER_CCMSRAM_RST       0x00000800UL              /*!< CCMSRAM Erase when system reset */
#define OB_USER_nRST_SHDW         0x00001000UL              /*!< Reset generated when entering the shutdown mode */
#define OB_USER_nSWBOOT0          0x00002000UL              /*!< Software BOOT0 */
#define OB_USER_nBOOT0            0x00004000UL              /*!< nBOOT0 option bit */
#define OB_USER_NRST_MODE         0x00008000UL              /*!< Reset pin configuration */
#define OB_USER_IRHEN             0x00010000UL              /*!< Internal Reset Holder enable */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_USER_nRST_STOP FLASH Option Bytes User Reset On Stop
  * @{
  */
#define OB_STOP_RST               0x00000000UL              /*!< Reset generated when entering the stop mode */
#define OB_STOP_NO_RST             FLASH_OPTR_nRST_STOP     /*!< No reset generated when entering the stop mode */
/**
  * @}
  */
...
/** @defgroup FLASH_OB_USER_nRST_STANDBY FLASH Option Bytes User Reset On Standby
  * @{
  */
#define OB_STANDBY_RST            0x00000000UL              /*!< Reset generated when entering the standby mode */
...
/** @defgroup FLASH_OB_USER_nRST_SHUTDOWN FLASH Option Bytes User Reset On Shutdown
  * @{
  */
#define OB_SHUTDOWN_RST           0x00000000UL              /*!< Reset generated when entering the shutdown mode */
...
/** @defgroup FLASH_OB_USER_IWDG_SW FLASH Option Bytes User IWDG Type
  * @{
  */
#define OB_IWDG_HW                0x00000000UL              /*!< Hardware independent watchdog */
...
/** @defgroup FLASH_OB_USER_IWDG_STOP FLASH Option Bytes User IWDG Mode On Stop
  * @{
  */
#define OB_IWDG_STOP_FREEZE       0x00000000UL              /*!< Independent watchdog counter is frozen in Stop mode */
...
/** @defgroup FLASH_OB_USER_IWDG_STANDBY FLASH Option Bytes User IWDG Mode On Standby
  * @{
  */
#define OB_IWDG_STDBY_FREEZE      0x00000000UL              /*!< Independent watchdog counter is frozen in Standby mode */
...
/** @defgroup FLASH_OB_USER_WWDG_SW FLASH Option Bytes User WWDG Type
  * @{
  */
#define OB_WWDG_HW                0x00000000UL              /*!< Hardware window watchdog */
...
/** @defgroup FLASH_OB_USER_BFB2 FLASH Option Bytes User BFB2 Mode
  * @{
  */
#define OB_BFB2_DISABLE           0x00000000UL              /*!< Dual-bank boot disable */
...
/** @defgroup FLASH_OB_USER_DBANK FLASH Option Bytes User DBANK Type
  * @{
  */
#define OB_DBANK_128_BITS         0x00000000UL              /*!< Single-bank with 128-bits data */
...
/** @defgroup FLASH_OB_USER_PB4_PUPEN FLASH Option Bytes User PB4 PUPEN bit
  * @{
  */
#define OB_PB4_PUPEN_DISABLE      0x00000000UL              /*!< USB power delivery dead-battery enabled/ TDI pull-up deactivated */
...
/** @defgroup FLASH_OB_USER_nBOOT1 FLASH Option Bytes User BOOT1 Type
  * @{
  */
#define OB_BOOT1_SRAM             0x00000000UL              /*!< Embedded SRAM1 is selected as boot space (if BOOT0=1) */
...
/** @defgroup FLASH_OB_USER_SRAM_PE FLASH Option Bytes User SRAM Parity Check Type
  * @{
  */
#define OB_SRAM_PARITY_ENABLE     0x00000000UL              /*!< SRAM parity check enable (first 32kB of SRAM1 + CCM SRAM) */
...
/** @defgroup FLASH_OB_USER_CCMSRAM_RST FLASH Option Bytes User CCMSRAM Erase On Reset Type
  * @{
  */
#define OB_CCMSRAM_RST_ERASE      0x00000000UL              /*!< CCMSRAM erased when a system reset occurs */
...
/** @defgroup FLASH_OB_USER_nSWBOOT0 FLASH Option Bytes User Software BOOT0
  * @{
  */
#define OB_BOOT0_FROM_OB          0x00000000UL              /*!< BOOT0 taken from the option bit nBOOT0 */
...
/** @defgroup FLASH_OB_USER_nBOOT0 FLASH Option Bytes User nBOOT0 option bit
  * @{
  */
#define OB_nBOOT0_RESET           0x00000000UL              /*!< nBOOT0 = 0 */
...
/** @defgroup FLASH_OB_USER_INTERNAL_RESET_HOLDER FLASH Option Bytes User internal reset holder bit
  * @{
  */
#define OB_IRH_DISABLE            0x00000000UL              /*!< Internal Reset holder disable */
...
/** @defgroup FLASH_OB_PCROP_RDP FLASH Option Bytes PCROP On RDP Level Type
  * @{
  */
#define OB_PCROP_RDP_NOT_ERASE    0x00000000UL              /*!< PCROP area is not erased when the RDP level
...
#define FLASH_PAGE_NB                   ((FLASH_SIZE == 0x00080000UL) ? 128U : \
                                        ((FLASH_SIZE == 0x00040000UL) ? 64U : 32U))
#define FLASH_PAGE_SIZE_128_BITS        0x1000U /* 4 KB */
#else
#define FLASH_SIZE                      ((((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0xFFFFU)) ? (0x80UL << 10U) : \
                                        (((*((uint32_t *)FLASH_SIZE_DATA_REGISTER)) & 0xFFFFUL) << 10U))
#define FLASH_BANK_SIZE                 (FLASH_SIZE)
#define FLASH_PAGE_NB                   ((FLASH_SIZE == 0x00080000UL) ? 256U : \
                                        ((FLASH_SIZE == 0x00040000UL) ? 128U : 64U))
#endif
...
#define IS_OB_USER_TYPE(TYPE)              (((TYPE) <= 0x1FFFFUL) && ((TYPE) != 0U))
