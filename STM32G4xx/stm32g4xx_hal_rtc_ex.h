...
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper(RTC_HandleTypeDef const * const hrtc, RTC_InternalTamperTypeDef const * const sIntTamper);
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper_IT(RTC_HandleTypeDef const * const hrtc, RTC_InternalTamperTypeDef const * const sIntTamper);
...
void              HAL_RTCEx_InternalTamper1EventCallback(RTC_HandleTypeDef * const hrtc);
#endif /* RTC_TAMP_INT_1_SUPPORT */
#ifdef RTC_TAMP_INT_2_SUPPORT
void              HAL_RTCEx_InternalTamper2EventCallback(RTC_HandleTypeDef * const hrtc);
#endif /* RTC_TAMP_INT_2_SUPPORT */
...
void              HAL_RTCEx_InternalTamper7EventCallback(RTC_HandleTypeDef * const hrtc);
#endif /* RTC_TAMP_INT_7_SUPPORT */
/**
  * @}
  */
