...
typedef struct __SAI_HandleTypeDef
{
  ...
  void (*InterruptServiceRoutine)(struct __SAI_HandleTypeDef * const hsai); /* function pointer for IRQ handler */
  ...
  void (*RxCpltCallback)(struct __SAI_HandleTypeDef * const hsai);      /*!< SAI receive complete callback */
  void (*RxHalfCpltCallback)(struct __SAI_HandleTypeDef * const hsai);  /*!< SAI receive half complete callback */
  void (*TxCpltCallback)(struct __SAI_HandleTypeDef * const hsai);      /*!< SAI transmit complete callback */
  void (*TxHalfCpltCallback)(struct __SAI_HandleTypeDef * const hsai);  /*!< SAI transmit half complete callback */
  void (*ErrorCallback)(struct __SAI_HandleTypeDef * const hsai);       /*!< SAI error callback */
  void (*MspInitCallback)(struct __SAI_HandleTypeDef * const hsai);     /*!< SAI MSP init callback */
  void (*MspDeInitCallback)(struct __SAI_HandleTypeDef * const hsai);   /*!< SAI MSP de-init callback */
...
/**
  ...
  */
typedef void (*pSAI_CallbackTypeDef)(SAI_HandleTypeDef * const hsai);
#endif /* USE_HAL_SAI_REGISTER_CALLBACKS */
...
/** @defgroup SAI_Error_Code SAI Error Code
  * @{
  */
#define HAL_SAI_ERROR_NONE             0x00000000UL  /*!< No error */
#define HAL_SAI_ERROR_OVR              0x00000001UL  /*!< Overrun Error */
#define HAL_SAI_ERROR_UDR              0x00000002UL  /*!< Underrun error */
#define HAL_SAI_ERROR_AFSDET           0x00000004UL  /*!< Anticipated Frame synchronisation detection */
#define HAL_SAI_ERROR_LFSDET           0x00000008UL  /*!< Late Frame synchronisation detection */
#define HAL_SAI_ERROR_CNREADY          0x00000010UL  /*!< codec not ready */
#define HAL_SAI_ERROR_WCKCFG           0x00000020UL  /*!< Wrong clock configuration */
#define HAL_SAI_ERROR_TIMEOUT          0x00000040UL  /*!< Timeout error */
#define HAL_SAI_ERROR_DMA              0x00000080UL  /*!< DMA error */
#if (USE_HAL_SAI_REGISTER_CALLBACKS == 1U)
#define HAL_SAI_ERROR_INVALID_CALLBACK 0x00000100UL  /*!< Invalid callback error */
#endif /* USE_HAL_SAI_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @defgroup SAI_Block_MckOutput SAI Block Master Clock Output
  * @{
  */
#define SAI_MCK_OUTPUT_DISABLE      0x00000000UL
...
/** @defgroup SAI_Audio_Frequency SAI Audio Frequency
  * @{
  */
#define SAI_AUDIO_FREQUENCY_192K          192000UL
#define SAI_AUDIO_FREQUENCY_96K           96000UL
...
/** @defgroup SAI_Block_Mck_OverSampling SAI Block Master Clock OverSampling
  * @{
  */
#define SAI_MCK_OVERSAMPLING_DISABLE      0x00000000UL
...
/** @defgroup SAI_Block_Mode SAI Block Mode
  * @{
  */
#define SAI_MODEMASTER_TX         0x00000000UL
...
/** @defgroup SAI_Block_Protocol SAI Block Protocol
  * @{
  */
#define SAI_FREE_PROTOCOL                 0x00000000UL
...
/** @defgroup SAI_Block_MSB_LSB_transmission SAI Block MSB LSB transmission
  * @{
  */
#define SAI_FIRSTBIT_MSB                  0x00000000UL
...
/** @defgroup SAI_Block_Output_Drive SAI Block Output Drive
  * @{
  */
#define SAI_OUTPUTDRIVE_DISABLE          0x00000000UL
...
/** @defgroup SAI_Block_NoDivider SAI Block NoDivider
  * @{
  */
#define SAI_MASTERDIVIDER_ENABLE         0x00000000UL
...
/** @defgroup SAI_Block_FS_Definition SAI Block FS Definition
  * @{
  */
#define SAI_FS_STARTFRAME                 0x00000000UL
...
/** @defgroup SAI_Block_FS_Polarity SAI Block FS Polarity
  * @{
  */
#define SAI_FS_ACTIVE_LOW                  0x00000000UL
...
/** @defgroup SAI_Block_FS_Offset SAI Block FS Offset
  * @{
  */
#define SAI_FS_FIRSTBIT                   0x00000000UL
...
/** @defgroup SAI_Block_Slot_Size SAI Block Slot Size
  * @{
  */
#define SAI_SLOTSIZE_DATASIZE             0x00000000UL
...
/** @defgroup SAI_Block_Slot_Active SAI Block Slot Active
  * @{
  */
#define SAI_SLOT_NOTACTIVE           0x00000000UL
#define SAI_SLOTACTIVE_0             0x00000001UL
#define SAI_SLOTACTIVE_1             0x00000002UL
#define SAI_SLOTACTIVE_2             0x00000004UL
#define SAI_SLOTACTIVE_3             0x00000008UL
#define SAI_SLOTACTIVE_4             0x00000010UL
#define SAI_SLOTACTIVE_5             0x00000020UL
#define SAI_SLOTACTIVE_6             0x00000040UL
#define SAI_SLOTACTIVE_7             0x00000080UL
#define SAI_SLOTACTIVE_8             0x00000100UL
#define SAI_SLOTACTIVE_9             0x00000200UL
#define SAI_SLOTACTIVE_10            0x00000400UL
#define SAI_SLOTACTIVE_11            0x00000800UL
#define SAI_SLOTACTIVE_12            0x00001000UL
#define SAI_SLOTACTIVE_13            0x00002000UL
#define SAI_SLOTACTIVE_14            0x00004000UL
#define SAI_SLOTACTIVE_15            0x00008000UL
#define SAI_SLOTACTIVE_ALL           0x0000FFFFUL
/**
  * @}
  */
...
/** @defgroup SAI_Mono_Stereo_Mode SAI Mono Stereo Mode
  * @{
  */
#define SAI_STEREOMODE               0x00000000UL
...
/** @defgroup SAI_TRIState_Management SAI TRIState Management
  * @{
  */
#define SAI_OUTPUT_NOTRELEASED    0x00000000UL
...
/** @defgroup SAI_Block_Fifo_Threshold SAI Block Fifo Threshold
  * @{
  */
#define SAI_FIFOTHRESHOLD_EMPTY  0x00000000UL
...
/** @defgroup SAI_Block_Companding_Mode SAI Block Companding Mode
  * @{
  */
#define SAI_NOCOMPANDING                 0x00000000UL
...
/** @defgroup SAI_Block_Mute_Value SAI Block Mute Value
  * @{
  */
#define SAI_ZERO_VALUE                     0x00000000UL
...
/** @defgroup SAI_Block_Fifo_Status_Level   SAI Block Fifo Status Level
  * @{
  */
#define SAI_FIFOSTATUS_EMPTY              0x00000000UL
#define SAI_FIFOSTATUS_LESS1QUARTERFULL   0x00010000UL
#define SAI_FIFOSTATUS_1QUARTERFULL       0x00020000UL
#define SAI_FIFOSTATUS_HALFFULL           0x00030000UL
#define SAI_FIFOSTATUS_3QUARTERFULL       0x00040000UL
#define SAI_FIFOSTATUS_FULL               0x00050000UL
/**
  * @}
  */
...
/** @addtogroup SAI_Exported_Functions_Group1
  * @{
  */
HAL_StatusTypeDef HAL_SAI_InitProtocol(SAI_HandleTypeDef * const hsai, uint32_t protocol, uint32_t datasize, uint32_t nbslot);
HAL_StatusTypeDef HAL_SAI_Init(SAI_HandleTypeDef * const hsai);
HAL_StatusTypeDef HAL_SAI_DeInit(SAI_HandleTypeDef * const hsai);
void HAL_SAI_MspInit(SAI_HandleTypeDef * const hsai);
void HAL_SAI_MspDeInit(SAI_HandleTypeDef * const hsai);

#if (USE_HAL_SAI_REGISTER_CALLBACKS == 1U)
/* SAI callbacks register/unregister functions ********************************/
HAL_StatusTypeDef HAL_SAI_RegisterCallback(SAI_HandleTypeDef        * const hsai,
                                           HAL_SAI_CallbackIDTypeDef CallbackID,
                                           pSAI_CallbackTypeDef      pCallback);
HAL_StatusTypeDef HAL_SAI_UnRegisterCallback(SAI_HandleTypeDef        * const hsai,
                                             HAL_SAI_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_SAI_REGISTER_CALLBACKS */
/**
  * @}
...
HAL_StatusTypeDef HAL_SAI_Transmit(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_SAI_Receive(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size, uint32_t Timeout);

/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_SAI_Transmit_IT(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SAI_Receive_IT(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size);

/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_SAI_Transmit_DMA(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SAI_Receive_DMA(SAI_HandleTypeDef * const hsai, uint8_t * const pData, uint16_t Size);
HAL_StatusTypeDef HAL_SAI_DMAPause(SAI_HandleTypeDef * const hsai);
HAL_StatusTypeDef HAL_SAI_DMAResume(SAI_HandleTypeDef * const hsai);
HAL_StatusTypeDef HAL_SAI_DMAStop(SAI_HandleTypeDef * const hsai);

/* Abort function */
HAL_StatusTypeDef HAL_SAI_Abort(SAI_HandleTypeDef * const hsai);

/* Mute management */
HAL_StatusTypeDef HAL_SAI_EnableTxMuteMode(SAI_HandleTypeDef * const hsai, uint16_t val);
HAL_StatusTypeDef HAL_SAI_DisableTxMuteMode(SAI_HandleTypeDef * const hsai);
HAL_StatusTypeDef HAL_SAI_EnableRxMuteMode(SAI_HandleTypeDef * const hsai, SAIcallback callback, uint16_t counter);
HAL_StatusTypeDef HAL_SAI_DisableRxMuteMode(SAI_HandleTypeDef * const hsai);

/* SAI IRQHandler and Callbacks used in non blocking modes (Interrupt and DMA) */
void HAL_SAI_IRQHandler(SAI_HandleTypeDef * const hsai);
void HAL_SAI_TxHalfCpltCallback(SAI_HandleTypeDef * const hsai);
void HAL_SAI_TxCpltCallback(SAI_HandleTypeDef * const hsai);
void HAL_SAI_RxHalfCpltCallback(SAI_HandleTypeDef * const hsai);
void HAL_SAI_RxCpltCallback(SAI_HandleTypeDef * const hsai);
void HAL_SAI_ErrorCallback(SAI_HandleTypeDef * const hsai);
/**
  * @}
  */
...
HAL_SAI_StateTypeDef HAL_SAI_GetState(SAI_HandleTypeDef const * const hsai);
uint32_t HAL_SAI_GetError(SAI_HandleTypeDef const * const hsai);
/**
  * @}
  */
