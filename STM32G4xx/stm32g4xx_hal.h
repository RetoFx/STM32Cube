...
/** @defgroup SYSCFG_VREFBUF_VoltageScale VREFBUF Voltage Scale
  * @{
  */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0  0x00000000UL /*!< Voltage reference scale 0 (VREFBUF_OUT = 2.048V) */
...
/** @brief  CCMSRAM page write protection unlock prior to erase
  ...
  */
#define __HAL_SYSCFG_CCMSRAM_WRP_UNLOCK()    do {SYSCFG->SKR = 0xCAU; \
                                                  SYSCFG->SKR = 0x53U; \
                                                }while(0U)
