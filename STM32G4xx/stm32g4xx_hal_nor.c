...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_NOR_Init(NOR_HandleTypeDef * const hnor, FMC_NORSRAM_TimingTypeDef const * const Timing,
                               FMC_NORSRAM_TimingTypeDef const * const ExtTiming)
{
