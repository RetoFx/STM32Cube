...
#define LL_SYSCFG_BANKMODE_BANK1           0x00000000UL               /*!< Flash Bank1 mapped at 0x08000000UL (and aliased @0x00000000UL)
                                                                      and Flash Bank2 mapped at 0x08040000UL (and aliased at 0x00080000UL) */
#define LL_SYSCFG_BANKMODE_BANK2           SYSCFG_MEMRMP_FB_MODE     /*!< Flash Bank2 mapped at 0x08000000UL (and aliased @0x00000000UL)
                                                                      and Flash Bank1 mapped at 0x08040000UL (and aliased at 0x00080000UL) */
/**
  * @}
  */
...
/** @defgroup SYSTEM_LL_EC_VOLTAGE VREFBUF VOLTAGE
  * @{
  */
#define LL_VREFBUF_VOLTAGE_SCALE0          ((uint32_t)0x00000000UL) /*!< Voltage reference scale 0 (VREFBUF_OUT = 2.048V) */
...
/**
  ...
  * @retval Values between Min_Data=0x00U and Max_Data=0x0FFFU (ex: device ID is 0x6415U)
  */
