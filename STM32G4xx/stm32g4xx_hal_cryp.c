...
#define  CRYP_PHASE_HEADER_SUSPENDED     0x00000004UL    /*!< GCM/GMAC/CCM header phase is suspended */
#define  CRYP_PHASE_PAYLOAD_SUSPENDED    0x00000005UL    /*!< GCM/CCM payload phase is suspended     */
#endif /* USE_HAL_CRYP_SUSPEND_RESUME */
#define  CRYP_PHASE_HEADER_DMA_FEED      0x00000006UL    /*!< GCM/GMAC/CCM header is fed to the peripheral in DMA mode */
...
static HAL_StatusTypeDef CRYP_SetHeaderDMAConfig(CRYP_HandleTypeDef * const hcryp, uint32_t inputaddr, uint16_t Size);
...
static HAL_StatusTypeDef CRYP_GCMCCM_SetPayloadPhase_DMA(CRYP_HandleTypeDef * const hcryp);
...
static void CRYP_ClearCCFlagWhenHigh(CRYP_HandleTypeDef * const hcryp, uint32_t Timeout);
#if (USE_HAL_CRYP_SUSPEND_RESUME == 1U)
static void CRYP_Read_IVRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t * const Output);
static void CRYP_Write_IVRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t const * const Input);
static void CRYP_Read_SuspendRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t * const Output);
static void CRYP_Write_SuspendRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t const * const Input);
static void CRYP_Read_KeyRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t * const Output, uint32_t KeySize);
static void CRYP_Write_KeyRegisters(CRYP_HandleTypeDef * const hcryp, uint32_t const * const Input, uint32_t KeySize);
static void CRYP_PhaseProcessingResume(CRYP_HandleTypeDef * const hcryp);
#endif /* USE_HAL_CRYP_SUSPEND_RESUME */
...
/**
  ...
  * @retval None
  */
void HAL_CRYP_ProcessSuspend(CRYP_HandleTypeDef * const hcryp)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYP_Suspend(CRYP_HandleTypeDef * const hcryp)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_CRYP_Resume(CRYP_HandleTypeDef * const hcryp)
{
  /* Check the CRYP handle allocation */
  if (hcryp == NULL)
  {
...
static void CRYP_DMAInCplt(DMA_HandleTypeDef * const hdma)
{
  ...
  uint32_t tmp;
  static uint32_t const mask[12U] = {0x0U, 0xFF000000UL, 0xFFFF0000UL, 0xFFFFFF00UL,  /* 32-bit data type */
                                     0x0U, 0x0000FF00UL, 0x0000FFFFUL, 0xFF00FFFFUL,  /* 16-bit data type */
                                     0x0U, 0x000000FFUL, 0x0000FFFFUL, 0x00FFFFFFUL
                                    }; /*  8-bit data type */
