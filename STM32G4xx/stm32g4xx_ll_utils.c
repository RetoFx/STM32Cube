...
/** @addtogroup UTILS_LL_Private_Constants
  * @{
  */
#define UTILS_MAX_FREQUENCY_SCALE1  170000000UL       /*!< Maximum frequency for system clock at power scale1, in Hz */
...
#define UTILS_SCALE1_LATENCY1_BOOST_FREQ   34000000UL       /*!< HCLK frequency to set FLASH latency 1 in power scale 1 */
#define UTILS_SCALE1_LATENCY2_BOOST_FREQ   68000000UL       /*!< HCLK frequency to set FLASH latency 2 in power scale 1 */
#define UTILS_SCALE1_LATENCY3_BOOST_FREQ  102000000UL       /*!< HCLK frequency to set FLASH latency 3 in power scale 1 */
#define UTILS_SCALE1_LATENCY4_BOOST_FREQ  136000000UL       /*!< HCLK frequency to set FLASH latency 4 in power scale 1 */
#define UTILS_SCALE1_LATENCY5_BOOST_FREQ  170000000UL       /*!< HCLK frequency to set FLASH latency 5 in power scale 1 */

#define UTILS_SCALE1_LATENCY1_FREQ   30000000UL       /*!< HCLK frequency to set FLASH latency 1 in power scale 1 normal mode */
#define UTILS_SCALE1_LATENCY2_FREQ   60000000UL       /*!< HCLK frequency to set FLASH latency 2 in power scale 1 normal mode */
#define UTILS_SCALE1_LATENCY3_FREQ   90000000UL       /*!< HCLK frequency to set FLASH latency 3 in power scale 1 normal mode */
#define UTILS_SCALE1_LATENCY4_FREQ  120000000UL       /*!< HCLK frequency to set FLASH latency 4 in power scale 1 normal mode */
#define UTILS_SCALE1_LATENCY5_FREQ  150000000UL       /*!< HCLK frequency to set FLASH latency 5 in power scale 1 normal mode */

#define UTILS_SCALE2_LATENCY1_FREQ   12000000UL       /*!< HCLK frequency to set FLASH latency 1 in power scale 2 */
#define UTILS_SCALE2_LATENCY2_FREQ   24000000UL       /*!< HCLK frequency to set FLASH latency 2 in power scale 2 */
#define UTILS_SCALE2_LATENCY3_FREQ   26000000UL       /*!< HCLK frequency to set FLASH latency 3 in power scale 2 */
/**
  * @}
  */
...
/**
  ...
  *         - PLLR: ensure that max frequency at 170000000UL Hz is reach (PLLVCO_output / PLLR)
  ...
  */
ErrorStatus LL_PLL_ConfigSystemClock_HSI(LL_UTILS_PLLInitTypeDef * const UTILS_PLLInitStruct,
                                         LL_UTILS_ClkInitTypeDef * const UTILS_ClkInitStruct)
{
  ErrorStatus status;
  uint32_t pllfreq;
...
/**
  ...
  *         - PLLN: ensure that the VCO output frequency is between 64 and 344 MHz (PLLVCO_output = PLLVCO_input * PLLN)
  *         - PLLR: ensure that max frequency at 170000000UL Hz is reached (PLLVCO_output / PLLR)
...
ErrorStatus LL_PLL_ConfigSystemClock_HSE(uint32_t HSEFrequency, uint32_t HSEBypass,
                                         LL_UTILS_PLLInitTypeDef const * const UTILS_PLLInitStruct, LL_UTILS_ClkInitTypeDef * const UTILS_ClkInitStruct)
{
  ErrorStatus status;
  uint32_t pllfreq;
  uint32_t hpre = LL_RCC_SYSCLK_DIV_1;
...
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef const * const UTILS_PLLInitStruct)
{
  ...
  /*  - PLLR: ensure that max frequency at 170000000UL Hz is reached                   */
