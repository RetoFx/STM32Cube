...
#define FDCAN_ELEMENT_MASK_STDID ((uint32_t)0x1FFC0000UL) /* Standard Identifier         */
#define FDCAN_ELEMENT_MASK_EXTID ((uint32_t)0x1FFFFFFFUL) /* Extended Identifier         */
#define FDCAN_ELEMENT_MASK_RTR   ((uint32_t)0x20000000UL) /* Remote Transmission Request */
#define FDCAN_ELEMENT_MASK_XTD   ((uint32_t)0x40000000UL) /* Extended Identifier         */
#define FDCAN_ELEMENT_MASK_ESI   ((uint32_t)0x80000000UL) /* Error State Indicator       */
#define FDCAN_ELEMENT_MASK_TS    ((uint32_t)0x0000FFFFUL) /* Timestamp                   */
#define FDCAN_ELEMENT_MASK_DLC   ((uint32_t)0x000F0000UL) /* Data Length Code            */
#define FDCAN_ELEMENT_MASK_BRS   ((uint32_t)0x00100000UL) /* Bit Rate Switch             */
#define FDCAN_ELEMENT_MASK_FDF   ((uint32_t)0x00200000UL) /* FD Format                   */
#define FDCAN_ELEMENT_MASK_EFC   ((uint32_t)0x00800000UL) /* Event FIFO Control          */
#define FDCAN_ELEMENT_MASK_MM    ((uint32_t)0xFF000000UL) /* Message Marker              */
#define FDCAN_ELEMENT_MASK_FIDX  ((uint32_t)0x7F000000UL) /* Filter Index                */
#define FDCAN_ELEMENT_MASK_ANMF  ((uint32_t)0x80000000UL) /* Accepted Non-matching Frame */
#define FDCAN_ELEMENT_MASK_ET    ((uint32_t)0x00C00000UL) /* Event type                  */
...
#define SRAMCAN_FLSSA ((uint32_t)0U)                                                      /* Filter List Standard Start
                                                                                            Address                  */
...
/** @addtogroup FDCAN_Private_Functions_Prototypes
  * @{
  */
static void FDCAN_CalcultateRamBlockAddresses(FDCAN_HandleTypeDef * const hfdcan);
static void FDCAN_CopyMessageToRAM(FDCAN_HandleTypeDef const * const hfdcan, FDCAN_TxHeaderTypeDef const * const pTxHeader,
                                   uint8_t const * const pTxData, uint32_t BufferIndex);
/**
  * @}
  */
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef * const hfdcan)
{
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
  /* NOTE: This function Should not be modified, when the callback is needed,
...
HAL_StatusTypeDef HAL_FDCAN_RegisterCallback(FDCAN_HandleTypeDef * const hfdcan, HAL_FDCAN_CallbackIDTypeDef CallbackID,
                                             void (* pCallback)(FDCAN_HandleTypeDef * const _hFDCAN))
{
...
HAL_StatusTypeDef HAL_FDCAN_ConfigFilter(FDCAN_HandleTypeDef * const hfdcan, FDCAN_FilterTypeDef const * const sFilterConfig)
{
  ...
  if ((state == HAL_FDCAN_STATE_READY) || (state == HAL_FDCAN_STATE_BUSY))
  {
    ...
    else /* sFilterConfig->IdType == FDCAN_EXTENDED_ID */
    {
      ...
      assert_param(IS_FDCAN_MAX_VALUE(sFilterConfig->FilterID1, 0x1FFFFFFFUL));
      assert_param(IS_FDCAN_MAX_VALUE(sFilterConfig->FilterID2, 0x1FFFFFFFUL));
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FDCAN_ConfigGlobalFilter(FDCAN_HandleTypeDef * const hfdcan,
...
/**
  ...
  *         This parameter must be a number between 0 and 0x1FFFFFFFUL.
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_FDCAN_ConfigExtendedIdMask(FDCAN_HandleTypeDef * const hfdcan, uint32_t Mask)
{
  /* Check function parameters */
  assert_param(IS_FDCAN_MAX_VALUE(Mask, 0x1FFFFFFFUL));
...
/**
  ...
  *         This parameter must be a number between 0x00U and 0xFFU,
  *         with the reset value of 0x00U the counter is disabled.
  * @retval HAL status
  */
...
/**
  ...
  *         This parameter must be a number between 0x0000U and 0xFFFFU
  * @retval HAL status
  */
...
/**
  ...
  *         This parameter must be a number between 0x00U and 0x7FU.
                                                ...
                                                uint8_t const * const pTxData)
{
  ...
  {
    assert_param(IS_FDCAN_MAX_VALUE(pTxHeader->Identifier, 0x1FFFFFFFUL));
  }
  ...
  if (hfdcan->State == HAL_FDCAN_STATE_BUSY)
  {
    ...
    else
    {
      ...
      hfdcan->Instance->TXBAR = ((uint32_t)1UL << PutIndex);

      /* Store the Latest Tx FIFO/Queue Request Buffer Index */
      hfdcan->LatestTxFifoQRequest = ((uint32_t)1UL << PutIndex);
    }
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TxEventFifoCallback(FDCAN_HandleTypeDef * const hfdcan, uint32_t TxEventFifoITs)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_RxFifo0Callback(FDCAN_HandleTypeDef * const hfdcan, uint32_t RxFifo0ITs)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
  UNUSED(RxFifo0ITs);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_RxFifo1Callback(FDCAN_HandleTypeDef * const hfdcan, uint32_t RxFifo1ITs)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
  UNUSED(RxFifo1ITs);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TxFifoEmptyCallback(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TxBufferCompleteCallback(FDCAN_HandleTypeDef * const hfdcan, uint32_t BufferIndexes)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TxBufferAbortCallback(FDCAN_HandleTypeDef * const hfdcan, uint32_t BufferIndexes)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
  UNUSED(BufferIndexes);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TimestampWraparoundCallback(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_TimeoutOccurredCallback(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_HighPriorityMessageCallback(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_ErrorCallback(FDCAN_HandleTypeDef * const hfdcan)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
/**
  ...
  * @retval None
  */
__weak void HAL_FDCAN_ErrorStatusCallback(FDCAN_HandleTypeDef * const hfdcan, uint32_t ErrorStatusITs)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hfdcan);
...
static void FDCAN_CalcultateRamBlockAddresses(FDCAN_HandleTypeDef * const hfdcan)
{
  ...
  {
    *(uint32_t *)(RAMcounter) = 0x00000000UL;
  }
}
