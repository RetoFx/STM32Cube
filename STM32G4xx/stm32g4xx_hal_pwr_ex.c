...
#define PWR_PORTF_AVAILABLE_PINS   0x0000FFFFUL /* PF0..PF15 */
#define PWR_PORTG_AVAILABLE_PINS   0x000007FFUL /* PG0..PG10 */
#elif defined (STM32G431xx) || defined (STM32G441xx) || defined (STM32GBK1CB) || defined (STM32G491xx) || defined (STM32G4A1xx)
#define PWR_PORTF_AVAILABLE_PINS   0x00000607UL /* PF0..PF2 and PF9 and PF10 */
#define PWR_PORTG_AVAILABLE_PINS   0x00000400UL /* PG10 */
...
#define PVM_MODE_EVT              0x00020000UL    /*!< Mask for event yielded by PVM threshold crossing        */
