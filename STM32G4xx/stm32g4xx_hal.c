...
#define FB_MODE_BIT_NUMBER       ((uint8_t)0x8U)
#define FB_MODE_BB              (PERIPH_BB_BASE + (MEMRMP_OFFSET * 32U) + (FB_MODE_BIT_NUMBER * 4U))

/* --- GPC Register ---*/
/* Alias word address of CCMER bit */
#define SCSR_OFFSET             (SYSCFG_OFFSET + 0x18U)
#define CCMER_BIT_NUMBER         ((uint8_t)0x0U)
#define SCSR_CCMER_BB           (PERIPH_BB_BASE + (SCSR_OFFSET * 32U) + (CCMER_BIT_NUMBER * 4U))
...
/**
  ...
  * @retval HAL status
  */
HAL_SYSTICK_WEAK(HAL_StatusTypeDef, HAL_InitTick)(uint32_t TickPriority)
{
  HAL_StatusTypeDef  status = HAL_OK;
...
/**
  ...
  * @retval None
  */
HAL_SYSTICK_WEAK(void, HAL_IncTick)(void)
{
  uwTick += uwTickFreq;
}
...
/**
  ...
  * @retval tick value
  */
HAL_SYSTICK_WEAK(uint32_t, HAL_GetTick)(void)
{
  return uwTick;
}
...
/**
  ...
  * @retval None
  */
HAL_SYSTICK_WEAK(void, HAL_SuspendTick)(void)
{
...
/**
  ...
  * @retval None
  */
HAL_SYSTICK_WEAK(void, HAL_ResumeTick)(void)
{
...
/**
  ...
  *
  * @note   Flash Bank2 mapped at 0x08000000UL (and aliased @0x00000000UL)
  *         and Flash Bank1 mapped at 0x08040000UL (and aliased at 0x00040000UL)
  *
  * @retval None
  */
...
/**
  ...
  * @note   This function can be used only for STM32G4xx devices.
  *
  * @note   The default state : Flash Bank1 mapped at 0x08000000UL (and aliased @0x0000U 0000)
  *         and Flash Bank2 mapped at 0x08040000UL (and aliased at 0x00040000UL)
  *
  * @retval None
  */
...
/**
  ...
  *        This parameter can be a number between Min_Data = 0x00U and Max_Data = 0x3FU
  * @retval None
  */
